...
final class TypeAnalyzer
{
    ...
    public function isPhpReservedType(string $type) : bool
    {
        ...
        foreach ($types as $singleType) {
            ...
            // remove [] from arrays
            $singleType = \RectorPrefix20201231\Nette\Utils\Strings::replace($singleType, self::SQUARE_BRACKET_REGEX, '');
    ...
    public function normalizeType(string $type) : string
    {
        ...
        if (\RectorPrefix20201231\Nette\Utils\Strings::match(\strtolower($type), self::ARRAY_TYPE_REGEX)) {
            return 'array';
        }
        return $type;
    }
