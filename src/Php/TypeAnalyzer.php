...
final class TypeAnalyzer
{
    ...
    public function isPhpReservedType(string $type) : bool
    {
        ...
        foreach ($types as $type) {
            ...
            // remove [] from arrays
            $type = \RectorPrefix20210425\Nette\Utils\Strings::replace($type, self::SQUARE_BRACKET_REGEX, '');
    ...
    public function normalizeType(string $type) : string
    {
        ...
        if (\RectorPrefix20210425\Nette\Utils\Strings::match($loweredType, self::ARRAY_TYPE_REGEX)) {
            return 'array';
        }
        return $type;
    }
