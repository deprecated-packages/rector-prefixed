...
final class MergeImportedRectorConfigureCallValuesCompilerPass implements \_PhpScoperb75b35f52b74\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoperb75b35f52b74\Rector\Core\DependencyInjection\Collector\ConfigureCallValuesCollector $configureCallValuesCollector)
    {
    ...
    private function completeCollectedArguments(string $serviceClass, \_PhpScoperb75b35f52b74\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
