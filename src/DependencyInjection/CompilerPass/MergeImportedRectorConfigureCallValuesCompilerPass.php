...
final class MergeImportedRectorConfigureCallValuesCompilerPass implements \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @var string
     */
    ...
    private function completeCollectedArguments(string $serviceClass, \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
