...
final class MergeImportedRectorConfigureCallValuesCompilerPass implements \_PhpScoperbf340cb0be9d\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @var string
     */
    ...
    private function completeCollectedArguments(string $serviceClass, \_PhpScoperbf340cb0be9d\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
