...
final class MergeImportedRectorConfigureCallValuesCompilerPass implements \RectorPrefix20210422\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @var string
     */
     ...
     * @return void
     */
    private function completeCollectedArguments(string $serviceClass, \RectorPrefix20210422\Symfony\Component\DependencyInjection\Definition $definition)
    {
