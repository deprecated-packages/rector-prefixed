...
final class VerifyRectorServiceExistsCompilerPass implements \RectorPrefix20210322\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\RectorPrefix20210322\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\RectorPrefix20210322\Nette\Utils\Strings::endsWith($class, 'Rector')) {
                continue;
            }
