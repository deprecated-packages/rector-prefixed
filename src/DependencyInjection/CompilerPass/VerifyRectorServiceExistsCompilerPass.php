...
final class VerifyRectorServiceExistsCompilerPass implements \RectorPrefix20210408\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\RectorPrefix20210408\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\RectorPrefix20210408\Nette\Utils\Strings::endsWith($class, 'Rector')) {
                continue;
            }
