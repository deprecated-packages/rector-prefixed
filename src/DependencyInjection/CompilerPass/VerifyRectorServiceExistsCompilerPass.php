...
final class VerifyRectorServiceExistsCompilerPass implements \RectorPrefix20210414\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\RectorPrefix20210414\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\RectorPrefix20210414\Nette\Utils\Strings::endsWith($class, 'Rector')) {
                continue;
            }
