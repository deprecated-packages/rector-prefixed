...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \_PhpScoperbd5d0c5f7638\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
