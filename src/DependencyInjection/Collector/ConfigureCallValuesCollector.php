...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \_PhpScoper567b66d83109\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
