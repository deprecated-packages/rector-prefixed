...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \_PhpScoper267b3276efc2\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
