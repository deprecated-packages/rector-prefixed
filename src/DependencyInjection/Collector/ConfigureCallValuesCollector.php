...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \_PhpScoper006a73f0e455\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
