...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \_PhpScoper26e51eeacccf\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
