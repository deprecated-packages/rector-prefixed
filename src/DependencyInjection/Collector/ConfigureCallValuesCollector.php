...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
