...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \_PhpScoperf18a0c41e2d2\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
