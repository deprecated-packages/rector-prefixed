...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \_PhpScopera143bcca66cb\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
