...
final class RectorContainerFactory
{
     ...
     * @api
     */
    public function createFromConfigs(array $configFileInfos) : \RectorPrefix20210212\Psr\Container\ContainerInterface
    {
        // to override the configs without clearing cache
        $isDebug = \RectorPrefix20210212\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug();
