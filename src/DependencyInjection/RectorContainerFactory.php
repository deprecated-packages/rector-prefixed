...
final class RectorContainerFactory
{
     ...
     * @api
     */
    public function createFromConfigs(array $configFileInfos) : \RectorPrefix20210113\Psr\Container\ContainerInterface
    {
        // to override the configs without clearing cache
        $environment = 'prod' . \random_int(1, 10000000);
        $isDebug = \RectorPrefix20210113\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug();
