...
final class RectorContainerFactory
{
     ...
     * @api
     */
    public function createFromConfigs(array $configFileInfos) : \RectorPrefix20210103\Psr\Container\ContainerInterface
    {
        // to override the configs without clearing cache
        $environment = 'prod' . \random_int(1, 10000000);
        $isDebug = \RectorPrefix20210103\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug();
