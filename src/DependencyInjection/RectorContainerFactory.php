...
final class RectorContainerFactory
{
     ...
     * @api
     */
    public function createFromConfigs(array $configFileInfos) : \RectorPrefix20210210\Psr\Container\ContainerInterface
    {
        // to override the configs without clearing cache
        $isDebug = \RectorPrefix20210210\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug();
