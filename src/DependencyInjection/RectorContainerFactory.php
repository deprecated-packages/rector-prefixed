...
final class RectorContainerFactory
{
     ...
     * @api
     */
    public function createFromConfigs(array $configFileInfos) : \RectorPrefix20210211\Psr\Container\ContainerInterface
    {
        // to override the configs without clearing cache
        $isDebug = \RectorPrefix20210211\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug();
