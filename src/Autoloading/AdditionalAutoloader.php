...
final class AdditionalAutoloader
{
    ...
    public function __construct(\RectorPrefix20210502\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard, \RectorPrefix20210502\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\StaticReflection\DynamicSourceLocatorDecorator $dynamicSourceLocatorDecorator)
    {
        $this->fileSystemGuard = $fileSystemGuard;
        $this->parameterProvider = $parameterProvider;
        $this->dynamicSourceLocatorDecorator = $dynamicSourceLocatorDecorator;
    }
    public function autoloadInput(\RectorPrefix20210502\Symfony\Component\Console\Input\InputInterface $input) : void
    {
