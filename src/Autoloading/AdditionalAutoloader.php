...
final class AdditionalAutoloader
{
    ...
    public function __construct(\RectorPrefix20210302\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard, \RectorPrefix20210302\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\StaticReflection\DynamicSourceLocatorDecorator $dynamicSourceLocatorDecorator)
    {
        $this->fileSystemGuard = $fileSystemGuard;
        $this->parameterProvider = $parameterProvider;
        $this->dynamicSourceLocatorDecorator = $dynamicSourceLocatorDecorator;
    }
    public function autoloadWithInputAndSource(\RectorPrefix20210302\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    private function autoloadInputAutoloadFile(\RectorPrefix20210302\Symfony\Component\Console\Input\InputInterface $input) : void
    {
