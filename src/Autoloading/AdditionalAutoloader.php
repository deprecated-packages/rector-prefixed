...
use RectorPrefix20210113\Nette\Loaders\RobotLoader;
...
final class AdditionalAutoloader
{
    ...
    public function __construct(\Rector\Core\FileSystem\FileGuard $fileGuard, \RectorPrefix20210113\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter, \RectorPrefix20210113\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210113\Symplify\Skipper\SkipCriteriaResolver\SkippedPathsResolver $skippedPathsResolver)
    {
     ...
     * @param string[] $source
     */
    public function autoloadWithInputAndSource(\RectorPrefix20210113\Symfony\Component\Console\Input\InputInterface $input, array $source) : void
    {
    ...
    private function autoloadFileFromInput(\RectorPrefix20210113\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    private function autoloadDirectories(array $directories) : void
    {
        ...
        $robotLoader = new \RectorPrefix20210113\Nette\Loaders\RobotLoader();
