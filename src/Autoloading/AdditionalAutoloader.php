...
namespace _PhpScoper0a2ac50786fa\Rector\Core\Autoloading;

use _PhpScoper0a2ac50786fa\Nette\Loaders\RobotLoader;
use _PhpScoper0a2ac50786fa\Rector\Core\Configuration\Option;
use _PhpScoper0a2ac50786fa\Rector\Core\FileSystem\FileGuard;
...
final class AdditionalAutoloader
{
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\Core\FileSystem\FileGuard $fileGuard, \_PhpScoper0a2ac50786fa\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter, \_PhpScoper0a2ac50786fa\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \_PhpScoper0a2ac50786fa\Symplify\Skipper\SkipCriteriaResolver\SkippedPathsResolver $skippedPathsResolver)
    {
        $this->fileGuard = $fileGuard;
        $this->autoloadPaths = (array) $parameterProvider->provideParameter(\_PhpScoper0a2ac50786fa\Rector\Core\Configuration\Option::AUTOLOAD_PATHS);
     ...
     * @param string[] $source
     */
    public function autoloadWithInputAndSource(\_PhpScoper0a2ac50786fa\Symfony\Component\Console\Input\InputInterface $input, array $source) : void
    {
    ...
    private function autoloadFileFromInput(\_PhpScoper0a2ac50786fa\Symfony\Component\Console\Input\InputInterface $input) : void
    {
        if (!$input->hasOption(\_PhpScoper0a2ac50786fa\Rector\Core\Configuration\Option::OPTION_AUTOLOAD_FILE)) {
            return;
        }
        /** @var string|null $autoloadFile */
        $autoloadFile = $input->getOption(\_PhpScoper0a2ac50786fa\Rector\Core\Configuration\Option::OPTION_AUTOLOAD_FILE);
