...
final class AdditionalAutoloader
{
    ...
    public function __construct(\RectorPrefix20210303\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard, \RectorPrefix20210303\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\StaticReflection\DynamicSourceLocatorDecorator $dynamicSourceLocatorDecorator)
    {
        $this->fileSystemGuard = $fileSystemGuard;
        $this->parameterProvider = $parameterProvider;
        $this->dynamicSourceLocatorDecorator = $dynamicSourceLocatorDecorator;
    }
    public function autoloadWithInputAndSource(\RectorPrefix20210303\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    private function autoloadInputAutoloadFile(\RectorPrefix20210303\Symfony\Component\Console\Input\InputInterface $input) : void
    {
