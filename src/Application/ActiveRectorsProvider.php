...
final class ActiveRectorsProvider
{
     ...
     */
    public function __construct(array $rectors, \RectorPrefix20210122\Symplify\Skipper\Skipper\Skipper $skipper)
    {
        $dummyFileInfo = new \RectorPrefix20210122\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/../../config/config.php');
