...
final class ActiveRectorsProvider
{
     ...
     */
    public function __construct(array $rectors, \RectorPrefix20210307\Symplify\Skipper\Skipper\Skipper $skipper)
    {
        $dummyFileInfo = new \RectorPrefix20210307\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/../../config/config.php');
