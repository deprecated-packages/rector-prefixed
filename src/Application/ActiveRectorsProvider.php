...
final class ActiveRectorsProvider
{
     ...
     */
    public function __construct(array $rectors, \RectorPrefix20210217\Symplify\Skipper\Skipper\Skipper $skipper)
    {
        $dummyFileInfo = new \RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/../../config/config.php');
