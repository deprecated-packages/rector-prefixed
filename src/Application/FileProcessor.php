...
final class FileProcessor
{
    ...
    public function parseFileInfoToLocalCache(\RectorPrefix20210204\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function printToFile(\RectorPrefix20210204\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
     ...
     */
    public function printToString(\RectorPrefix20210204\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    public function refactor(\RectorPrefix20210204\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function postFileRefactor(\RectorPrefix20210204\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        if (!$this->tokensByFilePathStorage->hasForFileInfo($smartFileInfo)) {
    ...
    private function parseAndTraverseFileInfoToNodes(\RectorPrefix20210204\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : \Rector\Core\ValueObject\Application\ParsedStmtsAndTokens
    {
    ...
    private function makeSureFileIsParsed(\RectorPrefix20210204\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        if ($this->tokensByFilePathStorage->hasForFileInfo($smartFileInfo)) {
            return;
        }
