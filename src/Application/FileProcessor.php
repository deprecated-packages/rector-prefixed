...
final class FileProcessor
{
    ...
    public function parseFileInfoToLocalCache(\RectorPrefix20210404\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function printToFile(\RectorPrefix20210404\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
     ...
     */
    public function printToString(\RectorPrefix20210404\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    public function refactor(\RectorPrefix20210404\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->currentFileInfoProvider->setCurrentFileInfo($smartFileInfo);
        $this->makeSureFileIsParsed($smartFileInfo);
        $parsedStmtsAndTokens = $this->tokensByFilePathStorage->getForFileInfo($smartFileInfo);
    ...
    public function postFileRefactor(\RectorPrefix20210404\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        if (!$this->tokensByFilePathStorage->hasForFileInfo($smartFileInfo)) {
    ...
    private function parseAndTraverseFileInfoToNodes(\RectorPrefix20210404\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : \Rector\Core\ValueObject\Application\ParsedStmtsAndTokens
    {
    ...
    private function makeSureFileIsParsed(\RectorPrefix20210404\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        if ($this->tokensByFilePathStorage->hasForFileInfo($smartFileInfo)) {
            return;
        }
