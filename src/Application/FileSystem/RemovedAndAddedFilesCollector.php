...
final class RemovedAndAddedFilesCollector
{
     ...
     */
    private $addedFiles = [];
    public function removeFile(\RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function isFileRemoved(\RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
