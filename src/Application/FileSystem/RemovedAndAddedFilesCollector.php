...
final class RemovedAndAddedFilesCollector
{
     ...
     */
    private $addedFiles = [];
    public function removeFile(\RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function isFileRemoved(\RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
