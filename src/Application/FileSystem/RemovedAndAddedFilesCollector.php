...
final class RemovedAndAddedFilesCollector
{
     ...
     */
    private $addedFiles = [];
    public function removeFile(\RectorPrefix20210430\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function isFileRemoved(\RectorPrefix20210430\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
