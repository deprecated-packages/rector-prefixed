...
final class RemovedAndAddedFilesCollector
{
     ...
     */
    private $movedFiles = [];
    public function removeFile(\RectorPrefix20210112\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    public function getMovedFileByFileInfo(\RectorPrefix20210112\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : ?\Rector\FileSystemRector\Contract\MovedFileInterface
    {
    ...
    public function isFileRemoved(\RectorPrefix20210112\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
