...
final class RemovedAndAddedFilesCollector
{
     ...
     * @return void
     */
    public function removeFile(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
    ...
    public function isFileRemoved(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
