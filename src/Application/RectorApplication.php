...
final class RectorApplication
{
    ...
    private function configureStepCount(int $fileCount) : void
    {
        ...
        if (!$progressBar instanceof \RectorPrefix2020DecSat\Symfony\Component\Console\Helper\ProgressBar) {
