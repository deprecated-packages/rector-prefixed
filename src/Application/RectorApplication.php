...
final class RectorApplication
{
    ...
    private function configureStepCount(int $fileCount) : void
    {
        ...
        if (!$progressBar instanceof \_PhpScoper8b9c402c5f32\Symfony\Component\Console\Helper\ProgressBar) {
