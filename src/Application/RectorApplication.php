...
final class RectorApplication
{
    ...
    private function configureStepCount(int $fileCount) : void
    {
        ...
        if (!$progressBar instanceof \_PhpScoperf18a0c41e2d2\Symfony\Component\Console\Helper\ProgressBar) {
