...
final class RectorApplication
{
    ...
    private function configureStepCount(int $fileCount) : void
    {
        ...
        if (!$progressBar instanceof \RectorPrefix20201226\Symfony\Component\Console\Helper\ProgressBar) {
