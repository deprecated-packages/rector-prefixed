...
final class RectorApplication
{
    ...
    public function runOnFileInfos(array $phpFileInfos) : void
    {
        ...
        foreach ($phpFileInfos as $phpFileInfo) {
            $this->tryCatchWrapper($phpFileInfo, function (\RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void {
    ...
    private function tryCatchWrapper(\RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, callable $callback, string $phase) : void
    {
    ...
    private function printFileInfo(\RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    private function configureStepCount(int $fileCount) : void
    {
        ...
        if (!$progressBar instanceof \RectorPrefix20210114\Symfony\Component\Console\Helper\ProgressBar) {
    ...
    private function advance(\RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $phase) : void
    {
        if ($this->symfonyStyle->isVerbose()) {
