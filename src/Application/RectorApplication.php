...
final class RectorApplication
{
    ...
    public function runOnFileInfos(array $phpFileInfos) : void
    {
        ...
        $this->eventDispatcher->dispatch(new \Rector\Core\EventDispatcher\Event\AfterProcessEvent());
    }
    ...
    private function configureStepCount(int $fileCount) : void
    {
        ...
        if (!$progressBar instanceof \_PhpScoper88fe6e0ad041\Symfony\Component\Console\Helper\ProgressBar) {
