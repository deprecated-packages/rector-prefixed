...
final class RectorApplication
{
    ...
    public function runOnPaths(array $paths) : void
    {
        ...
        foreach ($phpFileInfos as $phpFileInfo) {
            $this->tryCatchWrapper($phpFileInfo, function (\RectorPrefix20210329\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void {
    ...
    private function tryCatchWrapper(\RectorPrefix20210329\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, callable $callback, string $phase) : void
    {
    ...
    private function printFileInfo(\RectorPrefix20210329\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    private function configureStepCount(int $fileCount) : void
    {
        ...
        if (!$progressBar instanceof \RectorPrefix20210329\Symfony\Component\Console\Helper\ProgressBar) {
    ...
    private function advance(\RectorPrefix20210329\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $phase) : void
    {
        if ($this->symfonyStyle->isVerbose()) {
