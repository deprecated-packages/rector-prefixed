...
abstract class AbstractRector extends \PhpParser\NodeVisitorAbstract implements \Rector\Core\Contract\Rector\PhpRectorInterface
{
    ...
    public final function enterNode(\PhpParser\Node $node)
    {
        ...
        $this->currentFileInfo = $node->getAttribute(\RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo::class);
        ...
        if ($fileInfo instanceof \RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo && $this->skipper->shouldSkipElementAndFileInfo($this, $fileInfo)) {
            return null;
        }
    ...
    protected function getFileInfo() : \RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    {
        $fileInfo = $node->getAttribute(\Rector\NodeTypeResolver\Node\AttributeKey::FILE_INFO);
        if ($fileInfo instanceof \RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo) {
            return;
        }
