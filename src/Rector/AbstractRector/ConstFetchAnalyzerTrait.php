...
trait ConstFetchAnalyzerTrait
{
     ...
     * @required
     */
    public function autowireConstFetchAnalyzerTrait(\_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Node\Manipulator\ConstFetchManipulator $constFetchManipulator) : void
    {
