...
use _PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\Manipulator\VisibilityManipulator;
/**
...
trait VisibilityTrait
{
     ...
     * @required
     */
    public function autowireVisibilityTrait(\_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\Manipulator\VisibilityManipulator $visibilityManipulator) : void
    {
     ...
     * @param ClassMethod|Property|ClassConst $node
     */
    public function removeVisibility(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : void
    {
