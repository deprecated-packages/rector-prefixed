...
abstract class AbstractPHPUnitRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    protected function isTestClassMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if ($docComment !== null) {
            return (bool) \_PhpScoper26e51eeacccf\Nette\Utils\Strings::match($docComment->getText(), self::TEST_ANNOTATOIN_REGEX);
        }
        return \false;
    }
    ...
    protected function isInTestClass(\PhpParser\Node $node) : bool
    {
        ...
        return $this->isObjectTypes($classLike, ['_PhpScoper26e51eeacccf\\PHPUnit\\Framework\\TestCase', 'PHPUnit_Framework_TestCase']);
    }
    /**
