...
abstract class AbstractPHPUnitRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    protected function isTestClassMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if ($docComment !== null) {
            return (bool) \_PhpScoperabd03f0baf05\Nette\Utils\Strings::match($docComment->getText(), self::TEST_ANNOTATOIN_REGEX);
        }
        return \false;
    }
    ...
    protected function isInTestClass(\PhpParser\Node $node) : bool
    {
        ...
        return $this->isObjectTypes($classLike, ['_PhpScoperabd03f0baf05\\PHPUnit\\Framework\\TestCase', 'PHPUnit_Framework_TestCase']);
    }
    /**
