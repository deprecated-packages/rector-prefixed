...
final class ArrayManipulator
{
     ...
     * @return void
     */
    public function addItemToArrayUnderKey(Array_ $array, ArrayItem $newArrayItem, string $key)
    {
     ...
     */
    public function findItemInInArrayByKeyAndUnset(Array_ $array, string $keyName)
    {
