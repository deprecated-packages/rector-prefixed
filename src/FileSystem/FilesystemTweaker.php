...
final class FilesystemTweaker
{
    ...
    public function __construct(\RectorPrefix20210216\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function resolveDirectoriesWithFnmatch(array $directories) : array
    {
        ...
        foreach ($directories as $directory) {
            ...
            if (\RectorPrefix20210216\Nette\Utils\Strings::contains($directory, '*')) {
