...
final class FilesystemTweaker
{
    ...
    public function __construct(\RectorPrefix20210221\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function resolveDirectoriesWithFnmatch(array $directories) : array
    {
        ...
        foreach ($directories as $directory) {
            ...
            if (\RectorPrefix20210221\Nette\Utils\Strings::contains($directory, '*')) {
