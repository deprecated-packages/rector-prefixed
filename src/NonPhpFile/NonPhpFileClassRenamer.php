...
final class NonPhpFileClassRenamer
{
    ...
    public function renameClasses(string $newContent, array $classRenames) : string
    {
        ...
        foreach ($classRenames as $oldClass => $newClass) {
            ...
            if (!\RectorPrefix20210304\Nette\Utils\Strings::contains($oldClass, '\\')) {
            ...
            $newContent = \RectorPrefix20210304\Nette\Utils\Strings::replace($newContent, $oldClassRegex, function (array $match) use($newClass) : string {
