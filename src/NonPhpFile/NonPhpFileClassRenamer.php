...
final class NonPhpFileClassRenamer
{
    ...
    public function renameClasses(string $newContent, array $classRenames) : string
    {
        ...
        foreach ($classRenames as $oldClass => $newClass) {
            ...
            if (!\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::contains($oldClass, '\\')) {
            ...
            $newContent = \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::replace($newContent, $oldClassRegex, function (array $match) use($newClass) : string {
