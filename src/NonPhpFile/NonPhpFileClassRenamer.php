...
final class NonPhpFileClassRenamer
{
    ...
    public function renameClasses(string $newContent, array $classRenames) : string
    {
        ...
        foreach ($classRenames as $oldClass => $newClass) {
            ...
            if (!\_PhpScoper88fe6e0ad041\Nette\Utils\Strings::contains($oldClass, '\\')) {
            ...
            $newContent = \_PhpScoper88fe6e0ad041\Nette\Utils\Strings::replace($newContent, $oldClassRegex, function (array $match) use($newClass) : string {
