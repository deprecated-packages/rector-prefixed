...
final class NonPhpFileClassRenamer
{
    ...
    public function renameClasses(string $newContent, array $classRenames) : string
    {
        ...
        foreach ($classRenames as $oldClass => $newClass) {
            ...
            if (!\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::contains($oldClass, '\\')) {
            ...
            $newContent = \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::replace($newContent, $oldClassRegex, function (array $match) use($newClass) : string {
