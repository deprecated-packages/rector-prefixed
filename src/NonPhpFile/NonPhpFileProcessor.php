...
final class NonPhpFileProcessor
{
    ...
    public function __construct(\Rector\Core\Configuration\RenamedClassesDataCollector $renamedClassesDataCollector, \Rector\Core\Configuration\Configuration $configuration, \Rector\PSR4\Collector\RenamedClassesCollector $renamedClassesCollector, \RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210202\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Rector\Core\NonPhpFile\NonPhpFileClassRenamer $nonPhpFileClassRenamer)
    {
    ...
    public function processFileInfo(\RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    private function reportFileContentChange(\RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $newContent) : void
    {
