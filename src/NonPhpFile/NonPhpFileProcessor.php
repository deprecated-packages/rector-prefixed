...
final class NonPhpFileProcessor
{
    ...
    public function processFileInfo(\RectorPrefix20210319\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    private function reportFileContentChange(\RectorPrefix20210319\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $newContents, string $oldContents) : void
    {
