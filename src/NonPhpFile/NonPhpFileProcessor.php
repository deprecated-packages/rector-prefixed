...
final class NonPhpFileProcessor
{
    ...
    public function processFileInfo(\RectorPrefix20210309\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    private function reportFileContentChange(\RectorPrefix20210309\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $newContents, string $oldContents) : void
    {
