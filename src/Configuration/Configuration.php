...
final class Configuration
{
     ...
     */
    public function resolveFromInput(\RectorPrefix20210228\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \RectorPrefix20210228\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    public function getMainConfigFilePath() : ?string
    {
        ...
        if (!$mainConfigFileInfo instanceof \RectorPrefix20210228\Symplify\SmartFileSystem\SmartFileInfo) {
            return null;
        }
        return $mainConfigFileInfo->getRelativeFilePathFromCwd();
    }
    private function canShowProgressBar(\RectorPrefix20210228\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
