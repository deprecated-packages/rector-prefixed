...
final class Configuration
{
    ...
    public function __construct(\RectorPrefix20210102\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\RectorPrefix20210102\Symfony\Component\Console\Input\InputInterface $input) : void
    {
     ...
     * @api
     */
    public function setFirstResolverConfigFileInfo(\RectorPrefix20210102\Symplify\SmartFileSystem\SmartFileInfo $firstResolvedConfigFileInfo) : void
    {
    ...
    {
        $version = \RectorPrefix20210102\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    private function canShowProgressBar(\RectorPrefix20210102\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
