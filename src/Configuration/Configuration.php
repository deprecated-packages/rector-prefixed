...
use _PhpScoperbd5d0c5f7638\Jean85\PrettyVersions;
...
final class Configuration
{
    ...
    public function __construct(\_PhpScoperbd5d0c5f7638\OndraM\CiDetector\CiDetector $ciDetector, \Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\_PhpScoperbd5d0c5f7638\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \_PhpScoperbd5d0c5f7638\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    private function canShowProgressBar(\_PhpScoperbd5d0c5f7638\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
