...
final class Configuration
{
     ...
     */
    public function resolveFromInput(\RectorPrefix20210506\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \RectorPrefix20210506\Jean85\PrettyVersions::getVersion('rector/rector-prefixed');
    ...
    private function canShowProgressBar(\RectorPrefix20210506\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function correctBashSpacePaths(array $commandLinePaths) : array
    {
        ...
        foreach ($commandLinePaths as $commandLinePath) {
            if (\RectorPrefix20210506\Nette\Utils\Strings::contains($commandLinePath, ' ')) {
