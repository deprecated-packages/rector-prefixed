...
use _PhpScoper006a73f0e455\Jean85\PrettyVersions;
...
final class Configuration
{
    ...
    public function __construct(\_PhpScoper006a73f0e455\OndraM\CiDetector\CiDetector $ciDetector, \Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \_PhpScoper006a73f0e455\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    private function canShowProgressBar(\_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
