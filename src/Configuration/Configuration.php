...
final class Configuration
{
    ...
    public function __construct(\RectorPrefix20210323\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\RectorPrefix20210323\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \RectorPrefix20210323\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    public function getMainConfigFilePath() : ?string
    {
        ...
        if (!$mainConfigFileInfo instanceof \RectorPrefix20210323\Symplify\SmartFileSystem\SmartFileInfo) {
            return null;
        }
        return $mainConfigFileInfo->getRelativeFilePathFromCwd();
    }
    private function canShowProgressBar(\RectorPrefix20210323\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function correctBashSpacePaths(array $commandLinePaths) : array
    {
        ...
        foreach ($commandLinePaths as $commandLinePath) {
            if (\RectorPrefix20210323\Nette\Utils\Strings::contains($commandLinePath, ' ')) {
