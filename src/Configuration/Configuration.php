...
final class Configuration
{
    ...
    public function __construct(\RectorPrefix20210226\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\RectorPrefix20210226\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \RectorPrefix20210226\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    public function getMainConfigFilePath() : ?string
    {
        ...
        if (!$mainConfigFileInfo instanceof \RectorPrefix20210226\Symplify\SmartFileSystem\SmartFileInfo) {
            return null;
        }
        return $mainConfigFileInfo->getRelativeFilePathFromCwd();
    }
    private function canShowProgressBar(\RectorPrefix20210226\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
