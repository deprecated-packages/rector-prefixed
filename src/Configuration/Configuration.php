...
final class Configuration
{
     ...
     */
    public function resolveFromInput(\RectorPrefix20210502\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \RectorPrefix20210502\Jean85\PrettyVersions::getVersion('rector/rector-prefixed');
    ...
    private function canShowProgressBar(\RectorPrefix20210502\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function correctBashSpacePaths(array $commandLinePaths) : array
    {
        ...
        foreach ($commandLinePaths as $commandLinePath) {
            if (\RectorPrefix20210502\Nette\Utils\Strings::contains($commandLinePath, ' ')) {
