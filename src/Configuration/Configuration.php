...
final class Configuration
{
    ...
    public function __construct(\RectorPrefix20201231\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\RectorPrefix20201231\Symfony\Component\Console\Input\InputInterface $input) : void
    {
     ...
     * @api
     */
    public function setFirstResolverConfigFileInfo(\RectorPrefix20201231\Symplify\SmartFileSystem\SmartFileInfo $firstResolvedConfigFileInfo) : void
    {
    ...
    {
        $version = \RectorPrefix20201231\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    private function canShowProgressBar(\RectorPrefix20201231\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
