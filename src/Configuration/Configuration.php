...
final class Configuration
{
     ...
     */
    public function resolveFromInput(\RectorPrefix20210315\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \RectorPrefix20210315\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    public function getMainConfigFilePath() : ?string
    {
        ...
        if (!$mainConfigFileInfo instanceof \RectorPrefix20210315\Symplify\SmartFileSystem\SmartFileInfo) {
            return null;
        }
        return $mainConfigFileInfo->getRelativeFilePathFromCwd();
    }
    private function canShowProgressBar(\RectorPrefix20210315\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
