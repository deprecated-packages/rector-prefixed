...
use _PhpScoper88fe6e0ad041\Jean85\PrettyVersions;
...
final class Configuration
{
    ...
    public function __construct(\_PhpScoper88fe6e0ad041\OndraM\CiDetector\CiDetector $ciDetector, \Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\_PhpScoper88fe6e0ad041\Symfony\Component\Console\Input\InputInterface $input) : void
    {
     ...
     * @api
     */
    public function setFirstResolverConfigFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $firstResolvedConfigFileInfo) : void
    {
    ...
    {
        $version = \_PhpScoper88fe6e0ad041\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    private function canShowProgressBar(\_PhpScoper88fe6e0ad041\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
