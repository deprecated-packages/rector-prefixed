...
final class Configuration
{
     ...
     */
    public function resolveFromInput(\RectorPrefix20210509\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    {
        $version = \RectorPrefix20210509\Jean85\PrettyVersions::getVersion('rector/rector-prefixed');
    ...
    private function correctBashSpacePaths(array $commandLinePaths) : array
    {
        ...
        foreach ($commandLinePaths as $commandLinePath) {
            if (\RectorPrefix20210509\Nette\Utils\Strings::contains($commandLinePath, ' ')) {
