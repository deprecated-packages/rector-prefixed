...
final class Configuration
{
    ...
    public function __construct(\RectorPrefix20210122\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\RectorPrefix20210122\Symfony\Component\Console\Input\InputInterface $input) : void
    {
     ...
     * @api
     */
    public function setFirstResolverConfigFileInfo(\RectorPrefix20210122\Symplify\SmartFileSystem\SmartFileInfo $firstResolvedConfigFileInfo) : void
    {
    ...
    {
        $version = \RectorPrefix20210122\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    private function canShowProgressBar(\RectorPrefix20210122\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
