...
final class Configuration
{
    ...
    public function __construct(\RectorPrefix20210121\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
     ...
     */
    public function resolveFromInput(\RectorPrefix20210121\Symfony\Component\Console\Input\InputInterface $input) : void
    {
     ...
     * @api
     */
    public function setFirstResolverConfigFileInfo(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $firstResolvedConfigFileInfo) : void
    {
    ...
    {
        $version = \RectorPrefix20210121\Jean85\PrettyVersions::getVersion('rector/rector');
    ...
    private function canShowProgressBar(\RectorPrefix20210121\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
