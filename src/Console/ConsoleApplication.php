...
final class ConsoleApplication extends \RectorPrefix20210318\Symfony\Component\Console\Application
{
    ...
    public function doRun(\RectorPrefix20210318\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20210318\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
    ...
    private function getNewWorkingDir(\RectorPrefix20210318\Symfony\Component\Console\Input\InputInterface $input) : string
    {
    ...
    private function shouldPrintMetaInformation(\RectorPrefix20210318\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function removeUnusedOptions(\RectorPrefix20210318\Symfony\Component\Console\Input\InputDefinition $inputDefinition) : void
    {
        $options = $inputDefinition->getOptions();
        unset($options['quiet'], $options['no-interaction']);
        $inputDefinition->setOptions($options);
    }
    private function addCustomOptions(\RectorPrefix20210318\Symfony\Component\Console\Input\InputDefinition $inputDefinition) : void
    {
