...
use RectorPrefix20210423\Composer\XdebugHandler\XdebugHandler;
...
final class ConsoleApplication extends \RectorPrefix20210423\Symfony\Component\Console\Application
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(\Rector\Core\Configuration\Configuration $configuration, \RectorPrefix20210423\Symplify\PackageBuilder\Console\Command\CommandNaming $commandNaming, array $commands = [])
    {
        try {
        ...
        $this->setDefaultCommand(\RectorPrefix20210423\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\Rector\Core\Console\Command\ProcessCommand::class));
    }
    public function doRun(\RectorPrefix20210423\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20210423\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        // @fixes https://github.com/rectorphp/rector/issues/2205
        $isXdebugAllowed = $input->hasParameterOption('--xdebug');
        if (!$isXdebugAllowed) {
            $xdebugHandler = new \RectorPrefix20210423\Composer\XdebugHandler\XdebugHandler('rector', '--ansi');
            $xdebugHandler->check();
            unset($xdebugHandler);
        }
    ...
    protected function getDefaultInputDefinition() : \RectorPrefix20210423\Symfony\Component\Console\Input\InputDefinition
    {
    ...
    private function getNewWorkingDir(\RectorPrefix20210423\Symfony\Component\Console\Input\InputInterface $input) : string
    {
    ...
    private function shouldPrintMetaInformation(\RectorPrefix20210423\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function addCustomOptions(\RectorPrefix20210423\Symfony\Component\Console\Input\InputDefinition $inputDefinition)
    {
        ...
        $inputDefinition->addOption(new \RectorPrefix20210423\Symfony\Component\Console\Input\InputOption(\Rector\Core\Configuration\Option::XDEBUG, null, \RectorPrefix20210423\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Allow running xdebug'));
        $inputDefinition->addOption(new \RectorPrefix20210423\Symfony\Component\Console\Input\InputOption(\Rector\Core\Configuration\Option::OPTION_CLEAR_CACHE, null, \RectorPrefix20210423\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Clear cache'));
        $inputDefinition->addOption(new \RectorPrefix20210423\Symfony\Component\Console\Input\InputOption('working-dir', null, \RectorPrefix20210423\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'If specified, use the given directory as working directory.'));
    }
