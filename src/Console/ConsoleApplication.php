...
use Throwable;
final class ConsoleApplication extends \_PhpScoperabd03f0baf05\Symfony\Component\Console\Application
{
    /**
     * @var string
     */
    ...
    public function doRun(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        // @fixes https://github.com/rectorphp/rector/issues/2205
        $isXdebugAllowed = $input->hasParameterOption('--xdebug');
        if (!$isXdebugAllowed) {
            $xdebugHandler = new \_PhpScoperabd03f0baf05\Composer\XdebugHandler\XdebugHandler('rector', '--ansi');
            $xdebugHandler->check();
            unset($xdebugHandler);
        }
    ...
    public function renderThrowable(\Throwable $throwable, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
    ...
    protected function getDefaultInputDefinition() : \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputDefinition
    {
    ...
    private function getNewWorkingDir(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputInterface $input) : string
    {
    ...
    private function shouldPrintMetaInformation(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function removeUnusedOptions(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputDefinition $inputDefinition) : void
    {
        $options = $inputDefinition->getOptions();
        unset($options['quiet'], $options['no-interaction']);
        $inputDefinition->setOptions($options);
    }
    private function addCustomOptions(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputDefinition $inputDefinition) : void
    {
        $inputDefinition->addOption(new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption(\Rector\Core\Configuration\Option::OPTION_CONFIG, 'c', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to config file', $this->getDefaultConfigPath()));
        $inputDefinition->addOption(new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption(\Rector\Core\Configuration\Option::OPTION_DEBUG, null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Enable debug verbosity (-vvv)'));
        $inputDefinition->addOption(new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption(\Rector\Core\Configuration\Option::XDEBUG, null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Allow running xdebug'));
        $inputDefinition->addOption(new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption(\Rector\Core\Configuration\Option::OPTION_CLEAR_CACHE, null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Clear cache'));
        $inputDefinition->addOption(new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('--working-dir', '-d', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'If specified, use the given directory as working directory.'));
    }
