...
abstract class AbstractCommand extends \RectorPrefix20201228\Symfony\Component\Console\Command\Command
{
    /**
     ...
     * @required
     */
    public function autowireAbstractCommand(\RectorPrefix20201228\Symfony\Component\Console\Descriptor\TextDescriptor $textDescriptor, \Rector\Caching\Detector\ChangedFilesDetector $changedFilesDetector) : void
    {
        $this->textDescriptor = $textDescriptor;
        $this->changedFilesDetector = $changedFilesDetector;
    }
    public function run(\RectorPrefix20201228\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20201228\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        try {
            ...
            if (\RectorPrefix20201228\Nette\Utils\Strings::contains($runtimeException->getMessage(), 'Not enough arguments')) {
    ...
    protected function initialize(\RectorPrefix20201228\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20201228\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
