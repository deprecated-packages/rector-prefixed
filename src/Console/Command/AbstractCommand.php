...
abstract class AbstractCommand extends \RectorPrefix20210108\Symfony\Component\Console\Command\Command
{
    /**
     ...
     * @required
     */
    public function autowireAbstractCommand(\RectorPrefix20210108\Symfony\Component\Console\Descriptor\TextDescriptor $textDescriptor, \Rector\Caching\Detector\ChangedFilesDetector $changedFilesDetector) : void
    {
        $this->textDescriptor = $textDescriptor;
        $this->changedFilesDetector = $changedFilesDetector;
    }
    public function run(\RectorPrefix20210108\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20210108\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        try {
            ...
            if (\RectorPrefix20210108\Nette\Utils\Strings::contains($runtimeException->getMessage(), 'Not enough arguments')) {
    ...
    protected function initialize(\RectorPrefix20210108\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20210108\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
