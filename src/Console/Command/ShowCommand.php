...
final class ShowCommand extends \Rector\Core\Console\Command\AbstractCommand
{
    ...
    public function __construct(\RectorPrefix20210120\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Rector\Core\Application\ActiveRectorsProvider $activeRectorsProvider, \RectorPrefix20210120\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    private function reportLoadedSets() : void
    {
        ...
        $setFilePaths = [];
        foreach ($sets as $set) {
            $setFileInfo = new \RectorPrefix20210120\Symplify\SmartFileSystem\SmartFileInfo($set);
