...
final class InitCommand extends \RectorPrefix20210507\Symfony\Component\Console\Command\Command
{
    /**
     * @var FileSystemGuard
     */
     ...
     */
    public function __construct(\RectorPrefix20210507\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard, \RectorPrefix20210507\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210507\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, array $templateResolvers)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(\Rector\Core\Configuration\Option::TEMPLATE_TYPE, null, \RectorPrefix20210507\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'A template type like default, nette, doctrine etc.', 'default');
    }
