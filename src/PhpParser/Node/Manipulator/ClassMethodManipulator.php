...
final class ClassMethodManipulator
{
    ...
    public function isParameterUsedInClassMethod(\_PhpScoper0a6b37af0871\PhpParser\Node\Param $param, \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        $isUsedDirectly = (bool) $this->betterNodeFinder->findFirst((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($param) : bool {
        ...
        $compactFuncCalls = $this->betterNodeFinder->find((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool {
    ...
    public function isNamedConstructor(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        if (!$this->nodeNameResolver->isName($classMethod, \_PhpScoper0a6b37af0871\Rector\Core\ValueObject\MethodName::CONSTRUCT)) {
            return \false;
        }
    ...
    public function hasParentMethodOrInterfaceMethod(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, ?string $methodName = null) : bool
    {
     ...
     */
    public function isStaticClassMethod(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
     ...
     */
    public function addMethodParameterIfMissing(\_PhpScoper0a6b37af0871\PhpParser\Node $node, string $type, array $possibleNames) : string
    {
        $classMethodNode = $node->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::METHOD_NODE);
        if (!$classMethodNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod) {
            // or null?
        ...
        $classMethodNode->params[] = new \_PhpScoper0a6b37af0871\PhpParser\Node\Param(new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable($paramName), null, new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($type));
        return $paramName;
    }
    public function isPropertyPromotion(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
     ...
     * @param string[] $possibleNames
     */
    private function resolveName(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, array $possibleNames) : string
    {
