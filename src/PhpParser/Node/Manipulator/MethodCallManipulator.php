...
final class MethodCallManipulator
{
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder, \_PhpScoper0a2ac50786fa\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScoper0a2ac50786fa\Rector\Defluent\NodeAnalyzer\FluentChainMethodCallNodeAnalyzer $fluentChainMethodCallNodeAnalyzer)
    {
     ...
     * @return string[]
     */
    public function findMethodCallNamesOnVariable(\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable $variable) : array
    {
     ...
     * @return MethodCall[]
     */
    public function findMethodCallsIncludingChain(\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\MethodCall $methodCall) : array
    {
        $chainMethodCalls = [];
        // 1. collect method chain call
        $currentMethodCallee = $methodCall->var;
        while ($currentMethodCallee instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\MethodCall) {
        ...
        if ($currentMethodCallee instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable) {
    ...
    public function findAssignToVariable(\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable $variable) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Assign
    {
        ...
        } while ($parentNode instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node && !$parentNode instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike);
        return null;
    }
    /**
     * @return MethodCall[]
     */
    public function findMethodCallsOnVariable(\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable $variable) : array
    {
        ...
        $variableName = $this->nodeNameResolver->getName($variable);
        return $this->betterNodeFinder->find((array) $classMethod->stmts, function (\_PhpScoper0a2ac50786fa\PhpParser\Node $node) use($variableName) : bool {
            ...
            if (!$callerNode instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable) {
                return \false;
            }
    ...
    private function findAssignToVariableName(\_PhpScoper0a2ac50786fa\PhpParser\Node $node, string $variableName) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        return $this->betterNodeFinder->findFirst($node, function (\_PhpScoper0a2ac50786fa\PhpParser\Node $node) use($variableName) : bool {
    ...
    private function resolvePreviousNodeInSameScope(\_PhpScoper0a2ac50786fa\PhpParser\Node $parentNode) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        if (!$parentNode instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike) {
            ...
            $previousStatement = $previousParentNode->getAttribute(\_PhpScoper0a2ac50786fa\Rector\NodeTypeResolver\Node\AttributeKey::PREVIOUS_STATEMENT);
