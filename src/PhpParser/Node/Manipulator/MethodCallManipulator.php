...
final class MethodCallManipulator
{
     ...
     * @return string[]
     */
    public function findMethodCallNamesOnVariable(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable $variable) : array
    {
     ...
     * @return MethodCall[]
     */
    public function findMethodCallsIncludingChain(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall $methodCall) : array
    {
        $chainMethodCalls = [];
        // 1. collect method chain call
        $currentMethodCallee = $methodCall->var;
        while ($currentMethodCallee instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall) {
        ...
        if ($currentMethodCallee instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable) {
    ...
    public function findAssignToVariable(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable $variable) : ?\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Assign
    {
        ...
        } while ($parentNode instanceof \_PhpScoperb75b35f52b74\PhpParser\Node && !$parentNode instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\FunctionLike);
        return null;
    }
    /**
     * @return MethodCall[]
     */
    public function findMethodCallsOnVariable(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable $variable) : array
    {
        ...
        $variableName = $this->nodeNameResolver->getName($variable);
        return $this->betterNodeFinder->find((array) $classMethod->stmts, function (\_PhpScoperb75b35f52b74\PhpParser\Node $node) use($variableName) : bool {
            ...
            if (!$callerNode instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable) {
                return \false;
            }
    ...
    private function findAssignToVariableName(\_PhpScoperb75b35f52b74\PhpParser\Node $node, string $variableName) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        return $this->betterNodeFinder->findFirst($node, function (\_PhpScoperb75b35f52b74\PhpParser\Node $node) use($variableName) : bool {
    ...
    private function resolvePreviousNodeInSameScope(\_PhpScoperb75b35f52b74\PhpParser\Node $parentNode) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        if (!$parentNode instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\FunctionLike) {
            ...
            $previousStatement = $previousParentNode->getAttribute(\_PhpScoperb75b35f52b74\Rector\NodeTypeResolver\Node\AttributeKey::PREVIOUS_STATEMENT);
