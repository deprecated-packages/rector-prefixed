...
use _PhpScoper0a6b37af0871\Rector\ReadWrite\NodeAnalyzer\ReadWritePropertyAnalyzer;
...
final class PropertyManipulator
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Node\Manipulator\AssignManipulator $assignManipulator, \_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder, \_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Printer\BetterStandardPrinter $betterStandardPrinter, \_PhpScoper0a6b37af0871\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScoper0a6b37af0871\Rector\SOLID\Guard\VariableToConstantGuard $variableToConstantGuard, \_PhpScoper0a6b37af0871\Rector\NodeCollector\NodeCollector\NodeRepository $nodeRepository, \_PhpScoper0a6b37af0871\Rector\ReadWrite\NodeAnalyzer\ReadWritePropertyAnalyzer $readWritePropertyAnalyzer)
    {
     ...
     */
    public function getPrivatePropertyFetches(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property $property) : array
    {
        ...
        $propertyFetches = $this->betterNodeFinder->find($nodesToSearch, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($singleProperty, $nodesToSearch) : bool {
            ...
            return \in_array($node->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::CLASS_NODE), $nodesToSearch, \true);
        });
        return $propertyFetches;
    }
    public function isPropertyUsedInReadContext(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property $property) : bool
    {
        ...
        if ($phpDocInfo !== null && $phpDocInfo->hasByType(\_PhpScoper0a6b37af0871\Rector\BetterPhpDocParser\ValueObject\PhpDocNode\JMS\SerializerTypeTagValueNode::class)) {
            return \true;
        }
        ...
        $classLike = $property->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::CLASS_NODE);
        return (bool) $this->betterNodeFinder->findFirst($classLike->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool {
            ...
            return $node->name instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr;
        });
    }
    public function isPropertyChangeable(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property $property) : bool
    {
     ...
     */
    private function isChangeableContext(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool
    {
        $parent = $node->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
        if ($parent instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\PreInc || $parent instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\PreDec || $parent instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\PostInc || $parent instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\PostDec) {
            $parent = $parent->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
        }
