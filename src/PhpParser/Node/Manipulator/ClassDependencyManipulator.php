...
final class ClassDependencyManipulator
{
    ...
    public function addConstructorDependency(\_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_ $class, string $name, ?\_PhpScoperb75b35f52b74\PHPStan\Type\Type $type) : void
    {
    ...
    public function addConstructorDependencyWithCustomAssign(\_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_ $class, string $name, ?\_PhpScoperb75b35f52b74\PHPStan\Type\Type $type, \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Assign $assign) : void
    {
        $constructorMethod = $class->getMethod(\_PhpScoperb75b35f52b74\Rector\Core\ValueObject\MethodName::CONSTRUCT);
        ...
        $constructorMethod = $this->nodeFactory->createPublicMethod(\_PhpScoperb75b35f52b74\Rector\Core\ValueObject\MethodName::CONSTRUCT);
        $this->classMethodAssignManipulator->addParameterAndAssignToMethod($constructorMethod, $name, $type, $assign);
     ...
     * @param Stmt[] $stmts
     */
    public function addStmtsToConstructorIfNotThereYet(\_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_ $class, array $stmts) : void
    {
        $classMethod = $class->getMethod(\_PhpScoperb75b35f52b74\Rector\Core\ValueObject\MethodName::CONSTRUCT);
        if ($classMethod === null) {
            $classMethod = $this->nodeFactory->createPublicMethod(\_PhpScoperb75b35f52b74\Rector\Core\ValueObject\MethodName::CONSTRUCT);
            // keep parent constructor call
            if ($this->hasClassParentClassMethod($class, \_PhpScoperb75b35f52b74\Rector\Core\ValueObject\MethodName::CONSTRUCT)) {
                $classMethod->stmts[] = $this->createParentClassMethodCall(\_PhpScoperb75b35f52b74\Rector\Core\ValueObject\MethodName::CONSTRUCT);
            }
    ...
    public function addInjectProperty(\_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_ $class, string $propertyName, ?\_PhpScoperb75b35f52b74\PHPStan\Type\Type $propertyType) : void
    {
    ...
    private function isPropertyAlreadyAvailableInTheClassOrItsParents(\_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_ $class, string $propertyName) : bool
    {
    ...
    private function hasClassParentClassMethod(\_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_ $class, string $methodName) : bool
    {
    ...
    private function createParentClassMethodCall(string $methodName) : \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Expression
    {
        $staticCall = new \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\StaticCall(new \_PhpScoperb75b35f52b74\PhpParser\Node\Name('parent'), $methodName);
        return new \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Expression($staticCall);
    }
    /**
