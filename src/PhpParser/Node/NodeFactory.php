...
use RectorPrefix20210421\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder;
/**
...
final class NodeFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210421\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder($name);
    ...
    {
        $paramBuilder = new \RectorPrefix20210421\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($propertyMetadata->getName());
