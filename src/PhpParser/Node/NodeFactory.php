...
use RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder;
use RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder;
/**
...
final class NodeFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder($name);
        $methodBuilder->makePublic();
        return $methodBuilder->getNode();
    }
    public function createParamFromNameAndType(string $name, ?\PHPStan\Type\Type $type) : \PhpParser\Node\Param
    {
        $paramBuilder = new \RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($name);
        if ($type !== null) {
    ...
    {
        $propertyBuilder = new \RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder($name);
    ...
    {
        $methodBuilder = new \RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('get' . \ucfirst($propertyName));
        $methodBuilder->makePublic();
    ...
    {
        $methodBuilder = new \RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('set' . \ucfirst($propertyName));
        $methodBuilder->makePublic();
        $variable = new \PhpParser\Node\Expr\Variable($propertyName);
    ...
    {
        $paramBuilder = new \RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($propertyMetadata->getName());
