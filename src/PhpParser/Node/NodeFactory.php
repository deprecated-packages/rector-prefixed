...
use RectorPrefix20210423\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder;
/**
...
final class NodeFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210423\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder($name);
    ...
    {
        $paramBuilder = new \RectorPrefix20210423\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($name);
        if ($type !== null) {
    ...
    {
        $propertyBuilder = new \RectorPrefix20210423\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder($name);
    ...
    {
        $paramBuilder = new \RectorPrefix20210423\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($propertyMetadata->getName());
