...
use RectorPrefix20210502\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder;
/**
...
final class NodeFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210502\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder($name);
        $methodBuilder->makePublic();
        return $methodBuilder->getNode();
    }
    public function createParamFromNameAndType(string $name, ?\PHPStan\Type\Type $type) : \PhpParser\Node\Param
    {
        $paramBuilder = new \RectorPrefix20210502\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($name);
        if ($type !== null) {
    ...
    {
        $propertyBuilder = new \RectorPrefix20210502\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder($name);
    ...
    {
        $paramBuilder = new \RectorPrefix20210502\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($propertyMetadata->getName());
