...
final class NodeFactory
{
     ...
     */
    public function createParamFromNameAndType(string $name, $type): Param
    {
     ...
     * @param \PHPStan\Type\Type|null $type
     */
    public function createPublicInjectPropertyFromNameAndType(string $name, $type): Property
    {
     ...
     * @param \PHPStan\Type\Type|null $type
     */
    public function createPrivatePropertyFromNameAndType(string $name, $type): Property
    {
        $propertyBuilder = new PropertyBuilder($name);
     ...
     */
    public function createGetterClassMethodFromNameAndType(string $propertyName, $typeNode): ClassMethod
    {
...
//        return new StaticCall($class, $method, $args);
     ...
     * @return void
     */
    private function addPropertyType(Property $property, $type)
    {
        if ($type === null) {
            return;
        }
     ...
     * @return void
     */
    private function decoreateArrayItemWithKey($key, ArrayItem $arrayItem)
    {
        if ($key !== null) {
