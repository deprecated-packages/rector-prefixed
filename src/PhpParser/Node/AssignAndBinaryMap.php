...
final class AssignAndBinaryMap
{
     ...
     */
    const BINARY_OP_TO_INVERSE_CLASSES = [
     ...
     */
    const ASSIGN_OP_TO_BINARY_OP_CLASSES = [
     ...
     * @return string|null
     */
    public function getAlternative(Node $node)
    {
     ...
     * @return string|null
     */
    public function getInversed(BinaryOp $binaryOp)
    {
