...
final class BetterNodeFinder
{
    ...
    {
        \RectorPrefix20210113\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20210113\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
        /** @var Node|null $parent */
        $parent = $node->getAttribute(\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
        if ($parent === null) {
            return null;
