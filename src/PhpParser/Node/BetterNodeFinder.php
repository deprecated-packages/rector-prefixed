...
final class BetterNodeFinder
{
    ...
    public function findFirstParentInstanceOf(\PhpParser\Node $node, $type) : ?\PhpParser\Node
    {
        ...
        \_PhpScoper50d83356d739\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
    ...
    {
        \_PhpScoper50d83356d739\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
