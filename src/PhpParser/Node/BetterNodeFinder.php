...
final class BetterNodeFinder
{
    ...
    public function findFirstParentInstanceOf(\PhpParser\Node $node, $type) : ?\PhpParser\Node
    {
        ...
        \_PhpScoper5b8c9e9ebd21\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
    ...
    {
        \_PhpScoper5b8c9e9ebd21\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
