...
final class BetterNodeFinder
{
    ...
    public function findFirstParentInstanceOf(\PhpParser\Node $node, $type) : ?\PhpParser\Node
    {
        ...
        \RectorPrefix20210105\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20210105\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
