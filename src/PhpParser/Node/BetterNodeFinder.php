...
final class BetterNodeFinder
{
    ...
    public function findFirstParentInstanceOf(\PhpParser\Node $node, $type) : ?\PhpParser\Node
    {
        ...
        \RectorPrefix20201227\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20201227\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
