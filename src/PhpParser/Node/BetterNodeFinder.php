...
final class BetterNodeFinder
{
    ...
    public function findFirstParentInstanceOf(\PhpParser\Node $node, $type) : ?\PhpParser\Node
    {
        ...
        \_PhpScoper006a73f0e455\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
    ...
    {
        \_PhpScoper006a73f0e455\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
