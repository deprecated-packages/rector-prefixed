...
final class BetterNodeFinder
{
    ...
    public function findFirstParentInstanceOf(\PhpParser\Node $node, $type) : ?\PhpParser\Node
    {
        ...
        \_PhpScoper5edc98a7cce2\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
    ...
    {
        \_PhpScoper5edc98a7cce2\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
