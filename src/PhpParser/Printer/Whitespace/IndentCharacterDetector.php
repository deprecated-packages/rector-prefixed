...
final class IndentCharacterDetector
{
    ...
    public function detect(array $stmts) : string
    {
        foreach ($stmts as $stmt) {
            ...
            $whitespaces = \count(\RectorPrefix20210224\Nette\Utils\Strings::matchAll($fileInfo->getContents(), self::FOUR_SPACE_START_REGEX));
            $tabs = \count(\RectorPrefix20210224\Nette\Utils\Strings::matchAll($fileInfo->getContents(), '#^\\t#m'));
            // tab vs space
