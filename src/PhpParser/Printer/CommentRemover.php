...
final class CommentRemover
{
    ...
    {
        // remove /** ... */
        $content = \RectorPrefix20210111\Nette\Utils\Strings::replace($content, self::START_COMMENT_REGEX, '');
        // remove /* ... */
        $content = \RectorPrefix20210111\Nette\Utils\Strings::replace($content, self::START_COMMENT_REGEX, '');
        // remove # ...
        $content = \RectorPrefix20210111\Nette\Utils\Strings::replace($content, self::START_GRID_COMMENT_REGEX, '');
        // remove // ...
        return \RectorPrefix20210111\Nette\Utils\Strings::replace($content, self::START_DOUBLE_SLASH_COMMENT_REGEX, '');
    }
}
