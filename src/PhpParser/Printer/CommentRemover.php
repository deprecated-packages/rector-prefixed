...
final class CommentRemover
{
    ...
    {
        // remove /** ... */
        $content = \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($content, self::START_COMMENT_REGEX);
        // remove /* ... */
        $content = \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($content, self::START_COMMENT_REGEX);
        // remove # ...
        $content = \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($content, self::START_GRID_COMMENT_REGEX);
        // remove // ...
        return \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($content, self::START_DOUBLE_SLASH_COMMENT_REGEX);
    }
}
