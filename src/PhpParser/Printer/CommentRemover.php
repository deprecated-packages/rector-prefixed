...
final class CommentRemover
{
    ...
    {
        // remove /** ... */
        $content = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($content, self::START_COMMENT_REGEX, '');
        // remove /* ... */
        $content = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($content, self::START_COMMENT_REGEX, '');
        // remove # ...
        $content = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($content, self::START_GRID_COMMENT_REGEX, '');
        // remove // ...
        return \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($content, self::START_DOUBLE_SLASH_COMMENT_REGEX, '');
    }
}
