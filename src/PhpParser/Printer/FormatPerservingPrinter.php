...
final class FormatPerservingPrinter
{
    ...
    public function __construct(\Rector\Core\PhpParser\Printer\BetterStandardPrinter $betterStandardPrinter, \RectorPrefix20210120\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
     ...
     */
    public function printToFile(\RectorPrefix20210120\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, array $newStmts, array $oldStmts, array $oldTokens) : string
    {
    ...
    public function printParsedStmstAndTokens(\RectorPrefix20210120\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, \Rector\Core\ValueObject\Application\ParsedStmtsAndTokens $parsedStmtsAndTokens) : string
    {
