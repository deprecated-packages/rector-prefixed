...
final class Parser
{
    ...
    public function __construct(\PhpParser\Parser $nikicParser, \RectorPrefix20210221\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
     ...
     * @return Node[]
     */
    public function parseFileInfo(\RectorPrefix20210221\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
