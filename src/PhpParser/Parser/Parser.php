...
final class Parser
{
    ...
    public function __construct(\PhpParser\Parser $nikicParser, \RectorPrefix20210420\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
     ...
     * @return Stmt[]
     */
    public function parseFileInfo(\RectorPrefix20210420\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
