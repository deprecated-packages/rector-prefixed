...
final class FunctionLikeParser
{
     ...
     */
    private $nodeFinder;
    public function __construct(\PhpParser\Parser $parser, \RectorPrefix20210224\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \PhpParser\NodeFinder $nodeFinder)
    {
        $this->parser = $parser;
