...
final class FunctionLikeParser
{
    ...
    public function __construct(\PhpParser\Parser $parser, \RectorPrefix20210316\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \PhpParser\NodeFinder $nodeFinder, \Rector\NodeTypeResolver\NodeScopeAndMetadataDecorator $nodeScopeAndMetadataDecorator)
    {
        $this->parser = $parser;
    ...
    public function parseMethodReflection(\PHPStan\Reflection\MethodReflection $methodReflection) : ?\PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $nodes = $this->nodeScopeAndMetadataDecorator->decorateNodesFromFile($nodes, new \RectorPrefix20210316\Symplify\SmartFileSystem\SmartFileInfo($fileName));
