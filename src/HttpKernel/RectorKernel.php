...
use _PhpScoper267b3276efc2\Symfony\Component\Config\Loader\GlobFileLoader;
...
final class RectorKernel extends \_PhpScoper267b3276efc2\Symfony\Component\HttpKernel\Kernel implements \Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    protected function build(\_PhpScoper267b3276efc2\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
     ...
     */
    protected function getContainerLoader(\_PhpScoper267b3276efc2\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper267b3276efc2\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \_PhpScoper267b3276efc2\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \_PhpScoper267b3276efc2\Symfony\Component\Config\Loader\LoaderResolver([new \_PhpScoper267b3276efc2\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \_PhpScoper267b3276efc2\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
