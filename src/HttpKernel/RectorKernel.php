...
use _PhpScoper5edc98a7cce2\Symfony\Component\Config\Loader\GlobFileLoader;
use _PhpScoper5edc98a7cce2\Symfony\Component\Config\Loader\LoaderInterface;
...
final class RectorKernel extends \_PhpScoper5edc98a7cce2\Symfony\Component\HttpKernel\Kernel implements \Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    public function registerContainerConfiguration(\_PhpScoper5edc98a7cce2\Symfony\Component\Config\Loader\LoaderInterface $loader) : void
    {
    ...
    protected function build(\_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
     ...
     */
    protected function getContainerLoader(\_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper5edc98a7cce2\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \_PhpScoper5edc98a7cce2\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \_PhpScoper5edc98a7cce2\Symfony\Component\Config\Loader\LoaderResolver([new \_PhpScoper5edc98a7cce2\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \_PhpScoper5edc98a7cce2\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
