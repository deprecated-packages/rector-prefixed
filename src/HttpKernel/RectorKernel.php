...
use RectorPrefix20210506\Symfony\Component\Config\Loader\GlobFileLoader;
...
use RectorPrefix20210506\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
use RectorPrefix20210506\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle;
use RectorPrefix20210506\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
use RectorPrefix20210506\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20210506\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle;
...
final class RectorKernel extends \RectorPrefix20210506\Symfony\Component\HttpKernel\Kernel
{
    ...
    {
        return [new \RectorPrefix20210506\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \RectorPrefix20210506\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle(), new \RectorPrefix20210506\Symplify\Skipper\Bundle\SkipperBundle(), new \RectorPrefix20210506\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle()];
    }
    protected function build(\RectorPrefix20210506\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        ...
        $containerBuilder->addCompilerPass(new \RectorPrefix20210506\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass());
        // autowire Rectors by default (mainly for tests)
        $containerBuilder->addCompilerPass(new \RectorPrefix20210506\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]));
     ...
     */
    protected function getContainerLoader(\RectorPrefix20210506\Symfony\Component\DependencyInjection\ContainerInterface $container) : \RectorPrefix20210506\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \RectorPrefix20210506\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \RectorPrefix20210506\Symfony\Component\Config\Loader\LoaderResolver([new \RectorPrefix20210506\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \RectorPrefix20210506\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
