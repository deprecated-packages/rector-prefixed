...
use RectorPrefix20210406\Symfony\Component\Config\Loader\GlobFileLoader;
...
use RectorPrefix20210406\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
use RectorPrefix20210406\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface;
use RectorPrefix20210406\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20210406\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle;
use RectorPrefix20210406\Symplify\Skipper\Bundle\SkipperBundle;
/**
 * @todo possibly remove symfony/http-kernel and use the container build only
 */
final class RectorKernel extends \RectorPrefix20210406\Symfony\Component\HttpKernel\Kernel implements \RectorPrefix20210406\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \RectorPrefix20210406\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \RectorPrefix20210406\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle(), new \RectorPrefix20210406\Symplify\Skipper\Bundle\SkipperBundle(), new \RectorPrefix20210406\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle()];
    }
    protected function build(\RectorPrefix20210406\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        ...
        $containerBuilder->addCompilerPass(new \RectorPrefix20210406\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]));
     ...
     */
    protected function getContainerLoader(\RectorPrefix20210406\Symfony\Component\DependencyInjection\ContainerInterface $container) : \RectorPrefix20210406\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \RectorPrefix20210406\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \RectorPrefix20210406\Symfony\Component\Config\Loader\LoaderResolver([new \RectorPrefix20210406\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \RectorPrefix20210406\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
