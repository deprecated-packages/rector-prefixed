...
use _PhpScoper5b8c9e9ebd21\Symfony\Component\Config\Loader\GlobFileLoader;
...
final class RectorKernel extends \_PhpScoper5b8c9e9ebd21\Symfony\Component\HttpKernel\Kernel implements \Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    protected function build(\_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
     ...
     */
    protected function getContainerLoader(\_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper5b8c9e9ebd21\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \_PhpScoper5b8c9e9ebd21\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \_PhpScoper5b8c9e9ebd21\Symfony\Component\Config\Loader\LoaderResolver([new \_PhpScoper5b8c9e9ebd21\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \_PhpScoper5b8c9e9ebd21\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
