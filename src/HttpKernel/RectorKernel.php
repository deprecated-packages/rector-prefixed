...
use RectorPrefix20210423\Symfony\Component\Config\Loader\GlobFileLoader;
...
use RectorPrefix20210423\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle;
use RectorPrefix20210423\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
use RectorPrefix20210423\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20210423\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle;
use RectorPrefix20210423\Symplify\Skipper\Bundle\SkipperBundle;
 ...
 */
final class RectorKernel extends \RectorPrefix20210423\Symfony\Component\HttpKernel\Kernel
{
    /**
     * @var SmartFileInfo[]
     */
    ...
    {
        return [new \RectorPrefix20210423\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \RectorPrefix20210423\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle(), new \RectorPrefix20210423\Symplify\Skipper\Bundle\SkipperBundle(), new \RectorPrefix20210423\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle()];
    }
    protected function build(\RectorPrefix20210423\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        ...
        $containerBuilder->addCompilerPass(new \RectorPrefix20210423\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]));
     ...
     */
    protected function getContainerLoader(\RectorPrefix20210423\Symfony\Component\DependencyInjection\ContainerInterface $container) : \RectorPrefix20210423\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \RectorPrefix20210423\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \RectorPrefix20210423\Symfony\Component\Config\Loader\LoaderResolver([new \RectorPrefix20210423\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \RectorPrefix20210423\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
