 ...
 */
final class RectorKernel extends \RectorPrefix20210319\Symfony\Component\HttpKernel\Kernel implements \RectorPrefix20210319\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \RectorPrefix20210319\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \RectorPrefix20210319\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle(), new \RectorPrefix20210319\Symplify\Skipper\Bundle\SkipperBundle(), new \RectorPrefix20210319\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle()];
    }
     ...
     */
    protected function getContainerLoader(\RectorPrefix20210319\Symfony\Component\DependencyInjection\ContainerInterface $container) : \RectorPrefix20210319\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \RectorPrefix20210319\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \RectorPrefix20210319\Symfony\Component\Config\Loader\LoaderResolver([new \RectorPrefix20210319\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \RectorPrefix20210319\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
