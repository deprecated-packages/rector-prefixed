...
use _PhpScoperfce0de0de1ce\Symfony\Component\Config\Loader\GlobFileLoader;
...
final class RectorKernel extends \_PhpScoperfce0de0de1ce\Symfony\Component\HttpKernel\Kernel implements \Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    protected function build(\_PhpScoperfce0de0de1ce\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
     ...
     */
    protected function getContainerLoader(\_PhpScoperfce0de0de1ce\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoperfce0de0de1ce\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \_PhpScoperfce0de0de1ce\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \_PhpScoperfce0de0de1ce\Symfony\Component\Config\Loader\LoaderResolver([new \_PhpScoperfce0de0de1ce\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \_PhpScoperfce0de0de1ce\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
