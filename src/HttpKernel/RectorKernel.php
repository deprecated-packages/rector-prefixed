...
use RectorPrefix20210502\Symfony\Component\Config\Loader\GlobFileLoader;
...
use RectorPrefix20210502\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
use RectorPrefix20210502\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle;
use RectorPrefix20210502\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
 ...
 */
final class RectorKernel extends \RectorPrefix20210502\Symfony\Component\HttpKernel\Kernel
{
    /**
     * @var SmartFileInfo[]
     */
    ...
    {
        return [new \RectorPrefix20210502\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \RectorPrefix20210502\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle(), new \RectorPrefix20210502\Symplify\Skipper\Bundle\SkipperBundle(), new \RectorPrefix20210502\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle()];
    }
    protected function build(\RectorPrefix20210502\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
     ...
     */
    protected function getContainerLoader(\RectorPrefix20210502\Symfony\Component\DependencyInjection\ContainerInterface $container) : \RectorPrefix20210502\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \RectorPrefix20210502\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \RectorPrefix20210502\Symfony\Component\Config\Loader\LoaderResolver([new \RectorPrefix20210502\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \RectorPrefix20210502\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
