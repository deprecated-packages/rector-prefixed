...
namespace _PhpScoper0a2ac50786fa\Rector\Core\ValueObject\Reporting;
...
final class FileDiff
{
     ...
     */
    public function __construct(\_PhpScoper0a2ac50786fa\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $diff, string $diffConsoleFormatted, array $rectorWithFileAndLineChanges = [])
    {
