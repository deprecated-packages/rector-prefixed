...
final class FileDiff
{
     ...
     */
    public function __construct(\RectorPrefix20210419\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $diff, string $diffConsoleFormatted, array $rectorWithLineChanges = [])
    {
