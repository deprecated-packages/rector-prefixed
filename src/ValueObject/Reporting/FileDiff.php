...
final class FileDiff
{
     ...
     */
    public function __construct(\RectorPrefix20210318\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $diff, string $diffConsoleFormatted, array $rectorWithFileAndLineChanges = [])
    {
