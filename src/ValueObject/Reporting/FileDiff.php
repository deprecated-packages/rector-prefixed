...
final class FileDiff
{
     ...
     */
    public function __construct(\RectorPrefix20210418\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $diff, string $diffConsoleFormatted, array $rectorWithLineChanges = [])
    {
