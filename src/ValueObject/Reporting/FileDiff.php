...
final class FileDiff
{
     ...
     */
    public function __construct(\RectorPrefix20210424\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $diff, string $diffConsoleFormatted, array $rectorWithLineChanges = [])
    {
