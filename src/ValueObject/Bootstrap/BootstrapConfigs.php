...
final class BootstrapConfigs
{
     ...
     */
    public function __construct(?\RectorPrefix20210221\Symplify\SmartFileSystem\SmartFileInfo $mainConfigFileInfo, array $setConfigFileInfos)
    {
        $this->mainConfigFileInfo = $mainConfigFileInfo;
        $this->setConfigFileInfos = $setConfigFileInfos;
    }
    public function getMainConfigFileInfo() : ?\RectorPrefix20210221\Symplify\SmartFileSystem\SmartFileInfo
    {
