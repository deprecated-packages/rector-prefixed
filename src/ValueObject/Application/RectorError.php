...
final class RectorError
{
     ...
     */
    private $rectorClass;
    public function __construct(\RectorPrefix20210323\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $message, ?int $line = null, ?string $rectorClass = null)
    {
