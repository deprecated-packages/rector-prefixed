...
final class File
{
    ...
    public function __construct(\RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $fileContent)
    {
        $this->smartFileInfo = $smartFileInfo;
        $this->fileContent = $fileContent;
        $this->originalFileContent = $fileContent;
    }
    public function getSmartFileInfo() : \RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo
    {
