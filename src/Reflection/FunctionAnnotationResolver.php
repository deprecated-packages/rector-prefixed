...
use _PhpScoper0a6b37af0871\Rector\Core\PhpParser\Parser\FunctionParser;
...
final class FunctionAnnotationResolver
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\CodingStyle\Naming\ClassNaming $classNaming, \_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Parser\FunctionParser $functionParser, \_PhpScoper0a6b37af0871\Rector\Core\PhpDoc\PhpDocTagsFinder $phpDocTagsFinder)
    {
     ...
     * @return string[]
     */
    private function getUses(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Namespace_ $namespace) : array
    {
        $uses = [];
        foreach ($namespace->stmts as $stmt) {
            ...
            $use = $stmt->uses[0];
            if (!$use instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\UseUse) {
                continue;
            }
