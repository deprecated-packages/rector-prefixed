...
class FunctionLikeReflectionParser
{
    ...
    public function __construct(\PhpParser\Parser $parser, \RectorPrefix20210424\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \PhpParser\NodeFinder $nodeFinder, \Rector\NodeTypeResolver\NodeScopeAndMetadataDecorator $nodeScopeAndMetadataDecorator)
    {
        $this->parser = $parser;
    ...
    public function parseMethodReflection(\PHPStan\Reflection\MethodReflection $methodReflection) : ?\PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $smartFileInfo = new \RectorPrefix20210424\Symplify\SmartFileSystem\SmartFileInfo($fileName);
