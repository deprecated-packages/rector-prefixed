...
final class ClassReflectionToAstResolver
{
    ...
    public function __construct(\PhpParser\Parser $parser, \RectorPrefix20210210\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder)
    {
        $this->parser = $parser;
