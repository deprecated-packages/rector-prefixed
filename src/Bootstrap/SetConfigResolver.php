...
final class SetConfigResolver
{
     ...
     */
    public function resolve(\RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
    ...
    private function wrapToFileInfos(array $sets) : array
    {
        $setFileInfos = [];
        foreach ($sets as $set) {
            $setFileInfos[] = new \RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo($set);
        }
        return $setFileInfos;
    }
}
