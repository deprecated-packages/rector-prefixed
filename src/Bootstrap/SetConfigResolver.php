...
final class SetConfigResolver
{
     ...
     */
    public function resolve(\RectorPrefix20210417\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
    ...
    private function wrapToFileInfos(array $sets) : array
    {
        $setFileInfos = [];
        foreach ($sets as $set) {
            $setFileInfos[] = new \RectorPrefix20210417\Symplify\SmartFileSystem\SmartFileInfo($set);
        }
        return $setFileInfos;
    }
}
