...
use RectorPrefix20210215\Symplify\SetConfigResolver\ConfigResolver;
...
final class RectorConfigsResolver
{
    ...
    {
        $this->configResolver = new \RectorPrefix20210215\Symplify\SetConfigResolver\ConfigResolver();
        $rectorSetProvider = new \Rector\Set\RectorSetProvider();
        $this->setAwareConfigResolver = new \RectorPrefix20210215\Symplify\SetConfigResolver\SetAwareConfigResolver($rectorSetProvider);
    }
    /**
     * @return SmartFileInfo[]
     */
    public function resolveFromConfigFileInfo(\RectorPrefix20210215\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
     ...
     * @noRector
     */
    public function getFirstResolvedConfig() : ?\RectorPrefix20210215\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    public function provide() : array
    {
        ...
        if (\in_array($argvInput->getFirstArgument(), ['generate', 'g', 'create', 'c'], \true)) {
            ...
            if (\file_exists($rectorRecipeFilePath)) {
                $configFileInfos[] = new \RectorPrefix20210215\Symplify\SmartFileSystem\SmartFileInfo($rectorRecipeFilePath);
            }
        }
