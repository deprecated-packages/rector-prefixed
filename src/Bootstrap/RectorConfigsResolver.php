...
use RectorPrefix20210422\Symplify\SetConfigResolver\ConfigResolver;
...
final class RectorConfigsResolver
{
     ...
     */
    public function resolveFromConfigFileInfo(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
    ...
    public function provide() : \Rector\Core\ValueObject\Bootstrap\BootstrapConfigs
    {
        ...
        $configFileInfos = $mainConfigFileInfo instanceof \RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo ? $this->resolveFromConfigFileInfo($mainConfigFileInfo) : [];
     ...
     * @return SmartFileInfo[]
     */
    private function appendRectorRecipeConfig(\RectorPrefix20210422\Symfony\Component\Console\Input\ArgvInput $argvInput, array $configFileInfos) : array
    {
        ...
        if (\file_exists($rectorRecipeFilePath)) {
            $configFileInfos[] = new \RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo($rectorRecipeFilePath);
        }
        return $configFileInfos;
    }
}
