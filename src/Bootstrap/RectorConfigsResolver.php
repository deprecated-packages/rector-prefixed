...
use RectorPrefix20210508\Symplify\SetConfigResolver\ConfigResolver;
...
final class RectorConfigsResolver
{
    ...
    public function __construct()
    {
        ...
        $this->configResolver = new \RectorPrefix20210508\Symplify\SetConfigResolver\ConfigResolver();
    }
    /**
     ...
     * @return SmartFileInfo[]
     */
    private function appendRectorRecipeConfig(\RectorPrefix20210508\Symfony\Component\Console\Input\ArgvInput $argvInput, array $configFileInfos) : array
    {
