...
final class RectorConfigsResolver
{
    ...
    public function __construct()
    {
        ...
        $this->configResolver = new \RectorPrefix20210502\Symplify\SetConfigResolver\ConfigResolver();
    }
    /**
     ...
     * @return SmartFileInfo[]
     */
    private function appendRectorRecipeConfig(\RectorPrefix20210502\Symfony\Component\Console\Input\ArgvInput $argvInput, array $configFileInfos) : array
    {
