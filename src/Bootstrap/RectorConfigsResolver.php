...
use RectorPrefix20210416\Symplify\SetConfigResolver\ConfigResolver;
...
final class RectorConfigsResolver
{
     ...
     */
    public function resolveFromConfigFileInfo(\RectorPrefix20210416\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
     ...
     * @return SmartFileInfo[]
     */
    private function appendRectorRecipeConfig(\RectorPrefix20210416\Symfony\Component\Console\Input\ArgvInput $argvInput, array $configFileInfos) : array
    {
        ...
        if (\file_exists($rectorRecipeFilePath)) {
            $configFileInfos[] = new \RectorPrefix20210416\Symplify\SmartFileSystem\SmartFileInfo($rectorRecipeFilePath);
        }
        return $configFileInfos;
    }
}
