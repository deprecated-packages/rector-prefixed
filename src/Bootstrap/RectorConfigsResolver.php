...
use RectorPrefix20210209\Symplify\SetConfigResolver\ConfigResolver;
...
final class RectorConfigsResolver
{
     ...
     * @noRector
     */
    public function getFirstResolvedConfig() : ?\RectorPrefix20210209\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    public function provide() : array
    {
        ...
        if (\in_array($argvInput->getFirstArgument(), ['generate', 'g', 'create', 'c'], \true)) {
            ...
            if (\file_exists($rectorRecipeFilePath)) {
                $configFileInfos[] = new \RectorPrefix20210209\Symplify\SmartFileSystem\SmartFileInfo($rectorRecipeFilePath);
            }
        }
