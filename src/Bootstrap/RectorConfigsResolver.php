...
use RectorPrefix20210507\Symplify\SetConfigResolver\ConfigResolver;
...
final class RectorConfigsResolver
{
    ...
    public function __construct()
    {
        ...
        $this->configResolver = new \RectorPrefix20210507\Symplify\SetConfigResolver\ConfigResolver();
    }
    /**
     ...
     * @return SmartFileInfo[]
     */
    private function appendRectorRecipeConfig(\RectorPrefix20210507\Symfony\Component\Console\Input\ArgvInput $argvInput, array $configFileInfos) : array
    {
