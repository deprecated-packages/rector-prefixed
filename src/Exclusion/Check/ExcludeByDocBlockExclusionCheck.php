...
namespace _PhpScoper0a6b37af0871\Rector\Core\Exclusion\Check;
 ...
 */
final class ExcludeByDocBlockExclusionCheck implements \_PhpScoper0a6b37af0871\Rector\Core\Contract\Exclusion\ExclusionCheckInterface
{
    public function isNodeSkippedByRector(\_PhpScoper0a6b37af0871\Rector\Core\Contract\Rector\PhpRectorInterface $phpRector, \_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool
    {
        if ($node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\PropertyProperty || $node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Const_) {
        ...
        if (!$node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt && $parentNode !== null) {
            return $this->isNodeSkippedByRector($phpRector, $parentNode);
        }
        return \false;
    }
    private function hasNoRectorPhpDocTagMatch(\_PhpScoper0a6b37af0871\PhpParser\Node $node, \_PhpScoper0a6b37af0871\Rector\Core\Contract\Rector\PhpRectorInterface $phpRector) : bool
    {
        ...
        foreach ($noRectorTags as $noRectorTag) {
            if ($noRectorTag->value instanceof \_PhpScoper0a6b37af0871\PHPStan\PhpDocParser\Ast\PhpDoc\GenericTagValueNode) {
