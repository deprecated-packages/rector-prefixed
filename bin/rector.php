...
$autoloadIncluder = new \RectorPrefix20210317\AutoloadIncluder();
...
} catch (\RectorPrefix20210317\Symplify\SetConfigResolver\Exception\SetNotFoundException $setNotFoundException) {
    $invalidSetReporter = new \RectorPrefix20210317\Symplify\SetConfigResolver\Bootstrap\InvalidSetReporter();
...
\class_alias('RectorPrefix20210317\\AutoloadIncluder', 'AutoloadIncluder', \false);
