...
$autoloadIncluder = new \RectorPrefix20210507\AutoloadIncluder();
...
} elseif (\RectorPrefix20210507\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210507\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210507\\AutoloadIncluder', 'AutoloadIncluder', \false);
