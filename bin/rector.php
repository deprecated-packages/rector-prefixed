...
use RectorPrefix20210331\Symplify\SetConfigResolver\Bootstrap\InvalidSetReporter;
use RectorPrefix20210331\Symplify\SetConfigResolver\Exception\SetNotFoundException;
use RectorPrefix20210331\Tracy\Debugger;
...
$autoloadIncluder = new \RectorPrefix20210331\AutoloadIncluder();
$autoloadIncluder->includeDependencyOrRepositoryVendorAutoloadIfExists();
$autoloadIncluder->loadIfExistsAndNotLoadedYet(__DIR__ . '/../vendor/scoper-autoload.php');
$autoloadIncluder->autoloadProjectAutoloaderFile();
$autoloadIncluder->autoloadFromCommandLine();
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210331\Symplify\PackageBuilder\Reflection\PrivatesCaller());
$symfonyStyle = $symfonyStyleFactory->create();
$rectorConfigsResolver = new \Rector\Core\Bootstrap\RectorConfigsResolver();
// for simpler debugging output
if (\class_exists(\RectorPrefix20210331\Tracy\Debugger::class)) {
    \RectorPrefix20210331\Tracy\Debugger::$maxDepth = 2;
}
try {
    $bootstrapConfigs = $rectorConfigsResolver->provide();
    $rectorContainerFactory = new \Rector\Core\DependencyInjection\RectorContainerFactory();
    $container = $rectorContainerFactory->createFromBootstrapConfigs($bootstrapConfigs);
} catch (\RectorPrefix20210331\Symplify\SetConfigResolver\Exception\SetNotFoundException $setNotFoundException) {
    $invalidSetReporter = new \RectorPrefix20210331\Symplify\SetConfigResolver\Bootstrap\InvalidSetReporter();
...
\class_alias('RectorPrefix20210331\\AutoloadIncluder', 'AutoloadIncluder', \false);
