...
if (\class_exists(\RectorPrefix20210429\Tracy\Debugger::class)) {
    \RectorPrefix20210429\Tracy\Debugger::$maxDepth = 2;
}
try {
...
\class_alias('RectorPrefix20210429\\AutoloadIncluder', 'AutoloadIncluder', \false);
