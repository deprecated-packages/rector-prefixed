...
use RectorPrefix20210315\Symplify\SetConfigResolver\Bootstrap\InvalidSetReporter;
...
$autoloadIncluder = new \RectorPrefix20210315\AutoloadIncluder();
$autoloadIncluder->includeDependencyOrRepositoryVendorAutoloadIfExists();
$autoloadIncluder->loadIfExistsAndNotLoadedYet(__DIR__ . '/../vendor/scoper-autoload.php');
$autoloadIncluder->autoloadProjectAutoloaderFile();
$autoloadIncluder->autoloadFromCommandLine();
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210315\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
} catch (\RectorPrefix20210315\Symplify\SetConfigResolver\Exception\SetNotFoundException $setNotFoundException) {
    $invalidSetReporter = new \RectorPrefix20210315\Symplify\SetConfigResolver\Bootstrap\InvalidSetReporter();
...
\class_alias('RectorPrefix20210315\\AutoloadIncluder', 'AutoloadIncluder', \false);
