...
use RectorPrefix20210427\Tracy\Debugger;
...
$autoloadIncluder = new \RectorPrefix20210427\AutoloadIncluder();
$autoloadIncluder->includeDependencyOrRepositoryVendorAutoloadIfExists();
$autoloadIncluder->loadIfExistsAndNotLoadedYet(__DIR__ . '/../vendor/scoper-autoload.php');
$autoloadIncluder->autoloadProjectAutoloaderFile();
$autoloadIncluder->autoloadFromCommandLine();
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210427\Symplify\PackageBuilder\Reflection\PrivatesCaller());
$symfonyStyle = $symfonyStyleFactory->create();
$rectorConfigsResolver = new \Rector\Core\Bootstrap\RectorConfigsResolver();
// for simpler debugging output
if (\class_exists(\RectorPrefix20210427\Tracy\Debugger::class)) {
    \RectorPrefix20210427\Tracy\Debugger::$maxDepth = 2;
}
try {
...
\class_alias('RectorPrefix20210427\\AutoloadIncluder', 'AutoloadIncluder', \false);
