...
$autoloadIncluder = new \RectorPrefix20210502\AutoloadIncluder();
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210502\Symplify\PackageBuilder\Reflection\PrivatesCaller());
$symfonyStyle = $symfonyStyleFactory->create();
$rectorConfigsResolver = new \Rector\Core\Bootstrap\RectorConfigsResolver();
// for simpler debugging output
if (\class_exists(\RectorPrefix20210502\Tracy\Debugger::class)) {
    \RectorPrefix20210502\Tracy\Debugger::$maxDepth = 2;
}
try {
...
\class_alias('RectorPrefix20210502\\AutoloadIncluder', 'AutoloadIncluder', \false);
