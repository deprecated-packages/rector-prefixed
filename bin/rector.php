...
$autoloadIncluder = new \RectorPrefix20210508\AutoloadIncluder();
...
} elseif (\RectorPrefix20210508\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210508\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210508\\AutoloadIncluder', 'AutoloadIncluder', \false);
