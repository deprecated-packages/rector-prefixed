...
use RectorPrefix20210419\Tracy\Debugger;
...
$autoloadIncluder = new \RectorPrefix20210419\AutoloadIncluder();
$autoloadIncluder->includeDependencyOrRepositoryVendorAutoloadIfExists();
$autoloadIncluder->loadIfExistsAndNotLoadedYet(__DIR__ . '/../vendor/scoper-autoload.php');
$autoloadIncluder->autoloadProjectAutoloaderFile();
$autoloadIncluder->autoloadFromCommandLine();
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210419\Symplify\PackageBuilder\Reflection\PrivatesCaller());
$symfonyStyle = $symfonyStyleFactory->create();
$rectorConfigsResolver = new \Rector\Core\Bootstrap\RectorConfigsResolver();
// for simpler debugging output
if (\class_exists(\RectorPrefix20210419\Tracy\Debugger::class)) {
    \RectorPrefix20210419\Tracy\Debugger::$maxDepth = 2;
}
try {
...
\class_alias('RectorPrefix20210419\\AutoloadIncluder', 'AutoloadIncluder', \false);
