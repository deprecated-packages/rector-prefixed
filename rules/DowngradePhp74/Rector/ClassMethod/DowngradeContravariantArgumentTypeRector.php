...
CODE_SAMPLE
     ...
     * @return string|null
     */
    private function getDifferentParamTypeFromAncestorClass(Param $param, FunctionLike $functionLike)
    {
     ...
     * @return void
     */
    private function refactorParam(Param $param, FunctionLike $functionLike)
    {
