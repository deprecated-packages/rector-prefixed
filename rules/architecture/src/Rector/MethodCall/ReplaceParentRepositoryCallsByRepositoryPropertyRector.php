...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($node->var, '_PhpScoper17db12703726\\Doctrine\\ORM\\EntityRepository')) {
            return null;
        }
    ...
    private function shouldSkip(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        return !$this->isInObjectType($classLike, '_PhpScoper17db12703726\\Doctrine\\ORM\\EntityRepository');
    }
}
