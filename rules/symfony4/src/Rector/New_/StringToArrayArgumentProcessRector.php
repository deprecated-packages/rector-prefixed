...
use RectorPrefix20210127\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210127\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210127\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
