...
use _PhpScoperfce0de0de1ce\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($this->isObjectType($expr, '_PhpScoperfce0de0de1ce\\Symfony\\Component\\Process\\Process')) {
            return $this->processArgumentPosition($node, 0);
        }
        if ($this->isObjectType($expr, '_PhpScoperfce0de0de1ce\\Symfony\\Component\\Console\\Helper\\ProcessHelper')) {
    ...
    private function splitProcessCommandToItems(string $process) : array
    {
        ...
        return $privatesCaller->callPrivateMethod(new \_PhpScoperfce0de0de1ce\Symfony\Component\Console\Input\StringInput(''), 'tokenize', $process);
    }
