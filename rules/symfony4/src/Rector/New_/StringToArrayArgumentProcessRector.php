...
use RectorPrefix20210105\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210105\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210105\Symfony\Component\Console\Input\StringInput(''), 'tokenize', $process);
    }
