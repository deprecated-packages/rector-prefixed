...
use RectorPrefix20210223\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210223\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210223\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
