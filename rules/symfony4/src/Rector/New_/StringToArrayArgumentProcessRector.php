...
use RectorPrefix20210130\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210130\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210130\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
