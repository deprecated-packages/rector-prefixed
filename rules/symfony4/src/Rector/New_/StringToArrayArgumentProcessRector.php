...
use RectorPrefix20210215\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210215\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210215\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
