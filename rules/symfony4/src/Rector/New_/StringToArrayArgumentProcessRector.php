...
use _PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($this->isObjectType($expr, '_PhpScoper5b8c9e9ebd21\\Symfony\\Component\\Process\\Process')) {
            return $this->processArgumentPosition($node, 0);
        }
        if ($this->isObjectType($expr, '_PhpScoper5b8c9e9ebd21\\Symfony\\Component\\Console\\Helper\\ProcessHelper')) {
    ...
    private function splitProcessCommandToItems(string $process) : array
    {
        ...
        return $privatesCaller->callPrivateMethod(new \_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Input\StringInput(''), 'tokenize', $process);
    }
