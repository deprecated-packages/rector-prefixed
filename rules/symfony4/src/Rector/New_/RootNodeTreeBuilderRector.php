...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->class, '_PhpScoper267b3276efc2\\Symfony\\Component\\Config\\Definition\\Builder\\TreeBuilder')) {
            return null;
        }
    ...
    private function getRootMethodCallNode(\PhpParser\Node\Expr\New_ $new) : ?\PhpParser\Node
    {
        ...
        return $this->betterNodeFinder->findFirst([$nextExpression], function (\PhpParser\Node $node) : bool {
            ...
            if (!$this->isObjectType($node->var, '_PhpScoper267b3276efc2\\Symfony\\Component\\Config\\Definition\\Builder\\TreeBuilder')) {
                return \false;
            }
