...
final class SimplifyWebTestCaseAssertionsRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \RectorPrefix20201227\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Simplify use of assertions in WebTestCase', [new \RectorPrefix20201227\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function isInWebTestCase(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        return $this->isObjectType($classLike, 'RectorPrefix20201227\\Symfony\\Bundle\\FrameworkBundle\\Test\\WebTestCase');
    }
