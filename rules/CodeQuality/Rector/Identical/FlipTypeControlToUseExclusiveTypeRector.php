...
CODE_SAMPLE
     ...
     * @return \PhpParser\Node|null
     */
    private function getVariableAssign(Identical $identical, Expr $expr)
    {
     ...
     */
    private function processConvertToExclusiveType(array $types, Expr $expr, PhpDocInfo $phpDocInfo)
    {
