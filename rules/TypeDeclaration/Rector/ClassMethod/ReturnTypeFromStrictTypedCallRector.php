...
CODE_SAMPLE
     ...
     * @return \PhpParser\Node|null
     */
    private function resolveMethodCallReturnNode(MethodCall $methodCall)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function resolveStaticCallReturnNode(StaticCall $staticCall)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function resolveFuncCallReturnNode(FuncCall $funcCall)
    {
