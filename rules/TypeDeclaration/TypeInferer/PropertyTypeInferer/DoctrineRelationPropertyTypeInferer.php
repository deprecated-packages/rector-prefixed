...
final class DoctrineRelationPropertyTypeInferer implements \Rector\TypeDeclaration\Contract\TypeInferer\PropertyTypeInfererInterface
{
    ...
    private function processToOneRelation(\PhpParser\Node\Stmt\Property $property, \Rector\BetterPhpDocParser\PhpDoc\DoctrineAnnotationTagValueNode $toOneDoctrineAnnotationTagValueNode, $joinDoctrineAnnotationTagValueNode) : \PHPStan\Type\Type
    {
        ...
        if (\RectorPrefix20210422\Nette\Utils\Strings::endsWith($targetEntity, '::class')) {
            $targetEntity = \RectorPrefix20210422\Nette\Utils\Strings::before($targetEntity, '::class');
        }
        // resolve to FQN
