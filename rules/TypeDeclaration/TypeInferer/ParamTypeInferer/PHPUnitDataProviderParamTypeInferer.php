...
final class PHPUnitDataProviderParamTypeInferer implements ParamTypeInfererInterface
{
     ...
     * @return void
     */
    public function autowirePHPUnitDataProviderParamTypeInferer(NodeTypeResolver $nodeTypeResolver)
    {
     ...
     */
    private function resolveDataProviderClassMethod(Param $param)
    {
