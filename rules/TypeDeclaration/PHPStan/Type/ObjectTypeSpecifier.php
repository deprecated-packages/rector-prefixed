...
final class ObjectTypeSpecifier
{
     ...
     */
    private function matchAliasedObjectType(Node $node, ObjectType $objectType)
    {
        /** @var Use_[]|null $uses */
        $uses = $node->getAttribute(AttributeKey::USE_NODES);
        if ($uses === null) {
     ...
     */
    private function matchShortenedObjectType(Node $node, ObjectType $objectType)
    {
        /** @var Use_[]|null $uses */
        $uses = $node->getAttribute(AttributeKey::USE_NODES);
        if ($uses === null) {
     ...
     */
    private function matchSameNamespacedObjectType(Node $node, ObjectType $objectType)
    {
     ...
     * @return \Rector\StaticTypeMapper\ValueObject\Type\ShortenedObjectType|null
     */
    private function matchPartialNamespaceObjectType(ObjectType $objectType, UseUse $useUse)
    {
        // partial namespace
     ...
     * @return \PHPStan\Type\ObjectType|null
     */
    private function matchClassWithLastUseImportPart(ObjectType $objectType, UseUse $useUse)
    {
