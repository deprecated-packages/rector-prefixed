...
final class ObjectTypeSpecifier
{
    ...
    {
        // partial namespace
        if (!\RectorPrefix20210326\Nette\Utils\Strings::startsWith($objectType->getClassName(), $useUse->name->getLast() . '\\')) {
            return null;
        }
        $classNameWithoutLastUsePart = \RectorPrefix20210326\Nette\Utils\Strings::after($objectType->getClassName(), '\\', 1);
