...
final class NonInformativeReturnTagRemover
{
     ...
     */
    const USELESS_DOC_NAMES_BY_TYPE_CLASS = [
     ...
     * @return void
     */
    public function removeReturnTagIfNotUseful(FunctionLike $functionLike)
    {
     ...
     */
    private function matchNullabledType(Type $returnType)
    {
     ...
     */
    private function matchNullabledReturnTagValueNode(ReturnTagValueNode $returnTagValueNode)
    {
