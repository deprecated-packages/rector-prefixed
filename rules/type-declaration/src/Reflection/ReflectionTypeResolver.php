...
final class ReflectionTypeResolver
{
    ...
    public function __construct(\Rector\NodeTypeResolver\NodeTypeResolver $nodeTypeResolver, \PHPStan\Reflection\ReflectionProvider $reflectionProvider, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210223\Symplify\PackageBuilder\Reflection\PrivatesCaller $privatesCaller)
    {
