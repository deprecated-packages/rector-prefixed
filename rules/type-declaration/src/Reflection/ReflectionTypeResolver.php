...
final class ReflectionTypeResolver
{
    ...
    public function __construct(\Rector\NodeTypeResolver\NodeTypeResolver $nodeTypeResolver, \PHPStan\Reflection\ReflectionProvider $reflectionProvider, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210302\Symplify\PackageBuilder\Reflection\PrivatesCaller $privatesCaller)
    {
