...
final class PhpParserTypeAnalyzer
{
     ...
     */
    public function isSubtypeOf(\_PhpScoper0a6b37af0871\PhpParser\Node $possibleSubtype, \_PhpScoper0a6b37af0871\PhpParser\Node $possibleParentType) : bool
    {
        // skip until PHP 8 is out
        if ($possibleSubtype instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\UnionType || $possibleParentType instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\UnionType) {
            return \false;
        }
        // possible - https://3v4l.org/ZuJCh
        if ($possibleSubtype instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\NullableType && !$possibleParentType instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\NullableType) {
     ...
     */
    private function unwrapNullableAndToString(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : string
    {
