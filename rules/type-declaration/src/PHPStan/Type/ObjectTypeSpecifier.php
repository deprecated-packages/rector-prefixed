...
final class ObjectTypeSpecifier
{
    ...
    {
        // partial namespace
        if (!\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::startsWith($objectType->getClassName(), $useUse->name->getLast() . '\\')) {
            return null;
        }
        $classNameWithoutLastUsePart = \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::after($objectType->getClassName(), '\\', 1);
