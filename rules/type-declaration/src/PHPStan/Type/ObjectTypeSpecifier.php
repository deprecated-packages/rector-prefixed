...
final class ObjectTypeSpecifier
{
    ...
    {
        // partial namespace
        if (!\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::startsWith($objectType->getClassName(), $useUse->name->getLast() . '\\')) {
            return null;
        }
        $classNameWithoutLastUsePart = \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::after($objectType->getClassName(), '\\', 1);
