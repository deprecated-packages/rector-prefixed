...
final class ObjectTypeSpecifier
{
    ...
    {
        // partial namespace
        if (!\_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::startsWith($objectType->getClassName(), $useUse->name->getLast() . '\\')) {
            return null;
        }
        $classNameWithoutLastUsePart = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::after($objectType->getClassName(), '\\', 1);
