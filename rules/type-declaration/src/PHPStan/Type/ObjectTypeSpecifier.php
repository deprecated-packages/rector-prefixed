...
final class ObjectTypeSpecifier
{
    ...
    {
        // partial namespace
        if (!\_PhpScoper17db12703726\Nette\Utils\Strings::startsWith($objectType->getClassName(), $useUse->name->getLast() . '\\')) {
            return null;
        }
        $classNameWithoutLastUsePart = \_PhpScoper17db12703726\Nette\Utils\Strings::after($objectType->getClassName(), '\\', 1);
