...
use _PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\Manipulator\PropertyFetchAssignManipulator;
...
final class GetterNodeParamTypeInferer extends \_PhpScoper0a2ac50786fa\Rector\TypeDeclaration\TypeInferer\AbstractTypeInferer implements \_PhpScoper0a2ac50786fa\Rector\TypeDeclaration\Contract\TypeInferer\ParamTypeInfererInterface
{
    /**
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\Manipulator\PropertyFetchAssignManipulator $propertyFetchAssignManipulator, \_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\Manipulator\PropertyFetchManipulator $propertyFetchManipulator)
    {
    ...
    public function inferParam(\_PhpScoper0a2ac50786fa\PhpParser\Node\Param $param) : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        ...
        $returnType = new \_PhpScoper0a2ac50786fa\PHPStan\Type\MixedType();
        // resolve property assigns
        $this->callableNodeTraverser->traverseNodesWithCallable($classLike, function (\_PhpScoper0a2ac50786fa\PhpParser\Node $node) use($propertyNames, &$returnType) : ?int {
            ...
            if ($methodReturnType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\MixedType) {
                return null;
            }
