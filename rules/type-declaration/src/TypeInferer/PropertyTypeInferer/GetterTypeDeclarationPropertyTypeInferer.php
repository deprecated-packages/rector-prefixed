...
final class GetterTypeDeclarationPropertyTypeInferer extends \_PhpScoper0a6b37af0871\Rector\TypeDeclaration\TypeInferer\AbstractTypeInferer implements \_PhpScoper0a6b37af0871\Rector\TypeDeclaration\Contract\TypeInferer\PropertyTypeInfererInterface
{
    /**
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\TypeDeclaration\FunctionLikeReturnTypeResolver $functionLikeReturnTypeResolver, \_PhpScoper0a6b37af0871\Rector\TypeDeclaration\NodeAnalyzer\ClassMethodAndPropertyAnalyzer $classMethodAndPropertyAnalyzer)
    {
    ...
    public function inferProperty(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property $property) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        foreach ($classLike->getMethods() as $classMethod) {
            ...
            if ($returnType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\ArrayType) {
                return new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType();
            }
