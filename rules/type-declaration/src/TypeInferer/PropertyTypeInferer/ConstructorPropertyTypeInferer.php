...
use _PhpScoper0a6b37af0871\Rector\Core\PhpParser\Node\Manipulator\ClassMethodPropertyFetchManipulator;
...
final class ConstructorPropertyTypeInferer extends \_PhpScoper0a6b37af0871\Rector\TypeDeclaration\TypeInferer\AbstractTypeInferer implements \_PhpScoper0a6b37af0871\Rector\TypeDeclaration\Contract\TypeInferer\PropertyTypeInfererInterface
{
    /**
     * @var ClassMethodPropertyFetchManipulator
     */
    private $classMethodPropertyFetchManipulator;
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Node\Manipulator\ClassMethodPropertyFetchManipulator $classMethodPropertyFetchManipulator)
    {
    ...
    public function inferProperty(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property $property) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        $classMethod = $classLike->getMethod(\_PhpScoper0a6b37af0871\Rector\Core\ValueObject\MethodName::CONSTRUCT);
        if ($classMethod === null) {
            return new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType();
        }
    ...
    private function resolveFromParamType(\_PhpScoper0a6b37af0871\PhpParser\Node\Param $param, \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, string $propertyName) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
    ...
    private function resolveParamTypeToPHPStanType(\_PhpScoper0a6b37af0871\PhpParser\Node\Param $param) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        if ($param->type === null) {
            return new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType();
        }
        ...
        if ($param->type instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified) {
    ...
    private function getResolveParamStaticTypeAsPHPStanType(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, string $propertyName) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        $paramStaticType = new \_PhpScoper0a6b37af0871\PHPStan\Type\ArrayType(new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType(), new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType());
        $this->callableNodeTraverser->traverseNodesWithCallable((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($propertyName, &$paramStaticType) : ?int {
    ...
    private function isParamNullable(\_PhpScoper0a6b37af0871\PhpParser\Node\Param $param) : bool
    {
        if ($param->type instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\NullableType) {
            return \true;
        }
        if ($param->default !== null) {
            ...
            if ($defaultValueStaticType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\NullType) {
                return \true;
            }
        }
        return \false;
    }
    private function resolveFullyQualifiedOrAliasedObjectType(\_PhpScoper0a6b37af0871\PhpParser\Node\Param $param) : ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        if ($param->type === null) {
            return null;
        }
        ...
        $originalName = $param->type->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::ORIGINAL_NAME);
        if (!$originalName instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Name) {
            return null;
        }
        // if the FQN has different ending than the original, it was aliased and we need to return the alias
        if (!\_PhpScoper0a6b37af0871\Nette\Utils\Strings::endsWith($fullyQualifiedName, '\\' . $originalName->toString())) {
            ...
            return new \_PhpScoper0a6b37af0871\Rector\PHPStan\Type\AliasedObjectType($originalName->toString(), $fullyQualifiedName);
        }
        return null;
    }
}
