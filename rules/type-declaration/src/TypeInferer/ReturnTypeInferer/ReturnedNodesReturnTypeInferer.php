...
use _PhpScoper0a2ac50786fa\Rector\TypeDeclaration\TypeInferer\SilentVoidResolver;
final class ReturnedNodesReturnTypeInferer extends \_PhpScoper0a2ac50786fa\Rector\TypeDeclaration\TypeInferer\AbstractTypeInferer implements \_PhpScoper0a2ac50786fa\Rector\TypeDeclaration\Contract\TypeInferer\ReturnTypeInfererInterface
{
    /**
     * @var Type[]
     */
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\TypeDeclaration\TypeInferer\SilentVoidResolver $silentVoidResolver)
    {
    ...
    public function inferFunctionLike(\_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike $functionLike) : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        ...
        if ($functionLike instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassMethod && $classLike instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Interface_) {
            return new \_PhpScoper0a2ac50786fa\PHPStan\Type\MixedType();
        }
        $this->types = [];
        ...
        foreach ($localReturnNodes as $localReturnNode) {
            if ($localReturnNode->expr === null) {
                $this->types[] = new \_PhpScoper0a2ac50786fa\PHPStan\Type\VoidType();
                continue;
            }
     ...
     * @return Return_[]
     */
    private function collectReturns(\_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike $functionLike) : array
    {
        $returns = [];
        $this->callableNodeTraverser->traverseNodesWithCallable((array) $functionLike->getStmts(), function (\_PhpScoper0a2ac50786fa\PhpParser\Node $node) use(&$returns) : ?int {
    ...
    private function resolveNoLocalReturnNodes(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassLike $classLike, \_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike $functionLike) : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        // void type
    ...
    private function processSwitch(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Switch_ $switch) : void
    {
    ...
    private function isAbstractMethod(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassLike $classLike, \_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike $functionLike) : bool
    {
        if ($functionLike instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassMethod && $functionLike->isAbstract()) {
            return \true;
        }
