...
namespace _PhpScoper0a2ac50786fa\Rector\TypeDeclaration\TypeAlreadyAddedChecker;
...
final class ReturnTypeAlreadyAddedChecker
{
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Printer\BetterStandardPrinter $betterStandardPrinter, \_PhpScoper0a2ac50786fa\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScoper0a2ac50786fa\Rector\StaticTypeMapper\StaticTypeMapper $staticTypeMapper)
    {
     ...
     */
    public function isSameOrBetterReturnTypeAlreadyAdded(\_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike $functionLike, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $returnType) : bool
    {
        ...
        if ($returnType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\GenericObjectType && $returnType->getClassName() === 'class-string') {
            return \true;
        }
        // prevent overriding self with itself
        if (!$functionLike->returnType instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Name) {
            return \false;
        }
     ...
     */
    private function isArrayIterableIteratorCoType(\_PhpScoper0a2ac50786fa\PhpParser\Node $returnTypeNode, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $returnType) : bool
    {
     ...
     * @param Identifier|Name|NullableType|PhpParserUnionType $returnTypeNode
     */
    private function isUnionCoType(\_PhpScoper0a2ac50786fa\PhpParser\Node $returnTypeNode, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type) : bool
    {
    ...
    private function isStaticTypeIterable(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type) : bool
    {
    ...
    private function isArrayIterableOrIteratorType(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type) : bool
    {
