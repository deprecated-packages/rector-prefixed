...
final class ChangeQueryWhereDateValueWithCarbonRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('RectorPrefix20201226\\Add parent::boot(); call to boot() class method in child of Illuminate\\Database\\Eloquent\\Model', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($methodCall, 'RectorPrefix20201226\\Illuminate\\Database\\Query\\Builder', 'whereDate')) {
            return null;
        }
        ...
        // nothing to change
        if ($this->isStaticCallNamed($argValue, 'RectorPrefix20201226\\Carbon\\Carbon', 'today')) {
            return null;
        }
