...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($methodCall, 'RectorPrefix2020DecSat\\Illuminate\\Database\\Query\\Builder', 'whereDate')) {
            return null;
        }
        ...
        // nothing to change
        if ($this->isStaticCallNamed($argValue, 'RectorPrefix2020DecSat\\Carbon\\Carbon', 'today')) {
            return null;
        }
