...
final class ChangeQueryWhereDateValueWithCarbonRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('_PhpScoperfce0de0de1ce\\Add parent::boot(); call to boot() class method in child of Illuminate\\Database\\Eloquent\\Model', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($methodCall, '_PhpScoperfce0de0de1ce\\Illuminate\\Database\\Query\\Builder', 'whereDate')) {
            return null;
        }
        ...
        // nothing to change
        if ($this->isStaticCallNamed($argValue, '_PhpScoperfce0de0de1ce\\Carbon\\Carbon', 'today')) {
            return null;
        }
