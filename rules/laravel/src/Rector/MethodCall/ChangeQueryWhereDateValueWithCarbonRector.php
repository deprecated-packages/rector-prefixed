...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($methodCall, '_PhpScoper006a73f0e455\\Illuminate\\Database\\Query\\Builder', 'whereDate')) {
            return null;
        }
        ...
        // nothing to change
        if ($this->isStaticCallNamed($argValue, '_PhpScoper006a73f0e455\\Carbon\\Carbon', 'today')) {
            return null;
        }
