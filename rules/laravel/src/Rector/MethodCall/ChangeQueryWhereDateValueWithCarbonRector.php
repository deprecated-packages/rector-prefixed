...
final class ChangeQueryWhereDateValueWithCarbonRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('_PhpScoper5edc98a7cce2\\Add parent::boot(); call to boot() class method in child of Illuminate\\Database\\Eloquent\\Model', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($methodCall, '_PhpScoper5edc98a7cce2\\Illuminate\\Database\\Query\\Builder', 'whereDate')) {
            return null;
        }
        ...
        // nothing to change
        if ($this->isStaticCallNamed($argValue, '_PhpScoper5edc98a7cce2\\Carbon\\Carbon', 'today')) {
            return null;
        }
