...
final class RequestStaticValidateToInjectRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string[]
     */
    private const REQUEST_TYPES = ['_PhpScoperfce0de0de1ce\\Illuminate\\Http\\Request', 'Request'];
    /**
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $requestName = $this->classMethodManipulator->addMethodParameterIfMissing($node, '_PhpScoperfce0de0de1ce\\Illuminate\\Http\\Request', ['request', 'httpRequest']);
