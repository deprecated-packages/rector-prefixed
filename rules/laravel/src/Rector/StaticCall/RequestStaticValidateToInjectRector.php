 ...
 */
final class RequestStaticValidateToInjectRector extends \_PhpScoperb75b35f52b74\Rector\Core\Rector\AbstractRector
{
    /**
     * @var string[]
     */
    private const REQUEST_TYPES = ['_PhpScoperb75b35f52b74\\Illuminate\\Http\\Request', 'Request'];
    /**
    ...
    {
        return new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change static validate() method to $request->validate()', [new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        return [\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\StaticCall::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\FuncCall::class];
    }
    /**
    ...
    public function refactor(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        $requestName = $this->classMethodManipulator->addMethodParameterIfMissing($node, '_PhpScoperb75b35f52b74\\Illuminate\\Http\\Request', ['request', 'httpRequest']);
        $variable = new \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable($requestName);
        ...
        return new \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall($variable, new \_PhpScoperb75b35f52b74\PhpParser\Node\Identifier($methodName), $node->args);
    }
    /**
     * @param StaticCall|FuncCall $node
     */
