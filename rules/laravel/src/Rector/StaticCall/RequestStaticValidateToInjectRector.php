...
final class RequestStaticValidateToInjectRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string[]
     */
    private const REQUEST_TYPES = ['_PhpScoper17db12703726\\Illuminate\\Http\\Request', 'Request'];
    /**
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $requestName = $this->classMethodManipulator->addMethodParameterIfMissing($node, '_PhpScoper17db12703726\\Illuminate\\Http\\Request', ['request', 'httpRequest']);
