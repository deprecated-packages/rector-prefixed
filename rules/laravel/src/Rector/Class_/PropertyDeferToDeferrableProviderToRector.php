...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScoper26e51eeacccf\\Illuminate\\Support\\ServiceProvider')) {
            return null;
        }
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper26e51eeacccf\\Illuminate\\Contracts\\Support\\DeferrableProvider');
        return $node;
    }
