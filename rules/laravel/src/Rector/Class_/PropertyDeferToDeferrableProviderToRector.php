...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScoper567b66d83109\\Illuminate\\Support\\ServiceProvider')) {
            return null;
        }
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper567b66d83109\\Illuminate\\Contracts\\Support\\DeferrableProvider');
        return $node;
    }
