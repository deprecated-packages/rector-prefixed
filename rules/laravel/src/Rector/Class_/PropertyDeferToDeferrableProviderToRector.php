...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScoper5edc98a7cce2\\Illuminate\\Support\\ServiceProvider')) {
            return null;
        }
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper5edc98a7cce2\\Illuminate\\Contracts\\Support\\DeferrableProvider');
        return $node;
    }
