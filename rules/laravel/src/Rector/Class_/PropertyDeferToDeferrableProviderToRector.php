...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, 'RectorPrefix2020DecSat\\Illuminate\\Support\\ServiceProvider')) {
            return null;
        }
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('RectorPrefix2020DecSat\\Illuminate\\Contracts\\Support\\DeferrableProvider');
        return $node;
    }
