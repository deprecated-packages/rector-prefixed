...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScoper88fe6e0ad041\\Illuminate\\Support\\ServiceProvider')) {
            return null;
        }
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper88fe6e0ad041\\Illuminate\\Contracts\\Support\\DeferrableProvider');
        return $node;
    }
