...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScopera143bcca66cb\\Illuminate\\Support\\ServiceProvider')) {
            return null;
        }
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScopera143bcca66cb\\Illuminate\\Contracts\\Support\\DeferrableProvider');
        return $node;
    }
