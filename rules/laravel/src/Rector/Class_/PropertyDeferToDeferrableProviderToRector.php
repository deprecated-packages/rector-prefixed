...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScoper267b3276efc2\\Illuminate\\Support\\ServiceProvider')) {
            return null;
        }
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper267b3276efc2\\Illuminate\\Contracts\\Support\\DeferrableProvider');
        return $node;
    }
