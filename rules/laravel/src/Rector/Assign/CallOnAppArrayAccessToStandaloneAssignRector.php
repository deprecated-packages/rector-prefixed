...
final class CallOnAppArrayAccessToStandaloneAssignRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->serviceNameTypeAndVariableNames[] = new \Rector\Laravel\ValueObject\ServiceNameTypeAndVariableName('validator', 'RectorPrefix2020DecSat\\Illuminate\\Validation\\Factory', 'validationFactory');
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($methodCall->var, 'RectorPrefix2020DecSat\\Illuminate\\Contracts\\Foundation\\Application')) {
            return null;
        }
