...
final class CallOnAppArrayAccessToStandaloneAssignRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->serviceNameTypeAndVariableNames[] = new \Rector\Laravel\ValueObject\ServiceNameTypeAndVariableName('validator', '_PhpScoper5edc98a7cce2\\Illuminate\\Validation\\Factory', 'validationFactory');
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($methodCall->var, '_PhpScoper5edc98a7cce2\\Illuminate\\Contracts\\Foundation\\Application')) {
            return null;
        }
