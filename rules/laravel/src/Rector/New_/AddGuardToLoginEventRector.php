...
final class AddGuardToLoginEventRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('_PhpScoper5edc98a7cce2\\Add new $guard argument to Illuminate\\Auth\\Events\\Login', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->isName($node->class, '_PhpScoper5edc98a7cce2\\Illuminate\\Auth\\Events\\Login')) {
            return null;
        }
