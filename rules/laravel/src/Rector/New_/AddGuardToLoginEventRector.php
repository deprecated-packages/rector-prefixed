...
final class AddGuardToLoginEventRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('_PhpScopera143bcca66cb\\Add new $guard argument to Illuminate\\Auth\\Events\\Login', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->isName($node->class, '_PhpScopera143bcca66cb\\Illuminate\\Auth\\Events\\Login')) {
            return null;
        }
