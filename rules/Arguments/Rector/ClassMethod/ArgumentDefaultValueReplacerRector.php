...
, [self::REPLACED_ARGUMENTS => [new \Rector\Arguments\ValueObject\ArgumentDefaultValueReplacer('SomeExampleClass', 'someMethod', 0, 'SomeClass::OLD_CONSTANT', 'false')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20210418\Webmozart\Assert\Assert::allIsInstanceOf($replacedArguments, \Rector\Arguments\ValueObject\ArgumentDefaultValueReplacer::class);
    ...
    private function normalizeValueToArgument($value) : \PhpParser\Node\Arg
    {
        ...
        if (\is_string($value) && \RectorPrefix20210418\Nette\Utils\Strings::contains($value, '::')) {
