...
CODE_SAMPLE
     ...
     * @return void
     */
    private function processPositionWithDefaultValues(Node $node, ArgumentAdder $argumentAdder)
    {
     ...
     * @return void
     */
    private function processStaticCall(StaticCall $staticCall, int $position, ArgumentAdder $argumentAdder)
    {
        $argumentName = $argumentAdder->getArgumentName();
        if ($argumentName === null) {
            throw new ShouldNotHappenException();
