...
,
     ...
     */
    private function refactorArray(Arg $desiredArg, ObjectType $newObjectType, MethodCall $methodCall)
    {
     ...
     */
    private function matchArg(MethodCall $methodCall, ValueObjectWrapArg $valueObjectWrapArg)
    {
