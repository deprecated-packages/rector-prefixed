...
final class EregToPregMatchRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!\_PhpScoper267b3276efc2\Nette\Utils\Strings::startsWith($functionName, 'split')) {
            return;
        }
    ...
    {
        if (\_PhpScoper267b3276efc2\Nette\Utils\Strings::contains($functionName, 'eregi')) {
            return \true;
        }
        return \_PhpScoper267b3276efc2\Nette\Utils\Strings::contains($functionName, 'spliti');
    }
}
