...
final class EregToPregMatchRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::startsWith($functionName, 'split')) {
            return;
        }
    ...
    {
        if (\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::contains($functionName, 'eregi')) {
            return \true;
        }
        return \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::contains($functionName, 'spliti');
    }
}
