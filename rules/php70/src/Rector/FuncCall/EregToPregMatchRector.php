...
final class EregToPregMatchRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!\_PhpScoper006a73f0e455\Nette\Utils\Strings::startsWith($functionName, 'split')) {
            return;
        }
    ...
    {
        if (\_PhpScoper006a73f0e455\Nette\Utils\Strings::contains($functionName, 'eregi')) {
            return \true;
        }
        return \_PhpScoper006a73f0e455\Nette\Utils\Strings::contains($functionName, 'spliti');
    }
}
