...
final class EregToPregMatchRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!\_PhpScoper50d83356d739\Nette\Utils\Strings::startsWith($functionName, 'split')) {
            return;
        }
    ...
    {
        if (\_PhpScoper50d83356d739\Nette\Utils\Strings::contains($functionName, 'eregi')) {
            return \true;
        }
        return \_PhpScoper50d83356d739\Nette\Utils\Strings::contains($functionName, 'spliti');
    }
}
