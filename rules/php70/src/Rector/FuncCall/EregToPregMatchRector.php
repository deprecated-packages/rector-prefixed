...
final class EregToPregMatchRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::startsWith($functionName, 'split')) {
            return;
        }
    ...
    {
        if (\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::contains($functionName, 'eregi')) {
            return \true;
        }
        return \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::contains($functionName, 'spliti');
    }
}
