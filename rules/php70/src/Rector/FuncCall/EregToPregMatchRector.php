...
final class EregToPregMatchRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!\RectorPrefix20210201\Nette\Utils\Strings::startsWith($functionName, 'split')) {
            return;
        }
    ...
    {
        if (\RectorPrefix20210201\Nette\Utils\Strings::contains($functionName, 'eregi')) {
            return \true;
        }
        return \RectorPrefix20210201\Nette\Utils\Strings::contains($functionName, 'spliti');
    }
}
