...
final class EregToPregMatchRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!\RectorPrefix2020DecSat\Nette\Utils\Strings::startsWith($functionName, 'split')) {
            return;
        }
    ...
    {
        if (\RectorPrefix2020DecSat\Nette\Utils\Strings::contains($functionName, 'eregi')) {
            return \true;
        }
        return \RectorPrefix2020DecSat\Nette\Utils\Strings::contains($functionName, 'spliti');
    }
}
