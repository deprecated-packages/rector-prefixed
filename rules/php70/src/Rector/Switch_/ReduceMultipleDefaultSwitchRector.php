...
namespace _PhpScoper0a6b37af0871\Rector\Php70\Rector\Switch_;
 ...
 */
final class ReduceMultipleDefaultSwitchRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Remove first default switch, that is ignored', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
switch ($expr) {
    default:
         echo "Hello World";
...
CODE_SAMPLE
    ...
    private function keepStatementsToParentCase(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Case_ $case) : void
    {
        $previousNode = $case->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::PREVIOUS_NODE);
        if (!$previousNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Case_) {
            return;
        }
