...
namespace _PhpScoperb75b35f52b74\Rector\Php70\Rector\StaticCall;
 ...
 */
final class StaticCallOnNonStaticToInstanceCallRector extends \_PhpScoperb75b35f52b74\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    public function __construct(\_PhpScoperb75b35f52b74\Rector\Core\PhpParser\Node\Manipulator\ClassMethodManipulator $classMethodManipulator, \_PhpScoperb75b35f52b74\Rector\NodeCollector\StaticAnalyzer $staticAnalyzer)
    {
    ...
    {
        return new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Changes static call to instance call, where not useful', [new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class Something
{
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        if ($this->isInstantiable($className)) {
            $new = new \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\New_($node->class);
            return new \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall($new, $node->name, $node->args);
        }
    ...
    private function resolveStaticCallClassName(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\StaticCall $staticCall) : ?string
    {
        if ($staticCall->class instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\PropertyFetch) {
    ...
    private function shouldSkip(string $methodName, string $className, \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\StaticCall $staticCall) : bool
    {
