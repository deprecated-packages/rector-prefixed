...
final class EregToPcreTransformerTest extends \RectorPrefix20210212\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->eregToPcreTransformer = new \Rector\Php70\EregToPcreTransformer();
    }
    /**
