...
final class ConstructorAssignPropertyAnalyzer
{
    ...
    public function resolveConstructorAssign(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\Property $property) : ?\_PhpScopere8e811afab72\PhpParser\Node
    {
        ...
        return $this->betterNodeFinder->findFirst((array) $constructClassMethod->stmts, function (\_PhpScopere8e811afab72\PhpParser\Node $node) use($propertyName) : ?Assign {
