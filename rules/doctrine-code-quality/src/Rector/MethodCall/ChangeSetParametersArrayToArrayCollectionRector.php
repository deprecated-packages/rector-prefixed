...
CODE_SAMPLE
    ...
    private function shouldSkipMethodCall(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        if (!$this->isObjectType($classLike, '_PhpScoperbf340cb0be9d\\Doctrine\\ORM\\EntityRepository')) {
            return \true;
        }
        if (!$this->isObjectType($methodCall->var, '_PhpScoperbf340cb0be9d\\Doctrine\\ORM\\EntityRepository')) {
            return \true;
        }
    ...
    private function getNewArrayCollectionFromSetParametersArgument(\PhpParser\Node\Arg $arg) : \PhpParser\Node\Expr\New_
    {
        ...
        foreach ($firstArgumentArrayItems as $firstArgumentArrayItem) {
            ...
            $queryParameter = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('_PhpScoperbf340cb0be9d\\Doctrine\\ORM\\Query\\Parameter'));
        ...
        $arrayCollection = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('_PhpScoperbf340cb0be9d\\Doctrine\\Common\\Collections\\ArrayCollection'));
