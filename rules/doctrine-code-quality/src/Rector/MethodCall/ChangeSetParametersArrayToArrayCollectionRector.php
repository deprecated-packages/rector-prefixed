...
CODE_SAMPLE
    ...
    private function shouldSkipMethodCall(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        if (!$this->isObjectType($classLike, 'RectorPrefix20201226\\Doctrine\\ORM\\EntityRepository')) {
            return \true;
        }
        if (!$this->isObjectType($methodCall->var, 'RectorPrefix20201226\\Doctrine\\ORM\\EntityRepository')) {
            return \true;
        }
    ...
    private function getNewArrayCollectionFromSetParametersArgument(\PhpParser\Node\Arg $arg) : \PhpParser\Node\Expr\New_
    {
        ...
        foreach ($firstArgumentArrayItems as $firstArgumentArrayItem) {
            ...
            $queryParameter = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('RectorPrefix20201226\\Doctrine\\ORM\\Query\\Parameter'));
        ...
        $arrayCollection = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('RectorPrefix20201226\\Doctrine\\Common\\Collections\\ArrayCollection'));
