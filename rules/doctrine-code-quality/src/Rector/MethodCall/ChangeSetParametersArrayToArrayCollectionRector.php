...
CODE_SAMPLE
    ...
    private function shouldSkipMethodCall(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        if (!$this->isObjectType($classLike, '_PhpScoperf18a0c41e2d2\\Doctrine\\ORM\\EntityRepository')) {
            return \true;
        }
        if (!$this->isObjectType($methodCall->var, '_PhpScoperf18a0c41e2d2\\Doctrine\\ORM\\EntityRepository')) {
            return \true;
        }
    ...
    private function getNewArrayCollectionFromSetParametersArgument(\PhpParser\Node\Arg $arg) : \PhpParser\Node\Expr\New_
    {
        ...
        foreach ($firstArgumentArrayItems as $firstArgumentArrayItem) {
            ...
            $queryParameter = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('_PhpScoperf18a0c41e2d2\\Doctrine\\ORM\\Query\\Parameter'));
        ...
        $arrayCollection = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('_PhpScoperf18a0c41e2d2\\Doctrine\\Common\\Collections\\ArrayCollection'));
