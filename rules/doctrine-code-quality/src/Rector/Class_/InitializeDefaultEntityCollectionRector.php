...
use RectorPrefix20210121\Doctrine\Common\Collections\ArrayCollection;
use PhpParser\Node;
...
CODE_SAMPLE
    ...
    private function createPropertyArrayCollectionAssign(string $toManyPropertyName) : \PhpParser\Node\Stmt\Expression
    {
        ...
        $new = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified(\RectorPrefix20210121\Doctrine\Common\Collections\ArrayCollection::class));
