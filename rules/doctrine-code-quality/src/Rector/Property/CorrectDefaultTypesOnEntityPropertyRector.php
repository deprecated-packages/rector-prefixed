 ...
 */
final class CorrectDefaultTypesOnEntityPropertyRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change default value types to match Doctrine annotation type', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function refactorToBoolType(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\PropertyProperty $propertyProperty, \_PhpScopere8e811afab72\PhpParser\Node\Stmt\Property $property) : ?\_PhpScopere8e811afab72\PhpParser\Node\Stmt\Property
    {
        if ($propertyProperty->default === null) {
            return null;
        }
        $defaultExpr = $propertyProperty->default;
        if ($defaultExpr instanceof \_PhpScopere8e811afab72\PhpParser\Node\Scalar\String_) {
            $propertyProperty->default = \boolval($defaultExpr->value) ? $this->createTrue() : $this->createFalse();
            return $property;
        }
        if ($defaultExpr instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr\ConstFetch) {
            // already ok
            return null;
        }
        throw new \_PhpScopere8e811afab72\Rector\Core\Exception\NotImplementedYetException();
    }
    private function refactorToIntType(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\PropertyProperty $propertyProperty, \_PhpScopere8e811afab72\PhpParser\Node\Stmt\Property $property) : ?\_PhpScopere8e811afab72\PhpParser\Node\Stmt\Property
    {
        if ($propertyProperty->default === null) {
            return null;
        }
        $defaultExpr = $propertyProperty->default;
        if ($defaultExpr instanceof \_PhpScopere8e811afab72\PhpParser\Node\Scalar\String_) {
            $propertyProperty->default = new \_PhpScopere8e811afab72\PhpParser\Node\Scalar\LNumber((int) $defaultExpr->value);
            return $property;
        }
        if ($defaultExpr instanceof \_PhpScopere8e811afab72\PhpParser\Node\Scalar\LNumber) {
            // already correct
            return null;
        }
        throw new \_PhpScopere8e811afab72\Rector\Core\Exception\NotImplementedYetException();
