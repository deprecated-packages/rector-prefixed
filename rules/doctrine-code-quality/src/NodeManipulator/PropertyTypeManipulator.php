...
final class PropertyTypeManipulator
{
    ...
    public function __construct(\_PhpScopere8e811afab72\Rector\NodeTypeResolver\PhpDoc\NodeAnalyzer\DocBlockClassRenamer $docBlockClassRenamer)
    {
        $this->docBlockClassRenamer = $docBlockClassRenamer;
    }
    public function changePropertyType(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\Property $property, string $oldClass, string $newClass) : void
    {
        ...
        $this->docBlockClassRenamer->renamePhpDocType($phpDocInfo->getPhpDocNode(), new \_PhpScopere8e811afab72\Rector\PHPStan\Type\FullyQualifiedObjectType($oldClass), new \_PhpScopere8e811afab72\Rector\PHPStan\Type\FullyQualifiedObjectType($newClass), $property);
    }
}
