...
final class DoctrineItemDefaultValueManipulator
{
     ...
     */
    public function remove(\_PhpScoper0a6b37af0871\Rector\BetterPhpDocParser\ValueObject\PhpDocNode\Doctrine\AbstractDoctrineTagValueNode $doctrineTagValueNode, string $item, $defaultValue) : void
    {
     ...
     * @param string|bool|int $defaultValue
     */
    private function hasItemWithDefaultValue(\_PhpScoper0a6b37af0871\Rector\BetterPhpDocParser\ValueObject\PhpDocNode\Doctrine\AbstractDoctrineTagValueNode $doctrineTagValueNode, string $item, $defaultValue) : bool
    {
