...
final class DoctrineItemDefaultValueManipulator
{
     ...
     */
    public function remove(\_PhpScopere8e811afab72\Rector\BetterPhpDocParser\ValueObject\PhpDocNode\Doctrine\AbstractDoctrineTagValueNode $doctrineTagValueNode, string $item, $defaultValue) : void
    {
     ...
     * @param string|bool|int $defaultValue
     */
    private function hasItemWithDefaultValue(\_PhpScopere8e811afab72\Rector\BetterPhpDocParser\ValueObject\PhpDocNode\Doctrine\AbstractDoctrineTagValueNode $doctrineTagValueNode, string $item, $defaultValue) : bool
    {
