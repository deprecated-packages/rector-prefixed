...
final class SimplifyEmptyArrayCheckRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\CodeQuality\Rector\BooleanAnd\SimplifyEmptyArrayCheckRector::class;
    }
}
