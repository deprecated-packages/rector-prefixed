...
final class SimplifyConditionsRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\CodeQuality\Rector\Identical\SimplifyConditionsRector::class;
    }
}
