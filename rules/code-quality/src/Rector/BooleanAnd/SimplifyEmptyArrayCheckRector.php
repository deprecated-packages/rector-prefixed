...
namespace _PhpScoper0a6b37af0871\Rector\CodeQuality\Rector\BooleanAnd;
 ...
 */
final class SimplifyEmptyArrayCheckRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Simplify `is_array` and `empty` functions combination into a simple identical check for an empty array', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample('is_array($values) && empty($values)', '$values === []')]);
    }
    /**
     * @return string[]
     */
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        $twoNodeMatch = $this->binaryOpManipulator->matchFirstAndSecondConditionNode(
            ...
            \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Empty_::class
        );
        ...
        return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\Identical($emptyOrNotIdenticalNode->expr, new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Array_());
    }
}
