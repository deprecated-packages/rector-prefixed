...
use RectorPrefix20210304\Doctrine\Inflector\Inflector;
use PhpParser\Node;
...
final class ForToForeachRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function __construct(\RectorPrefix20210304\Doctrine\Inflector\Inflector $inflector, \Rector\CodeQuality\NodeAnalyzer\ForAnalyzer $forAnalyzer, \Rector\CodeQuality\NodeFactory\ForeachFactory $foreachFactory, \Rector\CodeQuality\NodeAnalyzer\ForeachAnalyzer $foreachAnalyzer)
    {
