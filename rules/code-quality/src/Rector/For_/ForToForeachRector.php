...
use RectorPrefix20210220\Doctrine\Inflector\Inflector;
use PhpParser\Node;
...
final class ForToForeachRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function __construct(\RectorPrefix20210220\Doctrine\Inflector\Inflector $inflector, \Rector\CodeQuality\NodeAnalyzer\ForNodeAnalyzer $forNodeAnalyzer, \Rector\CodeQuality\NodeFactory\ForeachFactory $foreachFactory)
    {
