...
namespace _PhpScoper0a6b37af0871\Rector\CodeQuality\Rector\Class_;

use _PhpScoper0a6b37af0871\PhpParser\Node;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_;
use _PhpScoper0a6b37af0871\PHPStan\Type\Type;
use _PhpScoper0a6b37af0871\Rector\CodeQuality\NodeAnalyzer\ClassLikeAnalyzer;
use _PhpScoper0a6b37af0871\Rector\CodeQuality\NodeAnalyzer\LocalPropertyAnalyzer;
use _PhpScoper0a6b37af0871\Rector\CodeQuality\NodeFactory\MissingPropertiesFactory;
 ...
 */
final class CompleteDynamicPropertiesRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\CodeQuality\NodeFactory\MissingPropertiesFactory $missingPropertiesFactory, \_PhpScoper0a6b37af0871\Rector\CodeQuality\NodeAnalyzer\LocalPropertyAnalyzer $localPropertyAnalyzer, \_PhpScoper0a6b37af0871\Rector\CodeQuality\NodeAnalyzer\ClassLikeAnalyzer $classLikeAnalyzer)
    {
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Add missing dynamic properties', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function set()
    {
...
CODE_SAMPLE
     ...
     * @return string[]
     */
    private function resolvePropertiesToComplete(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ $class, array $fetchedLocalPropertyNameToTypes) : array
    {
