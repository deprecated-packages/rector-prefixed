 ...
 */
final class ArrayKeysAndInArrayToArrayKeyExistsRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Replace array_keys() and in_array() to array_key_exists()', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        ...
        $previousAssignArraysKeysFuncCall = $this->betterNodeFinder->findFirstPrevious($node, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($arrayVariable) : bool {
        ...
        if (!$previousAssignArraysKeysFuncCall instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign) {
            return null;
        }
    ...
    private function createArrayKeyExists(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall $inArrayFuncCall, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall $arrayKeysFuncCall) : \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall
    {
        $arguments = [$inArrayFuncCall->args[0], $arrayKeysFuncCall->args[0]];
        return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall(new \_PhpScoper0a6b37af0871\PhpParser\Node\Name('array_key_exists'), $arguments);
    }
}
