 ...
 */
final class SplitListAssignToSeparateLineRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Splits `[$a, $b] = [5, 10]` scalar assign to standalone lines', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$assign->var instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr\Array_ && !$assign->var instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr\List_) {
            return \true;
        }
        if (!$assign->expr instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr\Array_) {
            return \true;
        }
     ...
     * @return Assign[]
     */
    private function createStandaloneAssigns(\_PhpScopere8e811afab72\PhpParser\Node $node, \_PhpScopere8e811afab72\PhpParser\Node\Expr\Array_ $rightArray) : array
    {
        $standaloneAssigns = [];
        foreach ($node->items as $key => $leftArrayItem) {
            ...
            $standaloneAssigns[] = new \_PhpScopere8e811afab72\PhpParser\Node\Expr\Assign($leftArrayItem->value, $rightArrayItem);
        }
     ...
     * @param Array_|List_ $node
     */
    private function getArrayItemsHash(\_PhpScopere8e811afab72\PhpParser\Node $node) : string
    {
        $arrayItemsHashes = [];
