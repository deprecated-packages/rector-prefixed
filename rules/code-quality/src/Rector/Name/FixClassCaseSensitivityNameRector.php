...
namespace _PhpScoper0a6b37af0871\Rector\CodeQuality\Rector\Name;
 ...
 */
final class FixClassCaseSensitivityNameRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change miss-typed case sensitivity name to correct one', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        ...
        if ($parent instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\UseUse) {
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Name($realClassName);
        }
        return new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($realClassName);
    }
    private function resolveFullyQualifiedName(\_PhpScoper0a6b37af0871\PhpParser\Node\Name $name) : string
    {
        $parent = $name->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
        // for some reason, Param gets already corrected name
        if (!$parent instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Param && !$parent instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\ClassConstFetch) {
            return $this->getName($name);
        }
        /** @var Name|null $originalName */
        $originalName = $name->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::ORIGINAL_NAME);
