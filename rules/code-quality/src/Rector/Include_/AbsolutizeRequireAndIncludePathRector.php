...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        // skip phar
        if (\RectorPrefix20210115\Nette\Utils\Strings::startsWith($includeValue, 'phar://')) {
            return null;
        }
        // add preslash to string
        // keep dots
        if (!\RectorPrefix20210115\Nette\Utils\Strings::startsWith($includeValue, '/') && !\RectorPrefix20210115\Nette\Utils\Strings::startsWith($includeValue, '.')) {
