...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        // skip phar
        if (\_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::startsWith($includeValue, 'phar://')) {
            return null;
        }
        // add preslash to string
        // keep dots
        if (!\_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::startsWith($includeValue, '/') && !\_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::startsWith($includeValue, '.')) {
