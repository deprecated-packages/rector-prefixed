...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        // skip phar
        if (\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::startsWith($includeValue, 'phar://')) {
            return null;
        }
        // add preslash to string
        // keep dots
        if (!\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::startsWith($includeValue, '/') && !\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::startsWith($includeValue, '.')) {
