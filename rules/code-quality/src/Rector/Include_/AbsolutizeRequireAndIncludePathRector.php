...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        // skip phar
        if (\_PhpScoper267b3276efc2\Nette\Utils\Strings::startsWith($includeValue, 'phar://')) {
            return null;
        }
        // add preslash to string
        // keep dots
        if (!\_PhpScoper267b3276efc2\Nette\Utils\Strings::startsWith($includeValue, '/') && !\_PhpScoper267b3276efc2\Nette\Utils\Strings::startsWith($includeValue, '.')) {
