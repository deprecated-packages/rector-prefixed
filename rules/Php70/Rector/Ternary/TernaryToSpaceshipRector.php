...
CODE_SAMPLE
     ...
     */
    private function processSmallerThanTernary(Ternary $node, Ternary $nestedTernary)
    {
     ...
     * @return \PhpParser\Node\Expr\BinaryOp\Spaceship|null
     */
    private function processGreaterThanTernary(Ternary $node, Ternary $nestedTernary)
    {
