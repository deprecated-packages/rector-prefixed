...
final class EregToPregMatchRector extends AbstractRector
{
     ...
     * @return void
     */
    private function processStringPattern(FuncCall $funcCall, String_ $string, string $functionName)
    {
     ...
     * @return void
     */
    private function processVariablePattern(FuncCall $funcCall, Variable $variable, string $functionName)
    {
     ...
     * @return void
     */
    private function processSplitLimitArgument(FuncCall $funcCall, string $functionName)
    {
