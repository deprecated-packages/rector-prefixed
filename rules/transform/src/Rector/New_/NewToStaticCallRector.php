...
namespace _PhpScoper0a6b37af0871\Rector\Transform\Rector\New_;
 ...
 */
final class NewToStaticCallRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector implements \_PhpScoper0a6b37af0871\Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    /**
     * @var string
     */
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change new Object to static call', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
...
CODE_SAMPLE
, [self::TYPE_TO_STATIC_CALLS => [new \_PhpScoper0a6b37af0871\Rector\Transform\ValueObject\NewToStaticCall('Cookie', 'Cookie', 'create')]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScoper0a6b37af0871\Webmozart\Assert\Assert::allIsInstanceOf($typeToStaticCalls, \_PhpScoper0a6b37af0871\Rector\Transform\ValueObject\NewToStaticCall::class);
