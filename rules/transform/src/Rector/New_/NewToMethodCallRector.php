...
, [self::NEWS_TO_METHOD_CALLS => [new \Rector\Transform\ValueObject\NewToMethodCall('MyClass', 'MyClassFactory', 'create')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20210220\Webmozart\Assert\Assert::allIsInstanceOf($newsToMethodCalls, \Rector\Transform\ValueObject\NewToMethodCall::class);
    ...
    private function getFactoryPropertyName(string $factoryFullQualifiedName) : string
    {
        ...
        return \RectorPrefix20210220\Nette\Utils\Strings::firstLower($shortName);
    }
}
