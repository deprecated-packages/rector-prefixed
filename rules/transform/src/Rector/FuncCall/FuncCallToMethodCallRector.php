 ...
 */
final class FuncCallToMethodCallRector extends \_PhpScoper0a2ac50786fa\Rector\Generic\Rector\AbstractToMethodCallRector
{
    /**
     * @var string
     */
    ...
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Turns defined function calls to local method calls.', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
...
CODE_SAMPLE
, [self::FUNC_CALL_TO_CLASS_METHOD_CALL => [new \_PhpScoper0a2ac50786fa\Rector\Transform\ValueObject\FuncNameToMethodCallName('view', '_PhpScoper0a2ac50786fa\\Namespaced\\SomeRenderer', 'render')]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScoper0a2ac50786fa\Webmozart\Assert\Assert::allIsInstanceOf($funcCallsToClassMethodCalls, \_PhpScoper0a2ac50786fa\Rector\Transform\ValueObject\FuncNameToMethodCallName::class);
