...
CODE_SAMPLE
     ...
     */
    private function findConnectionVariable(FuncCall $funcCall)
    {
     ...
     * @return void
     */
    private function removeExistingConnectionParameter(FuncCall $funcCall)
    {
