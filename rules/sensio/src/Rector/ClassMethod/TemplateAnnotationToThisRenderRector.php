...
final class TemplateAnnotationToThisRenderRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const RESPONSE_CLASS = '_PhpScoper5b8c9e9ebd21\\Symfony\\Component\\HttpFoundation\\Response';
    /**
...
CODE_SAMPLE
    ...
    private function addAbstractControllerParentClassIfMissing(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        $class->extends = new \PhpParser\Node\Name\FullyQualified('_PhpScoper5b8c9e9ebd21\\Symfony\\Bundle\\FrameworkBundle\\Controller\\AbstractController');
        return $class;
    }
