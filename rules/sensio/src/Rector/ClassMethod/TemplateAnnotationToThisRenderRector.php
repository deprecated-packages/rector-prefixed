...
final class TemplateAnnotationToThisRenderRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const RESPONSE_CLASS = '_PhpScoperbf340cb0be9d\\Symfony\\Component\\HttpFoundation\\Response';
    /**
...
CODE_SAMPLE
    ...
    private function addAbstractControllerParentClassIfMissing(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        $class->extends = new \PhpParser\Node\Name\FullyQualified('_PhpScoperbf340cb0be9d\\Symfony\\Bundle\\FrameworkBundle\\Controller\\AbstractController');
        return $class;
    }
