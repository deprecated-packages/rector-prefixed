...
use _PhpScopere8e811afab72\Rector\NetteCodeQuality\NodeResolver\FormVariableInputNameTypeResolver;
 ...
 */
final class ChangeFormArrayAccessToAnnotatedControlVariableRector extends \_PhpScopere8e811afab72\Rector\NetteCodeQuality\Rector\ArrayDimFetch\AbstractArrayDimFetchToAnnotatedControlVariableRector
{
    /**
     * @var FormVariableInputNameTypeResolver
     */
    private $formVariableInputNameTypeResolver;
    public function __construct(\_PhpScopere8e811afab72\Rector\NetteCodeQuality\NodeResolver\FormVariableInputNameTypeResolver $formVariableInputNameTypeResolver)
    {
        $this->formVariableInputNameTypeResolver = $formVariableInputNameTypeResolver;
    }
    public function getRuleDefinition() : \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change array access magic on $form to explicit standalone typed variable', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScopere8e811afab72\PhpParser\Node $node) : ?\_PhpScopere8e811afab72\PhpParser\Node
    {
        ...
        if ($this->hasParentTypes($node, [\_PhpScopere8e811afab72\PhpParser\Node\Expr\Isset_::class, \_PhpScopere8e811afab72\PhpParser\Node\Stmt\Unset_::class])) {
            return null;
        }
        ...
        $controlObjectType = new \_PhpScopere8e811afab72\PHPStan\Type\ObjectType($controlType);
        $this->addAssignExpressionForFirstCase($controlVariableName, $node, $controlObjectType);
        return new \_PhpScopere8e811afab72\PhpParser\Node\Expr\Variable($controlVariableName);
    }
}
