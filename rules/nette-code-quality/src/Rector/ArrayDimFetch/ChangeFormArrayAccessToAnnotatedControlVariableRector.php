...
use _PhpScoper0a6b37af0871\Rector\NetteCodeQuality\NodeResolver\FormVariableInputNameTypeResolver;
 ...
 */
final class ChangeFormArrayAccessToAnnotatedControlVariableRector extends \_PhpScoper0a6b37af0871\Rector\NetteCodeQuality\Rector\ArrayDimFetch\AbstractArrayDimFetchToAnnotatedControlVariableRector
{
    /**
     * @var FormVariableInputNameTypeResolver
     */
    private $formVariableInputNameTypeResolver;
    public function __construct(\_PhpScoper0a6b37af0871\Rector\NetteCodeQuality\NodeResolver\FormVariableInputNameTypeResolver $formVariableInputNameTypeResolver)
    {
        $this->formVariableInputNameTypeResolver = $formVariableInputNameTypeResolver;
    }
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change array access magic on $form to explicit standalone typed variable', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        ...
        if ($this->hasParentTypes($node, [\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Isset_::class, \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Unset_::class])) {
            return null;
        }
        ...
        $controlObjectType = new \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectType($controlType);
        $this->addAssignExpressionForFirstCase($controlVariableName, $node, $controlObjectType);
        return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable($controlVariableName);
    }
}
