...
CODE_SAMPLE
    ...
    private function isAssignOfControlToPresenterDimFetch(\PhpParser\Node\Expr\Assign $assign) : bool
    {
        ...
        if (!$this->isObjectType($assign->expr, '_PhpScoperbd5d0c5f7638\\Nette\\Application\\UI\\Control')) {
            return \false;
        }
        ...
        return $this->isObjectType($arrayDimFetch->var, '_PhpScoperbd5d0c5f7638\\Nette\\Application\\UI\\Presenter');
    }
}
