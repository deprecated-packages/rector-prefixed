...
CODE_SAMPLE
    ...
    {
        if ($this->isOnClassMethodCall($expr, '_PhpScoperfce0de0de1ce\\Nette\\Application\\UI\\Control', 'getComponent')) {
            return \true;
        }
    ...
    private function isArrayDimFetchStringOnControlVariable(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return \is_a($varStaticType->getClassName(), '_PhpScoperfce0de0de1ce\\Nette\\Application\\UI\\Control', \true);
    }
