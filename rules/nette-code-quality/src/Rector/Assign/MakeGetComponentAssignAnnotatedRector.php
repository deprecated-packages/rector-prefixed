...
CODE_SAMPLE
    ...
    {
        if ($this->isOnClassMethodCall($expr, '_PhpScoper567b66d83109\\Nette\\Application\\UI\\Control', 'getComponent')) {
            return \true;
        }
    ...
    private function isArrayDimFetchStringOnControlVariable(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return \is_a($varStaticType->getClassName(), '_PhpScoper567b66d83109\\Nette\\Application\\UI\\Control', \true);
    }
