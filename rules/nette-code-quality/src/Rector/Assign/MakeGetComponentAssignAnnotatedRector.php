...
CODE_SAMPLE
    ...
    {
        if ($this->isOnClassMethodCall($expr, '_PhpScoper267b3276efc2\\Nette\\Application\\UI\\Control', 'getComponent')) {
            return \true;
        }
    ...
    private function isArrayDimFetchStringOnControlVariable(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return \is_a($varStaticType->getClassName(), '_PhpScoper267b3276efc2\\Nette\\Application\\UI\\Control', \true);
    }
