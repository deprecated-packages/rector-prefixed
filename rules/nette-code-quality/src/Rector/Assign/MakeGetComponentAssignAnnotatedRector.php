...
CODE_SAMPLE
    ...
    {
        if ($this->isOnClassMethodCall($expr, 'RectorPrefix2020DecSat\\Nette\\Application\\UI\\Control', 'getComponent')) {
            return \true;
        }
    ...
    private function isArrayDimFetchStringOnControlVariable(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return \is_a($varStaticType->getClassName(), 'RectorPrefix2020DecSat\\Nette\\Application\\UI\\Control', \true);
    }
