...
CODE_SAMPLE
    ...
    {
        if ($this->isOnClassMethodCall($expr, '_PhpScoperabd03f0baf05\\Nette\\Application\\UI\\Control', 'getComponent')) {
            return \true;
        }
    ...
    private function isArrayDimFetchStringOnControlVariable(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return \is_a($varStaticType->getClassName(), '_PhpScoperabd03f0baf05\\Nette\\Application\\UI\\Control', \true);
    }
