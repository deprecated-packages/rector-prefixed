...
final class ClassMethodFormTypeResolver implements \_PhpScoper0a6b37af0871\Rector\NetteCodeQuality\Contract\FormControlTypeResolverInterface, \_PhpScoper0a6b37af0871\Rector\NetteCodeQuality\Contract\MethodNamesByInputNamesResolverAwareInterface
{
    /**
    ...
    public function resolve(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : array
    {
        ...
        $lastReturn = $this->betterNodeFinder->findLastInstanceOf((array) $node->stmts, \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Return_::class);
        if ($lastReturn === null) {
            return [];
        }
        if (!$lastReturn->expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable) {
            return [];
        }
