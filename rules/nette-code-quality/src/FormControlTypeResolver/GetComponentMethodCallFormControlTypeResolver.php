...
final class GetComponentMethodCallFormControlTypeResolver implements \_PhpScoper0a6b37af0871\Rector\NetteCodeQuality\Contract\FormControlTypeResolverInterface, \_PhpScoper0a6b37af0871\Rector\NetteCodeQuality\Contract\MethodNamesByInputNamesResolverAwareInterface
{
    /**
     * @var ValueResolver
     */
    ...
    public function resolve(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : array
    {
        ...
        $constructorClassMethod = $this->nodeRepository->findClassMethod($staticType->getClassName(), \_PhpScoper0a6b37af0871\Rector\Core\ValueObject\MethodName::CONSTRUCT);
    ...
    private function createCreateComponentMethodName(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall $methodCall) : string
    {
