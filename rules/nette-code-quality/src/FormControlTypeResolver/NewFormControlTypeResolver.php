...
final class NewFormControlTypeResolver implements \_PhpScopere8e811afab72\Rector\NetteCodeQuality\Contract\FormControlTypeResolverInterface, \_PhpScopere8e811afab72\Rector\NetteCodeQuality\Contract\MethodNamesByInputNamesResolverAwareInterface
{
    /**
    ...
    public function resolve(\_PhpScopere8e811afab72\PhpParser\Node $node) : array
    {
        ...
        $constructorClassMethod = $this->nodeRepository->findClassMethod($className, \_PhpScopere8e811afab72\Rector\Core\ValueObject\MethodName::CONSTRUCT);
