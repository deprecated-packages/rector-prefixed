...
final class NewFormControlTypeResolver implements \_PhpScoperb75b35f52b74\Rector\NetteCodeQuality\Contract\FormControlTypeResolverInterface, \_PhpScoperb75b35f52b74\Rector\NetteCodeQuality\Contract\MethodNamesByInputNamesResolverAwareInterface
{
    /**
    ...
    public function resolve(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : array
    {
        ...
        $constructorClassMethod = $this->nodeRepository->findClassMethod($className, \_PhpScoperb75b35f52b74\Rector\Core\ValueObject\MethodName::CONSTRUCT);
