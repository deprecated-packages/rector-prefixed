...
final class ControlDimFetchAnalyzer
{
    ...
    {
        return $this->matchNameOnVariableTypes($node, ['_PhpScoper5b8c9e9ebd21\\Nette\\Application\\UI\\Form']);
    }
    public function matchNameOnControlVariable(\PhpParser\Node $node) : ?string
    {
        return $this->matchNameOnVariableTypes($node, ['_PhpScoper5b8c9e9ebd21\\Nette\\Application\\UI\\Control']);
    }
    public function matchName(\PhpParser\Node $node) : ?string
    {
        ...
        if (!$this->isVariableTypes($node->var, ['_PhpScoper5b8c9e9ebd21\\Nette\\ComponentModel\\IContainer'])) {
            return null;
        }
