...
final class ControlDimFetchAnalyzer
{
    ...
    {
        return $this->matchNameOnVariableTypes($node, ['RectorPrefix20201228\\Nette\\Application\\UI\\Form']);
    }
    public function matchNameOnControlVariable(\PhpParser\Node $node) : ?string
    {
        return $this->matchNameOnVariableTypes($node, ['RectorPrefix20201228\\Nette\\Application\\UI\\Control']);
    }
    public function matchName(\PhpParser\Node $node) : ?string
    {
        ...
        if (!$this->isVariableTypes($node->var, ['RectorPrefix20201228\\Nette\\ComponentModel\\IContainer'])) {
            return null;
        }
