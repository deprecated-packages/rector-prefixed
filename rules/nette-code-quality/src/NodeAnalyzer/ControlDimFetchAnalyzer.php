...
final class ControlDimFetchAnalyzer
{
    ...
    {
        return $this->matchNameOnVariableTypes($node, ['_PhpScoperf18a0c41e2d2\\Nette\\Application\\UI\\Form']);
    }
    public function matchNameOnControlVariable(\PhpParser\Node $node) : ?string
    {
        return $this->matchNameOnVariableTypes($node, ['_PhpScoperf18a0c41e2d2\\Nette\\Application\\UI\\Control']);
    }
    public function matchName(\PhpParser\Node $node) : ?string
    {
        ...
        if (!$this->isVariableTypes($node->var, ['_PhpScoperf18a0c41e2d2\\Nette\\ComponentModel\\IContainer'])) {
            return null;
        }
