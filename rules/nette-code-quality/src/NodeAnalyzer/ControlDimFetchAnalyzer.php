...
final class ControlDimFetchAnalyzer
{
    ...
    {
        return $this->matchNameOnVariableTypes($node, ['_PhpScoperbf340cb0be9d\\Nette\\Application\\UI\\Form']);
    }
    public function matchNameOnControlVariable(\PhpParser\Node $node) : ?string
    {
        return $this->matchNameOnVariableTypes($node, ['_PhpScoperbf340cb0be9d\\Nette\\Application\\UI\\Control']);
    }
    public function matchName(\PhpParser\Node $node) : ?string
    {
        ...
        if (!$this->isVariableTypes($node->var, ['_PhpScoperbf340cb0be9d\\Nette\\ComponentModel\\IContainer'])) {
            return null;
        }
