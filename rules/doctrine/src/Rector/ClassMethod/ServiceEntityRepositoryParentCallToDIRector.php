...
final class ServiceEntityRepositoryParentCallToDIRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const SERVICE_ENTITY_REPOSITORY_CLASS = 'RectorPrefix20201226\\Doctrine\\Bundle\\DoctrineBundle\\Repository\\ServiceEntityRepository';
    /**
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $this->addServiceConstructorDependencyToClass($classLike, 'RectorPrefix20201226\\Doctrine\\ORM\\EntityManagerInterface');
        return $node;
    }
