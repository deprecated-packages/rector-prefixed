...
final class ServiceEntityRepositoryParentCallToDIRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const SERVICE_ENTITY_REPOSITORY_CLASS = '_PhpScopera143bcca66cb\\Doctrine\\Bundle\\DoctrineBundle\\Repository\\ServiceEntityRepository';
    /**
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $this->addServiceConstructorDependencyToClass($classLike, '_PhpScopera143bcca66cb\\Doctrine\\ORM\\EntityManagerInterface');
        return $node;
    }
