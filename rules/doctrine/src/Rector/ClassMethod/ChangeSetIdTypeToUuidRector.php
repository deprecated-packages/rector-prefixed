...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($node->params[0]->type !== null) {
            ...
            if ($currentType === \_PhpScoper5b8c9e9ebd21\Ramsey\Uuid\UuidInterface::class) {
                return null;
            }
        }
        $node->params[0]->type = new \PhpParser\Node\Name\FullyQualified(\_PhpScoper5b8c9e9ebd21\Ramsey\Uuid\UuidInterface::class);
        return $node;
    }
