...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($node->params[0]->type !== null) {
            ...
            if ($currentType === \_PhpScoper5edc98a7cce2\Ramsey\Uuid\UuidInterface::class) {
                return null;
            }
        }
        $node->params[0]->type = new \PhpParser\Node\Name\FullyQualified(\_PhpScoper5edc98a7cce2\Ramsey\Uuid\UuidInterface::class);
        return $node;
    }
