...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($node->params[0]->type !== null) {
            ...
            if ($currentType === \RectorPrefix20210129\Ramsey\Uuid\UuidInterface::class) {
                return null;
            }
        }
        $node->params[0]->type = new \PhpParser\Node\Name\FullyQualified(\RectorPrefix20210129\Ramsey\Uuid\UuidInterface::class);
        return $node;
    }
