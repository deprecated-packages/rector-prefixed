...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $node->returnType = new \PhpParser\Node\Name\FullyQualified(\_PhpScoperabd03f0baf05\Ramsey\Uuid\UuidInterface::class);
        return $node;
    }
    private function hasUuidReturnType(\PhpParser\Node $node) : bool
    {
        ...
        return $this->isName($node->returnType, \_PhpScoperabd03f0baf05\Ramsey\Uuid\UuidInterface::class);
    }
}
