...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $node->returnType = new \PhpParser\Node\Name\FullyQualified(\RectorPrefix20210206\Ramsey\Uuid\UuidInterface::class);
        return $node;
    }
    private function hasUuidReturnType(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        return $this->isName($classMethod->returnType, \RectorPrefix20210206\Ramsey\Uuid\UuidInterface::class);
    }
}
