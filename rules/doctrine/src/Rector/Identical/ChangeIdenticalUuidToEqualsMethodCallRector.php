...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $staticCall = $this->createStaticCall(\_PhpScoper5edc98a7cce2\Ramsey\Uuid\Uuid::class, 'fromString', [$comparedVariable]);
    ...
    private function isAlreadyUuidType(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return $comparedValueObjectType->getClassName() === \_PhpScoper5edc98a7cce2\Ramsey\Uuid\UuidInterface::class;
    }
}
