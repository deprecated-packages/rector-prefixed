...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $staticCall = $this->createStaticCall(\RectorPrefix20210110\Ramsey\Uuid\Uuid::class, 'fromString', [$comparedVariable]);
    ...
    private function isAlreadyUuidType(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return $comparedValueObjectType->getClassName() === \RectorPrefix20210110\Ramsey\Uuid\UuidInterface::class;
    }
}
