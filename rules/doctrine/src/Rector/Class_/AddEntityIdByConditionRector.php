...
use _PhpScoper0a6b37af0871\Rector\Doctrine\NodeFactory\EntityIdNodeFactory;
 ...
 */
final class AddEntityIdByConditionRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector implements \_PhpScoper0a6b37af0871\Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    /**
     * @var string
     */
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Add entity id with annotations when meets condition', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    use SomeTrait;
}
...
CODE_SAMPLE
, [self::DETECTED_TRAITS => ['_PhpScoper0a6b37af0871\\Knp\\DoctrineBehaviors\\Model\\Translatable\\Translation', '_PhpScoper0a6b37af0871\\Knp\\DoctrineBehaviors\\Model\\Translatable\\TranslationTrait']])]);
    }
    /**
     * @return string[]
     */
    ...
    private function shouldSkip(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ $class) : bool
    {
    ...
    private function isTraitMatch(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ $class) : bool
    {
