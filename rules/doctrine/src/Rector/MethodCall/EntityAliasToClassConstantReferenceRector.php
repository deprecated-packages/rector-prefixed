...
use _PhpScoperbf340cb0be9d\Doctrine\Common\Persistence\ManagerRegistry as DeprecatedManagerRegistry;
use _PhpScoperbf340cb0be9d\Doctrine\Common\Persistence\ObjectManager as DeprecatedObjectManager;
use _PhpScoperbf340cb0be9d\Doctrine\ORM\EntityManagerInterface;
use _PhpScoperbf340cb0be9d\Doctrine\Persistence\ManagerRegistry;
use _PhpScoperbf340cb0be9d\Doctrine\Persistence\ObjectManager;
...
final class EntityAliasToClassConstantReferenceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @var string[]
     */
    private const ALLOWED_OBJECT_TYPES = [\_PhpScoperbf340cb0be9d\Doctrine\ORM\EntityManagerInterface::class, \_PhpScoperbf340cb0be9d\Doctrine\Persistence\ObjectManager::class, \_PhpScoperbf340cb0be9d\Doctrine\Common\Persistence\ObjectManager::class, \_PhpScoperbf340cb0be9d\Doctrine\Persistence\ManagerRegistry::class, \_PhpScoperbf340cb0be9d\Doctrine\Common\Persistence\ManagerRegistry::class];
    /**
     * @var string[]
     */
...
CODE_SAMPLE
, [self::ALIASES_TO_NAMESPACES => ['App' => '_PhpScoperbf340cb0be9d\\App\\Entity']])]);
    }
    /**
     * @return string[]
     */
    ...
    {
        return \_PhpScoperbf340cb0be9d\Nette\Utils\Strings::contains($name, ':');
    }
