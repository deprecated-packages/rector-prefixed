...
use RectorPrefix20210121\Doctrine\Common\Persistence\ManagerRegistry as DeprecatedManagerRegistry;
use RectorPrefix20210121\Doctrine\Common\Persistence\ObjectManager as DeprecatedObjectManager;
use RectorPrefix20210121\Doctrine\ORM\EntityManagerInterface;
use RectorPrefix20210121\Doctrine\Persistence\ManagerRegistry;
use RectorPrefix20210121\Doctrine\Persistence\ObjectManager;
...
final class EntityAliasToClassConstantReferenceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @var string[]
     */
    private const ALLOWED_OBJECT_TYPES = [\RectorPrefix20210121\Doctrine\ORM\EntityManagerInterface::class, \RectorPrefix20210121\Doctrine\Persistence\ObjectManager::class, \RectorPrefix20210121\Doctrine\Common\Persistence\ObjectManager::class, \RectorPrefix20210121\Doctrine\Persistence\ManagerRegistry::class, \RectorPrefix20210121\Doctrine\Common\Persistence\ManagerRegistry::class];
    /**
     * @var string[]
     */
...
, [self::ALIASES_TO_NAMESPACES => ['App' => 'App\\Entity']])]);
    ...
    {
        return \RectorPrefix20210121\Nette\Utils\Strings::contains($name, ':');
    }
