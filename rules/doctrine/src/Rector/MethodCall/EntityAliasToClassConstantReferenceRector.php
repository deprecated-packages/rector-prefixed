...
use _PhpScoperf18a0c41e2d2\Doctrine\Common\Persistence\ManagerRegistry as DeprecatedManagerRegistry;
use _PhpScoperf18a0c41e2d2\Doctrine\Common\Persistence\ObjectManager as DeprecatedObjectManager;
use _PhpScoperf18a0c41e2d2\Doctrine\ORM\EntityManagerInterface;
use _PhpScoperf18a0c41e2d2\Doctrine\Persistence\ManagerRegistry;
use _PhpScoperf18a0c41e2d2\Doctrine\Persistence\ObjectManager;
...
final class EntityAliasToClassConstantReferenceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @var string[]
     */
    private const ALLOWED_OBJECT_TYPES = [\_PhpScoperf18a0c41e2d2\Doctrine\ORM\EntityManagerInterface::class, \_PhpScoperf18a0c41e2d2\Doctrine\Persistence\ObjectManager::class, \_PhpScoperf18a0c41e2d2\Doctrine\Common\Persistence\ObjectManager::class, \_PhpScoperf18a0c41e2d2\Doctrine\Persistence\ManagerRegistry::class, \_PhpScoperf18a0c41e2d2\Doctrine\Common\Persistence\ManagerRegistry::class];
    /**
     * @var string[]
     */
...
CODE_SAMPLE
, [self::ALIASES_TO_NAMESPACES => ['App' => '_PhpScoperf18a0c41e2d2\\App\\Entity']])]);
    }
    /**
     * @return string[]
     */
    ...
    {
        return \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::contains($name, ':');
    }
