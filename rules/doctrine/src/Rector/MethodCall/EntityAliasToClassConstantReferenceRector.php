...
use RectorPrefix20201228\Doctrine\Common\Persistence\ManagerRegistry as DeprecatedManagerRegistry;
use RectorPrefix20201228\Doctrine\Common\Persistence\ObjectManager as DeprecatedObjectManager;
use RectorPrefix20201228\Doctrine\ORM\EntityManagerInterface;
use RectorPrefix20201228\Doctrine\Persistence\ManagerRegistry;
use RectorPrefix20201228\Doctrine\Persistence\ObjectManager;
...
final class EntityAliasToClassConstantReferenceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @var string[]
     */
    private const ALLOWED_OBJECT_TYPES = [\RectorPrefix20201228\Doctrine\ORM\EntityManagerInterface::class, \RectorPrefix20201228\Doctrine\Persistence\ObjectManager::class, \RectorPrefix20201228\Doctrine\Common\Persistence\ObjectManager::class, \RectorPrefix20201228\Doctrine\Persistence\ManagerRegistry::class, \RectorPrefix20201228\Doctrine\Common\Persistence\ManagerRegistry::class];
    /**
     * @var string[]
     */
    ...
    {
        return new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Replaces doctrine alias with class.', [new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample(<<<'CODE_SAMPLE'
...
, [self::ALIASES_TO_NAMESPACES => ['App' => 'RectorPrefix20201228\\App\\Entity']])]);
    ...
    {
        return \RectorPrefix20201228\Nette\Utils\Strings::contains($name, ':');
    }
