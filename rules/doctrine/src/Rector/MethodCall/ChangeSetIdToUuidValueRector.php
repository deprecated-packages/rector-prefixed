...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($argumentValue instanceof \PhpParser\Node\Expr\ClassConstFetch) {
            ...
            $node->args[0]->value = $this->nodeFactory->createStaticCall(\RectorPrefix20210208\Ramsey\Uuid\Uuid::class, 'fromString', [$argumentValue]);
            return $node;
        }
        // C. set uuid from string with generated string
        $value = $this->nodeFactory->createStaticCall(\RectorPrefix20210208\Ramsey\Uuid\Uuid::class, 'fromString', [$this->createUuidStringNode()]);
    ...
    {
        $uuidValue = \RectorPrefix20210208\Ramsey\Uuid\Uuid::uuid4();
    ...
    private function isUuidType(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return $argumentStaticType->getClassName() === \RectorPrefix20210208\Ramsey\Uuid\Uuid::class;
    }
}
