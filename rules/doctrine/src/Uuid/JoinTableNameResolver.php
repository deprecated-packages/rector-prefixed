...
namespace _PhpScoper0a6b37af0871\Rector\Doctrine\Uuid;
...
final class JoinTableNameResolver
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Doctrine\PhpDocParser\DoctrineDocBlockResolver $doctrineDocBlockResolver)
    {
     ...
     */
    public function resolveManyToManyUuidTableNameForProperty(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property $property) : string
    {
    ...
    {
        if (!\_PhpScoper0a6b37af0871\Nette\Utils\Strings::contains($currentClass, '\\')) {
            return $currentClass;
        }
        return (string) \_PhpScoper0a6b37af0871\Nette\Utils\Strings::after($currentClass, '\\', -1);
    }
}
