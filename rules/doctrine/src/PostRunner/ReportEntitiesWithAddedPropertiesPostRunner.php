...
final class ReportEntitiesWithAddedPropertiesPostRunner implements \Rector\Core\Contract\PostRunnerInterface
{
    ...
    public function __construct(\RectorPrefix20210201\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210201\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Rector\Doctrine\Collector\UuidMigrationDataCollector $uuidMigrationDataCollector)
    {
    ...
    private function generatePropertiesJsonWithFileName(string $fileName, array $data) : void
    {
        ...
        $jsonContent = \RectorPrefix20210201\Nette\Utils\Json::encode(['new_columns_by_class' => $data], \RectorPrefix20210201\Nette\Utils\Json::PRETTY);
