...
namespace _PhpScoper0a6b37af0871\Rector\Doctrine\PostRunner;
 ...
 */
final class ReportEntitiesWithAddedPropertiesPostRunner implements \_PhpScoper0a6b37af0871\Rector\Core\Contract\PostRunnerInterface
{
    /**
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \_PhpScoper0a6b37af0871\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \_PhpScoper0a6b37af0871\Rector\Doctrine\Collector\UuidMigrationDataCollector $uuidMigrationDataCollector)
    {
    ...
    private function generatePropertiesJsonWithFileName(string $fileName, array $data) : void
    {
        ...
        $jsonContent = \_PhpScoper0a6b37af0871\Nette\Utils\Json::encode(['new_columns_by_class' => $data], \_PhpScoper0a6b37af0871\Nette\Utils\Json::PRETTY);
