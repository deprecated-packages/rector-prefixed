...
final class ReportEntitiesWithAddedPropertiesPostRunner implements \Rector\Core\Contract\PostRunnerInterface
{
    ...
    public function __construct(\RectorPrefix20210219\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210219\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Rector\Doctrine\Collector\UuidMigrationDataCollector $uuidMigrationDataCollector)
    {
    ...
    private function generatePropertiesJsonWithFileName(string $fileName, array $data) : void
    {
        ...
        $jsonContent = \RectorPrefix20210219\Nette\Utils\Json::encode(['new_columns_by_class' => $data], \RectorPrefix20210219\Nette\Utils\Json::PRETTY);
