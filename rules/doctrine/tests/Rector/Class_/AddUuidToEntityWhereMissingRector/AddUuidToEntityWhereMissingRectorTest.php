...
final class AddUuidToEntityWhereMissingRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\Doctrine\Rector\Class_\AddUuidToEntityWhereMissingRector::class;
    }
}
