...
final class RouteInfoFactory
{
     ...
     * @return \Rector\NetteToSymfony\ValueObject\RouteInfo|null
     */
    private function createRouteInfoFromArgs(Node $node, array $methods = [])
    {
     ...
     * @return \Rector\NetteToSymfony\ValueObject\RouteInfo|null
     */
    private function createForClassConstFetch(Node $node, array $methods, string $routePath)
    {
     ...
     * @return \Rector\NetteToSymfony\ValueObject\RouteInfo|null
     */
    private function createForString(String_ $string, string $routePath)
    {
