...
use RectorPrefix20210318\Symfony\Component\Form\AbstractType;
use RectorPrefix20210318\Symfony\Component\Form\Extension\Core\Type\TextType;
use RectorPrefix20210318\Symfony\Component\Form\FormBuilderInterface;
class SomeFormType extends \RectorPrefix20210318\Symfony\Component\Form\AbstractType
{
    public function buildForm(\RectorPrefix20210318\Symfony\Component\Form\FormBuilderInterface $formBuilder, array $options)
    {
        $formBuilder->add('name', \RectorPrefix20210318\Symfony\Component\Form\Extension\Core\Type\TextType::class, ['label' => 'Your name']);
    }
}
