...
final class ClassPropertyAssignToConstructorPromotionRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    /**
     * @param \Rector\Php80\NodeResolver\PromotedPropertyResolver $promotedPropertyResolver
     ...
     */
    public function __construct($promotedPropertyResolver, $variableRenamer, $varTagRemover, $phpDocTagRemover)
    {
