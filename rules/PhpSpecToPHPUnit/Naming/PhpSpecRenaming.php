...
final class PhpSpecRenaming
{
    ...
    public function __construct(\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210420\Symplify\PackageBuilder\Strings\StringFormatConverter $stringFormatConverter, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder)
    {
    ...
    public function renameMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod)
    {
        ...
        if (!\RectorPrefix20210420\Nette\Utils\Strings::startsWith($classMethodName, 'test')) {
