...
final class PhpSpecRenaming
{
    ...
    public function __construct(\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210505\Symplify\PackageBuilder\Strings\StringFormatConverter $stringFormatConverter, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder)
    {
    ...
    public function renameMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        ...
        if (!\RectorPrefix20210505\Nette\Utils\Strings::startsWith($classMethodName, 'test')) {
