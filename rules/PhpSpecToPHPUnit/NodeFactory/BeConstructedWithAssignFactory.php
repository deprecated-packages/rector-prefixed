...
final class BeConstructedWithAssignFactory
{
     ...
     */
    public function create(MethodCall $methodCall, string $testedClass, PropertyFetch $propertyFetch)
    {
     ...
     * @return void
     */
    private function moveConstructorArguments(MethodCall $methodCall, StaticCall $staticCall)
    {
