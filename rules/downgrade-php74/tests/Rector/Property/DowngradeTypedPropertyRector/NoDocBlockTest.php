...
final class NoDocBlockTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
     * @requires PHP 7.4
    ...
    {
        return [\Rector\DowngradePhp74\Rector\Property\DowngradeTypedPropertyRector::class => [\Rector\DowngradePhp74\Rector\Property\DowngradeTypedPropertyRector::ADD_DOC_BLOCK => \false]];
    }
