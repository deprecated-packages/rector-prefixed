...
final class DowngradeCovariantReturnTypeRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
     * @requires PHP 7.4
    ...
    {
        return \Rector\DowngradePhp74\Rector\ClassMethod\DowngradeCovariantReturnTypeRector::class;
    }
}
