...
namespace _PhpScoper0a2ac50786fa\Rector\DowngradePhp74\Rector\LNumber;
 ...
 */
final class DowngradeNumericLiteralSeparatorRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Remove "_" as thousands separator in numbers', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
         ...
         * Then, add it again.
         */
        if ($node instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Scalar\DNumber && !\_PhpScoper0a2ac50786fa\Nette\Utils\Strings::contains($node->value, '.')) {
            $node->value .= '.0';
        }
        return $node;
    }
     ...
     * @param LNumber|DNumber $node
     */
    public function shouldRefactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : bool
    {
        // "_" notation can be applied to decimal numbers only
        if ($node instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Scalar\LNumber) {
            return $node->getAttribute(\_PhpScoper0a2ac50786fa\Rector\NodeTypeResolver\Node\AttributeKey::KIND) === \_PhpScoper0a2ac50786fa\PhpParser\Node\Scalar\LNumber::KIND_DEC;
        }
        return \true;
    }
}
