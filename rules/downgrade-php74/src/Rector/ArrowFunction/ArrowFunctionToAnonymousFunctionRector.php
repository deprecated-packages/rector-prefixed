...
namespace _PhpScoper0a6b37af0871\Rector\DowngradePhp74\Rector\ArrowFunction;
...
use _PhpScoper0a6b37af0871\Rector\Php72\Rector\FuncCall\AbstractConvertToAnonymousFunctionRector;
 ...
 */
final class ArrowFunctionToAnonymousFunctionRector extends \_PhpScoper0a6b37af0871\Rector\Php72\Rector\FuncCall\AbstractConvertToAnonymousFunctionRector
{
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Replace arrow functions with anonymous functions', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
...
CODE_SAMPLE
    ...
    {
        return [new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Return_($node->expr)];
    }
}
