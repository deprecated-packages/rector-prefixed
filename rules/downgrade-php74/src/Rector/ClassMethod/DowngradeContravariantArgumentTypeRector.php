 ...
 */
final class DowngradeContravariantArgumentTypeRector extends \_PhpScopere8e811afab72\Rector\DowngradePhp70\Rector\FunctionLike\AbstractDowngradeParamDeclarationRector
{
    public function getRuleDefinition() : \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Remove contravariant argument type declarations', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class ParentType {}
...
CODE_SAMPLE
    ...
    private function getDifferentParamTypeFromAncestorClass(\_PhpScopere8e811afab72\PhpParser\Node\Param $param, \_PhpScopere8e811afab72\PhpParser\Node\FunctionLike $functionLike) : ?string
    {
        ...
        $isNullableType = $param->type instanceof \_PhpScopere8e811afab72\PhpParser\Node\NullableType;
        if ($isNullableType) {
            /** @var NullableType */
