...
final class ExtractAttributeRouteNameConstantsRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
     ...
     */
    public function test(\RectorPrefix20210126\Symplify\SmartFileSystem\SmartFileInfo $inputFile, string $expectedExtraFileName, string $expectedExtraContentFilePath) : void
    {
    ...
    {
        (yield [new \RectorPrefix20210126\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/fixture.php.inc'), 'src/ValueObject/Routing/RouteName.php', __DIR__ . '/Source/extra_file.php']);
    }
