...
final class RouteNameClassFactory
{
    ...
    {
        $classBuilder = new \RectorPrefix20210307\Symplify\Astral\ValueObject\NodeBuilder\ClassBuilder(\Rector\SymfonyCodeQuality\ValueObject\ClassName::ROUTE_CLASS_SHORT_NAME);
        ...
        $namespaceBuilder = new \RectorPrefix20210307\Symplify\Astral\ValueObject\NodeBuilder\NamespaceBuilder($namespaceName);
