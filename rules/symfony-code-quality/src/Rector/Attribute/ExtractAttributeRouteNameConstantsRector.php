...
final class ExtractAttributeRouteNameConstantsRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function __construct(\Rector\SymfonyCodeQuality\NodeFactory\RouteNameClassFactory $routeNameClassFactory, \Rector\SymfonyCodeQuality\ConstantNameAndValueMatcher $constantNameAndValueMatcher, \Rector\SymfonyCodeQuality\ConstantNameAndValueResolver $constantNameAndValueResolver, \RectorPrefix20210214\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
...
CODE_SAMPLE
    ...
    {
        if (!$this->isName($node->name, \RectorPrefix20210214\Symfony\Component\Routing\Annotation\Route::class)) {
            return null;
        }
    ...
    private function createRouteNameValueObject() : void
    {
        ...
        $routeAttributes = $this->nodeRepository->findAttributes(\RectorPrefix20210214\Symfony\Component\Routing\Annotation\Route::class);
