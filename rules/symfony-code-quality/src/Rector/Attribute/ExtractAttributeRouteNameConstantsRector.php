...
CODE_SAMPLE
    ...
    {
        if (!$this->isName($node->name, \RectorPrefix20210114\Symfony\Component\Routing\Annotation\Route::class)) {
            return null;
        }
    ...
    private function createRouteNameValueObject() : void
    {
        ...
        $routeAttributes = $this->nodeRepository->findAttributes(\RectorPrefix20210114\Symfony\Component\Routing\Annotation\Route::class);
