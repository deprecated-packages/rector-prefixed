...
CODE_SAMPLE
    ...
    private function getListenerClassesToEventsToMethods() : array
    {
        ...
        foreach ($eventListeners as $eventListener) {
            ...
            if (\RectorPrefix20201230\Nette\Utils\Strings::match((string) $eventListener->getClass(), self::SYMFONY_FAMILY_REGEX)) {
                continue;
            }
    ...
    private function changeListenerToSubscriberWithMethods(\PhpParser\Node\Stmt\Class_ $class, array $eventsToMethods) : \PhpParser\Node\Stmt\Class_
    {
        ...
        // remove suffix
        $classShortName = \RectorPrefix20201230\Nette\Utils\Strings::replace($classShortName, self::LISTENER_MATCH_REGEX, '$1');
