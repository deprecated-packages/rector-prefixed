...
use Iterator;
use RectorPrefix20210114\JMS\DiExtraBundle\Annotation\Inject;
...
final class InjectAnnotationClassRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    {
        return [\Rector\Generic\Rector\Property\InjectAnnotationClassRector::class => [\Rector\Generic\Rector\Property\InjectAnnotationClassRector::ANNOTATION_CLASSES => [\RectorPrefix20210114\JMS\DiExtraBundle\Annotation\Inject::class, \RectorPrefix20210114\DI\Annotation\Inject::class]]];
    }
}
