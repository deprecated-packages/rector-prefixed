...
namespace _PhpScoper0a2ac50786fa\Rector\Generic\Rector\ClassConst;
 ...
 */
final class ChangeConstantVisibilityRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector implements \_PhpScoper0a2ac50786fa\Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    /**
     * @var string
     */
    ...
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change visibility of constant from parent class.', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
, [self::CLASS_CONSTANT_VISIBILITY_CHANGES => [new \_PhpScoper0a2ac50786fa\Rector\Generic\ValueObject\ClassConstantVisibilityChange('ParentObject', 'SOME_CONSTANT', 'protected')]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScoper0a2ac50786fa\Webmozart\Assert\Assert::allIsInstanceOf($classConstantVisibilityChanges, \_PhpScoper0a2ac50786fa\Rector\Generic\ValueObject\ClassConstantVisibilityChange::class);
