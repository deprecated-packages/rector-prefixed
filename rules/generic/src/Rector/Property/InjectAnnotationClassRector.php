...
use RectorPrefix20210212\DI\Annotation\Inject as PHPDIInject;
use RectorPrefix20210212\JMS\DiExtraBundle\Annotation\Inject as JMSInject;
...
CODE_SAMPLE
, [self::ANNOTATION_CLASSES => [\RectorPrefix20210212\DI\Annotation\Inject::class, \RectorPrefix20210212\JMS\DiExtraBundle\Annotation\Inject::class]])]);
    }
    /**
     * @return string[]
     */
    ...
    private function isParameterInject(\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode $phpDocTagValueNode) : bool
    {
        ...
        return (bool) \RectorPrefix20210212\Nette\Utils\Strings::match($serviceName, self::BETWEEN_PERCENT_CHARS_REGEX);
    }
