...
use RectorPrefix20210127\JMS\DiExtraBundle\Annotation\Inject as JMSInject;
...
final class InjectAnnotationClassRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     */
    private const ANNOTATION_TO_TAG_CLASS = [\RectorPrefix20210127\DI\Annotation\Inject::class => \Rector\BetterPhpDocParser\ValueObject\PhpDocNode\PHPDI\PHPDIInjectTagValueNode::class, \RectorPrefix20210127\JMS\DiExtraBundle\Annotation\Inject::class => \Rector\BetterPhpDocParser\ValueObject\PhpDocNode\JMS\JMSInjectTagValueNode::class];
    /**
     * @var string
...
CODE_SAMPLE
, [self::ANNOTATION_CLASSES => [\RectorPrefix20210127\DI\Annotation\Inject::class, \RectorPrefix20210127\JMS\DiExtraBundle\Annotation\Inject::class]])]);
    }
    /**
     * @return string[]
     */
    ...
    private function isParameterInject(\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode $phpDocTagValueNode) : bool
    {
        ...
        return (bool) \RectorPrefix20210127\Nette\Utils\Strings::match($serviceName, self::BETWEEN_PERCENT_CHARS_REGEX);
    }
