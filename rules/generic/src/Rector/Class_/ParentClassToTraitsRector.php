...
final class ParentClassToTraitsRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    {
        return new \RectorPrefix20201227\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Replaces parent class to specific traits', [new \RectorPrefix20201227\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
, [self::PARENT_CLASS_TO_TRAITS => ['RectorPrefix20201227\\Nette\\Object' => ['RectorPrefix20201227\\Nette\\SmartObject']]])]);
    }
    /**
     * @return string[]
     */
