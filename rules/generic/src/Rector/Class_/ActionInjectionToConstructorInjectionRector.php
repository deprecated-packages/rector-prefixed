 ...
 */
final class ActionInjectionToConstructorInjectionRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Symfony\ServiceMapProvider $applicationServiceMapProvider, \_PhpScoper0a6b37af0871\Rector\Core\Configuration\Collector\VariablesToPropertyFetchCollection $variablesToPropertyFetchCollection)
    {
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Turns action injection in Controllers to constructor injection', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function isActionInjectedParamNode(\_PhpScoper0a6b37af0871\PhpParser\Node\Param $param) : bool
    {
        if ($param->type === null) {
            return \false;
        }
        ...
        if (!$paramStaticType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectType) {
            return \false;
        }
