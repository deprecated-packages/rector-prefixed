...
CODE_SAMPLE
, [self::SINGLES_TO_MANY_METHODS => [new \Rector\Generic\ValueObject\SingleToManyMethod('SomeClass', 'getNode', 'getNodes')]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20210220\Webmozart\Assert\Assert::allIsInstanceOf($singleToManyMethods, \Rector\Generic\ValueObject\SingleToManyMethod::class);
