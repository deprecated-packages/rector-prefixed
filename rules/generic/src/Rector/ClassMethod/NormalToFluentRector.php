...
final class NormalToFluentRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    {
        return new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Turns fluent interface calls to classic ones.', [new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample(<<<'CODE_SAMPLE'
...
, [self::CALLS_TO_FLUENT => [new \Rector\Generic\ValueObject\NormalToFluent('SomeClass', ['someFunction', 'otherFunction'])]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20201228\Webmozart\Assert\Assert::allIsInstanceOf($callsToFluent, \Rector\Generic\ValueObject\NormalToFluent::class);
