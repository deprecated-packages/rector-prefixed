...
final class RenameClassConstantsUseToStringsRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    {
        $configuration = [self::CLASS_CONST_FETCHES_TO_VALUES => [new \Rector\Generic\ValueObject\ClassConstFetchToValue('Nette\\Configurator', 'DEVELOPMENT', 'development'), new \Rector\Generic\ValueObject\ClassConstFetchToValue('Nette\\Configurator', 'PRODUCTION', 'production')]];
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20210128\Webmozart\Assert\Assert::allIsInstanceOf($classConstFetchesToValues, \Rector\Generic\ValueObject\ClassConstFetchToValue::class);
