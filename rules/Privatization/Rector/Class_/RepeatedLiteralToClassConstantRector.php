...
CODE_SAMPLE
     ...
     * @return void
     */
    private function replaceStringsWithClassConstReferences(Class_ $class, array $stringsToReplace)
    {
     ...
     * @return void
     */
    private function addClassConsts(array $stringsToReplace, Class_ $class)
    {
