...
final class PrivatizeLocalClassConstantRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Caching\Contract\Rector\ZeroCacheRectorInterface
{
    ...
    /**
     * @param \Rector\Privatization\NodeFinder\ParentClassConstantNodeFinder $parentClassConstantNodeFinder
     * @param \Rector\Privatization\Reflection\ParentConstantReflectionResolver $parentConstantReflectionResolver
     */
    public function __construct($parentClassConstantNodeFinder, $parentConstantReflectionResolver)
    {
