...
final class PSR4NamespaceMatcher implements \Rector\PSR4\Contract\PSR4AutoloadNamespaceMatcherInterface
{
     ...
     */
    private function resolveExtraNamespace(\RectorPrefix20210325\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $path) : string
    {
        $extraNamespace = \RectorPrefix20210325\Nette\Utils\Strings::substring($smartFileInfo->getRelativeDirectoryPath(), \RectorPrefix20210325\Nette\Utils\Strings::length($path) + 1);
        $extraNamespace = \RectorPrefix20210325\Nette\Utils\Strings::replace($extraNamespace, '#/#', '\\');
