...
final class PSR4AutoloadPathsProvider
{
    ...
    public function __construct(\RectorPrefix20210507\Symplify\SmartFileSystem\Json\JsonFileSystem $jsonFileSystem)
    {
    ...
    public function provide() : array
    {
        ...
        $psr4Autoloads = \array_merge($composerJson[\RectorPrefix20210507\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD]['psr-4'] ?? [], $composerJson[\RectorPrefix20210507\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV]['psr-4'] ?? []);
