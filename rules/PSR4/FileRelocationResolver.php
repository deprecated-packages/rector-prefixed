...
final class FileRelocationResolver
{
     ...
     */
    public function createNewFileDestination(\RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $suffixName, array $groupNames) : string
    {
    ...
    public function resolveNewFileLocationFromOldClassToNewClass(\RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $oldClass, string $newClass) : string
    {
     ...
     * @param string[] $groupNames
     */
    private function resolveRootDirectory(\RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $suffixName, array $groupNames) : string
    {
     ...
     */
    private function replaceRelativeFilePathsWithBeforeAfter(\RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo $oldSmartFileInfo, array $beforeToAfterPart) : string
    {
        // A. first "dir has changed" dummy detection
        $relativeFilePathParts = \RectorPrefix20210402\Nette\Utils\Strings::split($oldSmartFileInfo->getRelativeFilePath(), '#' . \DIRECTORY_SEPARATOR . '#');
