...
CODE_SAMPLE
    ...
    private function createClassLikeFileDestination(\PhpParser\Node\Stmt\ClassLike $classLike, \RectorPrefix20210427\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
