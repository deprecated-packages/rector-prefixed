...
CODE_SAMPLE
    ...
    private function createClassLikeFileDestination(\PhpParser\Node\Stmt\ClassLike $classLike, \RectorPrefix20210314\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
