 ...
 *
 * @see \Rector\Tests\Doctrine\Rector\Property\AddUuidAnnotationsToIdPropertyRector\AddUuidAnnotationsToIdPropertyRectorTest
 */
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $phpDocInfo = $this->phpDocInfoFactory->createFromNodeOrEmpty($node);
        $fullyQualifiedObjectType = new \Rector\StaticTypeMapper\ValueObject\Type\FullyQualifiedObjectType('Ramsey\\Uuid\\UuidInterface');
