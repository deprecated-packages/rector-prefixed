...
final class RouteNameClassFactory
{
    ...
    {
        $classBuilder = new \RectorPrefix20210312\Symplify\Astral\ValueObject\NodeBuilder\ClassBuilder(\Rector\Symfony\ValueObject\ClassName::ROUTE_CLASS_SHORT_NAME);
