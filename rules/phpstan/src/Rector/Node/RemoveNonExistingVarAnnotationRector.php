...
namespace _PhpScoperb75b35f52b74\Rector\PHPStan\Rector\Node;
 ...
 */
final class RemoveNonExistingVarAnnotationRector extends \_PhpScoperb75b35f52b74\Rector\Core\Rector\AbstractRector
{
    /**
     * @var class-string[]
     */
    private const NODES_TO_MATCH = [\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Assign::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\AssignRef::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Foreach_::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Static_::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Echo_::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Return_::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Expression::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Throw_::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\If_::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\While_::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Switch_::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Nop::class];
    public function getRuleDefinition() : \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Removes non-existing @var annotations above the code', [new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function get()
    {
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        // it's there
        if (\_PhpScoperb75b35f52b74\Nette\Utils\Strings::match($nodeContentWithoutPhpDoc, '#' . \preg_quote($variableName, '#') . '\\b#')) {
            return null;
        }
    ...
    {
        if ($node instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Nop && \count($node->getComments()) > 1) {
            return \true;
        }
