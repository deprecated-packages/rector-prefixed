...
namespace _PhpScoper0a2ac50786fa\Rector\PHPStan\Rector\Node;
 ...
 */
final class RemoveNonExistingVarAnnotationRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector
{
    /**
     * @var class-string[]
     */
    private const NODES_TO_MATCH = [\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Assign::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\AssignRef::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Foreach_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Static_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Echo_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Return_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Expression::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Throw_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\If_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\While_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Switch_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Nop::class];
    public function getRuleDefinition() : \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Removes non-existing @var annotations above the code', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function get()
    {
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        // it's there
        if (\_PhpScoper0a2ac50786fa\Nette\Utils\Strings::match($nodeContentWithoutPhpDoc, '#' . \preg_quote($variableName, '#') . '\\b#')) {
            return null;
        }
    ...
    {
        if ($node instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Nop && \count($node->getComments()) > 1) {
            return \true;
        }
