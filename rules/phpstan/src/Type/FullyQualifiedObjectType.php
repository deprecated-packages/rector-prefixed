...
final class FullyQualifiedObjectType extends \PHPStan\Type\ObjectType
{
    ...
    {
        if (!\_PhpScopera143bcca66cb\Nette\Utils\Strings::contains($this->getClassName(), '\\')) {
            return $this->getClassName();
        }
        return (string) \_PhpScopera143bcca66cb\Nette\Utils\Strings::after($this->getClassName(), '\\', -1);
    }
