...
{
    public function getShortNameType() : \Rector\PHPStan\Type\ShortenedObjectType
    {
        return new \Rector\PHPStan\Type\ShortenedObjectType($this->getShortName(), $this->getClassName());
    }
    /**
    ...
    {
        if (!\_PhpScoper006a73f0e455\Nette\Utils\Strings::contains($this->getClassName(), '\\')) {
            return $this->getClassName();
        }
        return (string) \_PhpScoper006a73f0e455\Nette\Utils\Strings::after($this->getClassName(), '\\', -1);
    }
