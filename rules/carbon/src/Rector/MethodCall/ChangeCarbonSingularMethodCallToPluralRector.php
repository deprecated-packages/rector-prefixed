 ...
 */
final class ChangeCarbonSingularMethodCallToPluralRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('_PhpScoper0a2ac50786fa\\Change setter methods with args to their plural names on Carbon\\Carbon', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
use Carbon\Carbon;
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        foreach (self::SINGULAR_TO_PLURAL_NAMES as $singularName => $pluralName) {
            ...
            $node->name = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Identifier($pluralName);
            return $node;
        }
        return null;
    }
