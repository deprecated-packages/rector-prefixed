...
final class SubstrMatchAndRefactor extends \_PhpScoper0a2ac50786fa\Rector\Php80\MatchAndRefactor\StrStartsWithMatchAndRefactor\AbstractMatchAndRefactor implements \_PhpScoper0a2ac50786fa\Rector\Php80\Contract\StrStartWithMatchAndRefactorInterface
{
    /**
    ...
    public function match(\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\BinaryOp $binaryOp) : ?\_PhpScoper0a2ac50786fa\Rector\Php80\ValueObject\StrStartsWith
    {
        ...
        if ($this->isFuncCallName($binaryOp->left, 'substr')) {
            ...
            return new \_PhpScoper0a2ac50786fa\Rector\Php80\ValueObject\StrStartsWith($funcCall, $haystack, $binaryOp->right, $isPositive);
        }
        if ($this->isFuncCallName($binaryOp->right, 'substr')) {
            /** @var FuncCall $funcCall */
            $funcCall = $binaryOp->right;
            $haystack = $funcCall->args[0]->value;
            return new \_PhpScoper0a2ac50786fa\Rector\Php80\ValueObject\StrStartsWith($funcCall, $haystack, $binaryOp->left, $isPositive);
        }
        return null;
    }
