...
return static function (\RectorPrefix20210312\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\RectorPrefix20210312\Symplify\PhpConfigPrinter\YamlToPhpConverter::class);
    $services->set(\RectorPrefix20210312\Symfony\Component\Yaml\Parser::class);
    $services->set(\RectorPrefix20210312\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter::class);
};
