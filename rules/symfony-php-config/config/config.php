...
return static function (\RectorPrefix20210301\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\RectorPrefix20210301\Symplify\PhpConfigPrinter\YamlToPhpConverter::class);
    $services->set(\RectorPrefix20210301\Symfony\Component\Yaml\Parser::class);
    $services->set(\RectorPrefix20210301\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter::class);
};
