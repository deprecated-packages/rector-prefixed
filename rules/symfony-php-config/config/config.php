...
use RectorPrefix20210213\Symplify\PhpConfigPrinter\YamlToPhpConverter;
return static function (\RectorPrefix20210213\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\RectorPrefix20210213\Symplify\PhpConfigPrinter\YamlToPhpConverter::class);
    $services->set(\RectorPrefix20210213\Symfony\Component\Yaml\Parser::class);
    $services->set(\RectorPrefix20210213\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter::class);
};
