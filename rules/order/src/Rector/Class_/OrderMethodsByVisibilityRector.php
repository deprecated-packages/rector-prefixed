 ...
 */
final class OrderMethodsByVisibilityRector extends \_PhpScoper0a2ac50786fa\Rector\Order\Rector\AbstractConstantPropertyMethodOrderRector
{
    /**
     * @var string[]
     */
    private const PREFERRED_ORDER = [\_PhpScoper0a2ac50786fa\Rector\Core\ValueObject\MethodName::CONSTRUCT, \_PhpScoper0a2ac50786fa\Rector\Core\ValueObject\MethodName::DESCTRUCT, '__call', '__callStatic', '__get', '__set', '__isset', '__unset', '__sleep', '__wakeup', '__serialize', '__unserialize', '__toString', '__invoke', \_PhpScoper0a2ac50786fa\Rector\Core\ValueObject\MethodName::SET_STATE, '__clone', 'setUpBeforeClass', 'tearDownAfterClass', \_PhpScoper0a2ac50786fa\Rector\Core\ValueObject\MethodName::SET_UP, \_PhpScoper0a2ac50786fa\Rector\Core\ValueObject\MethodName::TEAR_DOWN];
    public function getRuleDefinition() : \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Orders method by visibility', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
...
CODE_SAMPLE
    ...
    {
        $currentMethodsOrder = $this->stmtOrder->getStmtsOfTypeOrder($node, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassMethod::class);
     ...
     * @return string[]
     */
    private function getMethodsInDesiredOrder(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassLike $classLike) : array
    {
