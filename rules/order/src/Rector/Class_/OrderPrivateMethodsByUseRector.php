...
use _PhpScoper0a6b37af0871\Rector\Order\ValueObject\SortedClassMethodsAndOriginalClassMethods;
 ...
 */
final class OrderPrivateMethodsByUseRector extends \_PhpScoper0a6b37af0871\Rector\Order\Rector\AbstractConstantPropertyMethodOrderRector
{
    /**
     * @var int
     */
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Order private methods in order of their use', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        ...
        while (!$sortedAndOriginalClassMethods->hasOrderSame()) {
            ...
            if ($attempt >= self::MAX_ATTEMPTS) {
                throw new \_PhpScoper0a6b37af0871\Rector\Core\Exception\ShouldNotHappenException('Number of attempts to reorder the methods exceeded');
            }
     ...
     */
    private function getSortedAndOriginalClassMethods(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassLike $classLike) : \_PhpScoper0a6b37af0871\Rector\Order\ValueObject\SortedClassMethodsAndOriginalClassMethods
    {
        return new \_PhpScoper0a6b37af0871\Rector\Order\ValueObject\SortedClassMethodsAndOriginalClassMethods($this->getLocalPrivateMethodCallOrder($classLike), $this->resolvePrivateClassMethods($classLike));
    }
    /**
     * @return array<int, string>
     */
    private function getLocalPrivateMethodCallOrder(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassLike $classLike) : array
    {
        $localPrivateMethodCallInOrder = [];
        $this->traverseNodesWithCallable($classLike->getMethods(), function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use(&$localPrivateMethodCallInOrder, $classLike) {
     ...
     * @return array<int, string>
     */
    private function resolvePrivateClassMethods(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassLike $classLike) : array
    {
        $privateClassMethods = [];
