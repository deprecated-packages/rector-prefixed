...
final class OrderPrivateMethodsByUseRector extends \Rector\Order\Rector\AbstractConstantPropertyMethodOrderRector
{
    ...
    {
        return new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Order private methods in order of their use', [new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
