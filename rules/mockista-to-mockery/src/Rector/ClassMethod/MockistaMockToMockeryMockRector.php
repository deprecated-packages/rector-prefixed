...
namespace _PhpScoper0a6b37af0871\Rector\MockistaToMockery\Rector\ClassMethod;
 ...
 */
final class MockistaMockToMockeryMockRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractPHPUnitRector
{
    /**
     * @var string[]
     */
...
CODE_SAMPLE
    ...
    private function replaceMockWithMockerMockAndCollectMockVariableName(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        $this->traverseNodesWithCallable((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?StaticCall {
     ...
     * $mock->getMethod()->once()
     */
    private function replaceMethodCallOncePropertyFetch(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        $this->traverseNodesWithCallable((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?MethodCall {
            ...
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall($node->var, $node->name);
        });
    }
    private function removeUnusedMethodCalls(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
     ...
     */
    private function replaceMethodCallWithExpects(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        $this->traverseNodesWithCallable((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?MethodCall {
            if (!$this->isMethodCallOrPropertyFetchOnMockVariable($node)) {
                return null;
            ...
            $expectedMethodCall = new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall($node->var, 'expects');
            $methodCall = new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall($expectedMethodCall, $node->name);
            if ($node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\PropertyFetch) {
                return $methodCall;
            }
     ...
     */
    private function switchWithAnyArgsAndOnceTwice(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        $this->traverseNodesWithCallable((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) {
    ...
    private function collectMockVariableName(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall $funcCall) : void
    {
    ...
    private function isMethodCallOrPropertyFetchOnMockVariable(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool
    {
        if (!$node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall && !$this->isPropertyFetchDisguisedAsMethodCall($node)) {
            return \false;
        }
        /** @var MethodCall|PropertyFetch $node */
     ...
     */
    private function decorateWithAnyArgs(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall $originalMethodCall, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall $expectsMethodCall) : \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall
    {
        ...
        return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall($expectsMethodCall, 'withAnyArgs');
    }
    private function isPropertyFetchDisguisedAsMethodCall(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool
    {
        if (!$node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\PropertyFetch) {
            return \false;
        }
