...
namespace _PhpScopere8e811afab72\Rector\MockeryToProphecy\Rector\ClassMethod;
 ...
 */
final class MockeryCreateMockToProphizeRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractPHPUnitRector
{
    /**
    ...
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Changes mockery mock creation to Prophesize', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function replaceMockCreationsAndCollectVariableNames(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        if ($classMethod->stmts === null) {
            return;
        }
        $this->traverseNodesWithCallable($classMethod->stmts, function (\_PhpScopere8e811afab72\PhpParser\Node $node) : ?MethodCall {
    ...
    private function revealMockArguments(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        if ($classMethod->stmts === null) {
            return;
        }
        $this->traverseNodesWithCallable($classMethod->stmts, function (\_PhpScopere8e811afab72\PhpParser\Node $node) : ?MethodCall {
            ...
            if (!$node->value instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr\Variable) {
                return null;
            }
    ...
    private function collectMockVariableName(\_PhpScopere8e811afab72\PhpParser\Node\Expr\StaticCall $staticCall) : void
    {
        $parentNode = $staticCall->getAttribute(\_PhpScopere8e811afab72\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
    ...
    private function createProphesizeMethodCall(\_PhpScopere8e811afab72\PhpParser\Node\Expr\StaticCall $staticCall) : \_PhpScopere8e811afab72\PhpParser\Node\Expr\MethodCall
    {
