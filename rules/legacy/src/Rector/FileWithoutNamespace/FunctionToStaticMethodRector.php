...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $smartFileInfo = $node->getAttribute(\RectorPrefix20210106\Symplify\SmartFileSystem\SmartFileInfo::class);
     ...
     */
    private function printStaticMethodClass(\RectorPrefix20210106\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $shortClassName, \PhpParser\Node $node, \PhpParser\Node\Stmt\Class_ $class) : void
    {
