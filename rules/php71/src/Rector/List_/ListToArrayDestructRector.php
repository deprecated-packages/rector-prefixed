...
namespace _PhpScoper0a6b37af0871\Rector\Php71\Rector\List_;
 ...
 */
final class ListToArrayDestructRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Remove & from new &X', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
...
CODE_SAMPLE
    ...
    {
        if (!$this->isAtLeastPhpVersion(\_PhpScoper0a6b37af0871\Rector\Core\ValueObject\PhpVersionFeature::ARRAY_DESTRUCT)) {
            return null;
        }
        ...
        if ($parentNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign && $parentNode->var === $node) {
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Array_((array) $node->items);
        }
        if ($parentNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Foreach_ && $parentNode->valueVar === $node) {
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Array_((array) $node->items);
        }
        return null;
    }
