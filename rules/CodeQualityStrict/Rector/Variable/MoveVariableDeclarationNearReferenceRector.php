...
CODE_SAMPLE
     ...
     */
    private function isUsedAsArrayKey($node, Variable $variable): bool
    {
     ...
     * @return \PhpParser\Node\Expr\Variable|null
     */
    private function getSameVarName(array $multiNodes, Variable $variable)
    {
     ...
     * @return \PhpParser\Node\Expr\Variable|null
     */
    private function getSameVarNameInNexts(Node $node, Variable $variable)
    {
        while ($node) {
