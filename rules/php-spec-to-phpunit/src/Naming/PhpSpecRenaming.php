...
final class PhpSpecRenaming
{
    ...
    public function renameMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        ...
        if (!\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::startsWith($classMethodName, 'test')) {
    ...
    {
        $class->extends = new \PhpParser\Node\Name\FullyQualified('_PhpScoper5b8c9e9ebd21\\PHPUnit\\Framework\\TestCase');
    }
