...
final class PhpSpecRenaming
{
    ...
    public function __construct(\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210305\Symplify\PackageBuilder\Strings\StringFormatConverter $stringFormatConverter)
    {
    ...
    public function renameMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        ...
        if (!\RectorPrefix20210305\Nette\Utils\Strings::startsWith($classMethodName, 'test')) {
