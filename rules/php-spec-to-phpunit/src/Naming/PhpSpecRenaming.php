...
final class PhpSpecRenaming
{
    ...
    public function renameMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        ...
        if (!\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::startsWith($classMethodName, 'test')) {
    ...
    {
        $class->extends = new \PhpParser\Node\Name\FullyQualified('_PhpScoper5edc98a7cce2\\PHPUnit\\Framework\\TestCase');
    }
