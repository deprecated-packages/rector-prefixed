...
final class PhpSpecRenaming
{
     ...
     */
    private $classNaming;
    public function __construct(\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210126\Symplify\PackageBuilder\Strings\StringFormatConverter $stringFormatConverter, \Rector\CodingStyle\Naming\ClassNaming $classNaming)
    {
    ...
    public function renameMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        ...
        if (!\RectorPrefix20210126\Nette\Utils\Strings::startsWith($classMethodName, 'test')) {
