...
abstract class AbstractPhpSpecToPHPUnitRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Migrate PhpSpec behavior to PHPUnit test', [new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function isInPhpSpecBehavior(\PhpParser\Node $node) : bool
    {
        ...
        return $this->isObjectType($classLike, 'RectorPrefix20201228\\PhpSpec\\ObjectBehavior');
    }
}
