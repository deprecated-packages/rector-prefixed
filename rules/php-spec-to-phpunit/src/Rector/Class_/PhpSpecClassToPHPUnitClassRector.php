...
use _PhpScoperb75b35f52b74\Rector\PhpSpecToPHPUnit\LetManipulator;
 ...
 */
final class PhpSpecClassToPHPUnitClassRector extends \_PhpScoperb75b35f52b74\Rector\PhpSpecToPHPUnit\Rector\AbstractPhpSpecToPHPUnitRector
{
    /**
     * @var ObjectType
     */
    ...
    public function refactor(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        $this->testedObjectType = new \_PhpScoperb75b35f52b74\PHPStan\Type\ObjectType($testedClass);
    ...
    private function createLetClassMethod(string $propertyName) : \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\ClassMethod
    {
        ...
        if (!$testedObjectType instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Name) {
            throw new \_PhpScoperb75b35f52b74\Rector\Core\Exception\ShouldNotHappenException();
        }
        $new = new \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\New_($testedObjectType);
     ...
     */
    private function removeSelfTypeMethod(\_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_ $class) : \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_
    {
        foreach ($class->getMethods() as $classMethod) {
            ...
            if (!$innerClassMethodStmt instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall) {
                continue;
            }
     ...
     * @param Stmt[] $stmts
     */
    private function resolveFirstNonExpressionStmt(array $stmts) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        if (!isset($stmts[0])) {
            return null;
        }
        $firstStmt = $stmts[0];
        if ($firstStmt instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Expression) {
