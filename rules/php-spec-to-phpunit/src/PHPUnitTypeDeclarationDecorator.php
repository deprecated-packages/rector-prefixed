...
final class PHPUnitTypeDeclarationDecorator
{
    ...
    {
        if (!\class_exists('_PhpScoper26e51eeacccf\\PHPUnit\\Framework\\TestCase')) {
            return;
        }
        // skip test run
        ...
        $reflectionMethod = new \ReflectionMethod('_PhpScoper26e51eeacccf\\PHPUnit\\Framework\\TestCase', \Rector\Core\ValueObject\MethodName::SET_UP);
