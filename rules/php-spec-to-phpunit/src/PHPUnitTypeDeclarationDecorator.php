...
final class PHPUnitTypeDeclarationDecorator
{
    ...
    {
        if (!\class_exists('_PhpScoper50d83356d739\\PHPUnit\\Framework\\TestCase')) {
            return;
        }
        // skip test run
        ...
        $reflectionMethod = new \ReflectionMethod('_PhpScoper50d83356d739\\PHPUnit\\Framework\\TestCase', \Rector\Core\ValueObject\MethodName::SET_UP);
