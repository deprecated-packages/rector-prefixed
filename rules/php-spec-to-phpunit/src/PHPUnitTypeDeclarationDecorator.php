...
final class PHPUnitTypeDeclarationDecorator
{
    ...
    {
        if (!\class_exists('_PhpScoper5edc98a7cce2\\PHPUnit\\Framework\\TestCase')) {
            return;
        }
        // skip test run
        ...
        $reflectionMethod = new \ReflectionMethod('_PhpScoper5edc98a7cce2\\PHPUnit\\Framework\\TestCase', \Rector\Core\ValueObject\MethodName::SET_UP);
