...
final class PHPUnitTypeDeclarationDecorator
{
    ...
    {
        if (!\class_exists('RectorPrefix20201227\\PHPUnit\\Framework\\TestCase')) {
            return;
        }
        // skip test run
        ...
        $reflectionMethod = new \ReflectionMethod('RectorPrefix20201227\\PHPUnit\\Framework\\TestCase', \Rector\Core\ValueObject\MethodName::SET_UP);
