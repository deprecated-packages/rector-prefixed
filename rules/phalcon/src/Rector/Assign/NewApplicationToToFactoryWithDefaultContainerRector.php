...
CODE_SAMPLE
    ...
    private function isNewApplication(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return $this->isName($expr->class, '_PhpScoperabd03f0baf05\\Phalcon\\Mvc\\Application');
    }
    ...
    {
        return new \PhpParser\Node\Expr\Assign($variable, new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('_PhpScoperabd03f0baf05\\Phalcon\\Di\\FactoryDefault')));
    }
}
