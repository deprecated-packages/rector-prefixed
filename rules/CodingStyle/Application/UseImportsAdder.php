...
final class UseImportsAdder
{
    ...
    {
        $afterCurrentNamespace = \RectorPrefix20210422\Nette\Utils\Strings::after($objectType->getClassName(), $namespaceName . '\\');
        if (!$afterCurrentNamespace) {
            return \false;
        }
        return !\RectorPrefix20210422\Nette\Utils\Strings::contains($afterCurrentNamespace, '\\');
    }
}
