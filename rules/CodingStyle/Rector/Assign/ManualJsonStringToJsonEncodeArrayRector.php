...
use RectorPrefix20210317\Nette\Utils\JsonException;
...
CODE_SAMPLE
    ...
    private function isJsonString($stringValue) : bool
    {
        ...
        try {
            return (bool) \RectorPrefix20210317\Nette\Utils\Json::decode($stringValue, \RectorPrefix20210317\Nette\Utils\Json::FORCE_ARRAY);
        } catch (\RectorPrefix20210317\Nette\Utils\JsonException $jsonException) {
            return \false;
        }
    }
    /**
