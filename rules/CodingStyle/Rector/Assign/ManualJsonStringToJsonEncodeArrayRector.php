...
use RectorPrefix20210402\Nette\Utils\JsonException;
...
CODE_SAMPLE
    ...
    {
        if (!(bool) \RectorPrefix20210402\Nette\Utils\Strings::match($stringValue, self::JSON_STRING_REGEX)) {
            return \false;
        }
        try {
            return (bool) \RectorPrefix20210402\Nette\Utils\Json::decode($stringValue, \RectorPrefix20210402\Nette\Utils\Json::FORCE_ARRAY);
        } catch (\RectorPrefix20210402\Nette\Utils\JsonException $jsonException) {
            return \false;
        }
    }
    ...
    {
        $stringValue = \RectorPrefix20210402\Nette\Utils\Strings::replace($stringValue, self::UNQUOTED_OBJECT_HASH_REGEX, '$1"$2"');
