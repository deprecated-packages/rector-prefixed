...
final class ConsistentPregDelimiterRector extends AbstractRector implements ConfigurableRectorInterface
{
     ...
     */
    const FUNCTIONS_WITH_REGEX_PATTERN = [
        'preg_match' => 0,
     ...
     */
    const STATIC_METHODS_WITH_REGEX_PATTERN = [
        'Nette\Utils\Strings' => [
            'match' => 1,
            'matchAll' => 1,
            'replace' => 1,
...
,
     ...
     */
    private function refactorFuncCall(FuncCall $funcCall)
    {
     ...
     * @return void
     */
    private function refactorArgument(Arg $arg)
    {
