...
CODE_SAMPLE
     ...
     */
    private function processUnspreadOperatorClassMethodParams(ClassMethod $classMethod)
    {
     ...
     */
    private function processUnspreadOperatorMethodCallArgs(MethodCall $methodCall)
    {
