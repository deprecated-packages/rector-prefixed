...
CODE_SAMPLE
    ...
    {
        return !\RectorPrefix20210412\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\RectorPrefix20210412\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \RectorPrefix20210412\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
