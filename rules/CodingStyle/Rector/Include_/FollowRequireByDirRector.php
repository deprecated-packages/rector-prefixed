...
CODE_SAMPLE
    ...
    {
        return !\RectorPrefix20210410\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\RectorPrefix20210410\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \RectorPrefix20210410\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
