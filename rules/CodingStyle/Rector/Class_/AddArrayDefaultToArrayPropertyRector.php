...
CODE_SAMPLE
     ...
     * @return void
     */
    private function completeDefaultArrayToPropertyNames(Class_ $class, array $propertyNames)
    {
     ...
     * @return void
     */
    private function clearNotNullBeforeCount(Class_ $class, array $propertyNames)
    {
