...
final class JsonArrayFactory
{
     ...
     * @return void
     */
    private function replaceNodeObjectHashPlaceholdersWithNodes(Array_ $array, array $placeholderNodes)
    {
     ...
     */
    private function matchPlaceholderNode(Node $node, array $placeholderNodes)
    {
