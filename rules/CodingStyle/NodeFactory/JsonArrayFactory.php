...
final class JsonArrayFactory
{
    ...
    public function __construct(\Rector\Core\PhpParser\Node\NodeFactory $nodeFactory, \Rector\CodingStyle\NodeAnalyzer\ImplodeAnalyzer $implodeAnalyzer, \RectorPrefix20210507\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser)
    {
    ...
    {
        $array = \RectorPrefix20210507\Nette\Utils\Json::decode($stringValue, \RectorPrefix20210507\Nette\Utils\Json::FORCE_ARRAY);
