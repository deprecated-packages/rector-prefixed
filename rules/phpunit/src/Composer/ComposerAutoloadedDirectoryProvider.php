...
final class ComposerAutoloadedDirectoryProvider
{
    ...
    public function __construct(\RectorPrefix20210128\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210128\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210128\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
