...
final class ComposerAutoloadedDirectoryProvider
{
    ...
    public function __construct(\RectorPrefix20210106\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210106\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210106\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
