...
final class ComposerAutoloadedDirectoryProvider
{
     ...
     * @var string[]
     */
    private const AUTOLOAD_SECTIONS = [\RectorPrefix20210201\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD, \RectorPrefix20210201\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV];
    /**
     * @var string
     */
    ...
    public function __construct(\RectorPrefix20210201\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210201\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210201\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
