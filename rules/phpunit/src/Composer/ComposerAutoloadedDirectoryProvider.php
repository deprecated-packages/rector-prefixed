...
final class ComposerAutoloadedDirectoryProvider
{
    ...
    public function __construct(\RectorPrefix20210130\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210130\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210130\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
