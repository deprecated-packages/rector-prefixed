...
final class ComposerAutoloadedDirectoryProvider
{
    ...
    public function provide() : array
    {
        ...
        return \_PhpScoper17db12703726\Nette\Utils\Arrays::flatten($autoloadDirectories);
    }
    /**
     * @return mixed[]
     */
    private function loadComposerJsonArray() : array
    {
        ...
        return \_PhpScoper17db12703726\Nette\Utils\Json::decode($composerFileContent, \_PhpScoper17db12703726\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
