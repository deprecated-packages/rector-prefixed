...
final class ComposerAutoloadedDirectoryProvider
{
    ...
    public function __construct(\RectorPrefix20210126\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210126\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210126\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
