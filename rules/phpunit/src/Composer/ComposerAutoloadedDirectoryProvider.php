...
final class ComposerAutoloadedDirectoryProvider
{
    ...
    public function __construct(\RectorPrefix20201231\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20201231\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20201231\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
