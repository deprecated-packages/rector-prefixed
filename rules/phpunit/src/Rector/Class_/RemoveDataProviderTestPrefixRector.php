...
CODE_SAMPLE
    ...
    private function renameDataProviderAnnotationsAndCollectRenamedMethods(\PhpParser\Node\Stmt\Class_ $class) : void
    {
        foreach ($class->getMethods() as $classMethod) {
            ...
            foreach ($phpunitDataProviderTagValueNodes as $dataProviderTagValueNode) {
                ...
                if (!\RectorPrefix20210224\Nette\Utils\Strings::startsWith($oldMethodName, 'test')) {
                    continue;
                }
    ...
    {
        $newMethodName = \RectorPrefix20210224\Nette\Utils\Strings::substring($oldMethodName, \strlen('test'));
