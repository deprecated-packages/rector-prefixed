...
namespace _PhpScoperb75b35f52b74\Rector\PHPUnit\Rector\Foreach_;
 ...
 */
final class SimplifyForeachInstanceOfRector extends \_PhpScoperb75b35f52b74\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    {
        return new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Simplify unnecessary foreach check of instances', [new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
foreach ($foos as $foo) {
...
, '$this->assertContainsOnlyInstancesOf(\\SplFileInfo::class, $foos);')]);
    ...
    public function refactor(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        $matchedNode = $this->foreachManipulator->matchOnlyStmt($node, function (\_PhpScoperb75b35f52b74\PhpParser\Node $node, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Foreach_ $foreachNode) : ?Node {
        ...
        return new $callClass($this->resolveVar($matchedNode), new \_PhpScoperb75b35f52b74\PhpParser\Node\Name('assertContainsOnlyInstancesOf'), [$matchedNode->args[0], new \_PhpScoperb75b35f52b74\PhpParser\Node\Arg($node->expr)]);
    }
    /**
     * @param MethodCall|StaticCall $node
     */
    private function resolveVar(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : \_PhpScoperb75b35f52b74\PhpParser\Node
    {
