 ...
 */
final class ExplicitPhpErrorApiRector extends \_PhpScoperb75b35f52b74\Rector\Core\Rector\AbstractPHPUnitRector
{
    /**
     * @var array<string, string>
     */
    private const REPLACEMENTS = ['_PhpScoperb75b35f52b74\\PHPUnit\\Framework\\TestCase\\Notice' => 'expectNotice', '_PhpScoperb75b35f52b74\\PHPUnit\\Framework\\TestCase\\Deprecated' => 'expectDeprecation', '_PhpScoperb75b35f52b74\\PHPUnit\\Framework\\TestCase\\Error' => 'expectError', '_PhpScoperb75b35f52b74\\PHPUnit\\Framework\\TestCase\\Warning' => 'expectWarning'];
    public function getRuleDefinition() : \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Use explicit API for expecting PHP errors, warnings, and notices', [new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
     ...
     * @param MethodCall|StaticCall $node
     */
    private function replaceExceptionWith(\_PhpScoperb75b35f52b74\PhpParser\Node $node, string $exceptionClass, string $explicitMethod) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
