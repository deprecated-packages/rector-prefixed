 ...
 */
final class AssertInstanceOfComparisonRector extends \_PhpScoperb75b35f52b74\Rector\Core\Rector\AbstractPHPUnitRector
{
    /**
    ...
    {
        return new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Turns instanceof comparisons to their method name alternatives in PHPUnit TestCase', [new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample('$this->assertTrue($foo instanceof Foo, "message");', '$this->assertInstanceOf("Foo", $foo, "message");'), new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample('$this->assertFalse($foo instanceof Foo, "message");', '$this->assertNotInstanceOf("Foo", $foo, "message");')]);
    }
    /**
     * @return string[]
     */
    ...
    public function refactor(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        if (!$firstArgumentValue instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Instanceof_) {
            return null;
        }
    ...
    private function changeArgumentsOrder(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : void
    {
        ...
        $node->args = \array_merge([new \_PhpScoperb75b35f52b74\PhpParser\Node\Arg($this->builderFactory->classConstFetch($class, 'class')), new \_PhpScoperb75b35f52b74\PhpParser\Node\Arg($argument)], $oldArguments);
    }
}
