...
final class TestClassResolver
{
    ...
    public function resolveFromClassName(string $className) : ?string
    {
        ...
        foreach ($phpUnitTestCaseClasses as $phpUnitTestCaseClass) {
            ...
            if (!\RectorPrefix20210105\Nette\Utils\Strings::endsWith($phpUnitTestCaseClass, '\\' . $testShortClassName)) {
                continue;
            }
    ...
    {
        $namespacePart = (string) \RectorPrefix20210105\Nette\Utils\Strings::before($className, '\\', -1);
