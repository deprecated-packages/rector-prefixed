...
final class AssertIssetToSpecificMethodRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\PHPUnit\Rector\MethodCall\AssertIssetToSpecificMethodRector::class;
    }
}
