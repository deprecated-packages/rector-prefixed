...
final class AssertComparisonToSpecificMethodRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\PHPUnit\Rector\MethodCall\AssertComparisonToSpecificMethodRector::class;
    }
}
