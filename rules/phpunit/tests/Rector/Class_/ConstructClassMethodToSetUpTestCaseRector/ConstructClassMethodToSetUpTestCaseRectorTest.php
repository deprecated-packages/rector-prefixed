...
final class ConstructClassMethodToSetUpTestCaseRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\PHPUnit\Rector\Class_\ConstructClassMethodToSetUpTestCaseRector::class;
    }
}
