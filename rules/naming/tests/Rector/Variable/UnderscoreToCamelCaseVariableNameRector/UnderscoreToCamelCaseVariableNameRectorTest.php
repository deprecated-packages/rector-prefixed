...
final class UnderscoreToCamelCaseVariableNameRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\Naming\Rector\Variable\UnderscoreToCamelCaseVariableNameRector::class;
    }
}
