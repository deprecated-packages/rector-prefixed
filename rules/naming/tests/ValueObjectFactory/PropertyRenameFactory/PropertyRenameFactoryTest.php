...
final class PropertyRenameFactoryTest extends \RectorPrefix20210228\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        (yield [new \RectorPrefix20210228\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/skip_some_class.php.inc'), 'eliteManager', 'eventManager']);
    }
    private function getPropertyFromFileInfo(\RectorPrefix20210228\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : \PhpParser\Node\Stmt\Property
    {
