...
final class PropertyRenameFactoryTest extends \RectorPrefix20210312\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     ...
     */
    public function test(\RectorPrefix20210312\Symplify\SmartFileSystem\SmartFileInfo $fileInfoWithProperty, string $expectedName, string $currentName) : void
    {
    ...
    {
        (yield [new \RectorPrefix20210312\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/skip_some_class.php.inc'), 'eliteManager', 'eventManager']);
    }
    private function getPropertyFromFileInfo(\RectorPrefix20210312\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : \PhpParser\Node\Stmt\Property
    {
