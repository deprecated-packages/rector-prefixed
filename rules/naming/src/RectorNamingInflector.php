...
final class RectorNamingInflector
{
     ...
     */
    private $inflector;
    public function __construct(\RectorPrefix20201229\Doctrine\Inflector\Inflector $inflector)
    {
        $this->inflector = $inflector;
    }
    public function singularize(string $name) : string
    {
        $matches = \RectorPrefix20201229\Nette\Utils\Strings::match($name, self::DATA_INFO_SUFFIX_REGEX);
        if ($matches === null) {
