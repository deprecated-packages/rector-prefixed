...
use RectorPrefix20210105\Doctrine\Inflector\Inflector;
...
final class RectorNamingInflector
{
     ...
     */
    private $inflector;
    public function __construct(\RectorPrefix20210105\Doctrine\Inflector\Inflector $inflector)
    {
        $this->inflector = $inflector;
    }
    public function singularize(string $name) : string
    {
        $matches = \RectorPrefix20210105\Nette\Utils\Strings::match($name, self::DATA_INFO_SUFFIX_REGEX);
        if ($matches === null) {
