...
final class VariableRenamer
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Core\PhpParser\NodeTraverser\CallableNodeTraverser $callableNodeTraverser, \_PhpScoper0a6b37af0871\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScoper0a6b37af0871\Rector\Naming\PhpDoc\VarTagValueNodeRenamer $varTagValueNodeRenamer)
    {
     ...
     */
    public function renameVariableInFunctionLike(\_PhpScoper0a6b37af0871\PhpParser\Node\FunctionLike $functionLike, ?\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign $assign = null, string $oldName, string $expectedName) : void
    {
        $isRenamingActive = \false;
        if ($assign === null) {
            $isRenamingActive = \true;
        }
        $this->callableNodeTraverser->traverseNodesWithCallable((array) $functionLike->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($oldName, $expectedName, $assign, &$isRenamingActive) : ?Variable {
            ...
            if ($parent instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Param) {
                return null;
            }
    ...
    private function isParamInParentFunction(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable $variable) : bool
    {
        /** @var Closure|null $closure */
        $closure = $variable->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::CLOSURE_NODE);
        if ($closure === null) {
            return \false;
        }
    ...
    private function renameVariableIfMatchesName(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable $variable, string $oldName, string $expectedName) : ?\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable
    {
