...
use _PhpScopere8e811afab72\Rector\Naming\PropertyRenamer\BoolPropertyRenamer;
 ...
 */
final class MakeBoolPropertyRespectIsHasWasMethodNamingRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    public function __construct(\_PhpScopere8e811afab72\Rector\Naming\PropertyRenamer\BoolPropertyRenamer $boolPropertyRenamer, \_PhpScopere8e811afab72\Rector\Naming\ValueObjectFactory\PropertyRenameFactory $propertyRenameFactory, \_PhpScopere8e811afab72\Rector\Naming\ExpectedNameResolver\BoolPropertyExpectedNameResolver $boolPropertyExpectedNameResolver)
    {
    ...
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Renames property to respect is/has/was method naming', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    private $full = false;
