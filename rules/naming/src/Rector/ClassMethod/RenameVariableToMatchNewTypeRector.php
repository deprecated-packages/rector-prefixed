 ...
 */
final class RenameVariableToMatchNewTypeRector extends \_PhpScoper2a4e7ab1ecbc\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    public function __construct(\_PhpScoper2a4e7ab1ecbc\Rector\Naming\Guard\BreakingVariableRenameGuard $breakingVariableRenameGuard, \_PhpScoper2a4e7ab1ecbc\Rector\Naming\Naming\ExpectedNameResolver $expectedNameResolver, \_PhpScoper2a4e7ab1ecbc\Rector\Naming\VariableRenamer $variableRenamer)
    {
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node $node) : ?\_PhpScoper2a4e7ab1ecbc\PhpParser\Node
    {
        ...
        foreach ($assignsOfNew as $assign) {
            ...
            $assign->var = new \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\Variable($expectedName);
     ...
     * @return Assign[]
     */
    private function getAssignsOfNew(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\ClassMethod $classMethod) : array
    {
        /** @var Assign[] $assigns */
        ...
        return \array_filter($assigns, function (\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\Assign $assign) : bool {
            return $assign->expr instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\New_;
        });
    }
}
