...
namespace _PhpScopere8e811afab72\Rector\Naming\Rector\Assign;
...
use _PhpScopere8e811afab72\Rector\Naming\Matcher\VariableAndCallAssignMatcher;
 ...
 */
final class RenameVariableToMatchMethodCallReturnTypeRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector
{
    /**
     * @var string[]
     */
    private const ALLOWED_PARENT_TYPES = [\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassLike::class];
    /**
    ...
    public function __construct(\_PhpScopere8e811afab72\Rector\Naming\Guard\BreakingVariableRenameGuard $breakingVariableRenameGuard, \_PhpScopere8e811afab72\Rector\Naming\Naming\ExpectedNameResolver $expectedNameResolver, \_PhpScopere8e811afab72\Rector\FamilyTree\Reflection\FamilyRelationsAnalyzer $familyRelationsAnalyzer, \_PhpScopere8e811afab72\Rector\Naming\NamingConvention\NamingConventionAnalyzer $namingConventionAnalyzer, \_PhpScopere8e811afab72\Rector\Naming\PhpDoc\VarTagValueNodeRenamer $varTagValueNodeRenamer, \_PhpScopere8e811afab72\Rector\Naming\Matcher\VariableAndCallAssignMatcher $variableAndCallAssignMatcher, \_PhpScopere8e811afab72\Rector\Naming\VariableRenamer $variableRenamer)
    {
    ...
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Rename variable to match method return type', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
...
CODE_SAMPLE
     ...
     */
    private function isMultipleCall(\_PhpScopere8e811afab72\PhpParser\Node $node) : bool
    {
        $parentNode = $node->getAttribute(\_PhpScopere8e811afab72\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
        while ($parentNode) {
            $countUsed = \count($this->betterNodeFinder->find($parentNode, function (\_PhpScopere8e811afab72\PhpParser\Node $n) use($node) : bool {
    ...
    private function shouldSkip(\_PhpScopere8e811afab72\Rector\Naming\ValueObject\VariableAndCallAssign $variableAndCallAssign, string $expectedName) : bool
    {
    ...
    private function renameVariable(\_PhpScopere8e811afab72\Rector\Naming\ValueObject\VariableAndCallAssign $variableAndCallAssign, string $expectedName) : void
    {
     ...
     */
    private function isClassTypeWithChildren(\_PhpScopere8e811afab72\PhpParser\Node\Expr $expr) : bool
    {
        $callStaticType = $this->getStaticType($expr);
        $callStaticType = $this->typeUnwrapper->unwrapNullableType($callStaticType);
        if (!$callStaticType instanceof \_PhpScopere8e811afab72\PHPStan\Type\TypeWithClassName) {
            return \false;
        }
