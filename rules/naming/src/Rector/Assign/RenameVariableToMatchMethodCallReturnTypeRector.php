...
namespace _PhpScoper0a6b37af0871\Rector\Naming\Rector\Assign;
...
use _PhpScoper0a6b37af0871\Rector\Naming\Matcher\VariableAndCallAssignMatcher;
...
use _PhpScoper0a6b37af0871\Rector\Naming\PhpDoc\VarTagValueNodeRenamer;
 ...
 */
final class RenameVariableToMatchMethodCallReturnTypeRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
     * @var string[]
     */
    private const ALLOWED_PARENT_TYPES = [\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassLike::class];
    /**
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Naming\Guard\BreakingVariableRenameGuard $breakingVariableRenameGuard, \_PhpScoper0a6b37af0871\Rector\Naming\Naming\ExpectedNameResolver $expectedNameResolver, \_PhpScoper0a6b37af0871\Rector\FamilyTree\Reflection\FamilyRelationsAnalyzer $familyRelationsAnalyzer, \_PhpScoper0a6b37af0871\Rector\Naming\NamingConvention\NamingConventionAnalyzer $namingConventionAnalyzer, \_PhpScoper0a6b37af0871\Rector\Naming\PhpDoc\VarTagValueNodeRenamer $varTagValueNodeRenamer, \_PhpScoper0a6b37af0871\Rector\Naming\Matcher\VariableAndCallAssignMatcher $variableAndCallAssignMatcher, \_PhpScoper0a6b37af0871\Rector\Naming\VariableRenamer $variableRenamer)
    {
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Rename variable to match method return type', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public function run()
    {
...
CODE_SAMPLE
     ...
     */
    private function isMultipleCall(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool
    {
        $parentNode = $node->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
        while ($parentNode) {
            $countUsed = \count($this->betterNodeFinder->find($parentNode, function (\_PhpScoper0a6b37af0871\PhpParser\Node $n) use($node) : bool {
    ...
    private function shouldSkip(\_PhpScoper0a6b37af0871\Rector\Naming\ValueObject\VariableAndCallAssign $variableAndCallAssign, string $expectedName) : bool
    {
    ...
    private function renameVariable(\_PhpScoper0a6b37af0871\Rector\Naming\ValueObject\VariableAndCallAssign $variableAndCallAssign, string $expectedName) : void
    {
     ...
     */
    private function isClassTypeWithChildren(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr $expr) : bool
    {
        $callStaticType = $this->getStaticType($expr);
        $callStaticType = $this->typeUnwrapper->unwrapNullableType($callStaticType);
        if (!$callStaticType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\TypeWithClassName) {
            return \false;
        }
