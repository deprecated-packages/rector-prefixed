...
final class OverridenExistingNamesResolver
{
     ...
     */
    private $arrayFilter;
    public function __construct(\_PhpScopere8e811afab72\Rector\Naming\PhpArray\ArrayFilter $arrayFilter, \_PhpScopere8e811afab72\Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder, \_PhpScopere8e811afab72\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver)
    {
     ...
     */
    public function checkNameInClassMethodForNew(string $variableName, \_PhpScopere8e811afab72\PhpParser\Node\FunctionLike $functionLike) : bool
    {
    ...
    public function checkNameInClassMethodForParam(string $expectedName, \_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        /** @var Assign[] $assigns */
     ...
     * @return string[]
     */
    private function resolveOveriddenNamesForNew(\_PhpScopere8e811afab72\PhpParser\Node\FunctionLike $functionLike) : array
    {
