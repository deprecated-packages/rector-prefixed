...
final class ReplaceTimeNumberWithDateTimeConstantRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     */
    private const NUMBER_TO_CONSTANT_NAME = [\_PhpScoperbd5d0c5f7638\Nette\Utils\DateTime::HOUR => 'HOUR', \_PhpScoperbd5d0c5f7638\Nette\Utils\DateTime::DAY => 'DAY', \_PhpScoperbd5d0c5f7638\Nette\Utils\DateTime::WEEK => 'WEEK', \_PhpScoperbd5d0c5f7638\Nette\Utils\DateTime::MONTH => 'MONTH', \_PhpScoperbd5d0c5f7638\Nette\Utils\DateTime::YEAR => 'YEAR'];
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        return $this->createClassConstFetch('_PhpScoperbd5d0c5f7638\\Nette\\Utils\\DateTime', $constantName);
    }
}
