...
use RectorPrefix20210124\Nette\Utils\DateTime;
use PhpParser\Node;
...
final class ReplaceTimeNumberWithDateTimeConstantRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     */
    private const NUMBER_TO_CONSTANT_NAME = [\RectorPrefix20210124\Nette\Utils\DateTime::HOUR => 'HOUR', \RectorPrefix20210124\Nette\Utils\DateTime::DAY => 'DAY', \RectorPrefix20210124\Nette\Utils\DateTime::WEEK => 'WEEK', \RectorPrefix20210124\Nette\Utils\DateTime::MONTH => 'MONTH', \RectorPrefix20210124\Nette\Utils\DateTime::YEAR => 'YEAR'];
