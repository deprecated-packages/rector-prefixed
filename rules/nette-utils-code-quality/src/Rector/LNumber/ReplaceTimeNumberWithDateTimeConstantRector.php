...
use _PhpScoper5edc98a7cce2\Nette\Utils\DateTime;
use PhpParser\Node;
...
final class ReplaceTimeNumberWithDateTimeConstantRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     */
    private const NUMBER_TO_CONSTANT_NAME = [\_PhpScoper5edc98a7cce2\Nette\Utils\DateTime::HOUR => 'HOUR', \_PhpScoper5edc98a7cce2\Nette\Utils\DateTime::DAY => 'DAY', \_PhpScoper5edc98a7cce2\Nette\Utils\DateTime::WEEK => 'WEEK', \_PhpScoper5edc98a7cce2\Nette\Utils\DateTime::MONTH => 'MONTH', \_PhpScoper5edc98a7cce2\Nette\Utils\DateTime::YEAR => 'YEAR'];
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        return $this->createClassConstFetch('_PhpScoper5edc98a7cce2\\Nette\\Utils\\DateTime', $constantName);
    }
}
