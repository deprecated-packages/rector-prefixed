...
namespace _PhpScoper2a4e7ab1ecbc\Rector\Php73\Rector\ConstFetch;
 ...
 */
final class SensitiveConstantNameRector extends \_PhpScoper2a4e7ab1ecbc\Rector\Core\Rector\AbstractRector
{
    /**
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node $node) : ?\_PhpScoper2a4e7ab1ecbc\PhpParser\Node
    {
        ...
        $node->name = new \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Name\FullyQualified($uppercasedConstantName);
        return $node;
    }
}
