 ...
 */
final class StringifyStrNeedlesRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector
{
    /**
     * @var string[]
     */
    ...
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Makes needles explicit strings', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
$needle = 5;
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        if ($nodeStaticType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\StringType) {
            return null;
        }
        if ($node->args[1]->value instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Cast\String_) {
            return null;
        }
        $node->args[1]->value = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Cast\String_($node->args[1]->value);
        return $node;
    }
}
