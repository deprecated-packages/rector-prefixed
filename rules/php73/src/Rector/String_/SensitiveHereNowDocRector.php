...
namespace _PhpScoperb75b35f52b74\Rector\Php73\Rector\String_;
 ...
 */
final class SensitiveHereNowDocRector extends \_PhpScoperb75b35f52b74\Rector\Core\Rector\AbstractRector
{
    /**
     * @var string
     */
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        if (!\in_array($kind, [\_PhpScoperb75b35f52b74\PhpParser\Node\Scalar\String_::KIND_HEREDOC, \_PhpScoperb75b35f52b74\PhpParser\Node\Scalar\String_::KIND_NOWDOC], \true)) {
            return null;
        }
        // the doc label is not in the string → ok
        /** @var string $docLabel */
        $docLabel = $node->getAttribute(self::ATTRIBUTE_DOC_LABEL);
        if (!\_PhpScoperb75b35f52b74\Nette\Utils\Strings::contains($node->value, $docLabel)) {
            return null;
        }
    ...
    private function uniquateDocLabel(string $value, string $docLabel) : string
    {
        ...
        $i = 0;
        while (\_PhpScoperb75b35f52b74\Nette\Utils\Strings::contains($value, $docLabel)) {
