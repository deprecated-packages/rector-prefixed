...
final class NameImporter
{
    ...
    public function __construct(\Rector\CodingStyle\ClassNameImport\AliasUsesResolver $aliasUsesResolver, \Rector\CodingStyle\ClassNameImport\ClassNameImportSkipper $classNameImportSkipper, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210131\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\PSR4\Collector\RenamedClassesCollector $renamedClassesCollector, \Rector\StaticTypeMapper\StaticTypeMapper $staticTypeMapper, \Rector\PostRector\Collector\UseNodesToAddCollector $useNodesToAddCollector)
    {
    ...
    private function isFunctionOrConstantImportWithSingleName(\PhpParser\Node\Name $name) : bool
    {
        ...
        if ($autoImportNames && !$parentNode instanceof \PhpParser\Node && !\RectorPrefix20210131\Nette\Utils\Strings::contains($fullName, '\\') && \function_exists($fullName)) {
            return \true;
        }
