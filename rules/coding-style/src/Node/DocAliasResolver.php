...
final class DocAliasResolver
{
    ...
    public function __construct(\RectorPrefix20210218\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\BetterPhpDocParser\PhpDocInfo\PhpDocInfoFactory $phpDocInfoFactory)
    {
    ...
    public function resolve(\PhpParser\Node $node) : array
    {
        ...
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($node, function (\PhpParser\Node $node) use(&$possibleDocAliases) : void {
            ...
            $matches = \RectorPrefix20210218\Nette\Utils\Strings::matchAll($docComment->getText(), self::DOC_ALIAS_REGEX);
