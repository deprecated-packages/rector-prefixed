...
final class DocAliasResolver
{
    ...
    {
        $possibleDocAliases = [];
        $this->callableNodeTraverser->traverseNodesWithCallable($node, function (\_PhpScopere8e811afab72\PhpParser\Node $node) use(&$possibleDocAliases) : void {
            ...
            $matches = \_PhpScopere8e811afab72\Nette\Utils\Strings::matchAll($docComment->getText(), self::DOC_ALIAS_REGEX);
     ...
     * @return string[]
     */
    private function collectVarType(\_PhpScopere8e811afab72\Rector\BetterPhpDocParser\PhpDocInfo\PhpDocInfo $phpDocInfo, array $possibleDocAliases) : array
    {
     ...
     * @return string[]
     */
    private function appendPossibleAliases(\_PhpScopere8e811afab72\PHPStan\Type\Type $varType, array $possibleDocAliases) : array
    {
        if ($varType instanceof \_PhpScopere8e811afab72\Rector\PHPStan\Type\AliasedObjectType) {
