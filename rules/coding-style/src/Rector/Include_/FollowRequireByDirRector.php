...
CODE_SAMPLE
    ...
    {
        return !\_PhpScoper267b3276efc2\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScoper267b3276efc2\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScoper267b3276efc2\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
