...
CODE_SAMPLE
    ...
    {
        return !\RectorPrefix2020DecSat\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\RectorPrefix2020DecSat\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \RectorPrefix2020DecSat\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
