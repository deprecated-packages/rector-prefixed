...
CODE_SAMPLE
    ...
    {
        return !\RectorPrefix20201229\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\RectorPrefix20201229\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \RectorPrefix20201229\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
