...
CODE_SAMPLE
    ...
    {
        return !\_PhpScoperabd03f0baf05\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScoperabd03f0baf05\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
