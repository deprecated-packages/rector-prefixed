...
CODE_SAMPLE
    ...
    {
        return !\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
