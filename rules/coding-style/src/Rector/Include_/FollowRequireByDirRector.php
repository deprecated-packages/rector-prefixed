...
CODE_SAMPLE
    ...
    {
        return !\_PhpScoper567b66d83109\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScoper567b66d83109\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScoper567b66d83109\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
