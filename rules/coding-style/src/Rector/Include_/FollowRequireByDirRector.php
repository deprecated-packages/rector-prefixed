...
CODE_SAMPLE
    ...
    {
        return !\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
