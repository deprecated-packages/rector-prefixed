...
CODE_SAMPLE
    ...
    {
        return !\_PhpScoper006a73f0e455\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScoper006a73f0e455\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScoper006a73f0e455\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
