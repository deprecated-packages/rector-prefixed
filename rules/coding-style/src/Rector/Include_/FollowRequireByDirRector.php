...
CODE_SAMPLE
    ...
    {
        return !\_PhpScopera143bcca66cb\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScopera143bcca66cb\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
