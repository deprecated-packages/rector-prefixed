...
CODE_SAMPLE
    ...
    {
        return !\_PhpScoper26e51eeacccf\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScoper26e51eeacccf\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScoper26e51eeacccf\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
