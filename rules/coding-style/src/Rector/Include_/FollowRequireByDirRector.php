...
CODE_SAMPLE
    ...
    {
        return !\_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
