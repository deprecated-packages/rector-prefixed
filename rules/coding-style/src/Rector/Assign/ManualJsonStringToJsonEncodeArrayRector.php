...
CODE_SAMPLE
    ...
    {
        if (!(bool) \RectorPrefix20201229\Nette\Utils\Strings::match($stringValue, self::JSON_STRING_REGEX)) {
            return \false;
        }
        try {
            return (bool) \RectorPrefix20201229\Nette\Utils\Json::decode($stringValue, \RectorPrefix20201229\Nette\Utils\Json::FORCE_ARRAY);
    ...
    {
        $stringValue = \RectorPrefix20201229\Nette\Utils\Strings::replace($stringValue, self::UNQUOTED_OBJECT_HASH_REGEX, '$1"$2"');
    ...
    {
        $array = \RectorPrefix20201229\Nette\Utils\Json::decode($stringValue, \RectorPrefix20201229\Nette\Utils\Json::FORCE_ARRAY);
