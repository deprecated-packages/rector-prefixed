...
CODE_SAMPLE
    ...
    {
        if (!(bool) \RectorPrefix20210109\Nette\Utils\Strings::match($stringValue, self::JSON_STRING_REGEX)) {
            return \false;
        }
        try {
            return (bool) \RectorPrefix20210109\Nette\Utils\Json::decode($stringValue, \RectorPrefix20210109\Nette\Utils\Json::FORCE_ARRAY);
    ...
    {
        $stringValue = \RectorPrefix20210109\Nette\Utils\Strings::replace($stringValue, self::UNQUOTED_OBJECT_HASH_REGEX, '$1"$2"');
    ...
    {
        $array = \RectorPrefix20210109\Nette\Utils\Json::decode($stringValue, \RectorPrefix20210109\Nette\Utils\Json::FORCE_ARRAY);
