...
CODE_SAMPLE
, [self::TYPE_TO_PREFERENCE => [\_PhpScoperabd03f0baf05\PHPUnit\Framework\TestCase::class => self::PREFER_SELF]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScoperabd03f0baf05\Webmozart\Assert\Assert::allString($typeToPreference);
