...
CODE_SAMPLE
, [self::TYPE_TO_PREFERENCE => [\_PhpScoper267b3276efc2\PHPUnit\Framework\TestCase::class => self::PREFER_SELF]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScoper267b3276efc2\Webmozart\Assert\Assert::allString($typeToPreference);
