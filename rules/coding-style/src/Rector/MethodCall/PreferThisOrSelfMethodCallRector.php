...
CODE_SAMPLE
, [self::TYPE_TO_PREFERENCE => [\_PhpScopera143bcca66cb\PHPUnit\Framework\TestCase::class => self::PREFER_SELF]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScopera143bcca66cb\Webmozart\Assert\Assert::allString($typeToPreference);
