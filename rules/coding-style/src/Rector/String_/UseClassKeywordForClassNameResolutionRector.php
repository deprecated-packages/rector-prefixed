...
CODE_SAMPLE
    ...
    {
        /** @var mixed[] $matches */
        $matches = \RectorPrefix20210209\Nette\Utils\Strings::matchAll($string->value, self::CLASS_BEFORE_STATIC_ACCESS_REGEX, \PREG_PATTERN_ORDER);
    ...
    public function getParts(\PhpParser\Node\Scalar\String_ $string, array $classNames) : array
    {
        ...
        $parts = \RectorPrefix20210209\Nette\Utils\Strings::split($string->value, '#(' . \implode('|', $classNames) . ')#');
