 ...
 */
final class YieldClassMethodToArrayClassMethodRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector implements \_PhpScoper0a6b37af0871\Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Core\PhpParser\NodeTransformer $nodeTransformer, array $methodsByType = [])
    {
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Turns yield return to array return in specific type and method', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample(<<<'CODE_SAMPLE'
...
, [self::METHODS_BY_TYPE => ['EventSubscriberInterface' => ['getSubscribedEvents']]])]);
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        foreach ($this->methodsByType as $type => $methods) {
            ...
            foreach ($methods as $method) {
                ...
                $returnExpression = new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Return_($arrayNode);
     ...
     * @return Yield_[]
     */
    private function collectYieldNodesFromClassMethod(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : array
    {
        $yieldNodes = [];
        ...
        foreach ($classMethod->stmts as $statement) {
            ...
            if ($statement->expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Yield_) {
