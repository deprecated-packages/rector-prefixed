...
CODE_SAMPLE
    ...
    private function getClassFileNameByClassMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : ?string
    {
        ...
        if (\RectorPrefix20210107\Nette\Utils\Strings::match($shortClassName, self::ANONYMOUS_CLASS_REGEX)) {
            return null;
        }
    ...
    private function isInVendor(\PhpParser\Node $node) : bool
    {
        ...
        return \RectorPrefix20210107\Nette\Utils\Strings::contains($fileName, 'vendor');
    }
