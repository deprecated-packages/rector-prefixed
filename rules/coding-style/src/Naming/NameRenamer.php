...
final class NameRenamer
{
     ...
     * @param Name|Identifier $usedNameNode
     */
    private function renameParam(string $lastName, \PhpParser\Node $parentNode, \PhpParser\Node $usedNameNode) : void
    {
        ...
        $parentNode->type = new \PhpParser\Node\Name($lastName);
    }
    /**
     * @param Name|Identifier $usedNameNode
     */
    private function renameNew(string $lastName, \PhpParser\Node $parentNode, \PhpParser\Node $usedNameNode) : void
    {
        if ($this->nodeNameResolver->areNamesEqual($parentNode->class, $usedNameNode)) {
            $parentNode->class = new \PhpParser\Node\Name($lastName);
        }
    }
    /**
     * @param Name|Identifier $usedNameNode
