...
final class UseImportsRemover
{
     ...
     * @param string[] $removedShortUses
     */
    public function removeImportsFromNamespace(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Namespace_ $namespace, array $removedShortUses) : void
    {
     ...
     * @param string[] $removedShortUses
     */
    private function removeUseFromUse(array $removedShortUses, \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Use_ $use) : void
    {
