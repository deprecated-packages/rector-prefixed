...
final class UseImportsAdder
{
    ...
    {
        $afterCurrentNamespace = \_PhpScoperbf340cb0be9d\Nette\Utils\Strings::after($objectType->getClassName(), $namespaceName . '\\');
        if (!$afterCurrentNamespace) {
            return \false;
        }
        return !\_PhpScoperbf340cb0be9d\Nette\Utils\Strings::contains($afterCurrentNamespace, '\\');
    }
}
