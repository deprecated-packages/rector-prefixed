...
final class UseImportsAdder
{
    ...
    {
        $afterCurrentNamespace = \_PhpScoper567b66d83109\Nette\Utils\Strings::after($objectType->getClassName(), $namespaceName . '\\');
        if (!$afterCurrentNamespace) {
            return \false;
        }
        return !\_PhpScoper567b66d83109\Nette\Utils\Strings::contains($afterCurrentNamespace, '\\');
    }
}
