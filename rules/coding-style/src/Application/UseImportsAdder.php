...
final class UseImportsAdder
{
    ...
    {
        $afterCurrentNamespace = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::after($objectType->getClassName(), $namespaceName . '\\');
        if (!$afterCurrentNamespace) {
            return \false;
        }
        return !\_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::contains($afterCurrentNamespace, '\\');
    }
}
