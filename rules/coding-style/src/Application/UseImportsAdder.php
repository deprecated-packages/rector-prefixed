...
final class UseImportsAdder
{
    ...
    {
        $afterCurrentNamespace = \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::after($objectType->getClassName(), $namespaceName . '\\');
        if (!$afterCurrentNamespace) {
            return \false;
        }
        return !\_PhpScoperfce0de0de1ce\Nette\Utils\Strings::contains($afterCurrentNamespace, '\\');
    }
}
