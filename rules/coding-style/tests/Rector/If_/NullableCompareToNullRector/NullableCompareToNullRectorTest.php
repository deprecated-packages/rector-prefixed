...
final class NullableCompareToNullRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\CodingStyle\Rector\If_\NullableCompareToNullRector::class;
    }
}
