...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210314\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210314\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
