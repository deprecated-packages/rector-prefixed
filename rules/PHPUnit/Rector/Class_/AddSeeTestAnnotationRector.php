...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210318\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210318\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
