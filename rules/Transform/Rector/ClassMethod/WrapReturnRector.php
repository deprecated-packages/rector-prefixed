...
, [self::TYPE_METHOD_WRAPS => [new \Rector\Transform\ValueObject\WrapReturn('SomeClass', 'getItem', \true)]])]);
    ...
    public function configure($configuration) : void
    {
        ...
        \RectorPrefix20210318\Webmozart\Assert\Assert::allIsInstanceOf($typeMethodWraps, \Rector\Transform\ValueObject\WrapReturn::class);
        $this->typeMethodWraps = $typeMethodWraps;
    }
    /**
     * @param \PhpParser\Node\Stmt\ClassMethod $classMethod
     * @param bool $isArrayWrap
     */
    private function wrap($classMethod, $isArrayWrap) : ?\PhpParser\Node\Stmt\ClassMethod
    {
