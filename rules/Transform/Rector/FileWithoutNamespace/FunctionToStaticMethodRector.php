...
CODE_SAMPLE
     ...
     * @return void
     */
    private function printStaticMethodClass(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $shortClassName, \PhpParser\Node $node, \PhpParser\Node\Stmt\Class_ $class)
    {
