...
CODE_SAMPLE
     ...
     */
    private function printStaticMethodClass(\RectorPrefix20210418\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $shortClassName, \PhpParser\Node $node, \PhpParser\Node\Stmt\Class_ $class) : void
    {
