...
CODE_SAMPLE
     ...
     * @return void
     */
    private function processNestedIfsWithOnlyReturn(If_ $if, array $nestedIfsWithOnlyReturn, Return_ $nextReturn)
    {
     ...
     * @return void
     */
    private function addStandaloneIfsWithReturn(If_ $nestedIfWithOnlyReturn, If_ $if, Return_ $return)
    {
        $return = clone $return;
