...
namespace _PhpScoper2a4e7ab1ecbc\Rector\Nette;
...
final class TemplatePropertyAssignCollector
{
    ...
    public function collectTemplateFileNameVariablesAndNodesToRemove(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\ClassMethod $classMethod) : \_PhpScoper2a4e7ab1ecbc\Rector\Nette\ValueObject\MagicTemplatePropertyCalls
    {
        $this->templateFileExpr = null;
        $this->templateVariables = [];
        $this->nodesToRemove = [];
        $this->callableNodeTraverser->traverseNodesWithCallable((array) $classMethod->stmts, function (\_PhpScoper2a4e7ab1ecbc\PhpParser\Node $node) : void {
        ...
        return new \_PhpScoper2a4e7ab1ecbc\Rector\Nette\ValueObject\MagicTemplatePropertyCalls($this->templateFileExpr, $this->templateVariables, $this->nodesToRemove);
    }
    private function collectTemplateFileExpr(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\MethodCall $methodCall) : void
    {
    ...
    private function collectVariableFromAssign(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\Assign $assign) : void
    {
        // $this->template = x
     ...
     * $this->template
     */
    private function isTemplatePropertyFetch(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr $expr) : bool
    {
        if (!$expr instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\PropertyFetch) {
            return \false;
        }
        if (!$expr->var instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\Variable) {
            return \false;
        }
