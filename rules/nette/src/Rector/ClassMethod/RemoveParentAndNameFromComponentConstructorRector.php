...
final class RemoveParentAndNameFromComponentConstructorRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const COMPONENT_CONTAINER_CLASS = '_PhpScoper567b66d83109\\Nette\\ComponentModel\\IContainer';
    /**
     * @var string
     */
...
CODE_SAMPLE
    ...
    {
        if (!$this->isInObjectType($classMethod, \_PhpScoper567b66d83109\Nette\Application\UI\Control::class)) {
            return null;
        }
