...
final class RemoveParentAndNameFromComponentConstructorRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const COMPONENT_CONTAINER_CLASS = '_PhpScopera143bcca66cb\\Nette\\ComponentModel\\IContainer';
    /**
     * @var string
     */
...
CODE_SAMPLE
    ...
    {
        if (!$this->isInObjectType($classMethod, \_PhpScopera143bcca66cb\Nette\Application\UI\Control::class)) {
            return null;
        }
