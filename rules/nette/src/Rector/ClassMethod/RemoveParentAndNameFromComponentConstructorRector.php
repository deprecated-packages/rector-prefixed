...
final class RemoveParentAndNameFromComponentConstructorRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const COMPONENT_CONTAINER_CLASS = '_PhpScoper88fe6e0ad041\\Nette\\ComponentModel\\IContainer';
    /**
     * @var string
     */
...
CODE_SAMPLE
    ...
    {
        if (!$this->isInObjectType($classMethod, \_PhpScoper88fe6e0ad041\Nette\Application\UI\Control::class)) {
            return null;
        }
