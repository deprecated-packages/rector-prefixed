 ...
 */
final class TranslateClassMethodToVariadicsRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
     * @var string
     */
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change translate() method call 2nd arg to variadic', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->isMethodStaticCallOrClassMethodObjectType($node, '_PhpScoper0a6b37af0871\\Nette\\Localization\\ITranslator')) {
            return null;
        }
        ...
        if (!$secondParam->var instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable) {
            return null;
        }
    ...
    private function replaceSecondParamInClassMethodBody(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScoper0a6b37af0871\PhpParser\Node\Param $param) : void
    {
        $paramName = $this->getName($param->var);
        $this->traverseNodesWithCallable((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($paramName) : ?int {
    ...
    private function createCoalesceAssign(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable $variable) : \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign
    {
        $arrayDimFetch = new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\ArrayDimFetch(new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable(self::PARAMETERS), new \_PhpScoper0a6b37af0871\PhpParser\Node\Scalar\LNumber(0));
        $coalesce = new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\Coalesce($arrayDimFetch, $this->createNull());
        return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign(new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Variable($variable->name), $coalesce);
    }
}
