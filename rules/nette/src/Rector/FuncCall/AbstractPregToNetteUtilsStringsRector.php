 ...
 */
abstract class AbstractPregToNetteUtilsStringsRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector
{
    /**
     * @param array<string, string> $functionRenameMap
     */
    protected function matchFuncCallRenameToMethod(\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\FuncCall $funcCall, array $functionRenameMap) : ?string
    {
