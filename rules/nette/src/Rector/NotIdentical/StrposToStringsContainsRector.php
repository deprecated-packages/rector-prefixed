...
namespace _PhpScoper0a6b37af0871\Rector\Nette\Rector\NotIdentical;
 ...
 */
final class StrposToStringsContainsRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
...
CODE_SAMPLE
    ...
    {
        return [\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\NotIdentical::class, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\Identical::class];
    }
    /**
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        ...
        $containsStaticCall = $this->createStaticCall('_PhpScoper0a6b37af0871\\Nette\\Utils\\Strings', 'contains');
        ...
        if ($node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\Identical) {
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BooleanNot($containsStaticCall);
        }
        return $containsStaticCall;
    }
    private function matchStrposInComparisonToFalse(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp $binaryOp) : ?\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall
    {
        if ($this->isFalse($binaryOp->left)) {
            if (!$binaryOp->right instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall) {
                return null;
            }
        ...
        if ($this->isFalse($binaryOp->right)) {
            if (!$binaryOp->left instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall) {
                return null;
            }
