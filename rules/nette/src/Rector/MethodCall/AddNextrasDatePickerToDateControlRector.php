...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($node->var instanceof \PhpParser\Node\Expr\MethodCall) {
            if (!$this->isOnClassMethodCall($node->var, '_PhpScoperf18a0c41e2d2\\Nette\\Application\\UI\\Form', 'addDatePicker')) {
                return null;
            }
        ...
        // 2. assign call
        if (!$this->isOnClassMethodCall($node, '_PhpScoperf18a0c41e2d2\\Nette\\Application\\UI\\Form', 'addDatePicker')) {
            return null;
        }
    ...
    {
        $fullyQualified = new \PhpParser\Node\Name\FullyQualified('_PhpScoperf18a0c41e2d2\\Nextras\\FormComponents\\Controls\\DateControl');
