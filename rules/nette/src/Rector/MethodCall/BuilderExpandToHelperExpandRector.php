...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($node, '_PhpScoper88fe6e0ad041\\Nette\\DI\\ContainerBuilder', 'expand')) {
            return null;
        }
        $args = $node->args;
        ...
        return new \PhpParser\Node\Expr\StaticCall(new \PhpParser\Node\Name\FullyQualified('_PhpScoper88fe6e0ad041\\Nette\\DI\\Helpers'), 'expand', $args);
    }
}
