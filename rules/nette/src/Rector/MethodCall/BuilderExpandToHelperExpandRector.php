...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($node, '_PhpScoperf18a0c41e2d2\\Nette\\DI\\ContainerBuilder', 'expand')) {
            return null;
        }
        $args = $node->args;
        ...
        return new \PhpParser\Node\Expr\StaticCall(new \PhpParser\Node\Name\FullyQualified('_PhpScoperf18a0c41e2d2\\Nette\\DI\\Helpers'), 'expand', $args);
    }
}
