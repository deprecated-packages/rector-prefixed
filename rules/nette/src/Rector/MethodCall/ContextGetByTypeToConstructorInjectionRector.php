...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($node->var, '_PhpScoper8b9c402c5f32\\Nette\\DI\\Container')) {
            return null;
        }
    ...
    private function isInTestClass(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        return $this->isObjectTypes($classLike, ['_PhpScoper8b9c402c5f32\\PHPUnit\\Framework\\TestCase', 'PHPUnit_Framework_TestCase']);
    }
}
