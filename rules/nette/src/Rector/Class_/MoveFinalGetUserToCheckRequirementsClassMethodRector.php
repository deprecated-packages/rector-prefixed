...
namespace _PhpScoper0a6b37af0871\Rector\Nette\Rector\Class_;
...
use _PhpScoper0a6b37af0871\Rector\Nette\NodeFactory\CheckRequirementsClassMethodFactory;
 ...
 */
final class MoveFinalGetUserToCheckRequirementsClassMethodRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Nette\NodeFactory\CheckRequirementsClassMethodFactory $checkRequirementsClassMethodFactory, \_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Node\Manipulator\ClassInsertManipulator $classInsertManipulator)
    {
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Presenter method getUser() is now final, move logic to checkRequirements()', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScoper0a6b37af0871\\Nette\\Application\\UI\\Presenter')) {
            return null;
        }
