...
, [self::ISSET_UNSET_TO_METHOD_CALL => [$issetUnsetToMethodCall]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScoper88fe6e0ad041\Webmozart\Assert\Assert::allIsInstanceOf($issetUnsetToMethodCalls, \Rector\MagicDisclosure\ValueObject\IssetUnsetToMethodCall::class);
