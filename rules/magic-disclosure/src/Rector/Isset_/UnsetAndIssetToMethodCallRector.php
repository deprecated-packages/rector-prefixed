...
, [self::ISSET_UNSET_TO_METHOD_CALL => [$issetUnsetToMethodCall]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScoperbf340cb0be9d\Webmozart\Assert\Assert::allIsInstanceOf($issetUnsetToMethodCalls, \Rector\MagicDisclosure\ValueObject\IssetUnsetToMethodCall::class);
