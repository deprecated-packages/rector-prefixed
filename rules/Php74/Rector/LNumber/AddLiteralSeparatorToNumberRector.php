...
, [self::LIMIT_VALUE => 1000000])]);
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        if (\RectorPrefix20210317\Nette\Utils\Strings::contains($numericValueAsString, '.')) {
    ...
    private function shouldSkip($node, $numericValueAsString) : bool
    {
        ...
        // already separated
        if (\RectorPrefix20210317\Nette\Utils\Strings::contains($numericValueAsString, '_')) {
            return \true;
        }
        ...
        // e+/e-
        if (\RectorPrefix20210317\Nette\Utils\Strings::match($numericValueAsString, '#e#i')) {
            return \true;
        }
        // too short
        return \RectorPrefix20210317\Nette\Utils\Strings::length($numericValueAsString) <= self::GROUP_SIZE;
    }
    /**
     * @return string[]
     * @param string $string
