...
final class SelfContainerMethodCallCollector
{
    ...
    public function __construct(\RectorPrefix20210122\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\SymfonyPHPUnit\Node\KernelTestCaseNodeAnalyzer $kernelTestCaseNodeAnalyzer, \Rector\Core\PhpParser\Node\Value\ValueResolver $valueResolver)
    {
    ...
    {
        return $serviceType === \RectorPrefix20210122\Symfony\Component\HttpFoundation\Session\SessionInterface::class;
    }
}
