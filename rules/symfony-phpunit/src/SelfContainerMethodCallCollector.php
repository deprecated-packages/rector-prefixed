...
final class SelfContainerMethodCallCollector
{
    ...
    public function __construct(\RectorPrefix20210125\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\SymfonyPHPUnit\Node\KernelTestCaseNodeAnalyzer $kernelTestCaseNodeAnalyzer, \Rector\Core\PhpParser\Node\Value\ValueResolver $valueResolver)
    {
    ...
    {
        return $serviceType === \RectorPrefix20210125\Symfony\Component\HttpFoundation\Session\SessionInterface::class;
    }
}
