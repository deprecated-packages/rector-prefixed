...
final class MultiParentingToAbstractDependencyRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    /**
     * @param \Rector\DependencyInjection\NodeRemover\ClassMethodNodeRemover $classMethodNodeRemover
     * @param \Rector\DependencyInjection\NodeFactory\InjectMethodFactory $injectMethodFactory
     ...
     */
    public function __construct($classMethodNodeRemover, $injectMethodFactory, $phpDocInfoFactory, $classInsertManipulator)
    {
