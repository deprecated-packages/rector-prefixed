...
final class ClassRenamer
{
     ...
     */
    public function renameNode(Node $node, array $oldToNewClasses)
    {
        $oldToNewTypes = [];
     ...
     * @return void
     */
    private function refactorPhpDoc(Node $node, array $oldToNewTypes, array $oldToNewClasses)
    {
     ...
     */
    private function refactorName(Name $name, array $oldToNewClasses)
    {
     ...
     * @return void
     */
    private function removeUseName(Name $oldName)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorNamespace(Namespace_ $namespace, array $oldToNewClasses)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorClassLike(ClassLike $classLike, array $oldToNewClasses)
    {
        // rename interfaces
     ...
     */
    private function getClassOfNamespaceToRefactor(Namespace_ $namespace, array $oldToNewClasses)
    {
     ...
     * @return void
     */
    private function renameClassImplements(ClassLike $classLike, array $oldToNewClasses)
    {
     ...
     * @return void
     */
    private function changeNameToFullyQualifiedName(ClassLike $classLike)
    {
