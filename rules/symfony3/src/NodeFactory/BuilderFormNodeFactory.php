...
final class BuilderFormNodeFactory
{
    ...
    public function create(\PhpParser\Node\Stmt\ClassMethod $constructorClassMethod) : \PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $classMethodBuilder = new \RectorPrefix20210117\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('buildForm');
    ...
    {
        $builderParamBuilder = new \RectorPrefix20210117\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('builder');
    ...
    {
        $optionsParamBuilder = new \RectorPrefix20210117\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('options');
