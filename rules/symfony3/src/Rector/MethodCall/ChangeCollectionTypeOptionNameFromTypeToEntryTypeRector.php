 ...
 */
final class ChangeCollectionTypeOptionNameFromTypeToEntryTypeRector extends \_PhpScoper0a2ac50786fa\Rector\Symfony3\Rector\MethodCall\AbstractFormAddRector
{
    /**
    ...
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Rename `type` option to `entry_type` in CollectionType', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function refactorOptionsArray(\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Array_ $optionsArray) : void
    {
        foreach ($optionsArray->items as $arrayItem) {
            ...
            foreach (self::OLD_TO_NEW_OPTION_NAME as $oldName => $newName) {
                ...
                $arrayItem->key = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Scalar\String_($newName);
            }
        }
    }
}
