 ...
 */
final class ChangeCollectionTypeOptionNameFromTypeToEntryTypeRector extends \Rector\Symfony3\Rector\MethodCall\AbstractFormAddRector
{
    /**
    ...
    {
        return new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Rename `type` option to `entry_type` in CollectionType', [new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
