 ...
 */
final class OptionNameRector extends \_PhpScoper0a6b37af0871\Rector\Symfony3\Rector\MethodCall\AbstractFormAddRector
{
    /**
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Turns old option names to new ones in FormTypes in Form in Symfony', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        ...
        foreach ($optionsArray->items as $arrayItemNode) {
            ...
            if (!$arrayItemNode->key instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Scalar\String_) {
                continue;
            }
    ...
    private function processStringKey(\_PhpScoper0a6b37af0871\PhpParser\Node\Scalar\String_ $string) : void
    {
