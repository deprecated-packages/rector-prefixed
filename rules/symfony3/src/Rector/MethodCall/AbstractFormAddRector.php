...
abstract class AbstractFormAddRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string[]
     */
    private const FORM_TYPES = ['_PhpScoper8b9c402c5f32\\Symfony\\Component\\Form\\FormBuilderInterface', '_PhpScoper8b9c402c5f32\\Symfony\\Component\\Form\\FormInterface'];
    /**
    ...
    protected function isCollectionType(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        if ($typeValue instanceof \PhpParser\Node\Expr\ClassConstFetch && $this->isName($typeValue->class, '_PhpScoper8b9c402c5f32\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CollectionType')) {
            return \true;
        }
