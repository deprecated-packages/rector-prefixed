...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\RectorPrefix20210217\Nette\Utils\Strings::endsWith($shortClassName, 'Type')) {
            $shortClassName = (string) \RectorPrefix20210217\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
