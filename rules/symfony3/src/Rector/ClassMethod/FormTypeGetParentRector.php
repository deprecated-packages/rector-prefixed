...
CODE_SAMPLE
    ...
    {
        if ($this->isInObjectType($classMethod, '_PhpScoper17db12703726\\Symfony\\Component\\Form\\AbstractType')) {
            return $this->isName($classMethod->name, 'getParent');
        }
        if ($this->isInObjectType($classMethod, '_PhpScoper17db12703726\\Symfony\\Component\\Form\\AbstractTypeExtension')) {
