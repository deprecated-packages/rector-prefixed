...
CODE_SAMPLE
    ...
    {
        if ($this->isInObjectType($classMethod, '_PhpScoper8b9c402c5f32\\Symfony\\Component\\Form\\AbstractType')) {
            return $this->isName($classMethod->name, 'getParent');
        }
        if ($this->isInObjectType($classMethod, '_PhpScoper8b9c402c5f32\\Symfony\\Component\\Form\\AbstractTypeExtension')) {
