...
final class PSR4AutoloadPathsProvider
{
    ...
    public function __construct(\RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function readFileToJsonArray(string $composerJson) : array
    {
        ...
        return \RectorPrefix20210103\Nette\Utils\Json::decode($composerJsonContent, \RectorPrefix20210103\Nette\Utils\Json::FORCE_ARRAY);
    }
