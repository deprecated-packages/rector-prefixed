...
final class FileInfoDeletionAnalyzer
{
    ...
    public function isClassLikeAndFileInfoMatch(\PhpParser\Node\Stmt\ClassLike $classLike) : bool
    {
        ...
        $smartFileInfo = $classLike->getAttribute(\RectorPrefix20210126\Symplify\SmartFileSystem\SmartFileInfo::class);
    ...
    {
        return \RectorPrefix20210126\Nette\Utils\Strings::replace($name, self::TESTING_PREFIX_REGEX, '');
    }
}
