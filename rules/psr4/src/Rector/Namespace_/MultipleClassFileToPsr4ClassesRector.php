...
namespace _PhpScopere8e811afab72\Rector\PSR4\Rector\Namespace_;
...
use _PhpScopere8e811afab72\Rector\PSR4\FileInfoAnalyzer\FileInfoDeletionAnalyzer;
use _PhpScopere8e811afab72\Rector\PSR4\NodeManipulator\NamespaceManipulator;
 ...
 */
final class MultipleClassFileToPsr4ClassesRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    public function __construct(\_PhpScopere8e811afab72\Rector\PSR4\NodeManipulator\NamespaceManipulator $namespaceManipulator, \_PhpScopere8e811afab72\Rector\PSR4\FileInfoAnalyzer\FileInfoDeletionAnalyzer $fileInfoDeletionAnalyzer)
    {
    ...
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change multiple classes in one file to standalone PSR-4 classes.', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function hasAtLeastTwoClassLikes(\_PhpScopere8e811afab72\PhpParser\Node $node) : bool
    {
        $classes = $this->betterNodeFinder->findClassLikes($node);
        return \count($classes) > 1;
    }
    private function refactorNamespace(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\Namespace_ $namespace) : ?\_PhpScopere8e811afab72\PhpParser\Node\Stmt\Namespace_
    {
    ...
    private function refactorFileWithoutNamespace(\_PhpScopere8e811afab72\Rector\Core\PhpParser\Node\CustomNode\FileWithoutNamespace $fileWithoutNamespace) : ?\_PhpScopere8e811afab72\Rector\Core\PhpParser\Node\CustomNode\FileWithoutNamespace
    {
        /** @var ClassLike[] $classLikes */
     ...
     */
    private function printNewNodes(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassLike $classLike, \_PhpScopere8e811afab72\PhpParser\Node $mainNode) : void
    {
        /** @var SmartFileInfo $smartFileInfo */
        $smartFileInfo = $mainNode->getAttribute(\_PhpScopere8e811afab72\Rector\NodeTypeResolver\Node\AttributeKey::FILE_INFO);
        /** @var Declare_[] $declares */
        $declares = (array) $mainNode->getAttribute(\_PhpScopere8e811afab72\Rector\NodeTypeResolver\Node\AttributeKey::DECLARES);
        if ($mainNode instanceof \_PhpScopere8e811afab72\Rector\Core\PhpParser\Node\CustomNode\FileWithoutNamespace) {
        ...
        $movedFileWithNodes = new \_PhpScopere8e811afab72\Rector\FileSystemRector\ValueObject\MovedFileWithNodes($nodesToPrint, $fileDestination, $smartFileInfo);
        $this->addMovedFile($movedFileWithNodes);
    }
    private function createClassLikeFileDestination(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassLike $classLike, \_PhpScopere8e811afab72\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
