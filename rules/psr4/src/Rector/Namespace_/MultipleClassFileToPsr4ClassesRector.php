...
CODE_SAMPLE
    ...
    private function createClassLikeFileDestination(\PhpParser\Node\Stmt\ClassLike $classLike, \RectorPrefix20210210\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
