...
CODE_SAMPLE
    ...
    private function createClassLikeFileDestination(\PhpParser\Node\Stmt\ClassLike $classLike, \RectorPrefix20201231\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
