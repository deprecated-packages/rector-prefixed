...
final class MultipleClassFileToPsr4ClassesRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
     ...
     */
    public function test(\RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, array $expectedFilePathsWithContents) : void
    {
    ...
    public function provideData() : \Iterator
    {
        ...
        (yield [new \RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/nette_exceptions.php.inc'), $filePathsWithContents]);
        ...
        (yield [new \RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/skip_without_namespace.php.inc'), $filePathsWithContents]);
        ...
        (yield [new \RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/class_trait_and_interface.php.inc'), $filePathsWithContents]);
        // keep original class
        (yield [
            new \RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/some_class.php.inc'),
            // extra files
        ...
        (yield [new \RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/skip_ready_exception.php.inc'), []]);
    }
