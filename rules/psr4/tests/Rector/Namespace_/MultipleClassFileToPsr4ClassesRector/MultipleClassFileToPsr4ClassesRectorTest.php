...
final class MultipleClassFileToPsr4ClassesRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
     ...
     */
    public function test(\RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, array $expectedFilePathsWithContents) : void
    {
    ...
    public function provideData() : \Iterator
    {
        ...
        (yield [new \RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/nette-exceptions.php'), $filePathsWithContents]);
        ...
        (yield [new \RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/without-namespace.php'), $filePathsWithContents]);
        ...
        (yield [new \RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/ClassTraitAndInterface.php.inc'), $filePathsWithContents]);
        // keep original class
        (yield [
            new \RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/SomeClass.php'),
            // extra files
