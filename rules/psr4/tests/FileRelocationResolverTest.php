...
final class FileRelocationResolverTest extends \RectorPrefix20201230\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20201230\Symplify\SmartFileSystem\SmartFileInfo($file);
