...
final class FileRelocationResolverTest extends \RectorPrefix20210304\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210304\Symplify\SmartFileSystem\SmartFileInfo($file);
