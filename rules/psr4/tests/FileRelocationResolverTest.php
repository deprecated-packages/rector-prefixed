...
final class FileRelocationResolverTest extends \RectorPrefix20210228\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210228\Symplify\SmartFileSystem\SmartFileInfo($file);
