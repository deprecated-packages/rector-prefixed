...
final class FileRelocationResolverTest extends \RectorPrefix20210131\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210131\Symplify\SmartFileSystem\SmartFileInfo($file);
