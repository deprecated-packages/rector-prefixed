...
final class FileRelocationResolverTest extends \RectorPrefix20210120\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210120\Symplify\SmartFileSystem\SmartFileInfo($file);
