...
final class FileRelocationResolverTest extends \RectorPrefix20210202\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo($file);
