...
final class FileRelocationResolverTest extends \RectorPrefix20210219\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210219\Symplify\SmartFileSystem\SmartFileInfo($file);
