...
final class FileRelocationResolverTest extends \RectorPrefix20210223\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210223\Symplify\SmartFileSystem\SmartFileInfo($file);
