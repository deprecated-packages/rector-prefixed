...
final class FileRelocationResolverTest extends \RectorPrefix20210220\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210220\Symplify\SmartFileSystem\SmartFileInfo($file);
