...
final class FileRelocationResolverTest extends \RectorPrefix20210206\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210206\Symplify\SmartFileSystem\SmartFileInfo($file);
