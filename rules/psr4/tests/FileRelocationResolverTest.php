...
final class FileRelocationResolverTest extends \RectorPrefix20210122\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210122\Symplify\SmartFileSystem\SmartFileInfo($file);
