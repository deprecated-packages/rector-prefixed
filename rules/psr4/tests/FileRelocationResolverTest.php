...
final class FileRelocationResolverTest extends \RectorPrefix20210306\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210306\Symplify\SmartFileSystem\SmartFileInfo($file);
