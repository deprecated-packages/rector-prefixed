...
final class FileRelocationResolverTest extends \RectorPrefix20210309\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210309\Symplify\SmartFileSystem\SmartFileInfo($file);
