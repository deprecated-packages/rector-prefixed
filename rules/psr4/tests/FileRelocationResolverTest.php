...
final class FileRelocationResolverTest extends \RectorPrefix20210125\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210125\Symplify\SmartFileSystem\SmartFileInfo($file);
