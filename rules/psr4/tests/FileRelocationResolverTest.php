...
final class FileRelocationResolverTest extends \RectorPrefix20210119\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210119\Symplify\SmartFileSystem\SmartFileInfo($file);
