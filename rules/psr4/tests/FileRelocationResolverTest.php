...
final class FileRelocationResolverTest extends \RectorPrefix20210123\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210123\Symplify\SmartFileSystem\SmartFileInfo($file);
