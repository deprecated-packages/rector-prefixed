...
final class FileRelocationResolverTest extends \RectorPrefix20210218\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210218\Symplify\SmartFileSystem\SmartFileInfo($file);
