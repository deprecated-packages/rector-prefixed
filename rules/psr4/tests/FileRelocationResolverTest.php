...
final class FileRelocationResolverTest extends \RectorPrefix20210121\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo($file);
