...
final class FileRelocationResolverTest extends \RectorPrefix20210111\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo($file);
