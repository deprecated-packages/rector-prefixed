...
final class FileRelocationResolverTest extends \RectorPrefix20210305\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210305\Symplify\SmartFileSystem\SmartFileInfo($file);
