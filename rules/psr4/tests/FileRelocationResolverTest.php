...
final class FileRelocationResolverTest extends \RectorPrefix20210226\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210226\Symplify\SmartFileSystem\SmartFileInfo($file);
