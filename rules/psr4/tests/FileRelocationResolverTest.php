...
final class FileRelocationResolverTest extends \RectorPrefix20210224\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $smartFileInfo = new \RectorPrefix20210224\Symplify\SmartFileSystem\SmartFileInfo($file);
