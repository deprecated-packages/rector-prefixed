...
final class ChangeConditionalSetConditionRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\PHPOffice\Rector\MethodCall\ChangeConditionalSetConditionRector::class;
    }
}
