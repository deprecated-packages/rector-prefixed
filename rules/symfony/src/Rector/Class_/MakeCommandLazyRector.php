...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScopera143bcca66cb\\Symfony\\Component\\Console\\Command\\Command')) {
            return null;
        }
    ...
    private function resolveCommandNameFromConstructor(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node
    {
        ...
        $this->traverseNodesWithCallable((array) $class->stmts, function (\PhpParser\Node $node) use(&$commandName) {
            ...
            if (!$this->isObjectType($node->class, '_PhpScopera143bcca66cb\\Symfony\\Component\\Console\\Command\\Command')) {
                return null;
            }
    ...
    private function resolveCommandNameFromSetName(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node
    {
        ...
        $this->traverseNodesWithCallable((array) $class->stmts, function (\PhpParser\Node $node) use(&$commandName) {
            ...
            if (!$this->isObjectType($node->var, '_PhpScopera143bcca66cb\\Symfony\\Component\\Console\\Command\\Command')) {
                return null;
            }
