...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, '_PhpScoper8b9c402c5f32\\Symfony\\Component\\Console\\Command\\Command')) {
            return null;
        }
    ...
    private function resolveCommandNameFromConstructor(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node
    {
        ...
        $this->traverseNodesWithCallable($class->stmts, function (\PhpParser\Node $node) use(&$commandName) {
            ...
            if (!$this->isObjectType($node->class, '_PhpScoper8b9c402c5f32\\Symfony\\Component\\Console\\Command\\Command')) {
                return null;
            }
    ...
    private function resolveCommandNameFromSetName(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node
    {
        ...
        $this->traverseNodesWithCallable($class->stmts, function (\PhpParser\Node $node) use(&$commandName) {
            ...
            if (!$this->isObjectType($node->var, '_PhpScoper8b9c402c5f32\\Symfony\\Component\\Console\\Command\\Command')) {
                return null;
            }
