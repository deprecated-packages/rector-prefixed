...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($this->isObjectType($expr, '_PhpScoper26e51eeacccf\\Symfony\\Component\\Process\\Process')) {
            return $this->processArgumentPosition($node, 0);
        }
        if ($this->isObjectType($expr, '_PhpScoper26e51eeacccf\\Symfony\\Component\\Console\\Helper\\ProcessHelper')) {
    ...
    private function splitProcessCommandToItems(string $process) : array
    {
        ...
        return $privatesCaller->callPrivateMethod(new \_PhpScoper26e51eeacccf\Symfony\Component\Console\Input\StringInput(''), 'tokenize', $process);
    }
