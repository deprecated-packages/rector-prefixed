...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->class, '_PhpScoperbd5d0c5f7638\\Symfony\\Component\\Config\\Definition\\Builder\\TreeBuilder')) {
            return null;
        }
    ...
    private function getRootMethodCallNode(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        return $this->betterNodeFinder->findFirst([$nextExpression], function (\PhpParser\Node $node) : bool {
            ...
            if (!$this->isObjectType($node->var, '_PhpScoperbd5d0c5f7638\\Symfony\\Component\\Config\\Definition\\Builder\\TreeBuilder')) {
                return \false;
            }
