...
use _PhpScopera143bcca66cb\Symfony\Component\Process\ProcessBuilder;
...
final class ProcessBuilderInstanceRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isName($node->class, \_PhpScopera143bcca66cb\Symfony\Component\Process\ProcessBuilder::class)) {
            return null;
        }
