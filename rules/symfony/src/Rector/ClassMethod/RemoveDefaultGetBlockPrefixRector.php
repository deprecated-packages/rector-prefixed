...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\_PhpScoperabd03f0baf05\Nette\Utils\Strings::endsWith($classShortName, 'Type')) {
            $classShortName = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::before($classShortName, 'Type');
        }
    ...
    {
        if (!$this->isInObjectType($classMethod, '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\AbstractType')) {
            return \false;
        }
