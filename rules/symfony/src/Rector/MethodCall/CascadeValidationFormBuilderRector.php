...
CODE_SAMPLE
    ...
    private function findAndRemoveCascadeValidationOption(\PhpParser\Node\Expr\MethodCall $methodCall, \PhpParser\Node\Expr\Array_ $optionsArrayNode) : bool
    {
    ...
    {
        $new = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('_PhpScoper006a73f0e455\\Symfony\\Component\\Validator\\Constraints\\Valid'));
