...
abstract class AbstractFormAddRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string[]
     */
    private const FORM_TYPES = ['_PhpScoper88fe6e0ad041\\Symfony\\Component\\Form\\FormBuilderInterface', '_PhpScoper88fe6e0ad041\\Symfony\\Component\\Form\\FormInterface'];
    /**
    ...
    protected function isCollectionType(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        if ($typeValue instanceof \PhpParser\Node\Expr\ClassConstFetch && $this->isName($typeValue->class, '_PhpScoper88fe6e0ad041\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CollectionType')) {
            return \true;
        }
