...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoper267b3276efc2\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \_PhpScoper267b3276efc2\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
