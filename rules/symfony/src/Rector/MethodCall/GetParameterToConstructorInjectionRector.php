...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoperf18a0c41e2d2\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
