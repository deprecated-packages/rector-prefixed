...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoperabd03f0baf05\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
