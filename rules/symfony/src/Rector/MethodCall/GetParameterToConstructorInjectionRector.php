...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, 'RectorPrefix2020DecSat\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \RectorPrefix2020DecSat\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
