...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoperbf340cb0be9d\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \_PhpScoperbf340cb0be9d\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
