...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoperfce0de0de1ce\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
