...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoper5edc98a7cce2\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
