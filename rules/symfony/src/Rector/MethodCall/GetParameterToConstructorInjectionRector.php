...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoper8b9c402c5f32\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \_PhpScoper8b9c402c5f32\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
