...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoper50d83356d739\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \_PhpScoper50d83356d739\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
