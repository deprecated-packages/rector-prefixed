 ...
 */
final class FormTypeInstanceToClassConstRector extends \Rector\Symfony\Rector\MethodCall\AbstractFormAddRector
{
    /**
     * @var string[]
     */
    private const CONTROLLER_TYPES = ['_PhpScoper26e51eeacccf\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller', '_PhpScoper26e51eeacccf\\Symfony\\Bundle\\FrameworkBundle\\Controller\\AbstractController'];
    /**
    ...
    public function __construct(\Rector\Symfony\NodeFactory\BuilderFormNodeFactory $builderFormNodeFactory, \Rector\Symfony\NodeFactory\ConfigureOptionsNodeFactory $configureOptionsNodeFactory)
    {
...
CODE_SAMPLE
     ...
     * @param Arg[] $argNodes
     */
    private function moveArgumentsToOptions(\PhpParser\Node\Expr\MethodCall $methodCall, int $position, int $optionsPosition, string $className, array $argNodes) : ?\PhpParser\Node
    {
