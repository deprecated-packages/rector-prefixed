...
final class ServiceMapProvider
{
    ...
    {
        $data = \_PhpScoper5edc98a7cce2\Nette\Utils\Json::decode(\_PhpScoper5edc98a7cce2\Nette\Utils\Json::encode((array) $simpleXMLElement), \_PhpScoper5edc98a7cce2\Nette\Utils\Json::FORCE_ARRAY);
