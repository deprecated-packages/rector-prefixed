...
final class ServiceMapProvider
{
    ...
    public function __construct(\RectorPrefix20210303\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210303\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210303\Nette\Utils\Json::decode(\RectorPrefix20210303\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210303\Nette\Utils\Json::FORCE_ARRAY);
