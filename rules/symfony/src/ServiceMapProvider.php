...
final class ServiceMapProvider
{
    ...
    public function __construct(\RectorPrefix20210206\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210206\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210206\Nette\Utils\Json::decode(\RectorPrefix20210206\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210206\Nette\Utils\Json::FORCE_ARRAY);
