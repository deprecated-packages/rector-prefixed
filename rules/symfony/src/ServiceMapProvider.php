...
final class ServiceMapProvider
{
    ...
    public function __construct(\RectorPrefix20210214\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210214\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210214\Nette\Utils\Json::decode(\RectorPrefix20210214\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210214\Nette\Utils\Json::FORCE_ARRAY);
