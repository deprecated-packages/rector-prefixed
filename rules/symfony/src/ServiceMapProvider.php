...
final class ServiceMapProvider
{
    ...
    {
        $data = \_PhpScoperbf340cb0be9d\Nette\Utils\Json::decode(\_PhpScoperbf340cb0be9d\Nette\Utils\Json::encode((array) $simpleXMLElement), \_PhpScoperbf340cb0be9d\Nette\Utils\Json::FORCE_ARRAY);
