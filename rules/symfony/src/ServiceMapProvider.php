...
final class ServiceMapProvider
{
    ...
    {
        $data = \_PhpScoper88fe6e0ad041\Nette\Utils\Json::decode(\_PhpScoper88fe6e0ad041\Nette\Utils\Json::encode((array) $simpleXMLElement), \_PhpScoper88fe6e0ad041\Nette\Utils\Json::FORCE_ARRAY);
