...
final class ServiceMapProvider
{
    ...
    public function __construct(\RectorPrefix20210114\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210114\Nette\Utils\Json::decode(\RectorPrefix20210114\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210114\Nette\Utils\Json::FORCE_ARRAY);
