...
final class ServiceMapProvider
{
    ...
    public function __construct(\RectorPrefix20201231\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20201231\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20201231\Nette\Utils\Json::decode(\RectorPrefix20201231\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20201231\Nette\Utils\Json::FORCE_ARRAY);
