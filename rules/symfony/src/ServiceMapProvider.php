...
final class ServiceMapProvider
{
    ...
    public function __construct(\RectorPrefix20210127\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210127\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210127\Nette\Utils\Json::decode(\RectorPrefix20210127\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210127\Nette\Utils\Json::FORCE_ARRAY);
