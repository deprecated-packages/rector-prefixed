...
final class ServiceMapProvider
{
    ...
    {
        $data = \_PhpScoper17db12703726\Nette\Utils\Json::decode(\_PhpScoper17db12703726\Nette\Utils\Json::encode((array) $simpleXMLElement), \_PhpScoper17db12703726\Nette\Utils\Json::FORCE_ARRAY);
