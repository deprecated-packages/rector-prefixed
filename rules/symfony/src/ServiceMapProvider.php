...
final class ServiceMapProvider
{
    ...
    public function __construct(\RectorPrefix20210306\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210306\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210306\Nette\Utils\Json::decode(\RectorPrefix20210306\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210306\Nette\Utils\Json::FORCE_ARRAY);
