...
final class ServiceMapProvider
{
    ...
    public function __construct(\RectorPrefix20201228\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20201228\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20201228\Nette\Utils\Json::decode(\RectorPrefix20201228\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20201228\Nette\Utils\Json::FORCE_ARRAY);
