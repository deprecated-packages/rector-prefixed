...
final class ControllerMethodAnalyzer
{
    ...
    public function isAction(\PhpParser\Node $node) : bool
    {
        ...
        if (\RectorPrefix20210218\Nette\Utils\Strings::endsWith($parentClassName, 'Controller')) {
            return \true;
        }
        if (\RectorPrefix20210218\Nette\Utils\Strings::endsWith((string) $node->name, 'Action')) {
            return \true;
        }
