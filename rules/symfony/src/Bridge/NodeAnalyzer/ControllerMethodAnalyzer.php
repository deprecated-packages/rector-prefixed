...
final class ControllerMethodAnalyzer
{
    ...
    public function isAction(\PhpParser\Node $node) : bool
    {
        ...
        if (\_PhpScoper26e51eeacccf\Nette\Utils\Strings::endsWith($parentClassName, 'Controller')) {
            return \true;
        }
        if (\_PhpScoper26e51eeacccf\Nette\Utils\Strings::endsWith((string) $node->name, 'Action')) {
            return \true;
        }
