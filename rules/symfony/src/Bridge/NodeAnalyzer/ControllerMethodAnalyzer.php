...
final class ControllerMethodAnalyzer
{
    ...
    public function isAction(\PhpParser\Node $node) : bool
    {
        ...
        if (\_PhpScoper88fe6e0ad041\Nette\Utils\Strings::endsWith($parentClassName, 'Controller')) {
            return \true;
        }
        if (\_PhpScoper88fe6e0ad041\Nette\Utils\Strings::endsWith((string) $node->name, 'Action')) {
            return \true;
        }
