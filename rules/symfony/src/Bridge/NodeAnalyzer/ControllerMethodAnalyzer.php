...
final class ControllerMethodAnalyzer
{
    ...
    public function isAction(\PhpParser\Node $node) : bool
    {
        ...
        if (\_PhpScoperabd03f0baf05\Nette\Utils\Strings::endsWith($parentClassName, 'Controller')) {
            return \true;
        }
        if (\_PhpScoperabd03f0baf05\Nette\Utils\Strings::endsWith((string) $node->name, 'Action')) {
            return \true;
        }
