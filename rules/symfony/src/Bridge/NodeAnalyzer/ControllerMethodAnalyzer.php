...
final class ControllerMethodAnalyzer
{
    ...
    public function isAction(\PhpParser\Node $node) : bool
    {
        ...
        if (\_PhpScoper267b3276efc2\Nette\Utils\Strings::endsWith($parentClassName, 'Controller')) {
            return \true;
        }
        if (\_PhpScoper267b3276efc2\Nette\Utils\Strings::endsWith((string) $node->name, 'Action')) {
            return \true;
        }
