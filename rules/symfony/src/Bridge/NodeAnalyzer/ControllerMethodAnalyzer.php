...
final class ControllerMethodAnalyzer
{
    ...
    public function isAction(\PhpParser\Node $node) : bool
    {
        ...
        if (\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::endsWith($parentClassName, 'Controller')) {
            return \true;
        }
        if (\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::endsWith((string) $node->name, 'Action')) {
            return \true;
        }
