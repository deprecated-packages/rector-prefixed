...
namespace _PhpScopere8e811afab72\Rector\Polyfill\FeatureSupport;
...
final class FunctionSupportResolver
{
     ...
     */
    private const FUNCTIONS_BY_VERSION = [\_PhpScopere8e811afab72\Rector\Core\ValueObject\PhpVersion::PHP_56 => ['session_abort', 'hash_equals', 'ldap_escape'], \_PhpScopere8e811afab72\Rector\Core\ValueObject\PhpVersion::PHP_70 => ['random_int', 'random_bytes', 'intdiv', 'preg_replace_callback_array', 'error_clear_last'], \_PhpScopere8e811afab72\Rector\Core\ValueObject\PhpVersion::PHP_71 => ['is_iterable'], \_PhpScopere8e811afab72\Rector\Core\ValueObject\PhpVersion::PHP_72 => ['spl_object_id', 'stream_isatty'], \_PhpScopere8e811afab72\Rector\Core\ValueObject\PhpVersion::PHP_73 => ['array_key_first', 'array_key_last', 'hrtime', 'is_countable'], \_PhpScopere8e811afab72\Rector\Core\ValueObject\PhpVersion::PHP_74 => ['get_mangled_object_vars', 'mb_str_split', 'password_algos']];
    /**
