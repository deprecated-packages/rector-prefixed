...
namespace _PhpScoperb75b35f52b74\Rector\Polyfill\FeatureSupport;
...
final class FunctionSupportResolver
{
     ...
     */
    private const FUNCTIONS_BY_VERSION = [\_PhpScoperb75b35f52b74\Rector\Core\ValueObject\PhpVersion::PHP_56 => ['session_abort', 'hash_equals', 'ldap_escape'], \_PhpScoperb75b35f52b74\Rector\Core\ValueObject\PhpVersion::PHP_70 => ['random_int', 'random_bytes', 'intdiv', 'preg_replace_callback_array', 'error_clear_last'], \_PhpScoperb75b35f52b74\Rector\Core\ValueObject\PhpVersion::PHP_71 => ['is_iterable'], \_PhpScoperb75b35f52b74\Rector\Core\ValueObject\PhpVersion::PHP_72 => ['spl_object_id', 'stream_isatty'], \_PhpScoperb75b35f52b74\Rector\Core\ValueObject\PhpVersion::PHP_73 => ['array_key_first', 'array_key_last', 'hrtime', 'is_countable'], \_PhpScoperb75b35f52b74\Rector\Core\ValueObject\PhpVersion::PHP_74 => ['get_mangled_object_vars', 'mb_str_split', 'password_algos']];
    /**
