...
final class ConditionEvaluator
{
     ...
     */
    public function evaluate(\_PhpScoper0a6b37af0871\Rector\Polyfill\Contract\ConditionInterface $condition)
    {
        if ($condition instanceof \_PhpScoper0a6b37af0871\Rector\Polyfill\ValueObject\VersionCompareCondition) {
            return $this->evaluateVersionCompareCondition($condition);
        }
        if ($condition instanceof \_PhpScoper0a6b37af0871\Rector\Polyfill\ValueObject\BinaryToVersionCompareCondition) {
     ...
     * @return bool|int
     */
    private function evaluateVersionCompareCondition(\_PhpScoper0a6b37af0871\Rector\Polyfill\ValueObject\VersionCompareCondition $versionCompareCondition)
    {
    ...
    private function evaluateBinaryToVersionCompareCondition(\_PhpScoper0a6b37af0871\Rector\Polyfill\ValueObject\BinaryToVersionCompareCondition $binaryToVersionCompareCondition) : bool
    {
        $versionCompareResult = $this->evaluateVersionCompareCondition($binaryToVersionCompareCondition->getVersionCompareCondition());
        if ($binaryToVersionCompareCondition->getBinaryClass() === \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\Identical::class) {
            return $binaryToVersionCompareCondition->getExpectedValue() === $versionCompareResult;
        }
        if ($binaryToVersionCompareCondition->getBinaryClass() === \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\NotIdentical::class) {
            return $binaryToVersionCompareCondition->getExpectedValue() !== $versionCompareResult;
        }
        if ($binaryToVersionCompareCondition->getBinaryClass() === \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\Equal::class) {
            // weak comparison on purpose
            return $binaryToVersionCompareCondition->getExpectedValue() == $versionCompareResult;
        }
        if ($binaryToVersionCompareCondition->getBinaryClass() === \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\NotEqual::class) {
            // weak comparison on purpose
            return $binaryToVersionCompareCondition->getExpectedValue() != $versionCompareResult;
        }
