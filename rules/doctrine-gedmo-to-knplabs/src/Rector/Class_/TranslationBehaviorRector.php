...
CODE_SAMPLE
    ...
    {
        if (!$this->classManipulator->hasInterface($node, '_PhpScoper5edc98a7cce2\\Gedmo\\Translatable\\Translatable')) {
            return null;
        }
        $this->classManipulator->removeInterface($node, '_PhpScoper5edc98a7cce2\\Gedmo\\Translatable\\Translatable');
        // 1. replace trait
        $this->classInsertManipulator->addAsFirstTrait($node, '_PhpScoper5edc98a7cce2\\Knp\\DoctrineBehaviors\\Model\\Translatable\\TranslatableTrait');
        // 2. add interface
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper5edc98a7cce2\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TranslatableInterface');
    ...
    private function dumpEntityTranslation(\PhpParser\Node\Stmt\Class_ $class, array $translatedPropertyToPhpDocInfos) : void
    {
        ...
        $class->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper5edc98a7cce2\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TranslationInterface');
        $this->classInsertManipulator->addAsFirstTrait($class, '_PhpScoper5edc98a7cce2\\Knp\\DoctrineBehaviors\\Model\\Translatable\\TranslationTrait');
