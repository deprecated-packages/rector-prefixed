...
CODE_SAMPLE
    ...
    {
        if (!$this->classManipulator->hasTrait($node, '_PhpScoperbd5d0c5f7638\\Gedmo\\Timestampable\\Traits\\TimestampableEntity')) {
            return null;
        }
        $this->classManipulator->replaceTrait($node, '_PhpScoperbd5d0c5f7638\\Gedmo\\Timestampable\\Traits\\TimestampableEntity', '_PhpScoperbd5d0c5f7638\\Knp\\DoctrineBehaviors\\Model\\Timestampable\\TimestampableTrait');
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoperbd5d0c5f7638\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TimestampableInterface');
        return $node;
    }
}
