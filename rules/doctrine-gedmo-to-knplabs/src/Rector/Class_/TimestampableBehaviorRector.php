...
CODE_SAMPLE
    ...
    {
        if (!$this->classManipulator->hasTrait($node, '_PhpScoper88fe6e0ad041\\Gedmo\\Timestampable\\Traits\\TimestampableEntity')) {
            return null;
        }
        $this->classManipulator->replaceTrait($node, '_PhpScoper88fe6e0ad041\\Gedmo\\Timestampable\\Traits\\TimestampableEntity', '_PhpScoper88fe6e0ad041\\Knp\\DoctrineBehaviors\\Model\\Timestampable\\TimestampableTrait');
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper88fe6e0ad041\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TimestampableInterface');
        return $node;
    }
}
