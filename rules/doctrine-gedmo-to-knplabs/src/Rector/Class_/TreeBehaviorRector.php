...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('_PhpScoper17db12703726\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TreeNodeInterface');
        $this->classInsertManipulator->addAsFirstTrait($node, '_PhpScoper17db12703726\\Knp\\DoctrineBehaviors\\Model\\Tree\\TreeNodeTrait');
