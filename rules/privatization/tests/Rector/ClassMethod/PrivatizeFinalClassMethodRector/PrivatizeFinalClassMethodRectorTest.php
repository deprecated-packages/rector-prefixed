...
final class PrivatizeFinalClassMethodRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\Privatization\Rector\ClassMethod\PrivatizeFinalClassMethodRector::class;
    }
}
