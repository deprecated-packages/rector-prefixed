...
final class ChangeReadOnlyPropertyWithDefaultValueToConstantRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change property with read only status with default value to constant', [new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    /**
     * @var string[]
...
CODE_SAMPLE
    ...
    private function shouldSkip(\PhpParser\Node\Stmt\Property $property) : bool
    {
        ...
        return $this->isObjectType($classLike, 'RectorPrefix20201228\\PHP_CodeSniffer\\Sniffs\\Sniff');
    }
