...
final class PrivatizeLocalPropertyToPrivatePropertyRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Privatize local-only property to private property', [new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public $value;
...
CODE_SAMPLE
    ...
    private function shouldSkipClass(\PhpParser\Node\Stmt\ClassLike $classLike) : bool
    {
        ...
        return $this->isObjectTypes($classLike, ['RectorPrefix20201228\\PHPUnit\\Framework\\TestCase', 'RectorPrefix20201228\\PHP_CodeSniffer\\Sniffs\\Sniff']);
    }
