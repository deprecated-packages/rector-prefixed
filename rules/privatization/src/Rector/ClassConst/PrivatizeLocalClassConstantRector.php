...
namespace _PhpScopere8e811afab72\Rector\Privatization\Rector\ClassConst;
...
use _PhpScopere8e811afab72\Rector\SOLID\NodeFinder\ParentClassConstantNodeFinder;
use _PhpScopere8e811afab72\Rector\SOLID\Reflection\ParentConstantReflectionResolver;
use _PhpScopere8e811afab72\Rector\SOLID\ValueObject\ConstantVisibility;
 ...
 */
final class PrivatizeLocalClassConstantRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector implements \_PhpScopere8e811afab72\Rector\Caching\Contract\Rector\ZeroCacheRectorInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScopere8e811afab72\Rector\SOLID\NodeFinder\ParentClassConstantNodeFinder $parentClassConstantNodeFinder, \_PhpScopere8e811afab72\Rector\SOLID\Reflection\ParentConstantReflectionResolver $parentConstantReflectionResolver)
    {
    ...
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Finalize every class constant that is used only locally', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function shouldSkip(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassConst $classConst) : bool
    {
        ...
        $class = $classConst->getAttribute(\_PhpScopere8e811afab72\Rector\NodeTypeResolver\Node\AttributeKey::CLASS_NAME);
        return $class === null;
    }
    private function findParentClassConstantAndRefactorIfPossible(string $class, string $constant) : ?\_PhpScopere8e811afab72\Rector\SOLID\ValueObject\ConstantVisibility
    {
        ...
        if ($parentClassConst !== null) {
            ...
            return new \_PhpScopere8e811afab72\Rector\SOLID\ValueObject\ConstantVisibility($parentClassConst->isPublic(), $parentClassConst->isProtected(), $parentClassConst->isPrivate());
        ...
        return new \_PhpScopere8e811afab72\Rector\SOLID\ValueObject\ConstantVisibility($parentClassConstantReflection->isPublic(), $parentClassConstantReflection->isProtected(), $parentClassConstantReflection->isPrivate());
    }
    /**
     * @param string[] $directUseClasses
     * @param string[] $indirectUseClasses
     */
    private function changeConstantVisibility(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassConst $classConst, array $directUseClasses, array $indirectUseClasses, ?\_PhpScopere8e811afab72\Rector\SOLID\ValueObject\ConstantVisibility $constantVisibility, string $class) : void
    {
    ...
    private function makePrivateOrWeaker(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassConst $classConst, ?\_PhpScopere8e811afab72\Rector\SOLID\ValueObject\ConstantVisibility $parentConstantVisibility) : void
    {
