...
final class ChangeNestedIfsToEarlyReturnRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function __construct(\Rector\SOLID\NodeTransformer\ConditionInverter $conditionInverter, \Rector\Core\PhpParser\Node\Manipulator\IfManipulator $ifManipulator)
    {
