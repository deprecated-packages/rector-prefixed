...
namespace _PhpScoper0a6b37af0871\Rector\SOLID\Rector\ClassMethod;
 ...
 */
final class UseInterfaceOverImplementationInConstructorRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Use interface instead of specific class', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        ...
        foreach ($node->params as $param) {
            ...
            $param->type = new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($interfaceNames[0]);
        }
        return $node;
    }
    /**
