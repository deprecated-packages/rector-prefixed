...
final class SubstrMinusToStringEndsWithRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    /**
     * @param \Rector\NetteCodeQuality\NodeAnalyzer\BinaryOpAnalyzer $binaryOpAnalyzer
     */
    public function __construct($binaryOpAnalyzer)
    {
...
CODE_SAMPLE
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        $staticCall = $this->nodeFactory->createStaticCall(\RectorPrefix20210317\Nette\Utils\Strings::class, 'endsWith', $arguments);
