...
namespace _PhpScoperb75b35f52b74\Rector\Php74\Rector\MethodCall;
 ...
 */
final class ChangeReflectionTypeToStringToGetNameRector extends \_PhpScoperb75b35f52b74\Rector\Core\Rector\AbstractRector
{
    /**
     * @var string
     */
    ...
    {
        return new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change string calls on ReflectionType', [new \_PhpScoperb75b35f52b74\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
...
CODE_SAMPLE
    ...
    {
        return [\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall::class, \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Cast\String_::class];
    }
    /**
    ...
    public function refactor(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
        ...
        if ($node instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Cast\String_) {
            ...
            if ($node->expr instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable && $this->isObjectType($node->expr, 'ReflectionType')) {
    ...
    private function refactorIfHasReturnTypeWasCalled(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall $methodCall) : ?\_PhpScoperb75b35f52b74\PhpParser\Node
    {
    ...
    private function collectCallByVariable(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall $methodCall) : void
    {
    ...
    private function shouldSkipMethodCall(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        if ($parentNode instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Cast\String_) {
            return \false;
        }
        // probably already converted
        return !$parentNode instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\BinaryOp\Concat;
    }
    private function isReflectionParameterGetTypeMethodCall(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
    ...
    private function refactorReflectionParameterGetName(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Ternary
    {
        $getNameMethodCall = $this->createMethodCall($methodCall, self::GET_NAME);
        $ternary = new \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Ternary($methodCall, $getNameMethodCall, $this->createNull());
        // to prevent looping
        $methodCall->setAttribute(\_PhpScoperb75b35f52b74\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE, $ternary);
        return $ternary;
    }
    private function isReflectionFunctionAbstractGetReturnTypeMethodCall(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
    ...
    private function refactorReflectionFunctionGetReturnType(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoperb75b35f52b74\PhpParser\Node
    {
