 ...
 */
final class RestoreDefaultNullToNullableTypePropertyRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Add null default to properties with PHP 7.4 property nullable type', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
    public ?string $name;
}
...
CODE_SAMPLE
    ...
    private function shouldSkip(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property $property) : bool
    {
        ...
        if (!$property->type instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\NullableType) {
            return \true;
        }
    ...
    private function isPropertyInitiatedInConstuctor(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property $property, string $propertyName) : bool
    {
        ...
        $this->traverseNodesWithCallable((array) $constructClassMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($propertyName, &$isPropertyInitiated) : ?int {
