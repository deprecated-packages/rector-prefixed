...
final class InflectorSingularResolver
{
    ...
    {
        $matchBy = \RectorPrefix20210421\Nette\Utils\Strings::match($currentName, self::BY_MIDDLE_REGEX);
        if ($matchBy) {
            return \RectorPrefix20210421\Nette\Utils\Strings::substring($currentName, 0, -\strlen($matchBy['by']));
        }
        ...
        $camelCases = \RectorPrefix20210421\Nette\Utils\Strings::matchAll($currentName, self::CAMELCASE_REGEX);
