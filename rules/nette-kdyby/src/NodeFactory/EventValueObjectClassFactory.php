...
final class EventValueObjectClassFactory
{
    ...
    private function createEventClassBuilder(string $className) : \Rector\Core\PhpParser\Builder\ClassBuilder
    {
        ...
        $classBuilder->extend(new \PhpParser\Node\Name\FullyQualified('_PhpScoper8b9c402c5f32\\Symfony\\Contracts\\EventDispatcher\\Event'));
        return $classBuilder;
    }
    /**
     * @param Arg[] $args
    ...
    {
        $namespace = \_PhpScoper8b9c402c5f32\Nette\Utils\Strings::before($className, '\\', -1);
