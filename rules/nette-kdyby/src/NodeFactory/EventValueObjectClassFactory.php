...
use _PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Builder\NamespaceBuilder;
...
use _PhpScoper0a2ac50786fa\Rector\NetteKdyby\BlueprintFactory\VariableWithTypesFactory;
...
final class EventValueObjectClassFactory
{
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\CodingStyle\Naming\ClassNaming $classNaming, \_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\NodeFactory $nodeFactory, \_PhpScoper0a2ac50786fa\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScoper0a2ac50786fa\Rector\NetteKdyby\BlueprintFactory\VariableWithTypesFactory $variableWithTypesFactory)
    {
     ...
     * @param Arg[] $args
     */
    public function create(string $className, array $args) : \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Namespace_
    {
    ...
    private function createEventClassBuilder(string $className) : \_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Builder\ClassBuilder
    {
        $shortClassName = $this->classNaming->getShortName($className);
        $classBuilder = new \_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Builder\ClassBuilder($shortClassName);
        $classBuilder->makeFinal();
        $classBuilder->extend(new \_PhpScoper0a2ac50786fa\PhpParser\Node\Name\FullyQualified('_PhpScoper0a2ac50786fa\\Symfony\\Contracts\\EventDispatcher\\Event'));
        return $classBuilder;
    }
    /**
     * @param Arg[] $args
     */
    private function decorateWithConstructorIfHasArgs(\_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Builder\ClassBuilder $classBuilder, array $args) : void
    {
        if ($args === []) {
            return;
        }
    ...
    private function wrapClassToNamespace(string $className, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Class_ $class) : \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Namespace_
    {
        $namespace = \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::before($className, '\\', -1);
        $namespaceBuilder = new \_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Builder\NamespaceBuilder($namespace);
     ...
     */
    private function ensureVariablesAreUnique(array $variablesWithTypes, \_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Builder\ClassBuilder $classBuilder) : void
    {
        $usedVariableNames = [];
     ...
     */
    private function createConstructClassMethod(array $variableWithTypes) : \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassMethod
    {
        ...
        foreach ($variableWithTypes as $variableWithType) {
            $param = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Param(new \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable($variableWithType->getName()));
