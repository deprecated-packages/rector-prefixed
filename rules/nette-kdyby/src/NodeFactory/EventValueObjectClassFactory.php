...
final class EventValueObjectClassFactory
{
    ...
    private function createEventClassBuilder(string $className) : \Rector\Core\PhpParser\Builder\ClassBuilder
    {
        ...
        $classBuilder->extend(new \PhpParser\Node\Name\FullyQualified('_PhpScoperf18a0c41e2d2\\Symfony\\Contracts\\EventDispatcher\\Event'));
        return $classBuilder;
    }
    /**
     * @param Arg[] $args
    ...
    {
        $namespace = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::before($className, '\\', -1);
