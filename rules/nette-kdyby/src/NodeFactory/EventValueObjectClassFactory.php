...
final class EventValueObjectClassFactory
{
    ...
    private function createEventClassBuilder(string $className) : \Rector\Core\PhpParser\Builder\ClassBuilder
    {
        ...
        $classBuilder->extend(new \PhpParser\Node\Name\FullyQualified('_PhpScoper5edc98a7cce2\\Symfony\\Contracts\\EventDispatcher\\Event'));
        return $classBuilder;
    }
    /**
     * @param Arg[] $args
    ...
    {
        $namespace = \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::before($className, '\\', -1);
