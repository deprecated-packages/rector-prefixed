...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoper26e51eeacccf\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoper26e51eeacccf\Nette\Utils\Strings::substring($property, \strlen('on'));
