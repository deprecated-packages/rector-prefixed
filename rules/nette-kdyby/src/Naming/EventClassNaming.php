...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::substring($property, \strlen('on'));
