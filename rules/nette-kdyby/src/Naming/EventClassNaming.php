...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoper006a73f0e455\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoper006a73f0e455\Nette\Utils\Strings::substring($property, \strlen('on'));
