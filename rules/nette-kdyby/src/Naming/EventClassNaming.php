...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::substring($property, \strlen('on'));
