...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoper8b9c402c5f32\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoper8b9c402c5f32\Nette\Utils\Strings::substring($property, \strlen('on'));
