...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoper567b66d83109\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoper567b66d83109\Nette\Utils\Strings::substring($property, \strlen('on'));
