...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::substring($property, \strlen('on'));
