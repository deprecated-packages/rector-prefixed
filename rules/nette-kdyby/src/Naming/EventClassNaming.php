...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoper88fe6e0ad041\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoper88fe6e0ad041\Nette\Utils\Strings::substring($property, \strlen('on'));
