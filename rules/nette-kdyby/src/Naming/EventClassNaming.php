...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::substring($property, \strlen('on'));
