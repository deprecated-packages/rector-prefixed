...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScoper267b3276efc2\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScoper267b3276efc2\Nette\Utils\Strings::substring($property, \strlen('on'));
