...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \_PhpScopera143bcca66cb\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \_PhpScopera143bcca66cb\Nette\Utils\Strings::substring($property, \strlen('on'));
