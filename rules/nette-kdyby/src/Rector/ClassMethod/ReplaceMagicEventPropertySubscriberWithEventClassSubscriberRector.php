 ...
 */
final class ReplaceMagicEventPropertySubscriberWithEventClassSubscriberRector extends \_PhpScoper0a6b37af0871\Rector\NetteKdyby\Rector\ClassMethod\AbstractKdybyEventSubscriberRector
{
    /**
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\NetteKdyby\DataProvider\EventAndListenerTreeProvider $eventAndListenerTreeProvider, \_PhpScoper0a6b37af0871\Rector\NetteKdyby\Naming\EventClassNaming $eventClassNaming, \_PhpScoper0a6b37af0871\Rector\NetteKdyby\NodeManipulator\ListeningClassMethodArgumentManipulator $listeningClassMethodArgumentManipulator)
    {
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change getSubscribedEvents() from on magic property, to Event class', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function replaceEventPropertyReferenceWithEventClassReference(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        $this->traverseNodesWithCallable((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) {
            ...
            // is property?
            if (!\_PhpScoper0a6b37af0871\Nette\Utils\Strings::contains($eventPropertyReferenceName, '::')) {
                return null;
            }
