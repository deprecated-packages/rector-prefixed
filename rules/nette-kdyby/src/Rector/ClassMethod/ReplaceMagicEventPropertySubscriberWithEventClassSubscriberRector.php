 ...
 */
final class ReplaceMagicEventPropertySubscriberWithEventClassSubscriberRector extends \Rector\NetteKdyby\Rector\ClassMethod\AbstractKdybyEventSubscriberRector
{
    /**
...
CODE_SAMPLE
    ...
    private function replaceEventPropertyReferenceWithEventClassReference(\PhpParser\Node\Stmt\ClassMethod $classMethod) : void
    {
        $this->traverseNodesWithCallable((array) $classMethod->stmts, function (\PhpParser\Node $node) {
            ...
            // is property?
            if (!\_PhpScoper50d83356d739\Nette\Utils\Strings::contains($eventPropertyReferenceName, '::')) {
                return null;
            }
