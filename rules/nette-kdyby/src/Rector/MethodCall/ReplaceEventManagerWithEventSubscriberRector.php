 ...
 */
final class ReplaceEventManagerWithEventSubscriberRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\NetteKdyby\Naming\EventClassNaming $eventClassNaming, \_PhpScoper0a2ac50786fa\Rector\NetteKdyby\NodeFactory\EventValueObjectClassFactory $eventValueObjectClassFactory)
    {
    ...
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Change Kdyby EventManager to EventDispatcher', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        $node->name = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Identifier('dispatch');
        $oldArgs = $node->args;
        $node->args = [];
        ...
        $new = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\New_(new \_PhpScoper0a2ac50786fa\PhpParser\Node\Name\FullyQualified($eventClassName), $args);
    ...
    {
        if (!$this->isObjectType($methodCall->var, '_PhpScoper0a2ac50786fa\\Kdyby\\Events\\EventManager')) {
            return \true;
        }
    ...
    {
        $args = [];
        if ($oldArgs[1]->value instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\New_) {
            /** @var New_ $new */
            $new = $oldArgs[1]->value;
            $array = $new->args[0]->value;
            if (!$array instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Array_) {
                return [];
            }
