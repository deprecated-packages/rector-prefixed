...
final class ListeningMethodsCollector
{
    ...
    public function __construct(\RectorPrefix20210304\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\NetteKdyby\Naming\EventClassNaming $eventClassNaming, \Rector\Core\PhpParser\Node\Value\ValueResolver $valueResolver)
    {
    ...
    private function resolveCustomClassMethodAndEventClass(\PhpParser\Node\Expr\ArrayItem $arrayItem, \PhpParser\Node\Stmt\Class_ $class, string $eventClass) : ?\Rector\NetteKdyby\ValueObject\EventClassAndClassMethod
    {
        ...
        if (\RectorPrefix20210304\Nette\Utils\Strings::contains($eventClass, '::')) {
