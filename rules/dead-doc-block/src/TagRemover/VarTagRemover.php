...
final class VarTagRemover
{
    ...
    private function isArrayOfExistingClassNode(\PhpParser\Node $node, \Rector\AttributeAwarePhpDoc\Ast\Type\AttributeAwareArrayTypeNode $type) : bool
    {
