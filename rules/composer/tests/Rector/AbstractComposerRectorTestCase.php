...
abstract class AbstractComposerRectorTestCase extends \RectorPrefix20210129\Symplify\PackageBuilder\Testing\AbstractKernelTestCase implements \Rector\Composer\Tests\Contract\ConfigFileAwareInterface
{
    /**
     * @var FixtureGuard
     */
    ...
    protected function setUp() : void
    {
        ...
        $this->composerJsonFactory = $this->getService(\RectorPrefix20210129\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    }
    protected function doTestFileInfo(\RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->fixtureGuard->ensureFileInfoHasDifferentBeforeAndAfterContent($smartFileInfo);
        $inputFileInfoAndExpected = \RectorPrefix20210129\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($smartFileInfo);
        ...
        $changedComposerJson = \RectorPrefix20210129\Nette\Utils\Json::encode($composerJson->getJsonArray(), \RectorPrefix20210129\Nette\Utils\Json::PRETTY);
