...
abstract class AbstractComposerRectorTestCase extends \RectorPrefix20210228\Symplify\PackageBuilder\Testing\AbstractKernelTestCase implements \Rector\Composer\Tests\Contract\ConfigFileAwareInterface
{
    /**
     * @var FixtureGuard
     */
    ...
    protected function setUp() : void
    {
        ...
        $this->composerJsonFactory = $this->getService(\RectorPrefix20210228\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    }
    protected function doTestFileInfo(\RectorPrefix20210228\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->fixtureGuard->ensureFileInfoHasDifferentBeforeAndAfterContent($smartFileInfo);
        $inputFileInfoAndExpected = \RectorPrefix20210228\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($smartFileInfo);
        ...
        $changedComposerJson = \RectorPrefix20210228\Nette\Utils\Json::encode($composerJson->getJsonArray(), \RectorPrefix20210228\Nette\Utils\Json::PRETTY);
