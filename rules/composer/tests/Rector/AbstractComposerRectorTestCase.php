...
abstract class AbstractComposerRectorTestCase extends \RectorPrefix20210311\Symplify\PackageBuilder\Testing\AbstractKernelTestCase implements \Rector\Composer\Tests\Contract\ConfigFileAwareInterface
{
    /**
     * @var FixtureGuard
     */
    ...
    protected function doTestFileInfo(\RectorPrefix20210311\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->fixtureGuard->ensureFileInfoHasDifferentBeforeAndAfterContent($smartFileInfo);
        $inputFileInfoAndExpected = \RectorPrefix20210311\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($smartFileInfo);
        ...
        $changedComposerJson = \RectorPrefix20210311\Nette\Utils\Json::encode($composerJson->getJsonArray(), \RectorPrefix20210311\Nette\Utils\Json::PRETTY);
