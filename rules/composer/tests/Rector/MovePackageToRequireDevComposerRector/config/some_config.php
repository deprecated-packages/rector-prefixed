...
return static function (\RectorPrefix20210126\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Rector\Composer\Rector\MovePackageToRequireDevComposerRector::class)->call('configure', [[\Rector\Composer\Rector\MovePackageToRequireDevComposerRector::PACKAGE_NAMES => ['vendor1/package3']]]);
};
