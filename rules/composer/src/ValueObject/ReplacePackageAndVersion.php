...
final class ReplacePackageAndVersion implements \Rector\Composer\Contract\VersionAwareInterface
{
    ...
    {
        \RectorPrefix20210228\Webmozart\Assert\Assert::notSame($oldPackageName, $newPackageName, 'Old and new package have to be different. If you want to only change package version, use ' . \Rector\Composer\Rector\ChangePackageVersionComposerRector::class);
