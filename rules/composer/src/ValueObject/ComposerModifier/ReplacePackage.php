...
final class ReplacePackage implements \Rector\Composer\Contract\ComposerModifier\ComposerModifierInterface
{
    ...
    {
        \RectorPrefix20210114\Webmozart\Assert\Assert::notSame($oldPackageName, $newPackageName, '$oldPackageName cannot be the same as $newPackageName. If you want to change version of package, use ' . \Rector\Composer\ValueObject\ComposerModifier\ChangePackageVersion::class);
