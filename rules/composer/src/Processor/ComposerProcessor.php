...
final class ComposerProcessor
{
    ...
    private function reportFileContentChange(\RectorPrefix20210115\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $newContent) : void
    {
        ...
        $process = new \RectorPrefix20210115\Symfony\Component\Process\Process(\explode(' ', $command), \getcwd());
