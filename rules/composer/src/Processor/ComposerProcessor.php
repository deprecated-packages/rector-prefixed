...
use RectorPrefix20210114\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter;
...
final class ComposerProcessor
{
    ...
    public function __construct(\RectorPrefix20210114\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \RectorPrefix20210114\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter $composerJsonPrinter, \Rector\Composer\Modifier\ComposerModifier $composerModifier, \Rector\Core\Configuration\Configuration $configuration, \RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector)
    {
    ...
    public function process() : void
    {
        ...
        $smartFileInfo = new \RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo($composerJsonFilePath);
    ...
    private function reportFileContentChange(\RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $newContent) : void
    {
        ...
        $process = new \RectorPrefix20210114\Symfony\Component\Process\Process(\explode(' ', $command), \getcwd());
