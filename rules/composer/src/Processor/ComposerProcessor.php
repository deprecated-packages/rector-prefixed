...
use RectorPrefix20210226\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter;
...
final class ComposerProcessor
{
    ...
    public function process(string $composerJsonFilePath) : void
    {
        ...
        $smartFileInfo = new \RectorPrefix20210226\Symplify\SmartFileSystem\SmartFileInfo($composerJsonFilePath);
    ...
    private function addComposerJsonFileDiff(\RectorPrefix20210226\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $oldComposerJson, \RectorPrefix20210226\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $newComposerJson, \RectorPrefix20210226\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    private function reportFileContentChange(\RectorPrefix20210226\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \RectorPrefix20210226\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        if ($this->configuration->isDryRun()) {
            return;
        }
        $this->composerJsonPrinter->print($composerJson, $smartFileInfo);
        $process = new \RectorPrefix20210226\Symfony\Component\Process\Process(\explode(' ', self::COMPOSER_UPDATE), \getcwd());
