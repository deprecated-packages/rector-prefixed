...
use RectorPrefix20210119\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter;
...
final class ComposerProcessor
{
    ...
    public function process(string $composerJsonFilePath) : void
    {
        ...
        $smartFileInfo = new \RectorPrefix20210119\Symplify\SmartFileSystem\SmartFileInfo($composerJsonFilePath);
    ...
    private function reportFileContentChange(\RectorPrefix20210119\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \RectorPrefix20210119\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        if ($this->configuration->isDryRun()) {
            return;
        }
        $this->composerJsonPrinter->print($composerJson, $smartFileInfo);
        $process = new \RectorPrefix20210119\Symfony\Component\Process\Process(\explode(' ', self::COMPOSER_UPDATE), \getcwd());
    ...
    private function addComposerJsonFileDiff(\RectorPrefix20210119\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $oldComposerJson, \RectorPrefix20210119\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $newComposerJson, \RectorPrefix20210119\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
