...
use RectorPrefix20210122\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter;
...
final class ComposerProcessor
{
    ...
    public function __construct(\RectorPrefix20210122\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \RectorPrefix20210122\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter $composerJsonPrinter, \Rector\Core\Configuration\Configuration $configuration, \Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector, \RectorPrefix20210122\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Composer\Modifier\ComposerModifier $composerModifier)
    {
    ...
    public function process(string $composerJsonFilePath) : void
    {
        ...
        $smartFileInfo = new \RectorPrefix20210122\Symplify\SmartFileSystem\SmartFileInfo($composerJsonFilePath);
    ...
    private function reportFileContentChange(\RectorPrefix20210122\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \RectorPrefix20210122\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        ...
        $process = new \RectorPrefix20210122\Symfony\Component\Process\Process(\explode(' ', self::COMPOSER_UPDATE), \getcwd());
