...
use RectorPrefix20210321\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter;
...
final class ComposerProcessor
{
    ...
    public function __construct(\RectorPrefix20210321\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \RectorPrefix20210321\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter $composerJsonPrinter, \Rector\Core\Configuration\Configuration $configuration, \Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector, \RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Composer\Modifier\ComposerModifier $composerModifier)
    {
    ...
    public function process(string $composerJsonFilePath) : void
    {
        ...
        $smartFileInfo = new \RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileInfo($composerJsonFilePath);
    ...
    private function addComposerJsonFileDiff(\RectorPrefix20210321\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $oldComposerJson, \RectorPrefix20210321\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $newComposerJson, \RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    private function reportFileContentChange(\RectorPrefix20210321\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        if ($this->configuration->isDryRun()) {
            return;
        }
        $this->composerJsonPrinter->print($composerJson, $smartFileInfo);
        $process = new \RectorPrefix20210321\Symfony\Component\Process\Process(\explode(' ', self::COMPOSER_UPDATE), \getcwd());
