...
namespace _PhpScopere8e811afab72\Rector\CakePHP\Rector\FileWithoutNamespace;
 ...
 */
final class ImplicitShortClassNameUseStatementRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Collect implicit class names and add imports', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
use App\Foo\Plugin;
...
CODE_SAMPLE
    ...
    {
        return [\_PhpScopere8e811afab72\Rector\Core\PhpParser\Node\CustomNode\FileWithoutNamespace::class];
    }
    /**
     ...
     * @return Name[]
     */
    private function findNames(\_PhpScopere8e811afab72\Rector\Core\PhpParser\Node\CustomNode\FileWithoutNamespace $fileWithoutNamespace) : array
    {
        return $this->betterNodeFinder->find($fileWithoutNamespace->stmts, function (\_PhpScopere8e811afab72\PhpParser\Node $node) : bool {
            ...
            return !$parent instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr\New_;
        });
    }
    /**
     * @param Name[] $names
