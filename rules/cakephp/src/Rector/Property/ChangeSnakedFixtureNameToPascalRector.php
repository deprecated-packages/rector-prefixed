...
namespace _PhpScoper0a6b37af0871\Rector\CakePHP\Rector\Property;
 ...
 */
final class ChangeSnakedFixtureNameToPascalRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Changes $fixtues style from snake_case to PascalCase.', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
class SomeTest
{
    protected $fixtures = [
        'app.posts',
...
CODE_SAMPLE
    ...
    private function refactorPropertyWithArrayDefault(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\PropertyProperty $propertyProperty) : void
    {
        if (!$propertyProperty->default instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Array_) {
            return;
        }
        ...
        foreach ($array->items as $arrayItem) {
            ...
            if (!$arrayItem->value instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Scalar\String_) {
                continue;
            }
            $this->renameFixtureName($arrayItem->value);
        }
    }
    private function renameFixtureName(\_PhpScoper0a6b37af0871\PhpParser\Node\Scalar\String_ $string) : void
    {
        [$prefix, $table] = \explode('.', $string->value);
        $table = \array_map(function (string $token) : string {
            return \_PhpScoper0a6b37af0871\Rector\Core\Util\StaticRectorStrings::underscoreToPascalCase($token);
        }, \explode('/', $table));
        $table = \implode('/', $table);
