...
final class CakePHPFullyQualifiedClassNameResolver
{
    ...
    public function resolveFromPseudoNamespaceAndShortClassName(string $pseudoNamespace, string $shortClass) : string
    {
        ...
        if (\_PhpScoperabd03f0baf05\Nette\Utils\Strings::match($pseudoNamespace, self::LIB_NAMESPACE_PART_REGEX)) {
            $pseudoNamespace = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::replace($pseudoNamespace, '#\\\\Lib#');
        }
        ...
        if (\_PhpScoperabd03f0baf05\Nette\Utils\Strings::contains($pseudoNamespace, '\\') && !\_PhpScoperabd03f0baf05\Nette\Utils\Strings::match($pseudoNamespace, self::PLUGIN_OR_LIB_REGEX)) {
    ...
    {
        return \_PhpScoperabd03f0baf05\Nette\Utils\Strings::replace($pseudoNamespace, self::SLASH_REGEX, '\\');
    }
}
