...
final class CakePHPFullyQualifiedClassNameResolver
{
    ...
    public function resolveFromPseudoNamespaceAndShortClassName(string $pseudoNamespace, string $shortClass) : string
    {
        ...
        if (\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::match($pseudoNamespace, self::LIB_NAMESPACE_PART_REGEX)) {
            $pseudoNamespace = \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::replace($pseudoNamespace, '#\\\\Lib#', '');
        }
        ...
        if (\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::contains($pseudoNamespace, '\\') && !\_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::match($pseudoNamespace, self::PLUGIN_OR_LIB_REGEX)) {
    ...
    {
        return \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::replace($pseudoNamespace, self::SLASH_REGEX, '\\');
    }
}
