...
namespace _PhpScoper2a4e7ab1ecbc\Rector\CakePHP\Naming;
...
final class CakePHPFullyQualifiedClassNameResolver
{
    ...
    public function resolveFromPseudoNamespaceAndShortClassName(string $pseudoNamespace, string $shortClass) : string
    {
        ...
        if (\_PhpScoper2a4e7ab1ecbc\Nette\Utils\Strings::match($pseudoNamespace, self::LIB_NAMESPACE_PART_REGEX)) {
            $pseudoNamespace = \_PhpScoper2a4e7ab1ecbc\Nette\Utils\Strings::replace($pseudoNamespace, '#\\\\Lib#', '');
        }
        ...
        if (\_PhpScoper2a4e7ab1ecbc\Nette\Utils\Strings::contains($pseudoNamespace, '\\') && !\_PhpScoper2a4e7ab1ecbc\Nette\Utils\Strings::match($pseudoNamespace, self::PLUGIN_OR_LIB_REGEX)) {
    ...
    {
        return \_PhpScoper2a4e7ab1ecbc\Nette\Utils\Strings::replace($pseudoNamespace, self::SLASH_REGEX, '\\');
    }
}
