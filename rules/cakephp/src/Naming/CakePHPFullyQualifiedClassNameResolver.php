...
namespace _PhpScoper0a2ac50786fa\Rector\CakePHP\Naming;
...
final class CakePHPFullyQualifiedClassNameResolver
{
    ...
    public function resolveFromPseudoNamespaceAndShortClassName(string $pseudoNamespace, string $shortClass) : string
    {
        ...
        if (\_PhpScoper0a2ac50786fa\Nette\Utils\Strings::match($pseudoNamespace, self::LIB_NAMESPACE_PART_REGEX)) {
            $pseudoNamespace = \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::replace($pseudoNamespace, '#\\\\Lib#', '');
        }
        ...
        if (\_PhpScoper0a2ac50786fa\Nette\Utils\Strings::contains($pseudoNamespace, '\\') && !\_PhpScoper0a2ac50786fa\Nette\Utils\Strings::match($pseudoNamespace, self::PLUGIN_OR_LIB_REGEX)) {
    ...
    {
        return \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::replace($pseudoNamespace, self::SLASH_REGEX, '\\');
    }
}
