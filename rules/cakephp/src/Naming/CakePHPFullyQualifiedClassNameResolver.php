...
final class CakePHPFullyQualifiedClassNameResolver
{
    ...
    public function resolveFromPseudoNamespaceAndShortClassName(string $pseudoNamespace, string $shortClass) : string
    {
        ...
        if (\_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::match($pseudoNamespace, self::LIB_NAMESPACE_PART_REGEX)) {
            $pseudoNamespace = \_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::replace($pseudoNamespace, '#\\\\Lib#');
        }
        ...
        if (\_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::contains($pseudoNamespace, '\\') && !\_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::match($pseudoNamespace, self::PLUGIN_OR_LIB_REGEX)) {
    ...
    {
        return \_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::replace($pseudoNamespace, self::SLASH_REGEX, '\\');
    }
}
