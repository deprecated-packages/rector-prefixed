...
final class SomeTestCase extends \_PhpScoper267b3276efc2\PHPUnit\Framework\TestCase
{
    public function test()
    {
        $product = \_PhpScoper267b3276efc2\EntityFactory::create('product');
    }
}
\class_alias('_PhpScoper267b3276efc2\\SomeTestCase', 'SomeTestCase', \false);
CODE_SAMPLE
, <<<'CODE_SAMPLE'
...
, [self::STATIC_CLASS_TYPES => ['EntityFactory']])]);
    ...
    private function processPHPUnitClass(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        if (!$this->isObjectType($class, '_PhpScoper267b3276efc2\\Symfony\\Bundle\\FrameworkBundle\\Test\\KernelTestCase')) {
            $class->extends = new \PhpParser\Node\Name\FullyQualified('_PhpScoper267b3276efc2\\Symfony\\Bundle\\FrameworkBundle\\Test\\KernelTestCase');
        }
        return $class;
    }
    /**
