...
final class CheckoutEntityFactory
{
    public function run()
    {
        return \_PhpScoper50d83356d739\SomeStaticClass::go();
    }
}
\class_alias('_PhpScoper50d83356d739\\CheckoutEntityFactory', 'CheckoutEntityFactory', \false);
CODE_SAMPLE
, <<<'CODE_SAMPLE'
<?php
...
final class CheckoutEntityFactory
{
    ...
    public function setSomeStaticClass(\_PhpScoper50d83356d739\SomeStaticClass $someStaticClass)
    {
