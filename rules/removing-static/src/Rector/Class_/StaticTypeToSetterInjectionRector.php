...
final class CheckoutEntityFactory
{
    public function run()
    {
        return \_PhpScoper5b8c9e9ebd21\SomeStaticClass::go();
    }
}
\class_alias('_PhpScoper5b8c9e9ebd21\\CheckoutEntityFactory', 'CheckoutEntityFactory', \false);
CODE_SAMPLE
, <<<'CODE_SAMPLE'
<?php
...
final class CheckoutEntityFactory
{
    ...
    public function setSomeStaticClass(\_PhpScoper5b8c9e9ebd21\SomeStaticClass $someStaticClass)
    {
