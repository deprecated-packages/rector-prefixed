...
namespace _PhpScoper0a6b37af0871\Rector\RemovingStatic\NodeAnalyzer;
...
final class StaticCallPresenceAnalyzer
{
    ...
    public function hasMethodStaticCallOnType(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, string $type) : bool
    {
        return (bool) $this->betterNodeFinder->findFirst((array) $classMethod->stmts, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($type) : bool {
    ...
    public function hasClassAnyMethodWithStaticCallOnType(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ $class, string $type) : bool
    {
        foreach ($class->getMethods() as $classMethod) {
            // handled else where
            if ((string) $classMethod->name === \_PhpScoper0a6b37af0871\Rector\Core\ValueObject\MethodName::CONSTRUCT) {
                continue;
            }
