...
namespace _PhpScoperb75b35f52b74\Rector\Defluent\Tests\NodeFactory\FluentChainMethodCallRootExtractor;
...
final class FluentChainMethodCallRootExtractorTest extends \_PhpScoperb75b35f52b74\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    protected function setUp() : void
    {
        ...
        $this->fluentChainMethodCallRootExtractor = $this->getService(\_PhpScoperb75b35f52b74\Rector\Defluent\NodeAnalyzer\FluentChainMethodCallRootExtractor::class);
    ...
    public function testNew() : void
    {
        ...
        $this->assertInstanceOf(\_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable::class, $silentVariable);
    ...
    private function parseFileAndCreateAssignAndRootExprForSure(string $filePath) : \_PhpScoperb75b35f52b74\Rector\Defluent\ValueObject\AssignAndRootExpr
    {
        $assignAndRootExpr = $this->parseFileAndCreateAssignAndRootExpr($filePath);
        $this->assertInstanceOf(\_PhpScoperb75b35f52b74\Rector\Defluent\ValueObject\AssignAndRootExpr::class, $assignAndRootExpr);
        /** @var AssignAndRootExpr $assignAndRootExpr */
        return $assignAndRootExpr;
    }
    private function parseFileAndCreateAssignAndRootExpr(string $filePath) : ?\_PhpScoperb75b35f52b74\Rector\Defluent\ValueObject\AssignAndRootExpr
    {
        /** @var MethodCall[] $methodCalls */
        $methodCalls = $this->testingParser->parseFileToDecoratedNodesAndFindNodesByType($filePath, \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall::class);
        return $this->fluentChainMethodCallRootExtractor->extractFromMethodCalls($methodCalls, \_PhpScoperb75b35f52b74\Rector\Defluent\ValueObject\FluentCallsKind::NORMAL);
    }
}
