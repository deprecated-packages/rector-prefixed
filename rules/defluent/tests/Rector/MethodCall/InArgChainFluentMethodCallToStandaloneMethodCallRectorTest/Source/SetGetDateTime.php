...
final class SetGetDateTime
{
    ...
    public function setDateMin(?\RectorPrefix20210107\Nette\Utils\DateTime $dateTime = null)
    {
        $this->dateMin = $dateTime;
    }
    public function getDateMin() : ?\RectorPrefix20210107\Nette\Utils\DateTime
    {
        return $this->dateMin;
    }
}
