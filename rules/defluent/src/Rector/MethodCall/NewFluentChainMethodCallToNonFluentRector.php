 ...
 */
final class NewFluentChainMethodCallToNonFluentRector extends \_PhpScoper0a2ac50786fa\Rector\Defluent\Rector\AbstractFluentChainMethodCallRector
{
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        if ($this->hasParentTypes($node, [\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Return_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Arg::class])) {
            return null;
        }
