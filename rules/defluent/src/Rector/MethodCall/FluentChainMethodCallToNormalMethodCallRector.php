 ...
 */
final class FluentChainMethodCallToNormalMethodCallRector extends \_PhpScoper0a6b37af0871\Rector\Defluent\Rector\AbstractFluentChainMethodCallRector
{
...
CODE_SAMPLE
     ...
     */
    private function isHandledByAnotherRule(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        return $this->hasParentTypes($methodCall, [\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Return_::class, \_PhpScoper0a6b37af0871\PhpParser\Node\Arg::class]);
    }
}
