...
namespace _PhpScoper0a2ac50786fa\Rector\Defluent\Skipper;

use _PhpScoper0a2ac50786fa\PhpParser\Node\Expr\MethodCall;
use _PhpScoper0a2ac50786fa\Rector\Defluent\Contract\ValueObject\FirstCallFactoryAwareInterface;
use _PhpScoper0a2ac50786fa\Rector\Defluent\NodeAnalyzer\FluentCallStaticTypeResolver;
use _PhpScoper0a2ac50786fa\Rector\Defluent\NodeAnalyzer\FluentChainMethodCallNodeAnalyzer;
use _PhpScoper0a2ac50786fa\Rector\Defluent\NodeAnalyzer\GetterMethodCallAnalyzer;
...
final class FluentMethodCallSkipper
{
     ...
     * @var string[]
     */
    private const ALLOWED_FLUENT_TYPES = ['_PhpScoper0a2ac50786fa\\Symfony\\Component\\DependencyInjection\\Loader\\Configurator\\AbstractConfigurator', '_PhpScoper0a2ac50786fa\\Nette\\Forms\\Controls\\BaseControl', '_PhpScoper0a2ac50786fa\\Nette\\DI\\ContainerBuilder', '_PhpScoper0a2ac50786fa\\Nette\\DI\\Definitions\\Definition', '_PhpScoper0a2ac50786fa\\Nette\\DI\\Definitions\\ServiceDefinition', '_PhpScoper0a2ac50786fa\\PHPStan\\Analyser\\Scope', 'DateTime', '_PhpScoper0a2ac50786fa\\Nette\\Utils\\DateTime', 'DateTimeInterface', '*Finder', '*Builder', '*Query'];
    /**
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\Defluent\NodeAnalyzer\FluentCallStaticTypeResolver $fluentCallStaticTypeResolver, \_PhpScoper0a2ac50786fa\Rector\Defluent\NodeAnalyzer\SameClassMethodCallAnalyzer $sameClassMethodCallAnalyzer, \_PhpScoper0a2ac50786fa\Rector\Defluent\NodeAnalyzer\FluentChainMethodCallNodeAnalyzer $fluentChainMethodCallNodeAnalyzer, \_PhpScoper0a2ac50786fa\Rector\Defluent\NodeAnalyzer\GetterMethodCallAnalyzer $getterMethodCallAnalyzer, \_PhpScoper0a2ac50786fa\Rector\Defluent\Skipper\StringMatcher $stringMatcher)
    {
    ...
    public function shouldSkipRootMethodCall(\_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
    ...
    public function shouldSkipFirstAssignFluentCall(\_PhpScoper0a2ac50786fa\Rector\Defluent\ValueObject\FirstAssignFluentCall $firstAssignFluentCall) : bool
    {
     ...
     */
    public function shouldSkipMethodCalls(\_PhpScoper0a2ac50786fa\Rector\Defluent\ValueObject\AssignAndRootExpr $assignAndRootExpr, array $fluentMethodCalls) : bool
    {
     ...
     */
    private function resolveCalleeUniqueType(\_PhpScoper0a2ac50786fa\Rector\Defluent\Contract\ValueObject\FirstCallFactoryAwareInterface $firstCallFactoryAware, array $calleeUniqueTypes) : string
    {
