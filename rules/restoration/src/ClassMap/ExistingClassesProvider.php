...
namespace _PhpScoperb75b35f52b74\Rector\Restoration\ClassMap;
...
final class ExistingClassesProvider
{
    ...
    public function __construct(\_PhpScoperb75b35f52b74\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    private function getPsr4PathFromComposerJson() : array
    {
        ...
        return \_PhpScoperb75b35f52b74\Nette\Utils\Arrays::flatten($psr4AndClassmapDirectories);
    }
    /**
