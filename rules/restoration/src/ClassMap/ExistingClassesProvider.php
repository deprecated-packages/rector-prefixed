...
final class ExistingClassesProvider
{
    ...
    public function __construct(\RectorPrefix20210120\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    private function getPsr4PathFromComposerJson() : array
    {
        ...
        return \RectorPrefix20210120\Nette\Utils\Arrays::flatten($psr4AndClassmapDirectories);
    }
    /**
