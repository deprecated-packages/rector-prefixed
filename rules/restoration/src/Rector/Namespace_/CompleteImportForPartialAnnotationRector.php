...
CODE_SAMPLE
, [self::USE_IMPORTS_TO_RESTORE => [new \Rector\Restoration\ValueObject\UseWithAlias('_PhpScoperfce0de0de1ce\\Doctrine\\ORM\\Mapping', 'ORM')]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        foreach ($this->useImportsToRestore as $useImportToRestore) {
            ...
            if (!\_PhpScoperfce0de0de1ce\Nette\Utils\Strings::match($this->print($class), $annotationToSeek)) {
                continue;
            }
    ...
    {
        $default = [new \Rector\Restoration\ValueObject\UseWithAlias('_PhpScoperfce0de0de1ce\\Doctrine\\ORM\\Mapping', 'ORM'), new \Rector\Restoration\ValueObject\UseWithAlias('_PhpScoperfce0de0de1ce\\Symfony\\Component\\Validator\\Constraints', 'Assert'), new \Rector\Restoration\ValueObject\UseWithAlias('_PhpScoperfce0de0de1ce\\JMS\\Serializer\\Annotation', 'Serializer')];
