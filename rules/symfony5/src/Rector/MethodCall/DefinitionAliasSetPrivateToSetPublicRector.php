...
final class DefinitionAliasSetPrivateToSetPublicRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var class-string[]
     */
    private const REQUIRED_CLASS_TYPES = [\RectorPrefix20210205\Symfony\Component\DependencyInjection\Definition::class, \RectorPrefix20210205\Symfony\Component\DependencyInjection\Alias::class];
