 ...
 */
final class ReplaceEachAssignmentWithKeyCurrentRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector
{
    /**
     * @var string
     */
    ...
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Replace each() assign outside loop', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
$array = ['b' => 1, 'a' => 2];
...
CODE_SAMPLE
    ...
    private function shouldSkip(\_PhpScopere8e811afab72\PhpParser\Node\Expr\Assign $assign) : bool
    {
        ...
        return $parentNode->var instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr\List_;
    }
    /**
     * @return array<int, Assign|FuncCall>
     */
    private function createNewNodes(\_PhpScopere8e811afab72\PhpParser\Node\Expr $assignVariable, \_PhpScopere8e811afab72\PhpParser\Node\Expr $eachedVariable) : array
    {
        $newNodes = [];
        ...
        $newNodes[] = $this->createFuncCall('next', [new \_PhpScopere8e811afab72\PhpParser\Node\Arg($eachedVariable)]);
        return $newNodes;
    }
    /**
     * @param string|int $dimValue
     */
    private function createDimFetchAssignWithFuncCall(\_PhpScopere8e811afab72\PhpParser\Node\Expr $assignVariable, \_PhpScopere8e811afab72\PhpParser\Node\Expr $eachedVariable, $dimValue, string $functionName) : \_PhpScopere8e811afab72\PhpParser\Node\Expr\Assign
    {
        $dim = \_PhpScopere8e811afab72\PhpParser\BuilderHelpers::normalizeValue($dimValue);
        $arrayDimFetch = new \_PhpScopere8e811afab72\PhpParser\Node\Expr\ArrayDimFetch($assignVariable, $dim);
        return new \_PhpScopere8e811afab72\PhpParser\Node\Expr\Assign($arrayDimFetch, $this->createFuncCall($functionName, [new \_PhpScopere8e811afab72\PhpParser\Node\Arg($eachedVariable)]));
    }
}
