 ...
 */
final class ListEachRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
     * @var AssignManipulator
     */
    private $assignManipulator;
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Node\Manipulator\AssignManipulator $assignManipulator)
    {
        $this->assignManipulator = $assignManipulator;
    }
    public function getRuleDefinition() : \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('each() function is deprecated, use key() and current() instead', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : ?\_PhpScoper0a6b37af0871\PhpParser\Node
    {
        ...
        if ($listNode->items[0] && $listNode->items[1] === null) {
            ...
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign($listNode->items[0]->value, $keyFuncCall);
        }
        ...
        if ($listNode->items[1] && $listNode->items[0] === null) {
            ...
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign($secondArrayItem->value, $currentFuncCall);
        }
        ...
        $assign = new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign($secondArrayItem->value, $currentFuncCall);
        ...
        return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign($firstArrayItem->value, $keyFuncCall);
    }
