 ...
 */
final class ParseStrWithResultArgumentRector extends \_PhpScopere8e811afab72\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Use $result argument in parse_str() function', [new \_PhpScopere8e811afab72\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScopere8e811afab72\PhpParser\Node $node) : ?\_PhpScopere8e811afab72\PhpParser\Node
    {
        ...
        $resultVariable = new \_PhpScopere8e811afab72\PhpParser\Node\Expr\Variable('result');
        $node->args[1] = new \_PhpScopere8e811afab72\PhpParser\Node\Arg($resultVariable);
        ...
        $this->traverseNodesWithCallable($nextExpression, function (\_PhpScopere8e811afab72\PhpParser\Node $node) use($resultVariable) : ?Variable {
