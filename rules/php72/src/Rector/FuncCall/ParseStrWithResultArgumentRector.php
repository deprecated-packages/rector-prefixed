 ...
 */
final class ParseStrWithResultArgumentRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector
{
    public function getRuleDefinition() : \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Use $result argument in parse_str() function', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        $resultVariable = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable('result');
        $node->args[1] = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Arg($resultVariable);
        ...
        $this->traverseNodesWithCallable($nextExpression, function (\_PhpScoper0a2ac50786fa\PhpParser\Node $node) use($resultVariable) : ?Variable {
