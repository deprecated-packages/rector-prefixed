...
namespace _PhpScoper0a6b37af0871\Rector\Php72\Rector\While_;
 ...
 */
final class WhileEachToForeachRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('each() function is deprecated, use foreach() instead.', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        return [\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\While_::class];
    }
    /**
     * @param While_ $node
     */
    ...
    {
        if (!$node->cond instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Assign) {
            return null;
        }
        ...
        $foreach = new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Foreach_($foreachedExpr, $arrayItem, ['stmts' => $node->stmts]);
