...
final class CreateFunctionToAnonymousFunctionRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\Php72\Rector\FuncCall\CreateFunctionToAnonymousFunctionRector::class;
    }
}
