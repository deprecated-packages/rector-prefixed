...
, $configuration)]);
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        foreach ($this->classConstantRenames as $classConstantRename) {
            ...
            if (\RectorPrefix20201229\Nette\Utils\Strings::contains($classConstantRename->getNewConstant(), '::')) {
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20201229\Webmozart\Assert\Assert::allIsInstanceOf($classConstantRenames, \Rector\Renaming\ValueObject\RenameClassConstant::class);
