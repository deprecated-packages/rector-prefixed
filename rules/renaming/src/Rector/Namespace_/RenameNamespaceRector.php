...
namespace _PhpScoper0a2ac50786fa\Rector\Renaming\Rector\Namespace_;
...
use _PhpScoper0a2ac50786fa\Rector\Naming\NamespaceMatcher;
 ...
 */
final class RenameNamespaceRector extends \_PhpScoper0a2ac50786fa\Rector\Core\Rector\AbstractRector implements \_PhpScoper0a2ac50786fa\Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\Naming\NamespaceMatcher $namespaceMatcher)
    {
        $this->namespaceMatcher = $namespaceMatcher;
    }
    public function getRuleDefinition() : \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition
    {
        return new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Replaces old namespace by new one.', [new \_PhpScoper0a2ac50786fa\Symplify\RuleDocGenerator\ValueObject\CodeSample\ConfiguredCodeSample('$someObject = new SomeOldNamespace\\SomeClass;', '$someObject = new SomeNewNamespace\\SomeClass;', [self::OLD_TO_NEW_NAMESPACES => ['SomeOldNamespace' => 'SomeNewNamespace']])]);
    }
    /**
     * @return string[]
     */
    ...
    {
        return [\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Namespace_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Use_::class, \_PhpScoper0a2ac50786fa\PhpParser\Node\Name::class];
    }
    /**
    ...
    public function refactor(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        if ($node instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Use_) {
            $newName = $renamedNamespaceValueObject->getNameInNewNamespace();
            $node->uses[0]->name = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Name($newName);
            return $node;
        }
        ...
        return new \_PhpScoper0a2ac50786fa\PhpParser\Node\Name\FullyQualified($newName);
    }
    /**
     ...
     */
    private function isClassFullyQualifiedName(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : bool
    {
    ...
    private function isPartialNamespace(\_PhpScoper0a2ac50786fa\PhpParser\Node\Name $name) : bool
    {
        $resolvedName = $name->getAttribute(\_PhpScoper0a2ac50786fa\Rector\NodeTypeResolver\Node\AttributeKey::RESOLVED_NAME);
    ...
    private function resolvePartialNewName(\_PhpScoper0a2ac50786fa\PhpParser\Node\Name $name, \_PhpScoper0a2ac50786fa\Rector\Core\ValueObject\RenamedNamespace $renamedNamespace) : string
    {
        $nameInNewNamespace = $renamedNamespace->getNameInNewNamespace();
        // first dummy implementation - improve
        $cutOffFromTheLeft = \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::length($nameInNewNamespace) - \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::length($name->toString());
        return \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::substring($nameInNewNamespace, $cutOffFromTheLeft);
    }
}
