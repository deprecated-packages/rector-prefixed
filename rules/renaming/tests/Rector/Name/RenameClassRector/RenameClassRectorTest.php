...
use Iterator;
use RectorPrefix20210205\Manual\Twig\TwigFilter;
use RectorPrefix20210205\Manual_Twig_Filter;
...
final class RenameClassRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    {
        $fixtureFileInfo = new \RectorPrefix20210205\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/FixtureDuplication/skip_duplicated_class.php.inc');
    ...
    protected function getRectorsWithConfiguration() : array
    {
        return [\Rector\Renaming\Rector\Name\RenameClassRector::class => [\Rector\Renaming\Rector\Name\RenameClassRector::OLD_TO_NEW_CLASSES => [
            ...
            'Countable' => 'stdClass',
            \RectorPrefix20210205\Manual_Twig_Filter::class => \RectorPrefix20210205\Manual\Twig\TwigFilter::class,
            ...
            \RectorPrefix20210205\Acme\Foo\DoNotUpdateExistingTargetNamespace::class => \RectorPrefix20210205\Acme\Bar\DoNotUpdateExistingTargetNamespace::class,
        ]]];
    }
}
