...
final class RenameMethodRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    protected function getRectorsWithConfiguration() : array
    {
        return [\Rector\Renaming\Rector\MethodCall\RenameMethodRector::class => [\Rector\Renaming\Rector\MethodCall\RenameMethodRector::METHOD_CALL_RENAMES => [
            ...
            new \Rector\Renaming\ValueObject\MethodCallRename(\RectorPrefix20210112\Nette\Utils\Html::class, 'add', 'addHtml'),
            ...
            // with array key
            new \Rector\Renaming\ValueObject\MethodCallRenameWithArrayKey(\RectorPrefix20210112\Nette\Utils\Html::class, 'addToArray', 'addToHtmlArray', 'hey'),
        ]]];
    }
}
