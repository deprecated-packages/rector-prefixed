...
use RectorPrefix20210309\Doctrine\Common\Collections\ArrayCollection;
use PhpParser\Node;
...
CODE_SAMPLE
    ...
    private function isPropertyFetchAssignOfArrayCollection(\PhpParser\Node\Expr\PropertyFetch $propertyFetch) : bool
    {
        ...
        /** @var New_ $new */
        $new = $parentNode->expr;
        return $this->isName($new->class, \RectorPrefix20210309\Doctrine\Common\Collections\ArrayCollection::class);
    }
