...
use _PhpScoper0a6b37af0871\Rector\Core\Context\ContextAnalyzer;
use _PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector;
use _PhpScoper0a6b37af0871\Rector\DeadCode\FlowControl\VariableUseFinder;
use _PhpScoper0a6b37af0871\Rector\DeadCode\NodeCollector\NodeByTypeAndPositionCollector;
use _PhpScoper0a6b37af0871\Rector\DeadCode\ValueObject\VariableNodeUse;
 ...
 */
final class RemoveOverriddenValuesRector extends \_PhpScoper0a6b37af0871\Rector\Core\Rector\AbstractRector
{
    /**
     * @var ContextAnalyzer
     */
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\Core\Context\ContextAnalyzer $contextAnalyzer, \_PhpScoper0a6b37af0871\Rector\DeadCode\NodeCollector\NodeByTypeAndPositionCollector $nodeByTypeAndPositionCollector, \_PhpScoper0a6b37af0871\Rector\DeadCode\FlowControl\VariableUseFinder $variableUseFinder)
    {
    ...
    {
        return new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Remove initial assigns of overridden values', [new \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
     ...
     * @return Variable[]
     */
    private function resolveAssignedVariables(\_PhpScoper0a6b37af0871\PhpParser\Node\FunctionLike $functionLike) : array
    {
        return $this->betterNodeFinder->find($functionLike, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool {
            ...
            $assignNode = $node->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
    ...
    private function isAssignNodeUsed(?\_PhpScoper0a6b37af0871\Rector\DeadCode\ValueObject\VariableNodeUse $previousNode, \_PhpScoper0a6b37af0871\Rector\DeadCode\ValueObject\VariableNodeUse $nodeByTypeAndPosition) : bool
    {
        // this node was just used, skip to next one
        if ($previousNode === null) {
            return \false;
        }
        if (!$previousNode->isType(\_PhpScoper0a6b37af0871\Rector\DeadCode\ValueObject\VariableNodeUse::TYPE_ASSIGN)) {
            return \false;
        }
        return $nodeByTypeAndPosition->isType(\_PhpScoper0a6b37af0871\Rector\DeadCode\ValueObject\VariableNodeUse::TYPE_USE);
    }
    private function shouldRemoveAssignNode(?\_PhpScoper0a6b37af0871\Rector\DeadCode\ValueObject\VariableNodeUse $previousNode, \_PhpScoper0a6b37af0871\Rector\DeadCode\ValueObject\VariableNodeUse $nodeByTypeAndPosition) : bool
    {
        if ($previousNode === null) {
            return \false;
        }
        ...
        if (!$nodeByTypeAndPosition->isType(\_PhpScoper0a6b37af0871\Rector\DeadCode\ValueObject\VariableNodeUse::TYPE_ASSIGN)) {
            return \false;
        }
        ...
        $isVariableAssigned = (bool) $this->betterNodeFinder->findFirst($assignNode->expr, function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) use($nodeByTypeAndPosition) : bool {
