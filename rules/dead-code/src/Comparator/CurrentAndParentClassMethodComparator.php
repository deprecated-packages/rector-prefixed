...
namespace _PhpScoper0a6b37af0871\Rector\DeadCode\Comparator;
...
use _PhpScoper0a6b37af0871\Rector\DeadCode\Comparator\Parameter\ParameterDefaultsComparator;
use _PhpScoper0a6b37af0871\Rector\DeadCode\Comparator\Parameter\ParameterTypeComparator;
...
final class CurrentAndParentClassMethodComparator
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScoper0a6b37af0871\Rector\Core\PhpParser\Printer\BetterStandardPrinter $betterStandardPrinter, \_PhpScoper0a6b37af0871\Rector\NodeCollector\NodeCollector\NodeRepository $nodeRepository, \_PhpScoper0a6b37af0871\Rector\NodeCollector\Reflection\MethodReflectionProvider $methodReflectionProvider, \_PhpScoper0a6b37af0871\Rector\DeadCode\Comparator\Parameter\ParameterDefaultsComparator $parameterDefaultsComparator, \_PhpScoper0a6b37af0871\Rector\DeadCode\Comparator\Parameter\ParameterTypeComparator $parameterTypeComparator)
    {
    ...
    public function isParentCallMatching(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\StaticCall $staticCall) : bool
    {
    ...
    private function isSameMethodParentCall(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\StaticCall $staticCall) : bool
    {
    ...
    private function isParentClassMethodVisibilityOrDefaultOverride(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\StaticCall $staticCall) : bool
    {
        /** @var string $className */
        $className = $staticCall->getAttribute(\_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\Node\AttributeKey::CLASS_NAME);
    ...
    private function checkOverrideUsingReflection(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, string $parentClassName, string $methodName) : bool
    {
    ...
    private function areParameterDefaultsDifferent(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection $methodReflection) : bool
    {
