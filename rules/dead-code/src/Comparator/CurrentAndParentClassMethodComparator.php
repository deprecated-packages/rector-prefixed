...
namespace _PhpScopere8e811afab72\Rector\DeadCode\Comparator;
...
use _PhpScopere8e811afab72\Rector\DeadCode\Comparator\Parameter\ParameterDefaultsComparator;
use _PhpScopere8e811afab72\Rector\DeadCode\Comparator\Parameter\ParameterTypeComparator;
...
final class CurrentAndParentClassMethodComparator
{
    ...
    public function __construct(\_PhpScopere8e811afab72\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScopere8e811afab72\Rector\Core\PhpParser\Printer\BetterStandardPrinter $betterStandardPrinter, \_PhpScopere8e811afab72\Rector\NodeCollector\NodeCollector\NodeRepository $nodeRepository, \_PhpScopere8e811afab72\Rector\NodeCollector\Reflection\MethodReflectionProvider $methodReflectionProvider, \_PhpScopere8e811afab72\Rector\DeadCode\Comparator\Parameter\ParameterDefaultsComparator $parameterDefaultsComparator, \_PhpScopere8e811afab72\Rector\DeadCode\Comparator\Parameter\ParameterTypeComparator $parameterTypeComparator)
    {
    ...
    public function isParentCallMatching(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScopere8e811afab72\PhpParser\Node\Expr\StaticCall $staticCall) : bool
    {
    ...
    private function isSameMethodParentCall(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScopere8e811afab72\PhpParser\Node\Expr\StaticCall $staticCall) : bool
    {
    ...
    private function isParentClassMethodVisibilityOrDefaultOverride(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScopere8e811afab72\PhpParser\Node\Expr\StaticCall $staticCall) : bool
    {
        /** @var string $className */
        $className = $staticCall->getAttribute(\_PhpScopere8e811afab72\Rector\NodeTypeResolver\Node\AttributeKey::CLASS_NAME);
    ...
    private function checkOverrideUsingReflection(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassMethod $classMethod, string $parentClassName, string $methodName) : bool
    {
    ...
    private function areParameterDefaultsDifferent(\_PhpScopere8e811afab72\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScopere8e811afab72\PHPStan\Reflection\MethodReflection $methodReflection) : bool
    {
