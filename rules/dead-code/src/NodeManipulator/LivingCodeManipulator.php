...
use _PhpScoper0a6b37af0871\PhpParser\Node\Expr\UnaryPlus;
...
final class LivingCodeManipulator
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\PostRector\Collector\NodesToAddCollector $nodesToAddCollector)
    {
        $this->nodesToAddCollector = $nodesToAddCollector;
    }
    public function addLivingCodeBeforeNode(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr $expr, \_PhpScoper0a6b37af0871\PhpParser\Node $addBeforeThisNode) : void
    {
        $livinExprs = $this->keepLivingCodeFromExpr($expr);
        foreach ($livinExprs as $expr) {
            $this->nodesToAddCollector->addNodeBeforeNode(new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Expression($expr), $addBeforeThisNode);
        }
    }
    /**
    ...
    public function keepLivingCodeFromExpr($expr) : array
    {
        ...
        if ($expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Closure || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Scalar || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\ConstFetch) {
            return [];
        }
        ...
        if ($expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\ClassConstFetch || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\StaticPropertyFetch) {
    ...
    private function isNestedExpr(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr $expr) : bool
    {
        return $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Cast || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Empty_ || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\UnaryMinus || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\UnaryPlus || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BitwiseNot || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BooleanNot || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Clone_;
    }
    private function isBinaryOpWithoutChange(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr $expr) : bool
    {
        if (!$expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp) {
            return \false;
        }
        return !($expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\LogicalAnd || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\BooleanAnd || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\LogicalOr || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\BooleanOr || $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp\Coalesce);
    }
    /**
     * @return Expr[]
     */
    private function processBinary(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\BinaryOp $binaryOp) : array
    {
     ...
     * @return mixed[]
     */
    private function processIsset(\_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Isset_ $isset) : array
    {
        $livingExprs = [];
