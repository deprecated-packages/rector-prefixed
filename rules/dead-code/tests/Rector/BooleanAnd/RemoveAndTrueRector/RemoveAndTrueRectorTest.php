...
final class RemoveAndTrueRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\DeadCode\Rector\BooleanAnd\RemoveAndTrueRector::class;
    }
}
