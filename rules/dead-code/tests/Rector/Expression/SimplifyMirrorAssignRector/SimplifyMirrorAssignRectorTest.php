...
final class SimplifyMirrorAssignRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\DeadCode\Rector\Expression\SimplifyMirrorAssignRector::class;
    }
}
