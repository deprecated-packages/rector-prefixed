...
final class RemoveDelegatingParentCallRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    /**
    ...
    {
        return \Rector\DeadCode\Rector\ClassMethod\RemoveDelegatingParentCallRector::class;
    }
}
