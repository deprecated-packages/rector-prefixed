...
abstract class NettePresenter implements \RectorPrefix20210220\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210220\Nette\Application\Request $request) : \RectorPrefix20210220\Nette\Application\IResponse
    {
    }
}
