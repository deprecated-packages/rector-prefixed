...
abstract class NettePresenter implements \RectorPrefix20210226\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210226\Nette\Application\Request $request) : \RectorPrefix20210226\Nette\Application\IResponse
    {
    }
}
