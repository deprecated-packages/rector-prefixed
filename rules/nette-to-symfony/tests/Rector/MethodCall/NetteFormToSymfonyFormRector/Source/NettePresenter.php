...
abstract class NettePresenter implements \RectorPrefix20210106\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210106\Nette\Application\Request $request) : \RectorPrefix20210106\Nette\Application\IResponse
    {
    }
}
