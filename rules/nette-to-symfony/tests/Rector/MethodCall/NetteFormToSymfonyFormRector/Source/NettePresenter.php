...
abstract class NettePresenter implements \RectorPrefix20210130\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210130\Nette\Application\Request $request) : \RectorPrefix20210130\Nette\Application\IResponse
    {
    }
}
