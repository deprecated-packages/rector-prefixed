...
abstract class NettePresenter implements \RectorPrefix20210206\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210206\Nette\Application\Request $request) : \RectorPrefix20210206\Nette\Application\IResponse
    {
    }
}
