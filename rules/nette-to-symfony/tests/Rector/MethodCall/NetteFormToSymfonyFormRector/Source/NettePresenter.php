...
abstract class NettePresenter implements \RectorPrefix20210309\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210309\Nette\Application\Request $request) : \RectorPrefix20210309\Nette\Application\IResponse
    {
    }
}
