...
abstract class NettePresenter implements \RectorPrefix20210128\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210128\Nette\Application\Request $request) : \RectorPrefix20210128\Nette\Application\IResponse
    {
    }
}
