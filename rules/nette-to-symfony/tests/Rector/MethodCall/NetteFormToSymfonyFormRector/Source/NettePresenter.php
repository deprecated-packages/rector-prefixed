...
abstract class NettePresenter implements \RectorPrefix20201229\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20201229\Nette\Application\Request $request) : \RectorPrefix20201229\Nette\Application\IResponse
    {
    }
}
