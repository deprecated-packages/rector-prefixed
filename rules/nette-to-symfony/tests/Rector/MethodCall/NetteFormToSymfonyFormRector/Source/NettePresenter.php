...
abstract class NettePresenter implements \RectorPrefix20210302\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210302\Nette\Application\Request $request) : \RectorPrefix20210302\Nette\Application\IResponse
    {
    }
}
