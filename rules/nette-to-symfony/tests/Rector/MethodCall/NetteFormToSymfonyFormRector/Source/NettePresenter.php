...
abstract class NettePresenter implements \RectorPrefix20210118\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210118\Nette\Application\Request $request) : \RectorPrefix20210118\Nette\Application\IResponse
    {
    }
}
