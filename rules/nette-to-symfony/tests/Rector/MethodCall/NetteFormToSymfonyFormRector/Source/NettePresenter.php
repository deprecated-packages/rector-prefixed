...
abstract class NettePresenter implements \RectorPrefix20210122\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210122\Nette\Application\Request $request) : \RectorPrefix20210122\Nette\Application\IResponse
    {
    }
}
