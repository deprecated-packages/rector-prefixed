...
abstract class NettePresenter implements \RectorPrefix20210111\Nette\Application\IPresenter
{
    public function run(\RectorPrefix20210111\Nette\Application\Request $request) : \RectorPrefix20210111\Nette\Application\IResponse
    {
    }
}
