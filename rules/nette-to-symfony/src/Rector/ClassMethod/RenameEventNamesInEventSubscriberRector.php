...
use _PhpScoper88fe6e0ad041\Composer\Script\Event;
use PhpParser\Node;
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($classLike, '_PhpScoper88fe6e0ad041\\Symfony\\Component\\EventDispatcher\\EventSubscriberInterface')) {
            return null;
        }
