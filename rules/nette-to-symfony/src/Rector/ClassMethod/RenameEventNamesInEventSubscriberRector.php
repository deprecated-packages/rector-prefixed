...
use _PhpScoperabd03f0baf05\Composer\Script\Event;
use PhpParser\Node;
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($classLike, '_PhpScoperabd03f0baf05\\Symfony\\Component\\EventDispatcher\\EventSubscriberInterface')) {
            return null;
        }
