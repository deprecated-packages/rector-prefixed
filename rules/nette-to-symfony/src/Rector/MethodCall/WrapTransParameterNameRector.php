...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, '_PhpScoper8b9c402c5f32\\Symfony\\Component\\Translation\\TranslatorInterface')) {
            return null;
        }
        ...
        foreach ($parametersArrayNode->items as $arrayItem) {
            ...
            if (\_PhpScoper8b9c402c5f32\Nette\Utils\Strings::match($arrayItem->key->value, self::BETWEEN_PERCENT_CHARS_REGEX)) {
                continue;
            }
