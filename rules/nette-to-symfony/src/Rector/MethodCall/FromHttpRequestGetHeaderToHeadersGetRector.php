...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $requestName = $this->classMethodManipulator->addMethodParameterIfMissing($node, \_PhpScoperf18a0c41e2d2\Symfony\Component\HttpFoundation\Request::class, ['request', 'symfonyRequest']);
