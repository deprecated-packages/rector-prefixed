...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $requestName = $this->classMethodManipulator->addMethodParameterIfMissing($node, \RectorPrefix20210130\Symfony\Component\HttpFoundation\Request::class, ['request', 'symfonyRequest']);
