...
final class NetteFormToSymfonyFormRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    private const ADD_METHOD_TO_FORM_TYPE = [
        'addText' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType',
        'addPassword' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\PasswordType',
        'addTextArea' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\TextareaType',
        'addEmail' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\EmailType',
        'addInteger' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\IntegerType',
        'addHidden' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\HiddenType',
        // https://symfony.com/doc/current/reference/forms/types/checkbox.html
        'addCheckbox' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CheckboxType',
        'addUpload' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType',
        'addImage' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType',
        'addMultiUpload' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType',
        // https://symfony.com/doc/current/reference/forms/types/choice.html#select-tag-checkboxes-or-radio-buttons
        'addSelect' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType',
        'addRadioList' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType',
        'addCheckboxList' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType',
        'addMultiSelect' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType',
        'addSubmit' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType',
        'addButton' => '_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ButtonType',
    ];
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($classLike, '_PhpScoperabd03f0baf05\\Nette\\Application\\IPresenter')) {
            return null;
        }
        ...
        /** @var MethodCall $node */
        if (!$this->isObjectType($node->var, '_PhpScoperabd03f0baf05\\Nette\\Application\\UI\\Form')) {
            return null;
        }
    ...
    {
        if (!$this->isName($new->class, '_PhpScoperabd03f0baf05\\Nette\\Application\\UI\\Form')) {
            return null;
        }
