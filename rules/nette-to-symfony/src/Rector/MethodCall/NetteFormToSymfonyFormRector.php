...
final class NetteFormToSymfonyFormRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    private const ADD_METHOD_TO_FORM_TYPE = [
        'addText' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType',
        'addPassword' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\PasswordType',
        'addTextArea' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\TextareaType',
        'addEmail' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\EmailType',
        'addInteger' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\IntegerType',
        'addHidden' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\HiddenType',
        // https://symfony.com/doc/current/reference/forms/types/checkbox.html
        'addCheckbox' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CheckboxType',
        'addUpload' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType',
        'addImage' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType',
        'addMultiUpload' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType',
        // https://symfony.com/doc/current/reference/forms/types/choice.html#select-tag-checkboxes-or-radio-buttons
        'addSelect' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType',
        'addRadioList' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType',
        'addCheckboxList' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType',
        'addMultiSelect' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType',
        'addSubmit' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType',
        'addButton' => 'RectorPrefix20201226\\Symfony\\Component\\Form\\Extension\\Core\\Type\\ButtonType',
    ];
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($classLike, 'RectorPrefix20201226\\Nette\\Application\\IPresenter')) {
            return null;
        }
        ...
        /** @var MethodCall $node */
        if (!$this->isObjectType($node->var, 'RectorPrefix20201226\\Nette\\Application\\UI\\Form')) {
            return null;
        }
    ...
    {
        if (!$this->isName($new->class, 'RectorPrefix20201226\\Nette\\Application\\UI\\Form')) {
            return null;
        }
