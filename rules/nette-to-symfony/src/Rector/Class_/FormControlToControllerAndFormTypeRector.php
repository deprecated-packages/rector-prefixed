...
use _PhpScoper267b3276efc2\Symfony\Component\Form\AbstractType;
use _PhpScoper267b3276efc2\Symfony\Component\Form\Extension\Core\Type\TextType;
use _PhpScoper267b3276efc2\Symfony\Component\Form\FormBuilderInterface;
class SomeFormType extends \_PhpScoper267b3276efc2\Symfony\Component\Form\AbstractType
{
    public function buildForm(\_PhpScoper267b3276efc2\Symfony\Component\Form\FormBuilderInterface $formBuilder, array $options)
    {
        $formBuilder->add('name', \_PhpScoper267b3276efc2\Symfony\Component\Form\Extension\Core\Type\TextType::class, ['label' => 'Your name']);
    }
}
\class_alias('_PhpScoper267b3276efc2\\SomeFormType', 'SomeFormType', \false);
CODE_SAMPLE
)]);
    }
    /**
    ...
    private function collectFormMethodCallsAndCreateFormTypeClass(\PhpParser\Node\Stmt\ClassMethod $classMethod) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        foreach ($onFormVariableMethodCalls as $onFormVariableMethodCall) {
            if ($this->isName($onFormVariableMethodCall->name, 'addText')) {
                ...
                $formTypeClassConstant = $this->createClassConstantReference(\_PhpScoper267b3276efc2\Symfony\Component\Form\Extension\Core\Type\TextType::class);
