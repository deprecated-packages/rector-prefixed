...
use _PhpScoperf18a0c41e2d2\Symfony\Component\Form\Extension\Core\Type\TextType;
...
use _PhpScoperf18a0c41e2d2\Symfony\Component\Form\AbstractType;
use _PhpScoperf18a0c41e2d2\Symfony\Component\Form\Extension\Core\Type\TextType;
use _PhpScoperf18a0c41e2d2\Symfony\Component\Form\FormBuilderInterface;
class SomeFormType extends \_PhpScoperf18a0c41e2d2\Symfony\Component\Form\AbstractType
{
    public function buildForm(\_PhpScoperf18a0c41e2d2\Symfony\Component\Form\FormBuilderInterface $formBuilder, array $options)
    {
        $formBuilder->add('name', \_PhpScoperf18a0c41e2d2\Symfony\Component\Form\Extension\Core\Type\TextType::class, ['label' => 'Your name']);
    }
}
\class_alias('_PhpScoperf18a0c41e2d2\\SomeFormType', 'SomeFormType', \false);
CODE_SAMPLE
)]);
    }
    /**
    ...
    {
        if (!$this->isObjectType($node, '_PhpScoperf18a0c41e2d2\\Nette\\Application\\UI\\Control')) {
            return null;
        }
    ...
    private function collectFormMethodCallsAndCreateFormTypeClass(\PhpParser\Node\Stmt\ClassMethod $classMethod) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        foreach ($onFormVariableMethodCalls as $onFormVariableMethodCall) {
            if ($this->isName($onFormVariableMethodCall->name, 'addText')) {
                ...
                $formTypeClassConstant = $this->createClassConstantReference(\_PhpScoperf18a0c41e2d2\Symfony\Component\Form\Extension\Core\Type\TextType::class);
    ...
    private function createBuildFormClassMethod(\PhpParser\Node\Expr\Variable $formBuilderVariable) : \PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $buildFormClassMethod->params[] = new \PhpParser\Node\Param($formBuilderVariable, null, new \PhpParser\Node\Name\FullyQualified('_PhpScoperf18a0c41e2d2\\Symfony\\Component\\Form\\FormBuilderInterface'));
    ...
    private function createFormTypeClassFromBuildFormClassMethod(\PhpParser\Node\Stmt\ClassMethod $buildFormClassMethod) : \PhpParser\Node\Stmt\Class_
    {
        ...
        $formTypeClass->extends = new \PhpParser\Node\Name\FullyQualified('_PhpScoperf18a0c41e2d2\\Symfony\\Component\\Form\\AbstractType');
