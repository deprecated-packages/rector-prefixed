...
use RectorPrefix20201229\Symfony\Component\Form\Extension\Core\Type\TextType;
...
use RectorPrefix20201229\Symfony\Component\Form\AbstractType;
use RectorPrefix20201229\Symfony\Component\Form\Extension\Core\Type\TextType;
use RectorPrefix20201229\Symfony\Component\Form\FormBuilderInterface;
class SomeFormType extends \RectorPrefix20201229\Symfony\Component\Form\AbstractType
{
    public function buildForm(\RectorPrefix20201229\Symfony\Component\Form\FormBuilderInterface $formBuilder, array $options)
    {
        $formBuilder->add('name', \RectorPrefix20201229\Symfony\Component\Form\Extension\Core\Type\TextType::class, ['label' => 'Your name']);
    }
}
    ...
    private function collectFormMethodCallsAndCreateFormTypeClass(\PhpParser\Node\Stmt\ClassMethod $classMethod) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        foreach ($onFormVariableMethodCalls as $onFormVariableMethodCall) {
            if ($this->isName($onFormVariableMethodCall->name, 'addText')) {
                ...
                $formTypeClassConstant = $this->createClassConstantReference(\RectorPrefix20201229\Symfony\Component\Form\Extension\Core\Type\TextType::class);
