...
use _PhpScoperabd03f0baf05\Symfony\Component\Form\Extension\Core\Type\TextType;
...
use _PhpScoperabd03f0baf05\Symfony\Component\Form\AbstractType;
use _PhpScoperabd03f0baf05\Symfony\Component\Form\Extension\Core\Type\TextType;
use _PhpScoperabd03f0baf05\Symfony\Component\Form\FormBuilderInterface;
class SomeFormType extends \_PhpScoperabd03f0baf05\Symfony\Component\Form\AbstractType
{
    public function buildForm(\_PhpScoperabd03f0baf05\Symfony\Component\Form\FormBuilderInterface $formBuilder, array $options)
    {
        $formBuilder->add('name', \_PhpScoperabd03f0baf05\Symfony\Component\Form\Extension\Core\Type\TextType::class, ['label' => 'Your name']);
    }
}
\class_alias('_PhpScoperabd03f0baf05\\SomeFormType', 'SomeFormType', \false);
CODE_SAMPLE
)]);
    }
    /**
    ...
    private function collectFormMethodCallsAndCreateFormTypeClass(\PhpParser\Node\Stmt\ClassMethod $classMethod) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        foreach ($onFormVariableMethodCalls as $onFormVariableMethodCall) {
            if ($this->isName($onFormVariableMethodCall->name, 'addText')) {
                ...
                $formTypeClassConstant = $this->createClassConstantReference(\_PhpScoperabd03f0baf05\Symfony\Component\Form\Extension\Core\Type\TextType::class);
    ...
    private function createBuildFormClassMethod(\PhpParser\Node\Expr\Variable $formBuilderVariable) : \PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $buildFormClassMethod->params[] = new \PhpParser\Node\Param($formBuilderVariable, null, new \PhpParser\Node\Name\FullyQualified('_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\FormBuilderInterface'));
    ...
    private function createFormTypeClassFromBuildFormClassMethod(\PhpParser\Node\Stmt\ClassMethod $buildFormClassMethod) : \PhpParser\Node\Stmt\Class_
    {
        ...
        $formTypeClass->extends = new \PhpParser\Node\Name\FullyQualified('_PhpScoperabd03f0baf05\\Symfony\\Component\\Form\\AbstractType');
