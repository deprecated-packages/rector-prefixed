...
CODE_SAMPLE
    ...
    private function processMoveAnonymousClassInClass(\PhpParser\Node\Expr\New_ $new, \PhpParser\Node\Stmt\Class_ $class)
    {
        ...
        $namespace = $namespacedClassName === $shortClassName ? '' : \RectorPrefix20210422\Nette\Utils\Strings::substring($namespacedClassName, 0, -\strlen($shortClassName) - 1);
    ...
    private function processMoveAnonymousClassInFunction(\PhpParser\Node\Expr\New_ $new, \PhpParser\Node\Stmt\Function_ $function)
    {
        ...
        $namespace = $namespacedFunctionName === $shortFunctionName ? '' : \RectorPrefix20210422\Nette\Utils\Strings::substring($namespacedFunctionName, 0, -\strlen($shortFunctionName) - 1);
