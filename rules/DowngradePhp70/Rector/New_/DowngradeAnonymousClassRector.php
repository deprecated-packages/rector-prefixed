...
CODE_SAMPLE
    ...
    private function processMoveAnonymousClassInClass(\PhpParser\Node\Expr\New_ $new, \PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node\Expr\New_
    {
        ...
        $namespace = $namespacedClassName === $shortClassName ? '' : \RectorPrefix20210414\Nette\Utils\Strings::substring($namespacedClassName, 0, -\strlen($shortClassName) - 1);
    ...
    private function processMoveAnonymousClassInFunction(\PhpParser\Node\Expr\New_ $new, \PhpParser\Node\Stmt\Function_ $function) : ?\PhpParser\Node\Expr\New_
    {
        ...
        $namespace = $namespacedFunctionName === $shortFunctionName ? '' : \RectorPrefix20210414\Nette\Utils\Strings::substring($namespacedFunctionName, 0, -\strlen($shortFunctionName) - 1);
