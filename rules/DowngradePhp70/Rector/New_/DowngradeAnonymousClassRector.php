...
CODE_SAMPLE
    ...
    private function processMoveAnonymousClassInFunction(\PhpParser\Node\Expr\New_ $new, \PhpParser\Node\Stmt\Function_ $function) : ?\PhpParser\Node\Expr\New_
    {
        ...
        $namespace = $namespacedFunctionName === $shortFunctionName ? '' : \RectorPrefix20210507\Nette\Utils\Strings::substring($namespacedFunctionName, 0, -\strlen($shortFunctionName) - 1);
