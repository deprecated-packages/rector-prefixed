...
CODE_SAMPLE
     ...
     */
    private function processMoveAnonymousClassInClass(New_ $new, Class_ $class)
    {
     ...
     * @return \PhpParser\Node\Expr\New_|null
     */
    private function processMoveAnonymousClassInFunction(New_ $new, Function_ $function)
    {
     ...
     * @return \PhpParser\Node\Expr\New_|null
     */
    private function processMoveAnonymousClassInDirectCall(New_ $new, Stmt $stmt)
    {
     ...
     * @return \PhpParser\Node\Expr\New_|null
     */
    private function processMove(New_ $new, string $className, Node $node)
    {
