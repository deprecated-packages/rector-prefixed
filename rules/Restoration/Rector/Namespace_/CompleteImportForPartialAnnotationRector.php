...
use RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder;
...
, [self::USE_IMPORTS_TO_RESTORE => [new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Doctrine\\ORM\\Mapping', 'ORM')]])]);
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        foreach ($this->useImportsToRestore as $useImportToRestore) {
            ...
            if (!\RectorPrefix20210505\Nette\Utils\Strings::match($this->print($class), $annotationToSeek)) {
                continue;
            }
    ...
    {
        $useBuilder = new \RectorPrefix20210505\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder($completeImportForPartialAnnotation->getUse());
