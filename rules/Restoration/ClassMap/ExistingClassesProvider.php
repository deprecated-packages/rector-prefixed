...
use RectorPrefix20210427\Nette\Loaders\RobotLoader;
...
final class ExistingClassesProvider
{
    ...
    public function __construct(\RectorPrefix20210427\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    private function getPsr4PathFromComposerJson() : array
    {
        ...
        return \RectorPrefix20210427\Nette\Utils\Arrays::flatten($psr4AndClassmapDirectories);
    }
    /**
    ...
    {
        $robotLoader = new \RectorPrefix20210427\Nette\Loaders\RobotLoader();
