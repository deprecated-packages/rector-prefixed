...
use RectorPrefix20210407\Nette\Loaders\RobotLoader;
...
final class ExistingClassesProvider
{
    ...
    public function __construct(\RectorPrefix20210407\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    private function getPsr4PathFromComposerJson() : array
    {
        ...
        return \RectorPrefix20210407\Nette\Utils\Arrays::flatten($psr4AndClassmapDirectories);
    }
    /**
    ...
    {
        $robotLoader = new \RectorPrefix20210407\Nette\Loaders\RobotLoader();
