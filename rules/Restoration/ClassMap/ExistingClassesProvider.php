...
use RectorPrefix20210326\Nette\Loaders\RobotLoader;
...
final class ExistingClassesProvider
{
    ...
    public function __construct(\RectorPrefix20210326\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    private function getPsr4PathFromComposerJson() : array
    {
        ...
        return \RectorPrefix20210326\Nette\Utils\Arrays::flatten($psr4AndClassmapDirectories);
    }
    /**
    ...
    {
        $robotLoader = new \RectorPrefix20210326\Nette\Loaders\RobotLoader();
