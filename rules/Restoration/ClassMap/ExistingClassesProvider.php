...
use RectorPrefix20210318\Nette\Loaders\RobotLoader;
...
final class ExistingClassesProvider
{
    ...
    public function __construct(\RectorPrefix20210318\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    private function getPsr4PathFromComposerJson() : array
    {
        ...
        return \RectorPrefix20210318\Nette\Utils\Arrays::flatten($psr4AndClassmapDirectories);
    }
    /**
    ...
    {
        $robotLoader = new \RectorPrefix20210318\Nette\Loaders\RobotLoader();
