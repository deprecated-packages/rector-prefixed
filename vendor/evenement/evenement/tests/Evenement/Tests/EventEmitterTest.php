 ...
 */
namespace _PhpScoper006a73f0e455\Evenement\Tests;

use _PhpScoper006a73f0e455\Evenement\EventEmitter;
use InvalidArgumentException;
use _PhpScoper006a73f0e455\PHPUnit\Framework\TestCase;
class EventEmitterTest extends \_PhpScoper006a73f0e455\PHPUnit\Framework\TestCase
{
    private $emitter;
    public function setUp()
    {
        $this->emitter = new \_PhpScoper006a73f0e455\Evenement\EventEmitter();
    }
    ...
    {
        $listener = new \_PhpScoper006a73f0e455\Evenement\Tests\Listener();
        $this->emitter->on('foo', [$listener, 'onFoo']);
    }
    public function testAddListenerWithStaticMethod()
    {
        $this->emitter->on('bar', ['_PhpScoper006a73f0e455\\Evenement\\Tests\\Listener', 'onBar']);
    }
    ...
    public function testCallablesStaticClass()
    {
        ...
        $this->emitter->emit('foo', ['bar']);
        self::assertSame(['bar'], \_PhpScoper006a73f0e455\Evenement\Tests\Listener::getStaticData());
    }
    public function testCallablesFunction()
    {
        $this->emitter->on('foo', '_PhpScoper006a73f0e455\\Evenement\\Tests\\setGlobalTestData');
        $this->emitter->emit('foo', ['bar']);
