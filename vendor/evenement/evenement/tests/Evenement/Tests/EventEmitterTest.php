 ...
 */
namespace _PhpScoper88fe6e0ad041\Evenement\Tests;

use _PhpScoper88fe6e0ad041\Evenement\EventEmitter;
use InvalidArgumentException;
use _PhpScoper88fe6e0ad041\PHPUnit\Framework\TestCase;
class EventEmitterTest extends \_PhpScoper88fe6e0ad041\PHPUnit\Framework\TestCase
{
    private $emitter;
    public function setUp()
    {
        $this->emitter = new \_PhpScoper88fe6e0ad041\Evenement\EventEmitter();
    }
    ...
    {
        $listener = new \_PhpScoper88fe6e0ad041\Evenement\Tests\Listener();
        $this->emitter->on('foo', [$listener, 'onFoo']);
    }
    public function testAddListenerWithStaticMethod()
    {
        $this->emitter->on('bar', ['_PhpScoper88fe6e0ad041\\Evenement\\Tests\\Listener', 'onBar']);
    }
    ...
    public function testCallablesStaticClass()
    {
        ...
        $this->emitter->emit('foo', ['bar']);
        self::assertSame(['bar'], \_PhpScoper88fe6e0ad041\Evenement\Tests\Listener::getStaticData());
    }
    public function testCallablesFunction()
    {
        $this->emitter->on('foo', '_PhpScoper88fe6e0ad041\\Evenement\\Tests\\setGlobalTestData');
        $this->emitter->emit('foo', ['bar']);
