 ...
 */
namespace _PhpScoperbd5d0c5f7638\Evenement\Tests;

use _PhpScoperbd5d0c5f7638\Evenement\EventEmitter;
use InvalidArgumentException;
use _PhpScoperbd5d0c5f7638\PHPUnit\Framework\TestCase;
class EventEmitterTest extends \_PhpScoperbd5d0c5f7638\PHPUnit\Framework\TestCase
{
    private $emitter;
    public function setUp()
    {
        $this->emitter = new \_PhpScoperbd5d0c5f7638\Evenement\EventEmitter();
    }
    ...
    {
        $listener = new \_PhpScoperbd5d0c5f7638\Evenement\Tests\Listener();
        $this->emitter->on('foo', [$listener, 'onFoo']);
    }
    public function testAddListenerWithStaticMethod()
    {
        $this->emitter->on('bar', ['_PhpScoperbd5d0c5f7638\\Evenement\\Tests\\Listener', 'onBar']);
    }
    ...
    public function testCallablesStaticClass()
    {
        ...
        $this->emitter->emit('foo', ['bar']);
        self::assertSame(['bar'], \_PhpScoperbd5d0c5f7638\Evenement\Tests\Listener::getStaticData());
    }
    public function testCallablesFunction()
    {
        $this->emitter->on('foo', '_PhpScoperbd5d0c5f7638\\Evenement\\Tests\\setGlobalTestData');
        $this->emitter->emit('foo', ['bar']);
