...
final class EditorConfig
{
    ...
    private function getConfigFile(string $path) : \RectorPrefix20210507\Idiosyncratic\EditorConfig\EditorConfigFile
    {
        return $this->configFiles[$path] ?? ($this->configFiles[$path] = new \RectorPrefix20210507\Idiosyncratic\EditorConfig\EditorConfigFile($path));
    }
}
