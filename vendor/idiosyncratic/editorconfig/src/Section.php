...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20210509\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
