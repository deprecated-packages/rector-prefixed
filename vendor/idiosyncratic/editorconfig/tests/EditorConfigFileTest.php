...
class EditorConfigFileTest extends \RectorPrefix20210506\PHPUnit\Framework\TestCase
{
    public function testParseEditorConfigFile() : void
    {
        $path = __DIR__ . '/data/editorconfig';
        $file = new \RectorPrefix20210506\Idiosyncratic\EditorConfig\EditorConfigFile($path);
        $this->assertInstanceOf(\RectorPrefix20210506\Idiosyncratic\EditorConfig\EditorConfigFile::class, $file);
    ...
    public function testFileDoesNotExist() : void
    {
        ...
        $file = new \RectorPrefix20210506\Idiosyncratic\EditorConfig\EditorConfigFile(__DIR__);
    }
