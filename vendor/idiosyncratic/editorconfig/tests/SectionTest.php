...
class SectionTest extends \RectorPrefix20210507\PHPUnit\Framework\TestCase
{
    public function testGetDeclaration() : void
    {
        $section = new \RectorPrefix20210507\Idiosyncratic\EditorConfig\Section('**/', '*.php', ['indent_size' => '4', 'indent_style' => 'space'], new \RectorPrefix20210507\Idiosyncratic\EditorConfig\Declaration\Factory());
