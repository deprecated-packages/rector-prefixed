...
class UnsetDeclarationTest extends \RectorPrefix20210508\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20210508\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
