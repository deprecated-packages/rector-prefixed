...
class UnsetDeclarationTest extends \RectorPrefix20210507\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20210507\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
