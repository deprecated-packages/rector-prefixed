...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210423\Nette\Utils\Json::decode(\RectorPrefix20210423\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210423\Nette\Utils\Json::FORCE_ARRAY);
