...
final class ServiceMapFactory
{
    ...
    {
        $data = \RectorPrefix20210419\Nette\Utils\Json::decode(\RectorPrefix20210419\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210419\Nette\Utils\Json::FORCE_ARRAY);
