...
final class ServiceMapFactory
{
    ...
    {
        $data = \RectorPrefix20210331\Nette\Utils\Json::decode(\RectorPrefix20210331\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210331\Nette\Utils\Json::FORCE_ARRAY);
