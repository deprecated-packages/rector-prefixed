...
final class DefinitionAliasSetPrivateToSetPublicRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->definitionObjectTypes = [new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Symfony\\Component\\DependencyInjection\\Alias'), new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Symfony\\Component\\DependencyInjection\\Definition')];
    }
