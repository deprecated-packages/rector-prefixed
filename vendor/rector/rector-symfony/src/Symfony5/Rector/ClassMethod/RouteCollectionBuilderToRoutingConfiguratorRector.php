...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isName($firstParam->type, 'RectorPrefix20210318\\Symfony\\Component\\Routing\\RouteCollectionBuilder')) {
            return null;
        }
        $firstParam->type = new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210318\\Symfony\\Component\\Routing\\Loader\\Configurator\\RoutingConfigurator');
