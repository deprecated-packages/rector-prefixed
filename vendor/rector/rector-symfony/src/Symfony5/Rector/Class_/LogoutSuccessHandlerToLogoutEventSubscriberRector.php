...
final class LogoutSuccessHandlerToLogoutEventSubscriberRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function __construct(\Rector\Symfony5\NodeFactory\OnSuccessLogoutClassMethodFactory $onSuccessLogoutClassMethodFactory, \Rector\Symfony\NodeFactory\GetSubscribedEventsClassMethodFactory $getSubscribedEventsClassMethodFactory)
    {
        ...
        $this->successHandlerObjectType = new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Symfony\\Component\\Security\\Http\\Logout\\LogoutSuccessHandlerInterface');
    }
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $classConstFetch = $this->nodeFactory->createClassConstReference('RectorPrefix20210320\\Symfony\\Component\\Security\\Http\\Event\\LogoutEvent');
    ...
    {
        $class->implements[] = new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210320\\Symfony\\Component\\EventDispatcher\\EventSubscriberInterface');
