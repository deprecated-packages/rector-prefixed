...
use RectorPrefix20210324\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210324\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210324\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
