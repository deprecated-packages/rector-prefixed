...
use RectorPrefix20210429\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210429\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210429\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
