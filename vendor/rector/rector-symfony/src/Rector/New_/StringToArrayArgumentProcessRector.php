...
use RectorPrefix20210507\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210507\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210507\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
