...
use RectorPrefix20210420\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210420\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210420\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
    /**
     * @return void
     */
