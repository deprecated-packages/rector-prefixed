...
final class FormBuilderSetDataMapperRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->dataMapperObjectType = new \PHPStan\Type\ObjectType('RectorPrefix20210321\\Symfony\\Component\\Form\\Extension\\Core\\DataMapper\\DataMapper');
    }
...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, new \PHPStan\Type\ObjectType('RectorPrefix20210321\\Symfony\\Component\\Form\\FormConfigBuilderInterface'))) {
            return null;
        }
        ...
        $propertyPathAccessor = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210321\\Symfony\\Component\\Form\\Extension\\Core\\DataAccessor\\PropertyPathAccessor'));
