...
CODE_SAMPLE
     ...
     * @return void
     */
    private function refactorStringArgument(MethodCall $methodCall)
    {
        // swap arguments
     ...
     * @return void
     */
    private function refactorGetCallFuncCall(MethodCall $methodCall, FuncCall $funcCall, Expr $expr)
    {
