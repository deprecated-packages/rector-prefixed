...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($methodCall->var, new \PHPStan\Type\ObjectType('RectorPrefix20210321\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor'))) {
            return \true;
        }
    ...
    {
        $magicGetClassConstFetch = $this->nodeFactory->createClassConstFetch('RectorPrefix20210321\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_GET');
        $magicSetClassConstFetch = $this->nodeFactory->createClassConstFetch('RectorPrefix20210321\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_SET');
        ...
        $magicCallClassConstFetch = $this->nodeFactory->createClassConstFetch('RectorPrefix20210321\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_CALL');
