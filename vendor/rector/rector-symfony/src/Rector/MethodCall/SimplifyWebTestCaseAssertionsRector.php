...
CODE_SAMPLE
     ...
     */
    private function processAssertResponseStatusCodeSame(MethodCall $methodCall)
    {
     ...
     * @return mixed[]|null
     */
    private function matchAssertContainsCrawlerArg(MethodCall $methodCall)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function processAssertResponseRedirects(MethodCall $methodCall)
    {
