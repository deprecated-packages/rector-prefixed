...
CODE_SAMPLE
    ...
    private function isClassAndMethodMatch(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if ($this->isObjectType($classLike, new \PHPStan\Type\ObjectType('RectorPrefix20210321\\Symfony\\Component\\Form\\AbstractType'))) {
            return $this->isName($classMethod->name, 'getParent');
        }
        if ($this->isObjectType($classMethod, new \PHPStan\Type\ObjectType('RectorPrefix20210321\\Symfony\\Component\\Form\\AbstractTypeExtension'))) {
