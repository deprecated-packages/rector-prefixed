...
/**
 * @see \Rector\Tests\Symfony4\Rector\MethodCall\VarDumperTestTraitMethodArgsRector\VarDumperTestTraitMethodArgsRectorTest
 */
final class VarDumperTestTraitMethodArgsRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->isObjectType($node->var, new \PHPStan\Type\ObjectType('RectorPrefix20210318\\Symfony\\Component\\VarDumper\\Test\\VarDumperTestTrait'))) {
            return null;
        }
