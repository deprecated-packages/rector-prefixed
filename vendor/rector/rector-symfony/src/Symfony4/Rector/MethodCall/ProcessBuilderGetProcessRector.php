...
/**
 * @see \Rector\Tests\Symfony4\Rector\MethodCall\ProcessBuilderGetProcessRector\ProcessBuilderGetProcessRectorTest
 */
...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, new \PHPStan\Type\ObjectType('RectorPrefix20210319\\Symfony\\Component\\Process\\ProcessBuilder'))) {
            return null;
        }
