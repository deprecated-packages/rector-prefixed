...
final class ContainerGetToConstructorInjectionRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @var string[]
     */
    private $containerAwareParentTypes = ['RectorPrefix20210320\\Symfony\\Bundle\\FrameworkBundle\\Command\\ContainerAwareCommand', 'RectorPrefix20210320\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller'];
    /**
...
, [self::CONTAINER_AWARE_PARENT_TYPES => ['ContainerAwareParentClassName', 'ContainerAwareParentCommandClassName', 'ThisClassCallsMethodInConstructorClassName']])]);
    ...
    {
        if (!$this->isObjectType($node->var, new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Symfony\\Component\\DependencyInjection\\ContainerInterface'))) {
            return null;
        }
