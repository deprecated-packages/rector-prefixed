...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($this->isObjectType($expr, new \PHPStan\Type\ObjectType('RectorPrefix20210318\\Symfony\\Component\\Process\\Process'))) {
            return $this->processArgumentPosition($node, 0);
        }
        if ($this->isObjectType($expr, new \PHPStan\Type\ObjectType('RectorPrefix20210318\\Symfony\\Component\\Console\\Helper\\ProcessHelper'))) {
