...
final class TemplateAnnotationToThisRenderRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const RESPONSE_CLASS = 'RectorPrefix20210320\\Symfony\\Component\\HttpFoundation\\Response';
    /**
    ...
    public function __construct(\Rector\Symfony\TypeAnalyzer\ArrayUnionResponseTypeAnalyzer $arrayUnionResponseTypeAnalyzer, \Rector\NodeModifier\ReturnTypeDeclarationUpdater $returnTypeDeclarationUpdater, \Rector\Symfony\NodeFactory\ThisRenderFactory $thisRenderFactory)
    {
...
CODE_SAMPLE
    ...
    private function addAbstractControllerParentClassIfMissing(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        $class->extends = new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210320\\Symfony\\Bundle\\FrameworkBundle\\Controller\\AbstractController');
        return $class;
    }
