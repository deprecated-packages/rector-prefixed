...
final class RouteNameClassFactory
{
    ...
    {
        $classBuilder = new \RectorPrefix20210422\Symplify\Astral\ValueObject\NodeBuilder\ClassBuilder(\Rector\Symfony\ValueObject\ClassName::ROUTE_CLASS_SHORT_NAME);
        ...
        $namespaceBuilder = new \RectorPrefix20210422\Symplify\Astral\ValueObject\NodeBuilder\NamespaceBuilder($namespaceName);
