...
final class ConfigureOptionsNodeFactory
{
    ...
    public function create(array $namesToArgs) : \PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $methodBuilder = new \RectorPrefix20210506\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('configureOptions');
    ...
    {
        $paramBuilder = new \RectorPrefix20210506\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('resolver');
