...
final class BuilderFormNodeFactory
{
    ...
    public function create(\PhpParser\Node\Stmt\ClassMethod $constructorClassMethod) : \PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $classMethodBuilder = new \RectorPrefix20210319\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('buildForm');
    ...
    {
        $builderParamBuilder = new \RectorPrefix20210319\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('builder');
        $builderParamBuilder->setType(new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210319\\Symfony\\Component\\Form\\FormBuilderInterface'));
        return $builderParamBuilder->getNode();
    }
    private function createOptionsParam() : \PhpParser\Node\Param
    {
        $optionsParamBuilder = new \RectorPrefix20210319\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('options');
