...
final class ConfigureOptionsNodeFactory
{
    ...
    public function create(array $namesToArgs) : \PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $methodBuilder = new \RectorPrefix20210318\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('configureOptions');
    ...
    {
        $paramBuilder = new \RectorPrefix20210318\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('resolver');
        $paramBuilder->setType(new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210318\\Symfony\\Component\\OptionsResolver\\OptionsResolver'));
