...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\RectorPrefix20210318\Nette\Utils\Strings::endsWith($shortClassName, 'Type')) {
            $shortClassName = (string) \RectorPrefix20210318\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
        $stringy = new \RectorPrefix20210318\Stringy\Stringy($shortClassName);
    ...
    private function isObjectMethodNameMatch(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if (!$this->isObjectType($classMethod, new \PHPStan\Type\ObjectType('RectorPrefix20210318\\Symfony\\Component\\Form\\AbstractType'))) {
            return \false;
        }
