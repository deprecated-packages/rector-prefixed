...
use RectorPrefix20210318\Symfony\Component\Routing\Annotation\Route as BaseRoute;
if (\class_exists('RectorPrefix20210318\\Sensio\\Bundle\\FrameworkExtraBundle\\Configuration\\Route')) {
    return;
}
/**
 * @Annotation
 */
class Route extends \RectorPrefix20210318\Symfony\Component\Routing\Annotation\Route
{
    private $service;
