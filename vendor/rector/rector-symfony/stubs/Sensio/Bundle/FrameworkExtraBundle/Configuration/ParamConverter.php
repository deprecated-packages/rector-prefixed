...
if (\class_exists('RectorPrefix20210320\\Sensio\\Bundle\\FrameworkExtraBundle\\Configuration\\ParamConverter')) {
    return;
}
/**
 * @Annotation
*/
class ParamConverter extends \RectorPrefix20210320\Sensio\Bundle\FrameworkExtraBundle\Configuration\ConfigurationAnnotation
{
    /**
     * The parameter name.
     *
