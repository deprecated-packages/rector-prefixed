...
final class EventClassNaming
{
    ...
    public function resolveEventFileLocationFromClassNameAndFileInfo(string $className, \RectorPrefix20210428\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    {
        $namespaceAbove = \RectorPrefix20210428\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \RectorPrefix20210428\Nette\Utils\Strings::substring($property, \strlen('on'));
