...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($node, new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Nette\\DI\\ContainerBuilder'), 'expand')) {
            return null;
        }
        $args = $node->args;
        ...
        return new \PhpParser\Node\Expr\StaticCall(new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210320\\Nette\\DI\\Helpers'), 'expand', $args);
    }
}
