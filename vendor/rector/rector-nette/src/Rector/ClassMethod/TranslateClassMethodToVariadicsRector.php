...
CODE_SAMPLE
    ...
    {
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Nette\\Localization\\ITranslator'))) {
            return null;
        }
