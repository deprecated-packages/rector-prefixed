...
, [self::RENAME_METHODS => [new \Rector\Renaming\ValueObject\MethodCallRename('SomeClass', 'oldCall', 'newCall')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20210508\Webmozart\Assert\Assert::allIsInstanceOf($methodCallRenames, \Rector\Renaming\ValueObject\MethodCallRename::class);
    ...
    public function changeContent(string $content) : string
    {
        foreach ($this->methodCallRenames as $methodCallRename) {
            ...
            if (\RectorPrefix20210508\Nette\Utils\Strings::match($content, $pattern)) {
