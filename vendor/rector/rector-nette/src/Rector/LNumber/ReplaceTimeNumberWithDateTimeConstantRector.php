...
use RectorPrefix20210321\Nette\Utils\DateTime;
use PhpParser\Node;
...
final class ReplaceTimeNumberWithDateTimeConstantRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     */
    private const NUMBER_TO_CONSTANT_NAME = [\RectorPrefix20210321\Nette\Utils\DateTime::HOUR => 'HOUR', \RectorPrefix20210321\Nette\Utils\DateTime::DAY => 'DAY', \RectorPrefix20210321\Nette\Utils\DateTime::WEEK => 'WEEK', \RectorPrefix20210321\Nette\Utils\DateTime::MONTH => 'MONTH', \RectorPrefix20210321\Nette\Utils\DateTime::YEAR => 'YEAR'];
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        return $this->nodeFactory->createClassConstFetch('RectorPrefix20210321\\Nette\\Utils\\DateTime', $constantName);
    }
}
