...
/**
 * @see \Rector\Tests\Nette\Rector\MethodCall\AddNextrasDatePickerToDateControlRector\AddNextrasDatePickerToDateControlRectorTest
 */
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($node->var instanceof \PhpParser\Node\Expr\MethodCall) {
            if (!$this->isOnClassMethodCall($node->var, new \PHPStan\Type\ObjectType('RectorPrefix20210319\\Nette\\Application\\UI\\Form'), 'addDatePicker')) {
                return null;
            }
        ...
        // 2. assign call
        if (!$this->isOnClassMethodCall($node, new \PHPStan\Type\ObjectType('RectorPrefix20210319\\Nette\\Application\\UI\\Form'), 'addDatePicker')) {
            return null;
        }
    ...
    {
        $fullyQualified = new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210319\\Nextras\\FormComponents\\Controls\\DateControl');
