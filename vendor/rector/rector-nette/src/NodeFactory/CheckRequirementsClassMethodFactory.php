...
final class CheckRequirementsClassMethodFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210429\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder(self::CHECK_REQUIREMENTS_METHOD_NAME);
        $methodBuilder->makePublic();
        $paramBuilder = new \RectorPrefix20210429\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('element');
