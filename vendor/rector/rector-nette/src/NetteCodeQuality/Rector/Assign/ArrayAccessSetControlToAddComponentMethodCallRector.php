...
/**
 * @see \Rector\Tests\NetteCodeQuality\Rector\Assign\ArrayAccessSetControlToAddComponentMethodCallRector\ArrayAccessSetControlToAddComponentMethodCallRectorTest
 *
...
CODE_SAMPLE
    ...
    private function isAssignOfControlToPresenterDimFetch(\PhpParser\Node\Expr\Assign $assign) : bool
    {
        ...
        if (!$this->isObjectType($assign->expr, new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Nette\\Application\\UI\\Control'))) {
            return \false;
        }
        ...
        return $this->isObjectType($arrayDimFetch->var, new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Nette\\Application\\UI\\Presenter'));
    }
}
