...
if (\interface_exists('RectorPrefix20210319\\Nette\\ComponentModel\\IContainer')) {
    return;
}
// mimics: https://github.com/nette/component-model/blob/master/src/ComponentModel/IContainer.php
interface IContainer extends \RectorPrefix20210319\Nette\ComponentModel\IComponent
{
    /**
     * Adds the component to the container.
     * @return static
     */
    function addComponent(\RectorPrefix20210319\Nette\ComponentModel\IComponent $component, ?string $name);
    /**
     * Removes the component from the container.
     */
    function removeComponent(\RectorPrefix20210319\Nette\ComponentModel\IComponent $component) : void;
    /**
