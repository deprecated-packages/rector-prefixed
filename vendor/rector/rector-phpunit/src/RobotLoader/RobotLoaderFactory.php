...
use RectorPrefix20210506\Nette\Loaders\RobotLoader;
final class RobotLoaderFactory
{
    /**
     * @param string[] $directories
     */
    public function createFromDirectories(array $directories) : \RectorPrefix20210506\Nette\Loaders\RobotLoader
    {
        $robotLoader = new \RectorPrefix20210506\Nette\Loaders\RobotLoader();
