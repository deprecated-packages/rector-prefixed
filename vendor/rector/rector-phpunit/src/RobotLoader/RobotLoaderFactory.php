...
use RectorPrefix20210507\Nette\Loaders\RobotLoader;
final class RobotLoaderFactory
{
    /**
     * @param string[] $directories
     */
    public function createFromDirectories(array $directories) : \RectorPrefix20210507\Nette\Loaders\RobotLoader
    {
        $robotLoader = new \RectorPrefix20210507\Nette\Loaders\RobotLoader();
