...
final class TestClassResolver
{
    ...
    public function resolveFromClassName(string $className) : ?string
    {
        ...
        foreach ($phpUnitTestCaseClasses as $phpUnitTestCaseClass) {
            ...
            if (!\RectorPrefix20210506\Nette\Utils\Strings::endsWith($phpUnitTestCaseClass, '\\' . $testShortClassName)) {
                continue;
            }
    ...
    {
        return \RectorPrefix20210506\Nette\Utils\Strings::after($className, '\\', -1);
    }
    /**
     * @return string[]
     */
    ...
    {
        $namespacePart = (string) \RectorPrefix20210506\Nette\Utils\Strings::before($className, '\\', -1);
