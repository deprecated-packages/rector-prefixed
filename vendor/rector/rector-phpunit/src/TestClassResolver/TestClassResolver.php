...
final class TestClassResolver
{
    ...
    public function resolveFromClassName(string $className)
    {
        ...
        foreach ($phpUnitTestCaseClasses as $phpUnitTestCaseClass) {
            ...
            if (!\RectorPrefix20210422\Nette\Utils\Strings::endsWith($phpUnitTestCaseClass, '\\' . $testShortClassName)) {
                continue;
            }
    ...
    {
        $namespacePart = (string) \RectorPrefix20210422\Nette\Utils\Strings::before($className, '\\', -1);
