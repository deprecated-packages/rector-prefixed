...
final class ComposerAutoloadedDirectoryProvider
{
     ...
     * @var string[]
     */
    private const AUTOLOAD_SECTIONS = [\RectorPrefix20210330\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD, \RectorPrefix20210330\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV];
    /**
     * @var string
     */
    ...
    public function __construct(\RectorPrefix20210330\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210330\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210330\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
