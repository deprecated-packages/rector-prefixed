...
final class ComposerAutoloadedDirectoryProvider
{
     ...
     * @var string[]
     */
    const AUTOLOAD_SECTIONS = [\RectorPrefix20210421\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD, \RectorPrefix20210421\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV];
    /**
     * @var string
     */
    ...
    public function __construct(\RectorPrefix20210421\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210421\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210421\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
