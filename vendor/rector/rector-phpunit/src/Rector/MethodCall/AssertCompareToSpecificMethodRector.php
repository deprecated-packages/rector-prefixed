...
final class AssertCompareToSpecificMethodRector extends AbstractRector
{
     ...
     * @return \PhpParser\Node|null
     */
    private function processFuncCallArgumentValue(Node $node, FuncCall $funcCall, Arg $requiredArg)
    {
     ...
     * @return void
     */
    private function renameMethod(Node $node, FunctionNameWithAssertMethods $functionNameWithAssertMethods)
    {
     ...
     * @return void
     */
    private function moveFunctionArgumentsUp(Node $node, FuncCall $funcCall, Arg $requiredArg)
    {
