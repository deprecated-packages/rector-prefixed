...
CODE_SAMPLE
     ...
     * @return void
     */
    private function processAssertEqualsIgnoringCase(Node $node)
    {
     ...
     * @return void
     */
    private function processAssertEqualsCanonicalizing(Node $node)
    {
     ...
     * @return void
     */
    private function processAssertEqualsWithDelta(Node $node)
    {
