...
CODE_SAMPLE
    ...
    private function renameDataProviderAnnotationsAndCollectRenamedMethods(\PhpParser\Node\Stmt\Class_ $class) : void
    {
        foreach ($class->getMethods() as $classMethod) {
            ...
            foreach ($phpunitDataProviderTagValueNodes as $phpunitDataProviderTagValueNode) {
                ...
                if (!\RectorPrefix20210327\Nette\Utils\Strings::startsWith($oldMethodName, 'test')) {
                    continue;
                }
    ...
    {
        $newMethodName = \RectorPrefix20210327\Nette\Utils\Strings::substring($oldMethodName, \strlen('test'));
