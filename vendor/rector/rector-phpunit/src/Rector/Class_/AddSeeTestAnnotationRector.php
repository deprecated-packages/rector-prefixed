...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210415\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210415\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
