...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210404\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210404\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
