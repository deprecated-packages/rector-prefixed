...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210331\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210331\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
