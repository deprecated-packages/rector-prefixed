...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210508\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210508\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
