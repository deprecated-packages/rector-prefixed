...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210409\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210409\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
