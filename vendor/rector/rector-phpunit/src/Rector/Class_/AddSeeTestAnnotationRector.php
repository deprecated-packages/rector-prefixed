...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210326\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210326\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
