...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210507\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210507\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
