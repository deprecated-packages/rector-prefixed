...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210424\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210424\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
