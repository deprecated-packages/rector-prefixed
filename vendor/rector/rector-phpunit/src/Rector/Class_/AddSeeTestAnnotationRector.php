...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210410\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210410\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
