...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210322\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210322\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
