...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210323\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210323\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
