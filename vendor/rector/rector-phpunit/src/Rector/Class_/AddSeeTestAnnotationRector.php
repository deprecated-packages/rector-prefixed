...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210502\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210502\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
