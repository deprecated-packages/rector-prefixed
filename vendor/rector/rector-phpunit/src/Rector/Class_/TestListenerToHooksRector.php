...
final class TestListenerToHooksRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    private const LISTENER_METHOD_TO_HOOK_INTERFACES = [
        'addIncompleteTest' => ['RectorPrefix20210319\\PHPUnit\\Runner\\AfterIncompleteTestHook', 'executeAfterIncompleteTest'],
        'addRiskyTest' => ['RectorPrefix20210319\\PHPUnit\\Runner\\AfterRiskyTestHook', 'executeAfterRiskyTest'],
        'addSkippedTest' => ['RectorPrefix20210319\\PHPUnit\\Runner\\AfterSkippedTestHook', 'executeAfterSkippedTest'],
        'addError' => ['RectorPrefix20210319\\PHPUnit\\Runner\\AfterTestErrorHook', 'executeAfterTestError'],
        'addFailure' => ['RectorPrefix20210319\\PHPUnit\\Runner\\AfterTestFailureHook', 'executeAfterTestFailure'],
        'addWarning' => ['RectorPrefix20210319\\PHPUnit\\Runner\\AfterTestWarningHook', 'executeAfterTestWarning'],
        # test
        'startTest' => ['RectorPrefix20210319\\PHPUnit\\Runner\\BeforeTestHook', 'executeBeforeTest'],
        'endTest' => ['RectorPrefix20210319\\PHPUnit\\Runner\\AfterTestHook', 'executeAfterTest'],
        # suite
        'startTestSuite' => ['RectorPrefix20210319\\PHPUnit\\Runner\\BeforeFirstTestHook', 'executeBeforeFirstTest'],
        'endTestSuite' => ['RectorPrefix20210319\\PHPUnit\\Runner\\AfterLastTestHook', 'executeAfterLastTest'],
    ];
...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, new \PHPStan\Type\ObjectType('RectorPrefix20210319\\PHPUnit\\Framework\\TestListener'))) {
            return null;
        }
        foreach ($node->implements as $implement) {
            if ($this->isName($implement, 'RectorPrefix20210319\\PHPUnit\\Framework\\TestListener')) {
