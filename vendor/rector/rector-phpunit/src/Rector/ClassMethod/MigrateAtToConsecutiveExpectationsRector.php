...
CODE_SAMPLE
     ...
     * @return void
     */
    private function fillMissingAtIndexes(ExpectationMockCollection $expectationMockCollection)
    {
     ...
     * @return void
     */
    private function replaceExpectationNodes(ExpectationMockCollection $expectationMockCollection)
    {
