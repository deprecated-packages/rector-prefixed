...
CODE_SAMPLE
    ...
    private function shouldSkipClassMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if ($phpDocInfo->hasByTypes([\Rector\PHPUnit\PhpDoc\Node\PHPUnitDoesNotPerformAssertionTagNode::class, \Rector\PHPUnit\PhpDoc\Node\PHPUnitExpectedExceptionTagValueNode::class])) {
            return \true;
        }
    ...
    private function findClassMethodInFile(string $fileName, string $methodName) : ?\PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $smartFileInfo = new \RectorPrefix20210325\Symplify\SmartFileSystem\SmartFileInfo($fileName);
