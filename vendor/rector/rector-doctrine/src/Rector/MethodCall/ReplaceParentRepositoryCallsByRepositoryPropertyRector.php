...
CODE_SAMPLE
    ...
    private function resolveRepositoryName(\PhpParser\Node\Expr $expr) : string
    {
        ...
        $lastNamePart = (string) \RectorPrefix20210414\Nette\Utils\Strings::after($entityReferenceName, '\\', -1);
    ...
    private function guessRepositoryType(\PhpParser\Node\Expr $expr) : string
    {
        if ($expr instanceof \PhpParser\Node\Expr\ClassConstFetch) {
            ...
            $entityClassNamespace = (string) \RectorPrefix20210414\Nette\Utils\Strings::before($entityClass, '\\', -2);
            $lastNamePart = (string) \RectorPrefix20210414\Nette\Utils\Strings::after($entityClass, '\\', -1);
