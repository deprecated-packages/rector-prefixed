...
CODE_SAMPLE
     ...
     * @return void
     */
    private function removeBlameablePropertiesAndMethods(Class_ $class)
    {
     ...
     * @return void
     */
    private function removeSetterAndGetterByPropertyNames(Class_ $class, array $removedPropertyNames)
    {
