...
CODE_SAMPLE
     ...
     * @return void
     */
    private function removeSetAndGetMethods(Class_ $class, array $removedPropertyNames)
    {
     ...
     * @return void
     */
    private function dumpEntityTranslation(Class_ $class, array $translatedPropertyToPhpDocInfos)
    {
