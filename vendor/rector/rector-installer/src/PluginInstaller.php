...
CODE_SAMPLE;
    ...
    public function __construct(\Rector\RectorInstaller\Filesystem $filesystem, \Composer\Repository\InstalledRepositoryInterface $localRepository, \Composer\IO\IOInterface $io, \Composer\Installer\InstallationManager $installationManager, \Composer\Util\Filesystem $composerFilesystem, string $configurationFile)
    {
    ...
    private function shouldSkip(\Composer\Package\PackageInterface $package) : bool
    {
