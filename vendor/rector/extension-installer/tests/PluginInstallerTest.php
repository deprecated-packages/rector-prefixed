...
use RectorPrefix20210509\Composer\Installer\InstallationManager;
use RectorPrefix20210509\Composer\IO\IOInterface;
use RectorPrefix20210509\Composer\Package\PackageInterface;
use RectorPrefix20210509\Composer\Repository\InstalledRepositoryInterface;
use RectorPrefix20210509\PHPUnit\Framework\TestCase;
use RectorPrefix20210509\Prophecy\Argument;
use RectorPrefix20210509\Prophecy\PhpUnit\ProphecyTrait;
use RectorPrefix20210509\Prophecy\Prophecy\ObjectProphecy;
use Rector\RectorInstaller\Filesystem;
use Rector\RectorInstaller\PluginInstaller;
/**
 * @covers PluginInstaller
 */
final class PluginInstallerTest extends \RectorPrefix20210509\PHPUnit\Framework\TestCase
{
    use ProphecyTrait;
    /**
     * @var string
    ...
    protected function setUp() : void
    {
        ...
        $this->composerFilesystem = $this->prophesize(\RectorPrefix20210509\Composer\Util\Filesystem::class);
        ...
        $this->localRepository = $this->prophesize(\RectorPrefix20210509\Composer\Repository\InstalledRepositoryInterface::class);
        $this->io = $this->prophesize(\RectorPrefix20210509\Composer\IO\IOInterface::class);
        $this->installationManager = $this->prophesize(\RectorPrefix20210509\Composer\Installer\InstallationManager::class);
    ...
    public function testNoRectorPackagesInstalled() : void
    {
        ...
        $this->filesystem->writeFile($this->configurationFile, \RectorPrefix20210509\Prophecy\Argument::any())->shouldNotBeCalled();
        $this->filesystem->hashEquals(self::FILE_HASH, \RectorPrefix20210509\Prophecy\Argument::any())->willReturn(\true);
        $this->pluginInstaller->install();
    }
    public function testPackagesInstalled() : void
    {
        $rectorExtensionPackage = $this->prophesize(\RectorPrefix20210509\Composer\Package\PackageInterface::class);
        ...
        $nonRectorExtensionPackage = $this->prophesize(\RectorPrefix20210509\Composer\Package\PackageInterface::class);
        $nonRectorExtensionPackageWithExtra = $this->prophesize(\RectorPrefix20210509\Composer\Package\PackageInterface::class);
        ...
        $this->filesystem->hashEquals(self::FILE_HASH, \RectorPrefix20210509\Prophecy\Argument::any())->willReturn(\false);
        $this->filesystem->writeFile($this->configurationFile, \RectorPrefix20210509\Prophecy\Argument::any())->shouldBeCalledOnce();
