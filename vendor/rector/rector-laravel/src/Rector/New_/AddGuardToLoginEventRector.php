...
final class AddGuardToLoginEventRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('RectorPrefix20210319\\Add new $guard argument to Illuminate\\Auth\\Events\\Login', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->isName($node->class, 'RectorPrefix20210319\\Illuminate\\Auth\\Events\\Login')) {
            return null;
        }
