...
CODE_SAMPLE
     ...
     */
    private function processArgumentOnPosition(Node $node, Expr $argExpr, int $argumentPosition)
    {
     ...
     * @return void
     */
    private function refactorClassConstFetch(ClassConstFetch $classConstFetch)
    {
