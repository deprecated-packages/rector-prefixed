...
final class Redirect301ToPermanentRedirectRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->routerObjectTypes = [new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Illuminate\\Support\\Facades\\Route'), new \PHPStan\Type\ObjectType('RectorPrefix20210320\\Illuminate\\Routing\\Route')];
    }
