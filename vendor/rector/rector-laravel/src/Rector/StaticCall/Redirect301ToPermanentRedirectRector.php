...
final class Redirect301ToPermanentRedirectRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->routerObjectTypes = [new \PHPStan\Type\ObjectType('RectorPrefix20210319\\Illuminate\\Support\\Facades\\Route'), new \PHPStan\Type\ObjectType('RectorPrefix20210319\\Illuminate\\Routing\\Route')];
    }
