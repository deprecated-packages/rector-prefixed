...
return static function (\RectorPrefix20210321\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Rector\Transform\Rector\Expression\MethodCallToReturnRector::class)->call('configure', [[\Rector\Transform\Rector\Expression\MethodCallToReturnRector::METHOD_CALL_WRAPS => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Transform\ValueObject\MethodCallToReturn('RectorPrefix20210321\\Illuminate\\Auth\\Access\\HandlesAuthorization', 'deny')])]]);
    ...
    $services->set(\Rector\Renaming\Rector\MethodCall\RenameMethodRector::class)->call('configure', [[\Rector\Renaming\Rector\MethodCall\RenameMethodRector::METHOD_CALL_RENAMES => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Renaming\ValueObject\MethodCallRename(
        'RectorPrefix20210321\\Illuminate\\Auth\\Access\\Gate',
        ...
        'RectorPrefix20210321\\Illuminate\\Support\\Facades\\Lang',
        # https://github.com/laravel/framework/commit/efbe23c4116f86846ad6edc0d95cd56f4175a446
        'trans',
        'get'
    ), new \Rector\Renaming\ValueObject\MethodCallRename('RectorPrefix20210321\\Illuminate\\Support\\Facades\\Lang', 'transChoice', 'choice'), new \Rector\Renaming\ValueObject\MethodCallRename(
        'RectorPrefix20210321\\Illuminate\\Translation\\Translator',
    ...
    $configuration = [
        ...
        new \Rector\Renaming\ValueObject\RenameStaticMethod('RectorPrefix20210321\\Illuminate\\Support\\Facades\\Input', 'get', 'RectorPrefix20210321\\Illuminate\\Support\\Facades\\Request', 'input'),
    ];
    ...
    $services->set(\Rector\Renaming\Rector\Name\RenameClassRector::class)->call('configure', [[\Rector\Renaming\Rector\Name\RenameClassRector::OLD_TO_NEW_CLASSES => ['RectorPrefix20210321\\Illuminate\\Support\\Facades\\Input' => 'RectorPrefix20210321\\Illuminate\\Support\\Facades\\Request']]]);
    $services->set(\Rector\Visibility\Rector\ClassMethod\ChangeMethodVisibilityRector::class)->call('configure', [[\Rector\Visibility\Rector\ClassMethod\ChangeMethodVisibilityRector::METHOD_VISIBILITIES => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Visibility\ValueObject\ChangeMethodVisibility('RectorPrefix20210321\\Illuminate\\Foundation\\Http\\FormRequest', 'validationData', \Rector\Core\ValueObject\Visibility::PUBLIC)])]]);
    $services->set(\Rector\Arguments\Rector\ClassMethod\ArgumentAdderRector::class)->call('configure', [[\Rector\Arguments\Rector\ClassMethod\ArgumentAdderRector::ADDED_ARGUMENTS => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([
        ...
        new \Rector\Arguments\ValueObject\ArgumentAdder('RectorPrefix20210321\\Illuminate\\Database\\Capsule\\Manager', 'table', 1, 'as', 'null'),
        new \Rector\Arguments\ValueObject\ArgumentAdder('RectorPrefix20210321\\Illuminate\\Database\\Connection', 'table', 1, 'as', 'null'),
        new \Rector\Arguments\ValueObject\ArgumentAdder('RectorPrefix20210321\\Illuminate\\Database\\ConnectionInterface', 'table', 1, 'as', 'null'),
        new \Rector\Arguments\ValueObject\ArgumentAdder('RectorPrefix20210321\\Illuminate\\Database\\Query\\Builder', 'from', 1, 'as', 'null'),
    ])]]);
};
