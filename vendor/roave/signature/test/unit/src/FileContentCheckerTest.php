 ...
 */
final class FileContentCheckerTest extends \_PhpScoper26e51eeacccf\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        parent::setUp();
        $this->encoder = $this->createMock(\_PhpScoper26e51eeacccf\Roave\Signature\Encoder\EncoderInterface::class);
    }
    public function testShouldCheckClassFileContent()
    {
        ...
        $checker = new \_PhpScoper26e51eeacccf\Roave\Signature\FileContentChecker(new \_PhpScoper26e51eeacccf\Roave\Signature\Encoder\Base64Encoder());
    ...
    public function testShouldReturnFalseIfSignatureDoesNotMatch()
    {
        ...
        $checker = new \_PhpScoper26e51eeacccf\Roave\Signature\FileContentChecker($this->encoder);
