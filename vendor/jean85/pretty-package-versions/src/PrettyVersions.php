...
class PrettyVersions
{
    ...
    public static function getVersion(string $packageName) : \RectorPrefix20210314\Jean85\Version
    {
        ...
        return new \RectorPrefix20210314\Jean85\Version($packageName, \Composer\InstalledVersions::getPrettyVersion($packageName), \Composer\InstalledVersions::getReference($packageName));
    }
    ...
    {
        return new \RectorPrefix20210314\Jean85\Version(self::getRootPackageName(), \Composer\InstalledVersions::getRootPackage()['pretty_version'], \Composer\InstalledVersions::getRootPackage()['reference']);
    }
}
