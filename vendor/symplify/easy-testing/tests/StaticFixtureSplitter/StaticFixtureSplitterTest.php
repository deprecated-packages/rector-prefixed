...
namespace RectorPrefix20210508\Symplify\EasyTesting\Tests\StaticFixtureSplitter;
...
final class StaticFixtureSplitterTest extends \RectorPrefix20210508\PHPUnit\Framework\TestCase
{
    public function test() : void
    {
        $fileInfo = new \Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/simple_fixture.php.inc');
        $inputAndExpected = \RectorPrefix20210508\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToInputAndExpected($fileInfo);
    ...
    public function testSplitFileInfoToLocalInputAndExpected() : void
    {
        ...
        $inputFileInfoAndExpected = \RectorPrefix20210508\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($fileInfo);
