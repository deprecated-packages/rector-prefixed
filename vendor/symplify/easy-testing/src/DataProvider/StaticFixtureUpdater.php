...
{
    public static function updateFixtureContent(\RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, string $changedContent, \RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
    ...
    public static function updateExpectedFixtureContent(string $newOriginalContent, \RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $expectedFixtureFileInfo) : void
    {
        if (!\getenv('UPDATE_TESTS') && !\getenv('UT')) {
            return;
        }
