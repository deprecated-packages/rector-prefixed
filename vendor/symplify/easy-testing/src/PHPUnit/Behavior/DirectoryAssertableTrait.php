...
namespace RectorPrefix20210217\Symplify\EasyTesting\PHPUnit\Behavior;

use RectorPrefix20210217\Symfony\Component\Finder\Finder;
use RectorPrefix20210217\Symplify\EasyTesting\ValueObject\ExpectedAndOutputFileInfoPair;
...
trait DirectoryAssertableTrait
{
    ...
    {
        $firstDirectoryFinder = new \RectorPrefix20210217\Symfony\Component\Finder\Finder();
        $firstDirectoryFinder->files()->in($directory);
        $finderSanitizer = new \RectorPrefix20210217\Symplify\SmartFileSystem\Finder\FinderSanitizer();
    ...
    private function groupFileInfosByRelativeFilePath(array $expectedFileInfos, string $expectedDirectory, array $outputFileInfos, string $outputDirectory) : array
    {
        ...
        foreach ($expectedFileInfos as $expectedFileInfo) {
            ...
            $fileInfosByRelativeFilePath[$relativeFilePath] = new \RectorPrefix20210217\Symplify\EasyTesting\ValueObject\ExpectedAndOutputFileInfoPair($expectedFileInfo, $outputFileInfo);
        }
     ...
     */
    private function resolveFileInfoByRelativeFilePath(array $fileInfos, string $directory, string $desiredRelativeFilePath) : ?\RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo
    {
