...
final class MissplacedSkipPrefixResolver
{
    ...
    public function resolve(array $fixtureFileInfos) : array
    {
        ...
        foreach ($fixtureFileInfos as $fixtureFileInfo) {
            ...
            $hasSplitLine = (bool) \RectorPrefix20210502\Nette\Utils\Strings::match($fileContents, \RectorPrefix20210502\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
