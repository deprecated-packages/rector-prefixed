...
namespace RectorPrefix20210422\Symplify\EasyTesting\ValueObject;
...
final class ExpectedAndOutputFileInfoPair
{
     ...
     */
    public function __construct(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo) {
