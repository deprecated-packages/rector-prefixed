...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\RectorPrefix20210311\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\RectorPrefix20210311\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \RectorPrefix20210311\Symplify\SmartFileSystem\SmartFileInfo) {
