...
namespace RectorPrefix20210131\Symplify\EasyTesting\ValueObject;
...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\RectorPrefix20210131\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\RectorPrefix20210131\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \RectorPrefix20210131\Symplify\SmartFileSystem\SmartFileInfo) {
