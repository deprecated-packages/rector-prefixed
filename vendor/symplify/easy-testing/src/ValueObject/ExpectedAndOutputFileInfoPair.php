...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\RectorPrefix20210313\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\RectorPrefix20210313\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \RectorPrefix20210313\Symplify\SmartFileSystem\SmartFileInfo) {
