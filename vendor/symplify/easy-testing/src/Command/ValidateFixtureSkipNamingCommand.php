...
namespace RectorPrefix20210116\Symplify\EasyTesting\Command;
...
use RectorPrefix20210116\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20210116\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20210116\Symplify\EasyTesting\ValueObject\Option;
...
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20210116\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20210116\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20210116\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\RectorPrefix20210116\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20210116\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20210116\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20210116\Symplify\EasyTesting\ValueObject\Option::SOURCE);
