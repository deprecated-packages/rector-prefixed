...
namespace RectorPrefix20210317\Symplify\EasyTesting\Command;
...
use RectorPrefix20210317\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20210317\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20210317\Symplify\EasyTesting\ValueObject\Option;
...
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20210317\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    {
        $this->addArgument(\RectorPrefix20210317\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20210317\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20210317\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20210317\Symplify\EasyTesting\ValueObject\Option::SOURCE);
