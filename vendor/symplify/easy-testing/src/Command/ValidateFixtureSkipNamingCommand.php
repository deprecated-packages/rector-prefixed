...
namespace RectorPrefix20210408\Symplify\EasyTesting\Command;
...
use RectorPrefix20210408\Symplify\EasyTesting\ValueObject\Option;
use RectorPrefix20210408\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
use RectorPrefix20210408\Symplify\PackageBuilder\Console\ShellCode;
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20210408\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20210408\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20210408\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\RectorPrefix20210408\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20210408\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20210408\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20210408\Symplify\EasyTesting\ValueObject\Option::SOURCE);
