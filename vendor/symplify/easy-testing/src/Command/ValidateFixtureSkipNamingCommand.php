...
namespace RectorPrefix20210130\Symplify\EasyTesting\Command;
...
use RectorPrefix20210130\Symplify\EasyTesting\ValueObject\Option;
...
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20210130\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20210130\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20210130\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\RectorPrefix20210130\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20210130\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20210130\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20210130\Symplify\EasyTesting\ValueObject\Option::SOURCE);
