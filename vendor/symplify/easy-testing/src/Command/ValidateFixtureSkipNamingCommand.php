...
namespace RectorPrefix20210312\Symplify\EasyTesting\Command;
...
use RectorPrefix20210312\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20210312\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20210312\Symplify\EasyTesting\ValueObject\Option;
use RectorPrefix20210312\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
use RectorPrefix20210312\Symplify\PackageBuilder\Console\ShellCode;
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20210312\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20210312\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20210312\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\RectorPrefix20210312\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20210312\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20210312\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20210312\Symplify\EasyTesting\ValueObject\Option::SOURCE);
