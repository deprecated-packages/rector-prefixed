...
namespace RectorPrefix20210504\Symplify\EasyTesting\Finder;
...
final class FixtureFinder
{
    ...
    public function __construct(\RectorPrefix20210504\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer)
    {
