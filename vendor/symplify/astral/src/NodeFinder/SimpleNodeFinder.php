...
namespace RectorPrefix20210331\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use PhpParser\NodeFinder;
use RectorPrefix20210331\Symplify\Astral\ValueObject\CommonAttributeKey;
...
final class SimpleNodeFinder
{
     ...
     */
    private $nodeFinder;
    public function __construct(\RectorPrefix20210331\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \PhpParser\NodeFinder $nodeFinder)
    {
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20210331\Symplify\Astral\ValueObject\CommonAttributeKey::PARENT);
        while ($node) {
