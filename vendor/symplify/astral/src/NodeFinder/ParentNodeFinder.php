...
namespace RectorPrefix20210308\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use RectorPrefix20210308\Symplify\Astral\ValueObject\CommonAttributeKey;
...
final class ParentNodeFinder
{
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20210308\Symplify\Astral\ValueObject\CommonAttributeKey::PARENT);
        while ($node) {
