...
namespace RectorPrefix20210117\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use RectorPrefix20210117\Symplify\Astral\ValueObject\CommonAttributeKey;
...
final class ParentNodeFinder
{
     ...
     */
    private $typeChecker;
    public function __construct(\RectorPrefix20210117\Symplify\PackageBuilder\Php\TypeChecker $typeChecker)
    {
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20210117\Symplify\Astral\ValueObject\CommonAttributeKey::PARENT);
        while ($node) {
