...
namespace RectorPrefix20210303\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use RectorPrefix20210303\Symplify\Astral\ValueObject\CommonAttributeKey;
...
final class ParentNodeFinder
{
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20210303\Symplify\Astral\ValueObject\CommonAttributeKey::PARENT);
        while ($node) {
