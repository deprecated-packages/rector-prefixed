...
namespace RectorPrefix20210119\Symplify\Astral\Naming;
...
use RectorPrefix20210119\Symplify\Astral\Contract\NodeNameResolverInterface;
/**
...
final class SimpleNameResolver
{
    ...
    public function isName($node, string $desiredName) : bool
    {
        ...
        if (\RectorPrefix20210119\Nette\Utils\Strings::contains($desiredName, '*')) {
    ...
    public function getShortClassName(string $className) : string
    {
        ...
        return (string) \RectorPrefix20210119\Nette\Utils\Strings::after($className, '\\', -1);
    }
    ...
    public function isNameMatch(\PhpParser\Node $node, string $desiredNameRegex) : bool
    {
        ...
        return (bool) \RectorPrefix20210119\Nette\Utils\Strings::match($name, $desiredNameRegex);
    }
