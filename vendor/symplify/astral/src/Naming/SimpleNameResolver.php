...
final class SimpleNameResolver
{
     ...
     * @return string|null
     */
    public function resolveShortNameFromNode(ClassLike $classLike)
    {
     ...
     * @return string|null
     */
    public function resolveShortNameFromScope(Scope $scope)
    {
     ...
     * @return string|null
     */
    public function getClassNameFromScope(Scope $scope)
    {
        if ($scope->isInTrait()) {
