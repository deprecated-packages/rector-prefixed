...
return static function (\RectorPrefix20210502\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $parameters->set(\RectorPrefix20210502\Symplify\Skipper\ValueObject\Option::SKIP, [
        ...
        '*\\SomeSkipped\\*',
        // elements
        \RectorPrefix20210502\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\FifthElement::class,
        \RectorPrefix20210502\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\SixthSense::class,
    ]);
};
