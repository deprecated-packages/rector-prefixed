...
namespace RectorPrefix20210109\Symplify\Skipper\Tests\Skipper\Skipper;
...
use RectorPrefix20210109\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\FifthElement;
use RectorPrefix20210109\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\SixthSense;
use RectorPrefix20210109\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\ThreeMan;
use RectorPrefix20210109\Symplify\SmartFileSystem\SmartFileInfo;
final class SkipperTest extends \RectorPrefix20210109\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var Skipper
     */
    ...
    {
        $smartFileInfo = new \RectorPrefix20210109\Symplify\SmartFileSystem\SmartFileInfo($filePath);
    ...
    {
        (yield [\RectorPrefix20210109\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\ThreeMan::class, \false]);
        (yield [\RectorPrefix20210109\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\SixthSense::class, \true]);
        (yield [new \RectorPrefix20210109\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\FifthElement(), \true]);
    }
}
