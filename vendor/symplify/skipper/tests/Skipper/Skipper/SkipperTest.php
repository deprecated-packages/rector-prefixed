...
namespace RectorPrefix20201229\Symplify\Skipper\Tests\Skipper\Skipper;
...
use RectorPrefix20201229\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\ThreeMan;
use RectorPrefix20201229\Symplify\SmartFileSystem\SmartFileInfo;
final class SkipperTest extends \RectorPrefix20201229\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var Skipper
     */
    ...
    {
        $smartFileInfo = new \RectorPrefix20201229\Symplify\SmartFileSystem\SmartFileInfo($filePath);
    ...
    {
        (yield [\RectorPrefix20201229\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\ThreeMan::class, \false]);
        (yield [\RectorPrefix20201229\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\SixthSense::class, \true]);
        (yield [new \RectorPrefix20201229\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\FifthElement(), \true]);
    }
}
