...
namespace RectorPrefix20210210\Symplify\Skipper\Tests\FileSystem;
...
final class PathNormalizerTest extends \RectorPrefix20210210\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var PathNormalizer
     */
    ...
    {
        $this->bootKernel(\RectorPrefix20210210\Symplify\Skipper\HttpKernel\SkipperKernel::class);
        $this->pathNormalizer = $this->getService(\RectorPrefix20210210\Symplify\Skipper\FileSystem\PathNormalizer::class);
    }
    /**
