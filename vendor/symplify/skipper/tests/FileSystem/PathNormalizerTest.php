...
namespace _PhpScoperb75b35f52b74\Symplify\Skipper\Tests\FileSystem;
...
final class PathNormalizerTest extends \_PhpScoperb75b35f52b74\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var PathNormalizer
     */
    ...
    {
        $this->bootKernel(\_PhpScoperb75b35f52b74\Symplify\Skipper\HttpKernel\SkipperKernel::class);
        $this->pathNormalizer = $this->getService(\_PhpScoperb75b35f52b74\Symplify\Skipper\FileSystem\PathNormalizer::class);
    }
    /**
