...
namespace RectorPrefix20210509\Symplify\Skipper\Tests\FileSystem;

use Iterator;
use RectorPrefix20210509\Symplify\PackageBuilder\Testing\AbstractKernelTestCase;
use RectorPrefix20210509\Symplify\Skipper\FileSystem\PathNormalizer;
use RectorPrefix20210509\Symplify\Skipper\HttpKernel\SkipperKernel;
final class PathNormalizerTest extends \RectorPrefix20210509\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var PathNormalizer
     */
    ...
    {
        $this->bootKernel(\RectorPrefix20210509\Symplify\Skipper\HttpKernel\SkipperKernel::class);
        $this->pathNormalizer = $this->getService(\RectorPrefix20210509\Symplify\Skipper\FileSystem\PathNormalizer::class);
    }
    /**
