...
namespace RectorPrefix20210308\Symplify\Skipper\Tests\FileSystem;
...
final class PathNormalizerTest extends \RectorPrefix20210308\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var PathNormalizer
     */
    ...
    {
        $this->bootKernel(\RectorPrefix20210308\Symplify\Skipper\HttpKernel\SkipperKernel::class);
        $this->pathNormalizer = $this->getService(\RectorPrefix20210308\Symplify\Skipper\FileSystem\PathNormalizer::class);
    }
    /**
