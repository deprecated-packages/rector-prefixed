...
use RectorPrefix20210503\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver;
use RectorPrefix20210503\Symplify\Skipper\Skipper\OnlySkipper;
use RectorPrefix20210503\Symplify\Skipper\Skipper\SkipSkipper;
use RectorPrefix20210503\Symplify\Skipper\ValueObject\Option;
use Symplify\SmartFileSystem\SmartFileInfo;
final class ClassSkipVoter implements \RectorPrefix20210503\Symplify\Skipper\Contract\SkipVoterInterface
{
    /**
    ...
    public function __construct(\RectorPrefix20210503\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker $classLikeExistenceChecker, \RectorPrefix20210503\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210503\Symplify\Skipper\Skipper\SkipSkipper $skipSkipper, \RectorPrefix20210503\Symplify\Skipper\Skipper\OnlySkipper $onlySkipper, \RectorPrefix20210503\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver $skippedClassResolver)
    {
    ...
    {
        $only = $this->parameterProvider->provideArrayParameter(\RectorPrefix20210503\Symplify\Skipper\ValueObject\Option::ONLY);
