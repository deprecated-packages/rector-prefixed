...
namespace RectorPrefix20201229\Symplify\Skipper\SkipCriteriaResolver;
...
final class SkippedPathsResolver
{
    ...
    public function __construct(\RectorPrefix20201229\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20201229\Symplify\SmartFileSystem\Normalizer\PathNormalizer $pathNormalizer)
    {
    ...
    public function resolve() : array
    {
        ...
        $skip = $this->parameterProvider->provideArrayParameter(\RectorPrefix20201229\Symplify\Skipper\ValueObject\Option::SKIP);
        foreach ($skip as $key => $value) {
            ...
            if (\RectorPrefix20201229\Nette\Utils\Strings::contains($value, '*')) {
                $this->skippedPaths[] = $this->pathNormalizer->normalizePath($value);
                continue;
            }
        }
