...
namespace RectorPrefix20210306\Symplify\Skipper\SkipCriteriaResolver;
...
final class SkippedPathsResolver
{
    ...
    public function __construct(\RectorPrefix20210306\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210306\Symplify\SmartFileSystem\Normalizer\PathNormalizer $pathNormalizer)
    {
    ...
    public function resolve() : array
    {
        ...
        $skip = $this->parameterProvider->provideArrayParameter(\RectorPrefix20210306\Symplify\Skipper\ValueObject\Option::SKIP);
        foreach ($skip as $key => $value) {
            ...
            if (\RectorPrefix20210306\Nette\Utils\Strings::contains($value, '*')) {
                $this->skippedPaths[] = $this->pathNormalizer->normalizePath($value);
                continue;
            }
        }
