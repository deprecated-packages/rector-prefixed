...
final class SkippedPathsResolver
{
    ...
    public function __construct(\RectorPrefix20210121\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210121\Symplify\SmartFileSystem\Normalizer\PathNormalizer $pathNormalizer)
    {
    ...
    public function resolve() : array
    {
        ...
        foreach ($skip as $key => $value) {
            ...
            if (\RectorPrefix20210121\Nette\Utils\Strings::contains($value, '*')) {
                $this->skippedPaths[] = $this->pathNormalizer->normalizePath($value);
                continue;
            }
        }
