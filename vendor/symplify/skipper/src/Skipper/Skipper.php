...
namespace RectorPrefix20210212\Symplify\Skipper\Skipper;
...
final class Skipper
{
    ...
    {
        $fileInfo = new \RectorPrefix20210212\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
        return $this->shouldSkipElementAndFileInfo($element, $fileInfo);
    }
    public function shouldSkipFileInfo(\RectorPrefix20210212\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
     ...
     * @param string|object $element
     */
    public function shouldSkipElementAndFileInfo($element, \RectorPrefix20210212\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
