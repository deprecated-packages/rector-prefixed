...
namespace RectorPrefix20210423\Symplify\Skipper\Skipper;
...
final class Skipper
{
    ...
    {
        $fileInfo = new \RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
        return $this->shouldSkipElementAndFileInfo($element, $fileInfo);
    }
    public function shouldSkipFileInfo(\RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
     ...
     * @param string|object $element
     */
    public function shouldSkipElementAndFileInfo($element, \RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
