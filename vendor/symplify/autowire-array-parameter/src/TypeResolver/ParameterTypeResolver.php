...
namespace RectorPrefix20210223\Symplify\AutowireArrayParameter\TypeResolver;

use RectorPrefix20210223\Nette\Utils\Reflection;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\RectorPrefix20210223\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \RectorPrefix20210223\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringClassReflection);
