...
namespace RectorPrefix20210320\Symplify\AutowireArrayParameter\TypeResolver;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\RectorPrefix20210320\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \RectorPrefix20210320\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
