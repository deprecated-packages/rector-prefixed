...
namespace RectorPrefix20210412\Symplify\AutowireArrayParameter\TypeResolver;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\RectorPrefix20210412\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \RectorPrefix20210412\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
