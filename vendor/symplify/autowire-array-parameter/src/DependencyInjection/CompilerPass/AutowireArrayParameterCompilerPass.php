...
namespace _PhpScopere8e811afab72\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass;
...
use _PhpScopere8e811afab72\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder;
/**
 * @inspiration https://github.com/nette/di/pull/178
 * Not final just for BC with previous class location
 * @see \Symplify\AutowireArrayParameter\Tests\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPassTest
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScopere8e811afab72\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScopere8e811afab72\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScopere8e811afab72\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScopere8e811afab72\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScopere8e811afab72\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScopere8e811afab72\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScopere8e811afab72\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScopere8e811afab72\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScopere8e811afab72\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    {
        $this->definitionFinder = new \_PhpScopere8e811afab72\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder();
    ...
    private function shouldSkipDefinition(\_PhpScopere8e811afab72\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScopere8e811afab72\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ((bool) \_PhpScopere8e811afab72\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScopere8e811afab72\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScopere8e811afab72\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScopere8e811afab72\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScopere8e811afab72\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScopere8e811afab72\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScopere8e811afab72\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
