...
namespace _PhpScoper0a2ac50786fa\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass;

use _PhpScoper0a2ac50786fa\Nette\Utils\Reflection;
...
use _PhpScoper0a2ac50786fa\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder;
/**
 * @inspiration https://github.com/nette/di/pull/178
 * Not final just for BC with previous class location
 * @see \Symplify\AutowireArrayParameter\Tests\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPassTest
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScoper0a2ac50786fa\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScoper0a2ac50786fa\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScoper0a2ac50786fa\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScoper0a2ac50786fa\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScoper0a2ac50786fa\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScoper0a2ac50786fa\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScoper0a2ac50786fa\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScoper0a2ac50786fa\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScoper0a2ac50786fa\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    {
        $this->definitionFinder = new \_PhpScoper0a2ac50786fa\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder();
    ...
    private function shouldSkipDefinition(\_PhpScoper0a2ac50786fa\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScoper0a2ac50786fa\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ((bool) \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScoper0a2ac50786fa\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScoper0a2ac50786fa\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScoper0a2ac50786fa\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScoper0a2ac50786fa\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScoper0a2ac50786fa\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
