...
namespace RectorPrefix20210423\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass;
...
use RectorPrefix20210423\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver;
use RectorPrefix20210423\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper;
use RectorPrefix20210423\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver;
use RectorPrefix20210423\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder;
/**
 * @inspiration https://github.com/nette/di/pull/178
 * @see \Symplify\AutowireArrayParameter\Tests\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPassTest
 */
final class AutowireArrayParameterCompilerPass implements \RectorPrefix20210423\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['RectorPrefix20210423\\Symfony\\Component\\Form\\FormExtensionInterface', 'RectorPrefix20210423\\Symfony\\Component\\Asset\\PackageInterface', 'RectorPrefix20210423\\Symfony\\Component\\Config\\Loader\\LoaderInterface', 'RectorPrefix20210423\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', 'RectorPrefix20210423\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', 'RectorPrefix20210423\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', 'RectorPrefix20210423\\Sonata\\Doctrine\\Adapter\\AdapterChain', 'RectorPrefix20210423\\Sonata\\Twig\\Extension\\TemplateExtension', 'RectorPrefix20210423\\Symfony\\Component\\HttpKernel\\KernelInterface'];
    /**
    ...
    {
        $this->definitionFinder = new \RectorPrefix20210423\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder();
        $paramTypeDocBlockResolver = new \RectorPrefix20210423\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver();
    ...
    private function shouldSkipDefinition(\RectorPrefix20210423\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \RectorPrefix20210423\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if (\RectorPrefix20210423\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \RectorPrefix20210423\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}
