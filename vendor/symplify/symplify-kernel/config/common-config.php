...
use RectorPrefix20201231\Symplify\SmartFileSystem\FileSystemGuard;
use RectorPrefix20201231\Symplify\SmartFileSystem\Finder\FinderSanitizer;
use RectorPrefix20201231\Symplify\SmartFileSystem\Finder\SmartFinder;
...
return static function (\RectorPrefix20201231\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    // filesystem
    $services->set(\RectorPrefix20201231\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\RectorPrefix20201231\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\RectorPrefix20201231\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\RectorPrefix20201231\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\RectorPrefix20201231\Symplify\SmartFileSystem\FileSystemFilter::class);
    ...
    $services->set(\RectorPrefix20201231\Symplify\SymplifyKernel\Console\ConsoleApplicationFactory::class);
    // composer json factory
    $services->set(\RectorPrefix20201231\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    $services->set(\RectorPrefix20201231\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    $services->set(\RectorPrefix20201231\Symplify\ComposerJsonManipulator\Json\JsonCleaner::class);
    $services->set(\RectorPrefix20201231\Symplify\ComposerJsonManipulator\Json\JsonInliner::class);
};
