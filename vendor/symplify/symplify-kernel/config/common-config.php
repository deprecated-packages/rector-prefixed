...
return static function (\_PhpScoper0a2ac50786fa\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper0a2ac50786fa\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\_PhpScoper0a2ac50786fa\Symplify\SmartFileSystem\FileSystemGuard::class);
    ...
    $services->set(\_PhpScoper0a2ac50786fa\Symplify\SymplifyKernel\Console\ConsoleApplicationFactory::class);
    // composer json factory
    $services->set(\_PhpScoper0a2ac50786fa\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    $services->set(\_PhpScoper0a2ac50786fa\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    $services->set(\_PhpScoper0a2ac50786fa\Symplify\ComposerJsonManipulator\Json\JsonCleaner::class);
    $services->set(\_PhpScoper0a2ac50786fa\Symplify\ComposerJsonManipulator\Json\JsonInliner::class);
};
