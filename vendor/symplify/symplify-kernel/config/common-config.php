...
use RectorPrefix20210303\Symplify\SmartFileSystem\FileSystemGuard;
use RectorPrefix20210303\Symplify\SmartFileSystem\Finder\FinderSanitizer;
use RectorPrefix20210303\Symplify\SmartFileSystem\Finder\SmartFinder;
...
return static function (\RectorPrefix20210303\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\RectorPrefix20210303\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\RectorPrefix20210303\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\RectorPrefix20210303\Symplify\SmartFileSystem\FileSystemFilter::class);
    $services->set(\RectorPrefix20210303\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\RectorPrefix20210303\Symfony\Component\DependencyInjection\Loader\Configurator\service(\RectorPrefix20210303\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
    $services->set(\RectorPrefix20210303\Symplify\PackageBuilder\Reflection\PrivatesAccessor::class);
    $services->set(\RectorPrefix20210303\Symplify\SymplifyKernel\Console\ConsoleApplicationFactory::class);
    // composer json factory
    $services->set(\RectorPrefix20210303\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    $services->set(\RectorPrefix20210303\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    $services->set(\RectorPrefix20210303\Symplify\ComposerJsonManipulator\Json\JsonCleaner::class);
    $services->set(\RectorPrefix20210303\Symplify\ComposerJsonManipulator\Json\JsonInliner::class);
};
