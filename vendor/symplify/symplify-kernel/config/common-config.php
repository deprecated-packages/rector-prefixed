...
use RectorPrefix20201228\Symplify\ComposerJsonManipulator\ComposerJsonFactory;
use RectorPrefix20201228\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager;
use RectorPrefix20201228\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use RectorPrefix20201228\Symplify\ComposerJsonManipulator\Json\JsonInliner;
...
use RectorPrefix20201228\Symplify\SmartFileSystem\FileSystemGuard;
...
return static function (\RectorPrefix20201228\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    // filesystem
    $services->set(\RectorPrefix20201228\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\RectorPrefix20201228\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\RectorPrefix20201228\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\RectorPrefix20201228\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\RectorPrefix20201228\Symplify\SmartFileSystem\FileSystemFilter::class);
    $services->set(\RectorPrefix20201228\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\RectorPrefix20201228\Symfony\Component\DependencyInjection\Loader\Configurator\service(\RectorPrefix20201228\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
    $services->set(\RectorPrefix20201228\Symplify\PackageBuilder\Reflection\PrivatesAccessor::class);
    $services->set(\RectorPrefix20201228\Symplify\SymplifyKernel\Console\ConsoleApplicationFactory::class);
    // composer json factory
    $services->set(\RectorPrefix20201228\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    $services->set(\RectorPrefix20201228\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    $services->set(\RectorPrefix20201228\Symplify\ComposerJsonManipulator\Json\JsonCleaner::class);
    $services->set(\RectorPrefix20201228\Symplify\ComposerJsonManipulator\Json\JsonInliner::class);
};
