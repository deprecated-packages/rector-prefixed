...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\RectorPrefix2020DecSat\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\RectorPrefix2020DecSat\Symfony\Component\Console\Application::class, $application);
    }
}
