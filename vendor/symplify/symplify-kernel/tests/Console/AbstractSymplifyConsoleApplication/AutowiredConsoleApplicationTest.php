...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper88fe6e0ad041\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper88fe6e0ad041\Symfony\Component\Console\Application::class, $application);
    }
}
