...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper267b3276efc2\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper267b3276efc2\Symfony\Component\Console\Application::class, $application);
    }
}
