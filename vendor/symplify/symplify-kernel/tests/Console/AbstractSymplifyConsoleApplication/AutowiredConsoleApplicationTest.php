...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Application::class, $application);
    }
}
