...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScopera143bcca66cb\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopera143bcca66cb\Symfony\Component\Console\Application::class, $application);
    }
}
