...
abstract class AbstractSymplifyConsoleApplication extends \RectorPrefix20210318\Symfony\Component\Console\Application
{
    /**
     * @var CommandNaming
     */
    ...
    {
        $this->commandNaming = new \RectorPrefix20210318\Symplify\PackageBuilder\Console\Command\CommandNaming();
