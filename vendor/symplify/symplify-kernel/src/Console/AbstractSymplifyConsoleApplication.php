...
abstract class AbstractSymplifyConsoleApplication extends \RectorPrefix20210303\Symfony\Component\Console\Application
{
    /**
     * @var CommandNaming
     */
    ...
    {
        $this->commandNaming = new \RectorPrefix20210303\Symplify\PackageBuilder\Console\Command\CommandNaming();
