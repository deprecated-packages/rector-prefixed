...
abstract class AbstractSymplifyConsoleApplication extends \RectorPrefix20210408\Symfony\Component\Console\Application
{
    /**
     * @var CommandNaming
     */
    ...
    {
        $this->commandNaming = new \RectorPrefix20210408\Symplify\PackageBuilder\Console\Command\CommandNaming();
