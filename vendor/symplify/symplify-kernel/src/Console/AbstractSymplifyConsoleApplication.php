...
abstract class AbstractSymplifyConsoleApplication extends \RectorPrefix20210312\Symfony\Component\Console\Application
{
    /**
     * @var CommandNaming
     */
    ...
    {
        $this->commandNaming = new \RectorPrefix20210312\Symplify\PackageBuilder\Console\Command\CommandNaming();
