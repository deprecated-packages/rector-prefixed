...
use RectorPrefix20201230\Jean85\PrettyVersions;
...
use RectorPrefix20201230\Symplify\SymplifyKernel\Strings\StringsConverter;
use Throwable;
final class ConsoleApplicationFactory
{
     ...
     */
    public function __construct(array $commands, \RectorPrefix20201230\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20201230\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \RectorPrefix20201230\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function create() : \RectorPrefix20201230\Symplify\SymplifyKernel\Console\AutowiredConsoleApplication
    {
        $autowiredConsoleApplication = new \RectorPrefix20201230\Symplify\SymplifyKernel\Console\AutowiredConsoleApplication($this->commands);
        $this->decorateApplicationWithNameAndVersion($autowiredConsoleApplication);
        return $autowiredConsoleApplication;
    }
    private function decorateApplicationWithNameAndVersion(\RectorPrefix20201230\Symplify\SymplifyKernel\Console\AutowiredConsoleApplication $autowiredConsoleApplication) : void
    {
    ...
    {
        try {
            $version = \RectorPrefix20201230\Jean85\PrettyVersions::getVersion($packageName);
