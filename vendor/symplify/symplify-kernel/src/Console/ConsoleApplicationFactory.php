...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper88fe6e0ad041\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper88fe6e0ad041\Jean85\PrettyVersions::getVersion($packageName);
