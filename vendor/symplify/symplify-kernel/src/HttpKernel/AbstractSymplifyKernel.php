...
namespace RectorPrefix20210111\Symplify\SymplifyKernel\HttpKernel;
...
use RectorPrefix20210111\Symplify\SymplifyKernel\Strings\KernelUniqueHasher;
abstract class AbstractSymplifyKernel extends \RectorPrefix20210111\Symfony\Component\HttpKernel\Kernel implements \RectorPrefix20210111\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \RectorPrefix20210111\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle()];
    }
    /**
    ...
    public function setConfigs(array $configs) : void
    {
        foreach ($configs as $config) {
            if ($config instanceof \RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo) {
    ...
    {
        $kernelUniqueHasher = new \RectorPrefix20210111\Symplify\SymplifyKernel\Strings\KernelUniqueHasher();
