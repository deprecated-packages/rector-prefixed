...
namespace RectorPrefix20201228\Symplify\SymplifyKernel\HttpKernel;
...
use RectorPrefix20201228\Symplify\SymplifyKernel\Strings\KernelUniqueHasher;
abstract class AbstractSymplifyKernel extends \RectorPrefix20201228\Symfony\Component\HttpKernel\Kernel implements \RectorPrefix20201228\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \RectorPrefix20201228\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle()];
    }
    /**
    ...
    public function setConfigs(array $configs) : void
    {
        foreach ($configs as $config) {
            if ($config instanceof \RectorPrefix20201228\Symplify\SmartFileSystem\SmartFileInfo) {
    ...
    {
        $kernelUniqueHasher = new \RectorPrefix20201228\Symplify\SymplifyKernel\Strings\KernelUniqueHasher();
