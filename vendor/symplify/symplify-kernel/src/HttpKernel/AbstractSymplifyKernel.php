...
namespace RectorPrefix20210318\Symplify\SymplifyKernel\HttpKernel;
...
use RectorPrefix20210318\Symplify\SymplifyKernel\Strings\KernelUniqueHasher;
abstract class AbstractSymplifyKernel extends \RectorPrefix20210318\Symfony\Component\HttpKernel\Kernel implements \RectorPrefix20210318\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \RectorPrefix20210318\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle()];
    }
    /**
    ...
    {
        $kernelUniqueHasher = new \RectorPrefix20210318\Symplify\SymplifyKernel\Strings\KernelUniqueHasher();
