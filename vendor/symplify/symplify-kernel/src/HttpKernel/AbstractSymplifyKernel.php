...
namespace RectorPrefix20210112\Symplify\SymplifyKernel\HttpKernel;
...
use RectorPrefix20210112\Symplify\SymplifyKernel\Strings\KernelUniqueHasher;
abstract class AbstractSymplifyKernel extends \RectorPrefix20210112\Symfony\Component\HttpKernel\Kernel implements \RectorPrefix20210112\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \RectorPrefix20210112\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle()];
    }
    /**
    ...
    public function setConfigs(array $configs) : void
    {
        foreach ($configs as $config) {
            if ($config instanceof \RectorPrefix20210112\Symplify\SmartFileSystem\SmartFileInfo) {
    ...
    {
        $kernelUniqueHasher = new \RectorPrefix20210112\Symplify\SymplifyKernel\Strings\KernelUniqueHasher();
