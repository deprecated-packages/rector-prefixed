...
namespace RectorPrefix20210420\Symplify\SymplifyKernel\Strings;

use RectorPrefix20210420\Nette\Utils\Strings;
use RectorPrefix20210420\Symplify\SymplifyKernel\Exception\HttpKernel\TooGenericKernelClassException;
...
final class KernelUniqueHasher
{
    ...
    private function ensureIsNotGenericKernelClass(string $kernelClass) : void
    {
        ...
        $message = \sprintf('Instead of "%s", provide final Kernel class', \RectorPrefix20210420\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel::class);
        throw new \RectorPrefix20210420\Symplify\SymplifyKernel\Exception\HttpKernel\TooGenericKernelClassException($message);
    }
}
