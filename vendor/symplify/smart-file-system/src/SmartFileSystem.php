...
use RectorPrefix20210203\Nette\Utils\Html;
 ...
 */
final class SmartFileSystem extends \RectorPrefix20210203\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \RectorPrefix20210203\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    public function readFileToSmartFileInfo(string $filename) : \RectorPrefix20210203\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \RectorPrefix20210203\Symplify\SmartFileSystem\SmartFileInfo($filename);
    }
    /**
    ...
    private function getLastError() : string
    {
        ...
        return \RectorPrefix20210203\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
