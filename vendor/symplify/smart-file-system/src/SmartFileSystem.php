...
use _PhpScoperfce0de0de1ce\Nette\Utils\Html;
...
final class SmartFileSystem extends \_PhpScoperfce0de0de1ce\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoperfce0de0de1ce\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
