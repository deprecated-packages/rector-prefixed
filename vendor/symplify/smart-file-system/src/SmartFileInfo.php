 ...
 */
final class SmartFileInfo extends \_PhpScoper26e51eeacccf\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper26e51eeacccf\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper26e51eeacccf\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper26e51eeacccf\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper26e51eeacccf\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
