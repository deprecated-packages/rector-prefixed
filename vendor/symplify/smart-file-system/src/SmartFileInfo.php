 ...
 */
final class SmartFileInfo extends \_PhpScoper88fe6e0ad041\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper88fe6e0ad041\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper88fe6e0ad041\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper88fe6e0ad041\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper88fe6e0ad041\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
