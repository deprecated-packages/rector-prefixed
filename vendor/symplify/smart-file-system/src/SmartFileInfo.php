 ...
 */
final class SmartFileInfo extends \_PhpScoperbf340cb0be9d\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperbf340cb0be9d\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperbf340cb0be9d\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperbf340cb0be9d\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperbf340cb0be9d\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
