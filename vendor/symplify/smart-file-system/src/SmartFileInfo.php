 ...
 */
final class SmartFileInfo extends \_PhpScoperf18a0c41e2d2\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
