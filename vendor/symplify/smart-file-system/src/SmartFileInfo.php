 ...
 */
final class SmartFileInfo extends \_PhpScoperfce0de0de1ce\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperfce0de0de1ce\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
