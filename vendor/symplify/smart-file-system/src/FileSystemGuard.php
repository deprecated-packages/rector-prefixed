...
final class FileSystemGuard
{
    public function ensureFileExists(string $file, string $location) : void
    {
        ...
        throw new \_PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\Exception\FileNotFoundException(\sprintf('File "%s" not found in "%s".', $file, $location));
    }
    public function ensureDirectoryExists(string $directory, string $extraMessage = '') : void
    {
        ...
        throw new \_PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\Exception\DirectoryNotFoundException($message);
    }
}
