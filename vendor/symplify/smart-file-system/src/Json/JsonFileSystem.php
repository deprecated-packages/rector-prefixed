...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoperbd5d0c5f7638\Nette\Utils\Json::encode($jsonArray, \_PhpScoperbd5d0c5f7638\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoperbd5d0c5f7638\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
