...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoper26e51eeacccf\Nette\Utils\Json::encode($jsonArray, \_PhpScoper26e51eeacccf\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoper26e51eeacccf\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
