...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoper5b8c9e9ebd21\Nette\Utils\Json::encode($jsonArray, \_PhpScoper5b8c9e9ebd21\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoper5b8c9e9ebd21\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
