...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoperf18a0c41e2d2\Nette\Utils\Json::encode($jsonArray, \_PhpScoperf18a0c41e2d2\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoperf18a0c41e2d2\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
