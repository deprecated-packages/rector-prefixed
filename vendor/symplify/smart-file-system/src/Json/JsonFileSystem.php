...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScopera143bcca66cb\Nette\Utils\Json::encode($jsonArray, \_PhpScopera143bcca66cb\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScopera143bcca66cb\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
