...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoper8b9c402c5f32\Nette\Utils\Json::encode($jsonArray, \_PhpScoper8b9c402c5f32\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoper8b9c402c5f32\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
