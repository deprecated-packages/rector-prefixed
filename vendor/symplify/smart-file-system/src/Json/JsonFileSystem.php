...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoperbf340cb0be9d\Nette\Utils\Json::encode($jsonArray, \_PhpScoperbf340cb0be9d\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoperbf340cb0be9d\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
