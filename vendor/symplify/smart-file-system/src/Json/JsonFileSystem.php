...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoperabd03f0baf05\Nette\Utils\Json::encode($jsonArray, \_PhpScoperabd03f0baf05\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoperabd03f0baf05\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
