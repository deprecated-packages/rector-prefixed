...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoper50d83356d739\Nette\Utils\Json::encode($jsonArray, \_PhpScoper50d83356d739\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoper50d83356d739\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
