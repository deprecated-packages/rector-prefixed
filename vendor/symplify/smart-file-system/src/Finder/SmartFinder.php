...
namespace RectorPrefix20210405\Symplify\SmartFileSystem\Finder;
...
final class SmartFinder
{
    ...
    public function __construct(\RectorPrefix20210405\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \RectorPrefix20210405\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function findPaths(array $directoriesOrFiles, string $path) : array
    {
        ...
        $fileInfos = [];
        if ($directories !== []) {
            $finder = new \RectorPrefix20210405\Symfony\Component\Finder\Finder();
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \RectorPrefix20210405\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
