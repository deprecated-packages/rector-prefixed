...
namespace RectorPrefix20210117\Symplify\SmartFileSystem\Finder;
...
final class SmartFinder
{
    ...
    public function __construct(\RectorPrefix20210117\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \RectorPrefix20210117\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
