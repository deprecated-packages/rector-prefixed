...
namespace RectorPrefix20210502\Symplify\SmartFileSystem\Tests\Finder\FinderSanitizer;

use RectorPrefix20210502\Nette\Utils\Finder as NetteFinder;
...
final class FinderSanitizerTest extends \RectorPrefix20210502\PHPUnit\Framework\TestCase
{
    ...
    {
        $this->finderSanitizer = new \RectorPrefix20210502\Symplify\SmartFileSystem\Finder\FinderSanitizer();
    }
    ...
    {
        $symfonyFinder = \RectorPrefix20210502\Symfony\Component\Finder\Finder::create()->files()->in(__DIR__ . '/Source');
    ...
    {
        $netteFinder = \RectorPrefix20210502\Nette\Utils\Finder::findFiles('*')->from(__DIR__ . '/Source');
