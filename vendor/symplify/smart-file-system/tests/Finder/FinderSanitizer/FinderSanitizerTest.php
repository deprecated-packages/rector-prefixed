...
namespace RectorPrefix20210422\Symplify\SmartFileSystem\Tests\Finder\FinderSanitizer;
...
final class FinderSanitizerTest extends \RectorPrefix20210422\PHPUnit\Framework\TestCase
{
    /**
     * @var FinderSanitizer
     */
    ...
    {
        $this->finderSanitizer = new \RectorPrefix20210422\Symplify\SmartFileSystem\Finder\FinderSanitizer();
    }
    ...
    {
        $symfonyFinder = \RectorPrefix20210422\Symfony\Component\Finder\Finder::create()->files()->in(__DIR__ . '/Source');
    ...
    {
        $netteFinder = \RectorPrefix20210422\Nette\Utils\Finder::findFiles('*')->from(__DIR__ . '/Source');
     ...
     */
    private function assertFilesEqualFixtureFiles(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $firstSmartFileInfo, \RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $secondSmartFileInfo) : void
    {
        ...
        $this->assertTrue(\RectorPrefix20210422\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php') && \RectorPrefix20210422\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') || \RectorPrefix20210422\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') && \RectorPrefix20210422\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php'));
    }
    private function assertFileIsFromFixtureDirAndHasCorrectClass(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->assertInstanceOf(\RectorPrefix20210422\Symfony\Component\Finder\SplFileInfo::class, $smartFileInfo);
