...
namespace RectorPrefix20210508\Symplify\SmartFileSystem\Tests\Finder\FinderSanitizer;

use RectorPrefix20210508\Nette\Utils\Finder as NetteFinder;
use RectorPrefix20210508\Nette\Utils\Strings;
use RectorPrefix20210508\PHPUnit\Framework\TestCase;
use SplFileInfo;
use RectorPrefix20210508\Symfony\Component\Finder\Finder as SymfonyFinder;
use RectorPrefix20210508\Symfony\Component\Finder\SplFileInfo as SymfonySplFileInfo;
use RectorPrefix20210508\Symplify\SmartFileSystem\Finder\FinderSanitizer;
use Symplify\SmartFileSystem\SmartFileInfo;
final class FinderSanitizerTest extends \RectorPrefix20210508\PHPUnit\Framework\TestCase
{
    /**
     * @var FinderSanitizer
     */
    ...
    {
        $this->finderSanitizer = new \RectorPrefix20210508\Symplify\SmartFileSystem\Finder\FinderSanitizer();
    }
    ...
    {
        $symfonyFinder = \RectorPrefix20210508\Symfony\Component\Finder\Finder::create()->files()->in(__DIR__ . '/Source');
    ...
    {
        $netteFinder = \RectorPrefix20210508\Nette\Utils\Finder::findFiles('*')->from(__DIR__ . '/Source');
    ...
    private function assertFilesEqualFixtureFiles(\Symplify\SmartFileSystem\SmartFileInfo $firstSmartFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $secondSmartFileInfo) : void
    {
        ...
        $this->assertTrue(\RectorPrefix20210508\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php') && \RectorPrefix20210508\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') || \RectorPrefix20210508\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') && \RectorPrefix20210508\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php'));
    }
    private function assertFileIsFromFixtureDirAndHasCorrectClass(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->assertInstanceOf(\RectorPrefix20210508\Symfony\Component\Finder\SplFileInfo::class, $smartFileInfo);
