...
namespace RectorPrefix20210508\Symplify\SmartFileSystem\Tests\SmartFileInfo;
...
final class SmartFileInfoTest extends \RectorPrefix20210508\PHPUnit\Framework\TestCase
{
    ...
    {
        $this->expectException(\RectorPrefix20210508\Symplify\SmartFileSystem\Exception\DirectoryNotFoundException::class);
        $smartFileInfo = new \Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
