...
namespace RectorPrefix20210304\Symplify\SmartFileSystem\Tests\SmartFileInfo;
...
final class SmartFileInfoTest extends \RectorPrefix20210304\PHPUnit\Framework\TestCase
{
    public function testInvalidPath() : void
    {
        $this->expectException(\RectorPrefix20210304\Symplify\SmartFileSystem\Exception\FileNotFoundException::class);
        new \RectorPrefix20210304\Symplify\SmartFileSystem\SmartFileInfo('random');
    }
    public function testRelatives() : void
    {
        $smartFileInfo = new \RectorPrefix20210304\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
    ...
    {
        $smartFileInfo = new \RectorPrefix20210304\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/AnotherFile.txt');
    ...
    {
        $this->expectException(\RectorPrefix20210304\Symplify\SmartFileSystem\Exception\DirectoryNotFoundException::class);
        $smartFileInfo = new \RectorPrefix20210304\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
