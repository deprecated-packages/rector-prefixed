...
namespace RectorPrefix20210117\Symplify\SmartFileSystem\Tests\SmartFileInfo;
...
final class SmartFileInfoTest extends \RectorPrefix20210117\PHPUnit\Framework\TestCase
{
    public function testInvalidPath() : void
    {
        $this->expectException(\RectorPrefix20210117\Symplify\SmartFileSystem\Exception\FileNotFoundException::class);
        new \RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo('random');
    }
    ...
    {
        $smartFileInfo = new \RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/AnotherFile.txt');
