...
namespace RectorPrefix20210107\Symplify\SmartFileSystem\Tests\SmartFileInfo;
...
final class SmartFileInfoTest extends \RectorPrefix20210107\PHPUnit\Framework\TestCase
{
    public function testInvalidPath() : void
    {
        $this->expectException(\RectorPrefix20210107\Symplify\SmartFileSystem\Exception\FileNotFoundException::class);
        new \RectorPrefix20210107\Symplify\SmartFileSystem\SmartFileInfo('random');
    }
    public function testRelatives() : void
    {
        $smartFileInfo = new \RectorPrefix20210107\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
    ...
    {
        $smartFileInfo = new \RectorPrefix20210107\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/AnotherFile.txt');
    ...
    {
        $smartFileInfo = new \RectorPrefix20210107\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
        $this->expectException(\RectorPrefix20210107\Symplify\SmartFileSystem\Exception\DirectoryNotFoundException::class);
