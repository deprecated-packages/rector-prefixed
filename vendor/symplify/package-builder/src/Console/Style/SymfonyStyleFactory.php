...
namespace RectorPrefix20210504\Symplify\PackageBuilder\Console\Style;
...
final class SymfonyStyleFactory
{
    ...
    {
        $this->privatesCaller = new \RectorPrefix20210504\Symplify\PackageBuilder\Reflection\PrivatesCaller();
    }
    public function create() : \RectorPrefix20210504\Symfony\Component\Console\Style\SymfonyStyle
    {
        ...
        if (\RectorPrefix20210504\Symplify\EasyTesting\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun()) {
            $consoleOutput->setVerbosity(\RectorPrefix20210504\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
