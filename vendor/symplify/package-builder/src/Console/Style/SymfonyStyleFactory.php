...
final class SymfonyStyleFactory
{
    ...
    public function create() : \Symfony\Component\Console\Style\SymfonyStyle
    {
        ...
        $consoleOutput = new \_PhpScoper26e51eeacccf\Symfony\Component\Console\Output\ConsoleOutput();
        // to configure all -v, -vv, -vvv options without memory-lock to Application run() arguments
        $this->privatesCaller->callPrivateMethod(new \_PhpScoper26e51eeacccf\Symfony\Component\Console\Application(), 'configureIO', $argvInput, $consoleOutput);
        // --debug is called
        if ($argvInput->hasParameterOption('--debug')) {
            $consoleOutput->setVerbosity(\_PhpScoper26e51eeacccf\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_DEBUG);
        }
        // disable output for tests
        if (\Symplify\EasyTesting\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun()) {
            $consoleOutput->setVerbosity(\_PhpScoper26e51eeacccf\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
