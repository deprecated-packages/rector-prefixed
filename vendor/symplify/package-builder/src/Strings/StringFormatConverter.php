...
namespace _PhpScopere8e811afab72\Symplify\PackageBuilder\Strings;
...
final class StringFormatConverter
{
    ...
    {
        $matches = \_PhpScopere8e811afab72\Nette\Utils\Strings::matchAll($input, self::BIG_LETTER_REGEX);
        $parts = [];
