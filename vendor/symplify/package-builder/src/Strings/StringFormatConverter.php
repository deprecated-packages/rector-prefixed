...
namespace _PhpScoper0a2ac50786fa\Symplify\PackageBuilder\Strings;
...
final class StringFormatConverter
{
    ...
    {
        $matches = \_PhpScoper0a2ac50786fa\Nette\Utils\Strings::matchAll($input, self::BIG_LETTER_REGEX);
        $parts = [];
