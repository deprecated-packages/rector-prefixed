...
namespace _PhpScoper0a6b37af0871\Symplify\PackageBuilder\Strings;
...
final class StringFormatConverter
{
    ...
    {
        $matches = \_PhpScoper0a6b37af0871\Nette\Utils\Strings::matchAll($input, self::BIG_LETTER_REGEX);
        $parts = [];
