 ...
 */
abstract class AbstractKernelTestCase extends \_PhpScoperbd5d0c5f7638\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
     ...
     */
    protected function bootKernelWithConfigs(string $kernelClass, array $configs) : \_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\KernelInterface
    {
        ...
        if (!$kernel instanceof \_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\KernelInterface) {
    ...
    protected function ensureKernelShutdown() : void
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \_PhpScoperbd5d0c5f7638\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
    ...
    private function ensureIsConfigAwareKernel(\_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\KernelInterface $kernel) : void
    {
    ...
    private function bootAndReturnKernel(\_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\KernelInterface $kernel) : \_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\KernelInterface
    {
        $kernel->boot();
        ...
        if (!$container instanceof \_PhpScoperbd5d0c5f7638\Symfony\Component\DependencyInjection\ContainerInterface) {
            throw new \Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        ...
        if ($container->has(\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            ...
            $symfonyStyle->setVerbosity(\_PhpScoperbd5d0c5f7638\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
