 ...
 */
abstract class AbstractKernelTestCase extends \RectorPrefix2020DecSat\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
     ...
     */
    protected function bootKernelWithConfigs(string $kernelClass, array $configs) : \RectorPrefix2020DecSat\Symfony\Component\HttpKernel\KernelInterface
    {
        ...
        if (!$kernel instanceof \RectorPrefix2020DecSat\Symfony\Component\HttpKernel\KernelInterface) {
    ...
    protected function ensureKernelShutdown() : void
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \RectorPrefix2020DecSat\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
    ...
    private function ensureIsConfigAwareKernel(\RectorPrefix2020DecSat\Symfony\Component\HttpKernel\KernelInterface $kernel) : void
    {
    ...
    private function bootAndReturnKernel(\RectorPrefix2020DecSat\Symfony\Component\HttpKernel\KernelInterface $kernel) : \RectorPrefix2020DecSat\Symfony\Component\HttpKernel\KernelInterface
    {
        $kernel->boot();
        ...
        if (!$container instanceof \RectorPrefix2020DecSat\Symfony\Component\DependencyInjection\ContainerInterface) {
            throw new \Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        // has output? keep it silent out of tests
        if ($container->has(\RectorPrefix2020DecSat\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            $symfonyStyle = $container->get(\RectorPrefix2020DecSat\Symfony\Component\Console\Style\SymfonyStyle::class);
