 ...
 */
abstract class AbstractKernelTestCase extends \_PhpScoper5b8c9e9ebd21\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
     ...
     */
    protected function bootKernelWithConfigs(string $kernelClass, array $configs) : \_PhpScoper5b8c9e9ebd21\Symfony\Component\HttpKernel\KernelInterface
    {
        ...
        if (!$kernel instanceof \_PhpScoper5b8c9e9ebd21\Symfony\Component\HttpKernel\KernelInterface) {
    ...
    protected function ensureKernelShutdown() : void
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \_PhpScoper5b8c9e9ebd21\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
    ...
    private function ensureIsConfigAwareKernel(\_PhpScoper5b8c9e9ebd21\Symfony\Component\HttpKernel\KernelInterface $kernel) : void
    {
    ...
    private function bootAndReturnKernel(\_PhpScoper5b8c9e9ebd21\Symfony\Component\HttpKernel\KernelInterface $kernel) : \_PhpScoper5b8c9e9ebd21\Symfony\Component\HttpKernel\KernelInterface
    {
        $kernel->boot();
        ...
        if (!$container instanceof \_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\ContainerInterface) {
            throw new \Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        ...
        if ($container->has(\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            ...
            $symfonyStyle->setVerbosity(\_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
