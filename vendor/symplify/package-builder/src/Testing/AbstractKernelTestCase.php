 ...
 */
abstract class AbstractKernelTestCase extends \_PhpScoper17db12703726\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
     ...
     */
    protected function bootKernelWithConfigs(string $kernelClass, array $configs) : \_PhpScoper17db12703726\Symfony\Component\HttpKernel\KernelInterface
    {
        ...
        if (!$kernel instanceof \_PhpScoper17db12703726\Symfony\Component\HttpKernel\KernelInterface) {
    ...
    protected function ensureKernelShutdown() : void
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \_PhpScoper17db12703726\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
    ...
    private function ensureIsConfigAwareKernel(\_PhpScoper17db12703726\Symfony\Component\HttpKernel\KernelInterface $kernel) : void
    {
    ...
    private function bootAndReturnKernel(\_PhpScoper17db12703726\Symfony\Component\HttpKernel\KernelInterface $kernel) : \_PhpScoper17db12703726\Symfony\Component\HttpKernel\KernelInterface
    {
        $kernel->boot();
        ...
        if (!$container instanceof \_PhpScoper17db12703726\Symfony\Component\DependencyInjection\ContainerInterface) {
            throw new \Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        ...
        if ($container->has(\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            ...
            $symfonyStyle->setVerbosity(\_PhpScoper17db12703726\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
