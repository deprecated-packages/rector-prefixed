...
namespace RectorPrefix20210209\Symplify\PackageBuilder\Testing;
...
use RectorPrefix20210209\Symplify\PackageBuilder\Exception\HttpKernel\MissingInterfaceException;
 ...
 */
abstract class AbstractKernelTestCase extends \RectorPrefix20210209\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
    ...
    protected function getService(string $type) : object
    {
        if (self::$container === null) {
            throw new \RectorPrefix20210209\Symplify\SymplifyKernel\Exception\ShouldNotHappenException('First, crewate container with booKernel(KernelClass::class)');
        }
    ...
    protected function ensureKernelShutdown() : void
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \RectorPrefix20210209\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
    ...
    {
        if ($kernel instanceof \RectorPrefix20210209\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface) {
            return;
        }
        throw new \RectorPrefix20210209\Symplify\PackageBuilder\Exception\HttpKernel\MissingInterfaceException(\sprintf('"%s" is missing an "%s" interface', \get_class($kernel), \RectorPrefix20210209\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface::class));
    }
    private function bootAndReturnKernel(\RectorPrefix20210209\Symfony\Component\HttpKernel\KernelInterface $kernel) : \RectorPrefix20210209\Symfony\Component\HttpKernel\KernelInterface
    {
        $kernel->boot();
        ...
        if (!$container instanceof \RectorPrefix20210209\Symfony\Component\DependencyInjection\ContainerInterface) {
            throw new \RectorPrefix20210209\Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        // has output? keep it silent out of tests
        if ($container->has(\RectorPrefix20210209\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            $symfonyStyle = $container->get(\RectorPrefix20210209\Symfony\Component\Console\Style\SymfonyStyle::class);
