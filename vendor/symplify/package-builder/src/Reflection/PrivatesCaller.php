...
namespace RectorPrefix20210326\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210326\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
