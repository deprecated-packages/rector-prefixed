...
namespace RectorPrefix20210429\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210429\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
