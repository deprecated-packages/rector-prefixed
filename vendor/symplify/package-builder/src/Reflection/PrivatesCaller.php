...
namespace RectorPrefix20210319\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210319\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
