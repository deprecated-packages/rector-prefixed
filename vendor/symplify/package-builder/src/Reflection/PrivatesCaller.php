...
namespace RectorPrefix20210410\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210410\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
