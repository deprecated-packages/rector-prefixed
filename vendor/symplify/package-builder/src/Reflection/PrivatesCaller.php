...
namespace RectorPrefix20210418\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210418\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
