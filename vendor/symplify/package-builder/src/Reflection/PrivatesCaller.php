...
namespace RectorPrefix20210402\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210402\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
