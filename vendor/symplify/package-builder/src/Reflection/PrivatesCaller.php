...
namespace RectorPrefix20210327\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210327\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
