...
namespace RectorPrefix20210322\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210322\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
