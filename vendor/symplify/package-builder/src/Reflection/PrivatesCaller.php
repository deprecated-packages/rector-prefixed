...
namespace RectorPrefix20210412\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210412\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
