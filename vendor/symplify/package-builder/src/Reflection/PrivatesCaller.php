...
namespace RectorPrefix20210422\Symplify\PackageBuilder\Reflection;
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location)
    {
        ...
        throw new \RectorPrefix20210422\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
