...
use RectorPrefix20210116\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection(object $object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \RectorPrefix20210116\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
