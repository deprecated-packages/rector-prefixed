...
namespace RectorPrefix20210201\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use RectorPrefix20210201\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection(object $object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \RectorPrefix20210201\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
