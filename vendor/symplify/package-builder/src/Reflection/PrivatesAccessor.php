...
namespace RectorPrefix20210222\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use RectorPrefix20210222\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection(object $object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \RectorPrefix20210222\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
