...
namespace RectorPrefix20210202\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use RectorPrefix20210202\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection(object $object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \RectorPrefix20210202\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
