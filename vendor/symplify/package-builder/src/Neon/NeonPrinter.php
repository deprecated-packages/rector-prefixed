...
namespace RectorPrefix20210305\Symplify\PackageBuilder\Neon;

use RectorPrefix20210305\Nette\Neon\Encoder;
use RectorPrefix20210305\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \RectorPrefix20210305\Nette\Neon\Neon::encode($phpStanNeon, \RectorPrefix20210305\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \RectorPrefix20210305\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \RectorPrefix20210305\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \RectorPrefix20210305\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
