...
use _PhpScopera143bcca66cb\Nette\Neon\Encoder;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScopera143bcca66cb\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScopera143bcca66cb\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
