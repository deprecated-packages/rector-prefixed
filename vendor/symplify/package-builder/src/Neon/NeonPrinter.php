...
use _PhpScoper006a73f0e455\Nette\Neon\Encoder;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper006a73f0e455\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper006a73f0e455\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper006a73f0e455\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper006a73f0e455\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper006a73f0e455\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
