...
final class ParameterProviderTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    public function test() : void
    {
        $this->bootKernelWithConfigs(\Symplify\PackageBuilder\Tests\HttpKernel\PackageBuilderTestKernel::class, [__DIR__ . '/ParameterProviderSource/config.yml']);
    ...
    {
        $this->bootKernelWithConfigs(\Symplify\PackageBuilder\Tests\HttpKernel\PackageBuilderTestKernel::class, [__DIR__ . '/ParameterProviderSource/Yaml/including-config.php']);
        $parameterProvider = self::$container->get(\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
        $parameters = $parameterProvider->provide();
