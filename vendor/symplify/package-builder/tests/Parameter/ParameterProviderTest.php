...
namespace RectorPrefix20210129\Symplify\PackageBuilder\Tests\Parameter;
...
use RectorPrefix20210129\Symplify\PackageBuilder\Tests\HttpKernel\PackageBuilderTestKernel;
final class ParameterProviderTest extends \RectorPrefix20210129\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    public function test() : void
    {
        $this->bootKernelWithConfigs(\RectorPrefix20210129\Symplify\PackageBuilder\Tests\HttpKernel\PackageBuilderTestKernel::class, [__DIR__ . '/ParameterProviderSource/config.yml']);
    ...
    {
        $this->bootKernelWithConfigs(\RectorPrefix20210129\Symplify\PackageBuilder\Tests\HttpKernel\PackageBuilderTestKernel::class, [__DIR__ . '/ParameterProviderSource/Yaml/including-config.php']);
        $parameterProvider = $this->getService(\RectorPrefix20210129\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
        $parameters = $parameterProvider->provide();
