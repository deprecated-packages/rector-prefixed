...
namespace RectorPrefix20210321\Symplify\PackageBuilder\Tests\Parameter;
...
use RectorPrefix20210321\Symplify\PackageBuilder\Tests\HttpKernel\PackageBuilderTestKernel;
final class ParameterProviderTest extends \RectorPrefix20210321\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    public function test() : void
    {
        $this->bootKernelWithConfigs(\RectorPrefix20210321\Symplify\PackageBuilder\Tests\HttpKernel\PackageBuilderTestKernel::class, [__DIR__ . '/ParameterProviderSource/config.php']);
        $parameterProvider = $this->getService(\RectorPrefix20210321\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
    ...
    {
        $this->bootKernelWithConfigs(\RectorPrefix20210321\Symplify\PackageBuilder\Tests\HttpKernel\PackageBuilderTestKernel::class, [__DIR__ . '/ParameterProviderSource/Yaml/including-config.php']);
        $parameterProvider = $this->getService(\RectorPrefix20210321\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
        $parameters = $parameterProvider->provide();
