...
abstract class AbstractConfigResolver
{
    ...
    public function resolveFromInput(\RectorPrefix2020DecSat\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     */
    public function resolveFromInputWithFallback(\RectorPrefix2020DecSat\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
