...
abstract class AbstractConfigResolver
{
    ...
    public function resolveFromInput(\RectorPrefix20210222\Symfony\Component\Console\Input\InputInterface $input) : ?\RectorPrefix20210222\Symplify\SmartFileSystem\SmartFileInfo
    {
        $configValue = $this->optionValueResolver->getOptionValue($input, \RectorPrefix20210222\Symplify\SetConfigResolver\Console\Option\OptionName::CONFIG);
        if ($configValue !== null) {
            if (!\file_exists($configValue)) {
                $message = \sprintf('File "%s" was not found', $configValue);
                throw new \RectorPrefix20210222\Symplify\SmartFileSystem\Exception\FileNotFoundException($message);
            }
     ...
     */
    public function resolveFromInputWithFallback(\RectorPrefix20210222\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles) : ?\RectorPrefix20210222\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     * @param string[] $fallbackFiles
     */
    private function createFallbackFileInfoIfFound(array $fallbackFiles) : ?\RectorPrefix20210222\Symplify\SmartFileSystem\SmartFileInfo
    {
