...
namespace RectorPrefix20210129\Symplify\SetConfigResolver\Bootstrap;
...
final class InvalidSetReporter
{
    ...
    public function report(\RectorPrefix20210129\Symplify\SetConfigResolver\Exception\SetNotFoundException $setNotFoundException) : void
    {
        $message = $setNotFoundException->getMessage();
        $suggestedSet = \RectorPrefix20210129\Nette\Utils\ObjectHelpers::getSuggestion($setNotFoundException->getAvailableSetNames(), $setNotFoundException->getSetName());
