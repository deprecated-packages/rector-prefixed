...
namespace RectorPrefix20210318\Symplify\SetConfigResolver\Provider;

use RectorPrefix20210318\Nette\Utils\Strings;
use RectorPrefix20210318\Symplify\SetConfigResolver\Contract\SetProviderInterface;
...
abstract class AbstractSetProvider implements \RectorPrefix20210318\Symplify\SetConfigResolver\Contract\SetProviderInterface
{
    /**
     * @return string[]
     */
    ...
    public function provideByName(string $desiredSetName) : ?\RectorPrefix20210318\Symplify\SetConfigResolver\ValueObject\Set
    {
        ...
        } catch (\RectorPrefix20210318\Symplify\SymplifyKernel\Exception\ShouldNotHappenException $shouldNotHappenException) {
        }
