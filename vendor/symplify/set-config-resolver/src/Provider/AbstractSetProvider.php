...
namespace RectorPrefix20201228\Symplify\SetConfigResolver\Provider;
...
abstract class AbstractSetProvider implements \RectorPrefix20201228\Symplify\SetConfigResolver\Contract\SetProviderInterface
{
    /**
     * @return string[]
     */
    ...
    public function provideByName(string $desiredSetName) : ?\RectorPrefix20201228\Symplify\SetConfigResolver\ValueObject\Set
    {
        ...
        } catch (\RectorPrefix20201228\Symplify\SymplifyKernel\Exception\ShouldNotHappenException $shouldNotHappenException) {
        }
    ...
    {
        $setPath = \RectorPrefix20201228\Nette\Utils\Strings::after($setPath, \DIRECTORY_SEPARATOR, -2);
        if ($setPath === null) {
