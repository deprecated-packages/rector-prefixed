...
namespace RectorPrefix20201231\Symplify\SetConfigResolver\Provider;
...
abstract class AbstractSetProvider implements \RectorPrefix20201231\Symplify\SetConfigResolver\Contract\SetProviderInterface
{
    /**
     * @return string[]
     */
    ...
    public function provideByName(string $desiredSetName) : ?\RectorPrefix20201231\Symplify\SetConfigResolver\ValueObject\Set
    {
        ...
        } catch (\RectorPrefix20201231\Symplify\SymplifyKernel\Exception\ShouldNotHappenException $shouldNotHappenException) {
        }
    ...
    {
        $setPath = \RectorPrefix20201231\Nette\Utils\Strings::after($setPath, \DIRECTORY_SEPARATOR, -2);
        if ($setPath === null) {
