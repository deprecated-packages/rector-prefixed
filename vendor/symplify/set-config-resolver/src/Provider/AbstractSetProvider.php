...
namespace RectorPrefix20210215\Symplify\SetConfigResolver\Provider;
...
abstract class AbstractSetProvider implements \RectorPrefix20210215\Symplify\SetConfigResolver\Contract\SetProviderInterface
{
    /**
     * @return string[]
     */
    ...
    public function provideByName(string $desiredSetName) : ?\RectorPrefix20210215\Symplify\SetConfigResolver\ValueObject\Set
    {
        ...
        } catch (\RectorPrefix20210215\Symplify\SymplifyKernel\Exception\ShouldNotHappenException $shouldNotHappenException) {
        }
    ...
    {
        $setPath = \RectorPrefix20210215\Nette\Utils\Strings::after($setPath, \DIRECTORY_SEPARATOR, -2);
        if ($setPath === null) {
