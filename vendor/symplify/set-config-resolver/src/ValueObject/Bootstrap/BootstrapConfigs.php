...
namespace RectorPrefix20210321\Symplify\SetConfigResolver\ValueObject\Bootstrap;
...
final class BootstrapConfigs
{
     ...
     */
    public function __construct(?\RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileInfo $mainConfigFileInfo, array $setConfigFileInfos)
    {
        $this->mainConfigFileInfo = $mainConfigFileInfo;
        $this->setConfigFileInfos = $setConfigFileInfos;
    }
    public function getMainConfigFileInfo() : ?\RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    {
        if (!$this->mainConfigFileInfo instanceof \RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileInfo) {
