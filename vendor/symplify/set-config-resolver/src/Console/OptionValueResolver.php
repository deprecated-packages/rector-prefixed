...
namespace RectorPrefix20210124\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210124\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
