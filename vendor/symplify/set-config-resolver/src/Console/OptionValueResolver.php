...
namespace RectorPrefix20210303\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210303\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
