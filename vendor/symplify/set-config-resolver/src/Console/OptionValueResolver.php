...
namespace RectorPrefix20210118\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210118\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
