...
namespace RectorPrefix20210125\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210125\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
