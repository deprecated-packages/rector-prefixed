...
namespace RectorPrefix20210509\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210509\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
