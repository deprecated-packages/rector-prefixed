...
namespace RectorPrefix20210120\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210120\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
