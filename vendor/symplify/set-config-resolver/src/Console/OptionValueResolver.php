...
namespace RectorPrefix20210129\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210129\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
