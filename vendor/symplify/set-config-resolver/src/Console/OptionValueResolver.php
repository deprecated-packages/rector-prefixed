...
namespace RectorPrefix20201229\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20201229\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
