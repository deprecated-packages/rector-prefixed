...
namespace RectorPrefix20210107\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210107\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
