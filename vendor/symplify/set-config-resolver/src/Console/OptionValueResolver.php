...
namespace RectorPrefix20210220\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210220\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
