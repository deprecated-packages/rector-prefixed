...
namespace RectorPrefix20210218\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210218\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
