...
namespace RectorPrefix20210312\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210312\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
