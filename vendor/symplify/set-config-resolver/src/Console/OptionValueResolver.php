...
namespace RectorPrefix20210206\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210206\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
