...
namespace RectorPrefix20210119\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210119\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
