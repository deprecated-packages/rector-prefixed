...
namespace RectorPrefix20210222\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210222\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
