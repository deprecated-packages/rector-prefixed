...
namespace RectorPrefix20210205\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210205\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
