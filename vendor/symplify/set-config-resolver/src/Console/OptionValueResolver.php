...
namespace RectorPrefix20210502\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210502\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
