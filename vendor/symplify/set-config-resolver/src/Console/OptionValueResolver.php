...
namespace RectorPrefix20210126\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210126\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
