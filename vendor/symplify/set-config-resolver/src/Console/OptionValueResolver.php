...
namespace RectorPrefix20210304\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210304\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
