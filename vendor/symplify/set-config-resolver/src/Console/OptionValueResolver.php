...
namespace RectorPrefix20210122\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210122\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
