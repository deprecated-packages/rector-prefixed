...
namespace RectorPrefix20210302\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210302\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
