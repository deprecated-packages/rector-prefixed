...
namespace RectorPrefix20210130\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210130\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
