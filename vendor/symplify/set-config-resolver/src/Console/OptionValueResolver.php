...
namespace RectorPrefix20210108\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210108\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
