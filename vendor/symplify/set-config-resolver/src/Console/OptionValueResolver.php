...
namespace RectorPrefix20201228\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20201228\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
