...
namespace RectorPrefix20210318\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210318\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
