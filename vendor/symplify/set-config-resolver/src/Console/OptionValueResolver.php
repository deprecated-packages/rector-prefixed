...
namespace RectorPrefix20210110\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210110\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
