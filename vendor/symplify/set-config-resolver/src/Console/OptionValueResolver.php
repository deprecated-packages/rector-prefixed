...
namespace RectorPrefix20201230\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20201230\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
