...
namespace RectorPrefix20210506\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210506\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
