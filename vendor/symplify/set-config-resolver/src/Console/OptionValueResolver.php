...
namespace RectorPrefix20210113\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210113\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
