...
namespace RectorPrefix20210123\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210123\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
