...
namespace RectorPrefix20201231\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20201231\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
