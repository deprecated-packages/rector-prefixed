...
namespace RectorPrefix20210116\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210116\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
