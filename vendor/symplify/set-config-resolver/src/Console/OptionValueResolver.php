...
namespace RectorPrefix20210209\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210209\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
