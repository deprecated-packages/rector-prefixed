...
namespace RectorPrefix20210219\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210219\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
