...
namespace RectorPrefix20210424\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210424\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
