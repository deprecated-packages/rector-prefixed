...
namespace RectorPrefix20210128\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210128\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
