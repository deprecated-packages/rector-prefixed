...
namespace RectorPrefix20210425\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210425\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
