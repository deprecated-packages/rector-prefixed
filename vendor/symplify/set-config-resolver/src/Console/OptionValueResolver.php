...
namespace RectorPrefix20210208\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210208\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
