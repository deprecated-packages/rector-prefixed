...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper50d83356d739\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper50d83356d739\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper50d83356d739\Symfony\Component\Config\FileLocator());
