...
namespace RectorPrefix20210506\Symplify\SetConfigResolver\Config;
...
use RectorPrefix20210506\Symplify\Astral\Exception\ShouldNotHappenException;
use RectorPrefix20210506\Symplify\SetConfigResolver\SetResolver;
...
final class SetsParameterResolver
{
     ...
     */
    private $setResolver;
    public function __construct(\RectorPrefix20210506\Symplify\SetConfigResolver\SetResolver $setResolver)
    {
    ...
    private function resolveSetsFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        if ($configFileInfo->hasSuffixes(['yml', 'yaml'])) {
            throw new \RectorPrefix20210506\Symplify\Astral\Exception\ShouldNotHappenException('Only PHP config suffix is supported now. Migrete your Symfony config to PHP');
        }
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \RectorPrefix20210506\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \RectorPrefix20210506\Symfony\Component\Config\FileLocator());
