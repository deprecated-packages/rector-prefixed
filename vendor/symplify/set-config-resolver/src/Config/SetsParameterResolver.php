...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper567b66d83109\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper567b66d83109\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper567b66d83109\Symfony\Component\Config\FileLocator());
