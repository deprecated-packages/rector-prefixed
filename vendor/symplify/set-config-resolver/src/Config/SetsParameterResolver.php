...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperf18a0c41e2d2\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperf18a0c41e2d2\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperf18a0c41e2d2\Symfony\Component\Config\FileLocator());
