...
namespace RectorPrefix20210321\Symplify\SetConfigResolver\Config;
...
use RectorPrefix20210321\Symplify\Astral\Exception\ShouldNotHappenException;
use RectorPrefix20210321\Symplify\SetConfigResolver\SetResolver;
...
final class SetsParameterResolver
{
     ...
     */
    private $setResolver;
    public function __construct(\RectorPrefix20210321\Symplify\SetConfigResolver\SetResolver $setResolver)
    {
     ...
     * @return string[]
     */
    private function resolveSetsFromFileInfo(\RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        if ($configFileInfo->hasSuffixes(['yml', 'yaml'])) {
            throw new \RectorPrefix20210321\Symplify\Astral\Exception\ShouldNotHappenException('Only PHP config suffix is supported now. Migrete your Symfony config to PHP');
        }
     ...
     * @return string[]
     */
    private function resolveSetsParameterFromPhpFileInfo(\RectorPrefix20210321\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        // php file loader
