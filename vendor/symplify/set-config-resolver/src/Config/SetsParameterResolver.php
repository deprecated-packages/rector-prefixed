...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper88fe6e0ad041\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper88fe6e0ad041\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper88fe6e0ad041\Symfony\Component\Config\FileLocator());
