...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper5edc98a7cce2\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper5edc98a7cce2\Symfony\Component\Config\FileLocator());
