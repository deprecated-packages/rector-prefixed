...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper26e51eeacccf\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper26e51eeacccf\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper26e51eeacccf\Symfony\Component\Config\FileLocator());
