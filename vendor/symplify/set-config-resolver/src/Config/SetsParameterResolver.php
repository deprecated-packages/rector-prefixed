...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper006a73f0e455\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper006a73f0e455\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper006a73f0e455\Symfony\Component\Config\FileLocator());
