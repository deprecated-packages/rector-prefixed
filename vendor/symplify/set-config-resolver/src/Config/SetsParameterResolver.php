...
namespace RectorPrefix20210129\Symplify\SetConfigResolver\Config;
...
use RectorPrefix20210129\Symplify\SetConfigResolver\SetResolver;
...
final class SetsParameterResolver
{
     ...
     */
    private $setResolver;
    public function __construct(\RectorPrefix20210129\Symplify\SetConfigResolver\SetResolver $setResolver)
    {
     ...
     * @return string[]
     */
    private function resolveSetsFromFileInfo(\RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
     ...
     * @return string[]
     */
    private function resolveSetsParameterFromYamlFileInfo(\RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        $configContent = \RectorPrefix20210129\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
        return (array) ($configContent['parameters'][self::SETS] ?? []);
    }
    /**
     * @return string[]
     */
    private function resolveSetsParameterFromPhpFileInfo(\RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        // php file loader
