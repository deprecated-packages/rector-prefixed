...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper267b3276efc2\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper267b3276efc2\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper267b3276efc2\Symfony\Component\Config\FileLocator());
