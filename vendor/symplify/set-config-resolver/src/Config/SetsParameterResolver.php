...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera143bcca66cb\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera143bcca66cb\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera143bcca66cb\Symfony\Component\Config\FileLocator());
