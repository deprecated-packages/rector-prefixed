...
use RectorPrefix20201231\Symplify\SetConfigResolver\Config\SetsParameterResolver;
 ...
 */
final class SetAwareConfigResolver extends \RectorPrefix20201231\Symplify\SetConfigResolver\AbstractConfigResolver
{
    /**
    ...
    {
        $this->setResolver = new \RectorPrefix20201231\Symplify\SetConfigResolver\SetResolver($setProvider);
        $this->setsParameterResolver = new \RectorPrefix20201231\Symplify\SetConfigResolver\Config\SetsParameterResolver($this->setResolver);
        parent::__construct();
    }
    /**
    ...
    public function resolveSetFromInput(\RectorPrefix20201231\Symfony\Component\Console\Input\InputInterface $input) : ?\RectorPrefix20201231\Symplify\SmartFileSystem\SmartFileInfo
    {
