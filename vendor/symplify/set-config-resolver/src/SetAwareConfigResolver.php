...
use RectorPrefix20210225\Symplify\SetConfigResolver\Config\SetsParameterResolver;
 ...
 */
final class SetAwareConfigResolver extends \RectorPrefix20210225\Symplify\SetConfigResolver\AbstractConfigResolver
{
    /**
    ...
    {
        $this->setResolver = new \RectorPrefix20210225\Symplify\SetConfigResolver\SetResolver($setProvider);
        $this->setsParameterResolver = new \RectorPrefix20210225\Symplify\SetConfigResolver\Config\SetsParameterResolver($this->setResolver);
        parent::__construct();
    }
    /**
