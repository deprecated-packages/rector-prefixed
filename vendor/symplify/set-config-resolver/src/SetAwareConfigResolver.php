...
use RectorPrefix20210226\Symplify\SetConfigResolver\Config\SetsParameterResolver;
 ...
 */
final class SetAwareConfigResolver extends \RectorPrefix20210226\Symplify\SetConfigResolver\AbstractConfigResolver
{
    /**
    ...
    {
        $this->setResolver = new \RectorPrefix20210226\Symplify\SetConfigResolver\SetResolver($setProvider);
        $this->setsParameterResolver = new \RectorPrefix20210226\Symplify\SetConfigResolver\Config\SetsParameterResolver($this->setResolver);
        parent::__construct();
    }
    /**
