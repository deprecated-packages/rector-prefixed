...
final class SetResolver
{
    ...
    public function detectFromName(string $setName) : \RectorPrefix20210222\Symplify\SmartFileSystem\SmartFileInfo
    {
        ...
        if (!$set instanceof \RectorPrefix20210222\Symplify\SetConfigResolver\ValueObject\Set) {
    ...
    private function reportSetNotFound(string $setName) : void
    {
        ...
        throw new \RectorPrefix20210222\Symplify\SetConfigResolver\Exception\SetNotFoundException($message, $setName, $this->setProvider->provideSetNames());
    }
}
