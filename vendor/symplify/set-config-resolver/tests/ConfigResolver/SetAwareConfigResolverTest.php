...
namespace _PhpScoper2a4e7ab1ecbc\Symplify\SetConfigResolver\Tests\ConfigResolver;
...
use _PhpScoper2a4e7ab1ecbc\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider;
use _PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\Exception\FileNotFoundException;
use _PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\SmartFileInfo;
final class SetAwareConfigResolverTest extends \_PhpScoper2a4e7ab1ecbc\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->setAwareConfigResolver = new \_PhpScoper2a4e7ab1ecbc\Symplify\SetConfigResolver\SetAwareConfigResolver(new \_PhpScoper2a4e7ab1ecbc\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider());
    }
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper2a4e7ab1ecbc\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    {
        $basicConfigFileInfo = new \_PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/missing_set_config.php');
        $this->expectException(\_PhpScoper2a4e7ab1ecbc\Symplify\SetConfigResolver\Exception\SetNotFoundException::class);
    ...
    {
        $basicConfigFileInfo = new \_PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/php_config_with_sets.php');
        ...
        $expectedSetFileInfo = new \_PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/some_php_set.php');
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper2a4e7ab1ecbc\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
