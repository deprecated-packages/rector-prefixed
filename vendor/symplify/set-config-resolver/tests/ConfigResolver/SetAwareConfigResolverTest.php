...
final class SetAwareConfigResolverTest extends \_PhpScoper50d83356d739\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper50d83356d739\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper50d83356d739\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
