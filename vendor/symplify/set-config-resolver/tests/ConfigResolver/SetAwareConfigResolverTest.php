...
final class SetAwareConfigResolverTest extends \_PhpScoper88fe6e0ad041\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper88fe6e0ad041\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper88fe6e0ad041\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
