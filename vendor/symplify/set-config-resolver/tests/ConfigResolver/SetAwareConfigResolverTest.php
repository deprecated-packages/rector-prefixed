...
namespace RectorPrefix20210414\Symplify\SetConfigResolver\Tests\ConfigResolver;
...
use RectorPrefix20210414\Symplify\SetConfigResolver\SetAwareConfigResolver;
use RectorPrefix20210414\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider;
...
final class SetAwareConfigResolverTest extends \RectorPrefix20210414\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->setAwareConfigResolver = new \RectorPrefix20210414\Symplify\SetConfigResolver\SetAwareConfigResolver(new \RectorPrefix20210414\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider());
    }
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \RectorPrefix20210414\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    {
        $this->expectException(\RectorPrefix20210414\Symplify\SetConfigResolver\Exception\SetNotFoundException::class);
        $basicConfigFileInfo = new \RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/missing_set_config.php');
    ...
    {
        $basicConfigFileInfo = new \RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/php_config_with_sets.php');
        ...
        $expectedSetFileInfo = new \RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/some_php_set.php');
        $this->assertEquals($expectedSetFileInfo, $setFileInfo);
    }
    public function testMissingFileInInput() : void
    {
        $this->expectException(\RectorPrefix20210414\Symplify\SmartFileSystem\Exception\FileNotFoundException::class);
        $arrayInput = new \RectorPrefix20210414\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
