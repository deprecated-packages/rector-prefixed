...
final class SetAwareConfigResolverTest extends \_PhpScoper006a73f0e455\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
