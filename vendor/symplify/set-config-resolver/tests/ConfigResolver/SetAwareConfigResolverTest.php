...
namespace RectorPrefix20210502\Symplify\SetConfigResolver\Tests\ConfigResolver;
...
final class SetAwareConfigResolverTest extends \RectorPrefix20210502\PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setAwareConfigResolver = new \RectorPrefix20210502\Symplify\SetConfigResolver\SetAwareConfigResolver(new \RectorPrefix20210502\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider());
    }
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \RectorPrefix20210502\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \RectorPrefix20210502\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
