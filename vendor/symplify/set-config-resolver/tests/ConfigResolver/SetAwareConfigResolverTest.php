...
final class SetAwareConfigResolverTest extends \_PhpScoperbf340cb0be9d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperbf340cb0be9d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperbf340cb0be9d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
