...
namespace RectorPrefix20210117\Symplify\SetConfigResolver\Tests\ConfigResolver;

use Iterator;
use RectorPrefix20210117\PHPUnit\Framework\TestCase;
use RectorPrefix20210117\Symfony\Component\Console\Input\ArrayInput;
use RectorPrefix20210117\Symplify\SetConfigResolver\Exception\SetNotFoundException;
use RectorPrefix20210117\Symplify\SetConfigResolver\SetAwareConfigResolver;
use RectorPrefix20210117\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider;
...
final class SetAwareConfigResolverTest extends \RectorPrefix20210117\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->setAwareConfigResolver = new \RectorPrefix20210117\Symplify\SetConfigResolver\SetAwareConfigResolver(new \RectorPrefix20210117\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider());
    }
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \RectorPrefix20210117\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    {
        $basicConfigFileInfo = new \RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/php_config_with_sets.php');
        ...
        $expectedSetFileInfo = new \RectorPrefix20210117\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/some_php_set.php');
        $this->assertEquals($expectedSetFileInfo, $setFileInfo);
    }
    public function testMissingFileInInput() : void
    {
        $this->expectException(\RectorPrefix20210117\Symplify\SmartFileSystem\Exception\FileNotFoundException::class);
        $arrayInput = new \RectorPrefix20210117\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
