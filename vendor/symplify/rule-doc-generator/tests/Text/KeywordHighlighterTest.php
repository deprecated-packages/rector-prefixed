...
final class KeywordHighlighterTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    protected function setUp() : void
    {
        ...
        $this->keywordHighlighter = self::$container->get(\Symplify\RuleDocGenerator\Text\KeywordHighlighter::class);
    }
    /**
