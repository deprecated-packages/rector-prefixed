...
final class DirectoryToMarkdownPrinterTest extends \RectorPrefix20210129\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    public function test(string $directory, string $expectedFile, bool $shouldCategorize = \false) : void
    {
        ...
        $expectedFileInfo = new \RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo($expectedFile);
        \RectorPrefix20210129\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater::updateExpectedFixtureContent($fileContent, $expectedFileInfo);
        $directoryFileInfo = new \RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo($directory);
