...
final class DirectoryToMarkdownPrinterTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    protected function setUp() : void
    {
        ...
        $this->directoryToMarkdownPrinter = self::$container->get(\Symplify\RuleDocGenerator\DirectoryToMarkdownPrinter::class);
    }
    /**
    ...
    public function test(string $directory, string $expectedFile, bool $shouldCategorize = \false) : void
    {
        ...
        $expectedFileInfo = new \Symplify\SmartFileSystem\SmartFileInfo($expectedFile);
        \Symplify\EasyTesting\DataProvider\StaticFixtureUpdater::updateExpectedFixtureContent($fileContent, $expectedFileInfo);
