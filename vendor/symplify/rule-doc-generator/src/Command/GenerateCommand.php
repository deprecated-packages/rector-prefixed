...
final class GenerateCommand extends \RectorPrefix20210122\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\RuleDocGenerator\ValueObject\Option::PATHS, \RectorPrefix20210122\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20210122\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to directory of your project');
        $this->addOption(\Symplify\RuleDocGenerator\ValueObject\Option::OUTPUT_FILE, null, \RectorPrefix20210122\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to output generated markdown file', \getcwd() . '/docs/rules_overview.md');
        $this->addOption(\Symplify\RuleDocGenerator\ValueObject\Option::CATEGORIZE, null, \RectorPrefix20210122\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Group in categories');
    }
    protected function execute(\RectorPrefix20210122\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20210122\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $outputFileInfo = new \RectorPrefix20210122\Symplify\SmartFileSystem\SmartFileInfo($outputFilePath);
