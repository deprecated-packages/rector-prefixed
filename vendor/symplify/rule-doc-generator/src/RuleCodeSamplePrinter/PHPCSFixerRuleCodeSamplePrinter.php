...
final class PHPCSFixerRuleCodeSamplePrinter implements \Symplify\RuleDocGenerator\Contract\RuleCodeSamplePrinterInterface
{
     ...
     */
    public function __construct($diffCodeSamplePrinter, $configuredCodeSamplerPrinter)
    {
    ...
    {
        /** @noRector */
        return \is_a($class, 'RectorPrefix20210317\\PhpCsFixer\\Fixer\\FixerInterface', \true);
    }
    /**
     * @return mixed[]|string[]
     */
