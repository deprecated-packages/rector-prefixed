...
namespace _PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\Printer;

use _PhpScoper0a6b37af0871\Nette\Utils\Strings;
use _PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\Category\CategoryResolver;
use _PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\Printer\CodeSamplePrinter\CodeSamplePrinter;
use _PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\Text\KeywordHighlighter;
use _PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\Lines;
...
final class RuleDefinitionsPrinter
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\Printer\CodeSamplePrinter\CodeSamplePrinter $codeSamplePrinter, \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\Text\KeywordHighlighter $keywordHighlighter, \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\Category\CategoryResolver $categoryResolver)
    {
    ...
    private function printRuleDefinitions(array $ruleDefinitions, array $lines, bool $shouldCategorize = \false) : array
    {
        foreach ($ruleDefinitions as $ruleDefinition) {
            ...
            if ($ruleDefinition->isConfigurable()) {
                $lines[] = \_PhpScoper0a6b37af0871\Symplify\RuleDocGenerator\ValueObject\Lines::CONFIGURE_IT;
            }
    ...
    private function createCategoryMenu(array $ruleDefinitionsByCategory) : array
    {
        ...
        $lines[] = '## Categories';
        foreach ($ruleDefinitionsByCategory as $category => $ruleDefinitions) {
            $lines[] = \sprintf('- [%s](#%s) (%d)', $category, \_PhpScoper0a6b37af0871\Nette\Utils\Strings::webalize($category), \count($ruleDefinitions));
        }
        $lines[] = '<br>';
        return $lines;
    }
