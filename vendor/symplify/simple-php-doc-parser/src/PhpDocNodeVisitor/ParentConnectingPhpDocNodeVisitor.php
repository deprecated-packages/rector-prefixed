 ...
 */
final class ParentConnectingPhpDocNodeVisitor extends \RectorPrefix20210421\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
     * @var Node[]
     */
    ...
    public function enterNode(\PHPStan\PhpDocParser\Ast\Node $node)
    {
        if ($this->stack !== []) {
            ...
            $node->setAttribute(\RectorPrefix20210421\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT, $parentNode);
        }
        $this->stack[] = $node;
        return $node;
    }
