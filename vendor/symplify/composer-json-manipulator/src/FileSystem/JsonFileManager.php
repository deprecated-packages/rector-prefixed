...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperbf340cb0be9d\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperbf340cb0be9d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperbf340cb0be9d\Nette\Utils\Json::encode($json, \_PhpScoperbf340cb0be9d\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
