...
final class JsonFileManager
{
    ...
    {
        return \RectorPrefix2020DecSat\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix2020DecSat\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix2020DecSat\Nette\Utils\Json::encode($json, \RectorPrefix2020DecSat\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
