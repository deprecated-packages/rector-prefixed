...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper88fe6e0ad041\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper88fe6e0ad041\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper88fe6e0ad041\Nette\Utils\Json::encode($json, \_PhpScoper88fe6e0ad041\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
