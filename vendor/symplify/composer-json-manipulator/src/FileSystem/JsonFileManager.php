...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper26e51eeacccf\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper26e51eeacccf\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper26e51eeacccf\Nette\Utils\Json::encode($json, \_PhpScoper26e51eeacccf\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
