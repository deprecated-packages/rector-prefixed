...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperbd5d0c5f7638\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperbd5d0c5f7638\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperbd5d0c5f7638\Nette\Utils\Json::encode($json, \_PhpScoperbd5d0c5f7638\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
