...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperfce0de0de1ce\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperfce0de0de1ce\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperfce0de0de1ce\Nette\Utils\Json::encode($json, \_PhpScoperfce0de0de1ce\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
