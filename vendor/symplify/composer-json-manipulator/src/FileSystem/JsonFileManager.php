...
namespace RectorPrefix20210509\Symplify\ComposerJsonManipulator\FileSystem;
...
use RectorPrefix20210509\Symplify\PackageBuilder\Configuration\StaticEolConfiguration;
...
final class JsonFileManager
{
    ...
    public function __construct(\RectorPrefix20210509\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210509\Symplify\ComposerJsonManipulator\Json\JsonCleaner $jsonCleaner, \RectorPrefix20210509\Symplify\ComposerJsonManipulator\Json\JsonInliner $jsonInliner)
    {
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \RectorPrefix20210509\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix20210509\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \RectorPrefix20210509\Nette\Utils\Json::decode($fileContent, \RectorPrefix20210509\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function printComposerJsonToFilePath(\RectorPrefix20210509\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix20210509\Nette\Utils\Json::encode($json, \RectorPrefix20210509\Nette\Utils\Json::PRETTY) . \RectorPrefix20210509\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
