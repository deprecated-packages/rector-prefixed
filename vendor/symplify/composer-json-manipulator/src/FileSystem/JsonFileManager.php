...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperf18a0c41e2d2\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperf18a0c41e2d2\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperf18a0c41e2d2\Nette\Utils\Json::decode($fileContent, \_PhpScoperf18a0c41e2d2\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperf18a0c41e2d2\Nette\Utils\Json::encode($json, \_PhpScoperf18a0c41e2d2\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
