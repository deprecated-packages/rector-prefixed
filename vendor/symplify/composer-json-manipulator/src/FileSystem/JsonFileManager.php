...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera143bcca66cb\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera143bcca66cb\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera143bcca66cb\Nette\Utils\Json::decode($fileContent, \_PhpScopera143bcca66cb\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera143bcca66cb\Nette\Utils\Json::encode($json, \_PhpScopera143bcca66cb\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
