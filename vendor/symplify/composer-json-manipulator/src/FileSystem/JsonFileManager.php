...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper006a73f0e455\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper006a73f0e455\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper006a73f0e455\Nette\Utils\Json::encode($json, \_PhpScoper006a73f0e455\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
