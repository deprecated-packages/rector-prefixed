...
namespace RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject;

use RectorPrefix20210102\Nette\Utils\Arrays;
use RectorPrefix20210102\Nette\Utils\Strings;
use RectorPrefix20210102\Symplify\ComposerJsonManipulator\Sorter\ComposerPackageSorter;
use RectorPrefix20210102\Symplify\SmartFileSystem\SmartFileInfo;
use RectorPrefix20210102\Symplify\SymplifyKernel\Exception\ShouldNotHappenException;
final class ComposerJson
{
    ...
    {
        $this->composerPackageSorter = new \RectorPrefix20210102\Symplify\ComposerJsonManipulator\Sorter\ComposerPackageSorter();
    }
    public function setOriginalFileInfo(\RectorPrefix20210102\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    public function getAbsoluteAutoloadDirectories() : array
    {
        if ($this->fileInfo === null) {
            throw new \RectorPrefix20210102\Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
    ...
    public function getShortName() : ?string
    {
        ...
        return \RectorPrefix20210102\Nette\Utils\Strings::after($this->name, '/', -1);
    }
    /**
     * @return string[]
     */
    ...
    public function getJsonArray() : array
    {
        $array = [];
        if ($this->name !== null) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::NAME] = $this->name;
        }
        if ($this->description !== null) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::DESCRIPTION] = $this->description;
        }
        if ($this->license !== null) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::LICENSE] = $this->license;
        }
        if ($this->authors !== null) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTHORS] = $this->authors;
        }
        if ($this->type !== null) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::TYPE] = $this->type;
        }
        if ($this->require !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE] = $this->require;
        }
        if ($this->requireDev !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV] = $this->requireDev;
        }
        if ($this->conflicts !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::CONFLICT] = $this->conflicts;
        }
        if ($this->autoload !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD] = $this->autoload;
        }
        if ($this->autoloadDev !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV] = $this->autoloadDev;
        }
        if ($this->repositories !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REPOSITORIES] = $this->repositories;
        }
        if ($this->extra !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::EXTRA] = $this->extra;
        }
        if ($this->bin !== null) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::BIN] = $this->bin;
        }
        if ($this->scripts !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::SCRIPTS] = $this->scripts;
        }
        if ($this->config !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::CONFIG] = $this->config;
        }
        if ($this->replace !== []) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REPLACE] = $this->replace;
        }
        if ($this->minimumStability !== null) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::MINIMUM_STABILITY] = $this->minimumStability;
            $this->moveValueToBack(\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::MINIMUM_STABILITY);
        }
        if ($this->preferStable !== null) {
            $array[\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::PREFER_STABLE] = $this->preferStable;
            $this->moveValueToBack(\RectorPrefix20210102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::PREFER_STABLE);
        }
    ...
    public function getFileInfo() : ?\RectorPrefix20210102\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    private function getAutoloadDirectories() : array
    {
        ...
        return \RectorPrefix20210102\Nette\Utils\Arrays::flatten($autoloadDirectories);
    }
    /**
     * @return string[]
     */
