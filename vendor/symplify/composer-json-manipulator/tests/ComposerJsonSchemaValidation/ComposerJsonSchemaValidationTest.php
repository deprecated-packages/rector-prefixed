...
namespace RectorPrefix20210312\Symplify\ComposerJsonManipulator\Tests\ComposerJsonSchemaValidation;
...
final class ComposerJsonSchemaValidationTest extends \RectorPrefix20210312\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var JsonFileManager
     */
    ...
    public function testCheckEmptyKeysAreRemoved() : void
    {
         ...
         */
        $this->assertArrayHasKey(\RectorPrefix20210312\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV, $sourceJson);
        $this->assertArrayHasKey('auto-scripts', $sourceJson['scripts']);
        $this->assertArrayNotHasKey(\RectorPrefix20210312\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV, $targetJson);
