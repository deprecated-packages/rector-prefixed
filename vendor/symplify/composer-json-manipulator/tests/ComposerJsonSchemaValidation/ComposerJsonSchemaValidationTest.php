...
namespace RectorPrefix20210301\Symplify\ComposerJsonManipulator\Tests\ComposerJsonSchemaValidation;
...
final class ComposerJsonSchemaValidationTest extends \RectorPrefix20210301\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var JsonFileManager
     */
    ...
    protected function setUp() : void
    {
        ...
        $this->jsonFileManager = $this->getService(\RectorPrefix20210301\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    ...
    public function testCheckEmptyKeysAreRemoved() : void
    {
         ...
         */
        $this->assertArrayHasKey(\RectorPrefix20210301\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV, $sourceJson);
        $this->assertArrayHasKey('auto-scripts', $sourceJson['scripts']);
        $this->assertArrayNotHasKey(\RectorPrefix20210301\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV, $targetJson);
