...
namespace RectorPrefix20210322\Symplify\ComposerJsonManipulator\Tests\ComposerJsonFactory;
...
final class ComposerJsonFactoryTest extends \RectorPrefix20210322\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var string
     */
    ...
    protected function setUp() : void
    {
        ...
        $this->composerJsonFactory = $this->getService(\RectorPrefix20210322\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    ...
    public function test() : void
    {
        ...
        $this->assertInstanceOf(\RectorPrefix20210322\Symplify\SmartFileSystem\SmartFileInfo::class, $fileInfo);
