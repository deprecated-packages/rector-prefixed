...
use RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator;
use RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator;
use RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator;
use Symplify\SymfonyPhpConfig\Reflection\ArgumentAndParameterFactory;
use function RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\inline_service;
...
final class ValueObjectInliner
{
     ...
     * @param object $object
     */
    public static function inlineArgumentObject($object, \RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $servicesConfigurator) : \RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator
    {
        ...
        $servicesConfigurator->set($className)->factory([\RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\SymfonyPhpConfig\Reflection\ArgumentAndParameterFactory::class), 'create'])->args([$className, $argumentValues, $propertyValues]);
        return \RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\service($className);
    }
    /**
     ...
     * @param object $object
     */
    private static function inlineSingle($object) : \RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator
    {
        $reflectionClass = new \ReflectionClass($object);
        $className = $reflectionClass->getName();
        $argumentValues = self::resolveArgumentValues($reflectionClass, $object);
        $inlineServiceConfigurator = \RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\Configurator\inline_service($className);
        if ($argumentValues !== []) {
