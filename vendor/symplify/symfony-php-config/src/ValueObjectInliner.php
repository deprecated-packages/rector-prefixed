...
use RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator;
use RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator;
use RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator;
use Symplify\SymfonyPhpConfig\Reflection\ArgumentAndParameterFactory;
use function RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\inline_service;
...
{
    public static function inlineArgumentObject(object $object, \RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $servicesConfigurator) : \RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator
    {
        ...
        $servicesConfigurator->set($className)->factory([\RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\SymfonyPhpConfig\Reflection\ArgumentAndParameterFactory::class), 'create'])->args([$className, $argumentValues, $propertyValues]);
        return \RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\service($className);
    }
    /**
    ...
    private static function inlineSingle(object $object) : \RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator
    {
        $reflectionClass = new \ReflectionClass($object);
        $className = $reflectionClass->getName();
        $argumentValues = self::resolveArgumentValues($reflectionClass, $object);
        $inlineServiceConfigurator = \RectorPrefix20210313\Symfony\Component\DependencyInjection\Loader\Configurator\inline_service($className);
        if ($argumentValues !== []) {
