...
final class ConstantNodeFactory
{
    ...
    public function __construct(\RectorPrefix20210228\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider)
    {
    ...
    {
        if (\RectorPrefix20210228\Nette\Utils\Strings::contains($value, '::')) {
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\RectorPrefix20210228\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
