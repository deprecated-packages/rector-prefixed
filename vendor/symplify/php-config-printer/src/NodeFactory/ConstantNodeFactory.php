...
final class ConstantNodeFactory
{
    ...
    public function __construct(\RectorPrefix20210129\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider)
    {
    ...
    public function createConstantIfValue(string $value) : ?\PhpParser\Node\Expr
    {
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\RectorPrefix20210129\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
