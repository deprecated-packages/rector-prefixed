...
final class ConstantNodeFactory
{
    ...
    public function __construct(\RectorPrefix20210303\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider)
    {
    ...
    public function createConstantIfValue(string $value) : ?\PhpParser\Node\Expr
    {
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\RectorPrefix20210303\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
