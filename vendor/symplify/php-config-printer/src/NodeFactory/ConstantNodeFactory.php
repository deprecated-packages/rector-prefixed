...
final class ConstantNodeFactory
{
    ...
    public function __construct(\RectorPrefix20210227\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider)
    {
    ...
    {
        if (\RectorPrefix20210227\Nette\Utils\Strings::contains($value, '::')) {
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\RectorPrefix20210227\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
