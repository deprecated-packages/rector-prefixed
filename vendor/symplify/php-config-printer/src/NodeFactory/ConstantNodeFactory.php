...
final class ConstantNodeFactory
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider)
    {
     ...
     */
    public function createConstantIfValue(string $value) : ?\_PhpScoper0a6b37af0871\PhpParser\Node\Expr
    {
        if (\_PhpScoper0a6b37af0871\Nette\Utils\Strings::contains($value, '::')) {
            ...
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\ClassConstFetch(new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($class), $constant);
        }
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\_PhpScoper0a6b37af0871\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\ConstFetch(new \_PhpScoper0a6b37af0871\PhpParser\Node\Name($constantName));
        }
        return null;
    }
}
