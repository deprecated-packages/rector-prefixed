...
use RectorPrefix20210105\Symplify\PhpConfigPrinter\Contract\NestedCaseConverterInterface;
use RectorPrefix20210105\Symplify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory;
...
final class ContainerConfiguratorReturnClosureFactory
{
     ...
     */
    public function __construct(\RectorPrefix20210105\Symplify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory $configuratorClosureNodeFactory, array $caseConverters, array $nestedCaseConverters)
    {
    ...
    {
        if ($key === \RectorPrefix20210105\Symplify\PhpConfigPrinter\ValueObject\YamlKey::SERVICES) {
            $nodes[] = $this->createInitializeAssign(\RectorPrefix20210105\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES, \RectorPrefix20210105\Symplify\PhpConfigPrinter\ValueObject\MethodName::SERVICES);
        }
        if ($key === \RectorPrefix20210105\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARAMETERS) {
            $nodes[] = $this->createInitializeAssign(\RectorPrefix20210105\Symplify\PhpConfigPrinter\ValueObject\VariableName::PARAMETERS, \RectorPrefix20210105\Symplify\PhpConfigPrinter\ValueObject\MethodName::PARAMETERS);
        }
        return $nodes;
    }
}
