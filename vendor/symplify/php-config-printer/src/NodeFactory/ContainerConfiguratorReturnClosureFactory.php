...
use _PhpScoper0a2ac50786fa\Symplify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory;
...
final class ContainerConfiguratorReturnClosureFactory
{
     ...
     */
    public function __construct(\_PhpScoper0a2ac50786fa\Symplify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory $configuratorClosureNodeFactory, array $caseConverters, array $nestedCaseConverters)
    {
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
    ...
    {
        if ($key === \_PhpScoper0a2ac50786fa\Symplify\PhpConfigPrinter\ValueObject\YamlKey::SERVICES) {
            $nodes[] = $this->createInitializeAssign(\_PhpScoper0a2ac50786fa\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES, \_PhpScoper0a2ac50786fa\Symplify\PhpConfigPrinter\ValueObject\MethodName::SERVICES);
        }
        if ($key === \_PhpScoper0a2ac50786fa\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARAMETERS) {
            $nodes[] = $this->createInitializeAssign(\_PhpScoper0a2ac50786fa\Symplify\PhpConfigPrinter\ValueObject\VariableName::PARAMETERS, \_PhpScoper0a2ac50786fa\Symplify\PhpConfigPrinter\ValueObject\MethodName::PARAMETERS);
        }
        return $nodes;
    }
}
