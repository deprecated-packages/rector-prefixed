...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    {
        if ($key === \RectorPrefix20210122\Symplify\PhpConfigPrinter\ValueObject\YamlKey::SERVICES) {
            $nodes[] = $this->createInitializeAssign(\RectorPrefix20210122\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES, \RectorPrefix20210122\Symplify\PhpConfigPrinter\ValueObject\MethodName::SERVICES);
        }
        if ($key === \RectorPrefix20210122\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARAMETERS) {
