...
final class ArgsNodeFactory
{
    ...
    private function createServiceReferenceFromTaggedValue(\_PhpScoperbd5d0c5f7638\Symfony\Component\Yaml\Tag\TaggedValue $taggedValue) : \PhpParser\Node\Expr
    {
    ...
    private function resolveStringExpr(string $value, bool $skipServiceReference, bool $skipClassesToConstantReference) : \PhpParser\Node\Expr
    {
        ...
        if (\_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::startsWith($value, '@=')) {
            $value = \ltrim($value, '@=');
        ...
        if (\_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::startsWith($value, '@') && !$this->isFilePath($value)) {
    ...
    {
        return (bool) \_PhpScoperbd5d0c5f7638\Nette\Utils\Strings::match($value, self::TWIG_HTML_XML_SUFFIX_REGEX);
    }
