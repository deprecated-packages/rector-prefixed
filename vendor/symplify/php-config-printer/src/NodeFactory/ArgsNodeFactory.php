...
final class ArgsNodeFactory
{
    ...
    private function createServiceReferenceFromTaggedValue(\_PhpScoper26e51eeacccf\Symfony\Component\Yaml\Tag\TaggedValue $taggedValue) : \PhpParser\Node\Expr
    {
    ...
    private function resolveStringExpr(string $value, bool $skipServiceReference, bool $skipClassesToConstantReference) : \PhpParser\Node\Expr
    {
        ...
        if (\_PhpScoper26e51eeacccf\Nette\Utils\Strings::startsWith($value, '@=')) {
            $value = \ltrim($value, '@=');
        ...
        if (\_PhpScoper26e51eeacccf\Nette\Utils\Strings::startsWith($value, '@') && !$this->isFilePath($value)) {
    ...
    {
        return (bool) \_PhpScoper26e51eeacccf\Nette\Utils\Strings::match($value, self::TWIG_HTML_XML_SUFFIX_REGEX);
    }
