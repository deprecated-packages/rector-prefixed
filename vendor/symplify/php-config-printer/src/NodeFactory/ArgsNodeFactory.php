...
final class ArgsNodeFactory
{
    ...
    private function createServiceReferenceFromTaggedValue(\_PhpScopera143bcca66cb\Symfony\Component\Yaml\Tag\TaggedValue $taggedValue) : \PhpParser\Node\Expr
    {
    ...
    private function resolveStringExpr(string $value, bool $skipServiceReference, bool $skipClassesToConstantReference) : \PhpParser\Node\Expr
    {
        ...
        if (\_PhpScopera143bcca66cb\Nette\Utils\Strings::startsWith($value, '@=')) {
            $value = \ltrim($value, '@=');
        ...
        if (\_PhpScopera143bcca66cb\Nette\Utils\Strings::startsWith($value, '@') && !$this->isFilePath($value)) {
    ...
    {
        return (bool) \_PhpScopera143bcca66cb\Nette\Utils\Strings::match($value, self::TWIG_HTML_XML_SUFFIX_REGEX);
    }
