...
namespace RectorPrefix20210122\Symplify\PhpConfigPrinter\Configuration;
...
final class SymfonyFunctionNameProvider
{
    ...
    public function __construct(\RectorPrefix20210122\Symplify\PhpConfigPrinter\Contract\SymfonyVersionFeatureGuardInterface $symfonyVersionFeatureGuard)
    {
