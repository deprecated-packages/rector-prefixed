...
final class BindAutowireAutoconfigureServiceOptionKeyYamlToPhpFactory implements \RectorPrefix20210226\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
     * @var CommonNodeFactory
     */
    private $commonNodeFactory;
    public function __construct(\RectorPrefix20210226\Symplify\PhpConfigPrinter\NodeFactory\CommonNodeFactory $commonNodeFactory)
    {
    ...
    {
        return \in_array($key, [\RectorPrefix20210226\Symplify\PhpConfigPrinter\ValueObject\YamlServiceKey::BIND, \RectorPrefix20210226\Symplify\PhpConfigPrinter\ValueObject\YamlKey::AUTOWIRE, \RectorPrefix20210226\Symplify\PhpConfigPrinter\ValueObject\YamlKey::AUTOCONFIGURE], \true);
    }
}
