...
final class ArgumentsServiceOptionKeyYamlToPhpFactory implements \RectorPrefix20201229\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    {
        return $key === \RectorPrefix20201229\Symplify\PhpConfigPrinter\ValueObject\YamlServiceKey::ARGUMENTS;
    }
    private function hasNamedArguments(array $data) : bool
    {
        ...
        foreach (\array_keys($data) as $key) {
            if (!\RectorPrefix20201229\Nette\Utils\Strings::startsWith((string) $key, '$')) {
                return \false;
            }
        }
        return \true;
