...
final class ArgumentsServiceOptionKeyYamlToPhpFactory implements \RectorPrefix20201231\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    {
        return $key === \RectorPrefix20201231\Symplify\PhpConfigPrinter\ValueObject\YamlServiceKey::ARGUMENTS;
    }
    private function hasNamedArguments(array $data) : bool
    {
        ...
        foreach (\array_keys($data) as $key) {
            if (!\RectorPrefix20201231\Nette\Utils\Strings::startsWith((string) $key, '$')) {
                return \false;
            }
        }
        return \true;
