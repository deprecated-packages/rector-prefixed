...
final class ArgumentsServiceOptionKeyYamlToPhpFactory implements \RectorPrefix20210108\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    {
        return $key === \RectorPrefix20210108\Symplify\PhpConfigPrinter\ValueObject\YamlServiceKey::ARGUMENTS;
    }
    private function hasNamedArguments(array $data) : bool
    {
        ...
        foreach (\array_keys($data) as $key) {
            if (!\RectorPrefix20210108\Nette\Utils\Strings::startsWith((string) $key, '$')) {
                return \false;
            }
        }
        return \true;
