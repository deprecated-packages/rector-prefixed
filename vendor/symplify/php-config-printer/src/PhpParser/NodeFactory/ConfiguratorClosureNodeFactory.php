...
use _PhpScoper267b3276efc2\Symfony\Component\Routing\Loader\Configurator\RoutingConfigurator;
...
final class ConfiguratorClosureNodeFactory
{
    ...
    private function createRoutingConfiguratorParam() : \PhpParser\Node\Param
    {
        ...
        return new \PhpParser\Node\Param($containerConfiguratorVariable, null, new \PhpParser\Node\Name\FullyQualified(\_PhpScoper267b3276efc2\Symfony\Component\Routing\Loader\Configurator\RoutingConfigurator::class));
    }
