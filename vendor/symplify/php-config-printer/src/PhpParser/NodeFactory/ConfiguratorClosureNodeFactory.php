...
namespace RectorPrefix20210317\Symplify\PhpConfigPrinter\PhpParser\NodeFactory;
...
use RectorPrefix20210317\Symfony\Component\Routing\Loader\Configurator\RoutingConfigurator;
...
final class ConfiguratorClosureNodeFactory
{
    ...
    private function createContainerConfiguratorParam() : \PhpParser\Node\Param
    {
        ...
        return new \PhpParser\Node\Param($containerConfiguratorVariable, null, new \PhpParser\Node\Name\FullyQualified(\RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator::class));
    }
    private function createRoutingConfiguratorParam() : \PhpParser\Node\Param
    {
        $containerConfiguratorVariable = new \PhpParser\Node\Expr\Variable(\RectorPrefix20210317\Symplify\PhpConfigPrinter\ValueObject\VariableName::ROUTING_CONFIGURATOR);
        return new \PhpParser\Node\Param($containerConfiguratorVariable, null, new \PhpParser\Node\Name\FullyQualified(\RectorPrefix20210317\Symfony\Component\Routing\Loader\Configurator\RoutingConfigurator::class));
    }
