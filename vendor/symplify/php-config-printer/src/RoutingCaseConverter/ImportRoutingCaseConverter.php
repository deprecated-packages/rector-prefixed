...
namespace RectorPrefix20210119\Symplify\PhpConfigPrinter\RoutingCaseConverter;
...
final class ImportRoutingCaseConverter implements \RectorPrefix20210119\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    {
        $variable = new \PhpParser\Node\Expr\Variable(\RectorPrefix20210119\Symplify\PhpConfigPrinter\ValueObject\VariableName::ROUTING_CONFIGURATOR);
