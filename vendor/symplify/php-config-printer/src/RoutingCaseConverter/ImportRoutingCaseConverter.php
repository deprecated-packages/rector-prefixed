...
namespace RectorPrefix20210109\Symplify\PhpConfigPrinter\RoutingCaseConverter;
...
final class ImportRoutingCaseConverter implements \RectorPrefix20210109\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    {
        $variable = new \PhpParser\Node\Expr\Variable(\RectorPrefix20210109\Symplify\PhpConfigPrinter\ValueObject\VariableName::ROUTING_CONFIGURATOR);
