...
namespace RectorPrefix20210306\Symplify\PhpConfigPrinter\RoutingCaseConverter;

use PhpParser\Node\Arg;
use PhpParser\Node\Expr\MethodCall;
use PhpParser\Node\Expr\Variable;
use PhpParser\Node\Stmt\Expression;
use RectorPrefix20210306\Symplify\PackageBuilder\Strings\StringFormatConverter;
use RectorPrefix20210306\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface;
...
final class ImportRoutingCaseConverter implements \RectorPrefix20210306\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    public function __construct(\RectorPrefix20210306\Symplify\PhpConfigPrinter\NodeFactory\ArgsNodeFactory $argsNodeFactory)
    {
        $this->argsNodeFactory = $argsNodeFactory;
        $this->stringFormatConverter = new \RectorPrefix20210306\Symplify\PackageBuilder\Strings\StringFormatConverter();
    }
    ...
    {
        $variable = new \PhpParser\Node\Expr\Variable(\RectorPrefix20210306\Symplify\PhpConfigPrinter\ValueObject\VariableName::ROUTING_CONFIGURATOR);
