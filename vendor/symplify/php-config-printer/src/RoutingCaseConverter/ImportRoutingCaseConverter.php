...
namespace RectorPrefix20210301\Symplify\PhpConfigPrinter\RoutingCaseConverter;
...
use RectorPrefix20210301\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface;
...
final class ImportRoutingCaseConverter implements \RectorPrefix20210301\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    {
        $variable = new \PhpParser\Node\Expr\Variable(\RectorPrefix20210301\Symplify\PhpConfigPrinter\ValueObject\VariableName::ROUTING_CONFIGURATOR);
