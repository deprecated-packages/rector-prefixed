...
namespace RectorPrefix20210113\Symplify\PhpConfigPrinter\RoutingCaseConverter;
...
use RectorPrefix20210113\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface;
...
final class ImportRoutingCaseConverter implements \RectorPrefix20210113\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    public function __construct(\RectorPrefix20210113\Symplify\PhpConfigPrinter\NodeFactory\ArgsNodeFactory $argsNodeFactory)
    {
    ...
    {
        $variable = new \PhpParser\Node\Expr\Variable(\RectorPrefix20210113\Symplify\PhpConfigPrinter\ValueObject\VariableName::ROUTING_CONFIGURATOR);
