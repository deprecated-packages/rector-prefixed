...
use _PhpScoper26e51eeacccf\PhpCsFixer\Fixer\Comment\HeaderCommentFixer;
use ReflectionClass;
...
final class CheckerServiceParametersShifter
{
    ...
    public function __construct()
    {
        ...
        $reflectionClass = new \ReflectionClass(\_PhpScoper26e51eeacccf\Symfony\Component\DependencyInjection\Loader\YamlFileLoader::class);
    ...
    private function processServices(array $services) : array
    {
        foreach ($services as $serviceName => $serviceDefinition) {
            ...
            if (\_PhpScoper26e51eeacccf\Nette\Utils\Strings::endsWith($serviceName, 'Fixer')) {
                $services = $this->processFixer($services, $serviceName, $serviceDefinition);
            }
            if (\_PhpScoper26e51eeacccf\Nette\Utils\Strings::endsWith($serviceName, 'Sniff')) {
    ...
    {
        return \_PhpScoper26e51eeacccf\Nette\Utils\Strings::endsWith($checker, 'Fixer') || \_PhpScoper26e51eeacccf\Nette\Utils\Strings::endsWith($checker, 'Sniff');
    }
    /**
     * @param mixed[] $services
    ...
    private function correctHeader(string $checker, array $serviceDefinition) : array
    {
        ...
        if ($checker !== \_PhpScoper26e51eeacccf\PhpCsFixer\Fixer\Comment\HeaderCommentFixer::class) {
    ...
    private function escapeValue($value)
    {
        ...
        return \_PhpScoper26e51eeacccf\Nette\Utils\Strings::replace($value, '#^@#', '@@');
    }
}
