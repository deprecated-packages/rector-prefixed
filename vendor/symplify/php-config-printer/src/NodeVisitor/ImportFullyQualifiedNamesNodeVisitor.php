...
namespace RectorPrefix20210106\Symplify\PhpConfigPrinter\NodeVisitor;
...
use RectorPrefix20210106\Symplify\PhpConfigPrinter\Naming\ClassNaming;
final class ImportFullyQualifiedNamesNodeVisitor extends \PhpParser\NodeVisitorAbstract
{
     ...
     */
    private $nameImports = [];
    public function __construct(\RectorPrefix20210106\Symplify\PhpConfigPrinter\Naming\ClassNaming $classNaming)
    {
    ...
    public function enterNode(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\RectorPrefix20210106\Nette\Utils\Strings::startsWith($fullyQualifiedName, '\\')) {
