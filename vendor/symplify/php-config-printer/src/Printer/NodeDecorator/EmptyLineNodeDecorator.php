...
namespace _PhpScoper0a6b37af0871\Symplify\PhpConfigPrinter\Printer\NodeDecorator;
...
final class EmptyLineNodeDecorator
{
    ...
    public function decorate(array $stmts) : void
    {
        ...
        $closure = $this->nodeFinder->findFirstInstanceOf($stmts, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\Closure::class);
        if ($closure === null) {
        ...
        foreach ($closure->stmts as $key => $closureStmt) {
            if ($this->shouldAddEmptyLineBeforeStatement($key, $closureStmt)) {
                $newStmts[] = new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Nop();
            }
            $newStmts[] = $closureStmt;
        }
        $closure->stmts = $newStmts;
    }
    private function shouldAddEmptyLineBeforeStatement(int $key, \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt $stmt) : bool
    {
        ...
        return $expr instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall;
    }
}
