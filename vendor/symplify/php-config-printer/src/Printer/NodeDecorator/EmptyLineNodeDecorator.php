...
namespace _PhpScoperb75b35f52b74\Symplify\PhpConfigPrinter\Printer\NodeDecorator;
...
final class EmptyLineNodeDecorator
{
    ...
    public function decorate(array $stmts) : void
    {
        ...
        $closure = $this->nodeFinder->findFirstInstanceOf($stmts, \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Closure::class);
        if ($closure === null) {
        ...
        foreach ($closure->stmts as $key => $closureStmt) {
            if ($this->shouldAddEmptyLineBeforeStatement($key, $closureStmt)) {
                $newStmts[] = new \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Nop();
            }
            $newStmts[] = $closureStmt;
        }
        $closure->stmts = $newStmts;
    }
    private function shouldAddEmptyLineBeforeStatement(int $key, \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt $stmt) : bool
    {
        ...
        return $expr instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\MethodCall;
    }
}
