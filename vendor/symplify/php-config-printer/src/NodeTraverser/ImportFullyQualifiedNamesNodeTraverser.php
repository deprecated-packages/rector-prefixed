...
namespace RectorPrefix20210307\Symplify\PhpConfigPrinter\NodeTraverser;
...
use RectorPrefix20210307\Symplify\PhpConfigPrinter\NodeVisitor\ImportFullyQualifiedNamesNodeVisitor;
final class ImportFullyQualifiedNamesNodeTraverser
{
    ...
    public function __construct(\RectorPrefix20210307\Symplify\PhpConfigPrinter\NodeVisitor\ImportFullyQualifiedNamesNodeVisitor $importFullyQualifiedNamesNodeVisitor, \PhpParser\BuilderFactory $builderFactory)
    {
    ...
    private function createUses(array $nameImports) : array
    {
        ...
        foreach ($nameImports as $nameImport) {
            $shortNameImport = \RectorPrefix20210307\Nette\Utils\Strings::after($nameImport, '\\', -1);
