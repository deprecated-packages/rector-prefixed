...
namespace RectorPrefix20210119\Symplify\PhpConfigPrinter\NodeTraverser;
...
use RectorPrefix20210119\Symplify\PhpConfigPrinter\NodeVisitor\ImportFullyQualifiedNamesNodeVisitor;
final class ImportFullyQualifiedNamesNodeTraverser
{
    ...
    public function __construct(\RectorPrefix20210119\Symplify\PhpConfigPrinter\NodeVisitor\ImportFullyQualifiedNamesNodeVisitor $importFullyQualifiedNamesNodeVisitor, \PhpParser\BuilderFactory $builderFactory)
    {
    ...
    private function createUses(array $nameImports) : array
    {
        ...
        foreach ($nameImports as $nameImport) {
            $shortNameImport = \RectorPrefix20210119\Nette\Utils\Strings::after($nameImport, '\\', -1);
