...
namespace RectorPrefix20210111\Symplify\PhpConfigPrinter\NodeTraverser;
...
use RectorPrefix20210111\Symplify\PhpConfigPrinter\NodeVisitor\ImportFullyQualifiedNamesNodeVisitor;
final class ImportFullyQualifiedNamesNodeTraverser
{
    ...
    public function __construct(\RectorPrefix20210111\Symplify\PhpConfigPrinter\NodeVisitor\ImportFullyQualifiedNamesNodeVisitor $importFullyQualifiedNamesNodeVisitor, \PhpParser\BuilderFactory $builderFactory)
    {
    ...
    private function createUses(array $nameImports) : array
    {
        ...
        foreach ($nameImports as $nameImport) {
            $shortNameImport = \RectorPrefix20210111\Nette\Utils\Strings::after($nameImport, '\\', -1);
