 ...
 *         class: Other <---
 */
final class ClassServiceCaseConverter implements \RectorPrefix20201228\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    {
        $args = $this->argsNodeFactory->createFromValues([$key, $values[\RectorPrefix20201228\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]]);
        $setMethodCall = new \PhpParser\Node\Expr\MethodCall(new \PhpParser\Node\Expr\Variable(\RectorPrefix20201228\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \RectorPrefix20201228\Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
        unset($values[\RectorPrefix20201228\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return isset($values[\RectorPrefix20201228\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]) && !isset($values[\RectorPrefix20201228\Symplify\PhpConfigPrinter\ValueObject\YamlKey::ALIAS]);
    }
}
