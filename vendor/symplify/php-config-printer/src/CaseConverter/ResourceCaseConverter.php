...
final class ResourceCaseConverter implements \RectorPrefix20210307\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function __construct(\RectorPrefix20210307\Symplify\PhpConfigPrinter\NodeFactory\Service\ServicesPhpNodeFactory $servicesPhpNodeFactory)
    {
    ...
    {
        return isset($values[\RectorPrefix20210307\Symplify\PhpConfigPrinter\ValueObject\YamlKey::RESOURCE]);
    }
}
