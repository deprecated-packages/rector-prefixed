 ...
 */
final class NameOnlyServiceCaseConverter implements \RectorPrefix20210124\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \PhpParser\Node\Expr\MethodCall(new \PhpParser\Node\Expr\Variable(\RectorPrefix20210124\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \PhpParser\Node\Arg($classConstFetch)]);
