 ...
 *     key: value
 */
final class ExtensionConverter implements \RectorPrefix20210226\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var ArgsNodeFactory
     */
     ...
     */
    private $yamlKey;
    public function __construct(\RectorPrefix20210226\Symplify\PhpConfigPrinter\NodeFactory\ArgsNodeFactory $argsNodeFactory, \RectorPrefix20210226\Symplify\PhpConfigPrinter\ValueObject\YamlKey $yamlKey)
    {
    ...
    public function convertToMethodCall($key, $values) : \PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, \RectorPrefix20210226\Symplify\PhpConfigPrinter\ValueObject\MethodName::EXTENSION, $args);
