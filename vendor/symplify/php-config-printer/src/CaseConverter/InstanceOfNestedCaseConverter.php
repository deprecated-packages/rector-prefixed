...
final class InstanceOfNestedCaseConverter
{
    ...
    public function __construct(\RectorPrefix20210210\Symplify\PhpConfigPrinter\NodeFactory\CommonNodeFactory $commonNodeFactory, \RectorPrefix20210210\Symplify\PhpConfigPrinter\NodeFactory\Service\ServiceOptionNodeFactory $serviceOptionNodeFactory)
    {
    ...
    public function convertToMethodCall($key, $values) : \PhpParser\Node\Stmt\Expression
    {
        ...
        $instanceofMethodCall = new \PhpParser\Node\Expr\MethodCall($servicesVariable, \RectorPrefix20210210\Symplify\PhpConfigPrinter\ValueObject\MethodName::INSTANCEOF, $args);
    ...
    public function isMatch(string $rootKey, $subKey) : bool
    {
        ...
        return $subKey === \RectorPrefix20210210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::_INSTANCEOF;
    }
}
