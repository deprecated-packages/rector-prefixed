...
use RectorPrefix20210226\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider;
 ...
 * parameters: <---
 */
final class ParameterCaseConverter implements \RectorPrefix20210226\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    {
        return $rootKey === \RectorPrefix20210226\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARAMETERS;
    }
    public function convertToMethodCall($key, $values) : \PhpParser\Node\Stmt\Expression
    {
        ...
        $parametersVariable = new \PhpParser\Node\Expr\Variable(\RectorPrefix20210226\Symplify\PhpConfigPrinter\ValueObject\VariableName::PARAMETERS);
        $methodCall = new \PhpParser\Node\Expr\MethodCall($parametersVariable, \RectorPrefix20210226\Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
