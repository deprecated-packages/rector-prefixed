...
use RectorPrefix20210210\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider;
 ...
 * parameters: <---
 */
final class ParameterCaseConverter implements \RectorPrefix20210210\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    public function __construct(\RectorPrefix20210210\Symplify\PhpConfigPrinter\NodeFactory\ArgsNodeFactory $argsNodeFactory, \RectorPrefix20210210\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider $currentFilePathProvider, \RectorPrefix20210210\Symplify\PhpConfigPrinter\NodeFactory\CommonNodeFactory $commonNodeFactory)
    {
    ...
    {
        return $rootKey === \RectorPrefix20210210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARAMETERS;
    }
    public function convertToMethodCall($key, $values) : \PhpParser\Node\Stmt\Expression
    {
        ...
        $parametersVariable = new \PhpParser\Node\Expr\Variable(\RectorPrefix20210210\Symplify\PhpConfigPrinter\ValueObject\VariableName::PARAMETERS);
        $methodCall = new \PhpParser\Node\Expr\MethodCall($parametersVariable, \RectorPrefix20210210\Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
