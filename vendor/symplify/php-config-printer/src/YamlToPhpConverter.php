...
final class YamlToPhpConverter
{
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScoperf18a0c41e2d2\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScoperf18a0c41e2d2\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
