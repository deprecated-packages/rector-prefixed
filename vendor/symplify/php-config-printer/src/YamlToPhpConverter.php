...
final class YamlToPhpConverter
{
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScoper88fe6e0ad041\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScoper88fe6e0ad041\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
