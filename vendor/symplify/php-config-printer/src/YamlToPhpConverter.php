...
final class YamlToPhpConverter
{
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \RectorPrefix2020DecSat\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \RectorPrefix2020DecSat\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
