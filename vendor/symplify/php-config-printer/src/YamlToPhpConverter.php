...
namespace RectorPrefix20210306\Symplify\PhpConfigPrinter;
...
use RectorPrefix20210306\Symplify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory;
use RectorPrefix20210306\Symplify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory;
use RectorPrefix20210306\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter;
use RectorPrefix20210306\Symplify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter;
/**
...
final class YamlToPhpConverter
{
    ...
    public function __construct(\RectorPrefix20210306\Symfony\Component\Yaml\Parser $yamlParser, \RectorPrefix20210306\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, \RectorPrefix20210306\Symplify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory $returnClosureNodesFactory, \RectorPrefix20210306\Symplify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory $routingConfiguratorReturnClosureFactory, \RectorPrefix20210306\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider, \RectorPrefix20210306\Symplify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter $checkerServiceParametersShifter)
    {
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \RectorPrefix20210306\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \RectorPrefix20210306\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
