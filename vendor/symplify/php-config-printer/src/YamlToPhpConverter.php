...
final class YamlToPhpConverter
{
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScoperfce0de0de1ce\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScoperfce0de0de1ce\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
