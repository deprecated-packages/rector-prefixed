...
final class YamlToPhpConverter
{
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScopera143bcca66cb\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScopera143bcca66cb\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
