...
final class YamlToPhpConverter
{
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScoperbf340cb0be9d\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScoperbf340cb0be9d\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
