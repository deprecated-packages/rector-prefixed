...
final class CompleteUnifiedDiffOutputBuilderFactory
{
     ...
     * @api
     */
    public function create() : \RectorPrefix2020DecSat\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder
    {
        $unifiedDiffOutputBuilder = new \RectorPrefix2020DecSat\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder('');
