...
namespace RectorPrefix20201230\Symplify\MarkdownDiff\Differ;
...
final class MarkdownDiffer
{
    ...
    public function __construct(\RectorPrefix20201230\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \RectorPrefix20201230\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \RectorPrefix20201230\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
