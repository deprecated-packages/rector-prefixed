...
namespace _PhpScoper0a6b37af0871\Symplify\MarkdownDiff\Differ;
...
final class MarkdownDiffer
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \_PhpScoper0a6b37af0871\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \_PhpScoper0a6b37af0871\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
