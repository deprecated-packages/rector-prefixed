...
namespace RectorPrefix20210124\Symplify\MarkdownDiff\Differ;
...
final class MarkdownDiffer
{
    ...
    public function __construct(\RectorPrefix20210124\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \RectorPrefix20210124\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \RectorPrefix20210124\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
