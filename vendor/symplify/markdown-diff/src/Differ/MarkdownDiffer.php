...
namespace RectorPrefix20210109\Symplify\MarkdownDiff\Differ;
...
final class MarkdownDiffer
{
    ...
    public function __construct(\RectorPrefix20210109\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \RectorPrefix20210109\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \RectorPrefix20210109\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
