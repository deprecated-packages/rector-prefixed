...
final class MarkdownDiffer
{
    ...
    public function __construct(\_PhpScoper50d83356d739\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \_PhpScoper50d83356d739\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \_PhpScoper50d83356d739\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
