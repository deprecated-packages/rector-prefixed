...
namespace RectorPrefix20210204\Symplify\MarkdownDiff\Differ;
...
final class MarkdownDiffer
{
    ...
    public function __construct(\RectorPrefix20210204\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \RectorPrefix20210204\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \RectorPrefix20210204\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
