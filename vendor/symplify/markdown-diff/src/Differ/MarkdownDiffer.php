...
final class MarkdownDiffer
{
    ...
    public function __construct(\_PhpScoper5b8c9e9ebd21\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
