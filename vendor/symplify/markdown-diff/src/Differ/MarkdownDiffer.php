...
final class MarkdownDiffer
{
    ...
    public function __construct(\_PhpScoperf18a0c41e2d2\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \_PhpScoperf18a0c41e2d2\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
