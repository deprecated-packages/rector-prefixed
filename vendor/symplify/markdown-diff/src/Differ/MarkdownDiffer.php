...
namespace RectorPrefix20210303\Symplify\MarkdownDiff\Differ;
...
final class MarkdownDiffer
{
    ...
    public function __construct(\RectorPrefix20210303\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \RectorPrefix20210303\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \RectorPrefix20210303\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
