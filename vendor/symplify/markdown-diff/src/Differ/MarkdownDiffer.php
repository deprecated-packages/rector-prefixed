...
final class MarkdownDiffer
{
    ...
    public function __construct(\_PhpScoper006a73f0e455\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \_PhpScoper006a73f0e455\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \_PhpScoper006a73f0e455\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
