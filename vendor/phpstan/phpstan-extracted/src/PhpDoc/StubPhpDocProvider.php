...
class StubPhpDocProvider
{
     ...
     */
    public function __construct(\_PhpScoper2a4e7ab1ecbc\PHPStan\Parser\Parser $parser, \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\FileTypeMapper $fileTypeMapper, array $stubFiles)
    {
        $this->parser = $parser;
        $this->fileTypeMapper = $fileTypeMapper;
        $this->stubFiles = $stubFiles;
    }
    public function findClassPhpDoc(string $className) : ?\_PhpScoper2a4e7ab1ecbc\PHPStan\PhpDoc\ResolvedPhpDocBlock
    {
    ...
    public function findPropertyPhpDoc(string $className, string $propertyName) : ?\_PhpScoper2a4e7ab1ecbc\PHPStan\PhpDoc\ResolvedPhpDocBlock
    {
        if (!$this->isKnownClass($className)) {
            return null;
        }
     ...
     */
    public function findMethodPhpDoc(string $className, string $methodName, array $positionalParameterNames) : ?\_PhpScoper2a4e7ab1ecbc\PHPStan\PhpDoc\ResolvedPhpDocBlock
    {
        if (!$this->isKnownClass($className)) {
            return null;
        }
    ...
    public function findFunctionPhpDoc(string $functionName) : ?\_PhpScoper2a4e7ab1ecbc\PHPStan\PhpDoc\ResolvedPhpDocBlock
    {
    ...
    private function initializeKnownElementNode(string $stubFile, \_PhpScoper2a4e7ab1ecbc\PhpParser\Node $node) : void
    {
        ...
        if (!$node instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\Class_ && !$node instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\Interface_ && !$node instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\Trait_) {
            return;
        }
        ...
        foreach ($node->stmts as $stmt) {
            ...
            if ($stmt instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\Property) {
                ...
                $this->knownMethodsParameterNames[$className][$methodName] = \array_map(static function (\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Param $param) : string {
