...
class StubPhpDocProvider
{
     ...
     */
    public function __construct(\_PhpScoperb75b35f52b74\PHPStan\Parser\Parser $parser, \_PhpScoperb75b35f52b74\PHPStan\Type\FileTypeMapper $fileTypeMapper, array $stubFiles)
    {
        $this->parser = $parser;
        $this->fileTypeMapper = $fileTypeMapper;
        $this->stubFiles = $stubFiles;
    }
    public function findClassPhpDoc(string $className) : ?\_PhpScoperb75b35f52b74\PHPStan\PhpDoc\ResolvedPhpDocBlock
    {
    ...
    public function findPropertyPhpDoc(string $className, string $propertyName) : ?\_PhpScoperb75b35f52b74\PHPStan\PhpDoc\ResolvedPhpDocBlock
    {
        if (!$this->isKnownClass($className)) {
            return null;
        }
     ...
     */
    public function findMethodPhpDoc(string $className, string $methodName, array $positionalParameterNames) : ?\_PhpScoperb75b35f52b74\PHPStan\PhpDoc\ResolvedPhpDocBlock
    {
        if (!$this->isKnownClass($className)) {
            return null;
        }
    ...
    public function findFunctionPhpDoc(string $functionName) : ?\_PhpScoperb75b35f52b74\PHPStan\PhpDoc\ResolvedPhpDocBlock
    {
    ...
    private function initializeKnownElementNode(string $stubFile, \_PhpScoperb75b35f52b74\PhpParser\Node $node) : void
    {
        ...
        if (!$node instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_ && !$node instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Interface_ && !$node instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Trait_) {
            return;
        }
        ...
        foreach ($node->stmts as $stmt) {
            ...
            if ($stmt instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Property) {
                ...
                $this->knownMethodsParameterNames[$className][$methodName] = \array_map(static function (\_PhpScoperb75b35f52b74\PhpParser\Node\Param $param) : string {
