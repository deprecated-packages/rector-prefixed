...
use _PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\TypedTag;
...
class ResolvedPhpDocBlock
{
     ...
     * @return self
     */
    public static function create(\_PhpScoper0a6b37af0871\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode $phpDocNode, string $phpDocString, string $filename, \_PhpScoper0a6b37af0871\PHPStan\Analyser\NameScope $nameScope, \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateTypeMap $templateTypeMap, array $templateTags, \_PhpScoper0a6b37af0871\PHPStan\PhpDoc\PhpDocNodeResolver $phpDocNodeResolver) : self
    {
    ...
    public static function createEmpty() : self
    {
        ...
        $self->phpDocString = '/** */';
        $self->filename = null;
        $self->templateTypeMap = \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateTypeMap::createEmpty();
        $self->templateTags = [];
        $self->varTags = [];
        $self->methodTags = [];
        $self->propertyTags = [];
    ...
    private function getNameScope() : \_PhpScoper0a6b37af0871\PHPStan\Analyser\NameScope
    {
        return $this->nameScope;
    }
    public function getNullableNameScope() : ?\_PhpScoper0a6b37af0871\PHPStan\Analyser\NameScope
    {
        return $this->nameScope;
    }
    /**
    ...
    public function getReturnTag() : ?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ReturnTag
    {
    ...
    public function getThrowsTag() : ?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ThrowsTag
    {
    ...
    public function getDeprecatedTag() : ?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\DeprecatedTag
    {
     ...
     */
    private static function mergeOneParentVarTags(self $parent, \_PhpScoper0a6b37af0871\PHPStan\PhpDoc\PhpDocBlock $phpDocBlock) : ?array
    {
     ...
     * @return array<string, ParamTag>
     */
    private static function mergeOneParentParamTags(array $paramTags, self $parent, \_PhpScoper0a6b37af0871\PHPStan\PhpDoc\PhpDocBlock $phpDocBlock) : array
    {
     ...
     */
    private static function mergeReturnTags(?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ReturnTag $returnTag, array $parents, array $parentPhpDocBlocks) : ?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ReturnTag
    {
        if ($returnTag !== null) {
            return $returnTag;
        }
    ...
    private static function mergeOneParentReturnTag(?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ReturnTag $returnTag, self $parent, \_PhpScoper0a6b37af0871\PHPStan\PhpDoc\PhpDocBlock $phpDocBlock) : ?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ReturnTag
    {
     ...
     * @param array<int, self> $parents
     */
    private static function mergeThrowsTags(?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ThrowsTag $throwsTag, array $parents) : ?\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ThrowsTag
    {
        if ($throwsTag !== null) {
            return $throwsTag;
        }
     ...
     * @return T
     */
    private static function resolveTemplateTypeInTag(\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\TypedTag $tag, \_PhpScoper0a6b37af0871\PHPStan\PhpDoc\PhpDocBlock $phpDocBlock) : \_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\TypedTag
    {
        $type = \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateTypeHelper::resolveTemplateTypes($tag->getType(), $phpDocBlock->getClassReflection()->getActiveTemplateTypeMap());
