...
class PhpDocBlock
{
     ...
     */
    private function __construct(string $docComment, string $file, \RectorPrefix20201227\PHPStan\Reflection\ClassReflection $classReflection, ?string $trait, bool $explicit, array $parameterNameMapping, array $parents)
    {
     ...
     * @return self
     */
    public static function resolvePhpDocBlockForProperty(?string $docComment, \RectorPrefix20201227\PHPStan\Reflection\ClassReflection $classReflection, ?string $trait, string $propertyName, string $file, ?bool $explicit, array $originalPositionalParameterNames, array $newPositionalParameterNames) : self
    {
     ...
     * @return self
     */
    public static function resolvePhpDocBlockForMethod(?string $docComment, \RectorPrefix20201227\PHPStan\Reflection\ClassReflection $classReflection, ?string $trait, string $methodName, string $file, ?bool $explicit, array $originalPositionalParameterNames, array $newPositionalParameterNames) : self
    {
     ...
     * @return self
     */
    private static function resolvePhpDocBlockTree(?string $docComment, \RectorPrefix20201227\PHPStan\Reflection\ClassReflection $classReflection, ?string $trait, string $name, string $file, string $hasMethodName, string $getMethodName, string $resolveMethodName, ?bool $explicit, array $originalPositionalParameterNames, array $newPositionalParameterNames) : self
    {
     ...
     * @return array<int, self>
     */
    private static function resolveParentPhpDocBlocks(\RectorPrefix20201227\PHPStan\Reflection\ClassReflection $classReflection, string $name, string $hasMethodName, string $getMethodName, string $resolveMethodName, bool $explicit, array $positionalParameterNames) : array
    {
        $result = [];
     ...
     */
    private static function getParentReflections(\RectorPrefix20201227\PHPStan\Reflection\ClassReflection $classReflection) : array
    {
        $result = [];
     ...
     * @return self|null
     */
    private static function resolvePhpDocBlockFromClass(\RectorPrefix20201227\PHPStan\Reflection\ClassReflection $classReflection, string $name, string $hasMethodName, string $getMethodName, string $resolveMethodName, bool $explicit, array $positionalParameterNames) : ?self
    {
        if ($classReflection->getFileNameWithPhpDocs() !== null && $classReflection->{$hasMethodName}($name)) {
            ...
            if ($parentReflection instanceof \RectorPrefix20201227\PHPStan\Reflection\Php\PhpPropertyReflection || $parentReflection instanceof \RectorPrefix20201227\PHPStan\Reflection\ResolvedPropertyReflection) {
                $traitReflection = $parentReflection->getDeclaringTrait();
                $positionalMethodParameterNames = [];
            } elseif ($parentReflection instanceof \RectorPrefix20201227\PHPStan\Reflection\MethodReflection) {
                $traitReflection = null;
                if ($parentReflection instanceof \RectorPrefix20201227\PHPStan\Reflection\Php\PhpMethodReflection || $parentReflection instanceof \RectorPrefix20201227\PHPStan\Reflection\ResolvedMethodReflection) {
                    $traitReflection = $parentReflection->getDeclaringTrait();
                }
