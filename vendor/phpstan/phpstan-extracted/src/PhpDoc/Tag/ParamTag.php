...
class ParamTag implements \_PhpScoper0a2ac50786fa\PHPStan\PhpDoc\Tag\TypedTag
{
    /** @var \PHPStan\Type\Type */
    private $type;
    /** @var bool */
    private $isVariadic;
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type, bool $isVariadic)
    {
        $this->type = $type;
