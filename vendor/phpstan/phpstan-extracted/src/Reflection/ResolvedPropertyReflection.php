...
class ResolvedPropertyReflection implements \_PhpScoper0a2ac50786fa\PHPStan\Reflection\PropertyReflection
{
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Reflection\PropertyReflection $reflection, \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeMap $templateTypeMap)
    {
        $this->reflection = $reflection;
        $this->templateTypeMap = $templateTypeMap;
    }
    public function getOriginalReflection() : \_PhpScoper0a2ac50786fa\PHPStan\Reflection\PropertyReflection
    {
    ...
    {
        if ($this->reflection instanceof \_PhpScoper0a2ac50786fa\PHPStan\Reflection\Php\PhpPropertyReflection) {
    ...
    public function getReadableType() : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        ...
        $type = \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeHelper::resolveTemplateTypes($this->reflection->getReadableType(), $this->templateTypeMap);
    ...
    public function getWritableType() : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        ...
        $type = \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeHelper::resolveTemplateTypes($this->reflection->getWritableType(), $this->templateTypeMap);
