...
class NativeParameterWithPhpDocsReflection implements \_PhpScoper0a2ac50786fa\PHPStan\Reflection\ParameterReflectionWithPhpDocs
{
    /** @var string */
    private $name;
    /** @var bool */
    ...
    public function __construct(string $name, bool $optional, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $phpDocType, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $nativeType, \_PhpScoper0a2ac50786fa\PHPStan\Reflection\PassedByReference $passedByReference, bool $variadic, ?\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $defaultValue)
    {
        $this->name = $name;
