...
class IntersectionTypeMethodReflection implements \_PhpScoper0a2ac50786fa\PHPStan\Reflection\MethodReflection
{
    /** @var string */
    private $methodName;
    ...
    public function getVariants() : array
    {
        ...
        $returnType = \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::intersect(...\array_map(static function (\_PhpScoper0a2ac50786fa\PHPStan\Reflection\MethodReflection $method) : Type {
            return \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::intersect(...\array_map(static function (\_PhpScoper0a2ac50786fa\PHPStan\Reflection\ParametersAcceptor $acceptor) : Type {
    ...
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\TrinaryLogic::maxMin(...\array_map(static function (\_PhpScoper0a2ac50786fa\PHPStan\Reflection\MethodReflection $method) : TrinaryLogic {
