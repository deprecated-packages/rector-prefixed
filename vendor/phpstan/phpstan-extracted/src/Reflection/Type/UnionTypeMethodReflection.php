...
class UnionTypeMethodReflection implements \_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection
{
    /** @var string */
    private $methodName;
    ...
    public function getVariants() : array
    {
        ...
        $returnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypeCombinator::union(...\array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection $method) : Type {
            return \_PhpScoper0a6b37af0871\PHPStan\Type\TypeCombinator::union(...\array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptor $acceptor) : Type {
    ...
    {
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::extremeIdentity(...\array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection $method) : TrinaryLogic {
