...
class MixinMethodsClassReflectionExtension implements \_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodsClassReflectionExtension
{
    /** @var string[] */
    ...
    private function findMethod(\_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassReflection $classReflection, string $methodName) : ?\_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection
    {
        ...
        foreach ($mixinTypes as $type) {
            ...
            $method = $type->getMethod($methodName, new \_PhpScoper0a6b37af0871\PHPStan\Analyser\OutOfClassScope());
            $static = $method->isStatic();
            if (!$static && $classReflection->hasNativeMethod('__callStatic') && !$classReflection->hasNativeMethod('__call')) {
                $static = \true;
            }
            return new \_PhpScoper0a6b37af0871\PHPStan\Reflection\Mixin\MixinMethodReflection($method, $static);
        }
