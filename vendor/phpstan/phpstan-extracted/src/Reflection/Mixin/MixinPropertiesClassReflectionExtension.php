...
class MixinPropertiesClassReflectionExtension implements \_PhpScoper0a2ac50786fa\PHPStan\Reflection\PropertiesClassReflectionExtension
{
    /** @var string[] */
    ...
    private function findProperty(\_PhpScoper0a2ac50786fa\PHPStan\Reflection\ClassReflection $classReflection, string $propertyName) : ?\_PhpScoper0a2ac50786fa\PHPStan\Reflection\PropertyReflection
    {
        ...
        foreach ($mixinTypes as $type) {
            ...
            return $type->getProperty($propertyName, new \_PhpScoper0a2ac50786fa\PHPStan\Analyser\OutOfClassScope());
        }
