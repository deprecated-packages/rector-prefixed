...
class OptimizedDirectorySourceLocatorRepository
{
    ...
    private $locators = [];
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Reflection\BetterReflection\SourceLocator\OptimizedDirectorySourceLocatorFactory $factory)
    {
        $this->factory = $factory;
    }
    public function getOrCreate(string $directory) : \_PhpScoper0a2ac50786fa\PHPStan\Reflection\BetterReflection\SourceLocator\OptimizedDirectorySourceLocator
    {
