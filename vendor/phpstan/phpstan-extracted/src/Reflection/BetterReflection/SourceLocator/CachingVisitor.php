...
use RectorPrefix20201227\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\Exception\InvalidConstantNode;
use RectorPrefix20201227\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Util\ConstantNodeChecker;
class CachingVisitor extends \PhpParser\NodeVisitorAbstract
{
    ...
    public function enterNode(\PhpParser\Node $node) : ?int
    {
        ...
        if ($node instanceof \PhpParser\Node\Expr\FuncCall) {
            try {
                \RectorPrefix20201227\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Util\ConstantNodeChecker::assertValidDefineFunctionCall($node);
            } catch (\RectorPrefix20201227\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\Exception\InvalidConstantNode $e) {
                return null;
            }
