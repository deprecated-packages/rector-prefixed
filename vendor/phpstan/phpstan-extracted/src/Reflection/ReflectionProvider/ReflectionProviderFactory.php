...
class ReflectionProviderFactory
{
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Reflection\ReflectionProvider $runtimeReflectionProvider, \_PhpScoper0a2ac50786fa\PHPStan\Reflection\ReflectionProvider $staticReflectionProvider, bool $disableRuntimeReflectionProvider)
    {
    ...
    public function create() : \_PhpScoper0a2ac50786fa\PHPStan\Reflection\ReflectionProvider
    {
        $providers = [];
        ...
        return new \_PhpScoper0a2ac50786fa\PHPStan\Reflection\ReflectionProvider\MemoizingReflectionProvider(\count($providers) === 1 ? $providers[0] : new \_PhpScoper0a2ac50786fa\PHPStan\Reflection\ReflectionProvider\ChainReflectionProvider($providers));
    }
}
