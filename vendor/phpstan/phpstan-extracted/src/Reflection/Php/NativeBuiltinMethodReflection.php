...
class NativeBuiltinMethodReflection implements \_PhpScoperb75b35f52b74\PHPStan\Reflection\Php\BuiltinMethodReflection
{
    ...
    {
        return \_PhpScoperb75b35f52b74\PHPStan\TrinaryLogic::createFromBoolean($this->reflection->isDeprecated());
    }
