...
class PhpMethodReflection implements \_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection
{
    ...
    public function getVariants() : array
    {
        if ($this->variants === null) {
            $this->variants = [new \_PhpScoper0a6b37af0871\PHPStan\Reflection\FunctionVariantWithPhpDocs($this->templateTypeMap, null, $this->getParameters(), $this->isVariadic(), $this->getReturnType(), $this->getPhpDocReturnType(), $this->getNativeReturnType())];
        }
    ...
    private function getParameters() : array
    {
        if ($this->parameters === null) {
            $this->parameters = \array_map(function (\ReflectionParameter $reflection) : PhpParameterReflection {
                return new \_PhpScoper0a6b37af0871\PHPStan\Reflection\Php\PhpParameterReflection($reflection, $this->phpDocParameterTypes[$reflection->getName()] ?? null, $this->getDeclaringClass()->getName());
     ...
     * @return bool
     */
    private function callsFuncGetArgs(\_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassReflection $declaringClass, array $nodes) : bool
    {
        foreach ($nodes as $node) {
            ...
            if ($node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod) {
                ...
                if ($methodName === $this->reflection->getName()) {
                    return $this->functionCallStatementFinder->findFunctionCallInStatements(\_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptor::VARIADIC_FUNCTIONS, $node->getStmts()) !== null;
                }
                continue;
            }
            ...
            if (!$node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Declare_ || $node->stmts === null) {
                continue;
            }
            if ($this->callsFuncGetArgs($declaringClass, $node->stmts)) {
                return \true;
    ...
    private function getReturnType() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        if ($this->returnType === null) {
            ...
            if ($name === '__construct' || $name === '__destruct' || $name === '__unset' || $name === '__wakeup' || $name === '__clone') {
                return $this->returnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideType(new \_PhpScoper0a6b37af0871\PHPStan\Type\VoidType(), $this->phpDocReturnType);
            }
            if ($name === '__tostring') {
                return $this->returnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideType(new \_PhpScoper0a6b37af0871\PHPStan\Type\StringType(), $this->phpDocReturnType);
            }
            if ($name === '__isset') {
                return $this->returnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideType(new \_PhpScoper0a6b37af0871\PHPStan\Type\BooleanType(), $this->phpDocReturnType);
            }
            if ($name === '__sleep') {
                return $this->returnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideType(new \_PhpScoper0a6b37af0871\PHPStan\Type\ArrayType(new \_PhpScoper0a6b37af0871\PHPStan\Type\IntegerType(), new \_PhpScoper0a6b37af0871\PHPStan\Type\StringType()), $this->phpDocReturnType);
            }
            if ($name === '__set_state') {
                return $this->returnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideType(new \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectWithoutClassType(), $this->phpDocReturnType);
            }
            $this->returnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideTypeFromReflection($this->reflection->getReturnType(), $this->phpDocReturnType, $this->declaringClass->getName());
        }
        return $this->returnType;
    }
    private function getPhpDocReturnType() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
    ...
    private function getNativeReturnType() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        if ($this->nativeReturnType === null) {
            $this->nativeReturnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideTypeFromReflection($this->reflection->getReturnType(), null, $this->declaringClass->getName());
        }
    ...
    {
        return $this->reflection->isDeprecated()->or(\_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($this->isDeprecated));
    }
    public function isInternal() : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($this->reflection->isInternal() || $this->isInternal);
    }
    public function isFinal() : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($this->reflection->isFinal() || $this->isFinal);
    }
    ...
    {
        if ($this->getReturnType() instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\VoidType) {
