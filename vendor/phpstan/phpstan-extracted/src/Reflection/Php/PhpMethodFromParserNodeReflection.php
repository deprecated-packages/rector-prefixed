...
class PhpMethodFromParserNodeReflection extends \_PhpScoper0a6b37af0871\PHPStan\Reflection\Php\PhpFunctionFromParserNodeReflection implements \_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection
{
     ...
     * @param bool $isFinal
     */
    public function __construct(\_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassReflection $declaringClass, \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateTypeMap $templateTypeMap, array $realParameterTypes, array $phpDocParameterTypes, array $realParameterDefaultValues, \_PhpScoper0a6b37af0871\PHPStan\Type\Type $realReturnType, ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $phpDocReturnType, ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $throwType, ?string $deprecatedDescription, bool $isDeprecated, bool $isInternal, bool $isFinal)
    {
        $name = \strtolower($classMethod->name->name);
        if ($name === '__construct' || $name === '__destruct' || $name === '__unset' || $name === '__wakeup' || $name === '__clone') {
            $realReturnType = new \_PhpScoper0a6b37af0871\PHPStan\Type\VoidType();
        }
        if ($name === '__tostring') {
            $realReturnType = new \_PhpScoper0a6b37af0871\PHPStan\Type\StringType();
        }
        if ($name === '__isset') {
            $realReturnType = new \_PhpScoper0a6b37af0871\PHPStan\Type\BooleanType();
        }
        if ($name === '__sleep') {
            $realReturnType = new \_PhpScoper0a6b37af0871\PHPStan\Type\ArrayType(new \_PhpScoper0a6b37af0871\PHPStan\Type\IntegerType(), new \_PhpScoper0a6b37af0871\PHPStan\Type\StringType());
        }
        if ($name === '__set_state') {
            $realReturnType = \_PhpScoper0a6b37af0871\PHPStan\Type\TypeCombinator::intersect(new \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectWithoutClassType(), $realReturnType);
        }
    ...
    public function getPrototype() : \_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassMemberReflection
    {
        ...
        } catch (\_PhpScoper0a6b37af0871\PHPStan\Reflection\MissingMethodFromReflectionException $e) {
            return $this;
        }
    }
    private function getClassMethod() : \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod
    {
