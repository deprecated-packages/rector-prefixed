...
class PhpFunctionFromParserNodeReflection implements \_PhpScoper0a6b37af0871\PHPStan\Reflection\FunctionReflection
{
     ...
     * @param bool $isFinal
     */
    public function __construct(\_PhpScoper0a6b37af0871\PhpParser\Node\FunctionLike $functionLike, \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateTypeMap $templateTypeMap, array $realParameterTypes, array $phpDocParameterTypes, array $realParameterDefaultValues, \_PhpScoper0a6b37af0871\PHPStan\Type\Type $realReturnType, ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $phpDocReturnType = null, ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $throwType = null, ?string $deprecatedDescription = null, bool $isDeprecated = \false, bool $isInternal = \false, bool $isFinal = \false)
    {
    ...
    protected function getFunctionLike() : \_PhpScoper0a6b37af0871\PhpParser\Node\FunctionLike
    {
        return $this->functionLike;
    }
    public function getName() : string
    {
        if ($this->functionLike instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod) {
    ...
    public function getVariants() : array
    {
        if ($this->variants === null) {
            $this->variants = [new \_PhpScoper0a6b37af0871\PHPStan\Reflection\FunctionVariantWithPhpDocs($this->templateTypeMap, null, $this->getParameters(), $this->isVariadic(), $this->getReturnType(), $this->phpDocReturnType ?? new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType(), $this->realReturnType)];
        }
    ...
    private function getParameters() : array
    {
        ...
        foreach (\array_reverse($this->functionLike->getParams()) as $parameter) {
            ...
            $parameters[] = new \_PhpScoper0a6b37af0871\PHPStan\Reflection\Php\PhpParameterFromParserNodeReflection($parameter->var->name, $isOptional, $this->realParameterTypes[$parameter->var->name], $this->phpDocParameterTypes[$parameter->var->name] ?? null, $parameter->byRef ? \_PhpScoper0a6b37af0871\PHPStan\Reflection\PassedByReference::createCreatesNewVariable() : \_PhpScoper0a6b37af0871\PHPStan\Reflection\PassedByReference::createNo(), $this->realParameterDefaultValues[$parameter->var->name] ?? null, $parameter->variadic);
        }
    ...
    protected function getReturnType() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        return \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideType($this->realReturnType, $this->phpDocReturnType);
    }
    ...
    public function isFinal() : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        ...
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($finalMethod || $this->isFinal);
    }
