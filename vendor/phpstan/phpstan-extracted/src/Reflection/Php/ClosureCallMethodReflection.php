...
final class ClosureCallMethodReflection implements \_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection
{
    /** @var MethodReflection */
    private $nativeMethodReflection;
    /** @var ClosureType */
    private $closureType;
    public function __construct(\_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection $nativeMethodReflection, \_PhpScoper0a6b37af0871\PHPStan\Type\ClosureType $closureType)
    {
    ...
    public function getVariants() : array
    {
        ...
        $newThis = new \_PhpScoper0a6b37af0871\PHPStan\Reflection\Native\NativeParameterReflection('newThis', \false, new \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectWithoutClassType(), \_PhpScoper0a6b37af0871\PHPStan\Reflection\PassedByReference::createNo(), \false, null);
        \array_unshift($parameters, $newThis);
        return [new \_PhpScoper0a6b37af0871\PHPStan\Reflection\FunctionVariant($this->closureType->getTemplateTypeMap(), $this->closureType->getResolvedTemplateTypeMap(), $parameters, $this->closureType->isVariadic(), $this->closureType->getReturnType())];
    }
