...
class PhpFunctionReflection implements \_PhpScoper0a6b37af0871\PHPStan\Reflection\FunctionReflection, \_PhpScoper0a6b37af0871\PHPStan\Reflection\ReflectionWithFilename
{
     ...
     */
    public function __construct(\ReflectionFunction $reflection, \_PhpScoper0a6b37af0871\PHPStan\Parser\Parser $parser, \_PhpScoper0a6b37af0871\PHPStan\Parser\FunctionCallStatementFinder $functionCallStatementFinder, \_PhpScoper0a6b37af0871\PHPStan\Cache\Cache $cache, \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateTypeMap $templateTypeMap, array $phpDocParameterTypes, ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $phpDocReturnType, ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $phpDocThrowType, ?string $deprecatedDescription, bool $isDeprecated, bool $isInternal, bool $isFinal, $filename)
    {
    ...
    private function getParameters() : array
    {
        return \array_map(function (\ReflectionParameter $reflection) : PhpParameterReflection {
            return new \_PhpScoper0a6b37af0871\PHPStan\Reflection\Php\PhpParameterReflection($reflection, $this->phpDocParameterTypes[$reflection->getName()] ?? null, null);
    ...
    {
        return \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideTypeFromReflection($this->reflection->getReturnType(), $this->phpDocReturnType);
    }
    ...
    {
        return \_PhpScoper0a6b37af0871\PHPStan\Type\TypehintHelper::decideTypeFromReflection($this->reflection->getReturnType());
    }
    ...
    {
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($this->isDeprecated || $this->reflection->isDeprecated());
    }
    ...
    {
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($this->isFinal);
    }
