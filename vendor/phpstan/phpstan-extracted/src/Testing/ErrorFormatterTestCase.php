...
abstract class ErrorFormatterTestCase extends \PHPStan\Testing\TestCase
{
    ...
    /** @var Output|null */
    private $output = null;
    private function getOutputStream() : \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\StreamOutput
    {
        ...
        if ($this->outputStream === null) {
            ...
            $this->outputStream = new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\StreamOutput($resource);
        }
    ...
    {
        if ($this->output === null) {
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\StringInput(''), $this->getOutputStream());
