...
class FuzzyRelativePathHelper implements \_PhpScoperb75b35f52b74\PHPStan\File\RelativePathHelper
{
     ...
     */
    public function __construct(\_PhpScoperb75b35f52b74\PHPStan\File\RelativePathHelper $fallbackRelativePathHelper, string $currentWorkingDirectory, array $analysedPaths, ?string $directorySeparator = null)
    {
        ...
        foreach ($analysedPaths as $pathNumber => $path) {
            ...
            foreach ($pathArray as $i => $pathPart) {
                if (\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Utils\Strings::endsWith($pathPart, '.php')) {
                    continue;
                }
