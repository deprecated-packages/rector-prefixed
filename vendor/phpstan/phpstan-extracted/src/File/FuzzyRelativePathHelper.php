...
class FuzzyRelativePathHelper implements \_PhpScoper0a6b37af0871\PHPStan\File\RelativePathHelper
{
     ...
     */
    public function __construct(\_PhpScoper0a6b37af0871\PHPStan\File\RelativePathHelper $fallbackRelativePathHelper, string $currentWorkingDirectory, array $analysedPaths, ?string $directorySeparator = null)
    {
        ...
        foreach ($analysedPaths as $pathNumber => $path) {
            ...
            foreach ($pathArray as $i => $pathPart) {
                if (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Nette\Utils\Strings::endsWith($pathPart, '.php')) {
                    continue;
                }
