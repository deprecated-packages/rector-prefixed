...
class FileMonitor
{
    ...
    private $paths;
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\File\FileFinder $fileFinder)
    {
    ...
    public function getChanges() : \_PhpScoper0a2ac50786fa\PHPStan\File\FileMonitorResult
    {
        ...
        return new \_PhpScoper0a2ac50786fa\PHPStan\File\FileMonitorResult($newFiles, $changedFiles, $deletedFiles, \count($fileHashes));
    }
    private function getFileHash(string $filePath) : string
    {
        return \sha1(\_PhpScoper0a2ac50786fa\PHPStan\File\FileReader::read($filePath));
    }
}
