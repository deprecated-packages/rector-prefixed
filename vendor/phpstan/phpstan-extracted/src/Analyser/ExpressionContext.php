...
class ExpressionContext
{
    ...
    private function __construct(bool $isDeep, ?string $inAssignRightSideVariableName, ?\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $inAssignRightSideType)
    {
        $this->isDeep = $isDeep;
    ...
    public function enterRightSideAssign(string $variableName, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type) : self
    {
    ...
    public function getInAssignRightSideType() : ?\_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
