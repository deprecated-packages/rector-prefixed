...
class StatementResult
{
     ...
     */
    public function __construct(\_PhpScopere8e811afab72\PHPStan\Analyser\MutatingScope $scope, bool $hasYield, bool $isAlwaysTerminating, array $exitPoints)
    {
        $this->scope = $scope;
    ...
    public function filterOutLoopExitPoints() : self
    {
        ...
        foreach ($this->exitPoints as $exitPoint) {
            ...
            if ($statement instanceof \_PhpScopere8e811afab72\PhpParser\Node\Stmt\Break_ || $statement instanceof \_PhpScopere8e811afab72\PhpParser\Node\Stmt\Continue_) {
