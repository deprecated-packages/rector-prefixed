...
class StatementResult
{
     ...
     */
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Analyser\MutatingScope $scope, bool $hasYield, bool $isAlwaysTerminating, array $exitPoints)
    {
        $this->scope = $scope;
    ...
    public function filterOutLoopExitPoints() : self
    {
        ...
        foreach ($this->exitPoints as $exitPoint) {
            ...
            if ($statement instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Break_ || $statement instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Continue_) {
