...
class ExpressionResult
{
     ...
     */
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Analyser\MutatingScope $scope, bool $hasYield, ?callable $truthyScopeCallback = null, ?callable $falseyScopeCallback = null)
    {
        $this->scope = $scope;
    ...
    public function getTruthyScope() : \_PhpScoper0a2ac50786fa\PHPStan\Analyser\MutatingScope
    {
    ...
    public function getFalseyScope() : \_PhpScoper0a2ac50786fa\PHPStan\Analyser\MutatingScope
    {
