...
class ResultCacheProcessResult
{
    ...
    /** @var bool */
    private $saved;
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Analyser\AnalyserResult $analyserResult, bool $saved)
    {
        $this->analyserResult = $analyserResult;
        $this->saved = $saved;
    }
    public function getAnalyserResult() : \_PhpScoper0a2ac50786fa\PHPStan\Analyser\AnalyserResult
    {
