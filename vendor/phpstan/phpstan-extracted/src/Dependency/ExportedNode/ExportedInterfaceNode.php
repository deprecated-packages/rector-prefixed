...
class ExportedInterfaceNode implements \RectorPrefix20201227\PHPStan\Dependency\ExportedNode, \JsonSerializable
{
    /** @var string */
    private $name;
     ...
     */
    public function __construct(string $name, ?\RectorPrefix20201227\PHPStan\Dependency\ExportedNode\ExportedPhpDocNode $phpDoc, array $extends)
    {
        $this->name = $name;
        $this->phpDoc = $phpDoc;
    ...
    {
        return new self($data['name'], $data['phpDoc'] !== null ? \RectorPrefix20201227\PHPStan\Dependency\ExportedNode\ExportedPhpDocNode::decode($data['phpDoc']['data']) : null, $data['extends']);
    }
}
