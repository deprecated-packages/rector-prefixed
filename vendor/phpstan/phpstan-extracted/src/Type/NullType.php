...
class NullType implements \_PhpScoper0a6b37af0871\PHPStan\Type\ConstantScalarType
{
    ...
    {
        if ($otherType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\ConstantScalarType) {
            if ($orEqual) {
                return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean(null <= $otherType->getValue());
            }
            return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean(null < $otherType->getValue());
        }
        if ($otherType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\CompoundType) {
    ...
    {
        return new \_PhpScoper0a6b37af0871\PHPStan\Type\Constant\ConstantIntegerType(0);
    }
    ...
    {
        $array = new \_PhpScoper0a6b37af0871\PHPStan\Type\Constant\ConstantArrayType([], []);
