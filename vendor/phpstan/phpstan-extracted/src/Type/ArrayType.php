...
class ArrayType implements \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
{
    ...
    /** @var \PHPStan\Type\Type */
    private $itemType;
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $keyType, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $itemType)
    {
        if ($keyType->describe(\_PhpScoper0a2ac50786fa\PHPStan\Type\VerbosityLevel::value()) === '(int|string)') {
    ...
    public function getItemType() : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
    ...
    {
        return $type instanceof self && !$type instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantArrayType && $this->getItemType()->equals($type->getItemType()) && $this->keyType->equals($type->keyType);
    }
    public function describe(\_PhpScoper0a2ac50786fa\PHPStan\Type\VerbosityLevel $level) : string
    {
        $isMixedKeyType = $this->keyType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\MixedType && $this->keyType->describe(\_PhpScoper0a2ac50786fa\PHPStan\Type\VerbosityLevel::precise()) === 'mixed';
        $isMixedItemType = $this->itemType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\MixedType && $this->itemType->describe(\_PhpScoper0a2ac50786fa\PHPStan\Type\VerbosityLevel::precise()) === 'mixed';
        $valueHandler = function () use($level, $isMixedKeyType, $isMixedItemType) : string {
            if ($isMixedKeyType || $this->keyType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\NeverType) {
                if ($isMixedItemType || $this->itemType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\NeverType) {
                    return 'array';
                }
    ...
    {
        return new self($this->keyType, \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeUtils::generalizeType($this->itemType));
    }
    public function getKeysArray() : self
    {
        return new self(new \_PhpScoper0a2ac50786fa\PHPStan\Type\IntegerType(), $this->keyType);
    }
    public function getValuesArray() : self
    {
        return new self(new \_PhpScoper0a2ac50786fa\PHPStan\Type\IntegerType(), $this->itemType);
    }
    ...
    public function getIterableKeyType() : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        ...
        if ($keyType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\MixedType && !$keyType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateMixedType) {
    ...
    public function setOffsetValueType(?\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $offsetType, \_PhpScoper0a2ac50786fa\PHPStan\Type\Type $valueType, bool $unionValues = \true) : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        if ($offsetType === null) {
            $offsetType = new \_PhpScoper0a2ac50786fa\PHPStan\Type\IntegerType();
        }
        return \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::intersect(new self(\_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::union($this->keyType, self::castToArrayKeyType($offsetType)), $unionValues ? \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::union($this->itemType, $valueType) : $valueType), new \_PhpScoper0a2ac50786fa\PHPStan\Type\Accessory\NonEmptyArrayType());
    }
    public function isCallable() : \_PhpScoper0a2ac50786fa\PHPStan\TrinaryLogic
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\TrinaryLogic::createMaybe()->and((new \_PhpScoper0a2ac50786fa\PHPStan\Type\StringType())->isSuperTypeOf($this->itemType));
    }
    /**
    ...
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\Type\IntegerRangeType::fromInterval(0, null);
    }
    public static function castToArrayKeyType(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $offsetType) : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeTraverser::map($offsetType, static function (\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $offsetType, callable $traverse) : Type {
            if ($offsetType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateType) {
                return $offsetType;
            }
            if ($offsetType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\ConstantScalarType) {
                /** @var int|string $offsetValue */
                $offsetValue = \key([$offsetType->getValue() => null]);
                return \is_int($offsetValue) ? new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantIntegerType($offsetValue) : new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantStringType($offsetValue);
            }
            if ($offsetType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\IntegerType) {
                return $offsetType;
            }
            if ($offsetType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\FloatType || $offsetType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\BooleanType || $offsetType->isNumericString()->yes()) {
                return new \_PhpScoper0a2ac50786fa\PHPStan\Type\IntegerType();
            }
            if ($offsetType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\StringType) {
                return $offsetType;
            }
            if ($offsetType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\UnionType || $offsetType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\IntersectionType) {
                return $traverse($offsetType);
            }
            return new \_PhpScoper0a2ac50786fa\PHPStan\Type\UnionType([new \_PhpScoper0a2ac50786fa\PHPStan\Type\IntegerType(), new \_PhpScoper0a2ac50786fa\PHPStan\Type\StringType()]);
        });
    }
    public function inferTemplateTypes(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $receivedType) : \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeMap
    {
        ...
        if ($receivedType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantArrayType && \count($receivedType->getKeyTypes()) === 0) {
            $keyType = $this->getKeyType();
            $typeMap = \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeMap::createEmpty();
            if ($keyType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateType) {
                $typeMap = new \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeMap([$keyType->getName() => $keyType->getBound()]);
            }
            $itemType = $this->getItemType();
            if ($itemType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateType) {
                $typeMap = $typeMap->union(new \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeMap([$itemType->getName() => $itemType->getBound()]));
            }
            return $typeMap;
        }
        if ($receivedType instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\ArrayType && !$this->getKeyType()->isSuperTypeOf($receivedType->getKeyType())->no() && !$this->getItemType()->isSuperTypeOf($receivedType->getItemType())->no()) {
