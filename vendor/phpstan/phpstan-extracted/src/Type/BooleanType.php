...
class BooleanType implements \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
{
    ...
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::union(new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantStringType(''), new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantStringType('1'));
    }
    public function toInteger() : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::union(new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantIntegerType(0), new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantIntegerType(1));
    }
    public function toFloat() : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::union(new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantFloatType(0.0), new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantFloatType(1.0));
    }
