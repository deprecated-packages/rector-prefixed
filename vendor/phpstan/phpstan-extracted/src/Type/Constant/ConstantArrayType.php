...
class ConstantArrayType extends \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType implements \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ConstantType
{
    ...
    public function __construct(array $keyTypes, array $valueTypes, int $nextAutoIndex = 0, array $optionalKeys = [])
    {
        ...
        parent::__construct(\count($keyTypes) > 0 ? \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeCombinator::union(...$keyTypes) : new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\NeverType(), \count($valueTypes) > 0 ? \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeCombinator::union(...$valueTypes) : new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\NeverType());
    ...
    public function getAllArrays() : array
    {
        ...
        foreach ($optionalKeysCombinations as $combination) {
            ...
            if (!$array instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantArrayType) {
    ...
    public function getKeyType() : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type
    {
        if (\count($this->keyTypes) > 1) {
            return new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\UnionType($this->keyTypes);
        }
    ...
    {
        if ($type instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\MixedType && !$type instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Generic\TemplateMixedType) {
            return $type->isAcceptedBy($this, $strictTypes);
        }
        if ($type instanceof self && \count($this->keyTypes) === 0) {
            return \_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic::createFromBoolean(\count($type->keyTypes) === 0);
        }
        ...
        foreach ($this->keyTypes as $i => $keyType) {
            ...
            if ($hasOffset->maybe() && $this->isOptionalKey($i)) {
                $hasOffset = \_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic::createYes();
            }
    ...
    public function isSuperTypeOf(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $type) : \_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic
    {
        if ($type instanceof self) {
            ...
            foreach ($this->keyTypes as $i => $keyType) {
                ...
                if ($hasOffset->no()) {
                    ...
                    $results[] = \_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic::createMaybe();
                    continue;
                }
        ...
        if ($type instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType) {
            $result = \_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic::createMaybe();
            if (\count($this->keyTypes) === 0) {
                return $result;
            }
    ...
    public function findTypeAndMethodName() : ?\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantArrayTypeAndMethod
    {
        if (\count($this->keyTypes) !== 2) {
            return null;
        }
        if ($this->keyTypes[0]->isSuperTypeOf(new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType(0))->no()) {
            return null;
        }
        if ($this->keyTypes[1]->isSuperTypeOf(new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType(1))->no()) {
            return null;
        }
        [$classOrObject, $method] = $this->valueTypes;
        if (!$method instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantStringType) {
            return \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantArrayTypeAndMethod::createUnknown();
        }
        if ($classOrObject instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantStringType) {
            $broker = \_PhpScoper2a4e7ab1ecbc\PHPStan\Broker\Broker::getInstance();
            if (!$broker->hasClass($classOrObject->getValue())) {
                return \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantArrayTypeAndMethod::createUnknown();
            }
            $type = new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ObjectType($broker->getClass($classOrObject->getValue())->getName());
        } elseif ($classOrObject instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Generic\GenericClassStringType) {
            $type = $classOrObject->getGenericType();
        } elseif ((new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ObjectWithoutClassType())->isSuperTypeOf($classOrObject)->yes()) {
            $type = $classOrObject;
        } else {
            return \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantArrayTypeAndMethod::createUnknown();
        }
        ...
        if (!$has->no()) {
            if ($this->isOptionalKey(0) || $this->isOptionalKey(1)) {
                $has = $has->and(\_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic::createMaybe());
            }
            return \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantArrayTypeAndMethod::createConcrete($type, $method->getValue(), $has);
        }
        return null;
    }
    public function hasOffsetValueType(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $offsetType) : \_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic
    {
        ...
        if ($offsetType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\UnionType) {
            $results = [];
        ...
        $result = \_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic::createNo();
        foreach ($this->keyTypes as $i => $keyType) {
            if ($keyType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType && $offsetType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\StringType && !$offsetType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantStringType) {
                return \_PhpScoper2a4e7ab1ecbc\PHPStan\TrinaryLogic::createMaybe();
            }
    ...
    public function getOffsetValueType(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $offsetType) : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type
    {
        ...
        if (\count($matchingValueTypes) > 0) {
            $type = \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeCombinator::union(...$matchingValueTypes);
    ...
    public function setOffsetValueType(?\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $offsetType, \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $valueType, bool $unionValues = \false) : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type
    {
        $builder = \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantArrayTypeBuilder::createFromConstantArray($this);
        $builder->setOffsetValueType($offsetType, $valueType);
        return $builder->getArray();
    }
    public function unsetOffset(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $offsetType) : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type
    {
        $offsetType = \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType::castToArrayKeyType($offsetType);
        if ($offsetType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType || $offsetType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantStringType) {
            foreach ($this->keyTypes as $i => $keyType) {
        ...
        return \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeUtils::generalizeType(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeCombinator::union(...$arrays));
    }
    ...
    public function removeLast() : self
    {
        ...
        $nextAutoindex = $removedKeyType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType ? $removedKeyType->getValue() : $this->nextAutoIndex;
        return new self($keyTypes, $valueTypes, $nextAutoindex, \array_values($optionalKeys));
    }
    public function removeFirst() : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType
    {
        $builder = \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantArrayTypeBuilder::createEmpty();
        foreach ($this->keyTypes as $i => $keyType) {
            if ($i === 0) {
    ...
    public function slice(int $offset, ?int $limit, bool $preserveKeys = \false) : self
    {
        ...
        if (!$preserveKeys) {
            ...
            $keyTypes = \array_map(static function ($keyType) use(&$i) {
                if ($keyType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType) {
                    $i++;
                    return new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType($i - 1);
                }
                return $keyType;
            }, $keyTypes);
        }
    ...
    public function generalize() : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type
    {
        ...
        $arrayType = new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeUtils::generalizeType($this->getKeyType()), \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeUtils::generalizeType($this->getItemType()));
     ...
     * @return self
     */
    public function generalizeValues() : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType
    {
        $valueTypes = [];
        foreach ($this->valueTypes as $valueType) {
            $valueTypes[] = \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeUtils::generalizeType($valueType);
        }
     ...
     * @return self
     */
    public function getKeysArray() : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType
    {
        $keyTypes = [];
        $valueTypes = [];
        $optionalKeys = [];
        $autoIndex = 0;
        foreach ($this->keyTypes as $i => $keyType) {
            $keyTypes[] = new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType($i);
            $valueTypes[] = $keyType;
            $autoIndex++;
            if (!$this->isOptionalKey($i)) {
                continue;
     ...
     * @return self
     */
    public function getValuesArray() : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType
    {
        $keyTypes = [];
        $valueTypes = [];
        $optionalKeys = [];
    ...
    public function count() : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type
    {
        ...
        if ($optionalKeysCount === 0) {
            return new \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType($totalKeysCount);
        }
        return \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\IntegerRangeType::fromInterval($totalKeysCount - $optionalKeysCount, $totalKeysCount);
    }
    ...
    public function inferTemplateTypes(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $receivedType) : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Generic\TemplateTypeMap
    {
        ...
        if ($receivedType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType) {
    ...
    {
        $variance = $positionVariance->compose(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Generic\TemplateTypeVariance::createInvariant());
        $references = [];
    ...
    public function traverse(callable $cb) : \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type
    {
        ...
        foreach ($this->keyTypes as $keyType) {
            ...
            if (!$transformedKeyType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantIntegerType && !$transformedKeyType instanceof \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Constant\ConstantStringType) {
                throw new \_PhpScoper2a4e7ab1ecbc\PHPStan\ShouldNotHappenException();
            }
    ...
    public function mergeWith(self $otherArray) : self
    {
        ...
        foreach ($this->keyTypes as $i => $keyType) {
            ...
            $valueTypes[$i] = \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\TypeCombinator::union($valueTypes[$i], $otherValueType);
        }
    ...
    public function makeOffsetRequired(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $offsetType) : self
    {
        $offsetType = \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\ArrayType::castToArrayKeyType($offsetType);
        $optionalKeys = $this->optionalKeys;
        foreach ($this->keyTypes as $i => $keyType) {
