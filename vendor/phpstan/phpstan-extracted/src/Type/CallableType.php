...
class CallableType implements \_PhpScoper0a6b37af0871\PHPStan\Type\CompoundType, \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptor
{
     ...
     * @param bool $variadic
     */
    public function __construct(?array $parameters = null, ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $returnType = null, bool $variadic = \true)
    {
        $this->parameters = $parameters ?? [];
        $this->returnType = $returnType ?? new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType();
    ...
    {
        if ($type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\CompoundType && !$type instanceof self) {
    ...
    private function isSuperTypeOfInternal(\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type, bool $treatMixedAsAny) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        ...
        static $scope;
        if ($scope === null) {
            $scope = new \_PhpScoper0a6b37af0871\PHPStan\Analyser\OutOfClassScope();
        }
        $variantsResult = null;
        foreach ($type->getCallableParametersAcceptors($scope) as $variant) {
            $isSuperType = \_PhpScoper0a6b37af0871\PHPStan\Type\CallableTypeHelper::isParametersAcceptorSuperTypeOf($this, $variant, $treatMixedAsAny);
    ...
    public function isSubTypeOf(\_PhpScoper0a6b37af0871\PHPStan\Type\Type $otherType) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        ...
        return $otherType->isCallable()->and($otherType instanceof self ? \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createYes() : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createMaybe());
    }
    ...
    public function describe(\_PhpScoper0a6b37af0871\PHPStan\Type\VerbosityLevel $level) : string
    {
        return $level->handle(static function () : string {
            ...
            return \sprintf('callable(%s): %s', \implode(', ', \array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\Reflection\Native\NativeParameterReflection $param) use($level) : string {
    ...
    {
        $references = $this->getReturnType()->getReferencedTemplateTypes($positionVariance->compose(\_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateTypeVariance::createCovariant()));
        $paramVariance = $positionVariance->compose(\_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateTypeVariance::createContravariant());
    ...
    public function traverse(callable $cb) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        $parameters = \array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\Reflection\ParameterReflection $param) use($cb) : NativeParameterReflection {
