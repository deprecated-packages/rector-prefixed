...
class StaticType implements \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeWithClassName
{
    ...
    public function getStaticObjectType() : \_PhpScoper0a2ac50786fa\PHPStan\Type\ObjectType
    {
        if ($this->staticObjectType === null) {
            $this->staticObjectType = new \_PhpScoper0a2ac50786fa\PHPStan\Type\ObjectType($this->baseClass);
        }
    ...
    public function isSuperTypeOf(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type) : \_PhpScoper0a2ac50786fa\PHPStan\TrinaryLogic
    {
        ...
        if ($type instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\ObjectType) {
            return \_PhpScoper0a2ac50786fa\PHPStan\TrinaryLogic::createMaybe()->and($this->getStaticObjectType()->isSuperTypeOf($type));
        }
        if ($type instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\CompoundType) {
    ...
    public function changeBaseClass(\_PhpScoper0a2ac50786fa\PHPStan\Reflection\ClassReflection $classReflection) : self
    {
