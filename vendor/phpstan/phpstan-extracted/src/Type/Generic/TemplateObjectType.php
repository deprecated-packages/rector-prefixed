...
final class TemplateObjectType extends \_PhpScoper0a2ac50786fa\PHPStan\Type\ObjectType implements \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateType
{
    ...
    private $variance;
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeScope $scope, \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeStrategy $templateTypeStrategy, \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeVariance $templateTypeVariance, string $name, string $class)
    {
        ...
        $this->name = $name;
        $this->bound = new \_PhpScoper0a2ac50786fa\PHPStan\Type\ObjectType($class);
    }
    ...
    {
        return new self($this->scope, new \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateTypeArgumentStrategy(), $this->variance, $this->name, $this->getClassName());
    }
