...
class TemplateObjectWithoutClassType extends \_PhpScoper0a2ac50786fa\PHPStan\Type\ObjectWithoutClassType implements \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateType
{
    ...
    {
        if ($this->bound === null) {
            $this->bound = new \_PhpScoper0a2ac50786fa\PHPStan\Type\ObjectWithoutClassType();
        }
        return $this->bound;
    }
