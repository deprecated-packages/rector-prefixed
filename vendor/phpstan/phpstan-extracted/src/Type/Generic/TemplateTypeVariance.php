...
class TemplateTypeVariance
{
    ...
    {
        if ($a instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\MixedType && !$a instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateType) {
            return \true;
        }
        if ($b instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\MixedType && !$b instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Generic\TemplateType) {
            return \true;
        }
        if ($this->invariant()) {
            return $a->equals($b);
