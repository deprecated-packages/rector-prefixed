...
final class TemplateMixedType extends \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType implements \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\TemplateType
{
    ...
    {
        if ($this->bound === null) {
            $this->bound = new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType(\true);
        }
        return $this->bound;
    }
