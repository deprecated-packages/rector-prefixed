...
final class TemplateMixedType extends \_PhpScopere8e811afab72\PHPStan\Type\MixedType implements \_PhpScopere8e811afab72\PHPStan\Type\Generic\TemplateType
{
    ...
    {
        if ($this->bound === null) {
            $this->bound = new \_PhpScopere8e811afab72\PHPStan\Type\MixedType(\true);
        }
        return $this->bound;
    }
