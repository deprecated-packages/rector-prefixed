...
class ObjectWithoutClassType implements \_PhpScoper0a6b37af0871\PHPStan\Type\SubtractableType
{
    use ObjectTypeTrait;
    ...
    public function __construct(?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $subtractedType = null)
    {
    ...
    public function accepts(\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type, bool $strictTypes) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        ...
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($type instanceof self || $type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\TypeWithClassName);
    }
