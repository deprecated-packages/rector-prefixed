...
class FloatType implements \_PhpScoperb75b35f52b74\PHPStan\Type\Type
{
    ...
    {
        if ($type instanceof self || $type instanceof \_PhpScoperb75b35f52b74\PHPStan\Type\IntegerType) {
        ...
        if ($type instanceof \_PhpScoperb75b35f52b74\PHPStan\Type\CompoundType) {
            return $type->isAcceptedBy(new \_PhpScoperb75b35f52b74\PHPStan\Type\UnionType([$this, new \_PhpScoperb75b35f52b74\PHPStan\Type\IntegerType()]), $strictTypes);
        }
