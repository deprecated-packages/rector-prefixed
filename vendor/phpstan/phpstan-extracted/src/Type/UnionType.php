...
class UnionType implements \_PhpScoper0a6b37af0871\PHPStan\Type\CompoundType
{
    ...
    public function __construct(array $types)
    {
        $throwException = static function () use($types) : void {
            throw new \_PhpScoper0a6b37af0871\PHPStan\ShouldNotHappenException(\sprintf('Cannot create %s with: %s', self::class, \implode(', ', \array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) : string {
                return $type->describe(\_PhpScoper0a6b37af0871\PHPStan\Type\VerbosityLevel::value());
            }, $types))));
        };
        if (\count($types) < 2) {
            $throwException();
    ...
    {
        return \_PhpScoper0a6b37af0871\PHPStan\Type\UnionTypeHelper::getReferencedClasses($this->getTypes());
    }
    ...
    {
        if ($type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\CompoundType && !$type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\CallableType) {
    ...
    {
        if ($otherType instanceof self || $otherType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\IterableType) {
    ...
    public function describe(\_PhpScoper0a6b37af0871\PHPStan\Type\VerbosityLevel $level) : string
    {
        $joinTypes = static function (array $types) use($level) : string {
            $typeNames = [];
            foreach ($types as $type) {
                if ($type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\ClosureType || $type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\CallableType) {
                    $typeNames[] = \sprintf('(%s)', $type->describe($level));
                } elseif ($type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\IntersectionType) {
        ...
        return $level->handle(function () use($joinTypes) : string {
            $types = \_PhpScoper0a6b37af0871\PHPStan\Type\TypeCombinator::union(...\array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) : Type {
                if ($type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\ConstantType && !$type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\Constant\ConstantBooleanType) {
                    return $type->generalize();
                }
                return $type;
            }, $this->types));
            if ($types instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\UnionType) {
     ...
     * @return TrinaryLogic
     */
    private function hasInternal(callable $canCallback, callable $hasCallback) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        $results = [];
        foreach ($this->types as $type) {
            if ($canCallback($type)->no()) {
                $results[] = \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createNo();
                continue;
            }
    ...
    {
        return $this->unionResults(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) : TrinaryLogic {
    ...
    {
        return $this->unionResults(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($propertyName) : TrinaryLogic {
    ...
    {
        return $this->getInternal(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($propertyName) : TrinaryLogic {
            return $type->hasProperty($propertyName);
        }, static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($propertyName, $scope) : PropertyReflection {
    ...
    {
        return $this->unionResults(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($methodName) : TrinaryLogic {
    ...
    public function getMethod(string $methodName, \_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassMemberAccessAnswerer $scope) : \_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection
    {
        ...
        return new \_PhpScoper0a6b37af0871\PHPStan\Reflection\Type\UnionTypeMethodReflection($methodName, $methods);
    }
    ...
    {
        return $this->hasInternal(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) : TrinaryLogic {
            return $type->canAccessConstants();
        }, static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($constantName) : TrinaryLogic {
    ...
    {
        return $this->getInternal(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($constantName) : TrinaryLogic {
            return $type->hasConstant($constantName);
        }, static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($constantName) : ConstantReflection {
    ...
    {
        return $this->unionTypes(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) : Type {
    ...
    {
        return $this->unionResults(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($offsetType) : TrinaryLogic {
    ...
    public function getOffsetValueType(\_PhpScoper0a6b37af0871\PHPStan\Type\Type $offsetType) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        foreach ($this->types as $innerType) {
            ...
            if ($valueType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\ErrorType) {
                continue;
            }
            $types[] = $valueType;
        }
    ...
    {
        return $this->unionTypes(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($offsetType, $valueType) : Type {
    ...
    {
        return $this->unionResults(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) use($otherType, $orEqual) : TrinaryLogic {
    ...
    public function toBoolean() : \_PhpScoper0a6b37af0871\PHPStan\Type\BooleanType
    {
        ...
        $type = $this->unionTypes(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) : BooleanType {
    ...
    {
        $type = $this->unionTypes(static function (\_PhpScoper0a6b37af0871\PHPStan\Type\Type $type) : Type {
     ...
     * @return TrinaryLogic
     */
    private function unionResults(callable $getResult) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::extremeIdentity(...\array_map($getResult, $this->types));
    }
    /**
    ...
    {
        return \_PhpScoper0a6b37af0871\PHPStan\Type\TypeCombinator::union(...\array_map($getType, $this->types));
    }
}
