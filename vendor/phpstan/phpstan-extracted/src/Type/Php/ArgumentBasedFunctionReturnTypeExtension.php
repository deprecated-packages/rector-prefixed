...
class ArgumentBasedFunctionReturnTypeExtension implements \_PhpScoper0a2ac50786fa\PHPStan\Type\DynamicFunctionReturnTypeExtension
{
    /** @var int[] */
    ...
    public function getTypeFromFunctionCall(\_PhpScoper0a2ac50786fa\PHPStan\Reflection\FunctionReflection $functionReflection, \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\FuncCall $functionCall, \_PhpScoper0a2ac50786fa\PHPStan\Analyser\Scope $scope) : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        ...
        if ($argument->unpack) {
            $argumentKeyType = \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeUtils::generalizeType($argumentKeyType);
            $argumentValueType = \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeUtils::generalizeType($argumentValueType->getIterableValueType());
        }
        return new \_PhpScoper0a2ac50786fa\PHPStan\Type\ArrayType($argumentKeyType, $argumentValueType);
    }
}
