...
class PropertyExistsTypeSpecifyingExtension implements \_PhpScoper0a6b37af0871\PHPStan\Type\FunctionTypeSpecifyingExtension, \_PhpScoper0a6b37af0871\PHPStan\Analyser\TypeSpecifierAwareExtension
{
    /** @var PropertyReflectionFinder */
    private $propertyReflectionFinder;
    /** @var TypeSpecifier */
    private $typeSpecifier;
    public function __construct(\_PhpScoper0a6b37af0871\PHPStan\Rules\Properties\PropertyReflectionFinder $propertyReflectionFinder)
    {
    ...
    public function specifyTypes(\_PhpScoper0a6b37af0871\PHPStan\Reflection\FunctionReflection $functionReflection, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall $node, \_PhpScoper0a6b37af0871\PHPStan\Analyser\Scope $scope, \_PhpScoper0a6b37af0871\PHPStan\Analyser\TypeSpecifierContext $context) : \_PhpScoper0a6b37af0871\PHPStan\Analyser\SpecifiedTypes
    {
        ...
        if (!$propertyNameType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\Constant\ConstantStringType) {
        ...
        if ($objectType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\Constant\ConstantStringType) {
            return new \_PhpScoper0a6b37af0871\PHPStan\Analyser\SpecifiedTypes([], []);
        } elseif ((new \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectWithoutClassType())->isSuperTypeOf($objectType)->yes()) {
            $propertyNode = new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\PropertyFetch($node->args[0]->value, new \_PhpScoper0a6b37af0871\PhpParser\Node\Identifier($propertyNameType->getValue()));
        } else {
            return new \_PhpScoper0a6b37af0871\PHPStan\Analyser\SpecifiedTypes([], []);
        }
        ...
        return $this->typeSpecifier->create($node->args[0]->value, new \_PhpScoper0a6b37af0871\PHPStan\Type\IntersectionType([new \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectWithoutClassType(), new \_PhpScoper0a6b37af0871\PHPStan\Type\Accessory\HasPropertyType($propertyNameType->getValue())]), $context);
    }
}
