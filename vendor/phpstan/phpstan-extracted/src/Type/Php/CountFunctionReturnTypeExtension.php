...
class CountFunctionReturnTypeExtension implements \_PhpScoper0a2ac50786fa\PHPStan\Type\DynamicFunctionReturnTypeExtension
{
    ...
    public function getTypeFromFunctionCall(\_PhpScoper0a2ac50786fa\PHPStan\Reflection\FunctionReflection $functionReflection, \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\FuncCall $functionCall, \_PhpScoper0a2ac50786fa\PHPStan\Analyser\Scope $scope) : \_PhpScoper0a2ac50786fa\PHPStan\Type\Type
    {
        ...
        if (\count($functionCall->args) > 1) {
            ...
            if ($mode->isSuperTypeOf(new \_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantIntegerType(\COUNT_RECURSIVE))->yes()) {
                return \_PhpScoper0a2ac50786fa\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($functionReflection->getVariants())->getReturnType();
            }
        }
        $argType = $scope->getType($functionCall->args[0]->value);
        $constantArrays = \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeUtils::getConstantArrays($scope->getType($functionCall->args[0]->value));
        ...
        return \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeCombinator::union(...$countTypes);
    }
}
