...
class SprintfFunctionDynamicReturnTypeExtension implements \_PhpScopere8e811afab72\PHPStan\Type\DynamicFunctionReturnTypeExtension
{
    ...
    {
        $values = [];
        $returnType = new \_PhpScopere8e811afab72\PHPStan\Type\StringType();
        foreach ($functionCall->args as $arg) {
            $argType = $scope->getType($arg->value);
            if (!$argType instanceof \_PhpScopere8e811afab72\PHPStan\Type\ConstantScalarType) {
                return $returnType;
            }
