...
class VerbosityLevel
{
    ...
    public static function getRecommendedLevelByType(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type) : self
    {
        $moreVerbose = \false;
        \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeTraverser::map($type, static function (\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type, callable $traverse) use(&$moreVerbose) : Type {
            if ($type->isCallable()->yes()) {
                $moreVerbose = \true;
                return $type;
            }
            if ($type instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\ConstantType && !$type instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\NullType) {
                $moreVerbose = \true;
                return $type;
            }
            if ($type instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Accessory\AccessoryNumericStringType) {
                $moreVerbose = \true;
                return $type;
            }
            if ($type instanceof \_PhpScoper0a2ac50786fa\PHPStan\Type\Accessory\NonEmptyArrayType) {
                $moreVerbose = \true;
                return $type;
            }
