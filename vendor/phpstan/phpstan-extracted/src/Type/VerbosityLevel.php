...
class VerbosityLevel
{
    ...
    public static function getRecommendedLevelByType(\_PhpScoperb75b35f52b74\PHPStan\Type\Type $type) : self
    {
        $moreVerbose = \false;
        \_PhpScoperb75b35f52b74\PHPStan\Type\TypeTraverser::map($type, static function (\_PhpScoperb75b35f52b74\PHPStan\Type\Type $type, callable $traverse) use(&$moreVerbose) : Type {
            if ($type->isCallable()->yes()) {
                $moreVerbose = \true;
                return $type;
            }
            if ($type instanceof \_PhpScoperb75b35f52b74\PHPStan\Type\ConstantType && !$type instanceof \_PhpScoperb75b35f52b74\PHPStan\Type\NullType) {
                $moreVerbose = \true;
                return $type;
            }
            if ($type instanceof \_PhpScoperb75b35f52b74\PHPStan\Type\Accessory\AccessoryNumericStringType) {
                $moreVerbose = \true;
                return $type;
            }
            if ($type instanceof \_PhpScoperb75b35f52b74\PHPStan\Type\Accessory\NonEmptyArrayType) {
                $moreVerbose = \true;
                return $type;
            }
