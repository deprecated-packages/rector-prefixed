...
use _PhpScoper0a6b37af0871\PHPStan\Reflection\ObjectTypeMethodReflection;
...
class ObjectType implements \_PhpScoper0a6b37af0871\PHPStan\Type\TypeWithClassName, \_PhpScoper0a6b37af0871\PHPStan\Type\SubtractableType
{
    ...
    private $superTypes = [];
    public function __construct(string $className, ?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $subtractedType = null, ?\_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassReflection $classReflection = null)
    {
    ...
    private static function createFromReflection(\_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassReflection $reflection) : self
    {
        if (!$reflection->isGeneric()) {
            return new \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectType($reflection->getName());
        }
        return new \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\GenericObjectType($reflection->getName(), $reflection->typeMapToList($reflection->getActiveTemplateTypeMap()));
    }
    ...
    public function getProperty(string $propertyName, \_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassMemberAccessAnswerer $scope) : \_PhpScoper0a6b37af0871\PHPStan\Reflection\PropertyReflection
    {
        $classReflection = $this->getClassReflection();
        if ($classReflection === null) {
            throw new \_PhpScoper0a6b37af0871\PHPStan\Broker\ClassNotFoundException($this->className);
        }
    ...
    {
        $description = $type->describe(\_PhpScoper0a6b37af0871\PHPStan\Type\VerbosityLevel::cache());
        ...
        if ($type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectWithoutClassType) {
            if ($type->getSubtractedType() !== null) {
                ...
                if ($isSuperType->yes()) {
                    return $this->superTypes[$description] = \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createNo();
                }
            }
            return $this->superTypes[$description] = \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createMaybe();
        }
        if (!$type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\TypeWithClassName) {
            return $this->superTypes[$description] = \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createNo();
        }
        ...
        if ($type instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\SubtractableType && $type->getSubtractedType() !== null) {
            $isSuperType = $type->getSubtractedType()->isSuperTypeOf($this);
            if ($isSuperType->yes()) {
                return $this->superTypes[$description] = \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createNo();
            }
        ...
        if ($thatClassName === $thisClassName) {
            return $this->superTypes[$description] = \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createYes();
        }
    ...
    protected function checkSubclassAcceptability(string $thatClass) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        ...
        if ($thisReflection->isInterface() && $thatReflection->isInterface()) {
            return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($thatReflection->implementsInterface($this->className));
        }
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($thatReflection->isSubclassOf($this->className));
    }
    ...
    public function toNumber() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        if ($this->isInstanceOf('SimpleXMLElement')->yes()) {
            return new \_PhpScoper0a6b37af0871\PHPStan\Type\UnionType([new \_PhpScoper0a6b37af0871\PHPStan\Type\FloatType(), new \_PhpScoper0a6b37af0871\PHPStan\Type\IntegerType()]);
        }
    ...
    public function toString() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        if ($classReflection->hasNativeMethod('__toString')) {
            return \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($classReflection->getNativeMethod('__toString')->getVariants())->getReturnType();
        }
        return new \_PhpScoper0a6b37af0871\PHPStan\Type\ErrorType();
    }
    public function toArray() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        $broker = \_PhpScoper0a6b37af0871\PHPStan\Broker\Broker::getInstance();
        if (!$classReflection->getNativeReflection()->isUserDefined() || \_PhpScoper0a6b37af0871\PHPStan\Reflection\Php\UniversalObjectCratesClassReflectionExtension::isUniversalObjectCrate($broker, $broker->getUniversalObjectCratesClasses(), $classReflection)) {
            return new \_PhpScoper0a6b37af0871\PHPStan\Type\ArrayType(new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType(), new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType());
        }
        $arrayKeys = [];
        $arrayValues = [];
        do {
            foreach ($classReflection->getNativeReflection()->getProperties() as $nativeProperty) {
                ...
                $arrayKeys[] = new \_PhpScoper0a6b37af0871\PHPStan\Type\Constant\ConstantStringType($keyName);
                $arrayValues[] = $property->getReadableType();
            }
            $classReflection = $classReflection->getParentClass();
        } while ($classReflection !== \false);
        return new \_PhpScoper0a6b37af0871\PHPStan\Type\Constant\ConstantArrayType($arrayKeys, $arrayValues);
    }
    ...
    public function getMethod(string $methodName, \_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassMemberAccessAnswerer $scope) : \_PhpScoper0a6b37af0871\PHPStan\Reflection\MethodReflection
    {
        ...
        return new \_PhpScoper0a6b37af0871\PHPStan\Reflection\ObjectTypeMethodReflection($this, $classReflection->getMethod($methodName, $scope));
    }
    private function getGenericObjectType() : \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\GenericObjectType
    {
        $classReflection = $this->getClassReflection();
        ...
        if ($this->genericObjectType === null) {
            $this->genericObjectType = new \_PhpScoper0a6b37af0871\PHPStan\Type\Generic\GenericObjectType($this->className, \array_values($classReflection->getTemplateTypeMap()->resolveToBounds()->getTypes()), $this->subtractedType);
        }
    ...
    public function hasConstant(string $constantName) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        ...
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createFromBoolean($class->hasConstant($constantName));
    }
    ...
    {
        return $this->isInstanceOf(\Traversable::class)->and(\_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createMaybe());
    }
    public function getIterableKeyType() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        if ($this->isInstanceOf(\Iterator::class)->yes()) {
            return \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($classReflection->getNativeMethod('key')->getVariants())->getReturnType();
        }
        if ($this->isInstanceOf(\IteratorAggregate::class)->yes()) {
            return \_PhpScoper0a6b37af0871\PHPStan\Type\RecursionGuard::run($this, static function () use($classReflection) : Type {
                return \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($classReflection->getNativeMethod('getIterator')->getVariants())->getReturnType()->getIterableKeyType();
            });
        }
        if ($this->isInstanceOf(\Traversable::class)->yes()) {
            $tKey = \_PhpScoper0a6b37af0871\PHPStan\Type\GenericTypeVariableResolver::getType($this, \Traversable::class, 'TKey');
            if ($tKey !== null) {
                return $tKey;
            }
    ...
    public function getIterableValueType() : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        if ($this->isInstanceOf(\Iterator::class)->yes()) {
            return \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($classReflection->getNativeMethod('current')->getVariants())->getReturnType();
        }
        if ($this->isInstanceOf(\IteratorAggregate::class)->yes()) {
            return \_PhpScoper0a6b37af0871\PHPStan\Type\RecursionGuard::run($this, static function () use($classReflection) : Type {
                return \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($classReflection->getNativeMethod('getIterator')->getVariants())->getReturnType()->getIterableValueType();
            });
        }
        if ($this->isInstanceOf(\Traversable::class)->yes()) {
            $tValue = \_PhpScoper0a6b37af0871\PHPStan\Type\GenericTypeVariableResolver::getType($this, \Traversable::class, 'TValue');
            if ($tValue !== null) {
                return $tValue;
            }
            return new \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType();
    ...
    private function isExtraOffsetAccessibleClass() : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        $classReflection = $this->getClassReflection();
        if ($classReflection === null) {
            return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createMaybe();
    ...
    public function hasOffsetValueType(\_PhpScoper0a6b37af0871\PHPStan\Type\Type $offsetType) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        ...
        if ($this->isInstanceOf(\ArrayAccess::class)->yes()) {
            $acceptedOffsetType = \_PhpScoper0a6b37af0871\PHPStan\Type\RecursionGuard::run($this, function () use($classReflection) : Type {
                $parameters = \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($classReflection->getNativeMethod('offsetSet')->getVariants())->getParameters();
                if (\count($parameters) < 2) {
                    throw new \_PhpScoper0a6b37af0871\PHPStan\ShouldNotHappenException(\sprintf('Method %s::%s() has less than 2 parameters.', $this->className, 'offsetSet'));
                }
        ...
        return $this->isExtraOffsetAccessibleClass()->and(\_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createMaybe());
    }
    public function getOffsetValueType(\_PhpScoper0a6b37af0871\PHPStan\Type\Type $offsetType) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        if ($this->isInstanceOf(\ArrayAccess::class)->yes()) {
            return \_PhpScoper0a6b37af0871\PHPStan\Type\RecursionGuard::run($this, static function () use($classReflection) : Type {
                return \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($classReflection->getNativeMethod('offsetGet')->getVariants())->getReturnType();
            });
        }
        return new \_PhpScoper0a6b37af0871\PHPStan\Type\ErrorType();
    }
    public function setOffsetValueType(?\_PhpScoper0a6b37af0871\PHPStan\Type\Type $offsetType, \_PhpScoper0a6b37af0871\PHPStan\Type\Type $valueType) : \_PhpScoper0a6b37af0871\PHPStan\Type\Type
    {
        ...
        if ($this->isInstanceOf(\ArrayAccess::class)->yes()) {
            ...
            $acceptedValueType = new \_PhpScoper0a6b37af0871\PHPStan\Type\NeverType();
            $acceptedOffsetType = \_PhpScoper0a6b37af0871\PHPStan\Type\RecursionGuard::run($this, function () use($classReflection, &$acceptedValueType) : Type {
                $parameters = \_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($classReflection->getNativeMethod('offsetSet')->getVariants())->getParameters();
                if (\count($parameters) < 2) {
                    throw new \_PhpScoper0a6b37af0871\PHPStan\ShouldNotHappenException(\sprintf('Method %s::%s() has less than 2 parameters.', $this->className, 'offsetSet'));
                }
            ...
            if ($offsetType === null) {
                $offsetType = new \_PhpScoper0a6b37af0871\PHPStan\Type\NullType();
            }
            if (!$offsetType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType && !$acceptedOffsetType->isSuperTypeOf($offsetType)->yes() || !$valueType instanceof \_PhpScoper0a6b37af0871\PHPStan\Type\MixedType && !$acceptedValueType->isSuperTypeOf($valueType)->yes()) {
                return new \_PhpScoper0a6b37af0871\PHPStan\Type\ErrorType();
            }
        }
    ...
    public function isCallable() : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        ...
        if (\count($parametersAcceptors) === 1 && $parametersAcceptors[0] instanceof \_PhpScoper0a6b37af0871\PHPStan\Reflection\TrivialParametersAcceptor) {
            return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createMaybe();
        }
        return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createYes();
    }
    ...
    public function isInstanceOf(string $className) : \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic
    {
        $classReflection = $this->getClassReflection();
        if ($classReflection === null) {
            return \_PhpScoper0a6b37af0871\PHPStan\TrinaryLogic::createMaybe();
    ...
    {
        if ($this->subtractedType !== null) {
            $type = \_PhpScoper0a6b37af0871\PHPStan\Type\TypeCombinator::union($this->subtractedType, $type);
        }
    ...
    private function getParent() : ?\_PhpScoper0a6b37af0871\PHPStan\Type\ObjectType
    {
        $thisReflection = $this->getClassReflection();
        if ($thisReflection === null) {
            return null;
    ...
    private function getInterfaces() : array
    {
        ...
        return \array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassReflection $interfaceReflection) : self {
