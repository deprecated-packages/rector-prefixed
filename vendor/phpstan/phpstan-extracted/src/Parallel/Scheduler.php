...
class Scheduler
{
     ...
     * @return Schedule
     */
    public function scheduleWork(int $cpuCores, array $files) : \_PhpScopere8e811afab72\PHPStan\Parallel\Schedule
    {
        ...
        return new \_PhpScopere8e811afab72\PHPStan\Parallel\Schedule(\min($numberOfProcesses, $this->maximumNumberOfProcesses), $jobs);
    }
}
