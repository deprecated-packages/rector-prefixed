...
class Scheduler
{
     ...
     * @return Schedule
     */
    public function scheduleWork(int $cpuCores, array $files) : \_PhpScoper0a2ac50786fa\PHPStan\Parallel\Schedule
    {
        ...
        return new \_PhpScoper0a2ac50786fa\PHPStan\Parallel\Schedule(\min($numberOfProcesses, $this->maximumNumberOfProcesses), $jobs);
    }
}
