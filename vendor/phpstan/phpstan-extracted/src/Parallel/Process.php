...
class Process
{
    ...
    private $timer = null;
    public function __construct(string $command, \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface $loop, float $timeoutSeconds)
    {
    ...
    public function start(callable $onData, callable $onError, callable $onExit) : void
    {
        ...
        $this->process = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\ChildProcess\Process($this->command, null, null, [1 => $this->stdOut, 2 => $this->stdErr]);
    ...
    public function bindConnection(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface $out, \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Stream\WritableStreamInterface $in) : void
    {
