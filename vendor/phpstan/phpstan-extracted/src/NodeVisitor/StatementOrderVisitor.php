...
namespace _PhpScoper0a6b37af0871\PHPStan\NodeVisitor;

use _PhpScoper0a6b37af0871\PhpParser\Node;
use _PhpScoper0a6b37af0871\PhpParser\NodeVisitorAbstract;
class StatementOrderVisitor extends \_PhpScoper0a6b37af0871\PhpParser\NodeVisitorAbstract
{
    /** @var int[] */
    private $orderStack = [];
    /** @var int[] */
    ...
    public function enterNode(\_PhpScoper0a6b37af0871\PhpParser\Node $node)
    {
        ...
        if ($node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr && \count($this->expressionOrderStack) > 0) {
