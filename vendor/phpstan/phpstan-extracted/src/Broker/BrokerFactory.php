...
class BrokerFactory
{
    ...
    public function create() : \_PhpScoper0a6b37af0871\PHPStan\Broker\Broker
    {
        return new \_PhpScoper0a6b37af0871\PHPStan\Broker\Broker($this->container->getByType(\_PhpScoper0a6b37af0871\PHPStan\Reflection\ReflectionProvider::class), $this->container->getByType(\_PhpScoper0a6b37af0871\PHPStan\DependencyInjection\Type\DynamicReturnTypeExtensionRegistryProvider::class), $this->container->getByType(\_PhpScoper0a6b37af0871\PHPStan\DependencyInjection\Type\OperatorTypeSpecifyingExtensionRegistryProvider::class), $this->container->getParameter('universalObjectCratesClasses'));
    }
}
