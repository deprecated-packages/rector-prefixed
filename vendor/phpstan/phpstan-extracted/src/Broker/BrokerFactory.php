...
class BrokerFactory
{
    ...
    public function create() : \_PhpScopere8e811afab72\PHPStan\Broker\Broker
    {
        return new \_PhpScopere8e811afab72\PHPStan\Broker\Broker($this->container->getByType(\_PhpScopere8e811afab72\PHPStan\Reflection\ReflectionProvider::class), $this->container->getByType(\_PhpScopere8e811afab72\PHPStan\DependencyInjection\Type\DynamicReturnTypeExtensionRegistryProvider::class), $this->container->getByType(\_PhpScopere8e811afab72\PHPStan\DependencyInjection\Type\OperatorTypeSpecifyingExtensionRegistryProvider::class), $this->container->getParameter('universalObjectCratesClasses'));
    }
}
