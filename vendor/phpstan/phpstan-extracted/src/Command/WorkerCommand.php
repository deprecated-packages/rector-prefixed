...
use _HumbugBox221ad6f1b81f__UniqueRector\React\Socket\TcpConnector;
...
class WorkerCommand extends \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Command\Command
{
    ...
    protected function execute(\_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputInterface $input, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $tcpConector = new \_HumbugBox221ad6f1b81f__UniqueRector\React\Socket\TcpConnector($loop);
        $tcpConector->connect(\sprintf('127.0.0.1:%d', $port))->done(function (\_HumbugBox221ad6f1b81f__UniqueRector\React\Socket\ConnectionInterface $connection) use($container, $identifier, $output, $analysedFiles, $tmpFile, $insteadOfFile) : void {
            $out = new \_HumbugBox221ad6f1b81f__UniqueRector\Clue\React\NDJson\Encoder($connection, \defined('JSON_INVALID_UTF8_IGNORE') ? \JSON_INVALID_UTF8_IGNORE : 0);
            $in = new \_HumbugBox221ad6f1b81f__UniqueRector\Clue\React\NDJson\Decoder($connection, \true, 512, \defined('JSON_INVALID_UTF8_IGNORE') ? \JSON_INVALID_UTF8_IGNORE : 0, $container->getParameter('parallel')['buffer']);
     ...
     */
    private function runWorker(\PHPStan\DependencyInjection\Container $container, \_HumbugBox221ad6f1b81f__UniqueRector\React\Stream\WritableStreamInterface $out, \_HumbugBox221ad6f1b81f__UniqueRector\React\Stream\ReadableStreamInterface $in, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\OutputInterface $output, array $analysedFiles, ?string $tmpFile, ?string $insteadOfFile) : void
    {
