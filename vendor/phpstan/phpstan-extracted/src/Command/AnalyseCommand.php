...
use _HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\StringInput;
use _HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\OutputInterface;
use _HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\StreamOutput;
use function stream_get_contents;
class AnalyseCommand extends \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setName(self::NAME)->setDescription('Analyses source code')->setDefinition([new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputArgument('paths', \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputArgument::OPTIONAL | \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths with source code to run analysis on'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('paths-file', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to a file with a list of paths to run analysis on'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('configuration', 'c', \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to project configuration file'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption(self::OPTION_LEVEL, 'l', \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Level of rule options - the higher the stricter'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption(\PHPStan\Command\ErrorsConsoleStyle::OPTION_NO_PROGRESS, null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not show progress bar, only results'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('debug', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Show debug information - which file is analysed, do not catch internal errors'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('autoload-file', 'a', \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Project\'s additional autoload file path'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('error-format', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Format in which to print the result of the analysis', null), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('generate-baseline', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'Path to a file where the baseline should be saved', \false), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('memory-limit', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Memory limit for analysis'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('xdebug', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Allow running with XDebug for debugging purposes'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('fix', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('watch', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro'), new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption('pro', null, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro')]);
    }
    /**
     * @return string[]
     */
    ...
    protected function initialize(\_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputInterface $input, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
    ...
    protected function execute(\_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\InputInterface $input, \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if ($errorFormat === null) {
            $errorFormat = 'table';
            $ciDetector = new \_HumbugBox221ad6f1b81f__UniqueRector\OndraM\CiDetector\CiDetector();
            try {
                $ci = $ciDetector->detect();
                if ($ci->getCiName() === \_HumbugBox221ad6f1b81f__UniqueRector\OndraM\CiDetector\CiDetector::CI_GITHUB_ACTIONS) {
                    $errorFormat = 'github';
                } elseif ($ci->getCiName() === \_HumbugBox221ad6f1b81f__UniqueRector\OndraM\CiDetector\CiDetector::CI_TEAMCITY) {
                    $errorFormat = 'teamcity';
                }
            } catch (\_HumbugBox221ad6f1b81f__UniqueRector\OndraM\CiDetector\Exception\CiNotDetectedException $e) {
                // pass
            }
        }
        ...
        if ($generateBaselineFile !== null) {
            ...
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Input\StringInput(''), $streamOutput);
    ...
    private function createStreamOutput() : \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\StreamOutput
    {
        $resource = \fopen('php://memory', 'w', \false);
        if ($resource === \false) {
            throw new \PHPStan\ShouldNotHappenException();
        }
        return new \_HumbugBox221ad6f1b81f__UniqueRector\Symfony\Component\Console\Output\StreamOutput($resource);
    }
}
