...
use _PhpScoper0a2ac50786fa\PHPStan\Command\ErrorFormatter\BaselineNeonErrorFormatter;
use _PhpScoper0a2ac50786fa\PHPStan\Command\ErrorFormatter\ErrorFormatter;
use _PhpScoper0a2ac50786fa\PHPStan\Command\ErrorFormatter\TableErrorFormatter;
...
use _PhpScoper0a2ac50786fa\PHPStan\File\ParentDirectoryRelativePathHelper;
...
class AnalyseCommand extends \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Command\Command
{
    private const NAME = 'analyse';
    public const OPTION_LEVEL = 'level';
    public const DEFAULT_LEVEL = \_PhpScoper0a2ac50786fa\PHPStan\Command\CommandHelper::DEFAULT_LEVEL;
    /** @var string[] */
    ...
    {
        $this->setName(self::NAME)->setDescription('Analyses source code')->setDefinition([new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputArgument('paths', \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputArgument::OPTIONAL | \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths with source code to run analysis on'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('paths-file', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to a file with a list of paths to run analysis on'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('configuration', 'c', \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to project configuration file'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption(self::OPTION_LEVEL, 'l', \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Level of rule options - the higher the stricter'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption(\_PhpScoper0a2ac50786fa\PHPStan\Command\ErrorsConsoleStyle::OPTION_NO_PROGRESS, null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not show progress bar, only results'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('debug', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Show debug information - which file is analysed, do not catch internal errors'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('autoload-file', 'a', \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Project\'s additional autoload file path'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('error-format', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Format in which to print the result of the analysis', null), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('generate-baseline', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'Path to a file where the baseline should be saved', \false), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('memory-limit', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Memory limit for analysis'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('xdebug', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Allow running with XDebug for debugging purposes'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('fix', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('watch', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro'), new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption('pro', null, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro')]);
    }
    /**
     * @return string[]
     */
    ...
    protected function initialize(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
    ...
    protected function execute(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        try {
            $inceptionResult = \_PhpScoper0a2ac50786fa\PHPStan\Command\CommandHelper::begin($input, $output, $paths, $pathsFile, $memoryLimit, $autoloadFile, $this->composerAutoloaderProjectPaths, $configuration, $generateBaselineFile, $level, $allowXdebug, \true, $debugEnabled);
        ...
        if ($errorFormat === null) {
            $errorFormat = 'table';
            $ciDetector = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\OndraM\CiDetector\CiDetector();
            try {
                $ci = $ciDetector->detect();
                if ($ci->getCiName() === \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\OndraM\CiDetector\CiDetector::CI_GITHUB_ACTIONS) {
                    $errorFormat = 'github';
                } elseif ($ci->getCiName() === \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\OndraM\CiDetector\CiDetector::CI_TEAMCITY) {
                    $errorFormat = 'teamcity';
                }
            } catch (\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\OndraM\CiDetector\Exception\CiNotDetectedException $e) {
                // pass
            }
        }
        ...
        if (!$container->hasService($errorFormatterServiceName)) {
            ...
            }, $container->findServiceNamesByType(\_PhpScoper0a2ac50786fa\PHPStan\Command\ErrorFormatter\ErrorFormatter::class)))));
            return 1;
        }
        ...
        } catch (\_PhpScoper0a2ac50786fa\PHPStan\File\PathNotFoundException $e) {
            $inceptionResult->getErrorOutput()->writeLineFormatted(\sprintf('<error>%s</error>', $e->getMessage()));
            return 1;
        }
        /** @var AnalyseApplication  $application */
        $application = $container->getByType(\_PhpScoper0a2ac50786fa\PHPStan\Command\AnalyseApplication::class);
        ...
        if ($generateBaselineFile !== null) {
            ...
            $baselineErrorFormatter = new \_PhpScoper0a2ac50786fa\PHPStan\Command\ErrorFormatter\BaselineNeonErrorFormatter(new \_PhpScoper0a2ac50786fa\PHPStan\File\ParentDirectoryRelativePathHelper($baselineFileDirectory));
            $streamOutput = $this->createStreamOutput();
            $errorConsoleStyle = new \_PhpScoper0a2ac50786fa\PHPStan\Command\ErrorsConsoleStyle(new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\StringInput(''), $streamOutput);
            $baselineOutput = new \_PhpScoper0a2ac50786fa\PHPStan\Command\Symfony\SymfonyOutput($streamOutput, new \_PhpScoper0a2ac50786fa\PHPStan\Command\Symfony\SymfonyStyle($errorConsoleStyle));
            ...
            try {
                \_PhpScoper0a2ac50786fa\PHPStan\File\FileWriter::write($generateBaselineFile, $baselineContents);
            } catch (\_PhpScoper0a2ac50786fa\PHPStan\File\CouldNotWriteFileException $e) {
        ...
        if ($fix) {
            ...
            $container->getByType(\_PhpScoper0a2ac50786fa\PHPStan\Analyser\ResultCache\ResultCacheClearer::class)->clearTemporaryCaches();
            ...
            if ($hasInternalErrors || \count($nonIgnorableErrorsByException) > 0) {
                $fixerAnalysisResult = new \_PhpScoper0a2ac50786fa\PHPStan\Command\AnalysisResult($nonIgnorableErrorsByException, $analysisResult->getInternalErrors(), $analysisResult->getInternalErrors(), [], $analysisResult->isDefaultLevelUsed(), $analysisResult->getProjectConfigFile(), $analysisResult->isResultCacheSaved());
            ...
            $fixerApplication = $container->getByType(\_PhpScoper0a2ac50786fa\PHPStan\Command\FixerApplication::class);
    ...
    private function createStreamOutput() : \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Output\StreamOutput
    {
        $resource = \fopen('php://memory', 'w', \false);
        if ($resource === \false) {
            throw new \_PhpScoper0a2ac50786fa\PHPStan\ShouldNotHappenException();
        }
        return new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Output\StreamOutput($resource);
    }
}
