...
use _PhpScoper0a2ac50786fa\PHPStan\Internal\BytesHelper;
use _PhpScoper0a2ac50786fa\PHPStan\PhpDoc\StubValidator;
...
class AnalyseApplication
{
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\PHPStan\Command\AnalyserRunner $analyserRunner, \_PhpScoper0a2ac50786fa\PHPStan\PhpDoc\StubValidator $stubValidator, \_PhpScoper0a2ac50786fa\PHPStan\Analyser\ResultCache\ResultCacheManagerFactory $resultCacheManagerFactory, \_PhpScoper0a2ac50786fa\PHPStan\Analyser\IgnoredErrorHelper $ignoredErrorHelper, string $memoryLimitFile, int $internalErrorsCountLimit)
    {
     ...
     */
    public function analyse(array $files, bool $onlyFiles, \_PhpScoper0a2ac50786fa\PHPStan\Command\Output $stdOutput, \_PhpScoper0a2ac50786fa\PHPStan\Command\Output $errorOutput, bool $defaultLevelUsed, bool $debug, ?string $projectConfigFile, ?array $projectConfigArray, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputInterface $input) : \_PhpScoper0a2ac50786fa\PHPStan\Command\AnalysisResult
    {
        ...
        return new \_PhpScoper0a2ac50786fa\PHPStan\Command\AnalysisResult($fileSpecificErrors, $notFileSpecificErrors, $internalErrors, $warnings, $defaultLevelUsed, $projectConfigFile, $savedResultCache);
    }
    /**
     * @param string[] $files
     * @param string[] $allAnalysedFiles
     */
    private function runAnalyser(array $files, array $allAnalysedFiles, bool $debug, ?string $projectConfigFile, \_PhpScoper0a2ac50786fa\PHPStan\Command\Output $stdOutput, \_PhpScoper0a2ac50786fa\PHPStan\Command\Output $errorOutput, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Symfony\Component\Console\Input\InputInterface $input) : \_PhpScoper0a2ac50786fa\PHPStan\Analyser\AnalyserResult
    {
        ...
        if (!$debug) {
            ...
            if ($stdOutput->isDebug()) {
                ...
                $postFileCallback = static function () use($stdOutput, &$previousMemory) : void {
                    ...
                    $stdOutput->writeLineFormatted(\sprintf('--- consumed %s, total %s', \_PhpScoper0a2ac50786fa\PHPStan\Internal\BytesHelper::bytes($currentTotalMemory - $previousMemory), \_PhpScoper0a2ac50786fa\PHPStan\Internal\BytesHelper::bytes($currentTotalMemory)));
