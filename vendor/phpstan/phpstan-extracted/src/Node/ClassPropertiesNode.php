...
use _PhpScoper0a6b37af0871\PHPStan\Node\Method\MethodCall;
...
use _PhpScoper0a6b37af0871\PHPStan\Rules\Properties\ReadWritePropertiesExtension;
use _PhpScoper0a6b37af0871\PHPStan\Type\MixedType;
use _PhpScoper0a6b37af0871\PHPStan\Type\ObjectType;
class ClassPropertiesNode extends \_PhpScoper0a6b37af0871\PhpParser\NodeAbstract implements \_PhpScoper0a6b37af0871\PHPStan\Node\VirtualNode
{
    /** @var ClassLike */
    private $class;
     ...
     */
    public function __construct(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassLike $class, array $properties, array $propertyUsages, array $methodCalls)
    {
     ...
     */
    public function getUninitializedProperties(\_PhpScoper0a6b37af0871\PHPStan\Analyser\Scope $scope, array $constructors, array $extensions) : array
    {
        if (!$this->getClass() instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_) {
            return [[], []];
        }
        if (!$scope->isInClass()) {
        ...
        $classType = new \_PhpScoper0a6b37af0871\PHPStan\Type\ObjectType($scope->getClassReflection()->getName());
        ...
        foreach ($this->getPropertyUsages() as $usage) {
            ...
            if ($usage instanceof \_PhpScoper0a6b37af0871\PHPStan\Node\Property\PropertyWrite) {
     ...
     * @return string[]
     */
    private function getMethodsCalledFromConstructor(\_PhpScoper0a6b37af0871\PHPStan\Type\ObjectType $classType, array $methodCalls, array $methods) : array
    {
