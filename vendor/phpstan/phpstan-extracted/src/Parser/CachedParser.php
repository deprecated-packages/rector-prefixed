...
class CachedParser implements \RectorPrefix20201227\PHPStan\Parser\Parser
{
    ...
    public function __construct(\RectorPrefix20201227\PHPStan\Parser\Parser $originalParser, int $cachedNodesByStringCountMax)
    {
    ...
    public function parseFile(string $file) : array
    {
        ...
        $sourceCode = \RectorPrefix20201227\PHPStan\File\FileReader::read($file);
