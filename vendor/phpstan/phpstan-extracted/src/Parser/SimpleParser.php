...
class SimpleParser implements \_PhpScoper0a2ac50786fa\PHPStan\Parser\Parser
{
    /** @var \PhpParser\Parser */
    private $parser;
    /** @var NameResolver */
    private $nameResolver;
    public function __construct(\_PhpScoper0a2ac50786fa\PhpParser\Parser $parser, \_PhpScoper0a2ac50786fa\PhpParser\NodeVisitor\NameResolver $nameResolver)
    {
        $this->parser = $parser;
