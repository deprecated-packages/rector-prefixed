...
use _PhpScoper0a6b37af0871\PHPStan\Type\MethodTypeSpecifyingExtension;
use _PhpScoper0a6b37af0871\PHPStan\Type\TypeCombinator;
class ScopeIsInClassTypeSpecifyingExtension implements \_PhpScoper0a6b37af0871\PHPStan\Type\MethodTypeSpecifyingExtension, \_PhpScoper0a6b37af0871\PHPStan\Analyser\TypeSpecifierAwareExtension
{
    /** @var string */
    ...
    public function __construct(string $isInMethodName, string $removeNullMethodName, \_PhpScoper0a6b37af0871\PHPStan\Reflection\ReflectionProvider $reflectionProvider)
    {
    ...
    {
        return \_PhpScoper0a6b37af0871\PHPStan\Reflection\ClassMemberAccessAnswerer::class;
    }
    ...
    {
        $scopeClass = $this->reflectionProvider->getClass(\_PhpScoper0a6b37af0871\PHPStan\Analyser\Scope::class);
        $methodVariants = $scopeClass->getMethod($this->removeNullMethodName, $scope)->getVariants();
        return $this->typeSpecifier->create(new \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\MethodCall($node->var, $this->removeNullMethodName), \_PhpScoper0a6b37af0871\PHPStan\Type\TypeCombinator::removeNull(\_PhpScoper0a6b37af0871\PHPStan\Reflection\ParametersAcceptorSelector::selectSingle($methodVariants)->getReturnType()), $context);
    }
}
