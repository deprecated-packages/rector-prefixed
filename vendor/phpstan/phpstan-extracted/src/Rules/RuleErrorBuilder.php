...
class RuleErrorBuilder
{
    ...
    {
        return [self::TYPE_MESSAGE => [\_PhpScoper2a4e7ab1ecbc\PHPStan\Rules\RuleError::class, 'message', 'string', 'string'], self::TYPE_LINE => [\_PhpScoper2a4e7ab1ecbc\PHPStan\Rules\LineRuleError::class, 'line', 'int', 'int'], self::TYPE_FILE => [\_PhpScoper2a4e7ab1ecbc\PHPStan\Rules\FileRuleError::class, 'file', 'string', 'string'], self::TYPE_TIP => [\_PhpScoper2a4e7ab1ecbc\PHPStan\Rules\TipRuleError::class, 'tip', 'string', 'string'], self::TYPE_IDENTIFIER => [\_PhpScoper2a4e7ab1ecbc\PHPStan\Rules\IdentifierRuleError::class, 'identifier', 'string', 'string'], self::TYPE_METADATA => [\_PhpScoper2a4e7ab1ecbc\PHPStan\Rules\MetadataRuleError::class, 'metadata', 'array', 'mixed[]'], self::TYPE_NON_IGNORABLE => [\_PhpScoper2a4e7ab1ecbc\PHPStan\Rules\NonIgnorableRuleError::class, null, null, null]];
    }
    ...
    public function build() : \_PhpScoper2a4e7ab1ecbc\PHPStan\Rules\RuleError
    {
        /** @var class-string<RuleError> $className */
        $className = \sprintf('PHPStan\\Rules\\RuleErrors\\RuleError%d', $this->type);
        if (!\class_exists($className)) {
            throw new \_PhpScoper2a4e7ab1ecbc\PHPStan\ShouldNotHappenException(\sprintf('Class %s does not exist.', $className));
        }
