 ...
 */
class UnusedPrivateMethodRule implements \_PhpScoper0a2ac50786fa\PHPStan\Rules\Rule
{
    public function getNodeType() : string
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\Node\ClassMethodsNode::class;
    }
    public function processNode(\_PhpScoper0a2ac50786fa\PhpParser\Node $node, \_PhpScoper0a2ac50786fa\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        foreach ($node->getMethodCalls() as $methodCall) {
            ...
            if ($methodCallNode->name instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Identifier) {
                ...
                $strings = \_PhpScoper0a2ac50786fa\PHPStan\Type\TypeUtils::getConstantStrings($methodNameType);
                if (\count($strings) === 0) {
                    return [];
                }
                $methodNames = \array_map(static function (\_PhpScoper0a2ac50786fa\PHPStan\Type\Constant\ConstantStringType $type) : string {
