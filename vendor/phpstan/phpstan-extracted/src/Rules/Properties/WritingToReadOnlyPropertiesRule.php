 ...
 */
class WritingToReadOnlyPropertiesRule implements \_PhpScoper0a6b37af0871\PHPStan\Rules\Rule
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\PHPStan\Rules\RuleLevelHelper $ruleLevelHelper, \_PhpScoper0a6b37af0871\PHPStan\Rules\Properties\PropertyDescriptor $propertyDescriptor, \_PhpScoper0a6b37af0871\PHPStan\Rules\Properties\PropertyReflectionFinder $propertyReflectionFinder, bool $checkThisOnly)
    {
    ...
    public function processNode(\_PhpScoper0a6b37af0871\PhpParser\Node $node, \_PhpScoper0a6b37af0871\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if ($node->var instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\PropertyFetch && $this->checkThisOnly && !$this->ruleLevelHelper->isThis($node->var->var)) {
            return [];
        }
        ...
        if (!$propertyReflection->isWritable()) {
            ...
            return [\_PhpScoper0a6b37af0871\PHPStan\Rules\RuleErrorBuilder::message(\sprintf('%s is not writable.', $propertyDescription))->build()];
        }
        return [];
    }
}
