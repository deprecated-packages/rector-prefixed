 ...
 */
class TypesAssignedToPropertiesRule implements \_PhpScoper0a6b37af0871\PHPStan\Rules\Rule
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\PHPStan\Rules\RuleLevelHelper $ruleLevelHelper, \_PhpScoper0a6b37af0871\PHPStan\Rules\Properties\PropertyDescriptor $propertyDescriptor, \_PhpScoper0a6b37af0871\PHPStan\Rules\Properties\PropertyReflectionFinder $propertyReflectionFinder)
    {
     ...
     * @return RuleError[]
     */
    private function processSingleProperty(\_PhpScoper0a6b37af0871\PHPStan\Rules\Properties\FoundPropertyReflection $propertyReflection, \_PhpScoper0a6b37af0871\PhpParser\Node\Expr $node) : array
    {
        ...
        if (!$this->ruleLevelHelper->accepts($propertyType, $assignedValueType, $scope->isDeclareStrictTypes())) {
            ...
            return [\_PhpScoper0a6b37af0871\PHPStan\Rules\RuleErrorBuilder::message(\sprintf('%s (%s) does not accept %s.', $propertyDescription, $propertyType->describe($verbosityLevel), $assignedValueType->describe($verbosityLevel)))->build()];
        }
        return [];
    }
}
