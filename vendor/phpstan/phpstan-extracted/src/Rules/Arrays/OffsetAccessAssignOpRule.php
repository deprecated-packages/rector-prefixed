 ...
 */
class OffsetAccessAssignOpRule implements \_PhpScoper0a2ac50786fa\PHPStan\Rules\Rule
{
    /** @var RuleLevelHelper */
    ...
    {
        return \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\AssignOp::class;
    }
    public function processNode(\_PhpScoper0a2ac50786fa\PhpParser\Node $node, \_PhpScoper0a2ac50786fa\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        $varTypeResult = $this->ruleLevelHelper->findTypeToCheck($scope, $arrayDimFetch->var, '', static function (\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $varType) use($potentialDimType) : bool {
        ...
        if ($arrayDimFetch->dim !== null) {
            $dimTypeResult = $this->ruleLevelHelper->findTypeToCheck($scope, $arrayDimFetch->dim, '', static function (\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $dimType) use($varType) : bool {
