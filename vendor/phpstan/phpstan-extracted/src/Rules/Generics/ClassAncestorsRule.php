 ...
 */
class ClassAncestorsRule implements \RectorPrefix20201227\PHPStan\Rules\Rule
{
    ...
    public function processNode(\PhpParser\Node $node, \RectorPrefix20201227\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        $extendsErrors = $this->genericAncestorsCheck->check($node->extends !== null ? [$node->extends] : [], \array_map(static function (\RectorPrefix20201227\PHPStan\PhpDoc\Tag\ExtendsTag $tag) : Type {
            return $tag->getType();
        ...
        $implementsErrors = $this->genericAncestorsCheck->check($node->implements, \array_map(static function (\RectorPrefix20201227\PHPStan\PhpDoc\Tag\ImplementsTag $tag) : Type {
            return $tag->getType();
