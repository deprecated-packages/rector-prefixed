 ...
 */
class ClassAncestorsRule implements \_PhpScoperb75b35f52b74\PHPStan\Rules\Rule
{
    ...
    public function processNode(\_PhpScoperb75b35f52b74\PhpParser\Node $node, \_PhpScoperb75b35f52b74\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        $extendsErrors = $this->genericAncestorsCheck->check($node->extends !== null ? [$node->extends] : [], \array_map(static function (\_PhpScoperb75b35f52b74\PHPStan\PhpDoc\Tag\ExtendsTag $tag) : Type {
            return $tag->getType();
        ...
        $implementsErrors = $this->genericAncestorsCheck->check($node->implements, \array_map(static function (\_PhpScoperb75b35f52b74\PHPStan\PhpDoc\Tag\ImplementsTag $tag) : Type {
            return $tag->getType();
