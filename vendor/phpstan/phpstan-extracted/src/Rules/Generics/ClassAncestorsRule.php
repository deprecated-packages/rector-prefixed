 ...
 */
class ClassAncestorsRule implements \_PhpScopere8e811afab72\PHPStan\Rules\Rule
{
    ...
    public function processNode(\_PhpScopere8e811afab72\PhpParser\Node $node, \_PhpScopere8e811afab72\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        $extendsErrors = $this->genericAncestorsCheck->check($node->extends !== null ? [$node->extends] : [], \array_map(static function (\_PhpScopere8e811afab72\PHPStan\PhpDoc\Tag\ExtendsTag $tag) : Type {
            return $tag->getType();
        ...
        $implementsErrors = $this->genericAncestorsCheck->check($node->implements, \array_map(static function (\_PhpScopere8e811afab72\PHPStan\PhpDoc\Tag\ImplementsTag $tag) : Type {
            return $tag->getType();
