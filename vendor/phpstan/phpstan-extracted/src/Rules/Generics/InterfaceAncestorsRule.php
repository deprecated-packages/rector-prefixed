 ...
 */
class InterfaceAncestorsRule implements \_PhpScoper0a6b37af0871\PHPStan\Rules\Rule
{
    ...
    public function processNode(\_PhpScoper0a6b37af0871\PhpParser\Node $node, \_PhpScoper0a6b37af0871\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        $extendsErrors = $this->genericAncestorsCheck->check($node->extends, \array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ExtendsTag $tag) : Type {
            return $tag->getType();
        ...
        $implementsErrors = $this->genericAncestorsCheck->check([], \array_map(static function (\_PhpScoper0a6b37af0871\PHPStan\PhpDoc\Tag\ImplementsTag $tag) : Type {
            return $tag->getType();
