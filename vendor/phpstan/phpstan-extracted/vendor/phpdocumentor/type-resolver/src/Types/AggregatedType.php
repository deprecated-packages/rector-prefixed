 ...
 */
abstract class AggregatedType implements \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Type, \IteratorAggregate
{
    /**
     ...
     */
    public function get(int $index) : ?\_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Type
    {
        if (!$this->has($index)) {
            return null;
        }
     ...
     */
    public function contains(\_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Type $type) : bool
    {
     ...
     */
    private function add(\_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Type $type) : void
    {
