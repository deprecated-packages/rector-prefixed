 ...
 */
abstract class AggregatedType implements \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Type, \IteratorAggregate
{
    /**
     ...
     */
    public function get(int $index) : ?\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Type
    {
        if (!$this->has($index)) {
            return null;
        }
     ...
     */
    public function contains(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Type $type) : bool
    {
     ...
     */
    private function add(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Type $type) : void
    {
