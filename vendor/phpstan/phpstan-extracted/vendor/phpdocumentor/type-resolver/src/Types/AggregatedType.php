 ...
 */
abstract class AggregatedType implements \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Type, \IteratorAggregate
{
    /**
     ...
     */
    public function get(int $index) : ?\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Type
    {
        if (!$this->has($index)) {
            return null;
        }
     ...
     */
    public function contains(\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Type $type) : bool
    {
     ...
     */
    private function add(\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Type $type) : void
    {
