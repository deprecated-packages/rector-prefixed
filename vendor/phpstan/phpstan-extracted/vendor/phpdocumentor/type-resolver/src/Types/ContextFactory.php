...
final class ContextFactory
{
     ...
     */
    public function createFromReflector(\Reflector $reflector) : \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionParameter(\ReflectionParameter $parameter) : \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionMethod(\ReflectionMethod $method) : \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionProperty(\ReflectionProperty $property) : \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionClassConstant(\ReflectionClassConstant $constant) : \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
     ...
     */
    private function createFromReflectionClass(\ReflectionClass $class) : \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context($namespace, []);
    }
    /**
     ...
     */
    public function createForNamespace(string $namespace, string $fileContents) : \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Context($namespace, $useStatements);
    }
    /**
