...
use _HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Void_;
use _HumbugBox221ad6f1b81f__UniqueRector\Webmozart\Assert\Assert;
/**
 * Reflection class for an {@}method in a Docblock.
 */
final class Method extends \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\DocBlock\Tags\BaseTag implements \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    ...
    /** @var Type */
    private $returnType;
    public function __construct($methodName, array $arguments = [], \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Type $returnType = null, $static = \false, \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\DocBlock\Description $description = null)
    {
        \_HumbugBox221ad6f1b81f__UniqueRector\Webmozart\Assert\Assert::stringNotEmpty($methodName);
        \_HumbugBox221ad6f1b81f__UniqueRector\Webmozart\Assert\Assert::boolean($static);
        if ($returnType === null) {
            $returnType = new \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Void_();
        }
        ...
        if (\is_string($arguments) && \strlen($arguments) > 0) {
            ...
            foreach ($arguments as &$argument) {
                ...
                if ($argument[0][0] === '$') {
                    ...
                    $argumentType = new \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Void_();
                } else {
    ...
    private function filterArguments($arguments)
    {
        foreach ($arguments as &$argument) {
            ...
            if (!isset($argument['type'])) {
                $argument['type'] = new \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\Types\Void_();
            }
