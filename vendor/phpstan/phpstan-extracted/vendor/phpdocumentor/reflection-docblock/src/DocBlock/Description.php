...
use _HumbugBox221ad6f1b81f\phpDocumentor\Reflection\DocBlock\Tags\Formatter\PassthroughFormatter;
...
class Description
{
    ...
    {
        \_HumbugBox221ad6f1b81f\Webmozart\Assert\Assert::string($bodyTemplate);
