...
use _HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\DocBlock\Tags\Formatter\PassthroughFormatter;
...
class Description
{
    ...
    {
        \_HumbugBox221ad6f1b81f__UniqueRector\Webmozart\Assert\Assert::string($bodyTemplate);
     ...
     * @return string
     */
    public function render(\_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\DocBlock\Tags\Formatter $formatter = null)
    {
        if ($formatter === null) {
            $formatter = new \_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\DocBlock\Tags\Formatter\PassthroughFormatter();
        }
        $tags = [];
