...
class Alias extends \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUseAdaptation
{
    ...
    public function __construct($trait, $method, $newModifier, $newName, array $attributes = [])
    {
        ...
        $this->newName = \is_string($newName) ? new \_PhpScoper0a6b37af0871\PhpParser\Node\Identifier($newName) : $newName;
    }
