...
class NodeTraverser implements \_PhpScoper0a2ac50786fa\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper0a2ac50786fa\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper0a2ac50786fa\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : \_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt && $new instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr && $new instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt) {
