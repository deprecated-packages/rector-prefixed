...
class NodeTraverser implements \_PhpScopere8e811afab72\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopere8e811afab72\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopere8e811afab72\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopere8e811afab72\PhpParser\Node $node) : \_PhpScopere8e811afab72\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopere8e811afab72\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopere8e811afab72\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopere8e811afab72\PhpParser\Node\Stmt && $new instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopere8e811afab72\PhpParser\Node\Expr && $new instanceof \_PhpScopere8e811afab72\PhpParser\Node\Stmt) {
