 ...
 */
abstract class ClassLike extends \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt
{
        ...
        foreach ($this->stmts as $stmt) {
            if ($stmt instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Property) {
                foreach ($stmt->props as $prop) {
                    if ($prop instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\PropertyProperty && $name === $prop->name->toString()) {
                        return $stmt;
                    }
                }
            }
