 ...
 */
abstract class ClassLike extends \_PhpScopere8e811afab72\PhpParser\Node\Stmt
{
        ...
        foreach ($this->stmts as $stmt) {
            if ($stmt instanceof \_PhpScopere8e811afab72\PhpParser\Node\Stmt\Property) {
                foreach ($stmt->props as $prop) {
                    if ($prop instanceof \_PhpScopere8e811afab72\PhpParser\Node\Stmt\PropertyProperty && $name === $prop->name->toString()) {
                        return $stmt;
                    }
                }
            }
