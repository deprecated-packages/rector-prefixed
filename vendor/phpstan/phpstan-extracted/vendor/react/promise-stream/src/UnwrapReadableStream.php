 ...
 */
class UnwrapReadableStream extends \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Evenement\EventEmitter implements \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface
{
    private $promise;
     ...
     */
    public function __construct(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Promise\PromiseInterface $promise)
    {
        $out = $this;
        $closed =& $this->closed;
        $this->promise = $promise->then(function ($stream) {
            ...
            return $stream;
        })->then(function (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface $stream) use($out, &$closed) {
    ...
    public function pause()
    {
        if ($this->promise !== null) {
            $this->promise->then(function (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface $stream) {
                $stream->pause();
            });
        }
    }
    ...
    public function close()
    {
        ...
        if ($this->promise instanceof \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Promise\CancellablePromiseInterface) {
            $this->promise->cancel();
        }
        $this->promise = null;
        $this->emit('close');
