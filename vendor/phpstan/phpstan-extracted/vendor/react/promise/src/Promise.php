...
class Promise implements \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Promise\ExtendedPromiseInterface, \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Promise\CancellablePromiseInterface
{
    private $canceller;
    private $result;
    private $handlers = [];
    ...
    public function done(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        ...
        $this->handlers[] = static function (\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected) {
    ...
    private function resolver(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        return function ($resolve, $reject, $notify) use($onFulfilled, $onRejected, $onProgress) {
            ...
            $this->handlers[] = static function (\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected, $resolve, $reject, $progressHandler) {
    ...
    private function settle(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Promise\ExtendedPromiseInterface $promise)
    {
        $promise = $this->unwrap($promise);
        if ($promise === $this) {
            $promise = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Promise\RejectedPromise(new \LogicException('Cannot resolve a promise with itself.'));
        }
    ...
    {
        if ($promise instanceof \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Promise\LazyPromise) {
