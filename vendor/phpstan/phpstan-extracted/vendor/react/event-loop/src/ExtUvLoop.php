 ...
 */
final class ExtUvLoop implements \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface
{
    private $uv;
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\uv_signal_init($this->uv);
            \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\uv_signal_start($this->signalEvents[$signal], function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
        }
    }
    ...
    {
        if (!isset($this->streamEvents[(int) $stream])) {
            $this->streamEvents[(int) $stream] = \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\uv_poll_init_socket($this->uv, $stream);
        }
