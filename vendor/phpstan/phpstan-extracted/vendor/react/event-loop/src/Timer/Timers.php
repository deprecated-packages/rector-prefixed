...
namespace _HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\Timer;
...
final class Timers
{
    ...
    public function add(\_HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\TimerInterface $timer)
    {
    ...
    public function contains(\_HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\TimerInterface $timer)
    {
        return isset($this->timers[\spl_object_hash($timer)]);
    }
    public function cancel(\_HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\TimerInterface $timer)
    {
        $id = \spl_object_hash($timer);
