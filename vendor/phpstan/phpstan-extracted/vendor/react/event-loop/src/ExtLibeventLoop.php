 ...
 */
final class ExtLibeventLoop implements \_HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\LoopInterface
{
    /** @internal */
     ...
     */
    private function scheduleTimer(\_HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\TimerInterface $timer)
    {
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \_HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
