 ...
 */
final class ExtLibeventLoop implements \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface
{
    /** @internal */
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
