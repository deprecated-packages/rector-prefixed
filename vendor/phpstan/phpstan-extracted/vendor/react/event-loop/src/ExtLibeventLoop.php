 ...
 */
final class ExtLibeventLoop implements \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface
{
    /** @internal */
     ...
     */
    private function scheduleTimer(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\EventLoop\TimerInterface $timer)
    {
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
