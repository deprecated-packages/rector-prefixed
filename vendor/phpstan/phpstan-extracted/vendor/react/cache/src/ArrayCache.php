...
namespace _HumbugBox221ad6f1b81f\React\Cache;

use _HumbugBox221ad6f1b81f\React\Promise;
use _HumbugBox221ad6f1b81f\React\Promise\PromiseInterface;
class ArrayCache implements \_HumbugBox221ad6f1b81f\React\Cache\CacheInterface
{
    private $limit;
    private $data = array();
    ...
    public function get($key, $default = null)
    {
        ...
        if (!\array_key_exists($key, $this->data)) {
            return \_HumbugBox221ad6f1b81f\React\Promise\resolve($default);
        }
        // remove and append to end of array to keep track of LRU info
        $value = $this->data[$key];
        unset($this->data[$key]);
        $this->data[$key] = $value;
        return \_HumbugBox221ad6f1b81f\React\Promise\resolve($value);
    }
    public function set($key, $value, $ttl = null)
    {
        ...
        return \_HumbugBox221ad6f1b81f\React\Promise\resolve(\true);
    }
    ...
    public function getMultiple(array $keys, $default = null)
    {
        ...
        return \_HumbugBox221ad6f1b81f\React\Promise\all($values);
    }
    ...
    public function has($key)
    {
        ...
        if (!\array_key_exists($key, $this->data)) {
            return \_HumbugBox221ad6f1b81f\React\Promise\resolve(\false);
        }
        // remove and append to end of array to keep track of LRU info
        $value = $this->data[$key];
        unset($this->data[$key]);
