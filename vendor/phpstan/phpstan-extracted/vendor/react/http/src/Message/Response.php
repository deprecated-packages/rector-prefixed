...
use _HumbugBox221ad6f1b81f__UniqueRector\RingCentral\Psr7\Response as Psr7Response;
 ...
 */
final class Response extends \_HumbugBox221ad6f1b81f__UniqueRector\RingCentral\Psr7\Response
{
    /**
    ...
    public function __construct($status = 200, array $headers = array(), $body = '', $version = '1.1', $reason = null)
    {
        if ($body instanceof \_HumbugBox221ad6f1b81f__UniqueRector\React\Stream\ReadableStreamInterface && !$body instanceof \_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\StreamInterface) {
            $body = new \_HumbugBox221ad6f1b81f__UniqueRector\React\Http\Io\HttpBodyStream($body, null);
