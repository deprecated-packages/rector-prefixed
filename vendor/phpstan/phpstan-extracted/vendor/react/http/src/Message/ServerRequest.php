...
namespace _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Message;
 ...
 */
final class ServerRequest extends \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\RingCentral\Psr7\Request implements \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface
{
    ...
    {
        $stream = null;
        if ($body instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface && !$body instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\StreamInterface) {
            $stream = $body;
            $body = null;
        } elseif (!\is_string($body) && !$body instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\StreamInterface) {
        ...
        if ($stream !== null) {
            ...
            $this->stream = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\HttpBodyStream($stream, $size);
        }
