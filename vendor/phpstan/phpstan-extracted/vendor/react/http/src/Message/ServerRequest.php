 ...
 */
final class ServerRequest extends \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\RingCentral\Psr7\Request implements \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface
{
    ...
    public function __construct($method, $url, array $headers = array(), $body = '', $version = '1.1', $serverParams = array())
    {
        ...
        if ($stream !== null) {
            ...
            $this->stream = new \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Http\Io\HttpBodyStream($stream, $size);
        }
