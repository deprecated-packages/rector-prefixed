...
{
    private $response;
    public function __construct(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ResponseInterface $response, $message = null, $code = null, $previous = null)
    {
        if ($message === null) {
