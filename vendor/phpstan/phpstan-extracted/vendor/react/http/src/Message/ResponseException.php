...
{
    private $response;
    public function __construct(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Psr\Http\Message\ResponseInterface $response, $message = null, $code = null, $previous = null)
    {
        if ($message === null) {
