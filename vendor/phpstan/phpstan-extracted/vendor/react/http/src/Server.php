...
namespace _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http;
...
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\MiddlewareRunner;
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\StreamingServer;
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Middleware\LimitConcurrentRequestsMiddleware;
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Middleware\StreamingRequestMiddleware;
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Middleware\RequestBodyBufferMiddleware;
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Middleware\RequestBodyParserMiddleware;
 ...
 */
final class Server extends \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Evenement\EventEmitter
{
    /**
    ...
    public function __construct(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface $loop)
    {
        ...
        foreach ((array) $requestHandlers as $handler) {
            if ($handler instanceof \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Middleware\StreamingRequestMiddleware) {
                $streaming = \true;
                break;
            }
        }
        ...
        if (!$streaming) {
            ...
            if ($concurrency !== null) {
                $middleware[] = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Middleware\LimitConcurrentRequestsMiddleware($concurrency);
            }
            $middleware[] = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Middleware\RequestBodyBufferMiddleware($maxSize);
            ...
            if ($enablePostDataReading !== '') {
                $middleware[] = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Middleware\RequestBodyParserMiddleware();
            }
        }
        $middleware = \array_merge($middleware, $requestHandlers);
        $this->streamingServer = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\StreamingServer($loop, new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\MiddlewareRunner($middleware));
        $that = $this;
    ...
    private function getConcurrentRequestsLimit($memory_limit, $post_max_size)
    {
        ...
        $availableMemory = \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\IniUtil::iniSizeToBytes($memory_limit) / 2;
        $concurrentRequests = (int) \ceil($availableMemory / \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\IniUtil::iniSizeToBytes($post_max_size));
    ...
    {
        $maxSize = \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\IniUtil::iniSizeToBytes($post_max_size === null ? \ini_get('post_max_size') : $post_max_size);
