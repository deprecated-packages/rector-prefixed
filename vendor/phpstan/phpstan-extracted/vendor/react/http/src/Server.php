...
namespace _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http;
...
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\IniUtil;
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\MiddlewareRunner;
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\StreamingServer;
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Middleware\LimitConcurrentRequestsMiddleware;
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Middleware\StreamingRequestMiddleware;
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Middleware\RequestBodyBufferMiddleware;
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Middleware\RequestBodyParserMiddleware;
 ...
 */
final class Server extends \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Evenement\EventEmitter
{
    /**
    ...
    public function __construct(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface $loop)
    {
        ...
        foreach ((array) $requestHandlers as $handler) {
            if ($handler instanceof \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Middleware\StreamingRequestMiddleware) {
                $streaming = \true;
                break;
            }
        }
        ...
        if (!$streaming) {
            ...
            if ($concurrency !== null) {
                $middleware[] = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Middleware\LimitConcurrentRequestsMiddleware($concurrency);
            }
            $middleware[] = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Middleware\RequestBodyBufferMiddleware($maxSize);
            ...
            if ($enablePostDataReading !== '') {
                $middleware[] = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Middleware\RequestBodyParserMiddleware();
            }
        }
        $middleware = \array_merge($middleware, $requestHandlers);
        $this->streamingServer = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\StreamingServer($loop, new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\MiddlewareRunner($middleware));
        $that = $this;
    ...
    private function getConcurrentRequestsLimit($memory_limit, $post_max_size)
    {
        ...
        $availableMemory = \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\IniUtil::iniSizeToBytes($memory_limit) / 2;
        $concurrentRequests = (int) \ceil($availableMemory / \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\IniUtil::iniSizeToBytes($post_max_size));
    ...
    {
        $maxSize = \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\IniUtil::iniSizeToBytes($post_max_size === null ? \ini_get('post_max_size') : $post_max_size);
