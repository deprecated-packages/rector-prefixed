...
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\ReadableBodyStream;
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\Sender;
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\Transaction;
...
class Browser
{
    ...
    {
        $this->transaction = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\Transaction(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\Sender::createFromLoop($loop, $connector), $loop);
    }
    /**
    ...
    public function withBase($baseUrl)
    {
        ...
        $browser->baseUrl = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\RingCentral\Psr7\Uri($baseUrl);
    ...
    private function requestMayBeStreaming($method, $url, array $headers = array(), $body = '')
    {
        if ($this->baseUrl !== null) {
            ...
            $url = \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\RingCentral\Psr7\Uri::resolve($this->baseUrl, $url);
        }
        if ($body instanceof \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface) {
            $body = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Http\Io\ReadableBodyStream($body);
        }
        return $this->transaction->send(new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\RingCentral\Psr7\Request($method, $url, $headers, $body, $this->protocolVersion));
    }
}
