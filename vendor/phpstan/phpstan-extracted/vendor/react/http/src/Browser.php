...
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\ReadableBodyStream;
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\Sender;
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\Transaction;
...
class Browser
{
     ...
     */
    public function __construct(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface $loop, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Socket\ConnectorInterface $connector = null)
    {
        $this->transaction = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\Transaction(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\Sender::createFromLoop($loop, $connector), $loop);
    }
    /**
    ...
    public function withBase($baseUrl)
    {
        ...
        $browser->baseUrl = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\RingCentral\Psr7\Uri($baseUrl);
    ...
    private function requestMayBeStreaming($method, $url, array $headers = array(), $body = '')
    {
        if ($this->baseUrl !== null) {
            ...
            $url = \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\RingCentral\Psr7\Uri::resolve($this->baseUrl, $url);
        }
        if ($body instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface) {
            $body = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\ReadableBodyStream($body);
        }
        return $this->transaction->send(new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\RingCentral\Psr7\Request($method, $url, $headers, $body, $this->protocolVersion));
    }
}
