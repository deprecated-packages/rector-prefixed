...
use _HumbugBox221ad6f1b81f__UniqueRector\React\Http\Io\MultipartParser;
final class RequestBodyParserMiddleware
{
    ...
    {
        $this->multipart = new \_HumbugBox221ad6f1b81f__UniqueRector\React\Http\Io\MultipartParser($uploadMaxFilesize, $maxFileUploads);
    }
    ...
    private function parseFormUrlencoded(\_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\ServerRequestInterface $request)
    {
