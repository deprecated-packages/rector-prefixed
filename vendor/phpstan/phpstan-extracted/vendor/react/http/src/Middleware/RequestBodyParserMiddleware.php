...
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\MultipartParser;
final class RequestBodyParserMiddleware
{
    ...
    {
        $this->multipart = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Http\Io\MultipartParser($uploadMaxFilesize, $maxFileUploads);
    }
    ...
    private function parseFormUrlencoded(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request)
    {
