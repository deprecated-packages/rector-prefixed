...
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\React\Http\Io\MultipartParser;
final class RequestBodyParserMiddleware
{
    ...
    {
        $this->multipart = new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\React\Http\Io\MultipartParser($uploadMaxFilesize, $maxFileUploads);
    }
    ...
    private function parseFormUrlencoded(\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request)
    {
