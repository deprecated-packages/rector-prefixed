...
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface;
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface;
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Message\Response;
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Message\ServerRequest;
...
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Socket\ServerInterface;
 ...
 * @internal
 */
final class StreamingServer extends \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Evenement\EventEmitter
{
    private $callback;
    private $parser;
    private $loop;
     ...
     * @see self::listen()
     */
    public function __construct(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface $loop, $requestHandler)
    {
        ...
        $this->parser = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\RequestHeaderParser();
        $that = $this;
        $this->parser->on('headers', function (\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Socket\ConnectionInterface $conn) use($that) {
            $that->handleRequest($conn, $request);
        });
        $this->parser->on('error', function (\Exception $e, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Socket\ConnectionInterface $conn) use($that) {
            $that->emit('error', array($e));
            // parsing failed => assume dummy request and send appropriate error
            $that->writeError($conn, $e->getCode() !== 0 ? $e->getCode() : 400, new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Message\ServerRequest('GET', '/'));
        });
    }
    /**
     ...
     */
    public function listen(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Socket\ServerInterface $socket)
    {
        $socket->on('connection', array($this->parser, 'handle'));
    }
    /** @internal */
    public function handleRequest(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Socket\ConnectionInterface $conn, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request)
    {
        ...
        try {
            ...
            $response = \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Promise\reject($error);
        ...
        if ($response instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Promise\CancellablePromiseInterface) {
            $conn->on('close', function () use($response) {
                $response->cancel();
            });
        }
        // happy path: response returned, handle and return immediately
        if ($response instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ResponseInterface) {
        ...
        if (!$response instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Promise\PromiseInterface) {
            $response = \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Promise\resolve($response);
        }
        $that = $this;
    ...
    /** @internal */
    public function writeError(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Socket\ConnectionInterface $conn, $code, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request)
    {
        $response = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Message\Response($code, array('Content-Type' => 'text/plain'), 'Error ' . $code);
    ...
    /** @internal */
    public function handleResponse(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Socket\ConnectionInterface $connection, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\ResponseInterface $response)
    {
        ...
        if (($code === 101 || $method === 'CONNECT' && $code >= 200 && $code < 300) && $body instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\HttpBodyStream && $body->input instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Stream\WritableStreamInterface) {
        ...
        if (!$body instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface || !$body->isReadable()) {
            ...
            if ($body instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Stream\ReadableStreamInterface && $chunked) {
                $body = "0\r\n\r\n";
            }
        ...
        $connection->write($headers . "\r\n");
        if ($chunked) {
            $body = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\React\Http\Io\ChunkedEncoder($body);
        }
