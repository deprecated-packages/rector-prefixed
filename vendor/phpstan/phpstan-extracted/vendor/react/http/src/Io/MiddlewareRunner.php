...
final class MiddlewareRunner
{
     ...
     * @throws \Exception
     */
    public function __invoke(\_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\ServerRequestInterface $request)
    {
    ...
    /** @internal */
    public function call(\_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\ServerRequestInterface $request, $position)
    {
        ...
        $that = $this;
        $next = function (\_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\ServerRequestInterface $request) use($that, $position) {
