...
final class MiddlewareRunner
{
     ...
     * @throws \Exception
     */
    public function __invoke(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request)
    {
    ...
    /** @internal */
    public function call(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request, $position)
    {
        ...
        $that = $this;
        $next = function (\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request) use($that, $position) {
