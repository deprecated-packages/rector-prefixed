...
final class MiddlewareRunner
{
     ...
     * @throws \Exception
     */
    public function __invoke(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request)
    {
    ...
    /** @internal */
    public function call(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request, $position)
    {
        ...
        $that = $this;
        $next = function (\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Psr\Http\Message\ServerRequestInterface $request) use($that, $position) {
