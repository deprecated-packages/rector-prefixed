...
namespace _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Protocol;

use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message;
use _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Record;
...
final class Parser
{
    ...
    public function parseMessage($data)
    {
        ...
        $message = new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message();
        $message->data = $data;
    ...
    private function parse($data, \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message $message)
    {
     ...
     * @return ?Query
     */
    private function parseQuestion(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message $message)
    {
        ...
        return new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Query\Query(\implode('.', $labels), $type, $class);
    }
    /**
     * @param Message $message
     * @return ?Record returns parsed Record on success or null if data is invalid/incomplete
     */
    private function parseRecord(\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message $message)
    {
        $consumed = $message->consumed;
        ...
        if (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_A === $type) {
            if ($rdLength === 4) {
                $rdata = \inet_ntop(\substr($message->data, $consumed, $rdLength));
                $consumed += $rdLength;
            }
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_AAAA === $type) {
            if ($rdLength === 16) {
                $rdata = \inet_ntop(\substr($message->data, $consumed, $rdLength));
                $consumed += $rdLength;
            }
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_CNAME === $type || \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_PTR === $type || \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_NS === $type) {
            list($rdata, $consumed) = $this->readDomain($message->data, $consumed);
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_TXT === $type) {
            $rdata = array();
        ...
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_MX === $type) {
            if ($rdLength > 2) {
        ...
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_SRV === $type) {
            if ($rdLength > 6) {
        ...
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_SSHFP === $type) {
            if ($rdLength > 2) {
        ...
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_SOA === $type) {
        ...
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_OPT === $type) {
            $rdata = array();
            while (isset($message->data[$consumed + 4 - 1])) {
                ...
                if ($code === \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::OPT_TCP_KEEPALIVE && $value === '') {
                    $value = null;
                } elseif ($code === \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::OPT_TCP_KEEPALIVE && $length === 2) {
                    list($value) = \array_values(\unpack('n', $value));
                    $value = \round($value * 0.1, 1);
                } elseif ($code === \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::OPT_TCP_KEEPALIVE) {
                    break;
                }
                $rdata[$code] = $value;
                $consumed += 4 + $length;
            }
        } elseif (\_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Message::TYPE_CAA === $type) {
            if ($rdLength > 3) {
        ...
        $message->consumed = $consumed;
        return new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\React\Dns\Model\Record($name, $type, $class, $ttl, $rdata);
    }
