 ...
 * ```
 */
class SelectiveTransportExecutor implements \_HumbugBox221ad6f1b81f__UniqueRector\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\_HumbugBox221ad6f1b81f__UniqueRector\React\Dns\Query\ExecutorInterface $datagramExecutor, \_HumbugBox221ad6f1b81f__UniqueRector\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\_HumbugBox221ad6f1b81f__UniqueRector\React\Dns\Query\Query $query)
    {
        ...
        return new \_HumbugBox221ad6f1b81f__UniqueRector\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
