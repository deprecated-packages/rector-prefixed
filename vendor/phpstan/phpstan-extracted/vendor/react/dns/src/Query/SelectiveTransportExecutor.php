 ...
 * ```
 */
class SelectiveTransportExecutor implements \_HumbugBox221ad6f1b81f\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\_HumbugBox221ad6f1b81f\React\Dns\Query\ExecutorInterface $datagramExecutor, \_HumbugBox221ad6f1b81f\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\_HumbugBox221ad6f1b81f\React\Dns\Query\Query $query)
    {
        ...
        return new \_HumbugBox221ad6f1b81f\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
