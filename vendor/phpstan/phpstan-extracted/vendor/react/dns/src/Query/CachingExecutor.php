...
final class CachingExecutor implements \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Dns\Query\ExecutorInterface
{
    /**
    ...
    private $executor;
    private $cache;
    public function __construct(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Dns\Query\ExecutorInterface $executor, \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Cache\CacheInterface $cache)
    {
    ...
    public function query(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Dns\Query\Query $query)
    {
        ...
        return new \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Promise\Promise(function ($resolve, $reject) use($query, $id, $cache, $executor, &$pending, $that) {
            $pending->then(function ($message) use($query, $id, $cache, $executor, &$pending, $that) {
                ...
                return $pending = $executor->query($query)->then(function (\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Dns\Model\Message $message) use($cache, $id, $that) {
     ...
     * @internal
     */
    public function ttl(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Dns\Model\Message $message)
    {
