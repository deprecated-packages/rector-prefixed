 ...
 * ```
 */
final class CoopExecutor implements \_HumbugBox221ad6f1b81f__UniqueRector\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\_HumbugBox221ad6f1b81f__UniqueRector\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\_HumbugBox221ad6f1b81f__UniqueRector\React\Dns\Query\Query $query)
    {
