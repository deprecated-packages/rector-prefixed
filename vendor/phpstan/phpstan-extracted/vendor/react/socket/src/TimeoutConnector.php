...
final class TimeoutConnector implements \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\React\Socket\ConnectorInterface $connector, $timeout, \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface $loop)
    {
    ...
    {
        return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\React\Promise\Timer\timeout($this->connector->connect($uri), $this->timeout, $this->loop)->then(null, self::handler($uri));
    }
    /**
