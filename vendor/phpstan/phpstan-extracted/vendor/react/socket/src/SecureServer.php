 ...
 */
final class SecureServer extends \_HumbugBox221ad6f1b81f__UniqueRector\Evenement\EventEmitter implements \_HumbugBox221ad6f1b81f__UniqueRector\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\_HumbugBox221ad6f1b81f__UniqueRector\React\Socket\ServerInterface $tcp, \_HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\LoopInterface $loop, array $context)
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \_HumbugBox221ad6f1b81f__UniqueRector\React\Socket\StreamEncryption($loop);
    ...
    /** @internal */
    public function handleConnection(\_HumbugBox221ad6f1b81f__UniqueRector\React\Socket\ConnectionInterface $connection)
    {
