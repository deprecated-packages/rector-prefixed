 ...
 */
final class UnixServer extends \_HumbugBox221ad6f1b81f__UniqueRector\Evenement\EventEmitter implements \_HumbugBox221ad6f1b81f__UniqueRector\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \_HumbugBox221ad6f1b81f__UniqueRector\React\EventLoop\LoopInterface $loop, array $context = array())
    {
        $this->loop = $loop;
    ...
    {
        $connection = new \_HumbugBox221ad6f1b81f__UniqueRector\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
