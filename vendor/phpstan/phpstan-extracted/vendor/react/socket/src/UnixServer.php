 ...
 */
final class UnixServer extends \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Evenement\EventEmitter implements \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface $loop, array $context = array())
    {
        $this->loop = $loop;
    ...
    {
        $connection = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
