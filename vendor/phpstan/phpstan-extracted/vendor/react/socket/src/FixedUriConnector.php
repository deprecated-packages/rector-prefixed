 ...
 * ```
 */
class FixedUriConnector implements \_HumbugBox221ad6f1b81f\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \_HumbugBox221ad6f1b81f\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
