...
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Stream\DuplexResourceStream;
 ...
 * @internal
 */
class Connection extends \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Evenement\EventEmitter implements \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
