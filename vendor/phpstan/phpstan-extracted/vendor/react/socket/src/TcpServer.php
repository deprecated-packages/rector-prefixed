 ...
 */
final class TcpServer extends \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Evenement\EventEmitter implements \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    ...
    {
        $this->emit('connection', array(new \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\React\Socket\Connection($socket, $this->loop)));
    }
}
