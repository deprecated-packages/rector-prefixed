...
{
    public static function toString(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
    ...
    private static function sourceToString(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
    ...
    private static function fileAndLinesToString(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
