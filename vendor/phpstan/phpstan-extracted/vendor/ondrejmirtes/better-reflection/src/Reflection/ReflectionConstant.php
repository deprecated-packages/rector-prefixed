...
use _PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\StringCast\ReflectionConstantStringCast;
...
class ReflectionConstant implements \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Reflection
{
    /** @var Reflector */
    private $reflector;
    ...
    {
        return (new \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\BetterReflection())->constantReflector()->reflect($constantName);
    }
    /**
     ...
     */
    public static function createFromNode(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper2a4e7ab1ecbc\PhpParser\Node $node, \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, ?\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\Namespace_ $namespace = null, ?int $positionInNode = null) : self
    {
        return $node instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\Const_ ? self::createFromConstKeyword($reflector, $node, $locatedSource, $namespace, $positionInNode) : self::createFromDefineFunctionCall($reflector, $node, $locatedSource);
    }
    private static function createFromConstKeyword(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\Const_ $node, \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, ?\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Stmt\Namespace_ $namespace, int $positionInNode) : self
    {
        $constant = new self();
     ...
     */
    private static function createFromDefineFunctionCall(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\FuncCall $node, \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource) : self
    {
    ...
    {
        if ($this->node instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\FuncCall) {
    ...
    public function getNamespaceName() : string
    {
        ...
        $namespaceParts = $this->node instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\FuncCall ? \array_slice(\explode('\\', $this->getNameFromDefineFunctionCall($this->node)), 0, -1) : $this->declaringNamespace->name->parts;
    ...
    public function getValue()
    {
        ...
        /** @psalm-suppress PossiblyNullArrayOffset */
        $valueNode = $this->node instanceof \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\FuncCall ? $this->node->args[1]->value : $this->node->consts[$this->positionInNode]->value;
        $namespace = null;
        if ($this->declaringNamespace !== null && $this->declaringNamespace->name !== null) {
            $namespace = (string) $this->declaringNamespace->name;
        }
        /** @psalm-suppress UndefinedPropertyFetch */
        $this->value = (new \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\NodeCompiler\CompileNodeToValue())->__invoke($valueNode, new \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\NodeCompiler\CompilerContext($this->reflector, $this->getFileName(), null, $namespace, null));
        $this->valueWasCached = \true;
        return $this->value;
    }
    ...
    {
        return \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\StringCast\ReflectionConstantStringCast::toString($this);
    }
    /**
     * @return Node\Stmt\Const_|Node\Expr\FuncCall
     */
    public function getAst() : \_PhpScoper2a4e7ab1ecbc\PhpParser\Node
    {
        return $this->node;
    }
    private function getNameFromDefineFunctionCall(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr\FuncCall $node) : string
    {
