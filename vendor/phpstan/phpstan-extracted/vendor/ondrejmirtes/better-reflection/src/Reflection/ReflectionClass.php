...
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ as ClassNode;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassConst as ConstNode;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassLike as ClassLikeNode;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Interface_ as InterfaceNode;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Namespace_ as NamespaceNode;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Namespace_;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property as PropertyNode;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Trait_ as TraitNode;
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUse;
use ReflectionClass as CoreReflectionClass;
use ReflectionException;
use ReflectionProperty as CoreReflectionProperty;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\BetterReflection;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\NodeCompiler\CompileNodeToValue;
...
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\PropertyDoesNotExist;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\Uncloneable;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\StringCast\ReflectionClassStringCast;
...
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\CalculateReflectionColum;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\GetLastDocComment;
use Traversable;
...
class ReflectionClass implements \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Reflection
{
    ...
    {
        return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\StringCast\ReflectionClassStringCast::toString($this);
    }
    /**
    ...
    {
        return (new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\BetterReflection())->classReflector()->reflect($className);
    }
    /**
    ...
    {
        return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionObject::createFromInstance($instance);
    }
    /**
     ...
     */
    public static function createFromNode(\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassLike $node, \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, ?\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Namespace_ $namespace = null) : self
    {
        $class = new self();
    ...
    {
        if (!$this->isAnonymous()) {
            \assert($this->node->name instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Identifier);
     ...
     */
    private function createMethodsFromTrait(\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod $method) : array
    {
        $traitAliases = $this->getTraitAliases();
        $traitPrecedences = $this->getTraitPrecedences();
        $methodAst = $method->getAst();
        \assert($methodAst instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod);
        ...
        $createMethod = function (?string $aliasMethodName) use($method, $methodAst) : ReflectionMethod {
            return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod::createFromNode($this->reflector, $methodAst, $method->getDeclaringClass()->getDeclaringNamespaceAst(), $method->getDeclaringClass(), $this, $aliasMethodName);
        };
        $methods = [];
    ...
    {
        return \array_merge([], ...\array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $ancestor) : array {
    ...
    {
        return \array_merge([], ...\array_map(function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $trait) : array {
            return \array_merge([], ...\array_map(function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod $method) : array {
    ...
    public function getMethods(?int $filter = null) : array
    {
        ...
        return \array_values(\array_filter($this->getMethodsIndexedByName(), static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod $method) use($filter) : bool {
    ...
    public function getImmediateMethods(?int $filter = null) : array
    {
        ...
        $methods = \array_map(function (\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $methodNode) : ReflectionMethod {
            return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod::createFromNode($this->reflector, $methodNode, $this->declaringNamespace, $this, $this);
     ...
     */
    public function getMethod(string $methodName) : \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod
    {
    ...
    {
        return \array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant $classConstant) {
     ...
     * Returns null if not specified.
     */
    public function getReflectionConstant(string $name) : ?\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant
    {
    ...
    public function getImmediateReflectionConstants() : array
    {
        ...
        $constants = \array_merge([], ...\array_map(function (\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassConst $constNode) : array {
            $constants = [];
            foreach ($constNode->consts as $constantPositionInNode => $constantNode) {
                $constants[] = \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant::createFromNode($this->reflector, $constNode, $constantPositionInNode, $this);
            }
            return $constants;
        }, \array_filter($this->node->stmts, static function (\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt $stmt) : bool {
            return $stmt instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassConst;
        })));
        return $this->cachedReflectionConstants = \array_combine(\array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant $constant) : string {
    ...
    public function getReflectionConstants() : array
    {
        ...
        $allReflectionConstants = \array_merge(\array_values($this->getImmediateReflectionConstants()), ...\array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $ancestor) : array {
            return \array_filter(\array_values($ancestor->getReflectionConstants()), static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant $classConstant) : bool {
                return !$classConstant->isPrivate();
            });
        }, \array_filter([$this->getParentClass()])), ...\array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $interface) : array {
     ...
     * @throws OutOfBoundsException
     */
    public function getConstructor() : \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod
    {
        $constructors = \array_values(\array_filter($this->getMethods(), static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod $method) : bool {
    ...
    public function getImmediateProperties(?int $filter = null) : array
    {
        if ($this->cachedImmediateProperties === null) {
            ...
            foreach ($this->node->stmts as $stmt) {
                if ($stmt instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod && $stmt->name->toLowerString() === '__construct') {
                    foreach ($stmt->params as $param) {
                        ...
                        $prop = \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty::createFromNode($this->reflector, new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property($param->flags, [new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\PropertyProperty(new \_PhpScoper0a6b37af0871\PhpParser\Node\VarLikeIdentifier($param->var->name))], $param->getAttributes(), $param->type, $param->attrGroups), 0, $this->declaringNamespace, $this, $this, \true, \true);
                ...
                foreach ($stmt->props as $propertyPositionInNode => $propertyNode) {
                    $prop = \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty::createFromNode($this->reflector, $stmt, $propertyPositionInNode, $this->declaringNamespace, $this, $this);
                    $properties[$prop->getName()] = $prop;
                }
            }
        ...
        return \array_filter($this->cachedImmediateProperties, static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty $property) use($filter) : bool {
    ...
    public function getProperties(?int $filter = null) : array
    {
        if ($this->cachedProperties === null) {
            ...
            $this->cachedProperties = \array_merge(\array_merge([], ...\array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $ancestor) use($filter) : array {
                return \array_filter($ancestor->getProperties($filter), static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty $property) : bool {
                    return !$property->isPrivate();
                });
            }, \array_filter([$this->getParentClass()])), ...\array_map(function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $trait) use($filter) {
                return \array_map(function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty $property) use($trait) : ReflectionProperty {
                    return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty::createFromNode($this->reflector, $property->getAst(), $property->getPositionInAst(), $trait->declaringNamespace, $property->getDeclaringClass(), $this, $property->isDefault(), $property->isPromoted());
        ...
        return \array_filter($this->cachedProperties, static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty $property) use($filter) : bool {
            return (bool) ($filter & $property->getModifiers());
        });
    }
    /**
     ...
     */
    public function getProperty(string $name) : ?\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty
    {
    ...
    {
        return \array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty $property) {
            return $property->getDefaultValue();
        }, \array_filter($this->getProperties(), static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty $property) : bool {
    ...
    public function getLocatedSource() : \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Located\LocatedSource
    {
    ...
    {
        return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\CalculateReflectionColum::getStartColumn($this->locatedSource->getSource(), $this->node);
    }
    public function getEndColumn() : int
    {
        return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\CalculateReflectionColum::getEndColumn($this->locatedSource->getSource(), $this->node);
    }
    /**
     ...
     */
    public function getParentClass() : ?\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass
    {
        if (!$this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ || $this->node->extends === null) {
            return null;
        }
        ...
        if ($this->cachedParentClass->isInterface() || $this->cachedParentClass->isTrait()) {
            throw \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\NotAClassReflection::fromReflectionClass($this->cachedParentClass);
        }
    ...
    {
        return \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\GetLastDocComment::forNode($this->node);
    }
    ...
    {
        return $this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ && $this->node->isAbstract();
    }
    /**
    ...
    {
        return $this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ && $this->node->isFinal();
    }
    /**
    ...
    {
        return $this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Trait_;
    }
    /**
    ...
    {
        return $this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Interface_;
    }
    /**
    ...
    {
        return \array_map(function (\_PhpScoper0a6b37af0871\PhpParser\Node\Name $importedTrait) : ReflectionClass {
            return $this->reflectClassForNamedNode($importedTrait);
        }, \array_merge([], ...\array_map(static function (\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUse $traitUse) : array {
            return $traitUse->traits;
        }, \array_filter($this->node->stmts, static function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool {
            return $node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUse;
        }))));
    }
    /**
     * Given an AST Node\Name, create a new ReflectionClass for the element.
     */
    private function reflectClassForNamedNode(\_PhpScoper0a6b37af0871\PhpParser\Node\Name $node) : self
    {
        // @TODO use actual `ClassReflector` or `FunctionReflector`?
        if ($this->isAnonymous()) {
            $class = (new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\BetterReflection())->classReflector()->reflect($node->toString());
        } else {
    ...
    {
        return \array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $trait) : string {
    ...
    private function parseTraitUsages() : void
    {
        ...
        $traitUsages = \array_filter($this->node->stmts, static function (\_PhpScoper0a6b37af0871\PhpParser\Node $node) : bool {
            return $node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUse;
        });
        ...
        foreach ($traitUsages as $traitUsage) {
            ...
            foreach ($adaptations as $adaptation) {
                ...
                if ($adaptation instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUseAdaptation\Alias && $adaptation->newName) {
                    $this->cachedTraitAliases[$adaptation->newName->name] = $this->methodHash($usedTrait->toString(), $adaptation->method->toString());
                    continue;
                }
                if (!$adaptation instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUseAdaptation\Precedence || !$adaptation->insteadof) {
                    continue;
                }
    ...
    public function getImmediateInterfaces() : array
    {
        ...
        \assert($this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ || $this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Interface_);
        $nodes = $this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Interface_ ? $this->node->extends : $this->node->implements;
        return \array_combine(\array_map(static function (\_PhpScoper0a6b37af0871\PhpParser\Node\Name $interfaceName) : string {
            return $interfaceName->toString();
        }, $nodes), \array_map(function (\_PhpScoper0a6b37af0871\PhpParser\Node\Name $interfaceName) : ReflectionClass {
    ...
    private function getCurrentClassImplementedInterfacesIndexedByName() : array
    {
        ...
        if ($node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_) {
            $interfaces = \array_merge([], ...\array_map(function (\_PhpScoper0a6b37af0871\PhpParser\Node\Name $interfaceName) : array {
                return $this->reflectClassForNamedNode($interfaceName)->getInterfacesHierarchy();
            }, $node->implements));
            if (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\BetterReflection::$phpVersion >= 80000) {
                foreach ($node->getMethods() as $method) {
                    ...
                    $interfaces['Stringable'] = $this->reflectClassForNamedNode(new \_PhpScoper0a6b37af0871\PhpParser\Node\Name('Stringable'));
                    break;
                }
            }
            return $interfaces;
    ...
    {
        if (!$this->isInterface()) {
            throw \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\NotAnInterfaceReflection::fromReflectionClass($this);
        }
        $node = $this->node;
        \assert($node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Interface_);
        $interfaces = \array_merge([$this->getName() => $this], ...\array_map(function (\_PhpScoper0a6b37af0871\PhpParser\Node\Name $interfaceName) : array {
            return $this->reflectClassForNamedNode($interfaceName)->getInterfacesHierarchy();
        }, $node->extends));
        if (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\BetterReflection::$phpVersion >= 80000) {
            foreach ($node->getMethods() as $method) {
    ...
    {
        throw \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\Uncloneable::fromClass(static::class);
    }
    /**
    ...
    public function getStaticPropertyValue(string $propertyName)
    {
        ...
        if (!$property || !$property->isStatic()) {
            throw \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\PropertyDoesNotExist::fromName($propertyName);
        }
     ...
     */
    public function getAst() : \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassLike
    {
        return $this->node;
    }
    public function getDeclaringNamespaceAst() : ?\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Namespace_
    {
    ...
    {
        if (!$this->node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_) {
            throw \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\NotAClassReflection::fromReflectionClass($this);
        }
        if ($isFinal === \true) {
            $this->node->flags |= \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL;
            return;
        }
        $this->node->flags &= ~\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL;
    }
    ...
    public function removeMethod(string $methodName) : bool
    {
        ...
        foreach ($this->node->stmts as $key => $stmt) {
            if ($stmt instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod && $lowerName === $stmt->name->toLowerString()) {
    ...
    {
        $this->node->stmts[] = new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod($methodName);
        $this->cachedMethods = null;
    }
    /**
    ...
    public function addProperty(string $propertyName, int $visibility = \ReflectionProperty::IS_PUBLIC, bool $static = \false) : void
    {
        ...
        switch ($visibility) {
            case \ReflectionProperty::IS_PRIVATE:
                $type |= \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_PRIVATE;
                break;
            case \ReflectionProperty::IS_PROTECTED:
                $type |= \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_PROTECTED;
                break;
            default:
                $type |= \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC;
                break;
        }
        if ($static) {
            $type |= \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC;
        }
        $this->node->stmts[] = new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Property($type, [new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\PropertyProperty($propertyName)]);
    ...
    public function removeProperty(string $propertyName) : bool
    {
        ...
        foreach ($this->node->stmts as $key => $stmt) {
            ...
            $propertyNames = \array_map(static function (\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\PropertyProperty $propertyProperty) : string {
    ...
    {
        $attributes = [];
        $compileNodeToValue = new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\NodeCompiler\CompileNodeToValue();
        foreach ($this->node->attrGroups as $attrGroup) {
            foreach ($attrGroup->attrs as $attr) {
                ...
                foreach ($attr->args as $i => $arg) {
                    ...
                    $arguments[$key] = $compileNodeToValue->__invoke($arg->value, new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\NodeCompiler\CompilerContext($this->reflector, $this->getFileName(), $this, $this->declaringNamespace !== null && $this->declaringNamespace->name !== null ? $this->declaringNamespace->name->toString() : null, null));
                }
                $attributes[] = new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionAttribute($attr->name->toString(), $arguments);
            }
        }
        return $attributes;
    }
