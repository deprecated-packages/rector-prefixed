...
use _PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Yield_ as YieldNode;
use _PhpScoper0a2ac50786fa\PhpParser\Node\Param as ParamNode;
...
use _PhpScoper0a2ac50786fa\PhpParser\PrettyPrinter\Standard as StandardPrettyPrinter;
...
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\InvalidAbstractFunctionNodeType;
...
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Type\ClosureSourceLocator;
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\TypesFinder\FindReturnType;
...
use _PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\Visitor\ReturnNodeVisitor;
...
abstract class ReflectionFunctionAbstract
{
     ...
     */
    protected function populateFunctionAbstract(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike $node, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, ?\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Namespace_ $declaringNamespace = null) : void
    {
     ...
     */
    protected function getNode() : \_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike
    {
    ...
    public function getShortName() : string
    {
        ...
        if ($initializedNode instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Closure) {
    ...
    {
        return \count(\array_filter($this->getParameters(), static function (\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionParameter $p) : bool {
            return !$p->isOptional();
        }));
    }
    /**
    ...
    public function getParameters() : array
    {
        ...
        foreach ($nodeParams as $paramIndex => $paramNode) {
            $parameters[] = \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionParameter::createFromNode($this->reflector, $paramNode, $this->declaringNamespace, $this, $paramIndex);
        }
        return $parameters;
    }
    /**
     ...
     * the function.
     */
    public function getParameter(string $parameterName) : ?\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionParameter
    {
    ...
    {
        return \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\GetLastDocComment::forNode($this->getNode());
    }
    public function setDocCommentFromString(string $string) : void
    {
        $this->getAst()->setDocComment(new \_PhpScoper0a2ac50786fa\PhpParser\Comment\Doc($string));
    }
    ...
    {
        return $this->node instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Closure;
    }
    /**
     ...
     */
    private function nodeIsOrContainsYield(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : bool
    {
        if ($node instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Yield_) {
            return \true;
        }
        if ($node instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\YieldFrom) {
            return \true;
        }
        foreach ($node->getSubNodeNames() as $nodeName) {
            $nodeProperty = $node->{$nodeName};
            if ($nodeProperty instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node && $this->nodeIsOrContainsYield($nodeProperty)) {
                return \true;
            }
            ...
            foreach ($nodeProperty as $nodePropertyArrayItem) {
                if ($nodePropertyArrayItem instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node && $this->nodeIsOrContainsYield($nodePropertyArrayItem)) {
                    return \true;
                }
            }
        }
    ...
    {
        return \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\CalculateReflectionColum::getStartColumn($this->locatedSource->getSource(), $this->getNode());
    }
    public function getEndColumn() : int
    {
        return \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\CalculateReflectionColum::getEndColumn($this->locatedSource->getSource(), $this->getNode());
    }
    /**
    ...
    {
        return (new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\TypesFinder\FindReturnType())->__invoke($this, $this->declaringNamespace);
    }
    /**
     * Get the return type declaration (only for PHP 7+ code)
     */
    public function getReturnType() : ?\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionType
    {
        $returnType = $this->getNode()->getReturnType();
        if ($returnType === null) {
            return null;
        }
        return \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionType::createFromTypeAndReflector($returnType);
    }
    /**
    ...
    {
        $this->getNode()->returnType = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Name($newReturnType);
    }
    /**
    ...
    {
        throw \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\Uncloneable::fromClass(self::class);
    }
    /**
     ...
     */
    public function getBodyCode(?\_PhpScoper0a2ac50786fa\PhpParser\PrettyPrinterAbstract $printer = null) : string
    {
        if ($printer === null) {
     ...
     */
    public function getAst() : \_PhpScoper0a2ac50786fa\PhpParser\Node\FunctionLike
    {
        return $this->getNode();
    }
    /**
    ...
    {
        $closureReflection = (new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Type\ClosureSourceLocator($newBody, $this->loadStaticParser()))->locateIdentifier($this->reflector, new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Identifier\Identifier(self::CLOSURE_NAME, new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Identifier\IdentifierType(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Identifier\IdentifierType::IDENTIFIER_FUNCTION)));
    ...
    public function setBodyFromAst(array $nodes) : void
    {
        ...
        $validator = static function (\_PhpScoper0a2ac50786fa\PhpParser\Node ...$node) : array {
            return $node;
        };
    ...
    {
        $this->getNode()->params[] = new \_PhpScoper0a2ac50786fa\PhpParser\Node\Param(new \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Variable($parameterName));
    }
    /**
    ...
    public function removeParameter(string $parameterName) : void
    {
        ...
        foreach ($this->getNode()->params as $key => $paramNode) {
            if ($paramNode->var instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\Error) {
    ...
    {
        $visitor = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\Visitor\ReturnNodeVisitor();
    ...
    private function loadStaticParser() : \_PhpScoper0a2ac50786fa\PhpParser\Parser
    {
        return self::$parser ?? (self::$parser = (new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Roave\BetterReflection\BetterReflection())->phpParser());
    }
}
