...
use _PhpScoperb75b35f52b74\PhpParser\Node\Expr\Yield_ as YieldNode;
...
use _PhpScoperb75b35f52b74\PhpParser\PrettyPrinter\Standard as StandardPrettyPrinter;
...
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\TypesFinder\FindReturnType;
...
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\Visitor\ReturnNodeVisitor;
...
abstract class ReflectionFunctionAbstract
{
     ...
     */
    protected function populateFunctionAbstract(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoperb75b35f52b74\PhpParser\Node\FunctionLike $node, \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, ?\_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Namespace_ $declaringNamespace = null) : void
    {
     ...
     */
    protected function getNode() : \_PhpScoperb75b35f52b74\PhpParser\Node\FunctionLike
    {
    ...
    public function getShortName() : string
    {
        ...
        if ($initializedNode instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Closure) {
    ...
    {
        return \count(\array_filter($this->getParameters(), static function (\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionParameter $p) : bool {
            return !$p->isOptional();
        }));
    }
    /**
    ...
    public function getParameters() : array
    {
        ...
        foreach ($nodeParams as $paramIndex => $paramNode) {
            $parameters[] = \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionParameter::createFromNode($this->reflector, $paramNode, $this->declaringNamespace, $this, $paramIndex);
        }
        return $parameters;
    }
    /**
     ...
     * the function.
     */
    public function getParameter(string $parameterName) : ?\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionParameter
    {
    ...
    {
        return \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\GetLastDocComment::forNode($this->getNode());
    }
    public function setDocCommentFromString(string $string) : void
    {
        $this->getAst()->setDocComment(new \_PhpScoperb75b35f52b74\PhpParser\Comment\Doc($string));
    }
    ...
    {
        return $this->node instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Closure;
    }
    /**
     ...
     */
    private function nodeIsOrContainsYield(\_PhpScoperb75b35f52b74\PhpParser\Node $node) : bool
    {
        if ($node instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Yield_) {
            return \true;
        }
        if ($node instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\YieldFrom) {
            return \true;
        }
        foreach ($node->getSubNodeNames() as $nodeName) {
            $nodeProperty = $node->{$nodeName};
            if ($nodeProperty instanceof \_PhpScoperb75b35f52b74\PhpParser\Node && $this->nodeIsOrContainsYield($nodeProperty)) {
                return \true;
            }
            ...
            foreach ($nodeProperty as $nodePropertyArrayItem) {
                if ($nodePropertyArrayItem instanceof \_PhpScoperb75b35f52b74\PhpParser\Node && $this->nodeIsOrContainsYield($nodePropertyArrayItem)) {
                    return \true;
                }
            }
        }
    ...
    {
        return \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\CalculateReflectionColum::getStartColumn($this->locatedSource->getSource(), $this->getNode());
    }
    public function getEndColumn() : int
    {
        return \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\CalculateReflectionColum::getEndColumn($this->locatedSource->getSource(), $this->getNode());
    }
    /**
    ...
    {
        return (new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\TypesFinder\FindReturnType())->__invoke($this, $this->declaringNamespace);
    }
    /**
     * Get the return type declaration (only for PHP 7+ code)
     */
    public function getReturnType() : ?\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionType
    {
        $returnType = $this->getNode()->getReturnType();
        if ($returnType === null) {
            return null;
        }
        return \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionType::createFromTypeAndReflector($returnType);
    }
    /**
    ...
    {
        $this->getNode()->returnType = new \_PhpScoperb75b35f52b74\PhpParser\Node\Name($newReturnType);
    }
    /**
     ...
     */
    public function getBodyCode(?\_PhpScoperb75b35f52b74\PhpParser\PrettyPrinterAbstract $printer = null) : string
    {
        if ($printer === null) {
            $printer = new \_PhpScoperb75b35f52b74\PhpParser\PrettyPrinter\Standard();
        }
     ...
     */
    public function getAst() : \_PhpScoperb75b35f52b74\PhpParser\Node\FunctionLike
    {
        return $this->getNode();
    }
    /**
    ...
    {
        $closureReflection = (new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Type\ClosureSourceLocator($newBody, $this->loadStaticParser()))->locateIdentifier($this->reflector, new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Identifier\Identifier(self::CLOSURE_NAME, new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Identifier\IdentifierType(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Identifier\IdentifierType::IDENTIFIER_FUNCTION)));
    ...
    public function setBodyFromAst(array $nodes) : void
    {
        ...
        $validator = static function (\_PhpScoperb75b35f52b74\PhpParser\Node ...$node) : array {
            return $node;
        };
    ...
    {
        $this->getNode()->params[] = new \_PhpScoperb75b35f52b74\PhpParser\Node\Param(new \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Variable($parameterName));
    }
    /**
    ...
    public function removeParameter(string $parameterName) : void
    {
        ...
        foreach ($this->getNode()->params as $key => $paramNode) {
            if ($paramNode->var instanceof \_PhpScoperb75b35f52b74\PhpParser\Node\Expr\Error) {
    ...
    {
        $visitor = new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\Visitor\ReturnNodeVisitor();
    ...
    private function loadStaticParser() : \_PhpScoperb75b35f52b74\PhpParser\Parser
    {
        return self::$parser ?? (self::$parser = (new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Roave\BetterReflection\BetterReflection())->phpParser());
    }
}
