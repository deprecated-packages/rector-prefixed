...
{
    public static function toString(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
    ...
    private static function typeToString(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
    ...
    private static function valueToString(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
