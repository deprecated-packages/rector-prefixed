...
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass as BetterReflectionClass;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant as BetterReflectionClassConstant;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod as BetterReflectionMethod;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionObject as BetterReflectionObject;
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty as BetterReflectionProperty;
...
class ReflectionClass extends \ReflectionClass
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $betterReflectionClass)
    {
        $this->betterReflectionClass = $betterReflectionClass;
        unset($this->name);
    }
    public function getBetterReflection() : \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass
    {
    ...
    public static function export($argument, $return = \false)
    {
        if (\is_string($argument) || \is_object($argument)) {
            if (\is_string($argument)) {
                $output = \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass::createFromName($argument)->__toString();
            } else {
                $output = \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionObject::createFromInstance($argument)->__toString();
            }
            if ($return) {
                return $output;
            }
    ...
    public function getFileName()
    {
        ...
        return $fileName !== null ? \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Util\FileHelper::normalizeSystemPath($fileName) : \false;
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        try {
            return new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod($this->betterReflectionClass->getConstructor());
    ...
    {
        return new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod($this->betterReflectionClass->getMethod($name));
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return \array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod $method) : ReflectionMethod {
            return new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod($method);
    ...
    public function getProperty($name)
    {
        ...
        return new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty($betterReflectionProperty);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return \array_values(\array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty $property) : ReflectionProperty {
            return new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty($property);
    ...
    {
        return new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionClassConstant($this->betterReflectionClass->getReflectionConstant($name));
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \array_values(\array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant $betterConstant) : ReflectionClassConstant {
            return new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionClassConstant($betterConstant);
    ...
    public function getTraits()
    {
        ...
        $traitNames = \array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $trait) : string {
            return $trait->getName();
        }, $traits);
        $traitsByName = \array_combine($traitNames, \array_map(static function (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $trait) : self {
    ...
    public function isInstance($object)
    {
        ...
        } catch (\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\NotAnObject $e) {
            return null;
        }
    }
    /**
    ...
    {
        throw new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\Exception\NotImplemented('Not implemented');
    }
    /**
     * {@inheritDoc}
     */
    ...
    public function getStaticPropertyValue($name, $default = null)
    {
        ...
        $property = new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty($betterReflectionProperty);
