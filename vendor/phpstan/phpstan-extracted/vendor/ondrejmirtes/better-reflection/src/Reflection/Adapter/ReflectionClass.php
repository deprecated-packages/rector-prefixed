...
use _HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass as BetterReflectionClass;
use _HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant as BetterReflectionClassConstant;
use _HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod as BetterReflectionMethod;
use _HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionObject as BetterReflectionObject;
...
class ReflectionClass extends \ReflectionClass
{
    ...
    public function __construct(\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $betterReflectionClass)
    {
        $this->betterReflectionClass = $betterReflectionClass;
        unset($this->name);
    }
    public function getBetterReflection() : \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass
    {
    ...
    public static function export($argument, $return = \false)
    {
        if (\is_string($argument) || \is_object($argument)) {
            if (\is_string($argument)) {
                $output = \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass::createFromName($argument)->__toString();
            } else {
                $output = \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionObject::createFromInstance($argument)->__toString();
            }
            if ($return) {
                return $output;
            }
    ...
    {
        try {
            return new \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod($this->betterReflectionClass->getConstructor());
    ...
    {
        return new \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod($this->betterReflectionClass->getMethod($name));
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return \array_map(static function (\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionMethod $method) : ReflectionMethod {
            return new \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod($method);
    ...
    public function getProperty($name)
    {
        ...
        return new \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty($betterReflectionProperty);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return \array_values(\array_map(static function (\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionProperty $property) : ReflectionProperty {
            return new \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty($property);
    ...
    {
        return new \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionClassConstant($this->betterReflectionClass->getReflectionConstant($name));
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \array_values(\array_map(static function (\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClassConstant $betterConstant) : ReflectionClassConstant {
            return new \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionClassConstant($betterConstant);
    ...
    public function getTraits()
    {
        ...
        $traitNames = \array_map(static function (\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $trait) : string {
            return $trait->getName();
        }, $traits);
        $traitsByName = \array_combine($traitNames, \array_map(static function (\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\ReflectionClass $trait) : self {
    ...
    public function isInstance($object)
    {
        ...
        } catch (\_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Exception\NotAnObject $e) {
            return null;
        }
    }
    /**
    ...
    public function getStaticPropertyValue($name, $default = null)
    {
        ...
        $property = new \_HumbugBox221ad6f1b81f\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty($betterReflectionProperty);
