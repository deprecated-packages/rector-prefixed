...
use _HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\StringCast\ReflectionMethodStringCast;
...
class ReflectionMethod extends \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionFunctionAbstract
{
    /** @var ReflectionClass */
     ...
     */
    public static function createFromNode(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflector\Reflector $reflector, \PhpParser\Node\Stmt\ClassMethod $node, ?\PhpParser\Node\Stmt\Namespace_ $namespace, \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionClass $declaringClass, \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionClass $implementingClass, ?string $aliasName = null) : self
    {
        $method = new self();
    ...
    {
        return \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionClass::createFromName($className)->getMethod($methodName);
    }
    /**
    ...
    {
        return \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionClass::createFromInstance($instance)->getMethod($methodName);
    }
    ...
    public function getPrototype() : self
    {
        ...
        throw new \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\Exception\MethodPrototypeNotFound(\sprintf('Method %s::%s does not have a prototype', $this->getDeclaringClass()->getName(), $this->getName()));
    }
    private function findPrototype() : ?self
    {
        ...
        } catch (\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\Exception\MethodPrototypeNotFound $e) {
            return $this;
        }
    }
    /**
    ...
    {
        return \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\StringCast\ReflectionMethodStringCast::toString($this);
    }
    ...
    private function assertClassExist(string $className) : void
    {
        if (!\class_exists($className, \false)) {
            throw new \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\Exception\ClassDoesNotExist(\sprintf('Method of class %s cannot be used as the class is not loaded', $className));
        }
    }
    /**
     * @param mixed $object
