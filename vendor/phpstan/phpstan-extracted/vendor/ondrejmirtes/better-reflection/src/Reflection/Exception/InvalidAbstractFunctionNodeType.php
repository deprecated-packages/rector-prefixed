...
class InvalidAbstractFunctionNodeType extends \InvalidArgumentException
{
    ...
    {
        return new self(\sprintf('Node for "%s" must be "%s" or "%s", was a "%s"', \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionFunctionAbstract::class, \PhpParser\Node\Stmt\ClassMethod::class, \PhpParser\Node\FunctionLike::class, \get_class($node)));
    }
}
