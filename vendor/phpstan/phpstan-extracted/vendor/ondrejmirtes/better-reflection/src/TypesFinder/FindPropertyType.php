...
use _HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\DocBlock\Tags\Var_;
...
class FindPropertyType
{
     ...
     * @return Type[]
     */
    public function __invoke(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionProperty $reflectionProperty, ?\PhpParser\Node\Stmt\Namespace_ $namespace) : array
    {
        ...
        return \array_merge([], ...\array_map(function (\_HumbugBox221ad6f1b81f__UniqueRector\phpDocumentor\Reflection\DocBlock\Tags\Var_ $varTag) use($context) {
