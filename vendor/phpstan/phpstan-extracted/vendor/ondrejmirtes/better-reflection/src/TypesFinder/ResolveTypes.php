...
class ResolveTypes
{
    ...
    {
        $this->typeResolver = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\TypeResolver();
    }
    /**
     ...
     * @return Type[]
     */
    public function __invoke(array $stringTypes, \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\phpDocumentor\Reflection\Types\Context $context) : array
    {
        $resolvedTypes = [];
