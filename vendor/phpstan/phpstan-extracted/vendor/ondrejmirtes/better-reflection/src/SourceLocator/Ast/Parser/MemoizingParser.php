...
namespace _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\Ast\Parser;
 ...
 * @internal
 */
final class MemoizingParser implements \_PhpScoper0a6b37af0871\PhpParser\Parser
{
    /** @var Node\Stmt[][]|null[] indexed by source hash */
    private $sourceHashToAst = [];
    /** @var Parser */
    private $wrappedParser;
    public function __construct(\_PhpScoper0a6b37af0871\PhpParser\Parser $wrappedParser)
    {
