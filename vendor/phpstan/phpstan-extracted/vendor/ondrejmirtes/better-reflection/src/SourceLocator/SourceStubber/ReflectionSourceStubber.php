...
use _PhpScoper0a6b37af0871\PhpParser\Builder\Class_;
use _PhpScoper0a6b37af0871\PhpParser\Builder\Declaration;
use _PhpScoper0a6b37af0871\PhpParser\Builder\Function_;
use _PhpScoper0a6b37af0871\PhpParser\Builder\FunctionLike;
use _PhpScoper0a6b37af0871\PhpParser\Builder\Interface_;
use _PhpScoper0a6b37af0871\PhpParser\Builder\Method;
use _PhpScoper0a6b37af0871\PhpParser\Builder\Param;
use _PhpScoper0a6b37af0871\PhpParser\Builder\Property;
use _PhpScoper0a6b37af0871\PhpParser\Builder\Trait_;
...
use _PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUseAdaptation;
...
use _PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\ReflectionUnionType as CoreReflectionUnionType;
 ...
 * @internal
 */
final class ReflectionSourceStubber implements \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    {
        $this->builderFactory = new \_PhpScoper0a6b37af0871\PhpParser\BuilderFactory();
        $this->prettyPrinter = new \_PhpScoper0a6b37af0871\PhpParser\PrettyPrinter\Standard(self::BUILDER_OPTIONS);
    }
    ...
    public function generateClassStub(string $className) : ?\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        ...
        if ($classNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Builder\Class_) {
            $this->addClassModifiers($classNode, $classReflection);
        }
        if ($classNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Builder\Class_ || $classNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Builder\Interface_) {
            $this->addExtendsAndImplements($classNode, $classReflection);
        }
        if ($classNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Builder\Class_ || $classNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Builder\Trait_) {
    ...
    public function generateFunctionStub(string $functionName) : ?\_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        ...
        \assert($returnType instanceof \ReflectionNamedType || $returnType instanceof \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\ReflectionUnionType || $returnType === null);
        if ($returnType !== null) {
     ...
     */
    private function createClass(\ReflectionClass $classReflection) : \_PhpScoper0a6b37af0871\PhpParser\Builder\Declaration
    {
     ...
     */
    private function addDocComment(\_PhpScoper0a6b37af0871\PhpParser\Builder $node, \Reflector $reflection) : void
    {
        if ($reflection->getDocComment() === \false) {
            return;
        }
        $node->setDocComment(new \_PhpScoper0a6b37af0871\PhpParser\Comment\Doc($reflection->getDocComment()));
    }
    private function addClassModifiers(\_PhpScoper0a6b37af0871\PhpParser\Builder\Class_ $classNode, \ReflectionClass $classReflection) : void
    {
     ...
     */
    private function addExtendsAndImplements(\_PhpScoper0a6b37af0871\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection) : void
    {
        $parentClass = $classReflection->getParentClass();
        $interfaces = $classReflection->getInterfaceNames();
        if ($parentClass) {
            $classNode->extend(new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($parentClass->getName()));
        ...
        foreach ($interfaces as $interfaceName) {
            if ($classNode instanceof \_PhpScoper0a6b37af0871\PhpParser\Builder\Interface_) {
                $classNode->extend(new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($interfaceName));
            } else {
                $classNode->implement(new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($interfaceName));
            }
        }
    }
    private function addTraitUse(\_PhpScoper0a6b37af0871\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection) : void
    {
        ...
        foreach ($classReflection->getTraitAliases() as $methodNameAlias => $methodInfo) {
            ...
            $traitUseNode = new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUse([new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($traitName)], [new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUseAdaptation\Alias(new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($traitName), $methodName, null, $methodNameAlias)]);
        ...
        foreach (\array_diff($classReflection->getTraitNames(), $alreadyUsedTraitNames) as $traitName) {
            $classNode->addStmt(new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\TraitUse([new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($traitName)]));
        }
    }
    private function addProperties(\_PhpScoper0a6b37af0871\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection) : void
    {
        ...
        foreach ($classReflection->getProperties() as $propertyReflection) {
            ...
            if (\method_exists($propertyReflection, 'getType')) {
                ...
                \assert($propertyType instanceof \ReflectionNamedType || $propertyType instanceof \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\ReflectionUnionType || $propertyType === null);
    ...
    private function addPropertyModifiers(\_PhpScoper0a6b37af0871\PhpParser\Builder\Property $propertyNode, \ReflectionProperty $propertyReflection) : void
    {
    ...
    private function addConstants(\_PhpScoper0a6b37af0871\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection) : void
    {
        foreach ($classReflection->getReflectionConstants() as $constantReflection) {
            ...
            $classConstantNode = new \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassConst([new \_PhpScoper0a6b37af0871\PhpParser\Node\Const_($constantReflection->getName(), \_PhpScoper0a6b37af0871\PhpParser\BuilderHelpers::normalizeValue($constantReflection->getValue()))], $this->constantVisibilityFlags($constantReflection));
            if ($constantReflection->getDocComment() !== \false) {
                $classConstantNode->setDocComment(new \_PhpScoper0a6b37af0871\PhpParser\Comment\Doc($constantReflection->getDocComment()));
            }
    ...
    private function constantVisibilityFlags(\ReflectionClassConstant $constant) : int
    {
        if ($constant->isPrivate()) {
            return \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_PRIVATE;
        }
        if ($constant->isProtected()) {
            return \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_PROTECTED;
        }
        return \_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC;
    }
    private function addMethods(\_PhpScoper0a6b37af0871\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection) : void
    {
    ...
    private function addMethodFlags(\_PhpScoper0a6b37af0871\PhpParser\Builder\Method $methodNode, \ReflectionMethod $methodReflection) : void
    {
    ...
    private function addParameters(\_PhpScoper0a6b37af0871\PhpParser\Builder\FunctionLike $functionNode, \ReflectionFunctionAbstract $functionReflectionAbstract) : void
    {
    ...
    private function addParameterModifiers(\ReflectionParameter $parameterReflection, \_PhpScoper0a6b37af0871\PhpParser\Builder\Param $parameterNode) : \_PhpScoper0a6b37af0871\PhpParser\Builder\Param
    {
        ...
        \assert($parameterType instanceof \ReflectionNamedType || $parameterType instanceof \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\ReflectionUnionType || $parameterType === null);
     ...
     */
    private function formatType($type) : \_PhpScoper0a6b37af0871\PhpParser\NodeAbstract
    {
        if ($type instanceof \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\ReflectionUnionType) {
            $innerTypes = [];
            ...
            foreach ($type->getTypes() as $innerType) {
                ...
                if ($formattedType instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\NullableType) {
                    $addNull = \true;
            ...
            return new \_PhpScoper0a6b37af0871\PhpParser\Node\UnionType($innerTypes);
        }
        $name = $type->getName();
        $nameNode = $type->isBuiltin() || \in_array($name, ['self', 'parent'], \true) ? new \_PhpScoper0a6b37af0871\PhpParser\Node\Name($name) : new \_PhpScoper0a6b37af0871\PhpParser\Node\Name\FullyQualified($name);
        return $type->allowsNull() ? new \_PhpScoper0a6b37af0871\PhpParser\Node\NullableType($nameNode) : $nameNode;
    }
    private function generateStubInNamespace(\_PhpScoper0a6b37af0871\PhpParser\Node $node, string $namespaceName) : string
    {
    ...
    private function generateStub(\_PhpScoper0a6b37af0871\PhpParser\Node $node) : string
    {
        return "<?php\n\n" . $this->prettyPrinter->prettyPrint([$node]) . ($node instanceof \_PhpScoper0a6b37af0871\PhpParser\Node\Expr\FuncCall ? ';' : '') . "\n";
    }
    private function createStubData(string $stub, ?string $extensionName) : \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        return new \_PhpScoper0a6b37af0871\_HumbugBox221ad6f1b81f\Roave\BetterReflection\SourceLocator\SourceStubber\StubData($stub, $extensionName);
    }
}
