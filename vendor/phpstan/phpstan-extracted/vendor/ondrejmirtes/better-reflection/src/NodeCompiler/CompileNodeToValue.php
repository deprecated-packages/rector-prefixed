...
class CompileNodeToValue
{
     ...
     */
    public function __invoke(\PhpParser\Node $node, \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $context)
    {
        ...
        $constExprEvaluator = new \PhpParser\ConstExprEvaluator(function (\PhpParser\Node\Expr $node) use($context) {
            ...
            throw \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\Exception\UnableToCompileNode::forUnRecognizedExpressionInContext($node, $context);
        });
     ...
     * @throws Exception\UnableToCompileNode
     */
    private function compileConstFetch(\PhpParser\Node\Expr\ConstFetch $constNode, \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $context)
    {
        ...
        switch (\strtolower($constantName)) {
            ...
            default:
                if ($context->getNamespace() !== null && !$constNode->name->isFullyQualified()) {
                    ...
                    try {
                        return \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionConstant::createFromName($namespacedName)->getValue();
                ...
                try {
                    return \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionConstant::createFromName($constantName)->getValue();
                } catch (\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflector\Exception\IdentifierNotFound $e) {
                    throw \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\Exception\UnableToCompileNode::becauseOfNotFoundConstantReference($context, $constNode);
                }
        }
    }
    /**
     ...
     */
    private function compileClassConstFetch(\PhpParser\Node\Expr\ClassConstFetch $node, \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $context)
    {
        ...
        if ($classInfo === null) {
            ...
            \assert($classInfo instanceof \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionClass);
        }
        $reflectionConstant = $classInfo->getReflectionConstant($nodeName);
        if (!$reflectionConstant instanceof \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionClassConstant) {
            throw \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\Exception\UnableToCompileNode::becauseOfNotFoundClassConstantReference($context, $classInfo, $node);
        }
        return $this->__invoke($reflectionConstant->getAst()->consts[$reflectionConstant->getPositionInAst()]->value, new \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext($context->getReflector(), $context->hasFileName() ? $context->getFileName() : null, $classInfo, $context->getNamespace(), $context->getFunctionName()));
    }
    /**
     * Compile a __DIR__ node
     */
    private function compileDirConstant(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $context) : string
    {
        return \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Util\FileHelper::normalizeWindowsPath(\dirname(\realpath($context->getFileName())));
    }
    /**
     * Compiles magic constant __CLASS__
     */
    private function compileClassConstant(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $context) : string
    {
        return $context->hasSelf() ? $context->getSelf()->getName() : '';
    }
    private function resolveClassNameForClassNameConstant(string $className, \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $context) : string
    {
        if ($className === 'self' || $className === 'static') {
