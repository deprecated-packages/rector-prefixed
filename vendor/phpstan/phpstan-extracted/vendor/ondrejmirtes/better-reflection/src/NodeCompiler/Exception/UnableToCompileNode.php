...
namespace _HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\Exception;
...
class UnableToCompileNode extends \LogicException
{
    ...
    public static function forUnRecognizedExpressionInContext(\PhpParser\Node\Expr $expression, \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $context) : self
    {
    ...
    public static function becauseOfNotFoundClassConstantReference(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext, \_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\Reflection\ReflectionClass $targetClass, \PhpParser\Node\Expr\ClassConstFetch $constantFetch) : self
    {
    ...
    public static function becauseOfNotFoundConstantReference(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext, \PhpParser\Node\Expr\ConstFetch $constantFetch) : self
    {
    ...
    private static function compilerContextToContextDescription(\_HumbugBox221ad6f1b81f__UniqueRector\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext) : string
    {
