...
use _PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions::class, \false) || !\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions::class, \false) && \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Composer\InstalledVersions::getReference($packageName);
        }
