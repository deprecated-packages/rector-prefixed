...
use _HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions::class, \false) || !\_HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions::class, \false) && \_HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions::getRawData()) {
            return \_HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_HumbugBox221ad6f1b81f__UniqueRector\Composer\InstalledVersions::getReference($packageName);
        }
