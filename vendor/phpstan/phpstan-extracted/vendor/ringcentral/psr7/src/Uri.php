 ...
 */
class Uri implements \_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\UriInterface
{
     ...
     * @return UriInterface
     */
    public static function resolve(\_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\UriInterface $base, $rel)
    {
        if ($rel === null || $rel === '') {
            return $base;
        }
        if (!$rel instanceof \_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\_HumbugBox221ad6f1b81f__UniqueRector\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $current = $uri->getQuery();
