 ...
 */
class Uri implements \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\UriInterface
{
     ...
     * @return UriInterface
     */
    public static function resolve(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\UriInterface $base, $rel)
    {
        if ($rel === null || $rel === '') {
            return $base;
        }
        if (!$rel instanceof \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $current = $uri->getQuery();
