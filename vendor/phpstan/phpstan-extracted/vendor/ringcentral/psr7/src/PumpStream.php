 ...
 */
class PumpStream implements \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Psr\Http\Message\StreamInterface
{
    /** @var callable */
    private $source;
    /** @var int */
    ...
    public function __construct($source, array $options = array())
    {
        ...
        $this->buffer = new \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\RingCentral\Psr7\BufferStream();
    }
