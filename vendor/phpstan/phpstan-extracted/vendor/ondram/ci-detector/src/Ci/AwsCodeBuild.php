...
class AwsCodeBuild extends \_HumbugBox221ad6f1b81f__UniqueRector\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \_HumbugBox221ad6f1b81f__UniqueRector\OndraM\CiDetector\CiDetector::CI_AWS_CODEBUILD;
    }
    public function isPullRequest() : \_HumbugBox221ad6f1b81f__UniqueRector\OndraM\CiDetector\TrinaryLogic
    {
        return \_HumbugBox221ad6f1b81f__UniqueRector\OndraM\CiDetector\TrinaryLogic::createFromBoolean(\mb_strpos($this->env->getString('CODEBUILD_WEBHOOK_EVENT'), 'PULL_REQUEST') === 0);
    }
