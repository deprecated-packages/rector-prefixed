...
final class Processor
{
     ...
     */
    public function process(\_HumbugBox221ad6f1b81f__UniqueRector\Nette\Schema\Schema $schema, $data)
    {
     ...
     * @throws ValidationException
     */
    public function processMultiple(\_HumbugBox221ad6f1b81f__UniqueRector\Nette\Schema\Schema $schema, array $dataset)
    {
        $context = $this->createContext();
        $flatten = null;
        $first = \true;
    ...
    private function throwsErrors(\_HumbugBox221ad6f1b81f__UniqueRector\Nette\Schema\Context $context) : void
    {
        $messages = [];
        ...
        if ($messages) {
            throw new \_HumbugBox221ad6f1b81f__UniqueRector\Nette\Schema\ValidationException($messages[0], $messages);
        }
    }
    private function createContext() : \_HumbugBox221ad6f1b81f__UniqueRector\Nette\Schema\Context
    {
        $context = new \_HumbugBox221ad6f1b81f__UniqueRector\Nette\Schema\Context();
