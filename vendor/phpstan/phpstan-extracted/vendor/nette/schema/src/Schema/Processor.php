...
final class Processor
{
     ...
     */
    public function process(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Schema\Schema $schema, $data)
    {
     ...
     * @throws ValidationException
     */
    public function processMultiple(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Schema\Schema $schema, array $dataset)
    {
        $context = $this->createContext();
        $flatten = null;
        $first = \true;
    ...
    private function throwsErrors(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Schema\Context $context) : void
    {
        $messages = [];
        ...
        if ($messages) {
            throw new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Schema\ValidationException($messages[0], $messages);
        }
    }
    private function createContext() : \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Schema\Context
    {
        $context = new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Schema\Context();
