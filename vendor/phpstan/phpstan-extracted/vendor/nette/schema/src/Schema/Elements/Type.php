...
use _PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter;
...
final class Type implements \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Schema\Schema
{
    use Base;
    ...
    {
        $this->type .= '|' . \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter::class;
        return $this;
    }
    ...
    {
        $this->items = $type instanceof \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Schema\Schema ? $type : new self($type);
        return $this;
    }
    ...
    public function complete($value, \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Schema\Context $context)
    {
        ...
        if ($value instanceof \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter) {
            $context->dynamics[] = [$value, \str_replace('|' . \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter::class, '', $expected)];
        }
        if ($this->items) {
        ...
        $value = \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\Schema\Helpers::merge($value, $this->default);
