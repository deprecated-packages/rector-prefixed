...
use _HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter;
use _HumbugBox221ad6f1b81f\Nette\Schema\Helpers;
use _HumbugBox221ad6f1b81f\Nette\Schema\Schema;
final class Type implements \_HumbugBox221ad6f1b81f\Nette\Schema\Schema
{
    use Base;
    ...
    {
        $this->type .= '|' . \_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter::class;
        return $this;
    }
    ...
    {
        $this->items = $type instanceof \_HumbugBox221ad6f1b81f\Nette\Schema\Schema ? $type : new self($type);
        return $this;
    }
    ...
    public function complete($value, \_HumbugBox221ad6f1b81f\Nette\Schema\Context $context)
    {
        ...
        if ($value instanceof \_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter) {
            $context->dynamics[] = [$value, \str_replace('|' . \_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter::class, '', $expected)];
        }
        if ($this->items) {
        ...
        $value = \_HumbugBox221ad6f1b81f\Nette\Schema\Helpers::merge($value, $this->default);
