...
use _PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter;
...
final class Type implements \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Schema\Schema
{
    use Base;
    ...
    {
        $this->type .= '|' . \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter::class;
        return $this;
    }
    ...
    {
        $this->items = $type instanceof \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Schema\Schema ? $type : new self($type);
        return $this;
    }
    ...
    public function complete($value, \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Schema\Context $context)
    {
        ...
        if ($value instanceof \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter) {
            $context->dynamics[] = [$value, \str_replace('|' . \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Schema\DynamicParameter::class, '', $expected)];
        }
        if ($this->items) {
        ...
        $value = \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Schema\Helpers::merge($value, $this->default);
