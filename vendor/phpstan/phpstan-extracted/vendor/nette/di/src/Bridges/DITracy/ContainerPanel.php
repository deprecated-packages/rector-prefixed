...
namespace _PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Bridges\DITracy;

use _PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette;
use _PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\DI\Container;
use _PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Tracy;
/**
 * Dependency injection container panel for Debugger Bar.
 */
class ContainerPanel implements \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Tracy\IBarPanel
{
    ...
    {
        return \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Utils\Helpers::capture(function () {
    ...
    public function getPanel() : string
    {
        ...
        return \_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\Utils\Helpers::capture(function () use($tags, $types, $rc) {
    ...
    {
        $prop = (new \ReflectionClass(\_PhpScoper2a4e7ab1ecbc\_HumbugBox221ad6f1b81f\Nette\DI\Container::class))->getProperty($name);
