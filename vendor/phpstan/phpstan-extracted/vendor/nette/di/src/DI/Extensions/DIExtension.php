 ...
 * DI extension.
 */
final class DIExtension extends \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\DI\CompilerExtension
{
    /** @var array */
    public $exportedTags = [];
    /** @var array */
    ...
    public function __construct(bool $debugMode = \false)
    {
        ...
        $this->config->debugger = \interface_exists(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Tracy\IBarPanel::class);
    }
    ...
    private function restrictTags(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\PhpGenerator\ClassType $class) : void
    {
    ...
    private function restrictTypes(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\PhpGenerator\ClassType $class) : void
    {
    ...
    {
        \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Bridges\DITracy\ContainerPanel::$compilationTime = $this->time;
        $this->initialization->addBody($this->getContainerBuilder()->formatPhp('?;', [new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\DI\Definitions\Statement('@Tracy\\Bar::addPanel', [new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\DI\Definitions\Statement(\_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Bridges\DITracy\ContainerPanel::class)])]));
    }
}
