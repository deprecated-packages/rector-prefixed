...
abstract class Definition
{
    ...
    {
        if ($this->name) {
            throw new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\InvalidStateException('Name already has been set.');
        }
        $this->name = $name;
        return $this;
    }
    ...
    protected function setType(?string $type)
    {
        ...
        if ($type === null) {
            ...
            throw new \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\InvalidArgumentException("Service '{$this->name}': Class or interface '{$type}' not found.");
        } else {
            $this->type = \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\DI\Helpers::normalizeClass($type);
        }
        return $this;
    }
    ...
    /********************* life cycle ****************d*g**/
    public abstract function resolveType(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\DI\Resolver $resolver) : void;
    public abstract function complete(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\DI\Resolver $resolver) : void;
    public abstract function generateMethod(\_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\PhpGenerator\Method $method, \_PhpScoperb75b35f52b74\_HumbugBox221ad6f1b81f\Nette\DI\PhpGenerator $generator) : void;
