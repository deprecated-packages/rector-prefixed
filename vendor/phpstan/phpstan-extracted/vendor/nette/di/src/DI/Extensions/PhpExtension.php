 ...
 */
final class PhpExtension extends \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\DI\CompilerExtension
{
    public function getConfigSchema() : \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\Schema\Schema
    {
        return \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\Schema\Expect::arrayOf('scalar');
    }
    public function loadConfiguration()
    {
        foreach ($this->getConfig() as $name => $value) {
            if ($value === null) {
                ...
                // intentionally ==
                throw new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\NotSupportedException('Required function ini_set() is disabled.');
            }
        }
    }
}
