 ...
 */
final class PhpExtension extends \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\DI\CompilerExtension
{
    public function getConfigSchema() : \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Schema\Schema
    {
        return \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\Schema\Expect::arrayOf('scalar');
    }
    public function loadConfiguration()
    {
        foreach ($this->getConfig() as $name => $value) {
            if ($value === null) {
                ...
                // intentionally ==
                throw new \_PhpScoper0a2ac50786fa\_HumbugBox221ad6f1b81f\Nette\NotSupportedException('Required function ini_set() is disabled.');
            }
        }
    }
}
