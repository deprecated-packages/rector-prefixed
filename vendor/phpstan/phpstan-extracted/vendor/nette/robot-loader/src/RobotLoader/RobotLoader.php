...
namespace _HumbugBox221ad6f1b81f__UniqueRector\Nette\Loaders;
...
class RobotLoader
{
    ...
    public function __construct()
    {
        if (!\extension_loaded('tokenizer')) {
            throw new \_HumbugBox221ad6f1b81f__UniqueRector\Nette\NotSupportedException('PHP extension Tokenizer is not loaded.');
        }
    }
    /**
     * Register autoloader.
        ...
        foreach ($this->scanPaths as $path) {
            ...
            foreach ($iterator as $file) {
                ...
                foreach ($classes as $class) {
                    ...
                    if (isset($info['file'])) {
                        throw new \_HumbugBox221ad6f1b81f__UniqueRector\Nette\InvalidStateException("Ambiguous class {$class} resolution; defined in {$info['file']} and in {$file}.");
                    }
     ...
     */
    private function createFileIterator(string $dir) : \_HumbugBox221ad6f1b81f__UniqueRector\Nette\Utils\Finder
    {
        if (!\is_dir($dir)) {
            throw new \_HumbugBox221ad6f1b81f__UniqueRector\Nette\IOException("File or directory '{$dir}' not found.");
        }
        ...
        $iterator = \_HumbugBox221ad6f1b81f__UniqueRector\Nette\Utils\Finder::findFiles($acceptFiles)->filter(function (\SplFileInfo $file) use(&$disallow) {
