...
namespace _PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\Loaders;
...
class RobotLoader
{
    ...
    public function __construct()
    {
        if (!\extension_loaded('tokenizer')) {
            throw new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\NotSupportedException('PHP extension Tokenizer is not loaded.');
        }
    }
    /**
     * Register autoloader.
        ...
        foreach ($this->scanPaths as $path) {
            ...
            foreach ($iterator as $file) {
                ...
                foreach ($classes as $class) {
                    ...
                    if (isset($info['file'])) {
                        throw new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\InvalidStateException("Ambiguous class {$class} resolution; defined in {$info['file']} and in {$file}.");
                    }
     ...
     */
    private function createFileIterator(string $dir) : \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\Utils\Finder
    {
        if (!\is_dir($dir)) {
            throw new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\IOException("File or directory '{$dir}' not found.");
        }
        ...
        $iterator = \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\Utils\Finder::findFiles($acceptFiles)->filter(function (\SplFileInfo $file) use(&$disallow) {
