...
final class Helpers
{
    ...
    {
        return (new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\PhpGenerator\Dumper())->dump($var);
    }
    /** @deprecated  use Nette\PhpGenerator\Dumper::format() */
    public static function format(string $statement, ...$args) : string
    {
        return (new \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\PhpGenerator\Dumper())->format($statement, ...$args);
    }
    /** @deprecated  use Nette\PhpGenerator\Dumper::format() */
    ...
    {
        return \_PhpScopere8e811afab72\_HumbugBox221ad6f1b81f\Nette\PhpGenerator\Dumper::createObject($class, $props);
    }
}
