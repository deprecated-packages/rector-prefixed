...
final class Reflection
{
    ...
    public static function expandClassName(string $name, \ReflectionClass $context) : string
    {
        ...
        if (empty($name)) {
            throw new \_HumbugBox221ad6f1b81f__UniqueRector\Nette\InvalidArgumentException('Class name must not be empty.');
    ...
    public static function getUseStatements(\ReflectionClass $class) : array
    {
        if ($class->isAnonymous()) {
            throw new \_HumbugBox221ad6f1b81f__UniqueRector\Nette\NotImplementedException('Anonymous classes are not supported.');
        }
        static $cache = [];
