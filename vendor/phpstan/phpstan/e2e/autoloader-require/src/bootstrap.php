...
\spl_autoload_register(function ($class) {
    ...
    if (\mb_strpos($unprefixedClass, 'Tests\\') === 0) {
        ...
        $path = __DIR__ . \DIRECTORY_SEPARATOR . '..' . \DIRECTORY_SEPARATOR . 'tests' . \DIRECTORY_SEPARATOR . $unprefixedClass . '.php';
    } else {
        $path = __DIR__ . \DIRECTORY_SEPARATOR . $unprefixedClass . '.php';
    }
    if (!\file_exists($path)) {
