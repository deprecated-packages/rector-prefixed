...
use _PhpScoper26e51eeacccf\Httpful\Request;
...
(function () {
    ...
    $command = new class extends \_PhpScoper26e51eeacccf\Symfony\Component\Console\Command\Command
    {
        protected function configure()
        {
            $this->setName('run');
            $this->addArgument('fromCommit', \_PhpScoper26e51eeacccf\Symfony\Component\Console\Input\InputArgument::REQUIRED);
            $this->addArgument('toCommit', \_PhpScoper26e51eeacccf\Symfony\Component\Console\Input\InputArgument::REQUIRED);
        }
        protected function execute(\_PhpScoper26e51eeacccf\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper26e51eeacccf\Symfony\Component\Console\Output\OutputInterface $output)
        {
            ...
            foreach ($commits as $commit) {
                $searchPullRequestsResponse = \_PhpScoper26e51eeacccf\Httpful\Request::get(\sprintf('https://api.github.com/search/issues?q=repo:phpstan/phpstan-src+%s', $commit['hash']))->sendsAndExpectsType('application/json')->basicAuth('ondrejmirtes', \getenv('GITHUB_TOKEN'))->send();
                ...
                $searchIssuesResponse = \_PhpScoper26e51eeacccf\Httpful\Request::get(\sprintf('https://api.github.com/search/issues?q=repo:phpstan/phpstan+%s', $commit['hash']))->sendsAndExpectsType('application/json')->basicAuth('ondrejmirtes', \getenv('GITHUB_TOKEN'))->send();
    ...
    $application = new \_PhpScoper26e51eeacccf\Symfony\Component\Console\Application();
