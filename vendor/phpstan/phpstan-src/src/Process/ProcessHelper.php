...
class ProcessHelper
{
     ...
     * @return string
     */
    public static function getWorkerCommand(string $mainScript, string $commandName, ?string $projectConfigFile, array $additionalItems, \_PhpScopera143bcca66cb\Symfony\Component\Console\Input\InputInterface $input) : string
    {
