...
class AnalyseCommand extends \_PhpScoperabd03f0baf05\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setName(self::NAME)->setDescription('Analyses source code')->setDefinition([new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputArgument('paths', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputArgument::OPTIONAL | \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths with source code to run analysis on'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('paths-file', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to a file with a list of paths to run analysis on'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('configuration', 'c', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to project configuration file'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption(self::OPTION_LEVEL, 'l', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Level of rule options - the higher the stricter'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption(\PHPStan\Command\ErrorsConsoleStyle::OPTION_NO_PROGRESS, null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not show progress bar, only results'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('debug', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Show debug information - which file is analysed, do not catch internal errors'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('autoload-file', 'a', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Project\'s additional autoload file path'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('error-format', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Format in which to print the result of the analysis', null), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('generate-baseline', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'Path to a file where the baseline should be saved', \false), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('memory-limit', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Memory limit for analysis'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('xdebug', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Allow running with XDebug for debugging purposes'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('fix', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('watch', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('pro', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro')]);
    }
    /**
     * @return string[]
     */
    ...
    protected function execute(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if ($errorFormat === null) {
            $errorFormat = 'table';
            $ciDetector = new \_PhpScoperabd03f0baf05\OndraM\CiDetector\CiDetector();
            try {
                $ci = $ciDetector->detect();
                if ($ci->getCiName() === \_PhpScoperabd03f0baf05\OndraM\CiDetector\CiDetector::CI_GITHUB_ACTIONS) {
                    $errorFormat = 'github';
                } elseif ($ci->getCiName() === \_PhpScoperabd03f0baf05\OndraM\CiDetector\CiDetector::CI_TEAMCITY) {
                    $errorFormat = 'teamcity';
                }
            } catch (\_PhpScoperabd03f0baf05\OndraM\CiDetector\Exception\CiNotDetectedException $e) {
                // pass
            }
        }
        ...
        if ($generateBaselineFile !== null) {
            ...
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\StringInput(''), $streamOutput);
    ...
    private function createStreamOutput() : \_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\StreamOutput
    {
        $resource = \fopen('php://memory', 'w', \false);
        if ($resource === \false) {
            throw new \PHPStan\ShouldNotHappenException();
        }
        return new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\StreamOutput($resource);
    }
}
