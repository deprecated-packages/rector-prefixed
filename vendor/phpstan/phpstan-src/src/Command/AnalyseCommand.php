...
use _PhpScoper006a73f0e455\Symfony\Component\Console\Output\StreamOutput;
use function stream_get_contents;
class AnalyseCommand extends \_PhpScoper006a73f0e455\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setName(self::NAME)->setDescription('Analyses source code')->setDefinition([new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputArgument('paths', \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputArgument::OPTIONAL | \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths with source code to run analysis on'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('paths-file', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to a file with a list of paths to run analysis on'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('configuration', 'c', \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to project configuration file'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption(self::OPTION_LEVEL, 'l', \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Level of rule options - the higher the stricter'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption(\PHPStan\Command\ErrorsConsoleStyle::OPTION_NO_PROGRESS, null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not show progress bar, only results'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('debug', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Show debug information - which file is analysed, do not catch internal errors'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('autoload-file', 'a', \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Project\'s additional autoload file path'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('error-format', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Format in which to print the result of the analysis', null), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('generate-baseline', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'Path to a file where the baseline should be saved', \false), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('memory-limit', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Memory limit for analysis'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('xdebug', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Allow running with XDebug for debugging purposes'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('fix', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('watch', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro'), new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption('pro', null, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Launch PHPStan Pro')]);
    }
    /**
     * @return string[]
     */
    ...
    protected function execute(\_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper006a73f0e455\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if ($errorFormat === null) {
            ...
            try {
                ...
                if ($ci->getCiName() === \_PhpScoper006a73f0e455\OndraM\CiDetector\CiDetector::CI_GITHUB_ACTIONS) {
                    $errorFormat = 'github';
                } elseif ($ci->getCiName() === \_PhpScoper006a73f0e455\OndraM\CiDetector\CiDetector::CI_TEAMCITY) {
                    $errorFormat = 'teamcity';
                }
            } catch (\_PhpScoper006a73f0e455\OndraM\CiDetector\Exception\CiNotDetectedException $e) {
                // pass
            }
        }
        ...
        if ($generateBaselineFile !== null) {
            ...
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\StringInput(''), $streamOutput);
    ...
    private function createStreamOutput() : \_PhpScoper006a73f0e455\Symfony\Component\Console\Output\StreamOutput
    {
        $resource = \fopen('php://memory', 'w', \false);
        if ($resource === \false) {
            throw new \PHPStan\ShouldNotHappenException();
        }
        return new \_PhpScoper006a73f0e455\Symfony\Component\Console\Output\StreamOutput($resource);
    }
}
