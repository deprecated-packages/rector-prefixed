...
use _PhpScoperabd03f0baf05\React\Socket\TcpConnector;
...
class WorkerCommand extends \_PhpScoperabd03f0baf05\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setName(self::NAME)->setDescription('(Internal) Support for parallel analysis.')->setDefinition([new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputArgument('paths', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputArgument::OPTIONAL | \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths with source code to run analysis on'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('paths-file', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to a file with a list of paths to run analysis on'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('configuration', 'c', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to project configuration file'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption(\PHPStan\Command\AnalyseCommand::OPTION_LEVEL, 'l', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Level of rule options - the higher the stricter'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('autoload-file', 'a', \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Project\'s additional autoload file path'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('memory-limit', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Memory limit for analysis'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('xdebug', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Allow running with XDebug for debugging purposes'), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('port', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('identifier', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('tmp-file', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED), new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption('instead-of', null, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED)]);
    }
    protected function execute(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $tcpConector = new \_PhpScoperabd03f0baf05\React\Socket\TcpConnector($loop);
        $tcpConector->connect(\sprintf('127.0.0.1:%d', $port))->done(function (\_PhpScoperabd03f0baf05\React\Socket\ConnectionInterface $connection) use($container, $identifier, $output, $analysedFiles, $tmpFile, $insteadOfFile) : void {
            $out = new \_PhpScoperabd03f0baf05\Clue\React\NDJson\Encoder($connection, \defined('JSON_INVALID_UTF8_IGNORE') ? \JSON_INVALID_UTF8_IGNORE : 0);
            $in = new \_PhpScoperabd03f0baf05\Clue\React\NDJson\Decoder($connection, \true, 512, \defined('JSON_INVALID_UTF8_IGNORE') ? \JSON_INVALID_UTF8_IGNORE : 0, $container->getParameter('parallel')['buffer']);
     ...
     */
    private function runWorker(\PHPStan\DependencyInjection\Container $container, \_PhpScoperabd03f0baf05\React\Stream\WritableStreamInterface $out, \_PhpScoperabd03f0baf05\React\Stream\ReadableStreamInterface $in, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\OutputInterface $output, array $analysedFiles, ?string $tmpFile, ?string $insteadOfFile) : void
    {
