...
class ErrorsConsoleStyle extends \Symfony\Component\Console\Style\SymfonyStyle
{
    ...
    public function table(array $headers, array $rows) : void
    {
        ...
        $terminalWidth = (new \_PhpScoper88fe6e0ad041\Symfony\Component\Console\Terminal())->getWidth() - 2;
     ...
     * @param int $max
     */
    public function createProgressBar($max = 0) : \_PhpScoper88fe6e0ad041\Symfony\Component\Console\Helper\ProgressBar
    {
