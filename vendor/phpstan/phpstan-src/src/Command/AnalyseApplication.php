...
class AnalyseApplication
{
     ...
     */
    private function runAnalyser(array $files, array $allAnalysedFiles, bool $debug, ?string $projectConfigFile, \PHPStan\Command\Output $stdOutput, \PHPStan\Command\Output $errorOutput, \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\InputInterface $input) : \PHPStan\Analyser\AnalyserResult
    {
