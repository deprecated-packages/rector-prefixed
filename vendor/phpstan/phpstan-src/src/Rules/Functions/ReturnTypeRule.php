...
class ReturnTypeRule implements \PHPStan\Rules\Rule
{
    ...
    public function __construct(\PHPStan\Rules\FunctionReturnTypeCheck $returnTypeCheck, \_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflector\FunctionReflector $functionReflector)
    {
