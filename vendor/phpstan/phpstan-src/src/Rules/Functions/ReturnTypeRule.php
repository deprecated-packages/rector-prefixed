...
class ReturnTypeRule implements \PHPStan\Rules\Rule
{
    ...
    public function __construct(\PHPStan\Rules\FunctionReturnTypeCheck $returnTypeCheck, \_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflector\FunctionReflector $functionReflector)
    {
