...
class NodeTokensVisitor extends \PhpParser\NodeVisitorAbstract
{
    /** @var mixed[] */
    private $tokens;
    /**
    ...
    public function enterNode(\PhpParser\Node $node)
    {
        ...
        if ($node instanceof \PhpParser\Node\Expr\Ternary && $parent instanceof \PhpParser\Node\Expr\Ternary) {
     ...
     */
    private function getImmediates(\PhpParser\Node $parent, int $myStart, int $myEnd) : array
    {
