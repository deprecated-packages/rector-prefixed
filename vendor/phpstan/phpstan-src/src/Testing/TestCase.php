...
abstract class TestCase extends \_PhpScoper006a73f0e455\PHPUnit\Framework\TestCase
{
    /** @var bool */
    ...
    private static function getPhpStormStubsSourceStubber() : \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber
    {
        if (self::$phpStormStubsSourceStubber === null) {
            self::$phpStormStubsSourceStubber = self::getContainer()->getByType(\_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber::class);
        }
    ...
    public static function getReflectors() : array
    {
        ...
        if (!\class_exists(\_PhpScoper006a73f0e455\Composer\Autoload\ClassLoader::class)) {
        ...
        $astLocator = new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Ast\Locator($phpParser, static function () use(&$functionReflector) : FunctionReflector {
            return $functionReflector;
        });
        $reflectionSourceStubber = new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber();
        $locators[] = new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\PhpInternalSourceLocator($astLocator, self::getPhpStormStubsSourceStubber());
        ...
        $locators[] = new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\PhpInternalSourceLocator($astLocator, $reflectionSourceStubber);
        $locators[] = new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\EvaledCodeSourceLocator($astLocator, $reflectionSourceStubber);
        $sourceLocator = new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\MemoizingSourceLocator(new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\AggregateSourceLocator($locators));
