...
abstract class ErrorFormatterTestCase extends \PHPStan\Testing\TestCase
{
     ...
     */
    private $output = null;
    private function getOutputStream() : \_PhpScoperbd5d0c5f7638\Symfony\Component\Console\Output\StreamOutput
    {
        ...
        if ($this->outputStream === null) {
            ...
            $this->outputStream = new \_PhpScoperbd5d0c5f7638\Symfony\Component\Console\Output\StreamOutput($resource);
        }
    ...
    {
        if ($this->output === null) {
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \_PhpScoperbd5d0c5f7638\Symfony\Component\Console\Input\StringInput(''), $this->getOutputStream());
