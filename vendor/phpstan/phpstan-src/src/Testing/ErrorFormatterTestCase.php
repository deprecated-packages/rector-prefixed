...
abstract class ErrorFormatterTestCase extends \PHPStan\Testing\TestCase
{
     ...
     */
    private $output = null;
    private function getOutputStream() : \_PhpScoper88fe6e0ad041\Symfony\Component\Console\Output\StreamOutput
    {
        ...
        if ($this->outputStream === null) {
            ...
            $this->outputStream = new \_PhpScoper88fe6e0ad041\Symfony\Component\Console\Output\StreamOutput($resource);
        }
    ...
    {
        if ($this->output === null) {
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \_PhpScoper88fe6e0ad041\Symfony\Component\Console\Input\StringInput(''), $this->getOutputStream());
