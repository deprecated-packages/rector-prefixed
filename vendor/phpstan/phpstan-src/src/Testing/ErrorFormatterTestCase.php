...
abstract class ErrorFormatterTestCase extends \PHPStan\Testing\TestCase
{
    ...
    /**
     * @var \Symfony\Component\Console\Output\StreamOutput|null
     */
     ...
     */
    private $output = null;
    private function getOutputStream() : \_PhpScoper006a73f0e455\Symfony\Component\Console\Output\StreamOutput
    {
        ...
        if ($this->outputStream === null) {
            ...
            $this->outputStream = new \_PhpScoper006a73f0e455\Symfony\Component\Console\Output\StreamOutput($resource);
        }
    ...
    {
        if ($this->output === null) {
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \_PhpScoper006a73f0e455\Symfony\Component\Console\Input\StringInput(''), $this->getOutputStream());
