...
class Process
{
     ...
     */
    private $timer = null;
    public function __construct(string $command, \_PhpScoper006a73f0e455\React\EventLoop\LoopInterface $loop, float $timeoutSeconds)
    {
    ...
    public function start(callable $onData, callable $onError, callable $onExit) : void
    {
        ...
        $this->process = new \_PhpScoper006a73f0e455\React\ChildProcess\Process($this->command, null, null, [1 => $this->stdOut, 2 => $this->stdErr]);
    ...
    public function bindConnection(\_PhpScoper006a73f0e455\React\Stream\ReadableStreamInterface $out, \_PhpScoper006a73f0e455\React\Stream\WritableStreamInterface $in) : void
    {
