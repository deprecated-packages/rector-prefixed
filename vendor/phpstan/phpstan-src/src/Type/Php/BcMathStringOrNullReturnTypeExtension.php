...
class BcMathStringOrNullReturnTypeExtension implements \PHPStan\Type\DynamicFunctionReturnTypeExtension
{
    ...
    public function getTypeFromFunctionCall(\PHPStan\Reflection\FunctionReflection $functionReflection, \PhpParser\Node\Expr\FuncCall $functionCall, \PHPStan\Analyser\Scope $scope) : \PHPStan\Type\Type
    {
        ...
        $defaultReturnType = new \PHPStan\Type\UnionType([new \PHPStan\Type\StringType(), new \PHPStan\Type\NullType()]);
     ...
     */
    private function getTypeForBcSqrt(\PhpParser\Node\Expr\FuncCall $functionCall, \PHPStan\Analyser\Scope $scope)
    {
        $defaultReturnType = new \PHPStan\Type\UnionType([new \PHPStan\Type\StringType(), new \PHPStan\Type\NullType()]);
     ...
     */
    private function getTypeForBcPowMod(\PhpParser\Node\Expr\FuncCall $functionCall, \PHPStan\Analyser\Scope $scope)
    {
        if (isset($functionCall->args[1]) === \false) {
