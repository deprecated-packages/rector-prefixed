...
class FileTypeMapper
{
    ...
    private function resolvePhpDocStringToDocNode(string $phpDocString) : \PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode
    {
        ...
        try {
            $phpDocParserVersion = \_PhpScoperabd03f0baf05\Jean85\PrettyVersions::getVersion('phpstan/phpdoc-parser')->getPrettyVersion();
    ...
    {
        $docComment = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::replace($docComment, '#\\s+#', ' ');
