...
use _PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod;
use _PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty;
class PhpClassReflectionExtension implements \PHPStan\Reflection\PropertiesClassReflectionExtension, \PHPStan\Reflection\MethodsClassReflectionExtension
{
    ...
    {
        if ($propertyReflection instanceof \_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty) {
    ...
    {
        if ($methodReflection->getReflection() instanceof \_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod) {
