...
use _PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod;
use _PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty;
class PhpClassReflectionExtension implements \PHPStan\Reflection\PropertiesClassReflectionExtension, \PHPStan\Reflection\MethodsClassReflectionExtension
{
    ...
    {
        if ($propertyReflection instanceof \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Adapter\ReflectionProperty) {
    ...
    {
        if ($methodReflection->getReflection() instanceof \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod) {
