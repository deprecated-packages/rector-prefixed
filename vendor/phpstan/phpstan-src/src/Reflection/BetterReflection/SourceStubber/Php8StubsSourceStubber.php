...
class Php8StubsSourceStubber implements \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    public function generateClassStub(string $className) : ?\_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        ...
        return new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\StubData(\PHPStan\File\FileReader::read($file), $this->getExtensionFromFilePath($relativeFilePath), $file);
    }
