...
class Php8StubsSourceStubber implements \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    public function generateClassStub(string $className) : ?\_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        ...
        return new \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\SourceStubber\StubData(\PHPStan\File\FileReader::read($file), $this->getExtensionFromFilePath($relativeFilePath), $file);
    }
