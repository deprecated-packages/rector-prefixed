...
class Php8StubsSourceStubber implements \_PhpScoper88fe6e0ad041\Roave\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    public function generateClassStub(string $className) : ?\_PhpScoper88fe6e0ad041\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        ...
        return new \_PhpScoper88fe6e0ad041\Roave\BetterReflection\SourceLocator\SourceStubber\StubData(\PHPStan\File\FileReader::read($file), $this->getExtensionFromFilePath($relativeFilePath), $file);
    }
