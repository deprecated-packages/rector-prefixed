...
class OptimizedSingleFileSourceLocator implements \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\SourceLocator
{
    /**
    ...
    public function locateIdentifier(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper006a73f0e455\Roave\BetterReflection\Identifier\Identifier $identifier) : ?\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Reflection
    {
        ...
        if ($identifier->isClass()) {
            ...
            foreach ($classNodes[$className] as $classNode) {
                ...
                if (!$classReflection instanceof \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionClass) {
        ...
        if ($identifier->isFunction()) {
            ...
            if (!$functionReflection instanceof \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionFunction) {
                throw new \PHPStan\ShouldNotHappenException();
            }
