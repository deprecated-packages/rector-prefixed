...
use _PhpScoperabd03f0baf05\Nette\DI\Extensions\PhpExtension;
use Phar;
...
class ContainerFactory
{
    ...
    public function create(string $tempDirectory, array $additionalConfigFiles, array $analysedPaths, array $composerAutoloaderProjectPaths = [], array $analysedPathsFromConfig = [], string $usedLevel = \PHPStan\Command\CommandHelper::DEFAULT_LEVEL, ?string $generateBaselineFile = null, ?string $cliAutoloadFile = null, ?string $singleReflectionFile = null) : \PHPStan\DependencyInjection\Container
    {
        ...
        $configurator->defaultExtensions = ['php' => \_PhpScoperabd03f0baf05\Nette\DI\Extensions\PhpExtension::class, 'extensions' => \_PhpScoperabd03f0baf05\Nette\DI\Extensions\ExtensionsExtension::class];
        ...
        \_PhpScoperabd03f0baf05\Roave\BetterReflection\BetterReflection::$phpVersion = $container->getByType(\PHPStan\Php\PhpVersion::class)->getVersionId();
        \_PhpScoperabd03f0baf05\Roave\BetterReflection\BetterReflection::populate(
            ...
            // @phpstan-ignore-line
            $container->getByType(\_PhpScoperabd03f0baf05\Roave\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber::class)
        );
        /** @var Broker $broker */
