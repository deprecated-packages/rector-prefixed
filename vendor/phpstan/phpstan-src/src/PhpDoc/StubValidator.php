...
class StubValidator
{
     ...
     */
    public function __construct(array $stubFiles, \PHPStan\DependencyInjection\DerivativeContainerFactory $derivativeContainerFactory)
    {
    ...
    public function validate() : array
    {
        ...
        $analysedFiles = \array_fill_keys($this->stubFiles, \true);
        $errors = [];
