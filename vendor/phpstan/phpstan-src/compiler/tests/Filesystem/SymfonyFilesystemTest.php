...
final class SymfonyFilesystemTest extends \_PhpScopera143bcca66cb\PHPUnit\Framework\TestCase
{
    public function testExists() : void
    {
        $inner = $this->createMock(\_PhpScopera143bcca66cb\Symfony\Component\Filesystem\Filesystem::class);
