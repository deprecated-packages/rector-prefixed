...
final class SymfonyFilesystemTest extends \_PhpScoperabd03f0baf05\PHPUnit\Framework\TestCase
{
    public function testExists() : void
    {
        $inner = $this->createMock(\_PhpScoperabd03f0baf05\Symfony\Component\Filesystem\Filesystem::class);
