...
final class CompileCommand extends \_PhpScoperabd03f0baf05\Symfony\Component\Console\Command\Command
{
    /** @var Filesystem */
    private $filesystem;
    /** @var ProcessFactory */
    ...
    private function renamePhpStormStubs() : void
    {
        ...
        $stubFinder = \_PhpScoperabd03f0baf05\Symfony\Component\Finder\Finder::create();
    ...
    private function patchPhpStormStubs(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
        $stubFinder = \_PhpScoperabd03f0baf05\Symfony\Component\Finder\Finder::create();
...
%s
php;
        $finder = \_PhpScoperabd03f0baf05\Symfony\Component\Finder\Finder::create();
    ...
    private function patchFile(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\OutputInterface $output, string $originalFile, string $patchFile) : void
    {
