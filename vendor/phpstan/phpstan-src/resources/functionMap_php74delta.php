 ...
 */
return ['new' => ['FFI::addr' => ['_PhpScoperbd5d0c5f7638\\FFI\\CData', '&ptr' => '_PhpScoperbd5d0c5f7638\\FFI\\CData'], 'FFI::alignof' => ['int', '&ptr' => 'mixed'], 'FFI::arrayType' => ['_PhpScoperbd5d0c5f7638\\FFI\\CType', 'type' => '_PhpScoperbd5d0c5f7638\\string|FFI\\CType', 'dims' => 'array<int,int>'], 'FFI::cast' => ['_PhpScoperbd5d0c5f7638\\FFI\\CData', 'type' => '_PhpScoperbd5d0c5f7638\\string|FFI\\CType', '&ptr' => ''], 'FFI::cdef' => ['FFI', 'code=' => 'string', 'lib=' => '?string'], 'FFI::free' => ['void', '&ptr' => '_PhpScoperbd5d0c5f7638\\FFI\\CData'], 'FFI::load' => ['FFI', 'filename' => 'string'], 'FFI::memcmp' => ['int', '&ptr1' => 'FFI\\CData|string', '&ptr2' => 'FFI\\CData|string', 'size' => 'int'], 'FFI::memcpy' => ['void', '&dst' => '_PhpScoperbd5d0c5f7638\\FFI\\CData', '&src' => '_PhpScoperbd5d0c5f7638\\string|FFI\\CData', 'size' => 'int'], 'FFI::memset' => ['void', '&ptr' => '_PhpScoperbd5d0c5f7638\\FFI\\CData', 'ch' => 'int', 'size' => 'int'], 'FFI::new' => ['_PhpScoperbd5d0c5f7638\\FFI\\CData', 'type' => '_PhpScoperbd5d0c5f7638\\string|FFI\\CType', 'owned=' => 'bool', 'persistent=' => 'bool'], 'FFI::scope' => ['FFI', 'scope_name' => 'string'], 'FFI::sizeof' => ['int', '&ptr' => '_PhpScoperbd5d0c5f7638\\FFI\\CData|FFI\\CType'], 'FFI::string' => ['string', '&ptr' => '_PhpScoperbd5d0c5f7638\\FFI\\CData', 'size=' => 'int'], 'FFI::typeof' => ['_PhpScoperbd5d0c5f7638\\FFI\\CType', '&ptr' => '_PhpScoperbd5d0c5f7638\\FFI\\CData'], 'FFI::type' => ['_PhpScoperbd5d0c5f7638\\FFI\\CType', 'type' => 'string'], 'get_mangled_object_vars' => ['array', 'obj' => 'object'], 'mb_str_split' => ['array<int,string>|false', 'str' => 'string', 'split_length=' => 'int', 'encoding=' => 'string'], 'password_algos' => ['array<int, string>'], 'password_hash' => ['string|false', 'password' => 'string', 'algo' => 'string|null', 'options=' => 'array'], 'password_needs_rehash' => ['bool', 'hash' => 'string', 'algo' => 'string|null', 'options=' => 'array'], 'sapi_windows_set_ctrl_handler' => ['bool', 'callable' => 'callable', 'add=' => 'bool'], 'ReflectionProperty::getType' => ['?ReflectionType'], 'ReflectionProperty::hasType' => ['bool'], 'ReflectionProperty::isInitialized' => ['bool', 'object=' => '?object'], 'ReflectionReference::fromArrayElement' => ['?ReflectionReference', 'array' => 'array', 'key' => 'int|string'], 'ReflectionReference::getId' => ['string'], 'SQLite3Stmt::getSQL' => ['string', 'expanded=' => 'bool'], 'strip_tags' => ['string', 'str' => 'string', 'allowable_tags=' => 'string|array<int, string>'], 'WeakReference::create' => ['WeakReference', 'referent' => 'object'], 'WeakReference::get' => ['?object']], 'old' => ['implode\'2' => ['string', 'pieces' => 'array', 'glue' => 'string']]];
