...
class CachedParserTest extends \_PhpScoper006a73f0e455\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $parser = new \PHPStan\Parser\CachedParser($this->getParserMock(), $cachedNodesByStringCountMax);
     ...
     */
    private function getParserMock() : \PHPStan\Parser\Parser
    {
        $mock = $this->createMock(\PHPStan\Parser\Parser::class);
