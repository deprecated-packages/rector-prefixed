...
class IntersectionTypeMethodReflectionTest extends \PHPStan\Testing\TestCase
{
    ...
    {
        $reflection = new \PHPStan\Reflection\Type\IntersectionTypeMethodReflection('foo', [$this->createDeprecatedMethod(\PHPStan\TrinaryLogic::createYes(), 'Deprecated'), $this->createDeprecatedMethod(\PHPStan\TrinaryLogic::createMaybe(), 'Maybe deprecated'), $this->createDeprecatedMethod(\PHPStan\TrinaryLogic::createNo(), 'Not deprecated')]);
        $this->assertSame('Deprecated', $reflection->getDeprecatedDescription());
    }
    public function testMultipleDeprecationsAreJoined() : void
    {
        $reflection = new \PHPStan\Reflection\Type\IntersectionTypeMethodReflection('foo', [$this->createDeprecatedMethod(\PHPStan\TrinaryLogic::createYes(), 'Deprecated #1'), $this->createDeprecatedMethod(\PHPStan\TrinaryLogic::createYes(), 'Deprecated #2')]);
