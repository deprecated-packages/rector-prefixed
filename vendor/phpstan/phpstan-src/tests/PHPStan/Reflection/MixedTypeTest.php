...
use _PhpScoperbd5d0c5f7638\NativeMixedType\Foo;
...
class MixedTypeTest extends \PHPStan\Testing\TestCase
{
    public function testMixedType() : void
    {
        ...
        $class = $reflectionProvider->getClass(\_PhpScoperbd5d0c5f7638\NativeMixedType\Foo::class);
        ...
        $function = $reflectionProvider->getFunction(new \PhpParser\Node\Name('_PhpScoperbd5d0c5f7638\\NativeMixedType\\doFoo'), null);
