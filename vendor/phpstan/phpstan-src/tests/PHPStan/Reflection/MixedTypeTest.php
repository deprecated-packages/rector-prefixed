...
use _PhpScoper26e51eeacccf\NativeMixedType\Foo;
...
class MixedTypeTest extends \PHPStan\Testing\TestCase
{
    public function testMixedType() : void
    {
        ...
        $class = $reflectionProvider->getClass(\_PhpScoper26e51eeacccf\NativeMixedType\Foo::class);
        ...
        $function = $reflectionProvider->getFunction(new \PhpParser\Node\Name('_PhpScoper26e51eeacccf\\NativeMixedType\\doFoo'), null);
