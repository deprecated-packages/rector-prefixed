...
use _PhpScoper006a73f0e455\NativeMixedType\Foo;
...
class MixedTypeTest extends \PHPStan\Testing\TestCase
{
    public function testMixedType() : void
    {
        ...
        $class = $reflectionProvider->getClass(\_PhpScoper006a73f0e455\NativeMixedType\Foo::class);
        ...
        $function = $reflectionProvider->getFunction(new \PhpParser\Node\Name('_PhpScoper006a73f0e455\\NativeMixedType\\doFoo'), null);
