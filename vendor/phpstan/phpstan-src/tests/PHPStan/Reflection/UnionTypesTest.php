...
use _PhpScopera143bcca66cb\NativeUnionTypes\Foo;
...
class UnionTypesTest extends \PHPStan\Testing\TestCase
{
    public function testUnionTypes() : void
    {
        ...
        $class = $reflectionProvider->getClass(\_PhpScopera143bcca66cb\NativeUnionTypes\Foo::class);
        ...
        $this->assertSame('_PhpScopera143bcca66cb\\NativeUnionTypes\\Bar|NativeUnionTypes\\Foo', $methodReturnType->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $function = $reflectionProvider->getFunction(new \PhpParser\Node\Name('_PhpScopera143bcca66cb\\NativeUnionTypes\\doFoo'), null);
        ...
        $this->assertSame('_PhpScopera143bcca66cb\\NativeUnionTypes\\Bar|NativeUnionTypes\\Foo', $functionReturnType->describe(\PHPStan\Type\VerbosityLevel::precise()));
