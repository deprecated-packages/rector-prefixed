...
use _PhpScoper006a73f0e455\NativeUnionTypes\Foo;
...
class UnionTypesTest extends \PHPStan\Testing\TestCase
{
    public function testUnionTypes() : void
    {
        ...
        $class = $reflectionProvider->getClass(\_PhpScoper006a73f0e455\NativeUnionTypes\Foo::class);
        ...
        $this->assertSame('_PhpScoper006a73f0e455\\NativeUnionTypes\\Bar|NativeUnionTypes\\Foo', $methodReturnType->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $function = $reflectionProvider->getFunction(new \PhpParser\Node\Name('_PhpScoper006a73f0e455\\NativeUnionTypes\\doFoo'), null);
        ...
        $this->assertSame('_PhpScoper006a73f0e455\\NativeUnionTypes\\Bar|NativeUnionTypes\\Foo', $functionReturnType->describe(\PHPStan\Type\VerbosityLevel::precise()));
