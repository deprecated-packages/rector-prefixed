...
class InternalAnnotationsTest extends \PHPStan\Testing\TestCase
{
    ...
    {
        return [[\false, \_PhpScoper88fe6e0ad041\InternalAnnotations\Foo::class, ['constant' => ['FOO'], 'method' => ['foo', 'staticFoo'], 'property' => ['foo', 'staticFoo']]], [\true, \_PhpScoper88fe6e0ad041\InternalAnnotations\InternalFoo::class, ['constant' => ['INTERNAL_FOO'], 'method' => ['internalFoo', 'internalStaticFoo'], 'property' => ['internalFoo', 'internalStaticFoo']]], [\false, \_PhpScoper88fe6e0ad041\InternalAnnotations\FooInterface::class, ['constant' => ['FOO'], 'method' => ['foo', 'staticFoo']]], [\true, \_PhpScoper88fe6e0ad041\InternalAnnotations\InternalFooInterface::class, ['constant' => ['INTERNAL_FOO'], 'method' => ['internalFoo', 'internalStaticFoo']]], [\false, \_PhpScoper88fe6e0ad041\InternalAnnotations\FooTrait::class, ['method' => ['foo', 'staticFoo'], 'property' => ['foo', 'staticFoo']]], [\true, \_PhpScoper88fe6e0ad041\InternalAnnotations\InternalFooTrait::class, ['method' => ['internalFoo', 'internalStaticFoo'], 'property' => ['internalFoo', 'internalStaticFoo']]]];
    }
    /**
    ...
    public function testInternalUserFunctions() : void
    {
        ...
        /** @var Broker $broker */
        $broker = self::getContainer()->getByType(\PHPStan\Broker\Broker::class);
        $this->assertFalse($broker->getFunction(new \PhpParser\Node\Name\FullyQualified('_PhpScoper88fe6e0ad041\\InternalAnnotations\\foo'), null)->isInternal()->yes());
        $this->assertTrue($broker->getFunction(new \PhpParser\Node\Name\FullyQualified('_PhpScoper88fe6e0ad041\\InternalAnnotations\\internalFoo'), null)->isInternal()->yes());
    }
}
