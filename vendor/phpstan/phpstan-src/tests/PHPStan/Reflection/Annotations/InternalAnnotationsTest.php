...
class InternalAnnotationsTest extends \PHPStan\Testing\TestCase
{
    ...
    {
        return [[\false, \_PhpScopera143bcca66cb\InternalAnnotations\Foo::class, ['constant' => ['FOO'], 'method' => ['foo', 'staticFoo'], 'property' => ['foo', 'staticFoo']]], [\true, \_PhpScopera143bcca66cb\InternalAnnotations\InternalFoo::class, ['constant' => ['INTERNAL_FOO'], 'method' => ['internalFoo', 'internalStaticFoo'], 'property' => ['internalFoo', 'internalStaticFoo']]], [\false, \_PhpScopera143bcca66cb\InternalAnnotations\FooInterface::class, ['constant' => ['FOO'], 'method' => ['foo', 'staticFoo']]], [\true, \_PhpScopera143bcca66cb\InternalAnnotations\InternalFooInterface::class, ['constant' => ['INTERNAL_FOO'], 'method' => ['internalFoo', 'internalStaticFoo']]], [\false, \_PhpScopera143bcca66cb\InternalAnnotations\FooTrait::class, ['method' => ['foo', 'staticFoo'], 'property' => ['foo', 'staticFoo']]], [\true, \_PhpScopera143bcca66cb\InternalAnnotations\InternalFooTrait::class, ['method' => ['internalFoo', 'internalStaticFoo'], 'property' => ['internalFoo', 'internalStaticFoo']]]];
    }
    /**
    ...
    public function testInternalUserFunctions() : void
    {
        ...
        /** @var Broker $broker */
        $broker = self::getContainer()->getByType(\PHPStan\Broker\Broker::class);
        $this->assertFalse($broker->getFunction(new \PhpParser\Node\Name\FullyQualified('_PhpScopera143bcca66cb\\InternalAnnotations\\foo'), null)->isInternal()->yes());
        $this->assertTrue($broker->getFunction(new \PhpParser\Node\Name\FullyQualified('_PhpScopera143bcca66cb\\InternalAnnotations\\internalFoo'), null)->isInternal()->yes());
    }
}
