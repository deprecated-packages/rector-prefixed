...
class DeprecatedAnnotationsTest extends \PHPStan\Testing\TestCase
{
    ...
    {
        return [[\false, \_PhpScoper26e51eeacccf\DeprecatedAnnotations\Foo::class, null, ['constant' => ['FOO' => null], 'method' => ['foo' => null, 'staticFoo' => null], 'property' => ['foo' => null, 'staticFoo' => null]]], [\true, \_PhpScoper26e51eeacccf\DeprecatedAnnotations\DeprecatedFoo::class, 'in 1.0.0.', ['constant' => ['DEPRECATED_FOO' => 'Deprecated constant.'], 'method' => ['deprecatedFoo' => 'method.', 'deprecatedStaticFoo' => 'static method.'], 'property' => ['deprecatedFoo' => null, 'deprecatedStaticFoo' => null]]], [\false, \_PhpScoper26e51eeacccf\DeprecatedAnnotations\FooInterface::class, null, ['constant' => ['FOO' => null], 'method' => ['foo' => null, 'staticFoo' => null]]], [\true, \_PhpScoper26e51eeacccf\DeprecatedAnnotations\DeprecatedWithMultipleTags::class, "in Foo 1.1.0 and will be removed in 1.5.0, use\n\\Foo\\Bar\\NotDeprecated instead.", ['method' => ['deprecatedFoo' => "in Foo 1.1.0, will be removed in Foo 1.5.0, use\n\\Foo\\Bar\\NotDeprecated::replacementFoo() instead."]]]];
    }
    /**
    ...
    public function testDeprecatedUserFunctions() : void
    {
        ...
        /** @var Broker $broker */
        $broker = self::getContainer()->getByType(\PHPStan\Broker\Broker::class);
        $this->assertFalse($broker->getFunction(new \PhpParser\Node\Name\FullyQualified('_PhpScoper26e51eeacccf\\DeprecatedAnnotations\\foo'), null)->isDeprecated()->yes());
        $this->assertTrue($broker->getFunction(new \PhpParser\Node\Name\FullyQualified('_PhpScoper26e51eeacccf\\DeprecatedAnnotations\\deprecatedFoo'), null)->isDeprecated()->yes());
    }
