...
class ThrowsAnnotationsTest extends \PHPStan\Testing\TestCase
{
    ...
    {
        return [[\_PhpScopera143bcca66cb\ThrowsAnnotations\Foo::class, ['withoutThrows' => null, 'throwsRuntime' => \RuntimeException::class, 'staticThrowsRuntime' => \RuntimeException::class]], [\_PhpScopera143bcca66cb\ThrowsAnnotations\PhpstanFoo::class, ['withoutThrows' => 'void', 'throwsRuntime' => \RuntimeException::class, 'staticThrowsRuntime' => \RuntimeException::class]], [\_PhpScopera143bcca66cb\ThrowsAnnotations\FooInterface::class, ['withoutThrows' => null, 'throwsRuntime' => \RuntimeException::class, 'staticThrowsRuntime' => \RuntimeException::class]], [\_PhpScopera143bcca66cb\ThrowsAnnotations\FooTrait::class, ['withoutThrows' => null, 'throwsRuntime' => \RuntimeException::class, 'staticThrowsRuntime' => \RuntimeException::class]], [\_PhpScopera143bcca66cb\ThrowsAnnotations\BarTrait::class, ['withoutThrows' => null, 'throwsRuntime' => \RuntimeException::class, 'staticThrowsRuntime' => \RuntimeException::class]]];
    }
    /**
    ...
    public function testThrowsOnUserFunctions() : void
    {
        ...
        /** @var Broker $broker */
        $broker = self::getContainer()->getByType(\PHPStan\Broker\Broker::class);
        $this->assertNull($broker->getFunction(new \PhpParser\Node\Name\FullyQualified('_PhpScopera143bcca66cb\\ThrowsAnnotations\\withoutThrows'), null)->getThrowType());
        $throwType = $broker->getFunction(new \PhpParser\Node\Name\FullyQualified('_PhpScopera143bcca66cb\\ThrowsAnnotations\\throwsRuntime'), null)->getThrowType();
