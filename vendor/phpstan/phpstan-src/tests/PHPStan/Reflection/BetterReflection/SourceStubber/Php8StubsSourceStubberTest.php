...
class Php8StubsSourceStubberTest extends \_PhpScoper006a73f0e455\PHPUnit\Framework\TestCase
{
    ...
    private function getReflectors() : array
    {
        ...
        $astLocator = new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Ast\Locator($parser, static function () use(&$functionReflector) : FunctionReflector {
            return $functionReflector;
        });
        $sourceStubber = new \PHPStan\Reflection\BetterReflection\SourceStubber\Php8StubsSourceStubber();
        $phpInternalSourceLocator = new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\PhpInternalSourceLocator($astLocator, $sourceStubber);
        $classReflector = new \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\ClassReflector($phpInternalSourceLocator);
        $functionReflector = new \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\FunctionReflector($phpInternalSourceLocator, $classReflector);
