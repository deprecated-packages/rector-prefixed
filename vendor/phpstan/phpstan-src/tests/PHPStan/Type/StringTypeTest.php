...
class StringTypeTest extends \PHPStan\Testing\TestCase
{
    ...
    {
        (yield [new \PHPStan\Type\StringType(), new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScoperabd03f0baf05\Test\ClassWithToString::class), new \PHPStan\Type\Accessory\HasPropertyType('foo')]), \PHPStan\TrinaryLogic::createNo()]);
