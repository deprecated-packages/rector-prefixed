...
class IntersectionTypeTest extends \PHPStan\Testing\TestCase
{
    public function dataAccepts() : \Iterator
    {
        ...
        (yield [new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\Test\ClassWithToString::class), new \PHPStan\Type\Accessory\HasPropertyType('foo')]), new \PHPStan\Type\StringType(), \PHPStan\TrinaryLogic::createNo()]);
    ...
    public function dataIsSuperTypeOf() : \Iterator
    {
        ...
        (yield [new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\DoctrineIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(\true), new \PHPStan\Type\ObjectType(\stdClass::class))]), new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\DoctrineIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(\true), new \PHPStan\Type\ObjectType(\stdClass::class))]), \PHPStan\TrinaryLogic::createYes()]);
        (yield [new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\TestIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(\true), new \PHPStan\Type\ObjectType(\stdClass::class))]), new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\TestIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(\true), new \PHPStan\Type\ObjectType(\stdClass::class))]), \PHPStan\TrinaryLogic::createYes()]);
        (yield [new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\DoctrineIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(\true), new \PHPStan\Type\ObjectType(\stdClass::class))]), new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\DoctrineIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(), new \PHPStan\Type\ObjectType(\stdClass::class))]), \PHPStan\TrinaryLogic::createYes()]);
        (yield [new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\DoctrineIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(), new \PHPStan\Type\ObjectType(\stdClass::class))]), new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\DoctrineIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(\true), new \PHPStan\Type\ObjectType(\stdClass::class))]), \PHPStan\TrinaryLogic::createYes()]);
        (yield [new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\DoctrineIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(), new \PHPStan\Type\ObjectType(\stdClass::class))]), new \PHPStan\Type\IntersectionType([new \PHPStan\Type\ObjectType(\_PhpScopera143bcca66cb\DoctrineIntersectionTypeIsSupertypeOf\Collection::class), new \PHPStan\Type\IterableType(new \PHPStan\Type\MixedType(), new \PHPStan\Type\ObjectType(\stdClass::class))]), \PHPStan\TrinaryLogic::createYes()]);
    }
    /**
