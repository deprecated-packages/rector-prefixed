...
class FileTypeMapperTest extends \PHPStan\Testing\TestCase
{
    public function testGetResolvedPhpDoc() : void
    {
        ...
        $fileTypeMapper = self::getContainer()->getByType(\PHPStan\Type\FileTypeMapper::class);
 ...
 */');
        ...
        $this->assertSame('float|int', $resolvedA->getPropertyTags()['numericBazBazProperty']->getType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        $this->assertSame('X', $resolvedA->getPropertyTags()['singleLetterObjectName']->getType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('void', $simpleMethod->getReturnType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('string', $returningMethod->getReturnType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('float|null', $returningNullableScalar->getReturnType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('stdClass|null', $returningNullableObject->getReturnType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('Image', $rotate->getReturnType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        $this->assertFalse($rotate->isStatic());
        $this->assertCount(2, $rotate->getParameters());
        $this->assertSame('float', $rotate->getParameters()['angle']->getType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('mixed', $rotate->getParameters()['backgroundColor']->getType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('float|int', $paramMultipleTypesWithExtraSpaces->getReturnType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('string|null', $paramMultipleTypesWithExtraSpaces->getParameters()['string']->getType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
        ...
        $this->assertSame('stdClass|null', $paramMultipleTypesWithExtraSpaces->getParameters()['object']->getType()->describe(\PHPStan\Type\VerbosityLevel::precise()));
    ...
    public function testFileWithDependentPhpDocs() : void
    {
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoperabd03f0baf05\DependentPhpDocs\Foo::class, null, 'addPages', '/** @param Foo[]|Foo|\\Iterator $pages */');
    ...
    public function testFileThrowsPhpDocs() : void
    {
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoperabd03f0baf05\ThrowsPhpDocs\Foo::class, null, 'throwRuntimeException', '/**
 ...
 */');
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoperabd03f0baf05\ThrowsPhpDocs\Foo::class, null, 'throwRuntimeAndLogicException', '/**
 ...
 */');
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoperabd03f0baf05\ThrowsPhpDocs\Foo::class, null, 'throwRuntimeAndLogicException2', '/**
 * @throws RuntimeException
 ...
 */');
    ...
    public function testFileWithCyclicPhpDocs() : void
    {
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoperabd03f0baf05\CyclicPhpDocs\Foo::class, null, 'getIterator', '/** @return iterable<Foo> | Foo */');
