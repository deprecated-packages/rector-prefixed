 ...
 */');
    ...
    public function testFileWithDependentPhpDocs() : void
    {
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoper006a73f0e455\DependentPhpDocs\Foo::class, null, 'addPages', '/** @param Foo[]|Foo|\\Iterator $pages */');
    ...
    public function testFileThrowsPhpDocs() : void
    {
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoper006a73f0e455\ThrowsPhpDocs\Foo::class, null, 'throwRuntimeException', '/**
 ...
 */');
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoper006a73f0e455\ThrowsPhpDocs\Foo::class, null, 'throwRuntimeAndLogicException', '/**
 ...
 */');
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoper006a73f0e455\ThrowsPhpDocs\Foo::class, null, 'throwRuntimeAndLogicException2', '/**
 * @throws RuntimeException
 ...
 */');
    ...
    public function testFileWithCyclicPhpDocs() : void
    {
        ...
        $resolved = $fileTypeMapper->getResolvedPhpDoc($realpath, \_PhpScoper006a73f0e455\CyclicPhpDocs\Foo::class, null, 'getIterator', '/** @return iterable<Foo> | Foo */');
