 ...
 * @group exec
 */
class TraitsCachingIssueIntegrationTest extends \PHPStan\Testing\TestCase
{
    /** @var string|null */
    ...
    private function runPhpStan() : array
    {
        ...
        $json = \_PhpScoper26e51eeacccf\Nette\Utils\Json::decode($stringOutput, \_PhpScoper26e51eeacccf\Nette\Utils\Json::FORCE_ARRAY);
    ...
    {
        $originalTraitContents = \PHPStan\File\FileReader::read($traitPath);
