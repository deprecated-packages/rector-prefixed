...
class AnalyserIntegrationTest extends \PHPStan\Testing\TestCase
{
    ...
    public function testExtendingKnownClassWithCheck() : void
    {
        ...
        $this->assertTrue($broker->hasClass(\_PhpScopera143bcca66cb\ExtendingKnownClassWithCheck\Foo::class));
    }
    ...
    private function runAnalyse(string $file) : array
    {
        ...
        $analyser = self::getContainer()->getByType(\PHPStan\Analyser\Analyser::class);
