...
// lint >= 8.0
namespace _PhpScoperabd03f0baf05\PromotedPropertiesTypes;
...
function (\_PhpScoperabd03f0baf05\PromotedPropertiesTypes\Foo $foo) : void {
 ...
 */
class Bar extends \_PhpScoperabd03f0baf05\PromotedPropertiesTypes\Foo
{
}
function (\_PhpScoperabd03f0baf05\PromotedPropertiesTypes\Bar $bar) : void {
...
function () : void {
    $lorem = new \_PhpScoperabd03f0baf05\PromotedPropertiesTypes\Lorem(new \stdClass());
    \PHPStan\Analyser\assertType('stdClass', $lorem->foo);
};
/**
 * @extends Foo<\stdClass>
 */
class Baz extends \_PhpScoperabd03f0baf05\PromotedPropertiesTypes\Foo
{
...
function (\_PhpScoperabd03f0baf05\PromotedPropertiesTypes\Baz $baz) : void {
