...
$strtotimeUnknown = \strtotime(\_PhpScoper006a73f0e455\doFoo() ? 'now' : '4 qm');
$strtotimeUnknown2 = \strtotime($undefined);
$strtotimeCrash = \strtotime();
$versionCompare1 = \version_compare('7.0.0', '7.0.1');
$versionCompare2 = \version_compare('7.0.0', \_PhpScoper006a73f0e455\doFoo() ? '7.0.1' : '6.0.0');
$versionCompare3 = \version_compare(\_PhpScoper006a73f0e455\doFoo() ? '7.0.0' : '6.0.5', \_PhpScoper006a73f0e455\doBar() ? '7.0.1' : '6.0.0');
$versionCompare4 = \version_compare('7.0.0', \_PhpScoper006a73f0e455\doFoo());
$versionCompare5 = \version_compare('7.0.0', '7.0.1', '<');
$versionCompare6 = \version_compare('7.0.0', \_PhpScoper006a73f0e455\doFoo() ? '7.0.1' : '6.0.0', '<');
$versionCompare7 = \version_compare(\_PhpScoper006a73f0e455\doFoo() ? '7.0.0' : '6.0.5', \_PhpScoper006a73f0e455\doBar() ? '7.0.1' : '6.0.0', '<');
$versionCompare8 = \version_compare('7.0.0', \_PhpScoper006a73f0e455\doFoo(), '<');
...
$mbStrlenWithValidAndInvalidEncoding = \mb_strlen('', \_PhpScoper006a73f0e455\doFoo() ? 'utf-8' : 'foo');
$mbStrlenWithUnknownEncoding = \mb_strlen('', \_PhpScoper006a73f0e455\doFoo());
...
$mbHttpOutputWithValidAndInvalidEncoding = \mb_http_output(\_PhpScoper006a73f0e455\doFoo() ? 'utf-8' : 'foo');
$mbHttpOutputWithUnknownEncoding = \mb_http_output(\_PhpScoper006a73f0e455\doFoo());
...
$mbRegexEncodingWithValidAndInvalidEncoding = \mb_regex_encoding(\_PhpScoper006a73f0e455\doFoo() ? 'utf8' : 'foo');
$mbRegexEncodingWithUnknownEncoding = \mb_regex_encoding(\_PhpScoper006a73f0e455\doFoo());
...
$mbInternalEncodingWithValidAndInvalidEncoding = \mb_internal_encoding(\_PhpScoper006a73f0e455\doFoo() ? 'utf-8' : 'foo');
$mbInternalEncodingWithUnknownEncoding = \mb_internal_encoding(\_PhpScoper006a73f0e455\doFoo());
$mbEncodingAliasesWithValidEncoding = \mb_encoding_aliases('utf-8');
$mbEncodingAliasesWithInvalidEncoding = \mb_encoding_aliases('foo');
$mbEncodingAliasesWithValidAndInvalidEncoding = \mb_encoding_aliases(\_PhpScoper006a73f0e455\doFoo() ? 'utf-8' : 'foo');
$mbEncodingAliasesWithUnknownEncoding = \mb_encoding_aliases(\_PhpScoper006a73f0e455\doFoo());
$mbChrWithoutEncoding = \mb_chr(68);
$mbChrWithValidEncoding = \mb_chr(68, 'utf-8');
$mbChrWithInvalidEncoding = \mb_chr(68, 'foo');
$mbChrWithValidAndInvalidEncoding = \mb_chr(68, \_PhpScoper006a73f0e455\doFoo() ? 'utf-8' : 'foo');
$mbChrWithUnknownEncoding = \mb_chr(68, \_PhpScoper006a73f0e455\doFoo());
$mbOrdWithoutEncoding = \mb_ord('');
$mbOrdWithValidEncoding = \mb_ord('', 'utf-8');
$mbOrdWithInvalidEncoding = \mb_ord('', 'foo');
$mbOrdWithValidAndInvalidEncoding = \mb_ord('', \_PhpScoper006a73f0e455\doFoo() ? 'utf-8' : 'foo');
$mbOrdWithUnknownEncoding = \mb_ord('', \_PhpScoper006a73f0e455\doFoo());
...
$strSplitConstantStringWithVariableStringAndConstantSplitLength = \str_split(\_PhpScoper006a73f0e455\doFoo() ? 'abcdef' : 'ghijkl', 1);
$strSplitConstantStringWithVariableStringAndVariableSplitLength = \str_split(\_PhpScoper006a73f0e455\doFoo() ? 'abcdef' : 'ghijkl', \_PhpScoper006a73f0e455\doFoo() ? 1 : 2);
// parse_url
/** @var int $integer */
...
$resource = \_PhpScoper006a73f0e455\doFoo();
$stat = \stat(__FILE__);
