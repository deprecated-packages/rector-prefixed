...
$strtotimeUnknown = \strtotime(\_PhpScoperbd5d0c5f7638\doFoo() ? 'now' : '4 qm');
$strtotimeUnknown2 = \strtotime($undefined);
$strtotimeCrash = \strtotime();
$versionCompare1 = \version_compare('7.0.0', '7.0.1');
$versionCompare2 = \version_compare('7.0.0', \_PhpScoperbd5d0c5f7638\doFoo() ? '7.0.1' : '6.0.0');
$versionCompare3 = \version_compare(\_PhpScoperbd5d0c5f7638\doFoo() ? '7.0.0' : '6.0.5', \_PhpScoperbd5d0c5f7638\doBar() ? '7.0.1' : '6.0.0');
$versionCompare4 = \version_compare('7.0.0', \_PhpScoperbd5d0c5f7638\doFoo());
$versionCompare5 = \version_compare('7.0.0', '7.0.1', '<');
$versionCompare6 = \version_compare('7.0.0', \_PhpScoperbd5d0c5f7638\doFoo() ? '7.0.1' : '6.0.0', '<');
$versionCompare7 = \version_compare(\_PhpScoperbd5d0c5f7638\doFoo() ? '7.0.0' : '6.0.5', \_PhpScoperbd5d0c5f7638\doBar() ? '7.0.1' : '6.0.0', '<');
$versionCompare8 = \version_compare('7.0.0', \_PhpScoperbd5d0c5f7638\doFoo(), '<');
...
$mbStrlenWithValidAndInvalidEncoding = \mb_strlen('', \_PhpScoperbd5d0c5f7638\doFoo() ? 'utf-8' : 'foo');
$mbStrlenWithUnknownEncoding = \mb_strlen('', \_PhpScoperbd5d0c5f7638\doFoo());
...
$mbHttpOutputWithValidAndInvalidEncoding = \mb_http_output(\_PhpScoperbd5d0c5f7638\doFoo() ? 'utf-8' : 'foo');
$mbHttpOutputWithUnknownEncoding = \mb_http_output(\_PhpScoperbd5d0c5f7638\doFoo());
...
$mbRegexEncodingWithValidAndInvalidEncoding = \mb_regex_encoding(\_PhpScoperbd5d0c5f7638\doFoo() ? 'utf8' : 'foo');
$mbRegexEncodingWithUnknownEncoding = \mb_regex_encoding(\_PhpScoperbd5d0c5f7638\doFoo());
...
$mbInternalEncodingWithValidAndInvalidEncoding = \mb_internal_encoding(\_PhpScoperbd5d0c5f7638\doFoo() ? 'utf-8' : 'foo');
$mbInternalEncodingWithUnknownEncoding = \mb_internal_encoding(\_PhpScoperbd5d0c5f7638\doFoo());
$mbEncodingAliasesWithValidEncoding = \mb_encoding_aliases('utf-8');
$mbEncodingAliasesWithInvalidEncoding = \mb_encoding_aliases('foo');
$mbEncodingAliasesWithValidAndInvalidEncoding = \mb_encoding_aliases(\_PhpScoperbd5d0c5f7638\doFoo() ? 'utf-8' : 'foo');
$mbEncodingAliasesWithUnknownEncoding = \mb_encoding_aliases(\_PhpScoperbd5d0c5f7638\doFoo());
$mbChrWithoutEncoding = \mb_chr(68);
$mbChrWithValidEncoding = \mb_chr(68, 'utf-8');
$mbChrWithInvalidEncoding = \mb_chr(68, 'foo');
$mbChrWithValidAndInvalidEncoding = \mb_chr(68, \_PhpScoperbd5d0c5f7638\doFoo() ? 'utf-8' : 'foo');
$mbChrWithUnknownEncoding = \mb_chr(68, \_PhpScoperbd5d0c5f7638\doFoo());
$mbOrdWithoutEncoding = \mb_ord('');
$mbOrdWithValidEncoding = \mb_ord('', 'utf-8');
$mbOrdWithInvalidEncoding = \mb_ord('', 'foo');
$mbOrdWithValidAndInvalidEncoding = \mb_ord('', \_PhpScoperbd5d0c5f7638\doFoo() ? 'utf-8' : 'foo');
$mbOrdWithUnknownEncoding = \mb_ord('', \_PhpScoperbd5d0c5f7638\doFoo());
...
$strSplitConstantStringWithVariableStringAndConstantSplitLength = \str_split(\_PhpScoperbd5d0c5f7638\doFoo() ? 'abcdef' : 'ghijkl', 1);
$strSplitConstantStringWithVariableStringAndVariableSplitLength = \str_split(\_PhpScoperbd5d0c5f7638\doFoo() ? 'abcdef' : 'ghijkl', \_PhpScoperbd5d0c5f7638\doFoo() ? 1 : 2);
// parse_url
/** @var int $integer */
