...
namespace _PhpScoper006a73f0e455\InstanceOfNamespace;
...
class Foo extends \_PhpScoper006a73f0e455\InstanceOfNamespace\BarParent
{
    public function someMethod(\PhpParser\Node\Expr $foo)
    {
        $bar = $foo;
        $baz = doFoo();
        $intersected = new \_PhpScoper006a73f0e455\InstanceOfNamespace\Foo();
        $parent = doFoo();
        if ($baz instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Foo) {
            // ...
        } else {
            while ($foo instanceof \PhpParser\Node\Expr\ArrayDimFetch) {
                \assert($lorem instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Lorem);
                if ($dolor instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Dolor && $sit instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Sit) {
                    if ($static instanceof static) {
                        if ($self instanceof self) {
                            if ($intersected instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\BarInterface) {
                                if ($this instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\BarInterface) {
                                    if ($parent instanceof parent) {
                                        ...
                                        \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\Lorem', $lorem);
                                        \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\Dolor', $dolor);
                                        \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\Sit', $sit);
                                        \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\Foo', $self);
                                        ...
                                        \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarInterface&InstanceOfNamespace\\Foo', $intersected);
                                        \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\$this(InstanceOfNamespace\\Foo)&InstanceOfNamespace\\BarInterface', $this);
                                        \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarParent', $parent);
                                    }
                                }
                            }
                        }
    ...
    public function testExprInstanceof($subject, string $classString, $union, $intersection, string $other, $instance, $objectT, $objectTString, $mixedTString, string $string, $object)
    {
        ...
        if ($subject instanceof $classString) {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\Foo', $subject);
            \PHPStan\Analyser\assertType('true', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Foo);
            \PHPStan\Analyser\assertType('bool', $subject instanceof $classString);
        } else {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\mixed~InstanceOfNamespace\\Foo', $subject);
            \PHPStan\Analyser\assertType('false', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Foo);
            \PHPStan\Analyser\assertType('false', $subject instanceof $classString);
        }
        $constantString = '_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarParent';
        \PHPStan\Analyser\assertType('bool', $subject instanceof $constantString);
        if ($subject instanceof $constantString) {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarParent', $subject);
            \PHPStan\Analyser\assertType('true', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\BarParent);
            \PHPStan\Analyser\assertType('true', $subject instanceof $constantString);
        } else {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\mixed~InstanceOfNamespace\\BarParent', $subject);
            \PHPStan\Analyser\assertType('false', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\BarParent);
        ...
        if ($subject instanceof $union) {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarInterface|InstanceOfNamespace\\Foo', $subject);
            \PHPStan\Analyser\assertType('bool', $subject instanceof $union);
            \PHPStan\Analyser\assertType('bool', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\BarInterface);
            \PHPStan\Analyser\assertType('bool', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Foo);
            \PHPStan\Analyser\assertType('true', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Foo || $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\BarInterface);
        }
        if ($subject instanceof $intersection) {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarInterface&InstanceOfNamespace\\Foo', $subject);
            \PHPStan\Analyser\assertType('bool', $subject instanceof $intersection);
            \PHPStan\Analyser\assertType('true', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\BarInterface);
            \PHPStan\Analyser\assertType('true', $subject instanceof \_PhpScoper006a73f0e455\InstanceOfNamespace\Foo);
        }
        if ($subject instanceof $instance) {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarInterface', $subject);
        ...
        if ($object instanceof $classString) {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\Foo', $object);
            \PHPStan\Analyser\assertType('bool', $object instanceof $classString);
        } else {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\object~InstanceOfNamespace\\Foo', $object);
            \PHPStan\Analyser\assertType('false', $object instanceof $classString);
        }
        if ($instance instanceof $string) {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarInterface', $instance);
        ...
        if ($instance instanceof $classString) {
            \PHPStan\Analyser\assertType('_PhpScoper006a73f0e455\\InstanceOfNamespace\\BarInterface&InstanceOfNamespace\\Foo', $instance);
