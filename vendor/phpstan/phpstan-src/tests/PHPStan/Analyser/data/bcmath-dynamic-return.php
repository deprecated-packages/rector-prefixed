...
/** @var mixed $mixed */
$mixed = \_PhpScoper26e51eeacccf\getMixed();
/** @var int $iUnknown */
$iUnknown = \_PhpScoper26e51eeacccf\getInt();
/** @var string $string */
$string = \_PhpScoper26e51eeacccf\getString();
$iNeg = -5;
$iPos = 5;
$nonNumeric = 'foo';
...
\PHPStan\Analyser\assertType('null', \bcdiv('10', '0'));
// Warning: Division by zero
\PHPStan\Analyser\assertType('null', \bcdiv('10', '0.0'));
// Warning: Division by zero
\PHPStan\Analyser\assertType('null', \bcdiv('10', 0.0));
// Warning: Division by zero
...
\PHPStan\Analyser\assertType('null', \bcdiv('10', $iPos, $nonNumeric));
// Warning: expects parameter 3 to be int, string given in
\PHPStan\Analyser\assertType('null', \bcdiv('10', $nonNumeric));
...
\PHPStan\Analyser\assertType('null', \bcmod($iPos, '0'));
// Warning: Division by zero
...
\PHPStan\Analyser\assertType('false', \bcpowmod('10', '-2', '0'));
// exponent negative, and modulus is 0
\PHPStan\Analyser\assertType('false', \bcpowmod('10', '-2', '1'));
// exponent negative
\PHPStan\Analyser\assertType('false', \bcpowmod('10', '2', $nonNumeric));
// Warning: bcmath function argument is not well-formed
\PHPStan\Analyser\assertType('false', \bcpowmod('10', '-2', '-1'));
// exponent negative
\PHPStan\Analyser\assertType('false', \bcpowmod('10', '-2', -1.3));
// exponent negative
\PHPStan\Analyser\assertType('false', \bcpowmod('10', -$iPos, '-1'));
// exponent negative
\PHPStan\Analyser\assertType('false', \bcpowmod('10', -$iPos, '1'));
// exponent negative
\PHPStan\Analyser\assertType('false', \bcpowmod('10', $nonNumeric, $nonNumeric));
// Warning: bcmath function argument is not well-formed
\PHPStan\Analyser\assertType('false', \bcpowmod($iPos, $nonNumeric, $nonNumeric));
\PHPStan\Analyser\assertType('false', \bcpowmod('10', '2', '0'));
// modulus is 0
\PHPStan\Analyser\assertType('false', \bcpowmod('10', 2.3, '0'));
// modulus is 0
\PHPStan\Analyser\assertType('false', \bcpowmod('10', '0', '0'));
// modulus is 0
...
\PHPStan\Analyser\assertType('string', \bcpowmod('10', $nonNumeric, '2'));
// Warning: bcmath function argument is not well-formed
...
\PHPStan\Analyser\assertType('null', \bcsqrt('-10', 0));
// Warning: Square root of negative number
\PHPStan\Analyser\assertType('null', \bcsqrt($iNeg, 0));
\PHPStan\Analyser\assertType('null', \bcsqrt('10', $nonNumeric));
...
\PHPStan\Analyser\assertType('null', \bcsqrt('-10'));
// Warning: Square root of negative number
\PHPStan\Analyser\assertType('string|null', \bcsqrt($nonNumeric, -1));
// Warning: bcmath function argument is not well-formed
