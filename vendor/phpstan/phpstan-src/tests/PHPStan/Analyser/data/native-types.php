...
namespace _PhpScopera143bcca66cb\NativeTypes;
...
class Foo
{
    ...
    {
        \PHPStan\Analyser\assertType(\_PhpScopera143bcca66cb\NativeTypes\Foo::class, $foo);
        \PHPStan\Analyser\assertNativeType('mixed', $foo);
        // change type after assignment
        $foo = new \_PhpScopera143bcca66cb\NativeTypes\Foo();
        \PHPStan\Analyser\assertType(\_PhpScopera143bcca66cb\NativeTypes\Foo::class, $foo);
        \PHPStan\Analyser\assertNativeType(\_PhpScopera143bcca66cb\NativeTypes\Foo::class, $foo);
        ...
        $f = function (\_PhpScopera143bcca66cb\NativeTypes\Foo $foo) use($dateTime) {
            \PHPStan\Analyser\assertType(\_PhpScopera143bcca66cb\NativeTypes\Foo::class, $foo);
            \PHPStan\Analyser\assertNativeType(\_PhpScopera143bcca66cb\NativeTypes\Foo::class, $foo);
            \PHPStan\Analyser\assertType(\DateTimeImmutable::class, $dateTime);
            \PHPStan\Analyser\assertNativeType(\DateTimeInterface::class, $dateTime);
