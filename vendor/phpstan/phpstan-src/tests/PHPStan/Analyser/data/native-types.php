...
namespace _PhpScoper26e51eeacccf\NativeTypes;
...
class Foo
{
    ...
    {
        \PHPStan\Analyser\assertType(\_PhpScoper26e51eeacccf\NativeTypes\Foo::class, $foo);
        \PHPStan\Analyser\assertNativeType('mixed', $foo);
        // change type after assignment
        $foo = new \_PhpScoper26e51eeacccf\NativeTypes\Foo();
        \PHPStan\Analyser\assertType(\_PhpScoper26e51eeacccf\NativeTypes\Foo::class, $foo);
        \PHPStan\Analyser\assertNativeType(\_PhpScoper26e51eeacccf\NativeTypes\Foo::class, $foo);
        ...
        $f = function (\_PhpScoper26e51eeacccf\NativeTypes\Foo $foo) use($dateTime) {
            \PHPStan\Analyser\assertType(\_PhpScoper26e51eeacccf\NativeTypes\Foo::class, $foo);
            \PHPStan\Analyser\assertNativeType(\_PhpScoper26e51eeacccf\NativeTypes\Foo::class, $foo);
            \PHPStan\Analyser\assertType(\DateTimeImmutable::class, $dateTime);
            \PHPStan\Analyser\assertNativeType(\DateTimeInterface::class, $dateTime);
