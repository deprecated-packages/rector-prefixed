...
namespace _PhpScoperabd03f0baf05\NativeTypes;
...
class Foo
{
    ...
    {
        \PHPStan\Analyser\assertType(\_PhpScoperabd03f0baf05\NativeTypes\Foo::class, $foo);
        \PHPStan\Analyser\assertNativeType('mixed', $foo);
        // change type after assignment
        $foo = new \_PhpScoperabd03f0baf05\NativeTypes\Foo();
        \PHPStan\Analyser\assertType(\_PhpScoperabd03f0baf05\NativeTypes\Foo::class, $foo);
        \PHPStan\Analyser\assertNativeType(\_PhpScoperabd03f0baf05\NativeTypes\Foo::class, $foo);
        ...
        $f = function (\_PhpScoperabd03f0baf05\NativeTypes\Foo $foo) use($dateTime) {
            \PHPStan\Analyser\assertType(\_PhpScoperabd03f0baf05\NativeTypes\Foo::class, $foo);
            \PHPStan\Analyser\assertNativeType(\_PhpScoperabd03f0baf05\NativeTypes\Foo::class, $foo);
            \PHPStan\Analyser\assertType(\DateTimeImmutable::class, $dateTime);
            \PHPStan\Analyser\assertNativeType(\DateTimeInterface::class, $dateTime);
