 ...
 */
class InvalidAssignVarRuleTest extends \PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \PHPStan\Rules\Rule
    {
        return new \PHPStan\Rules\Operators\InvalidAssignVarRule(new \PHPStan\Rules\NullsafeCheck());
    }
