...
class CallMethodsRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    protected function getRule() : \PHPStan\Rules\Rule
    {
        ...
        $ruleLevelHelper = new \PHPStan\Rules\RuleLevelHelper($broker, $this->checkNullables, $this->checkThisOnly, $this->checkUnionTypes, $this->checkExplicitMixed);
        return new \PHPStan\Rules\Methods\CallMethodsRule($broker, new \PHPStan\Rules\FunctionCallParametersCheck($ruleLevelHelper, new \PHPStan\Rules\NullsafeCheck(), new \PHPStan\Php\PhpVersion($this->phpVersion), \true, \true, \true, \true), $ruleLevelHelper, \true, \true);
    }
