 ...
 */
class OverridingMethodRuleTest extends \PHPStan\Testing\RuleTestCase
{
    /** @var int */
    private $phpVersionId;
    protected function getRule() : \PHPStan\Rules\Rule
    {
        return new \PHPStan\Rules\Methods\OverridingMethodRule(new \PHPStan\Php\PhpVersion($this->phpVersionId), new \PHPStan\Rules\Methods\MethodSignatureRule(\true, \true), \false);
    }
