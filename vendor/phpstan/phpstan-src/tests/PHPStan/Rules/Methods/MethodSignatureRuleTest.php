...
class MethodSignatureRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    {
        return new \PHPStan\Rules\Methods\OverridingMethodRule(new \PHPStan\Php\PhpVersion(\PHP_VERSION_ID), new \PHPStan\Rules\Methods\MethodSignatureRule($this->reportMaybes, $this->reportStatic), \true);
    }
