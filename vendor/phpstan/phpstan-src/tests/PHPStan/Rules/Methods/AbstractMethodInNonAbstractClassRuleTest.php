...
use _PhpScoper006a73f0e455\Bug3406\AbstractFoo;
use _PhpScoper006a73f0e455\Bug3406\ClassFoo;
...
class AbstractMethodInNonAbstractClassRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    public function testBug3406ReflectionCheck() : void
    {
        ...
        $reflection = $reflectionProvider->getClass(\_PhpScoper006a73f0e455\Bug3406\ClassFoo::class);
        $this->assertSame(\_PhpScoper006a73f0e455\Bug3406\AbstractFoo::class, $reflection->getNativeMethod('myFoo')->getDeclaringClass()->getName());
        $this->assertSame(\_PhpScoper006a73f0e455\Bug3406\ClassFoo::class, $reflection->getNativeMethod('myBar')->getDeclaringClass()->getName());
    }
