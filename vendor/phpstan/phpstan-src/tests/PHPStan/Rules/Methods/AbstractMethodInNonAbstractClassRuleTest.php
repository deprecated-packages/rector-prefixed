...
use _PhpScoperbd5d0c5f7638\Bug3406\AbstractFoo;
use _PhpScoperbd5d0c5f7638\Bug3406\ClassFoo;
...
class AbstractMethodInNonAbstractClassRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    public function testBug3406ReflectionCheck() : void
    {
        ...
        $reflection = $reflectionProvider->getClass(\_PhpScoperbd5d0c5f7638\Bug3406\ClassFoo::class);
        $this->assertSame(\_PhpScoperbd5d0c5f7638\Bug3406\AbstractFoo::class, $reflection->getNativeMethod('myFoo')->getDeclaringClass()->getName());
        $this->assertSame(\_PhpScoperbd5d0c5f7638\Bug3406\ClassFoo::class, $reflection->getNativeMethod('myBar')->getDeclaringClass()->getName());
    }
