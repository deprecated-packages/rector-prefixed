...
class Foo extends \_PhpScoper88fe6e0ad041\ReturnTypes\FooParent implements \_PhpScoper88fe6e0ad041\ReturnTypes\FooInterface
{
    ...
    public function returnObject() : \_PhpScoper88fe6e0ad041\ReturnTypes\Bar
    {
        if (\rand(0, 1)) {
            return 1;
        }
    ...
    public function returnInterface() : \_PhpScoper88fe6e0ad041\ReturnTypes\FooInterface
    {
        return new self();
    }
    /**
     ...
     * @return static
     */
    public function returnStatic() : \_PhpScoper88fe6e0ad041\ReturnTypes\FooParent
    {
        if (\rand(0, 1)) {
            return parent::returnStatic();
        }
        $parent = new \_PhpScoper88fe6e0ad041\ReturnTypes\FooParent();
        if (\rand(0, 1)) {
            return $parent->returnStatic();
    ...
    public function returnAlias() : \_PhpScoper88fe6e0ad041\ReturnTypes\Foo
    {
        return new \_PhpScoper88fe6e0ad041\ReturnTypes\FooAlias();
    }
    public function returnAnotherAlias() : \_PhpScoper88fe6e0ad041\ReturnTypes\FooAlias
    {
    ...
    public function returnUnionIterableType($collection)
    {
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoper88fe6e0ad041\ReturnTypes\Collection();
        }
        if (\rand(0, 1)) {
            return new self();
        }
    ...
    public function returnsParent() : \_PhpScoper88fe6e0ad041\parent
    {
        if (\rand(0, 1)) {
            return new \_PhpScoper88fe6e0ad041\ReturnTypes\FooParent();
        }
        if (\rand(0, 1)) {
            return 1;
        }
    ...
    public function misleadingBoolReturnType() : \_PhpScoper88fe6e0ad041\ReturnTypes\boolean
    {
        if (\rand(0, 1)) {
            return \true;
        }
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoper88fe6e0ad041\ReturnTypes\boolean();
        }
    }
    public function misleadingIntReturnType() : \_PhpScoper88fe6e0ad041\ReturnTypes\integer
    {
        if (\rand(0, 1)) {
            return 1;
        }
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoper88fe6e0ad041\ReturnTypes\integer();
        }
    }
    public function misleadingMixedReturnType() : mixed
    {
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoper88fe6e0ad041\ReturnTypes\mixed();
        }
    }
}
class FooChild extends \_PhpScoper88fe6e0ad041\ReturnTypes\Foo
{
}
class Stock
{
...
class ReturnTernary
{
     ...
     * @return Foo
     */
    public function returnTernary($fooOrFalse) : \_PhpScoper88fe6e0ad041\ReturnTypes\Foo
    {
        if (\rand(0, 1)) {
            return $fooOrFalse ?: new \_PhpScoper88fe6e0ad041\ReturnTypes\Foo();
        }
        if (\rand(0, 1)) {
            return $fooOrFalse !== \false ? $fooOrFalse : new \_PhpScoper88fe6e0ad041\ReturnTypes\Foo();
        }
        if (\rand(0, 1)) {
            $fooOrFalse ? $fooResult = $fooOrFalse : new \_PhpScoper88fe6e0ad041\ReturnTypes\Foo();
            return $fooResult;
        }
        if (\rand(0, 1)) {
...
class ArrayFillKeysIssue
{
    ...
    public function getIPs(array $stringIds)
    {
        ...
        foreach ($stringIds as $id) {
            $paired[$id][] = new \_PhpScoper88fe6e0ad041\ReturnTypes\Foo();
        }
        return $paired;
    }
    /**
    ...
    public function getIPs2(array $stringIds)
    {
        $paired = \array_fill_keys($stringIds, []);
        foreach ($stringIds as $id) {
            $paired[$id][] = new \_PhpScoper88fe6e0ad041\ReturnTypes\Bar();
        }
        return $paired;
    }
}
class AssertThisInstanceOf
{
    ...
    {
        \assert($this instanceof \_PhpScoper88fe6e0ad041\ReturnTypes\FooInterface);
        return $this;
    }
    /**
     * @return $this
    ...
    public function doBar()
    {
        ...
        \assert($otherInstance instanceof \_PhpScoper88fe6e0ad041\ReturnTypes\FooInterface);
...
class Foo2 extends \_PhpScoper88fe6e0ad041\ReturnTypes\FooParent implements \_PhpScoper88fe6e0ad041\ReturnTypes\FooInterface
{
...
class ClassThatImplementsInterfaceAndInheritDocsIt implements \_PhpScoper88fe6e0ad041\ReturnTypes\InterfaceThatWillBeDocInherited
{
    public function setTableSchema() : \_PhpScoper88fe6e0ad041\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * {@inheritDoc}
     */
    public function setTableSchema2() : \_PhpScoper88fe6e0ad041\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema3() : \_PhpScoper88fe6e0ad041\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema4() : \_PhpScoper88fe6e0ad041\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema5() : \_PhpScoper88fe6e0ad041\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
}
