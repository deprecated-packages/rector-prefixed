...
class Foo extends \_PhpScoperabd03f0baf05\ReturnTypes\FooParent implements \_PhpScoperabd03f0baf05\ReturnTypes\FooInterface
{
    ...
    public function returnObject() : \_PhpScoperabd03f0baf05\ReturnTypes\Bar
    {
        if (\rand(0, 1)) {
            return 1;
        }
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoperabd03f0baf05\ReturnTypes\Bar();
        }
    }
    public function returnChild() : self
    {
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoperabd03f0baf05\ReturnTypes\FooChild();
        }
        if (\rand(0, 1)) {
            return new \_PhpScoperabd03f0baf05\ReturnTypes\OtherInterfaceImpl();
        }
    }
    /**
     * @return string|null
    ...
    public function returnInterface() : \_PhpScoperabd03f0baf05\ReturnTypes\FooInterface
    {
        return new self();
    }
    /**
     ...
     * @return static
     */
    public function returnStatic() : \_PhpScoperabd03f0baf05\ReturnTypes\FooParent
    {
        if (\rand(0, 1)) {
            return parent::returnStatic();
        }
        $parent = new \_PhpScoperabd03f0baf05\ReturnTypes\FooParent();
        if (\rand(0, 1)) {
            return $parent->returnStatic();
    ...
    public function returnAlias() : \_PhpScoperabd03f0baf05\ReturnTypes\Foo
    {
        return new \_PhpScoperabd03f0baf05\ReturnTypes\FooAlias();
    }
    public function returnAnotherAlias() : \_PhpScoperabd03f0baf05\ReturnTypes\FooAlias
    {
        return new \_PhpScoperabd03f0baf05\ReturnTypes\Foo();
    }
    /**
    ...
    public function returnUnionIterableType($collection)
    {
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoperabd03f0baf05\ReturnTypes\Collection();
        }
        if (\rand(0, 1)) {
            return new self();
        }
    ...
    public function returnsParent() : \_PhpScoperabd03f0baf05\parent
    {
        if (\rand(0, 1)) {
            return new \_PhpScoperabd03f0baf05\ReturnTypes\FooParent();
        }
        if (\rand(0, 1)) {
            return 1;
        }
    ...
    public function misleadingBoolReturnType() : \_PhpScoperabd03f0baf05\ReturnTypes\boolean
    {
        if (\rand(0, 1)) {
            return \true;
        }
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoperabd03f0baf05\ReturnTypes\boolean();
        }
    }
    public function misleadingIntReturnType() : \_PhpScoperabd03f0baf05\ReturnTypes\integer
    {
        if (\rand(0, 1)) {
            return 1;
        }
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoperabd03f0baf05\ReturnTypes\integer();
        }
    }
    public function misleadingMixedReturnType() : mixed
    {
        ...
        if (\rand(0, 1)) {
            return new \_PhpScoperabd03f0baf05\ReturnTypes\mixed();
        }
    }
}
class FooChild extends \_PhpScoperabd03f0baf05\ReturnTypes\Foo
{
}
class Stock
{
...
class ReturnTernary
{
     ...
     * @return Foo
     */
    public function returnTernary($fooOrFalse) : \_PhpScoperabd03f0baf05\ReturnTypes\Foo
    {
        if (\rand(0, 1)) {
            return $fooOrFalse ?: new \_PhpScoperabd03f0baf05\ReturnTypes\Foo();
        }
        if (\rand(0, 1)) {
            return $fooOrFalse !== \false ? $fooOrFalse : new \_PhpScoperabd03f0baf05\ReturnTypes\Foo();
        }
        if (\rand(0, 1)) {
            $fooOrFalse ? $fooResult = $fooOrFalse : new \_PhpScoperabd03f0baf05\ReturnTypes\Foo();
            return $fooResult;
        }
        if (\rand(0, 1)) {
...
class ArrayFillKeysIssue
{
    ...
    public function getIPs(array $stringIds)
    {
        ...
        foreach ($stringIds as $id) {
            $paired[$id][] = new \_PhpScoperabd03f0baf05\ReturnTypes\Foo();
        }
        return $paired;
    }
    /**
    ...
    public function getIPs2(array $stringIds)
    {
        $paired = \array_fill_keys($stringIds, []);
        foreach ($stringIds as $id) {
            $paired[$id][] = new \_PhpScoperabd03f0baf05\ReturnTypes\Bar();
        }
        return $paired;
    }
}
class AssertThisInstanceOf
{
    ...
    {
        \assert($this instanceof \_PhpScoperabd03f0baf05\ReturnTypes\FooInterface);
        return $this;
    }
    /**
     * @return $this
    ...
    public function doBar()
    {
        ...
        \assert($otherInstance instanceof \_PhpScoperabd03f0baf05\ReturnTypes\FooInterface);
...
class Foo2 extends \_PhpScoperabd03f0baf05\ReturnTypes\FooParent implements \_PhpScoperabd03f0baf05\ReturnTypes\FooInterface
{
...
class ClassThatImplementsInterfaceAndInheritDocsIt implements \_PhpScoperabd03f0baf05\ReturnTypes\InterfaceThatWillBeDocInherited
{
    public function setTableSchema() : \_PhpScoperabd03f0baf05\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * {@inheritDoc}
     */
    public function setTableSchema2() : \_PhpScoperabd03f0baf05\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema3() : \_PhpScoperabd03f0baf05\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema4() : \_PhpScoperabd03f0baf05\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema5() : \_PhpScoperabd03f0baf05\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
}
