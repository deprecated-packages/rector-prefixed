...
namespace _PhpScoper26e51eeacccf\Bug2950;
...
class AttributeMap implements \ArrayAccess
{
    /** @var Attribute[] */
    private $attributes = [];
    public function addAttribute(\_PhpScoper26e51eeacccf\Bug2950\Attribute $attribute) : void
    {
        $this->attributes[$attribute->getId()] = $attribute;
    }
    public function getAttribute(int $id) : ?\_PhpScoper26e51eeacccf\Bug2950\Attribute
    {
    ...
    {
        return \array_filter($this->attributes, function (\_PhpScoper26e51eeacccf\Bug2950\Attribute $attribute) {
