...
namespace _PhpScoperabd03f0baf05\Bug2950;
...
class AttributeMap implements \ArrayAccess
{
    /** @var Attribute[] */
    private $attributes = [];
    public function addAttribute(\_PhpScoperabd03f0baf05\Bug2950\Attribute $attribute) : void
    {
        $this->attributes[$attribute->getId()] = $attribute;
    }
    public function getAttribute(int $id) : ?\_PhpScoperabd03f0baf05\Bug2950\Attribute
    {
    ...
    {
        return \array_filter($this->attributes, function (\_PhpScoperabd03f0baf05\Bug2950\Attribute $attribute) {
