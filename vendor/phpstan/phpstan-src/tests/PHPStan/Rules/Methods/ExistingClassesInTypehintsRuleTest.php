...
class ExistingClassesInTypehintsRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    protected function getRule() : \PHPStan\Rules\Rule
    {
        ...
        return new \PHPStan\Rules\Methods\ExistingClassesInTypehintsRule(new \PHPStan\Rules\FunctionDefinitionCheck($broker, new \PHPStan\Rules\ClassCaseSensitivityCheck($broker), new \PHPStan\Php\PhpVersion($this->phpVersionId), \true, \false));
    }
