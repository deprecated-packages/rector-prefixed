...
class CallStaticMethodsRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    protected function getRule() : \PHPStan\Rules\Rule
    {
        ...
        $ruleLevelHelper = new \PHPStan\Rules\RuleLevelHelper($broker, \true, $this->checkThisOnly, \true, \false);
        return new \PHPStan\Rules\Methods\CallStaticMethodsRule($broker, new \PHPStan\Rules\FunctionCallParametersCheck($ruleLevelHelper, new \PHPStan\Rules\NullsafeCheck(), new \PHPStan\Php\PhpVersion(80000), \true, \true, \true, \true), $ruleLevelHelper, new \PHPStan\Rules\ClassCaseSensitivityCheck($broker), \true, \true);
    }
