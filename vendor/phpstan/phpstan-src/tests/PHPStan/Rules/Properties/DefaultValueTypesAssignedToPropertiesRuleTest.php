...
class DefaultValueTypesAssignedToPropertiesRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    {
        return new \PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule(new \PHPStan\Rules\RuleLevelHelper($this->createReflectionProvider(), \true, \false, \true, \false));
    }
