...
namespace _PhpScoper006a73f0e455\PropertiesAssignedTypes;

class Foo extends \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Ipsum
{
    /** @var string */
    ...
    public function doFoo()
    {
        ...
        $this->fooProperty = new \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Bar();
        self::$staticStringProperty = 'foo';
        self::$staticStringProperty = 1;
        \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Foo::$staticStringProperty = 'foo';
        \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Foo::$staticStringProperty = 1;
        ...
        $this->unionPropertySelf = new \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Collection();
        $this->unionPropertySelf = new self();
        $this->unionPropertySelf = [new \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Bar()];
        $this->unionPropertySelf = new \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Bar();
...
class Ipsum
{
    ...
    {
        if ($this->foo instanceof \_PhpScoper006a73f0e455\PropertiesAssignedTypes\SomeInterface) {
            $this->foo->foo = new \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Bar();
            self::$fooStatic::$fooStatic = new \_PhpScoper006a73f0e455\PropertiesAssignedTypes\Bar();
        }
    }
}
