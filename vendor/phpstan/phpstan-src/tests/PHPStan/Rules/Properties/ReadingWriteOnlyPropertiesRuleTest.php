...
class ReadingWriteOnlyPropertiesRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    {
        return new \PHPStan\Rules\Properties\ReadingWriteOnlyPropertiesRule(new \PHPStan\Rules\Properties\PropertyDescriptor(), new \PHPStan\Rules\Properties\PropertyReflectionFinder(), new \PHPStan\Rules\RuleLevelHelper($this->createReflectionProvider(), \true, $this->checkThisOnly, \true, \false), $this->checkThisOnly);
    }
