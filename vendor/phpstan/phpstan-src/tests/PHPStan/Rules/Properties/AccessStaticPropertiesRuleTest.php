...
class AccessStaticPropertiesRuleTest extends \PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \PHPStan\Rules\Rule
    {
        ...
        return new \PHPStan\Rules\Properties\AccessStaticPropertiesRule($broker, new \PHPStan\Rules\RuleLevelHelper($broker, \true, \false, \true, \false), new \PHPStan\Rules\ClassCaseSensitivityCheck($broker));
    }
