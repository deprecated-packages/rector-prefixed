 ...
 */
class IssetRuleTest extends \PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \PHPStan\Rules\Rule
    {
        return new \PHPStan\Rules\Variables\IssetRule(new \PHPStan\Rules\IssetCheck(new \PHPStan\Rules\Properties\PropertyDescriptor(), new \PHPStan\Rules\Properties\PropertyReflectionFinder()));
    }
