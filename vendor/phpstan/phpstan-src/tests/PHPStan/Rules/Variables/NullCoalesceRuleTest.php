...
class NullCoalesceRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    {
        return new \PHPStan\Rules\Variables\NullCoalesceRule(new \PHPStan\Rules\IssetCheck(new \PHPStan\Rules\Properties\PropertyDescriptor(), new \PHPStan\Rules\Properties\PropertyReflectionFinder()));
    }
