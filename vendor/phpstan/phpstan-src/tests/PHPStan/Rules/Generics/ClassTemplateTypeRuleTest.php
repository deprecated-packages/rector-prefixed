 ...
 */
class ClassTemplateTypeRuleTest extends \PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \PHPStan\Rules\Rule
    {
        $broker = $this->createReflectionProvider();
        return new \PHPStan\Rules\Generics\ClassTemplateTypeRule(new \PHPStan\Rules\Generics\TemplateTypeCheck($broker, new \PHPStan\Rules\ClassCaseSensitivityCheck($broker), ['TypeAlias' => 'int'], \true));
    }
