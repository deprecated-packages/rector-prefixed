 ...
 */
class MatchExpressionRuleTest extends \PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \PHPStan\Rules\Rule
    {
        return new \PHPStan\Rules\Comparison\MatchExpressionRule(\true);
    }
