 ...
 */
class UnreachableTernaryElseBranchRuleTest extends \PHPStan\Testing\RuleTestCase
{
    /** @var bool */
    private $treatPhpDocTypesAsCertain;
    protected function getRule() : \PHPStan\Rules\Rule
    {
        return new \PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule(new \PHPStan\Rules\Comparison\ConstantConditionRuleHelper(new \PHPStan\Rules\Comparison\ImpossibleCheckTypeHelper($this->createReflectionProvider(), $this->getTypeSpecifier(), [], $this->treatPhpDocTypesAsCertain), $this->treatPhpDocTypesAsCertain), $this->treatPhpDocTypesAsCertain);
    }
