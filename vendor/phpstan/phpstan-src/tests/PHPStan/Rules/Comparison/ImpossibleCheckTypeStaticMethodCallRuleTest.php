...
class ImpossibleCheckTypeStaticMethodCallRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    {
        return new \PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule(new \PHPStan\Rules\Comparison\ImpossibleCheckTypeHelper($this->createReflectionProvider(), $this->getTypeSpecifier(), [], $this->treatPhpDocTypesAsCertain), \true, $this->treatPhpDocTypesAsCertain);
    }
    ...
    {
        return [new \PHPStan\Tests\AssertionClassStaticMethodTypeSpecifyingExtension(null), new \PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension()];
    }
