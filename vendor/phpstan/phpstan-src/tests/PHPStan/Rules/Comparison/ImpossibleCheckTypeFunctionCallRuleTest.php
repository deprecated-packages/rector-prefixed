...
class ImpossibleCheckTypeFunctionCallRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    {
        return new \PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule(new \PHPStan\Rules\Comparison\ImpossibleCheckTypeHelper($this->createReflectionProvider(), $this->getTypeSpecifier(), [\stdClass::class], $this->treatPhpDocTypesAsCertain), $this->checkAlwaysTrueCheckTypeFunctionCall, $this->treatPhpDocTypesAsCertain);
    }
