...
namespace _PhpScoperabd03f0baf05\StrictComparison;
...
class Foo
{
    public function doFoo()
    {
        ...
        doFoo() === doBar();
        1 === null;
        new \_PhpScoperabd03f0baf05\StrictComparison\Bar() === 1;
        // wrong
        /** @var Foo[]|Collection|bool $unionIterableType */
        $unionIterableType = doFoo();
        1 === $unionIterableType;
        \false === $unionIterableType;
        $unionIterableType === [new \_PhpScoperabd03f0baf05\StrictComparison\Foo()];
        $unionIterableType === new \_PhpScoperabd03f0baf05\StrictComparison\Collection();
        /** @var bool $boolean */
        $boolean = doFoo();
        \true === $boolean;
        \false === $boolean;
...
{
    private const MAPPING = [\stdClass::class, \_PhpScoperabd03f0baf05\StrictComparison\RandomAbstractClass::class];
    public function test(int $key)
    {
        if (\is_subclass_of(self::MAPPING[$key], \_PhpScoperabd03f0baf05\StrictComparison\RandomAbstractClass::class) === \false) {
            return;
        }
    }
}
