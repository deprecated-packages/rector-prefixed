...
// lint >= 8.0
namespace _PhpScopera143bcca66cb\InvalidPhpDocPromotedProperties;

use _PhpScopera143bcca66cb\InvalidPhpDoc\Foo;
use _PhpScopera143bcca66cb\InvalidPhpDoc\Bar;
