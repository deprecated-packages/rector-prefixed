...
class InvalidPhpDocTagValueRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    {
        return new \PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule(self::getContainer()->getByType(\PHPStan\PhpDocParser\Lexer\Lexer::class), self::getContainer()->getByType(\PHPStan\PhpDocParser\Parser\PhpDocParser::class));
    }
