...
class OffsetAccessAssignmentRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    {
        $ruleLevelHelper = new \PHPStan\Rules\RuleLevelHelper($this->createReflectionProvider(), \true, \false, $this->checkUnionTypes, \false);
        return new \PHPStan\Rules\Arrays\OffsetAccessAssignmentRule($ruleLevelHelper);
    }
