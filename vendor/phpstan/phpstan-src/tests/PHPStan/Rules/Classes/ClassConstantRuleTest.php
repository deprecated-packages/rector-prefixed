...
class ClassConstantRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    protected function getRule() : \PHPStan\Rules\Rule
    {
        ...
        return new \PHPStan\Rules\Classes\ClassConstantRule($broker, new \PHPStan\Rules\RuleLevelHelper($broker, \true, \false, \true, \false), new \PHPStan\Rules\ClassCaseSensitivityCheck($broker), new \PHPStan\Php\PhpVersion($this->phpVersion));
    }
