 ...
 */
class InvalidPromotedPropertiesRuleTest extends \PHPStan\Testing\RuleTestCase
{
    /** @var int */
    private $phpVersion;
    protected function getRule() : \PHPStan\Rules\Rule
    {
        return new \PHPStan\Rules\Classes\InvalidPromotedPropertiesRule(new \PHPStan\Php\PhpVersion($this->phpVersion));
    }
