 ...
 */
class MixinRuleTest extends \PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \PHPStan\Rules\Rule
    {
        $reflectionProvider = $this->createReflectionProvider();
        return new \PHPStan\Rules\Classes\MixinRule(self::getContainer()->getByType(\PHPStan\Type\FileTypeMapper::class), $reflectionProvider, new \PHPStan\Rules\ClassCaseSensitivityCheck($reflectionProvider), new \PHPStan\Rules\Generics\GenericObjectTypeCheck(), new \PHPStan\Rules\MissingTypehintCheck($reflectionProvider, \true, \true), \true);
    }
