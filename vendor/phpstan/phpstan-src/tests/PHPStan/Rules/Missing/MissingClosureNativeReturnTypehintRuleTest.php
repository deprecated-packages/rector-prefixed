 ...
 */
class MissingClosureNativeReturnTypehintRuleTest extends \PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \PHPStan\Rules\Rule
    {
        return new \PHPStan\Rules\Missing\MissingClosureNativeReturnTypehintRule(\true);
    }
