...
namespace _PhpScopera143bcca66cb\Constants;

use const _PhpScopera143bcca66cb\OtherConstants\BAZ_CONSTANT;
echo FOO_CONSTANT;
echo BAR_CONSTANT;
echo \_PhpScopera143bcca66cb\OtherConstants\BAZ_CONSTANT;
