 ...
 */
class UnusedPrivatePropertyRuleTest extends \PHPStan\Testing\RuleTestCase
{
    /** @var string[] */
    ...
    {
        return new \PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule(new \PHPStan\Rules\Properties\DirectReadWritePropertiesExtensionProvider([new class implements \PHPStan\Rules\Properties\ReadWritePropertiesExtension
        {
    ...
    public function testRule() : void
    {
        ...
        $this->alwaysReadTags = [];
        $this->analyse([__DIR__ . '/data/unused-private-property.php'], [['Property UnusedPrivateProperty\\Foo::$bar is never read, only written.', 10], ['Property UnusedPrivateProperty\\Foo::$baz is unused.', 12], ['Property UnusedPrivateProperty\\Foo::$lorem is never written, only read.', 14], ['Property UnusedPrivateProperty\\Bar::$baz is never written, only read.', 57], ['Static property UnusedPrivateProperty\\Baz::$bar is never read, only written.', 86], ['Static property UnusedPrivateProperty\\Baz::$baz is unused.', 88], ['Static property UnusedPrivateProperty\\Baz::$lorem is never written, only read.', 90], ['Property UnusedPrivateProperty\\Lorem::$baz is never read, only written.', 117]]);
    ...
    {
        $this->alwaysWrittenTags = ['_PhpScoper006a73f0e455\\@ORM\\Column'];
