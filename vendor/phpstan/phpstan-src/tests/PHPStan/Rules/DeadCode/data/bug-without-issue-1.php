...
namespace _PhpScoperabd03f0baf05\BugWithoutIssue1;
...
interface Message
{
    ...
    public function getFromUser() : \_PhpScoperabd03f0baf05\BugWithoutIssue1\User;
}
...
class X
{
    public function checkAndSendThreadNotRepliedNotification(\_PhpScoperabd03f0baf05\BugWithoutIssue1\MessageThread $thread) : bool
    {
