...
namespace _PhpScoperbd5d0c5f7638\BugWithoutIssue1;
...
interface Message
{
    ...
    public function getFromUser() : \_PhpScoperbd5d0c5f7638\BugWithoutIssue1\User;
}
...
class X
{
    public function checkAndSendThreadNotRepliedNotification(\_PhpScoperbd5d0c5f7638\BugWithoutIssue1\MessageThread $thread) : bool
    {
