...
namespace _PhpScoper26e51eeacccf\BugWithoutIssue1;
...
interface Message
{
    ...
    public function getFromUser() : \_PhpScoper26e51eeacccf\BugWithoutIssue1\User;
}
...
class X
{
    public function checkAndSendThreadNotRepliedNotification(\_PhpScoper26e51eeacccf\BugWithoutIssue1\MessageThread $thread) : bool
    {
