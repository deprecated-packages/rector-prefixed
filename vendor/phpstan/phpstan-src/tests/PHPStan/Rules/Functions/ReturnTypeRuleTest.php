...
class ReturnTypeRuleTest extends \PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \PHPStan\Rules\Rule
    {
        ...
        return new \PHPStan\Rules\Functions\ReturnTypeRule(new \PHPStan\Rules\FunctionReturnTypeCheck(new \PHPStan\Rules\RuleLevelHelper($this->createReflectionProvider(), \true, \false, \true, \false)), $functionReflector);
    }
