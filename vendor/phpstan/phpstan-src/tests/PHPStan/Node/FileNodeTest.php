...
class FileNodeTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    public function dataRule() : iterable
    {
        ...
        (yield [__DIR__ . '/data/declare.php', '_PhpScoper88fe6e0ad041\\First node in file declare.php is: PhpParser\\Node\\Stmt\\Declare_', 1]);
        (yield [__DIR__ . '/data/namespace.php', '_PhpScoper88fe6e0ad041\\First node in file namespace.php is: PhpParser\\Node\\Stmt\\Namespace_', 3]);
    }
    /**
