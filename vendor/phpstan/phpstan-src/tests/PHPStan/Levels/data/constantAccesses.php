...
namespace _PhpScoper88fe6e0ad041\Levels\ConstantAccesses;
...
class Foo
{
    ...
    {
        echo \_PhpScoper88fe6e0ad041\Levels\ConstantAccesses\Foo::FOO_CONSTANT;
        echo \_PhpScoper88fe6e0ad041\Levels\ConstantAccesses\Foo::BAR_CONSTANT;
        echo \_PhpScoper88fe6e0ad041\Levels\ConstantAccesses\Bar::FOO_CONSTANT;
...
class Baz
{
     ...
     */
    public function doBaz($fooOrBar, ?\_PhpScoper88fe6e0ad041\Levels\ConstantAccesses\Foo $fooOrNull, $fooOrBarOrNull, $barOrBaz)
    {
