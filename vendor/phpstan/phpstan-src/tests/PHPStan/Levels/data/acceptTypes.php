...
namespace _PhpScoperabd03f0baf05\Levels\AcceptTypes;
...
interface FooInterface extends \_PhpScoperabd03f0baf05\Levels\AcceptTypes\ParentFooInterface
{
}
interface FooCountableInterface extends \Countable
{
}
class FooImpl implements \_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooInterface
{
}
class ClosureAccepts
{
    ...
    {
        $c = function (\_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooInterface $x, $y) : FooInterface {
            return new \_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooInterface $x) : FooInterface {
            // less parameters - OK
            return new \_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooInterface $x, $y, $z) : FooInterface {
            // more parameters - error
            return new \_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoperabd03f0baf05\Levels\AcceptTypes\ParentFooInterface $x) : FooInterface {
            // parameter contravariance - OK
            return new \_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooImpl $x) : FooInterface {
            // parameter covariance - error
            return new \_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooInterface $x) : FooImpl {
            // return type covariance - OK
            return new \_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoperabd03f0baf05\Levels\AcceptTypes\FooInterface $x) : ParentFooInterface {
...
class Baz
{
    ...
    public function makeFoo() : \_PhpScoperabd03f0baf05\Levels\AcceptTypes\Foo
    {
        return new \_PhpScoperabd03f0baf05\Levels\AcceptTypes\Foo();
    }
    /**
     * @return Foo|mixed[]
     */
    ...
    private function requireFoo(\_PhpScoperabd03f0baf05\Levels\AcceptTypes\Foo $foo)
    {
    }
}
class ArrayShapes
