...
namespace _PhpScoper006a73f0e455\Levels\AcceptTypes;
...
interface FooInterface extends \_PhpScoper006a73f0e455\Levels\AcceptTypes\ParentFooInterface
{
}
interface FooCountableInterface extends \Countable
{
}
class FooImpl implements \_PhpScoper006a73f0e455\Levels\AcceptTypes\FooInterface
{
}
class ClosureAccepts
{
    ...
    {
        $c = function (\_PhpScoper006a73f0e455\Levels\AcceptTypes\FooInterface $x, $y) : FooInterface {
            return new \_PhpScoper006a73f0e455\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoper006a73f0e455\Levels\AcceptTypes\FooInterface $x) : FooInterface {
            // less parameters - OK
            return new \_PhpScoper006a73f0e455\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoper006a73f0e455\Levels\AcceptTypes\FooInterface $x, $y, $z) : FooInterface {
            // more parameters - error
            return new \_PhpScoper006a73f0e455\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoper006a73f0e455\Levels\AcceptTypes\ParentFooInterface $x) : FooInterface {
            // parameter contravariance - OK
            return new \_PhpScoper006a73f0e455\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoper006a73f0e455\Levels\AcceptTypes\FooImpl $x) : FooInterface {
            // parameter covariance - error
            return new \_PhpScoper006a73f0e455\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoper006a73f0e455\Levels\AcceptTypes\FooInterface $x) : FooImpl {
            // return type covariance - OK
            return new \_PhpScoper006a73f0e455\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\_PhpScoper006a73f0e455\Levels\AcceptTypes\FooInterface $x) : ParentFooInterface {
...
class Baz
{
    ...
    public function makeFoo() : \_PhpScoper006a73f0e455\Levels\AcceptTypes\Foo
    {
        return new \_PhpScoper006a73f0e455\Levels\AcceptTypes\Foo();
    }
    /**
     * @return Foo|mixed[]
     */
    ...
    private function requireFoo(\_PhpScoper006a73f0e455\Levels\AcceptTypes\Foo $foo)
    {
    }
}
class ArrayShapes
