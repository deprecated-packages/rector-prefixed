...
class PhpVersionFactoryTest extends \_PhpScoper006a73f0e455\PHPUnit\Framework\TestCase
{
    ...
    {
        $factory = new \PHPStan\Php\PhpVersionFactory($versionId, $composerPhpVersion);
