...
class JsonErrorFormatterTest extends \PHPStan\Testing\ErrorFormatterTestCase
{
        ...
        (yield ['Multiple file, multiple generic errors', 1, 4, 2, '
{
    ...
    {
        $formatter = new \PHPStan\Command\ErrorFormatter\JsonErrorFormatter(\true);
    ...
    {
        $formatter = new \PHPStan\Command\ErrorFormatter\JsonErrorFormatter(\false);
