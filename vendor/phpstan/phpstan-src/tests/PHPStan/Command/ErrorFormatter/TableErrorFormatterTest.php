...
class TableErrorFormatterTest extends \PHPStan\Testing\ErrorFormatterTestCase
{
...
']);
    ...
    {
        $formatter = new \PHPStan\Command\ErrorFormatter\TableErrorFormatter(new \PHPStan\File\FuzzyRelativePathHelper(new \PHPStan\File\NullRelativePathHelper(), self::DIRECTORY_PATH, [], '/'), \false);
