...
class GithubErrorFormatterTest extends \PHPStan\Testing\ErrorFormatterTestCase
{
...
']);
    ...
    {
        $relativePathHelper = new \PHPStan\File\FuzzyRelativePathHelper(new \PHPStan\File\NullRelativePathHelper(), self::DIRECTORY_PATH, [], '/');
        $formatter = new \PHPStan\Command\ErrorFormatter\GithubErrorFormatter($relativePathHelper, new \PHPStan\Command\ErrorFormatter\TableErrorFormatter($relativePathHelper, \false));
