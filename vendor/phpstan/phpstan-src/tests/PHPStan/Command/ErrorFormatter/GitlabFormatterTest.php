...
class GitlabFormatterTest extends \PHPStan\Testing\ErrorFormatterTestCase
{
    ...
    {
        $formatter = new \PHPStan\Command\ErrorFormatter\GitlabErrorFormatter(new \PHPStan\File\SimpleRelativePathHelper('/data/folder'));
