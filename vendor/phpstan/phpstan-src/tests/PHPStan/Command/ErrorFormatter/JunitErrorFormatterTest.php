...
class JunitErrorFormatterTest extends \PHPStan\Testing\ErrorFormatterTestCase
{
    ...
    {
        parent::setUp();
        $this->formatter = new \PHPStan\Command\ErrorFormatter\JunitErrorFormatter(new \PHPStan\File\SimpleRelativePathHelper(self::DIRECTORY_PATH));
    }
    /**
