 ...
 * @group exec
 */
class BaselineNeonErrorFormatterIntegrationTest extends \_PhpScoper006a73f0e455\PHPUnit\Framework\TestCase
{
    public function testErrorWithTrait() : void
    {
        $output = $this->runPhpStan(__DIR__ . '/data/', null);
        $errors = \_PhpScoper006a73f0e455\Nette\Utils\Json::decode($output, \_PhpScoper006a73f0e455\Nette\Utils\Json::FORCE_ARRAY);
