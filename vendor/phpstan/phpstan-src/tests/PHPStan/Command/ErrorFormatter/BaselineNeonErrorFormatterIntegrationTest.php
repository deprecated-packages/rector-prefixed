 ...
 * @group exec
 */
class BaselineNeonErrorFormatterIntegrationTest extends \_PhpScoperabd03f0baf05\PHPUnit\Framework\TestCase
{
    public function testErrorWithTrait() : void
    {
        $output = $this->runPhpStan(__DIR__ . '/data/', null);
        $errors = \_PhpScoperabd03f0baf05\Nette\Utils\Json::decode($output, \_PhpScoperabd03f0baf05\Nette\Utils\Json::FORCE_ARRAY);
