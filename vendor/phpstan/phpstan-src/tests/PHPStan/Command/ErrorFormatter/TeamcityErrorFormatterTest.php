...
class TeamcityErrorFormatterTest extends \PHPStan\Testing\ErrorFormatterTestCase
{
...
']);
    ...
    public function testFormatErrors(string $message, int $exitCode, int $numFileErrors, int $numGenericErrors, string $expected) : void
    {
        ...
        $formatter = new \PHPStan\Command\ErrorFormatter\TeamcityErrorFormatter($relativePathHelper);
