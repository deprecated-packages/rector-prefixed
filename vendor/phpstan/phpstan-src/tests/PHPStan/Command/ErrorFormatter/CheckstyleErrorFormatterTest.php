...
class CheckstyleErrorFormatterTest extends \PHPStan\Testing\ErrorFormatterTestCase
{
...
']);
    ...
    {
        $formatter = new \PHPStan\Command\ErrorFormatter\CheckstyleErrorFormatter(new \PHPStan\File\SimpleRelativePathHelper(self::DIRECTORY_PATH));
    ...
    {
        $formatter = new \PHPStan\Command\ErrorFormatter\CheckstyleErrorFormatter(new \PHPStan\File\SimpleRelativePathHelper(__DIR__));
        $error = new \PHPStan\Analyser\Error('Foo', __DIR__ . '/FooTrait.php (in context of class Foo)', 5, \true, __DIR__ . '/Foo.php', __DIR__ . '/FooTrait.php');
        $formatter->formatErrors(new \PHPStan\Command\AnalysisResult([$error], [], [], [], \false, null, \true), $this->getOutput());
