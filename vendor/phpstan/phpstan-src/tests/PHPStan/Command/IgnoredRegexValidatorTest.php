...
class IgnoredRegexValidatorTest extends \PHPStan\Testing\TestCase
{
    ...
    public function testValidate(string $regex, array $expectedTypes, bool $expectedHasAnchors, bool $expectAllErrorsIgnored) : void
    {
        ...
        $validator = new \PHPStan\Command\IgnoredRegexValidator($parser, self::getContainer()->getByType(\PHPStan\PhpDoc\TypeStringResolver::class));
