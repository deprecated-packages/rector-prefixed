...
final class OutputDebugger
{
    ...
    private function renderHtml() : string
    {
        ...
        foreach ($this->list as $item) {
            ...
            $res .= '<span title="' . \RectorPrefix20210424\Tracy\Helpers::escapeHtml(\implode("\n", $stack)) . '">' . \RectorPrefix20210424\Tracy\Helpers::editorLink($item[0], $item[1]) . ' ' . \str_replace(self::BOM, '<big>BOM</big>', \RectorPrefix20210424\Tracy\Dumper::toHtml($item[2])) . "</span><br>\n";
        }
        return $res . '</code>';
    }
}
