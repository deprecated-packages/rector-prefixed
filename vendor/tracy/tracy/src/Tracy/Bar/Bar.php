...
class Bar
{
     ...
     * @return static
     */
    public function addPanel(\RectorPrefix20210427\Tracy\IBarPanel $panel, string $id = null)
    {
        if ($id === null) {
            $c = 0;
            do {
     ...
     */
    public function getPanel(string $id) : ?\RectorPrefix20210427\Tracy\IBarPanel
    {
    ...
    public function render() : void
    {
        ...
        if (\RectorPrefix20210427\Tracy\Helpers::isAjax()) {
            if ($useSession) {
    ...
    private function renderHtml(string $type, string $suffix = '') : array
    {
        ...
        return ['bar' => \RectorPrefix20210427\Tracy\Helpers::capture(function () use($type, $panels) {
            require __DIR__ . '/assets/bar.phtml';
        }), 'panels' => \RectorPrefix20210427\Tracy\Helpers::capture(function () use($type, $panels) {
    ...
    private function renderPanels(string $suffix = '') : array
    {
        ...
        foreach ($this->panels as $id => $panel) {
            ...
            try {
                ...
                $idHtml = "error-{$idHtml}";
                $tab = "Error in {$id}";
                $panelHtml = "<h1>Error: {$id}</h1><div class='tracy-inner'>" . \nl2br(\RectorPrefix20210427\Tracy\Helpers::escapeHtml($e)) . '</div>';
                unset($e);
            }
    ...
    public function dispatchAssets() : bool
    {
        ...
        if ($this->useSession && \RectorPrefix20210427\Tracy\Helpers::isAjax()) {
    ...
    {
        $css = \array_map('file_get_contents', \array_merge([__DIR__ . '/assets/bar.css', __DIR__ . '/../Toggle/toggle.css', __DIR__ . '/../TableSort/table-sort.css', __DIR__ . '/../Dumper/assets/dumper-light.css', __DIR__ . '/../Dumper/assets/dumper-dark.css', __DIR__ . '/../BlueScreen/assets/bluescreen.css'], \RectorPrefix20210427\Tracy\Debugger::$customCssFiles));
        echo "'use strict';\n(function(){\n\tvar el = document.createElement('style');\n\tel.setAttribute('nonce', document.currentScript.getAttribute('nonce') || document.currentScript.nonce);\n\tel.className='tracy-debug';\n\tel.textContent=" . \json_encode(\RectorPrefix20210427\Tracy\Helpers::minifyCss(\implode($css))) . ";\n\tdocument.head.appendChild(el);})\n();\n";
        ...
        \array_map('readfile', \RectorPrefix20210427\Tracy\Debugger::$customJsFiles);
    }
}
