...
\class_alias('RectorPrefix20210503\\Test', 'Test', \false);
$arr = [10, 'hello', \fopen(__FILE__, 'r')];
$obj = new \RectorPrefix20210503\Test();
$snapshot = [];
echo \RectorPrefix20210503\Tracy\Dumper::toHtml($arr, [\RectorPrefix20210503\Tracy\Dumper::SNAPSHOT => &$snapshot]);
echo \RectorPrefix20210503\Tracy\Dumper::toHtml($obj, [\RectorPrefix20210503\Tracy\Dumper::SNAPSHOT => &$snapshot]);
...
echo \RectorPrefix20210503\Tracy\Dumper::toHtml($obj, [\RectorPrefix20210503\Tracy\Dumper::SNAPSHOT => &$snapshot]);
// prints snapshot
echo '<meta itemprop=tracy-snapshot content=', \RectorPrefix20210503\Tracy\Dumper::formatSnapshotAttribute($snapshot), '>';
echo '</div>';
