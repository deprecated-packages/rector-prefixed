...
\class_alias('RectorPrefix20210504\\Test', 'Test', \false);
$arr = [10, 'hello', \fopen(__FILE__, 'r')];
$obj = new \RectorPrefix20210504\Test();
$snapshot = [];
echo \RectorPrefix20210504\Tracy\Dumper::toHtml($arr, [\RectorPrefix20210504\Tracy\Dumper::SNAPSHOT => &$snapshot]);
echo \RectorPrefix20210504\Tracy\Dumper::toHtml($obj, [\RectorPrefix20210504\Tracy\Dumper::SNAPSHOT => &$snapshot]);
...
echo \RectorPrefix20210504\Tracy\Dumper::toHtml($obj, [\RectorPrefix20210504\Tracy\Dumper::SNAPSHOT => &$snapshot]);
// prints snapshot
echo '<meta itemprop=tracy-snapshot content=', \RectorPrefix20210504\Tracy\Dumper::formatSnapshotAttribute($snapshot), '>';
echo '</div>';
