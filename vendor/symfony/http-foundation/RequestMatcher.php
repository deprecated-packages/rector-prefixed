 ...
 */
class RequestMatcher implements \_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
