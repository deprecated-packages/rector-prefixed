 ...
 */
class RequestMatcher implements \RectorPrefix20210423\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\RectorPrefix20210423\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\RectorPrefix20210423\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
