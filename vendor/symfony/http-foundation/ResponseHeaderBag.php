 ...
 */
class ResponseHeaderBag extends \RectorPrefix20210317\Symfony\Component\HttpFoundation\HeaderBag
{
    ...
    public function set($key, $values, $replace = \true)
    {
        ...
        if ('set-cookie' === $uniqueKey) {
            ...
            foreach ((array) $values as $cookie) {
                $this->setCookie(\RectorPrefix20210317\Symfony\Component\HttpFoundation\Cookie::fromString($cookie));
            }
