 ...
 */
class ResponseHeaderBag extends \RectorPrefix20210423\Symfony\Component\HttpFoundation\HeaderBag
{
    ...
    public function set($key, $values, $replace = \true)
    {
        ...
        if ('set-cookie' === $uniqueKey) {
            ...
            foreach ((array) $values as $cookie) {
                $this->setCookie(\RectorPrefix20210423\Symfony\Component\HttpFoundation\Cookie::fromString($cookie));
            }
    ...
    public function setCookie(\RectorPrefix20210423\Symfony\Component\HttpFoundation\Cookie $cookie)
    {
    ...
    {
        return \RectorPrefix20210423\Symfony\Component\HttpFoundation\HeaderUtils::makeDisposition($disposition, $filename, $filenameFallback);
    }
    /**
