...
final class ResponseCookieValueSame extends \RectorPrefix20210220\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
    ...
    protected function getCookie(\RectorPrefix20210220\Symfony\Component\HttpFoundation\Response $response) : ?\RectorPrefix20210220\Symfony\Component\HttpFoundation\Cookie
    {
        $cookies = $response->headers->getCookies();
        $filteredCookies = \array_filter($cookies, function (\RectorPrefix20210220\Symfony\Component\HttpFoundation\Cookie $cookie) {
