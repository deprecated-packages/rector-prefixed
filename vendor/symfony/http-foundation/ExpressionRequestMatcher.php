...
use _PhpScoper0a6b37af0871\Symfony\Component\ExpressionLanguage\ExpressionLanguage;
/**
 * ExpressionRequestMatcher uses an expression to match a Request.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class ExpressionRequestMatcher extends \_PhpScoper0a6b37af0871\Symfony\Component\HttpFoundation\RequestMatcher
{
    private $language;
    private $expression;
    public function setExpression(\_PhpScoper0a6b37af0871\Symfony\Component\ExpressionLanguage\ExpressionLanguage $language, $expression)
    {
