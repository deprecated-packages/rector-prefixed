...
class Response
{
    ...
    {
        $this->headers = new \RectorPrefix20201228\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\RectorPrefix20201228\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\RectorPrefix20201228\Symfony\Component\HttpFoundation\Request $request) : void
    {
