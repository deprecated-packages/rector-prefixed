...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper88fe6e0ad041\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper88fe6e0ad041\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper88fe6e0ad041\Symfony\Component\HttpFoundation\Request $request) : void
    {
