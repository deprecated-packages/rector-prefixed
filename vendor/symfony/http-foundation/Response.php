...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperbf340cb0be9d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperbf340cb0be9d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperbf340cb0be9d\Symfony\Component\HttpFoundation\Request $request) : void
    {
