...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Request $request) : void
    {
