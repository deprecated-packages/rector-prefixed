...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\Request $request) : void
    {
