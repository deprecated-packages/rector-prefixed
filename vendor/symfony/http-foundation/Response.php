...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper0a6b37af0871\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper0a6b37af0871\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper0a6b37af0871\Symfony\Component\HttpFoundation\Request $request) : void
    {
