...
class Response
{
    ...
    {
        $this->headers = new \RectorPrefix2020DecSat\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\RectorPrefix2020DecSat\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\RectorPrefix2020DecSat\Symfony\Component\HttpFoundation\Request $request) : void
    {
