...
class Response
{
    ...
    {
        $this->headers = new \RectorPrefix20210422\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\RectorPrefix20210422\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @return void
     */
    protected function ensureIEOverSSLCompatibility(\RectorPrefix20210422\Symfony\Component\HttpFoundation\Request $request)
    {
