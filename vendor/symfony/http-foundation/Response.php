...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper2a4e7ab1ecbc\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper2a4e7ab1ecbc\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper2a4e7ab1ecbc\Symfony\Component\HttpFoundation\Request $request) : void
    {
