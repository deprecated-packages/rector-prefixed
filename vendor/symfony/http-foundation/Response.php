...
class Response
{
    ...
    {
        $this->headers = new \RectorPrefix20210123\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\RectorPrefix20210123\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\RectorPrefix20210123\Symfony\Component\HttpFoundation\Request $request) : void
    {
