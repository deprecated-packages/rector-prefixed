...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperabd03f0baf05\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperabd03f0baf05\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperabd03f0baf05\Symfony\Component\HttpFoundation\Request $request) : void
    {
