...
class Response
{
    ...
    {
        $this->headers = new \RectorPrefix20210421\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\RectorPrefix20210421\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @return void
     */
    protected function ensureIEOverSSLCompatibility(\RectorPrefix20210421\Symfony\Component\HttpFoundation\Request $request)
    {
