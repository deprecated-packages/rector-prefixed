...
class HeaderBag implements \IteratorAggregate, \Countable
{
    ...
    protected function getCacheControlHeader()
    {
        ...
        return \RectorPrefix20210206\Symfony\Component\HttpFoundation\HeaderUtils::toString($this->cacheControl, ',');
    }
    /**
    ...
    {
        $parts = \RectorPrefix20210206\Symfony\Component\HttpFoundation\HeaderUtils::split($header, ',=');
        return \RectorPrefix20210206\Symfony\Component\HttpFoundation\HeaderUtils::combine($parts);
    }
}
