 ...
 */
class MongoDbSessionHandler extends \RectorPrefix2020DecSat\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler
{
    private $mongo;
    /**
     ...
     */
    public function __construct(\RectorPrefix2020DecSat\MongoDB\Client $mongo, array $options)
    {
    ...
    private function getCollection() : \RectorPrefix2020DecSat\MongoDB\Collection
    {
