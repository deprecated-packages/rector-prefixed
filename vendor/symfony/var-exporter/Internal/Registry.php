...
use RectorPrefix20210316\Symfony\Component\VarExporter\Exception\ClassNotFoundException;
...
class Registry
{
    ...
    public static function getClassReflector($class, $instantiableWithoutConstructor = \false, $cloneable = null)
    {
        if (!($isClass = \class_exists($class)) && !\interface_exists($class, \false) && !\trait_exists($class, \false)) {
            throw new \RectorPrefix20210316\Symfony\Component\VarExporter\Exception\ClassNotFoundException($class);
        }
            ...
            try {
                ...
                if ('C:' === $proto && !$reflector->getMethod('unserialize')->isInternal()) {
                    ...
                    try {
                        ...
                        throw new \RectorPrefix20210316\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException($class, $e);
                    }
                    if (\false === $proto) {
                        throw new \RectorPrefix20210316\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException($class);
                    }
