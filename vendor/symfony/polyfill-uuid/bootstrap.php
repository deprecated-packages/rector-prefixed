...
if (!\function_exists('uuid_create')) {
    ...
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_create($uuid_type);
    }
}
if (!\function_exists('uuid_generate_md5')) {
    function uuid_generate_md5($uuid_ns, $name)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_generate_md5($uuid_ns, $name);
    }
}
if (!\function_exists('uuid_generate_sha1')) {
    function uuid_generate_sha1($uuid_ns, $name)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_generate_sha1($uuid_ns, $name);
    }
}
if (!\function_exists('uuid_is_valid')) {
    function uuid_is_valid($uuid)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_is_valid($uuid);
    }
}
if (!\function_exists('uuid_compare')) {
    function uuid_compare($uuid1, $uuid2)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_compare($uuid1, $uuid2);
    }
}
if (!\function_exists('uuid_is_null')) {
    function uuid_is_null($uuid)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_is_null($uuid);
    }
}
if (!\function_exists('uuid_type')) {
    function uuid_type($uuid)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_type($uuid);
    }
}
if (!\function_exists('uuid_variant')) {
    function uuid_variant($uuid)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_variant($uuid);
    }
}
if (!\function_exists('uuid_time')) {
    function uuid_time($uuid)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_time($uuid);
    }
}
if (!\function_exists('uuid_mac')) {
    function uuid_mac($uuid)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_mac($uuid);
    }
}
if (!\function_exists('uuid_parse')) {
    function uuid_parse($uuid)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_parse($uuid);
    }
}
if (!\function_exists('uuid_unparse')) {
    function uuid_unparse($uuid)
    {
        return \RectorPrefix20210317\Symfony\Polyfill\Uuid\Uuid::uuid_unparse($uuid);
    }
}
