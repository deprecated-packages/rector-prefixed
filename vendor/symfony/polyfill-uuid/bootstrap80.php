...
if (!function_exists('uuid_create')) {
     ...
     */
    function uuid_create($uuid_type = \UUID_TYPE_DEFAULT): string { return p\Uuid::uuid_create((int) $uuid_type); }
}
if (!function_exists('uuid_generate_md5')) {
     ...
     */
    function uuid_generate_md5($uuid_ns, $name): string { return p\Uuid::uuid_generate_md5((string) $uuid_ns, (string) $name); }
}
if (!function_exists('uuid_generate_sha1')) {
     ...
     * @param string|null $name
     */
    function uuid_generate_sha1($uuid_ns, $name): string { return p\Uuid::uuid_generate_sha1((string) $uuid_ns, (string) $name); }
}
if (!function_exists('uuid_is_valid')) {
    /**
     * @param string|null $uuid
     */
    function uuid_is_valid($uuid): bool { return p\Uuid::uuid_is_valid((string) $uuid); }
}
if (!function_exists('uuid_compare')) {
     ...
     */
    function uuid_compare($uuid1, $uuid2): int { return p\Uuid::uuid_compare((string) $uuid1, (string) $uuid2); }
}
if (!function_exists('uuid_is_null')) {
    /**
     * @param string|null $uuid
     */
    function uuid_is_null($uuid): bool { return p\Uuid::uuid_is_null((string) $uuid); }
}
if (!function_exists('uuid_type')) {
    /**
     * @param string|null $uuid
     */
    function uuid_type($uuid): int { return p\Uuid::uuid_type((string) $uuid); }
}
if (!function_exists('uuid_variant')) {
    /**
     * @param string|null $uuid
     */
    function uuid_variant($uuid): int { return p\Uuid::uuid_variant((string) $uuid); }
}
if (!function_exists('uuid_time')) {
    /**
     * @param string|null $uuid
     */
    function uuid_time($uuid): int { return p\Uuid::uuid_time((string) $uuid); }
}
if (!function_exists('uuid_mac')) {
    /**
     * @param string|null $uuid
     */
    function uuid_mac($uuid): string { return p\Uuid::uuid_mac((string) $uuid); }
}
if (!function_exists('uuid_parse')) {
    /**
     * @param string|null $uuid
     */
    function uuid_parse($uuid): string { return p\Uuid::uuid_parse((string) $uuid); }
}
if (!function_exists('uuid_unparse')) {
    /**
     * @param string|null $uuid
     */
    function uuid_unparse($uuid): string { return p\Uuid::uuid_unparse((string) $uuid); }
}
