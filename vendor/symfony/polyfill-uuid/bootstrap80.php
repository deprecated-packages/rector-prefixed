 ...
 */
use RectorPrefix20210320\Symfony\Polyfill\Uuid as p;
...
if (!\function_exists('uuid_create')) {
    ...
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_create((int) $uuid_type);
    }
}
if (!\function_exists('uuid_generate_md5')) {
    function uuid_generate_md5(?string $uuid_ns, ?string $name) : string
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_generate_md5((string) $uuid_ns, (string) $name);
    }
}
if (!\function_exists('uuid_generate_sha1')) {
    function uuid_generate_sha1(?string $uuid_ns, ?string $name) : string
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_generate_sha1((string) $uuid_ns, (string) $name);
    }
}
if (!\function_exists('uuid_is_valid')) {
    function uuid_is_valid(?string $uuid) : bool
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_is_valid((string) $uuid);
    }
}
if (!\function_exists('uuid_compare')) {
    function uuid_compare(?string $uuid1, ?string $uuid2) : int
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_compare((string) $uuid1, (string) $uuid2);
    }
}
if (!\function_exists('uuid_is_null')) {
    function uuid_is_null(?string $uuid) : bool
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_is_null((string) $uuid);
    }
}
if (!\function_exists('uuid_type')) {
    function uuid_type(?string $uuid) : int
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_type((string) $uuid);
    }
}
if (!\function_exists('uuid_variant')) {
    function uuid_variant(?string $uuid) : int
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_variant((string) $uuid);
    }
}
if (!\function_exists('uuid_time')) {
    function uuid_time(?string $uuid) : int
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_time((string) $uuid);
    }
}
if (!\function_exists('uuid_mac')) {
    function uuid_mac(?string $uuid) : string
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_mac((string) $uuid);
    }
}
if (!\function_exists('uuid_parse')) {
    function uuid_parse(?string $uuid) : string
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_parse((string) $uuid);
    }
}
if (!\function_exists('uuid_unparse')) {
    function uuid_unparse(?string $uuid) : string
    {
        return \RectorPrefix20210320\Symfony\Polyfill\Uuid\Uuid::uuid_unparse((string) $uuid);
    }
}
