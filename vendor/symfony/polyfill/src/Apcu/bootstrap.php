...
if (\extension_loaded('Zend Data Cache')) {
    if (!\function_exists('apcu_add')) {
        ...
        {
            return \RectorPrefix20210316\Symfony\Polyfill\Apcu\Apcu::apcu_add($key, $value, $ttl);
        }
    }
    ...
    if (!\function_exists('apcu_store')) {
        ...
        {
            return \RectorPrefix20210316\Symfony\Polyfill\Apcu\Apcu::apcu_store($key, $value, $ttl);
        }
    }
} else {
    if (!\function_exists('apcu_add')) {
