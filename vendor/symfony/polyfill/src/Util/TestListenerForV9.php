...
class TestListenerForV9 extends \RectorPrefix20210316\PHPUnit\Framework\TestSuite implements \RectorPrefix20210316\PHPUnit\Framework\TestListener
{
    private $suite;
    private $trait;
    ...
    public function addWarning($test, \RectorPrefix20210316\PHPUnit\Framework\Warning $e = null, float $time = null) : void
    {
        if (\is_string($test)) {
