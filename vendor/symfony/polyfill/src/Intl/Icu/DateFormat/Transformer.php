...
abstract class Transformer
{
     ...
     */
    public abstract function format(\DateTime $dateTime, int $length) : string;
    /**
     ...
     */
    public abstract function getReverseMatchingRegExp(int $length) : string;
    /**
     ...
     */
    public abstract function extractDateOptions(string $matched, int $length) : array;
    /**
