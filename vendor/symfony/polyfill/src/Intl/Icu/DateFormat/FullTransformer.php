...
class FullTransformer
{
    ...
    public function __construct(string $pattern, string $timezone)
    {
        ...
        $this->transformers = ['M' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\MonthTransformer(), 'L' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\MonthTransformer(), 'y' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\YearTransformer(), 'd' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\DayTransformer(), 'q' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\QuarterTransformer(), 'Q' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\QuarterTransformer(), 'h' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\Hour1201Transformer(), 'D' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\DayOfYearTransformer(), 'E' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\DayOfWeekTransformer(), 'a' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\AmPmTransformer(), 'H' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\Hour2400Transformer(), 'K' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\Hour1200Transformer(), 'k' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\Hour2401Transformer(), 'm' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\MinuteTransformer(), 's' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\SecondTransformer(), 'z' => new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\TimezoneTransformer()];
    }
    /**
    ...
    private function formatReplace(string $dateChars, \DateTime $dateTime) : string
    {
        ...
        if (\false !== \strpos($this->notImplementedChars, $dateChars[0])) {
            throw new \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\Exception\NotImplementedException(\sprintf('Unimplemented date character "%s" in format "%s".', $dateChars[0], $this->pattern));
        }
        return '';
    }
    /**
    ...
    public function parse(\DateTime $dateTime, string $value)
    {
        ...
        \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\Icu::setError(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\Icu::U_PARSE_ERROR, 'Date parsing failed');
        return \false;
    }
    /**
    ...
    private function calculateUnixTimestamp(\DateTime $dateTime, array $options)
    {
        ...
        // Normalize hour
        if ($hourInstance instanceof \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\DateFormat\HourTransformer) {
