...
abstract class Icu
{
     ...
     */
    private static $errorCodes = [self::U_ZERO_ERROR => 'U_ZERO_ERROR', self::U_ILLEGAL_ARGUMENT_ERROR => 'U_ILLEGAL_ARGUMENT_ERROR', self::U_PARSE_ERROR => 'U_PARSE_ERROR'];
    /**
    ...
    {
        return isset(self::$errorCodes[$errorCode]) && $errorCode > self::U_ZERO_ERROR;
    }
    /**
