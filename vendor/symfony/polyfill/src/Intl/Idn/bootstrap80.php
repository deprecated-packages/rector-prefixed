 ...
 */
use RectorPrefix20210316\Symfony\Polyfill\Intl\Idn as p;
...
if (!\function_exists('idn_to_ascii')) {
    ...
    {
        return \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::idn_to_ascii((string) $domain, (int) $flags, (int) $variant, $idna_info);
    }
}
if (!\function_exists('idn_to_utf8')) {
    function idn_to_utf8(?string $domain, ?int $flags = 0, ?int $variant = \INTL_IDNA_VARIANT_UTS46, &$idna_info = null) : string|false
    {
        return \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::idn_to_utf8((string) $domain, (int) $flags, (int) $variant, $idna_info);
    }
}
