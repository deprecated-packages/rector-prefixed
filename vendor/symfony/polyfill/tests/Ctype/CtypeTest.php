 ...
 */
namespace RectorPrefix20210316\Symfony\Polyfill\Tests\Ctype;

use RectorPrefix20210316\PHPUnit\Framework\TestCase;
class CtypeTest extends \RectorPrefix20210316\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        return [['0'], [53], [65], [98], ['asdf'], ['ADD'], ['123'], ['A1cbad'], [280]];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], [8], [43], [-127], ['asd df'], [''], ['é'], ['!!'], ['!asdf'], ['as2!a'], ["\0asdf"]];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], [8], [43], [53], ['asd df'], [''], ['é'], ['1234'], ['13addfadsf2'], ["\0asd"], [280]];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], [53], [65], [98], [43], [280], ['asd df'], [''], ['é'], ['1234'], ['13addfadsf2'], ["\0adf"], [\chr(127) . 'adf']];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], [8], [43], [65], [98], [-129], [-456], ['asd df'], [''], ['é'], ['1234B'], ['13addfadsf2'], ["\0a"], [\chr(127), '-3', '3.5']];
    }
    /**
    ...
    {
        return [[-129], [-386], ['0'], [43], [53], [65], [98], ['asdf'], ['ADD'], ['123'], ['A1cbad'], ['!!'], ['!asdF']];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [8], [127], ['asd df'], [''], ['é'], ["\n"], ["\0asdf"]];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], ['asd df'], ['ADD'], ['123'], ['A1cbad'], ['!!'], [''], ['é'], ["\n"], ["\0asdf"]];
    }
    /**
    ...
    {
        return [[-129], [-386], ['0'], [43], [53], [280], [65], [98], ['567'], ['!!'], ['@@!#^$'], ['asd df']];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [8], [127], ['é'], ["\n"], ["\0asdf"]];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], [8], [53], [65], [98], [127], ['é'], ['asd df'], ['ADD'], ['123'], ['A1cbad'], [''], ["\n"], ["\0asdf"]];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], [8], [65], [98], [43], [127], [280], ['asdf'], ['123'], ["\1"], [''], ['Ad12'], ['ADD']];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], [8], [43], [53], [98], [127], [280], [-129], [-128], ['asdf'], ['123'], ["\1"], [''], ['Ad12'], ["\t"], ["\n"], ["\r\n"], ["\n\r"], ["\r"]];
    }
    /**
    ...
    {
        return [['0'], [53], [65], [98], [70], [102], [280], ['01234'], ['a0123'], ['A4fD'], ['DDD'], ['bbb']];
    }
    /**
    ...
    {
        return [[[]], [\true], [null], [new \stdClass()], [53.0], [25.4], [-129], [-386], [43], [71], [103], [127], ['asdfk'], ['hhh'], ['0123kl'], ['zzz'], ["\1"], [''], ["\t"], ["\n"], ["\r\n"], ["\n\r"], ["\r"]];
    }
}
