 ...
 */
namespace RectorPrefix20210316\Symfony\Polyfill\Tests\Apcu;

use RectorPrefix20210316\PHPUnit\Framework\TestCase;
/**
 * @requires extension apc
 */
class ApcuTest extends \RectorPrefix20210316\PHPUnit\Framework\TestCase
{
    ...
    public function testArrayCompatibility()
    {
        ...
        $data = ['key1' => 'value2', 'key2' => 'value3'];
        \apcu_store($data);
        $this->assertEquals($data, \apcu_fetch(\array_keys($data)));
        $this->assertSame(['key1' => \true, 'key2' => \true], \apcu_exists(['key1', 'key2', 'key3']));
        \apcu_delete(\array_keys($data));
