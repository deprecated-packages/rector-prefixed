...
use RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\Intl;
 ...
 */
abstract class AbstractIntlDateFormatterTest extends \RectorPrefix20210316\PHPUnit\Framework\TestCase
{
    ...
    public function testConstructorDefaultTimeZone()
    {
        ...
        $this->assertEquals($this->getDateTime(0, $formatter->getTimeZoneId())->format('M j, Y, g:i A'), $formatter->format(0));
    }
    public function testConstructorWithoutDateType()
    {
        $formatter = $this->getDateFormatter('en', null, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, 'UTC', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN);
        $this->assertSame('EEEE, MMMM d, y \'at\' h:mm a', $formatter->getPattern());
    }
    public function testConstructorWithoutTimeType()
    {
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, null, 'UTC', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN);
    ...
    public function testFormatUtcAndGmtAreSplit()
    {
        ...
        $gmtFormatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, 'GMT', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, $pattern);
        $utcFormatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, 'UTC', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, $pattern);
    ...
    {
        $errorCode = \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\Icu::U_ILLEGAL_ARGUMENT_ERROR;
        $formatter = $this->getDefaultDateFormatter($pattern);
    ...
    {
        return [['y-M-d', 'foobar', 'datefmt_format: string \'foobar\' is not numeric, which would be required for it to be a valid date: U_ILLEGAL_ARGUMENT_ERROR']];
    }
    /**
    ...
    public function testFormatWithTimezone($timestamp, $timezone, $expected)
    {
        ...
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, $timezone, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, $pattern);
        $this->assertSame($expected, $formatter->format($timestamp));
    }
    public function formatWithTimezoneProvider()
    {
        $data = [[0, 'UTC', '1970-01-01 00:00:00'], [0, 'GMT', '1970-01-01 00:00:00'], [0, 'GMT-03:00', '1969-12-31 21:00:00'], [0, 'GMT+03:00', '1970-01-01 03:00:00'], [0, 'Europe/Zurich', '1970-01-01 01:00:00'], [0, 'Europe/Paris', '1970-01-01 01:00:00'], [0, 'Africa/Cairo', '1970-01-01 02:00:00'], [0, 'Africa/Casablanca', '1970-01-01 00:00:00'], [0, 'Africa/Djibouti', '1970-01-01 03:00:00'], [0, 'Africa/Johannesburg', '1970-01-01 02:00:00'], [0, 'America/Antigua', '1969-12-31 20:00:00'], [0, 'America/Toronto', '1969-12-31 19:00:00'], [0, 'America/Vancouver', '1969-12-31 16:00:00'], [0, 'Asia/Aqtau', '1970-01-01 05:00:00'], [0, 'Asia/Bangkok', '1970-01-01 07:00:00'], [0, 'Asia/Dubai', '1970-01-01 04:00:00'], [0, 'Australia/Brisbane', '1970-01-01 10:00:00'], [0, 'Australia/Eucla', '1970-01-01 08:45:00'], [0, 'Australia/Melbourne', '1970-01-01 10:00:00'], [0, 'Europe/Berlin', '1970-01-01 01:00:00'], [0, 'Europe/Dublin', '1970-01-01 01:00:00'], [0, 'Europe/Warsaw', '1970-01-01 01:00:00'], [0, 'Pacific/Fiji', '1970-01-01 12:00:00']];
        return $data;
    }
    /**
    ...
    {
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, 'UTC');
        $formatter->setPattern('yyyy-MM-dd HH:mm:ss');
        $this->assertEquals($this->getDateTime(0, 'UTC')->format('Y-m-d H:i:s'), $formatter->format(0));
    }
    public function testFormatWithDateTimeZoneGmt()
    {
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, new \DateTimeZone('GMT'), \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, 'zzz');
        $this->assertEquals('GMT', $formatter->format(0));
    }
    public function testFormatWithDateTimeZoneGmtOffset()
    {
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, new \DateTimeZone('GMT+03:00'), \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, 'zzzz');
        $this->assertEquals('GMT+03:00', $formatter->format(0));
    }
    /**
    ...
    {
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, \IntlTimeZone::createTimeZone('GMT+03:00'), \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, 'zzzz');
        $this->assertEquals('GMT+03:00', $formatter->format(0));
    }
    public function testFormatWithTimezoneFromPhp()
    {
        ...
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT);
        $formatter->setPattern('yyyy-MM-dd HH:mm:ss');
        $this->assertEquals($this->getDateTime(0, 'Europe/London')->format('Y-m-d H:i:s'), $formatter->format(0));
    ...
    {
        return [[0, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::FULL, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, 'Thursday, January 1, 1970'], [0, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::LONG, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, 'January 1, 1970'], [0, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, 'Jan 1, 1970'], [0, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, '1/1/70'], [0, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::FULL, '12:00:00 AM Coordinated Universal Time'], [0, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::LONG, '12:00:00 AM UTC'], [0, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, '12:00:00 AM'], [0, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, '12:00 AM']];
    }
    public function testGetCalendar()
    {
        $formatter = $this->getDefaultDateFormatter();
        $this->assertEquals(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, $formatter->getCalendar());
    }
    public function testGetDateType()
    {
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::FULL, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE);
        $this->assertEquals(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::FULL, $formatter->getDateType());
    }
    ...
    {
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::FULL, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, 'UTC', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, 'yyyy-MM-dd');
        $this->assertEquals('yyyy-MM-dd', $formatter->getPattern());
    }
    public function testGetTimeType()
    {
        $formatter = $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::NONE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::FULL);
        $this->assertEquals(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::FULL, $formatter->getTimeType());
    }
    /**
    ...
    {
        return \array_merge($this->parseYearProvider(), $this->parseQuarterProvider(), $this->parseMonthProvider(), $this->parseStandaloneMonthProvider(), $this->parseDayProvider(), $this->parseDayOfWeekProvider(), $this->parseDayOfYearProvider(), $this->parseHour12ClockOneBasedProvider(), $this->parseHour12ClockZeroBasedProvider(), $this->parseHour24ClockOneBasedProvider(), $this->parseHour24ClockZeroBasedProvider(), $this->parseMinuteProvider(), $this->parseSecondProvider(), $this->parseTimezoneProvider(), $this->parseAmPmProvider(), $this->parseStandaloneAmPmProvider(), $this->parseRegexMetaCharsProvider(), $this->parseQuoteCharsProvider(), $this->parseDashSlashProvider());
    }
    public function parseYearProvider()
    {
        return [['y-M-d', '1970-1-1', 0], ['yy-M-d', '70-1-1', 0]];
    }
    public function parseQuarterProvider()
    {
        return [['Q', '1', 0], ['QQ', '01', 0], ['QQQ', 'Q1', 0], ['QQQQ', '1st quarter', 0], ['QQQQQ', '1st quarter', 0], ['Q', '2', 7776000], ['QQ', '02', 7776000], ['QQQ', 'Q2', 7776000], ['QQQQ', '2nd quarter', 7776000], ['QQQQQ', '2nd quarter', 7776000], ['q', '1', 0], ['qq', '01', 0], ['qqq', 'Q1', 0], ['qqqq', '1st quarter', 0], ['qqqqq', '1st quarter', 0]];
    }
    public function parseMonthProvider()
    {
        return [['y-M-d', '1970-1-1', 0], ['y-MM-d', '1970-1-1', 0], ['y-MMM-d', '1970-Jan-1', 0], ['y-MMMM-d', '1970-January-1', 0]];
    }
    public function parseStandaloneMonthProvider()
    {
        return [['y-L-d', '1970-1-1', 0], ['y-LLL-d', '1970-Jan-1', 0], ['y-LLLL-d', '1970-January-1', 0]];
    }
    public function parseDayProvider()
    {
        return [['y-M-d', '1970-1-1', 0], ['y-M-dd', '1970-1-1', 0], ['y-M-dd', '1970-1-01', 0], ['y-M-ddd', '1970-1-001', 0]];
    }
    public function parseDayOfWeekProvider()
    {
        return [['E', 'Thu', 0], ['EE', 'Thu', 0], ['EEE', 'Thu', 0], ['EEEE', 'Thursday', 0], ['EEEEE', 'T', 432000], ['EEEEEE', 'Th', 0]];
    }
    public function parseDayOfYearProvider()
    {
        return [['D', '1', 0], ['D', '2', 86400]];
    }
    ...
    {
        return [['y-M-d HH:m', '1970-1-1 0:1', 60], ['y-M-d HH:mm', '1970-1-1 0:10', 600]];
    }
    public function parseSecondProvider()
    {
        return [['y-M-d HH:mm:s', '1970-1-1 00:01:1', 61], ['y-M-d HH:mm:ss', '1970-1-1 00:01:10', 70]];
    }
    ...
    {
        return [["'M'", 'M', 0], ["'yy'", 'yy', 0], ["'''yy'", "'yy", 0], ["''y", "'1970", 0], ["H 'o'' clock'", "0 o' clock", 0]];
    }
    public function parseDashSlashProvider()
    {
        return [['y-M-d', '1970/1/1', 0], ['yy-M-d', '70/1/1', 0], ['y/M/d', '1970-1-1', 0], ['yy/M/d', '70-1-1', 0]];
    }
    /**
    ...
    {
        return [['UTC', 'UTC'], ['GMT', 'GMT'], ['GMT-03:00', 'GMT-03:00'], ['Europe/Zurich', 'Europe/Zurich'], [null, \date_default_timezone_get()], ['Foo/Bar', 'UTC'], ['GMT+00:AA', 'UTC'], ['GMT+00AA', 'UTC']];
    }
    protected function getDefaultDateFormatter($pattern = null)
    {
        return $this->getDateFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::MEDIUM, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::SHORT, 'UTC', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, $pattern);
    }
    protected function getDateTime($timestamp, $timeZone)
    {
        $dateTime = new \DateTime();
        $dateTime->setTimestamp(null === $timestamp ? \time() : $timestamp);
     ...
     */
    protected abstract function getDateFormatter($locale, $datetype, $timetype, $timezone = null, $calendar = \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\IntlDateFormatter::GREGORIAN, $pattern = null);
