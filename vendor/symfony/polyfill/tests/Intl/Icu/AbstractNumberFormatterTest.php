...
use RectorPrefix20210316\PHPUnit\Framework\Error\Warning;
 ...
 * behavior of PHP.
 */
abstract class AbstractNumberFormatterTest extends \RectorPrefix20210316\PHPUnit\Framework\TestCase
{
    ...
    {
        return [[100, 'ALL', '100'], [100, 'BRL', '100'], [100, 'CRC', '100'], [100, 'JPY', '100'], [100, 'CHF', '100'], [-100, 'ALL', '-100'], [-100, 'BRL', '-100'], [-100, 'CRC', '-100'], [-100, 'JPY', '-100'], [-100, 'CHF', '-100'], [1000.12, 'ALL', '1,000.12'], [1000.12, 'BRL', '1,000.12'], [1000.12, 'CRC', '1,000.12'], [1000.12, 'JPY', '1,000.12'], [1000.12, 'CHF', '1,000.12']];
    }
    /**
    ...
    public function testFormatCurrencyWithCurrencyStyle($value, $currency, $expected)
    {
        ...
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::CURRENCY);
        $this->assertEquals($expected, $formatter->formatCurrency($value, $currency));
    }
    public function formatCurrencyWithCurrencyStyleProvider()
    {
        return [[100, 'ALL', "ALL 100"], [-100, 'ALL', "-ALL 100"], [1000.12, 'ALL', "ALL 1,000"], [100, 'JPY', '¥100'], [-100, 'JPY', '-¥100'], [1000.12, 'JPY', '¥1,000'], [100, 'EUR', '€100.00'], [-100, 'EUR', '-€100.00'], [1000.12, 'EUR', '€1,000.12']];
    }
    /**
    ...
    {
        return [[100, 'CRC', 'CRC', "%s 100.00"], [-100, 'CRC', 'CRC', "-%s 100.00"], [1000.12, 'CRC', 'CRC', "%s 1,000.12"]];
    }
    /**
    ...
    {
        return [
            [100, 'CHF', 'CHF', "%s 100.00"],
            [-100, 'CHF', 'CHF', "-%s 100.00"],
            [1000.12, 'CHF', 'CHF', "%s 1,000.12"],
            ['1000.12', 'CHF', 'CHF', "%s 1,000.12"],
            // Rounding checks
            [1000.121, 'CHF', 'CHF', "%s 1,000.12"],
            [1000.123, 'CHF', 'CHF', "%s 1,000.12"],
            [1000.125, 'CHF', 'CHF', "%s 1,000.12"],
            [1000.127, 'CHF', 'CHF', "%s 1,000.13"],
            [1000.129, 'CHF', 'CHF', "%s 1,000.13"],
            [1200000.0, 'CHF', 'CHF', "%s 1,200,000.00"],
            [1200000.1, 'CHF', 'CHF', "%s 1,200,000.10"],
            [1200000.1, 'CHF', 'CHF', "%s 1,200,000.10"],
            [1200000.101, 'CHF', 'CHF', "%s 1,200,000.10"],
        ];
    }
    public function testFormat()
    {
        $errorCode = \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\Icu::U_ZERO_ERROR;
    ...
    {
        $formattedValue = $formatter->format($value, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_INT32);
    ...
    public function formatTypeInt32Provider()
    {
        ...
        return [[$formatter, 1, '1'], [$formatter, 1.1, '1'], [$formatter, 2147483648, '-2,147,483,648', $message], [$formatter, -2147483649, '2,147,483,647', $message]];
    }
    /**
    ...
    public function formatTypeInt32WithCurrencyStyleProvider()
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::CURRENCY);
        $message = '->format() TYPE_INT32 formats inconsistently an integer if out of the 32 bit range.';
        return [[$formatter, 1, '¤1.00'], [$formatter, 1.1, '¤1.00'], [$formatter, 2147483648, '-¤2,147,483,648.00', $message], [$formatter, -2147483649, '¤2,147,483,647.00', $message]];
    }
    /**
    ...
    {
        $formattedValue = $formatter->format($value, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_INT64);
        $this->assertEquals($expected, $formattedValue);
    }
    public function formatTypeInt64Provider()
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        return [[$formatter, 1, '1'], [$formatter, 1.1, '1'], [$formatter, 2147483648, '2,147,483,648'], [$formatter, -2147483649, '-2,147,483,649']];
    }
    /**
    ...
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::CURRENCY);
        return [[$formatter, 1, '¤1.00'], [$formatter, 1.1, '¤1.00'], [$formatter, 2147483648, '¤2,147,483,648.00'], [$formatter, -2147483649, '-¤2,147,483,649.00']];
    }
    /**
    ...
    {
        $formattedValue = $formatter->format($value, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_DOUBLE);
        $this->assertEquals($expected, $formattedValue);
    }
    public function formatTypeDoubleProvider()
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        return [[$formatter, 1, '1'], [$formatter, 1.1, '1.1']];
    }
    /**
    ...
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::CURRENCY);
        return [[$formatter, 1, '¤1.00'], [$formatter, 1.1, '¤1.10']];
    }
    /**
    ...
    public function testFormatTypeCurrency($formatter, $value)
    {
        if (\PHP_VERSION_ID >= 80000) {
            ...
            $this->expectException(\RectorPrefix20210316\PHPUnit\Framework\Error\Warning::class);
        }
        $formatter->format($value, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_CURRENCY);
    }
    /**
     * @dataProvider formatTypeCurrencyProvider
     */
    public function testFormatTypeCurrencyReturn($formatter, $value)
    {
        ...
        $this->assertFalse(@$formatter->format($value, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_CURRENCY));
    }
    public function formatTypeCurrencyProvider()
    {
        $df = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $cf = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::CURRENCY);
        return [[$df, 1], [$cf, 1]];
    }
    /**
    ...
    public function testFormatFractionDigits($value, $expected, $fractionDigits = null, $expectedFractionDigits = 1)
    {
        ...
        if (null !== $fractionDigits) {
            $attributeRet = $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS, $fractionDigits);
        }
        $formattedValue = $formatter->format($value);
        $this->assertSame($expected, $formattedValue);
        $this->assertSame($expectedFractionDigits, $formatter->getAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS));
    ...
    public function testFormatGroupingUsed($value, $expected, $groupingUsed = null, $expectedGroupingUsed = 1)
    {
        ...
        if (null !== $groupingUsed) {
            $attributeRet = $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::GROUPING_USED, $groupingUsed);
        }
        $formattedValue = $formatter->format($value);
        $this->assertSame($expected, $formattedValue);
        $this->assertSame($expectedGroupingUsed, $formatter->getAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::GROUPING_USED));
        if (null !== $attributeRet) {
            $this->assertTrue($attributeRet);
        }
    }
    ...
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS, 2);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUNDING_MODE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUND_HALFUP);
    ...
    public function testFormatRoundingModeHalfDown($value, $expected)
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS, 2);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUNDING_MODE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUND_HALFDOWN);
    ...
    {
        return [[1.121, '1.12'], [1.123, '1.12'], [1.125, '1.12'], [1.127, '1.13'], [1.129, '1.13'], [1020 / 100, '10.20']];
    }
    /**
    ...
    public function testFormatRoundingModeHalfEven($value, $expected)
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS, 2);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUNDING_MODE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUND_HALFEVEN);
    ...
    public function testFormatRoundingModeCeiling($value, $expected)
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS, 2);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUNDING_MODE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUND_CEILING);
    ...
    {
        return [[1.123, '1.13'], [1.125, '1.13'], [1.127, '1.13'], [-1.123, '-1.12'], [-1.125, '-1.12'], [-1.127, '-1.12'], [1020 / 100, '10.20']];
    }
    /**
    ...
    public function testFormatRoundingModeFloor($value, $expected)
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS, 2);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUNDING_MODE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUND_FLOOR);
    ...
    {
        return [[1.123, '1.12'], [1.125, '1.12'], [1.127, '1.12'], [-1.123, '-1.13'], [-1.125, '-1.13'], [-1.127, '-1.13'], [1020 / 100, '10.20']];
    }
    /**
    ...
    public function testFormatRoundingModeDown($value, $expected)
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS, 2);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUNDING_MODE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUND_DOWN);
    ...
    {
        return [[1.123, '1.12'], [1.125, '1.12'], [1.127, '1.12'], [-1.123, '-1.12'], [-1.125, '-1.12'], [-1.127, '-1.12'], [1020 / 100, '10.20']];
    }
    /**
    ...
    public function testFormatRoundingModeUp($value, $expected)
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::FRACTION_DIGITS, 2);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUNDING_MODE, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::ROUND_UP);
    ...
    {
        return [[1.123, '1.13'], [1.125, '1.13'], [1.127, '1.13'], [-1.123, '-1.13'], [-1.125, '-1.13'], [-1.127, '-1.13'], [1020 / 100, '10.20']];
    }
    ...
    {
        $decimalFormatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $currencyFormatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::CURRENCY);
        $r = new \ReflectionProperty('RectorPrefix20210316\\Symfony\\Polyfill\\Intl\\Icu\\NumberFormatter', 'enSymbols');
        $r->setAccessible(\true);
        $expected = $r->getValue();
        for ($i = 0; $i <= 17; ++$i) {
    ...
    public function testGetTextAttribute()
    {
        ...
        $decimalFormatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $currencyFormatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::CURRENCY);
        $r = new \ReflectionProperty('RectorPrefix20210316\\Symfony\\Polyfill\\Intl\\Icu\\NumberFormatter', 'enTextAttributes');
        $r->setAccessible(\true);
        $expected = $r->getValue();
        for ($i = 0; $i <= 5; ++$i) {
     ...
     */
    public function testParse($value, $expected, $message, $expectedPosition, $groupingUsed = \true)
    {
        if (!\defined('INTL_ICU_VERSION') || \version_compare(\INTL_ICU_VERSION, '62.1', '<')) {
            $this->markTestSkipped('ICU version 62.1 is required.');
        }
        $position = 0;
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->setAttribute(\RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::GROUPING_USED, $groupingUsed);
        $parsedValue = $formatter->parse($value, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_DOUBLE, $position);
        $this->assertSame($expected, $parsedValue, $message);
        $this->assertSame($expectedPosition, $position, $message);
        if (\false === $expected) {
            $errorCode = \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\Icu::U_PARSE_ERROR;
    ...
    public function testParseTypeDefault()
    {
        ...
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->parse('1', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_DEFAULT);
    }
    /**
    ...
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $parsedValue = $formatter->parse($value, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_INT32);
        $this->assertSame($expected, $parsedValue, $message);
    }
    public function parseTypeInt32Provider()
    {
        return [['1', 1], ['1.1', 1], ['.1', 0], ['2,147,483,647', 2147483647], ['-2,147,483,648', -2147483647 - 1], ['2,147,483,648', \false, '->parse() TYPE_INT32 returns false when the number is greater than the integer positive range.'], ['-2,147,483,649', \false, '->parse() TYPE_INT32 returns false when the number is greater than the integer negative range.']];
    }
    public function testParseTypeInt64With32BitIntegerInPhp32Bit()
    {
        ...
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $parsedValue = $formatter->parse('2,147,483,647', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_INT64);
        $this->assertIsInt($parsedValue);
        $this->assertEquals(2147483647, $parsedValue);
        $parsedValue = $formatter->parse('-2,147,483,648', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_INT64);
        $this->assertIsInt($parsedValue);
    ...
    public function testParseTypeInt64With64BitIntegerInPhp32Bit()
    {
        ...
        $parsedValue = $formatter->parse('-2,147,483,649', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_INT64);
        $this->assertIsFloat($parsedValue);
    ...
    {
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $parsedValue = $formatter->parse($value, \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_DOUBLE);
        $this->assertEqualsWithDelta($expectedValue, $parsedValue, 0.001);
    }
    public function parseTypeDoubleProvider()
    {
        return [['1', (float) 1], ['1.1', 1.1], ['9,223,372,036,854,775,808', 9.223372036854776E+18], ['-9,223,372,036,854,775,809', -9.223372036854776E+18]];
    }
    public function testParseTypeCurrency()
    {
        ...
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->parse('1', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_CURRENCY);
    }
    public function testParseWithNotNullPositionValue()
    {
        $position = 1;
        $formatter = $this->getNumberFormatter('en', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::DECIMAL);
        $formatter->parse('123', \RectorPrefix20210316\Symfony\Polyfill\Intl\Icu\NumberFormatter::TYPE_DOUBLE, $position);
        $this->assertEquals(3, $position);
    }
    /**
     * @return NumberFormatter|\NumberFormatter
     */
    protected abstract function getNumberFormatter(string $locale = 'en', string $style = null, string $pattern = null);
    protected abstract function getIntlErrorMessage() : string;
    protected abstract function getIntlErrorCode() : int;
    /**
     * @param int $errorCode
     */
    protected abstract function isIntlFailure($errorCode) : bool;
}
