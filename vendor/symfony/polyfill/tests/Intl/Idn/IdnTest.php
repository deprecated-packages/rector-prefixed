 ...
 */
namespace RectorPrefix20210316\Symfony\Polyfill\Tests\Intl\Idn;

use RectorPrefix20210316\PHPUnit\Framework\TestCase;
use RuntimeException;
use RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn;
/**
 * @requires PHP 7.2
 *
 ...
 */
class IdnTest extends \RectorPrefix20210316\PHPUnit\Framework\TestCase
{
    private static $ERROR_CODE_MAP = [
        'P1' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_DISALLOWED,
        'P4' => [\RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_EMPTY_LABEL, \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_DOMAIN_NAME_TOO_LONG, \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_LABEL_TOO_LONG, \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_PUNYCODE],
        'V1' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_INVALID_ACE_LABEL,
        'V2' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_HYPHEN_3_4,
        'V3' => [\RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_LEADING_HYPHEN, \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_TRAILING_HYPHEN],
        'V4' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_LABEL_HAS_DOT,
        'V5' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_LEADING_COMBINING_MARK,
        'V6' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_DISALLOWED,
        // V7 and V8 are handled by C* and B* respectively.
        'A3' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_PUNYCODE,
        'A4_1' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_DOMAIN_NAME_TOO_LONG,
        'A4_2' => [\RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_EMPTY_LABEL, \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_LABEL_TOO_LONG],
        'B1' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_BIDI,
        'B2' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_BIDI,
        'B3' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_BIDI,
        'B4' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_BIDI,
        'B5' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_BIDI,
        'B6' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_BIDI,
        'C1' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_CONTEXTJ,
        'C2' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_CONTEXTJ,
        ...
        'X4_2' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_EMPTY_LABEL,
        'X3' => \RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::ERROR_EMPTY_LABEL,
    ];
    /**
    ...
    public function testUppercaseUTS46($decoded, $ascii, $encoded)
    {
        ...
        $expected = ['result' => $result, 'isTransitionalDifferent' => \false, 'errors' => 0];
    ...
    {
        $result = @\RectorPrefix20210316\Symfony\Polyfill\Intl\Idn\Idn::idn_to_ascii($decoded, \IDNA_DEFAULT, \INTL_IDNA_VARIANT_2003);
        $this->assertSame($encoded, $result);
    }
    public function domainNamesProvider()
    {
        return [
            ...
            ['άέήίΰαβγδεζηθικλμνξοπρσστυφχ.com', 'xn--hxacdefghijklmnopqrstuvw0caz0a1a2a.com'],
            ['test@bücher.de', 'xn--test@bcher-feb.de'],
        ];
    }
    public function domainNamesUppercaseUTS46Provider()
    {
        return [['рф.RU', 'xn--p1ai.ru', 'рф.ru'], ['GUANGDONG.广东', 'guangdong.xn--xhq521b', 'guangdong.广东'], ['renanGonçalves.COM', 'xn--renangonalves-pgb.com', 'renangonçalves.com']];
    }
    public function invalidUtf8DomainNamesProvider()
    {
        return [['äöüßáàăâåãąāæćĉčċçďđéèĕêěëėęēğĝġģĥħíìĭîïĩįīıĵķĺľļłńňñņŋóòŏôőõøōœĸŕřŗśŝšşťţŧúùŭûůűũųūŵýŷÿźžżðþ.de'], ['aaaaa.aaaaaaaaaaaaaaa.aaaaaaaaaaaaaaaaaaa.aaaaaaaaaaaaaaaaa.aaaaaaaaaaaaaaaaaa.äöüßáàăâåãąāæćĉčċçďđéèĕêěëėęēğĝġģĥ.ħíìĭîïĩįīıĵķĺľļłńňñņŋóòŏôőõ.øōœĸŕřŗśŝšşťţŧúùŭûůűũųū.ŵýŷÿźžżðþ.de'], ['aa..aa.de'], ['-leading.de'], ['trailing-.de']];
    }
    /**
