 ...
 */
namespace RectorPrefix20210316\Symfony\Polyfill\Tests\Iconv;

use RectorPrefix20210316\PHPUnit\Framework\TestCase;
use RectorPrefix20210316\Symfony\Polyfill\Iconv\Iconv as p;
/**
 * @author Nicolas Grekas <p@tchwork.com>
 *
 * @covers \Symfony\Polyfill\Iconv\Iconv::<!public>
 */
class IconvTest extends \RectorPrefix20210316\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testIconv()
    {
        ...
        $this->assertSame('deja noeud', \RectorPrefix20210316\Symfony\Polyfill\Iconv\Iconv::iconv('UTF-8//ignore//IGNORE', 'US-ASCII//TRANSLIT//IGNORE//translit', 'déjà nœud'));
        $this->assertSame('4', \iconv('UTF-8', 'UTF-8', 4));
        $this->assertSame('aa', \RectorPrefix20210316\Symfony\Polyfill\Iconv\Iconv::iconv('UTF-8', 'ASCII//TRANSLIT//IGNORE', "aa"));
    }
    /**
    ...
    public function testIconvStrlen()
    {
        ...
        $this->assertSame(4, \RectorPrefix20210316\Symfony\Polyfill\Iconv\Iconv::strlen2('déjà'));
        $this->assertSame(3, \RectorPrefix20210316\Symfony\Polyfill\Iconv\Iconv::strlen2('한국어'));
    }
    /**
    ...
    {
        $text = "テストテスト";
        $options = ['scheme' => 'Q', 'input-charset' => 'UTF-8', 'output-charset' => 'UTF-8', 'line-length' => 30];
...
To: <test@example.com>
HEADERS;
        $result = ['From' => '<foo@example.com>', 'Subject' => '=?ks_c_5601-1987?B?UkU6odk=?= Foo', 'X-Bar' => ['RE:☆ Foo', 'RE:☆Bar'], 'To' => '<test@example.com>'];
    ...
    {
        $a = ['input_encoding' => 'UTF-8', 'output_encoding' => 'UTF-8', 'internal_encoding' => 'UTF-8'];
        foreach ($a as $t => $e) {
