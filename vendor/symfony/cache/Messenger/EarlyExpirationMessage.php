...
final class EarlyExpirationMessage
{
    ...
    private $pool;
    private $callback;
    public static function create(\RectorPrefix20210123\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer, callable $callback, \RectorPrefix20210123\Symfony\Component\Cache\CacheItem $item, \RectorPrefix20210123\Symfony\Component\Cache\Adapter\AdapterInterface $pool) : ?self
    {
        try {
            $item = clone $item;
            $item->set(null);
    ...
    public function getItem() : \RectorPrefix20210123\Symfony\Component\Cache\CacheItem
    {
        return $this->item;
    }
    ...
    public function findPool(\RectorPrefix20210123\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer) : \RectorPrefix20210123\Symfony\Component\Cache\Adapter\AdapterInterface
    {
        return $reverseContainer->getService($this->pool);
    }
    public function findCallback(\RectorPrefix20210123\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer) : callable
    {
    ...
    private function __construct(\RectorPrefix20210123\Symfony\Component\Cache\CacheItem $item, string $pool, $callback)
    {
        $this->item = $item;
        $this->pool = $pool;
