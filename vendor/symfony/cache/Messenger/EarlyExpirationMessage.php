...
final class EarlyExpirationMessage
{
    ...
    public function getItem() : \RectorPrefix20210317\Symfony\Component\Cache\CacheItem
    {
        return $this->item;
    }
    ...
    public function findPool(\RectorPrefix20210317\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer) : \RectorPrefix20210317\Symfony\Component\Cache\Adapter\AdapterInterface
    {
        return $reverseContainer->getService($this->pool);
    }
    public function findCallback(\RectorPrefix20210317\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer) : callable
    {
    ...
    private function __construct(\RectorPrefix20210317\Symfony\Component\Cache\CacheItem $item, string $pool, $callback)
    {
        $this->item = $item;
        $this->pool = $pool;
