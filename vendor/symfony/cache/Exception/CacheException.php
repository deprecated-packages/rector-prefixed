...
if (\interface_exists(\_PhpScoperabd03f0baf05\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperabd03f0baf05\Psr\Cache\CacheException, \_PhpScoperabd03f0baf05\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperabd03f0baf05\Psr\Cache\CacheException
    {
    }
}
