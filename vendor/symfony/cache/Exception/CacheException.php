...
if (\interface_exists(\RectorPrefix20201226\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \RectorPrefix20201226\Psr\Cache\CacheException, \RectorPrefix20201226\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \RectorPrefix20201226\Psr\Cache\CacheException
    {
    }
}
