...
if (\interface_exists(\_PhpScoper5edc98a7cce2\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper5edc98a7cce2\Psr\Cache\CacheException, \_PhpScoper5edc98a7cce2\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper5edc98a7cce2\Psr\Cache\CacheException
    {
    }
}
