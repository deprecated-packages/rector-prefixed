...
if (\interface_exists(\_PhpScoper88fe6e0ad041\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper88fe6e0ad041\Psr\Cache\CacheException, \_PhpScoper88fe6e0ad041\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper88fe6e0ad041\Psr\Cache\CacheException
    {
    }
}
