...
if (\interface_exists(\RectorPrefix20210210\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \RectorPrefix20210210\Psr\Cache\CacheException, \RectorPrefix20210210\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \RectorPrefix20210210\Psr\Cache\CacheException
    {
    }
}
