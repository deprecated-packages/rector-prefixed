...
if (\interface_exists(\_PhpScoperbd5d0c5f7638\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperbd5d0c5f7638\Psr\Cache\CacheException, \_PhpScoperbd5d0c5f7638\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperbd5d0c5f7638\Psr\Cache\CacheException
    {
    }
}
