...
if (\interface_exists(\_PhpScopere8e811afab72\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopere8e811afab72\Psr\Cache\CacheException, \_PhpScopere8e811afab72\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopere8e811afab72\Psr\Cache\CacheException
    {
    }
}
