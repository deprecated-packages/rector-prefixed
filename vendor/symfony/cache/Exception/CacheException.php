...
if (\interface_exists(\_PhpScoper5b8c9e9ebd21\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper5b8c9e9ebd21\Psr\Cache\CacheException, \_PhpScoper5b8c9e9ebd21\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper5b8c9e9ebd21\Psr\Cache\CacheException
    {
    }
}
