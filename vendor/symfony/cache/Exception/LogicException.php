...
if (\interface_exists(\_PhpScoper0a6b37af0871\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper0a6b37af0871\Psr\Cache\CacheException, \_PhpScoper0a6b37af0871\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper0a6b37af0871\Psr\Cache\CacheException
    {
    }
}
