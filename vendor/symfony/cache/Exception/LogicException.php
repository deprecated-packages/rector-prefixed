...
if (\interface_exists(\RectorPrefix2020DecSat\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \RectorPrefix2020DecSat\Psr\Cache\CacheException, \RectorPrefix2020DecSat\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \RectorPrefix2020DecSat\Psr\Cache\CacheException
    {
    }
}
