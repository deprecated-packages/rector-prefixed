...
if (\interface_exists(\RectorPrefix20210220\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \RectorPrefix20210220\Psr\Cache\CacheException, \RectorPrefix20210220\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \RectorPrefix20210220\Psr\Cache\CacheException
    {
    }
}
