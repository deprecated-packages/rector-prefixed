...
if (\interface_exists(\RectorPrefix20210101\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \RectorPrefix20210101\Psr\Cache\CacheException, \RectorPrefix20210101\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \RectorPrefix20210101\Psr\Cache\CacheException
    {
    }
}
