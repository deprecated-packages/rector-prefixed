...
if (\interface_exists(\_PhpScoper267b3276efc2\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper267b3276efc2\Psr\Cache\CacheException, \_PhpScoper267b3276efc2\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper267b3276efc2\Psr\Cache\CacheException
    {
    }
}
