...
if (\interface_exists(\_PhpScoperf18a0c41e2d2\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperf18a0c41e2d2\Psr\Cache\CacheException, \_PhpScoperf18a0c41e2d2\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperf18a0c41e2d2\Psr\Cache\CacheException
    {
    }
}
