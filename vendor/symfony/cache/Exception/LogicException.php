...
if (\interface_exists(\_PhpScopera143bcca66cb\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScopera143bcca66cb\Psr\Cache\CacheException, \_PhpScopera143bcca66cb\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScopera143bcca66cb\Psr\Cache\CacheException
    {
    }
}
