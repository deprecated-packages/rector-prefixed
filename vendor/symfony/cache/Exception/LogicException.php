...
if (\interface_exists(\_PhpScoperfce0de0de1ce\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperfce0de0de1ce\Psr\Cache\CacheException, \_PhpScoperfce0de0de1ce\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperfce0de0de1ce\Psr\Cache\CacheException
    {
    }
}
