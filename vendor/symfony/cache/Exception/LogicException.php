...
if (\interface_exists(\RectorPrefix20210302\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \RectorPrefix20210302\Psr\Cache\CacheException, \RectorPrefix20210302\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \RectorPrefix20210302\Psr\Cache\CacheException
    {
    }
}
