...
if (\interface_exists(\_PhpScoper0a2ac50786fa\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper0a2ac50786fa\Psr\Cache\CacheException, \_PhpScoper0a2ac50786fa\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper0a2ac50786fa\Psr\Cache\CacheException
    {
    }
}
