...
if (\interface_exists(\_PhpScoper006a73f0e455\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper006a73f0e455\Psr\Cache\CacheException, \_PhpScoper006a73f0e455\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper006a73f0e455\Psr\Cache\CacheException
    {
    }
}
