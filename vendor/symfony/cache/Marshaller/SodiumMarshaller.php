 ...
 */
namespace _PhpScoperfce0de0de1ce\Symfony\Component\Cache\Marshaller;
 ...
 */
class SodiumMarshaller implements \_PhpScoperfce0de0de1ce\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
    private $marshaller;
     ...
     */
    public function __construct(array $decryptionKeys, \_PhpScoperfce0de0de1ce\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!self::isSupported()) {
            throw new \_PhpScoperfce0de0de1ce\Symfony\Component\Cache\Exception\CacheException('The "sodium" PHP extension is not loaded.');
        }
        if (!isset($decryptionKeys[0])) {
            throw new \_PhpScoperfce0de0de1ce\Symfony\Component\Cache\Exception\InvalidArgumentException('At least one decryption key must be provided at index "0".');
        }
