 ...
 */
class CachePoolPrunerPass implements \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolTag) as $id => $tags) {
            ...
            if ($reflection->implementsInterface(\_PhpScoperabd03f0baf05\Symfony\Component\Cache\PruneableInterface::class)) {
                $services[$id] = new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Reference($id);
            }
        }
        $container->getDefinition($this->cacheCommandServiceId)->replaceArgument(0, new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Argument\IteratorArgument($services));
    }
}
