 ...
 */
class CachePoolPrunerPass implements \RectorPrefix20210203\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\RectorPrefix20210203\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolTag) as $id => $tags) {
            ...
            if ($reflection->implementsInterface(\RectorPrefix20210203\Symfony\Component\Cache\PruneableInterface::class)) {
                $services[$id] = new \RectorPrefix20210203\Symfony\Component\DependencyInjection\Reference($id);
            }
        }
        $container->getDefinition($this->cacheCommandServiceId)->replaceArgument(0, new \RectorPrefix20210203\Symfony\Component\DependencyInjection\Argument\IteratorArgument($services));
    }
}
