 ...
 */
class CachePoolClearerPass implements \_PhpScoper26e51eeacccf\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolClearerTag) as $id => $attr) {
            ...
            foreach ($clearer->getArgument(0) as $name => $ref) {
                if ($container->hasDefinition($ref)) {
                    $pools[$name] = new \_PhpScoper26e51eeacccf\Symfony\Component\DependencyInjection\Reference($ref);
                }
            }
