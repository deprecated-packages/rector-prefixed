...
trait MemcachedTrait
{
    ...
    private function init(\Memcached $client, string $namespace, int $defaultLifetime, ?\_PhpScoper0a6b37af0871\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller)
    {
    ...
    public static function createConnection($servers, array $options = [])
    {
        if (\is_string($servers)) {
            ...
            throw new \_PhpScoper0a6b37af0871\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('MemcachedAdapter::createClient() expects array or string as first argument, "%s" given.', \gettype($servers)));
        }
        if (!static::isSupported()) {
            throw new \_PhpScoper0a6b37af0871\Symfony\Component\Cache\Exception\CacheException('Memcached >= 2.2.0 is required.');
        }
