 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper26e51eeacccf\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper26e51eeacccf\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, \_PhpScoper26e51eeacccf\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \_PhpScoper26e51eeacccf\Symfony\Component\Cache\Exception\CacheException('Couchbase >= 2.6.0 is required.');
        }
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper26e51eeacccf\CouchbaseBucket
    {
        ...
        try {
            ...
            foreach ($servers as $dsn) {
                if (0 !== \strpos($dsn, 'couchbase:')) {
                    throw new \_PhpScoper26e51eeacccf\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('Invalid Couchbase DSN: "%s" does not start with "couchbase:".', $dsn));
                }
            ...
            $client = new \_PhpScoper26e51eeacccf\CouchbaseCluster($connectionString);
