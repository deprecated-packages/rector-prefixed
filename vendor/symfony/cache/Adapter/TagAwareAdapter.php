...
use _PhpScoperb75b35f52b74\Psr\Cache\InvalidArgumentException;
 ...
 */
class TagAwareAdapter implements \_PhpScoperb75b35f52b74\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \_PhpScoperb75b35f52b74\Symfony\Contracts\Cache\TagAwareCacheInterface, \_PhpScoperb75b35f52b74\Symfony\Component\Cache\PruneableInterface, \_PhpScoperb75b35f52b74\Symfony\Component\Cache\ResettableInterface
{
    ...
    public function __construct(\_PhpScoperb75b35f52b74\Symfony\Component\Cache\Adapter\AdapterInterface $itemsPool, \_PhpScoperb75b35f52b74\Symfony\Component\Cache\Adapter\AdapterInterface $tagsPool = null, float $knownTagVersionsTtl = 0.15)
    {
        $this->pool = $itemsPool;
        $this->tags = $tagsPool ?: $itemsPool;
        $this->knownTagVersionsTtl = $knownTagVersionsTtl;
        $this->createCacheItem = \Closure::bind(static function ($key, $value, \_PhpScoperb75b35f52b74\Symfony\Component\Cache\CacheItem $protoItem) {
        ...
        $this->setCacheItemTags = \Closure::bind(static function (\_PhpScoperb75b35f52b74\Symfony\Component\Cache\CacheItem $item, $key, array &$itemTags) {
            $item->isTaggable = \true;
            if (!$item->isHit) {
                return $item;
            }
            if (isset($itemTags[$key])) {
                foreach ($itemTags[$key] as $tag => $version) {
                    $item->metadata[\_PhpScoperb75b35f52b74\Symfony\Component\Cache\CacheItem::METADATA_TAGS][$tag] = $tag;
                }
                unset($itemTags[$key]);
            } else {
                $item->value = null;
        ...
        $this->getTagsByKey = \Closure::bind(static function ($deferred) {
            ...
            foreach ($deferred as $key => $item) {
                $tagsByKey[$key] = $item->newMetadata[\_PhpScoperb75b35f52b74\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
            }
            return $tagsByKey;
        }, null, \_PhpScoperb75b35f52b74\Symfony\Component\Cache\CacheItem::class);
        $this->invalidateTags = \Closure::bind(static function (\_PhpScoperb75b35f52b74\Symfony\Component\Cache\Adapter\AdapterInterface $tagsAdapter, array $tags) {
            foreach ($tags as $v) {
                $v->expiry = 0;
    ...
    public function invalidateTags(array $tags)
    {
        ...
        $invalidatedTags = [];
        foreach ($tags as $tag) {
            \_PhpScoperb75b35f52b74\Symfony\Component\Cache\CacheItem::validateKey($tag);
    ...
    public function getItems(array $keys = [])
    {
        ...
        } catch (\_PhpScoperb75b35f52b74\Psr\Cache\InvalidArgumentException $e) {
