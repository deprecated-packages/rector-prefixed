 ...
 */
class ProxyAdapter implements \RectorPrefix20210101\Symfony\Component\Cache\Adapter\AdapterInterface, \RectorPrefix20210101\Symfony\Contracts\Cache\CacheInterface, \RectorPrefix20210101\Symfony\Component\Cache\PruneableInterface, \RectorPrefix20210101\Symfony\Component\Cache\ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    public function __construct(\RectorPrefix20210101\Psr\Cache\CacheItemPoolInterface $pool, string $namespace = '', int $defaultLifetime = 0)
    {
        $this->pool = $pool;
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $innerItem) use($poolHash) {
            ...
            } elseif ($innerItem instanceof \RectorPrefix20210101\Symfony\Component\Cache\CacheItem) {
        ...
        $this->setInnerItem = \Closure::bind(
             ...
             */
            static function (\RectorPrefix20210101\Psr\Cache\CacheItemInterface $innerItem, array $item) {
                // Tags are stored separately, no need to account for them when considering this item's newly set metadata
                if (isset(($metadata = $item["\0*\0newMetadata"])[\RectorPrefix20210101\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
            ...
            null,
            \RectorPrefix20210101\Symfony\Component\Cache\CacheItem::class
        );
    }
    /**
     * {@inheritdoc}
    ...
    private function doSave(\RectorPrefix20210101\Psr\Cache\CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \RectorPrefix20210101\Symfony\Component\Cache\Adapter\AdapterInterface) {
    ...
    {
        \RectorPrefix20210101\Symfony\Component\Cache\CacheItem::validateKey($key);
