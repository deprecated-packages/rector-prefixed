 ...
 */
class TraceableAdapter implements \_PhpScoperb75b35f52b74\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoperb75b35f52b74\Symfony\Contracts\Cache\CacheInterface, \_PhpScoperb75b35f52b74\Symfony\Component\Cache\PruneableInterface, \_PhpScoperb75b35f52b74\Symfony\Component\Cache\ResettableInterface
{
    protected $pool;
    private $calls = [];
    public function __construct(\_PhpScoperb75b35f52b74\Symfony\Component\Cache\Adapter\AdapterInterface $pool)
    {
        $this->pool = $pool;
    }
    /**
    ...
    public function get(string $key, callable $callback, float $beta = null, array &$metadata = null)
    {
        if (!$this->pool instanceof \_PhpScoperb75b35f52b74\Symfony\Contracts\Cache\CacheInterface) {
            throw new \BadMethodCallException(\sprintf('Cannot call "%s::get()": this class doesn\'t implement "%s".', \get_debug_type($this->pool), \_PhpScoperb75b35f52b74\Symfony\Contracts\Cache\CacheInterface::class));
        }
        $isHit = \true;
        $callback = function (\_PhpScoperb75b35f52b74\Symfony\Component\Cache\CacheItem $item, bool &$save) use($callback, &$isHit) {
            $isHit = $item->isHit();
    ...
    {
        if (!$this->pool instanceof \_PhpScoperb75b35f52b74\Symfony\Component\Cache\PruneableInterface) {
            return \false;
        }
        $event = $this->start(__FUNCTION__);
        try {
    ...
    {
        $this->calls[] = $event = new \_PhpScoperb75b35f52b74\Symfony\Component\Cache\Adapter\TraceableAdapterEvent();
        $event->name = $name;
