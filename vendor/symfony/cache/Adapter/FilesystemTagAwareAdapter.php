...
use _PhpScoper17db12703726\Symfony\Component\Cache\Traits\FilesystemTrait;
/**
 ...
 */
class FilesystemTagAwareAdapter extends \_PhpScoper17db12703726\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter implements \_PhpScoper17db12703726\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait {
    ...
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $directory = null, \_PhpScoper17db12703726\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        $this->marshaller = new \_PhpScoper17db12703726\Symfony\Component\Cache\Marshaller\TagAwareMarshaller($marshaller);
