 ...
 */
class FilesystemTagAwareAdapter extends \RectorPrefix2020DecSat\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter implements \RectorPrefix2020DecSat\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait {
    ...
    {
        $this->marshaller = new \RectorPrefix2020DecSat\Symfony\Component\Cache\Marshaller\TagAwareMarshaller($marshaller);
