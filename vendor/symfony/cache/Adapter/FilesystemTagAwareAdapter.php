...
use RectorPrefix20210302\Symfony\Component\Cache\Traits\FilesystemTrait;
/**
 ...
 */
class FilesystemTagAwareAdapter extends \RectorPrefix20210302\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter implements \RectorPrefix20210302\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait {
    ...
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $directory = null, \RectorPrefix20210302\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        $this->marshaller = new \RectorPrefix20210302\Symfony\Component\Cache\Marshaller\TagAwareMarshaller($marshaller);
