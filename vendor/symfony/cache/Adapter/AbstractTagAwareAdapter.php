...
use RectorPrefix20210112\Symfony\Contracts\Cache\TagAwareCacheInterface;
/**
 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \RectorPrefix20210112\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \RectorPrefix20210112\Symfony\Contracts\Cache\TagAwareCacheInterface, \RectorPrefix20210112\Psr\Log\LoggerAwareInterface, \RectorPrefix20210112\Symfony\Component\Cache\ResettableInterface
{
    ...
    protected function __construct(string $namespace = '', int $defaultLifetime = 0)
    {
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\RectorPrefix20210112\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\RectorPrefix20210112\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\RectorPrefix20210112\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\RectorPrefix20210112\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
    ...
    public function deleteItems(array $keys) : bool
    {
        ...
        foreach ($ids as $key => $id) {
            ...
            \RectorPrefix20210112\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['key' => $key, 'exception' => $e, 'cache-adapter' => \get_debug_type($this)]);
            $ok = \false;
        }
        return $ok;
    }
