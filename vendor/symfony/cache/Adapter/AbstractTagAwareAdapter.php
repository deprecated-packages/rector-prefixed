 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \_PhpScoperbf340cb0be9d\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \_PhpScoperbf340cb0be9d\Symfony\Contracts\Cache\TagAwareCacheInterface, \_PhpScoperbf340cb0be9d\Psr\Log\LoggerAwareInterface, \_PhpScoperbf340cb0be9d\Symfony\Component\Cache\ResettableInterface
{
    ...
    protected function __construct(string $namespace = '', int $defaultLifetime = 0)
    {
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\_PhpScoperbf340cb0be9d\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\_PhpScoperbf340cb0be9d\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\_PhpScoperbf340cb0be9d\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\_PhpScoperbf340cb0be9d\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
