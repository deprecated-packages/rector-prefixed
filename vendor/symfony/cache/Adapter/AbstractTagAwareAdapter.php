...
use _PhpScoper8b9c402c5f32\Symfony\Contracts\Cache\TagAwareCacheInterface;
/**
 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \_PhpScoper8b9c402c5f32\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \_PhpScoper8b9c402c5f32\Symfony\Contracts\Cache\TagAwareCacheInterface, \_PhpScoper8b9c402c5f32\Psr\Log\LoggerAwareInterface, \_PhpScoper8b9c402c5f32\Symfony\Component\Cache\ResettableInterface
{
    ...
    protected function __construct(string $namespace = '', int $defaultLifetime = 0)
    {
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\_PhpScoper8b9c402c5f32\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\_PhpScoper8b9c402c5f32\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\_PhpScoper8b9c402c5f32\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\_PhpScoper8b9c402c5f32\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
    ...
    public function deleteItems(array $keys) : bool
    {
        ...
        foreach ($ids as $key => $id) {
            ...
            \_PhpScoper8b9c402c5f32\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['key' => $key, 'exception' => $e, 'cache-adapter' => \get_debug_type($this)]);
            $ok = \false;
        }
        return $ok;
    }
