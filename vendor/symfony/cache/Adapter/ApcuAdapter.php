 ...
 */
class ApcuAdapter extends \RectorPrefix20210219\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    /**
    ...
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $version = null)
    {
        if (!static::isSupported()) {
            throw new \RectorPrefix20210219\Symfony\Component\Cache\Exception\CacheException('APCu is not enabled.');
        }
        if ('cli' === \PHP_SAPI) {
        ...
        if (null !== $version) {
            \RectorPrefix20210219\Symfony\Component\Cache\CacheItem::validateKey($version);
