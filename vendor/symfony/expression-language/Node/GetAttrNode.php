 ...
 * @internal
 */
class GetAttrNode extends \RectorPrefix20210212\Symfony\Component\ExpressionLanguage\Node\Node
{
    public const PROPERTY_CALL = 1;
    public const METHOD_CALL = 2;
    public const ARRAY_CALL = 3;
    public function __construct(\RectorPrefix20210212\Symfony\Component\ExpressionLanguage\Node\Node $node, \RectorPrefix20210212\Symfony\Component\ExpressionLanguage\Node\Node $attribute, \RectorPrefix20210212\Symfony\Component\ExpressionLanguage\Node\ArrayNode $arguments, int $type)
    {
