 ...
 * @internal
 */
class UnaryNode extends \RectorPrefix20210301\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \RectorPrefix20210301\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
