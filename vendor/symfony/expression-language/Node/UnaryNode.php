 ...
 * @internal
 */
class UnaryNode extends \RectorPrefix20210125\Symfony\Component\ExpressionLanguage\Node\Node
{
    private static $operators = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \RectorPrefix20210125\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
