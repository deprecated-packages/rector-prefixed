 ...
 * @internal
 */
class FunctionNode extends \RectorPrefix20210211\Symfony\Component\ExpressionLanguage\Node\Node
{
    public function __construct(string $name, \RectorPrefix20210211\Symfony\Component\ExpressionLanguage\Node\Node $arguments)
    {
