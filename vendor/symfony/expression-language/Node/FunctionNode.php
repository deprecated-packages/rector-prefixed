 ...
 * @internal
 */
class FunctionNode extends \RectorPrefix20210218\Symfony\Component\ExpressionLanguage\Node\Node
{
    public function __construct(string $name, \RectorPrefix20210218\Symfony\Component\ExpressionLanguage\Node\Node $arguments)
    {
