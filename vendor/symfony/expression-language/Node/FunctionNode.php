 ...
 * @internal
 */
class FunctionNode extends \RectorPrefix20210125\Symfony\Component\ExpressionLanguage\Node\Node
{
    public function __construct(string $name, \RectorPrefix20210125\Symfony\Component\ExpressionLanguage\Node\Node $arguments)
    {
