 ...
 * @internal
 */
class BinaryNode extends \RectorPrefix20210211\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['~' => '.', 'and' => '&&', 'or' => '||'];
    private const FUNCTIONS = ['**' => 'pow', '..' => 'range', 'in' => 'in_array', 'not in' => '!in_array'];
    public function __construct(string $operator, \RectorPrefix20210211\Symfony\Component\ExpressionLanguage\Node\Node $left, \RectorPrefix20210211\Symfony\Component\ExpressionLanguage\Node\Node $right)
    {
