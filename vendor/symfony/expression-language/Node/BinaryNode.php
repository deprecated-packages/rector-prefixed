 ...
 * @internal
 */
class BinaryNode extends \RectorPrefix20210125\Symfony\Component\ExpressionLanguage\Node\Node
{
    private static $operators = ['~' => '.', 'and' => '&&', 'or' => '||'];
    private static $functions = ['**' => 'pow', '..' => 'range', 'in' => 'in_array', 'not in' => '!in_array'];
    public function __construct(string $operator, \RectorPrefix20210125\Symfony\Component\ExpressionLanguage\Node\Node $left, \RectorPrefix20210125\Symfony\Component\ExpressionLanguage\Node\Node $right)
    {
