...
use RectorPrefix2020DecSat\Symfony\Contracts\HttpClient\Test\HttpClientTestCase;
/**
...
interface HttpClientInterface
{
     ...
     */
    public function request(string $method, string $url, array $options = []) : \RectorPrefix2020DecSat\Symfony\Contracts\HttpClient\ResponseInterface;
    /**
     ...
     */
    public function stream($responses, float $timeout = null) : \RectorPrefix2020DecSat\Symfony\Contracts\HttpClient\ResponseStreamInterface;
}
