...
if (!\function_exists('normalizer_is_normalized')) {
    function normalizer_is_normalized($string, $form = \RectorPrefix20210130\Symfony\Polyfill\Intl\Normalizer\Normalizer::FORM_C)
    {
        return \RectorPrefix20210130\Symfony\Polyfill\Intl\Normalizer\Normalizer::isNormalized($string, $form);
    }
}
if (!\function_exists('normalizer_normalize')) {
    function normalizer_normalize($string, $form = \RectorPrefix20210130\Symfony\Polyfill\Intl\Normalizer\Normalizer::FORM_C)
    {
