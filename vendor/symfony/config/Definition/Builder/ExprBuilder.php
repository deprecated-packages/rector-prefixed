...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\RectorPrefix20210206\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \RectorPrefix20210206\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key.');
        };
        return $this;
    }
    /**
