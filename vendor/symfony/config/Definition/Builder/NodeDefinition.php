 ...
 */
abstract class NodeDefinition implements \RectorPrefix20210501\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $name;
    ...
    protected $pathSeparator = \RectorPrefix20210501\Symfony\Component\Config\Definition\BaseNode::DEFAULT_PATH_SEPARATOR;
    protected $parent;
     ...
     * @return $this
     */
    public function setParent(\RectorPrefix20210501\Symfony\Component\Config\Definition\Builder\NodeParentInterface $parent)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    public function getNode(bool $forceRootNode = \false)
    {
        ...
        if (null !== $this->normalization) {
            $this->normalization->before = \RectorPrefix20210501\Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->normalization->before);
        }
    ...
    {
        if (null === $this->validation) {
            $this->validation = new \RectorPrefix20210501\Symfony\Component\Config\Definition\Builder\ValidationBuilder($this);
        }
    ...
    {
        if (null === $this->merge) {
            $this->merge = new \RectorPrefix20210501\Symfony\Component\Config\Definition\Builder\MergeBuilder($this);
        }
        return $this->merge;
    }
    /**
    ...
    {
        if (null === $this->normalization) {
            $this->normalization = new \RectorPrefix20210501\Symfony\Component\Config\Definition\Builder\NormalizationBuilder($this);
        }
    ...
    {
        if ($this instanceof \RectorPrefix20210501\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface) {
