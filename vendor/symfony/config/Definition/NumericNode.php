 ...
 */
class NumericNode extends \RectorPrefix20210423\Symfony\Component\Config\Definition\ScalarNode
{
    protected $min;
    protected $max;
    /**
    ...
    protected function finalizeValue($value)
    {
        ...
        if (isset($errorMsg)) {
            $ex = new \RectorPrefix20210423\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException($errorMsg);
