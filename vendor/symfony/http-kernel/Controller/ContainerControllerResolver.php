 ...
 */
class ContainerControllerResolver extends \_PhpScoper267b3276efc2\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper267b3276efc2\Psr\Container\ContainerInterface $container, \_PhpScoper267b3276efc2\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper267b3276efc2\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
