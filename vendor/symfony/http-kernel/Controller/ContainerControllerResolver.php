 ...
 */
class ContainerControllerResolver extends \RectorPrefix20201228\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20201228\Psr\Container\ContainerInterface $container, \RectorPrefix20201228\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20201228\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
