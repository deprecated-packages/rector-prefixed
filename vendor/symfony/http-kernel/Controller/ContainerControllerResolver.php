 ...
 */
class ContainerControllerResolver extends \RectorPrefix20210419\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20210419\Psr\Container\ContainerInterface $container, \RectorPrefix20210419\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20210419\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
