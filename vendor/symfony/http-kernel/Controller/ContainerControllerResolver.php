 ...
 */
class ContainerControllerResolver extends \_PhpScoper006a73f0e455\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper006a73f0e455\Psr\Container\ContainerInterface $container, \_PhpScoper006a73f0e455\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper006a73f0e455\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
