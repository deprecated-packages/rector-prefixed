 ...
 */
class ContainerControllerResolver extends \_PhpScoperf18a0c41e2d2\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf18a0c41e2d2\Psr\Container\ContainerInterface $container, \_PhpScoperf18a0c41e2d2\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf18a0c41e2d2\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
