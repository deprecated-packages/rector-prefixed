 ...
 */
class ContainerControllerResolver extends \_PhpScoper17db12703726\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper17db12703726\Psr\Container\ContainerInterface $container, \_PhpScoper17db12703726\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper17db12703726\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
