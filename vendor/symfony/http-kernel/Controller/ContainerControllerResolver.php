 ...
 */
class ContainerControllerResolver extends \_PhpScoper0a6b37af0871\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper0a6b37af0871\Psr\Container\ContainerInterface $container, \_PhpScoper0a6b37af0871\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper0a6b37af0871\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
