 ...
 */
class ContainerControllerResolver extends \_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperbd5d0c5f7638\Psr\Container\ContainerInterface $container, \_PhpScoperbd5d0c5f7638\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperbd5d0c5f7638\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
