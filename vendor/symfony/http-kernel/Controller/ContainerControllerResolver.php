 ...
 */
class ContainerControllerResolver extends \RectorPrefix20210127\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20210127\Psr\Container\ContainerInterface $container, \RectorPrefix20210127\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20210127\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
