 ...
 */
class ContainerControllerResolver extends \_PhpScoper567b66d83109\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper567b66d83109\Psr\Container\ContainerInterface $container, \_PhpScoper567b66d83109\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper567b66d83109\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
