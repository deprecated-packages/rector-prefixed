 ...
 */
class ContainerControllerResolver extends \RectorPrefix20201229\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20201229\Psr\Container\ContainerInterface $container, \RectorPrefix20201229\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20201229\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
