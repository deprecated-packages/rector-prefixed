 ...
 */
class ContainerControllerResolver extends \_PhpScopera143bcca66cb\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera143bcca66cb\Psr\Container\ContainerInterface $container, \_PhpScopera143bcca66cb\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera143bcca66cb\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
