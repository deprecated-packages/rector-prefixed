 ...
 */
class ContainerControllerResolver extends \_PhpScoper5edc98a7cce2\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper5edc98a7cce2\Psr\Container\ContainerInterface $container, \_PhpScoper5edc98a7cce2\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
