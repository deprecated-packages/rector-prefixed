 ...
 */
class ContainerControllerResolver extends \_PhpScoper88fe6e0ad041\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper88fe6e0ad041\Psr\Container\ContainerInterface $container, \_PhpScoper88fe6e0ad041\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper88fe6e0ad041\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
