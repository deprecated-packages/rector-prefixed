 ...
 */
class ContainerControllerResolver extends \_PhpScoperbf340cb0be9d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperbf340cb0be9d\Psr\Container\ContainerInterface $container, \_PhpScoperbf340cb0be9d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperbf340cb0be9d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
