 ...
 */
class ContainerControllerResolver extends \_PhpScoper26e51eeacccf\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper26e51eeacccf\Psr\Container\ContainerInterface $container, \_PhpScoper26e51eeacccf\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper26e51eeacccf\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
