 ...
 */
class ContainerControllerResolver extends \_PhpScoperb75b35f52b74\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperb75b35f52b74\Psr\Container\ContainerInterface $container, \_PhpScoperb75b35f52b74\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperb75b35f52b74\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
