 ...
 */
class ContainerControllerResolver extends \_PhpScopere8e811afab72\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere8e811afab72\Psr\Container\ContainerInterface $container, \_PhpScopere8e811afab72\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere8e811afab72\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
