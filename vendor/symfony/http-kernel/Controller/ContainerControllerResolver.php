 ...
 */
class ContainerControllerResolver extends \RectorPrefix20210107\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20210107\Psr\Container\ContainerInterface $container, \RectorPrefix20210107\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20210107\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
