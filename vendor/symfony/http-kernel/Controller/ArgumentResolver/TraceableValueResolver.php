 ...
 */
final class TraceableValueResolver implements \_PhpScopera143bcca66cb\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopera143bcca66cb\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopera143bcca66cb\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;
