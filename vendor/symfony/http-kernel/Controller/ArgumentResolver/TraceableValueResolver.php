 ...
 */
final class TraceableValueResolver implements \_PhpScopere8e811afab72\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopere8e811afab72\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopere8e811afab72\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;
