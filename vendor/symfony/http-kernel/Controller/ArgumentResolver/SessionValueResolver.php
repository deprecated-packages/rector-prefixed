 ...
 */
final class SessionValueResolver implements \_PhpScoper0a2ac50786fa\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\Request $request, \_PhpScoper0a2ac50786fa\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoper0a2ac50786fa\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
