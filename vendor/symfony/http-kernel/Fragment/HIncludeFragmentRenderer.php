...
use _PhpScoperfce0de0de1ce\Twig\Environment;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \_PhpScoperfce0de0de1ce\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
     ...
     */
    public function __construct(\_PhpScoperfce0de0de1ce\Twig\Environment $twig = null, \_PhpScoperfce0de0de1ce\Symfony\Component\HttpKernel\UriSigner $signer = null, string $globalDefaultTemplate = null, string $charset = 'utf-8')
    {
        $this->twig = $twig;
    ...
    public function render($uri, \_PhpScoperfce0de0de1ce\Symfony\Component\HttpFoundation\Request $request, array $options = [])
    {
        ...
        return new \_PhpScoperfce0de0de1ce\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
     * {@inheritdoc}
     */
