...
use RectorPrefix20210317\Twig\Environment;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \RectorPrefix20210317\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
    ...
    public function render($uri, \RectorPrefix20210317\Symfony\Component\HttpFoundation\Request $request, array $options = [])
    {
        ...
        return new \RectorPrefix20210317\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
     * {@inheritdoc}
     */
