...
use RectorPrefix20210317\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface;
use RectorPrefix20210317\Symfony\Component\HttpKernel\UriSigner;
/**
 * Implements Surrogate rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
abstract class AbstractSurrogateFragmentRenderer extends \RectorPrefix20210317\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
    private $surrogate;
    ...
    public function render($uri, \RectorPrefix20210317\Symfony\Component\HttpFoundation\Request $request, array $options = [])
    {
        if (!$this->surrogate || !$this->surrogate->hasSurrogateCapability($request)) {
            if ($uri instanceof \RectorPrefix20210317\Symfony\Component\HttpKernel\Controller\ControllerReference && $this->containsNonScalars($uri->attributes)) {
        ...
        if ($alt instanceof \RectorPrefix20210317\Symfony\Component\HttpKernel\Controller\ControllerReference) {
