 ...
 */
class FileProfilerStorage implements \RectorPrefix20210318\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\RectorPrefix20210318\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\RectorPrefix20210318\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\RectorPrefix20210318\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
