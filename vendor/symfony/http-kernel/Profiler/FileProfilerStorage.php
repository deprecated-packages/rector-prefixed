 ...
 */
class FileProfilerStorage implements \RectorPrefix20210331\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\RectorPrefix20210331\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\RectorPrefix20210331\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\RectorPrefix20210331\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \RectorPrefix20210331\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \RectorPrefix20210331\Symfony\Component\HttpKernel\Profiler\Profile($token);
