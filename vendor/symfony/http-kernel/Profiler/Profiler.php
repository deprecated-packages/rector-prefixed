 ...
 */
class Profiler implements \RectorPrefix20210317\Symfony\Contracts\Service\ResetInterface
{
    private $storage;
    /**
    ...
    private $enabled = \true;
    public function __construct(\RectorPrefix20210317\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface $storage, \RectorPrefix20210317\Psr\Log\LoggerInterface $logger = null, bool $enable = \true)
    {
     ...
     */
    public function loadProfileFromResponse(\RectorPrefix20210317\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * @return bool
     */
    public function saveProfile(\RectorPrefix20210317\Symfony\Component\HttpKernel\Profiler\Profile $profile)
    {
        // late collect
        foreach ($profile->getCollectors() as $collector) {
            if ($collector instanceof \RectorPrefix20210317\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface) {
    ...
    public function collect(\RectorPrefix20210317\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210317\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        $profile = new \RectorPrefix20210317\Symfony\Component\HttpKernel\Profiler\Profile(\substr(\hash('sha256', \uniqid(\mt_rand(), \true)), 0, 6));
        $profile->setTime(\time());
        ...
        } catch (\RectorPrefix20210317\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException $e) {
     ...
     * Adds a Collector.
     */
    public function add(\RectorPrefix20210317\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface $collector)
    {
