...
use RectorPrefix20210317\Symfony\Component\Console\ConsoleEvents;
use RectorPrefix20210317\Symfony\Component\Console\Event\ConsoleEvent;
...
use RectorPrefix20210317\Symfony\Component\HttpKernel\Event\KernelEvent;
 ...
 * @final
 */
class DebugHandlersListener implements \RectorPrefix20210317\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function configure(object $event = null)
    {
        ...
        if (!$event instanceof \RectorPrefix20210317\Symfony\Component\HttpKernel\Event\KernelEvent ? !$this->firstCall : !$event->isMasterRequest()) {
            return;
        }
        ...
        \restore_exception_handler();
        if (!$handler instanceof \RectorPrefix20210317\Symfony\Component\ErrorHandler\ErrorHandler) {
        ...
        if (!$this->exceptionHandler) {
            if ($event instanceof \RectorPrefix20210317\Symfony\Component\HttpKernel\Event\KernelEvent) {
            ...
            } elseif ($event instanceof \RectorPrefix20210317\Symfony\Component\Console\Event\ConsoleEvent && ($app = $event->getCommand()->getApplication())) {
    ...
    {
        $events = [\RectorPrefix20210317\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['configure', 2048]];
        if (\defined('Symfony\\Component\\Console\\ConsoleEvents::COMMAND')) {
            $events[\RectorPrefix20210317\Symfony\Component\Console\ConsoleEvents::COMMAND] = ['configure', 2048];
        }
        return $events;
    }
}
