...
use RectorPrefix20210317\Symfony\Component\HttpKernel\HttpCache\HttpCache;
...
class SurrogateListener implements \RectorPrefix20210317\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function onKernelResponse($event)
    {
        ...
        if ($kernel instanceof \RectorPrefix20210317\Symfony\Component\HttpKernel\HttpCache\HttpCache) {
    ...
    {
        return [\RectorPrefix20210317\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
}
