...
use _PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\HttpCache\HttpCache;
...
{
    private $surrogate;
    public function __construct(\_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        ...
        if ($kernel instanceof \_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\HttpCache\HttpCache) {
