...
use _PhpScoper88fe6e0ad041\Symfony\Component\HttpKernel\HttpCache\HttpCache;
...
{
    private $surrogate;
    public function __construct(\_PhpScoper88fe6e0ad041\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\_PhpScoper88fe6e0ad041\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        ...
        if ($kernel instanceof \_PhpScoper88fe6e0ad041\Symfony\Component\HttpKernel\HttpCache\HttpCache) {
