...
use _PhpScoper0a6b37af0871\Symfony\Component\HttpKernel\HttpCache\HttpCache;
 ...
 * @final
 */
class SurrogateListener implements \_PhpScoper0a6b37af0871\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\_PhpScoper0a6b37af0871\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\_PhpScoper0a6b37af0871\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        ...
        if ($kernel instanceof \_PhpScoper0a6b37af0871\Symfony\Component\HttpKernel\HttpCache\HttpCache) {
