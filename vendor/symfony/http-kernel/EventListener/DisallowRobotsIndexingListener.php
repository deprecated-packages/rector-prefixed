 ...
 */
class DisallowRobotsIndexingListener implements \RectorPrefix20210421\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    const HEADER_NAME = 'X-Robots-Tag';
    /**
     * @return void
     */
    public function onResponse(\RectorPrefix20210421\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
    ...
    {
        return [\RectorPrefix20210421\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onResponse', -255]];
    }
}
