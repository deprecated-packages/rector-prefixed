 ...
 * @final
 */
class AddRequestFormatsListener implements \RectorPrefix20210318\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\RectorPrefix20210318\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
