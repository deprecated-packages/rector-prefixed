 ...
 * @final
 */
class AddRequestFormatsListener implements \RectorPrefix20201228\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\RectorPrefix20201228\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
