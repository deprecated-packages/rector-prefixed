 ...
 * @final
 */
class AddRequestFormatsListener implements \_PhpScoper17db12703726\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoper17db12703726\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
