 ...
 * @final
 */
class TestSessionListener extends \_PhpScoper88fe6e0ad041\Symfony\Component\HttpKernel\EventListener\AbstractTestSessionListener
{
    private $container;
    public function __construct(\_PhpScoper88fe6e0ad041\Psr\Container\ContainerInterface $container, array $sessionOptions = [])
    {
