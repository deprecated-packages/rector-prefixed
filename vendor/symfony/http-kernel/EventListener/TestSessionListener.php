 ...
 * @final
 */
class TestSessionListener extends \_PhpScoper2a4e7ab1ecbc\Symfony\Component\HttpKernel\EventListener\AbstractTestSessionListener
{
    private $container;
    public function __construct(\_PhpScoper2a4e7ab1ecbc\Psr\Container\ContainerInterface $container, array $sessionOptions = [])
    {
