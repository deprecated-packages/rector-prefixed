...
use RectorPrefix20210317\Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException;
 ...
 * @final
 */
class FragmentListener implements \RectorPrefix20210317\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $signer;
    ...
    protected function validateRequest($request)
    {
        ...
        if (!$request->isMethodSafe()) {
            throw new \RectorPrefix20210317\Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException();
        }
    ...
    {
        return [\RectorPrefix20210317\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 48]]];
    }
}
