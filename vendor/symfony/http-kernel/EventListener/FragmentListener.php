...
use _PhpScoper006a73f0e455\Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException;
...
class FragmentListener implements \Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct(\_PhpScoper006a73f0e455\Symfony\Component\HttpKernel\UriSigner $signer, string $fragmentPath = '/_fragment')
    {
        $this->signer = $signer;
    ...
    protected function validateRequest(\_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Request $request)
    {
        // is the Request safe?
        if (!$request->isMethodSafe()) {
            throw new \_PhpScoper006a73f0e455\Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException();
        }
    ...
    {
        return [\_PhpScoper006a73f0e455\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 48]]];
    }
}
