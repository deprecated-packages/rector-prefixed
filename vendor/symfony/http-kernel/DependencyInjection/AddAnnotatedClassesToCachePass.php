 ...
 */
class AddAnnotatedClassesToCachePass implements \RectorPrefix20210502\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\RectorPrefix20210502\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process(\RectorPrefix20210502\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \RectorPrefix20210502\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
