 ...
 */
namespace RectorPrefix20210127\Symfony\Component\HttpKernel\Log;
            ...
            if (isset($_ENV['SHELL_VERBOSITY']) || isset($_SERVER['SHELL_VERBOSITY'])) {
                switch ((int) ($_ENV['SHELL_VERBOSITY'] ?? $_SERVER['SHELL_VERBOSITY'])) {
                    case -1:
                        ...
                        break;
                    case 1:
                        $minLevel = \RectorPrefix20210127\Psr\Log\LogLevel::NOTICE;
                        break;
                    case 2:
                        $minLevel = \RectorPrefix20210127\Psr\Log\LogLevel::INFO;
                        break;
                    case 3:
                        $minLevel = \RectorPrefix20210127\Psr\Log\LogLevel::DEBUG;
                        break;
                }
            }
        }
