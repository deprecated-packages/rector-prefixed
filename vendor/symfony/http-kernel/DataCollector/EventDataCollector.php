...
use _PhpScoperfce0de0de1ce\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher;
 ...
 * @final
 */
class EventDataCollector extends \_PhpScoperfce0de0de1ce\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScoperfce0de0de1ce\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $dispatcher;
    private $requestStack;
    private $currentRequest;
    public function __construct(\_PhpScoperfce0de0de1ce\Symfony\Contracts\EventDispatcher\EventDispatcherInterface $dispatcher = null, \_PhpScoperfce0de0de1ce\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
    ...
    {
        $this->data = [];
        if ($this->dispatcher instanceof \_PhpScoperfce0de0de1ce\Symfony\Contracts\Service\ResetInterface) {
            $this->dispatcher->reset();
        }
    }
    public function lateCollect()
    {
        if ($this->dispatcher instanceof \_PhpScoperfce0de0de1ce\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher) {
