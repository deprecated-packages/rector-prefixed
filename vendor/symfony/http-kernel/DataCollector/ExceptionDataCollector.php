 ...
 * @final
 */
class ExceptionDataCollector extends \_PhpScoper5b8c9e9ebd21\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoper5b8c9e9ebd21\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
