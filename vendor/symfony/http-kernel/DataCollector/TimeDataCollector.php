...
use RectorPrefix20210503\Symfony\Component\Stopwatch\StopwatchEvent;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 *
 * @final
 */
class TimeDataCollector extends \RectorPrefix20210503\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \RectorPrefix20210503\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $kernel;
    protected $stopwatch;
    public function __construct(\RectorPrefix20210503\Symfony\Component\HttpKernel\KernelInterface $kernel = null, \RectorPrefix20210503\Symfony\Component\Stopwatch\Stopwatch $stopwatch = null)
    {
        $this->kernel = $kernel;
    ...
    public function collect(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210503\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        $this->data = ['token' => $response->headers->get('X-Debug-Token'), 'start_time' => $startTime * 1000, 'events' => [], 'stopwatch_installed' => \class_exists(\RectorPrefix20210503\Symfony\Component\Stopwatch\Stopwatch::class, \false)];
    }
    /**
     * {@inheritdoc}
     */
