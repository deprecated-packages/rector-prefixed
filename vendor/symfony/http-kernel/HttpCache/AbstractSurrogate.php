 ...
 */
abstract class AbstractSurrogate implements \_PhpScoper006a73f0e455\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScoper006a73f0e455\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        $subRequest = \_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Request::create($uri, \_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \_PhpScoper006a73f0e455\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Response $response)
    {
