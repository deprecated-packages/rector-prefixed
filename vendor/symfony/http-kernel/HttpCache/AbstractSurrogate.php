 ...
 */
abstract class AbstractSurrogate implements \RectorPrefix20210423\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \RectorPrefix20210423\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function handle(\RectorPrefix20210423\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, string $uri, string $alt, bool $ignoreErrors)
    {
        ...
        try {
            $response = $cache->handle($subRequest, \RectorPrefix20210423\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\RectorPrefix20210423\Symfony\Component\HttpFoundation\Response $response)
    {
