 ...
 */
abstract class AbstractSurrogate implements \RectorPrefix20210503\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    public function hasSurrogateCapability(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function addSurrogateCapability(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function needsParsing(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function handle(\RectorPrefix20210503\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, string $uri, string $alt, bool $ignoreErrors)
    {
        $subRequest = \RectorPrefix20210503\Symfony\Component\HttpFoundation\Request::create($uri, \RectorPrefix20210503\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \RectorPrefix20210503\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Response $response)
    {
