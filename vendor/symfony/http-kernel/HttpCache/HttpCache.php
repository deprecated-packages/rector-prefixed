 ...
 */
namespace RectorPrefix20210131\Symfony\Component\HttpKernel\HttpCache;
...
use RectorPrefix20210131\Symfony\Component\HttpKernel\HttpKernelInterface;
use RectorPrefix20210131\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \RectorPrefix20210131\Symfony\Component\HttpKernel\HttpKernelInterface, \RectorPrefix20210131\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\RectorPrefix20210131\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \RectorPrefix20210131\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \RectorPrefix20210131\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, int $type = \RectorPrefix20210131\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, bool $catch = \true)
    {
        ...
        if (\RectorPrefix20210131\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \RectorPrefix20210131\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     */
    protected function pass(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
     ...
     * @see RFC2616 13.10
     */
    protected function invalidate(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $response = $this->pass($request, $catch);
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \RectorPrefix20210131\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
     ...
     * @throws \Exception
     */
    protected function lookup(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        try {
     ...
     * @return Response A Response instance
     */
    protected function validate(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $entry, bool $catch = \false)
    {
     ...
     * @return Response A Response instance
     */
    protected function fetch(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $subRequest = clone $request;
        // send no head requests because we want content
        if ('HEAD' === $request->getMethod()) {
     ...
     * @return Response A Response instance
     */
    protected function forward(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false, \RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $entry = null)
    {
        if ($this->surrogate) {
            $this->surrogate->addSurrogateCapability($request);
        }
        // always a "master" request (as the real master request can be in cache)
        $response = \RectorPrefix20210131\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \RectorPrefix20210131\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $catch);
        /*
     ...
     */
    protected function isFreshEnough(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $entry)
    {
        if (!$entry->isFresh()) {
     ...
     */
    protected function lock(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $entry)
    {
     ...
     * @throws \Exception
     */
    protected function store(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $response)
    {
        try {
     ...
     */
    private function restoreResponseBody(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    protected function processResponseBody(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\RectorPrefix20210131\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
