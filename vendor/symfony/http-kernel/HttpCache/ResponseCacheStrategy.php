 ...
 */
class ResponseCacheStrategy implements \RectorPrefix2020DecSat\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategyInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function add(\RectorPrefix2020DecSat\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function update(\RectorPrefix2020DecSat\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function willMakeFinalResponseUncacheable(\RectorPrefix2020DecSat\Symfony\Component\HttpFoundation\Response $response) : bool
    {
