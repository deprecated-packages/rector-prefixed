 ...
 */
class ConsoleSectionOutput extends \_PhpScoperabd03f0baf05\Symfony\Component\Console\Output\StreamOutput
{
    private $content = [];
    private $lines = 0;
    private $sections;
     ...
     */
    public function __construct($stream, array &$sections, int $verbosity, bool $decorated, \_PhpScoperabd03f0baf05\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter)
    {
    ...
    {
        return \_PhpScoperabd03f0baf05\Symfony\Component\Console\Helper\Helper::strlenWithoutDecoration($this->getFormatter(), \str_replace("\t", '        ', $text));
    }
}
