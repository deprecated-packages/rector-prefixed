 ...
 */
class ConsoleSectionOutput extends \_PhpScoper0a2ac50786fa\Symfony\Component\Console\Output\StreamOutput
{
    private $content = [];
    private $lines = 0;
    private $sections;
     ...
     */
    public function __construct($stream, array &$sections, int $verbosity, bool $decorated, \_PhpScoper0a2ac50786fa\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter)
    {
    ...
    {
        return \_PhpScoper0a2ac50786fa\Symfony\Component\Console\Helper\Helper::strlenWithoutDecoration($this->getFormatter(), \str_replace("\t", '        ', $text));
    }
}
