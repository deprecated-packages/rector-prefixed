 ...
 * @internal
 */
class JsonDescriptor extends \_PhpScoperabd03f0baf05\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Application $application, array $options = [])
    {
        ...
        $description = new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputOption $option) : array
    {
    ...
    private function getInputDefinitionData(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Command\Command $command) : array
    {
        $command->getSynopsis();
