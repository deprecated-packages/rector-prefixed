 ...
 * @internal
 */
class JsonDescriptor extends \RectorPrefix20210423\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    private function getInputArgumentData(\RectorPrefix20210423\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\RectorPrefix20210423\Symfony\Component\Console\Input\InputOption $option) : array
    {
    ...
    private function getInputDefinitionData(\RectorPrefix20210423\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\RectorPrefix20210423\Symfony\Component\Console\Command\Command $command) : array
    {
