 ...
 */
namespace RectorPrefix20210420\Symfony\Component\Console\Logger;
...
class ConsoleLogger extends \RectorPrefix20210420\Psr\Log\AbstractLogger
{
    ...
    public function __construct(\RectorPrefix20210420\Symfony\Component\Console\Output\OutputInterface $output, array $verbosityLevelMap = [], array $formatLevelMap = [])
    {
        $this->output = $output;
