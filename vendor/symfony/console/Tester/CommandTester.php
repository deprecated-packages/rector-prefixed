...
class CommandTester
{
    ...
    private $input;
    private $statusCode;
    public function __construct(\RectorPrefix20210303\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function execute(array $input, array $options = [])
    {
        ...
        $this->input = new \RectorPrefix20210303\Symfony\Component\Console\Input\ArrayInput($input);
