 ...
 */
namespace RectorPrefix20210127\Symfony\Component\Console\Tester;
...
use RectorPrefix20210127\Symfony\Component\Console\Output\StreamOutput;
/**
...
trait TesterTrait
{
    ...
    private function initOutput(array $options)
    {
        ...
        if (!$this->captureStreamsIndependently) {
            $this->output = new \RectorPrefix20210127\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
