 ...
 */
namespace RectorPrefix20210503\Symfony\Component\Console\Tester;
...
trait TesterTrait
{
    ...
    private function initOutput(array $options)
    {
        ...
        if (!$this->captureStreamsIndependently) {
            $this->output = new \RectorPrefix20210503\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
            ...
            $this->output = new \RectorPrefix20210503\Symfony\Component\Console\Output\ConsoleOutput($options['verbosity'] ?? \RectorPrefix20210503\Symfony\Component\Console\Output\ConsoleOutput::VERBOSITY_NORMAL, $options['decorated'] ?? null);
            $errorOutput = new \RectorPrefix20210503\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
