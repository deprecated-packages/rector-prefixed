 ...
 */
abstract class Helper implements \RectorPrefix20210423\Symfony\Component\Console\Helper\HelperInterface
{
    ...
    public static function strlen($string)
    {
        ...
        if (\preg_match('//u', $string)) {
            return (new \RectorPrefix20210423\Symfony\Component\String\UnicodeString($string))->width(\false);
        }
    ...
    public static function strlenWithoutDecoration(\RectorPrefix20210423\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter, $string)
    {
        ...
        if (\preg_match('//u', $string)) {
            return (new \RectorPrefix20210423\Symfony\Component\String\UnicodeString($string))->width(\true);
        }
