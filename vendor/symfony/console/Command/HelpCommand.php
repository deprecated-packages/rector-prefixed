 ...
 */
class HelpCommand extends \RectorPrefix20210504\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
    ...
    protected function configure()
    {
        ...
        $this->setName('help')->setDefinition([new \RectorPrefix20210504\Symfony\Component\Console\Input\InputArgument('command_name', \RectorPrefix20210504\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The command name', 'help'), new \RectorPrefix20210504\Symfony\Component\Console\Input\InputOption('format', null, \RectorPrefix20210504\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \RectorPrefix20210504\Symfony\Component\Console\Input\InputOption('raw', null, \RectorPrefix20210504\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command help')])->setDescription('Display help for a command')->setHelp(<<<'EOF'
...
EOF
    ...
    public function setCommand(\RectorPrefix20210504\Symfony\Component\Console\Command\Command $command)
    {
