 ...
 */
class HelpCommand extends \_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
    ...
    protected function configure()
    {
        ...
        $this->setName('help')->setDefinition([new \_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Input\InputArgument('command_name', \_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The command name', 'help'), new \_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Input\InputOption('format', null, \_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Input\InputOption('raw', null, \_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command help')])->setDescription('Displays help for a command')->setHelp(<<<'EOF'
...
EOF
    ...
    public function setCommand(\_PhpScoper5b8c9e9ebd21\Symfony\Component\Console\Command\Command $command)
    {
