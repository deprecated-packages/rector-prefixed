 ...
 */
class HelpCommand extends \_PhpScoperfce0de0de1ce\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
    ...
    protected function configure()
    {
        ...
        $this->setName('help')->setDefinition([new \_PhpScoperfce0de0de1ce\Symfony\Component\Console\Input\InputArgument('command_name', \_PhpScoperfce0de0de1ce\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The command name', 'help'), new \_PhpScoperfce0de0de1ce\Symfony\Component\Console\Input\InputOption('format', null, \_PhpScoperfce0de0de1ce\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \_PhpScoperfce0de0de1ce\Symfony\Component\Console\Input\InputOption('raw', null, \_PhpScoperfce0de0de1ce\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command help')])->setDescription('Displays help for a command')->setHelp(<<<'EOF'
...
EOF
    ...
    public function setCommand(\_PhpScoperfce0de0de1ce\Symfony\Component\Console\Command\Command $command)
    {
