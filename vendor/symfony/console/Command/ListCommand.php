 ...
 */
class ListCommand extends \RectorPrefix20210503\Symfony\Component\Console\Command\Command
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->setName('list')->setDefinition([new \RectorPrefix20210503\Symfony\Component\Console\Input\InputArgument('namespace', \RectorPrefix20210503\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The namespace name'), new \RectorPrefix20210503\Symfony\Component\Console\Input\InputOption('raw', null, \RectorPrefix20210503\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command list'), new \RectorPrefix20210503\Symfony\Component\Console\Input\InputOption('format', null, \RectorPrefix20210503\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt')])->setDescription('List commands')->setHelp(<<<'EOF'
