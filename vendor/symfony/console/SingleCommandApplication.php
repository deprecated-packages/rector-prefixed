 ...
 */
class SingleCommandApplication extends \RectorPrefix20210502\Symfony\Component\Console\Command\Command
{
    ...
    public function run($input = null, $output = null) : int
    {
        ...
        $application = new \RectorPrefix20210502\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
