...
use RectorPrefix20210317\Psr\Container\ContainerExceptionInterface;
use RectorPrefix20210317\Psr\Container\NotFoundExceptionInterface;
...
use RectorPrefix20210317\Symfony\Contracts\Service\ServiceLocatorTrait;
 ...
 */
class ServiceLocator implements \RectorPrefix20210317\Symfony\Contracts\Service\ServiceProviderInterface
{
    ...
    private function createNotFoundException($id) : \RectorPrefix20210317\Psr\Container\NotFoundExceptionInterface
    {
        if ($this->loading) {
            ...
            return new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \RectorPrefix20210317\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
