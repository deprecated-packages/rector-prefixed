...
use RectorPrefix20210318\Psr\Container\ContainerExceptionInterface;
use RectorPrefix20210318\Psr\Container\NotFoundExceptionInterface;
...
use RectorPrefix20210318\Symfony\Contracts\Service\ServiceLocatorTrait;
 ...
 */
class ServiceLocator implements \RectorPrefix20210318\Symfony\Contracts\Service\ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \RectorPrefix20210318\Symfony\Component\DependencyInjection\Container $container)
    {
        $locator = clone $this;
    ...
    private function createNotFoundException(string $id) : \RectorPrefix20210318\Psr\Container\NotFoundExceptionInterface
    {
        if ($this->loading) {
            ...
            return new \RectorPrefix20210318\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \RectorPrefix20210318\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
