 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoperbf340cb0be9d\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoperbf340cb0be9d\Symfony\Contracts\Service\Attribute\Required::class)) {
