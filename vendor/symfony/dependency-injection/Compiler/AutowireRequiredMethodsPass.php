 ...
 */
class AutowireRequiredMethodsPass extends \RectorPrefix20210419\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param bool $isRoot
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\RectorPrefix20210419\Symfony\Contracts\Service\Attribute\Required::class)) {
