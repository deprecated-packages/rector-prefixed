 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper567b66d83109\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper567b66d83109\Symfony\Contracts\Service\Attribute\Required::class)) {
