 ...
 */
class ResolveReferencesToAliasesPass extends \RectorPrefix20210317\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
    ...
    private function getDefinitionId($id, $container) : string
    {
        ...
        do {
            if (isset($seen[$id])) {
                throw new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
