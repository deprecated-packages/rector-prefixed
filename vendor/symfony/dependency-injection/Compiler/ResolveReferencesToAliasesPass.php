 ...
 */
class ResolveReferencesToAliasesPass extends \RectorPrefix20210203\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        return $defId !== $id ? new \RectorPrefix20210203\Symfony\Component\DependencyInjection\Reference($defId, $value->getInvalidBehavior()) : $value;
    }
    private function getDefinitionId(string $id, \RectorPrefix20210203\Symfony\Component\DependencyInjection\ContainerBuilder $container) : string
    {
        ...
        do {
            if (isset($seen[$id])) {
                throw new \RectorPrefix20210203\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
