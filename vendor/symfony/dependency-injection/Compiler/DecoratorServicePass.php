 ...
 */
class DecoratorServicePass extends \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($definitions as list($id, $definition)) {
            ...
            $invalidBehavior = $decoratedService[3] ?? \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Alias((string) $alias, \false));
                ...
                continue;
            } elseif (\_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $public = $definition->isPublic();
                $private = $definition->isPrivate();
            } else {
                throw new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($inner, $id);
            }
    ...
    {
        if ($value instanceof \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Reference && $this->innerId === (string) $value) {
            return new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Reference($this->currentId, $value->getInvalidBehavior());
        }
