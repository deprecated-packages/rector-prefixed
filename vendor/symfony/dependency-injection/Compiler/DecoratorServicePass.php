 ...
 */
class DecoratorServicePass extends \RectorPrefix20210408\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\RectorPrefix20210408\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($definitions as [$id, $definition]) {
            ...
            $invalidBehavior = $decoratedService[3] ?? \RectorPrefix20210408\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \RectorPrefix20210408\Symfony\Component\DependencyInjection\Alias((string) $alias, \false));
                ...
                continue;
            } elseif (\RectorPrefix20210408\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $public = $definition->isPublic();
                $private = $definition->isPrivate();
            } else {
                throw new \RectorPrefix20210408\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($inner, $id);
            }
    ...
    {
        if ($value instanceof \RectorPrefix20210408\Symfony\Component\DependencyInjection\Reference && $this->innerId === (string) $value) {
            return new \RectorPrefix20210408\Symfony\Component\DependencyInjection\Reference($this->currentId, $value->getInvalidBehavior());
        }
