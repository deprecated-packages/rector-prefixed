 ...
 */
class DecoratorServicePass extends \_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($definitions as [$id, $definition]) {
            ...
            $invalidBehavior = $decoratedService[3] ?? \_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\Alias((string) $alias, \false));
                ...
                continue;
            } elseif (\_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $public = $definition->isPublic();
                $private = $definition->isPrivate();
            } else {
                throw new \_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($inner, $id);
            }
    ...
    {
        if ($value instanceof \_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\Reference && $this->innerId === (string) $value) {
            return new \_PhpScoper5b8c9e9ebd21\Symfony\Component\DependencyInjection\Reference($this->currentId, $value->getInvalidBehavior());
        }
