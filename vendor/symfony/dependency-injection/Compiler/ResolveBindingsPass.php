 ...
 */
class ResolveBindingsPass extends \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        try {
            ...
            foreach ($this->unusedBindings as [$key, $serviceId, $bindingType, $file]) {
                ...
                if (\_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Argument\BoundArgument::DEFAULTS_BINDING === $bindingType) {
                    $message .= 'under "_defaults"';
                } elseif (\_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Argument\BoundArgument::INSTANCEOF_BINDING === $bindingType) {
                ...
                throw new \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException($message);
            }
        } finally {
            $this->usedBindings = [];
            $this->unusedBindings = [];
    ...
    {
        if ($value instanceof \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\TypedReference && $value->getType() === (string) $value) {
            // Already checked
        ...
        if (!$value instanceof \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Definition || !($bindings = $value->getBindings())) {
            return parent::processValue($value, $isRoot);
        }
        $bindingNames = [];
        ...
        foreach ($calls as $i => $call) {
            ...
            foreach ($reflectionMethod->getParameters() as $key => $parameter) {
                ...
                $typeHint = \_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\LazyProxy\ProxyHelper::getTypeHint($reflectionMethod, $parameter);
     ...
     * @return mixed
     */
    private function getBindingValue(\_PhpScoper5edc98a7cce2\Symfony\Component\DependencyInjection\Argument\BoundArgument $binding)
    {
