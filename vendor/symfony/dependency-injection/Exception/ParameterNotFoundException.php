 ...
 */
class ParameterNotFoundException extends \RectorPrefix20210317\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException implements \RectorPrefix20210317\Psr\Container\NotFoundExceptionInterface
{
    private $key;
    private $sourceId;
    private $sourceKey;
     ...
     */
    public function __construct($key, $sourceId = null, $sourceKey = null, $previous = null, $alternatives = [], $nonNestedAlternative = null)
    {
        $this->key = $key;
