 ...
 */
class PrototypeConfigurator extends \_PhpScoper88fe6e0ad041\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    const FACTORY = 'load';
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\_PhpScoper88fe6e0ad041\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, \_PhpScoper88fe6e0ad041\Symfony\Component\DependencyInjection\Loader\PhpFileLoader $loader, \_PhpScoper88fe6e0ad041\Symfony\Component\DependencyInjection\Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {
