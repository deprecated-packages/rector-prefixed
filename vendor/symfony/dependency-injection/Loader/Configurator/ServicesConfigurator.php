 ...
 */
class ServicesConfigurator extends \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractConfigurator
{
    ...
    public function __construct($container, $loader, &$instanceof, $path = null, &$anonymousCount = 0)
    {
        ...
        $this->path = $path;
        $this->anonymousHash = \RectorPrefix20210317\Symfony\Component\DependencyInjection\ContainerBuilder::hash($path ?: \mt_rand());
     ...
     */
    public final function defaults() : \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\DefaultsConfigurator
    {
        return new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\DefaultsConfigurator($this, $this->defaults = new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Definition(), $this->path);
    }
    /**
    ...
    public final function set($id, $class = null) : \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\ServiceConfigurator
    {
        ...
        $configurator = new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\ServiceConfigurator($this->container, $this->instanceof, \true, $this, $definition, $id, $defaults->getTags(), $this->path);
    ...
    public final function alias($id, $referencedId) : \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\AliasConfigurator
    {
        ...
        return new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\AliasConfigurator($this, $alias);
    }
    /**
    ...
    public final function stack($id, $services) : \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\AliasConfigurator
    {
        foreach ($services as $i => $service) {
            ...
            } elseif (!$service instanceof \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator) {
                throw new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('"%s()" expects a list of definitions as returned by "%s()" or "%s()", "%s" given at index "%s" for service "%s".', __METHOD__, \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator::FACTORY, \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator::FACTORY, $service instanceof \RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractConfigurator ? $service::FACTORY . '()' : \get_debug_type($service), $i, $id));
            }
        }
        $alias = $this->alias($id, '');
