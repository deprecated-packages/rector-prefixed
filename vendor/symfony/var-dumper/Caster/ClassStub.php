 ...
 */
class ClassStub extends \RectorPrefix20210302\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \RectorPrefix20210302\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \RectorPrefix20210302\Symfony\Component\VarDumper\Cloner\Stub(), \true, \RectorPrefix20210302\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \RectorPrefix20210302\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
