 ...
 */
class ClassStub extends \RectorPrefix2020DecSat\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \RectorPrefix2020DecSat\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \RectorPrefix2020DecSat\Symfony\Component\VarDumper\Cloner\Stub(), \true, \RectorPrefix2020DecSat\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \RectorPrefix2020DecSat\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
