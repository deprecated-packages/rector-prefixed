 ...
 */
class ClassStub extends \_PhpScoperbd5d0c5f7638\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \_PhpScoperbd5d0c5f7638\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \_PhpScoperbd5d0c5f7638\Symfony\Component\VarDumper\Cloner\Stub(), \true, \_PhpScoperbd5d0c5f7638\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \_PhpScoperbd5d0c5f7638\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
