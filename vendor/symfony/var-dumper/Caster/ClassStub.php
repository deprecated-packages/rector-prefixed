 ...
 */
class ClassStub extends \_PhpScoperabd03f0baf05\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \_PhpScoperabd03f0baf05\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \_PhpScoperabd03f0baf05\Symfony\Component\VarDumper\Cloner\Stub(), \true, \_PhpScoperabd03f0baf05\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \_PhpScoperabd03f0baf05\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
