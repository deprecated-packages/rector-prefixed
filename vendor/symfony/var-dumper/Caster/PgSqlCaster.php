...
class PgSqlCaster
{
    ...
    public static function castLink($link, array $a, \RectorPrefix20210127\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        ...
        $a['param'] = new \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\EnumStub($a['param']);
        return $a;
    }
    public static function castResult($result, array $a, \RectorPrefix20210127\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        ...
        for ($i = 0; $i < $fields; ++$i) {
            ...
            $a['fields'][] = new \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\EnumStub($field);
        }
        return $a;
    }
}
