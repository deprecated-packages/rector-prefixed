...
class RedisCaster
{
    ...
    {
        $prefix = \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
        return $a + [$prefix . 'hosts' => $c->_hosts(), $prefix . 'function' => \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\ClassStub::wrapCallable($c->_function()), $prefix . 'lastError' => $c->getLastError(), $prefix . 'options' => self::getRedisOptions($c)];
    }
    public static function castRedisCluster(\RedisCluster $c, array $a, \RectorPrefix20210127\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        $prefix = \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
     ...
     */
    private static function getRedisOptions($redis, array $options = []) : \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\EnumStub
    {
        ...
        if (\is_array($retry)) {
            foreach ($retry as &$v) {
                $v = new \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\ConstStub($v ? 'RETRY' : 'NORETRY', $v);
            }
        } else {
            $retry = new \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\ConstStub($retry ? 'RETRY' : 'NORETRY', $retry);
        }
        ...
        return new \RectorPrefix20210127\Symfony\Component\VarDumper\Caster\EnumStub($options);
    }
}
