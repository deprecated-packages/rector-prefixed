 ...
 * @final
 */
class CliDescriptor implements \_PhpScoper0a2ac50786fa\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoper0a2ac50786fa\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoper0a2ac50786fa\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoper0a2ac50786fa\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoper0a2ac50786fa\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoper0a2ac50786fa\Symfony\Component\Console\Input\ArrayInput([]), $output);
