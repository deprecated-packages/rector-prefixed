 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperabd03f0baf05\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperabd03f0baf05\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperabd03f0baf05\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \Symfony\Component\Console\Style\SymfonyStyle ? $output : new \Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperabd03f0baf05\Symfony\Component\Console\Input\ArrayInput([]), $output);
