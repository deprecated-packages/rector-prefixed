 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperbf340cb0be9d\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperbf340cb0be9d\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperbf340cb0be9d\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperbf340cb0be9d\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperbf340cb0be9d\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperbf340cb0be9d\Symfony\Component\Console\Input\ArrayInput([]), $output);
