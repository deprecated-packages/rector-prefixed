 ...
 * @final
 */
class CliDescriptor implements \_PhpScopere8e811afab72\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScopere8e811afab72\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScopere8e811afab72\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScopere8e811afab72\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScopere8e811afab72\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScopere8e811afab72\Symfony\Component\Console\Input\ArrayInput([]), $output);
