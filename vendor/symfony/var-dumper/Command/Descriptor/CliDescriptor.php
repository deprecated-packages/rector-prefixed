 ...
 * @final
 */
class CliDescriptor implements \RectorPrefix2020DecSat\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\RectorPrefix2020DecSat\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\RectorPrefix2020DecSat\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \RectorPrefix2020DecSat\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \RectorPrefix2020DecSat\Symfony\Component\Console\Style\SymfonyStyle(new \RectorPrefix2020DecSat\Symfony\Component\Console\Input\ArrayInput([]), $output);
