 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperbd5d0c5f7638\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperbd5d0c5f7638\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperbd5d0c5f7638\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \Symfony\Component\Console\Style\SymfonyStyle ? $output : new \Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperbd5d0c5f7638\Symfony\Component\Console\Input\ArrayInput([]), $output);
