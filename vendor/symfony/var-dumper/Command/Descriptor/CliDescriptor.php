 ...
 * @final
 */
class CliDescriptor implements \_PhpScoper26e51eeacccf\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoper26e51eeacccf\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoper26e51eeacccf\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \Symfony\Component\Console\Style\SymfonyStyle ? $output : new \Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoper26e51eeacccf\Symfony\Component\Console\Input\ArrayInput([]), $output);
