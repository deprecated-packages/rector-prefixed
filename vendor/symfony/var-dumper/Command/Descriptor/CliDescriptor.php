 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperf18a0c41e2d2\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperf18a0c41e2d2\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperf18a0c41e2d2\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperf18a0c41e2d2\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperf18a0c41e2d2\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperf18a0c41e2d2\Symfony\Component\Console\Input\ArrayInput([]), $output);
