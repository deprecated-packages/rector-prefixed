...
use _PhpScopera143bcca66cb\Twig\Template;
/**
 ...
 */
final class SourceContextProvider implements \_PhpScopera143bcca66cb\Symfony\Component\VarDumper\Dumper\ContextProvider\ContextProviderInterface
{
    private $limit;
    private $charset;
    private $projectDir;
    private $fileLinkFormatter;
    public function __construct(string $charset = null, string $projectDir = null, \_PhpScopera143bcca66cb\Symfony\Component\HttpKernel\Debug\FileLinkFormatter $fileLinkFormatter = null, int $limit = 9)
    {
    ...
    public function getContext() : ?array
    {
        ...
        for ($i = 2; $i < $this->limit; ++$i) {
            if (isset($trace[$i]['class'], $trace[$i]['function']) && 'dump' === $trace[$i]['function'] && \_PhpScopera143bcca66cb\Symfony\Component\VarDumper\VarDumper::class === $trace[$i]['class']) {
                ...
                while (++$i < $this->limit) {
                    if (isset($trace[$i]['function'], $trace[$i]['file']) && empty($trace[$i]['class']) && 0 !== \strpos($trace[$i]['function'], 'call_user_func')) {
                        ...
                        $line = $trace[$i]['line'];
                        break;
                    } elseif (isset($trace[$i]['object']) && $trace[$i]['object'] instanceof \_PhpScopera143bcca66cb\Twig\Template) {
    ...
    {
        $html = '';
        $dumper = new \_PhpScopera143bcca66cb\Symfony\Component\VarDumper\Dumper\HtmlDumper(function ($line) use(&$html) {
            $html .= $line;
        }, $this->charset);
