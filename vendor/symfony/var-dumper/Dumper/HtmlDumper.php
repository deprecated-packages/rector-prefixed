 ...
 */
class HtmlDumper extends \RectorPrefix20210422\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \RectorPrefix20210422\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     * {@inheritdoc}
     */
    public function dump(\RectorPrefix20210422\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, array $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\RectorPrefix20210422\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \RectorPrefix20210422\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\RectorPrefix20210422\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, bool $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \RectorPrefix20210422\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \RectorPrefix20210422\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
