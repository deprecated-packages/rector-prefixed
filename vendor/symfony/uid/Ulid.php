 ...
 */
class Ulid extends \RectorPrefix20210412\Symfony\Component\Uid\AbstractUid
{
    private static $time = '';
    private static $rand = [];
    ...
    {
        if (36 === \strlen($ulid) && \RectorPrefix20210412\Symfony\Component\Uid\Uuid::isValid($ulid)) {
            $ulid = (new \RectorPrefix20210412\Symfony\Component\Uid\Uuid($ulid))->toBinary();
        } elseif (22 === \strlen($ulid) && 22 === \strspn($ulid, \RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::BASE58[''])) {
            $ulid = \RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::fromBase($ulid, \RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::BASE58);
        }
        if (16 !== \strlen($ulid)) {
    ...
    public function getTime() : float
    {
        ...
        return \RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::toBase(\hex2bin($time), \RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::BASE10) / 1000;
    }
    private static function generate() : string
    {
        ...
        if (\PHP_INT_SIZE >= 8) {
            ...
            $time = \str_pad(\bin2hex(\RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::fromBase($time, \RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::BASE10)), 12, '0', \STR_PAD_LEFT);
