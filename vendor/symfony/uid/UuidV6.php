 ...
 */
class UuidV6 extends \RectorPrefix20210410\Symfony\Component\Uid\Uuid
{
    ...
    public function __construct(string $uuid = null)
    {
        if (null === $uuid) {
            ...
            $this->uid .= \sprintf('%06x%06x', self::$seed[0] ^ $node[1] | 0x10000, self::$seed[1] ^ $node[2]);
        } else {
    ...
    public function getTime() : float
    {
        ...
        return \RectorPrefix20210410\Symfony\Component\Uid\BinaryUtil::timeToFloat($time);
    }
