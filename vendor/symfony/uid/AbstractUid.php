...
abstract class AbstractUid implements \JsonSerializable
{
    ...
    {
        return \strtr(\sprintf('%022s', \RectorPrefix20210306\Symfony\Component\Uid\BinaryUtil::toBase($this->toBinary(), \RectorPrefix20210306\Symfony\Component\Uid\BinaryUtil::BASE58)), '0', '1');
    }
    /**
