 ...
 */
class ClassNotFoundErrorEnhancer implements \RectorPrefix20210502\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
     */
    public function enhance(\Throwable $error) : ?\Throwable
    {
        ...
        $message = !$error instanceof \RectorPrefix20210502\Symfony\Component\ErrorHandler\Error\FatalError ? $error->getMessage() : $error->getError()['message'];
        ...
        return new \RectorPrefix20210502\Symfony\Component\ErrorHandler\Error\ClassNotFoundError($message, $error);
    }
    /**
    ...
    private function getClassCandidates(string $class) : array
    {
        ...
        foreach ($functions as $function) {
            ...
            if ($function[0] instanceof \RectorPrefix20210502\Symfony\Component\ErrorHandler\DebugClassLoader) {
