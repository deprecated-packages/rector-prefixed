 ...
 */
namespace _PhpScoper006a73f0e455\Symfony\Component\ErrorHandler\Exception;
 ...
 */
class FlattenException extends \_PhpScoper006a73f0e455\Symfony\Component\Debug\Exception\FlattenException
{
    private $message;
    private $code;
    private $previous;
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = []) : self
    {
        ...
        if ($exception instanceof \_PhpScoper006a73f0e455\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Response::class) && isset(\_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \_PhpScoper006a73f0e455\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
        ...
        $e->setClass($exception instanceof \_PhpScoper006a73f0e455\Symfony\Component\Debug\Exception\FatalThrowableError ? $exception->getOriginalClassName() : \get_debug_type($exception));
     ...
     * @return $this
     */
    public final function setPrevious(\_PhpScoper006a73f0e455\Symfony\Component\Debug\Exception\FlattenException $previous) : self
    {
