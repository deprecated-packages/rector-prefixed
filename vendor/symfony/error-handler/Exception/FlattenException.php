 ...
 */
namespace _PhpScoperbd5d0c5f7638\Symfony\Component\ErrorHandler\Exception;
 ...
 */
class FlattenException extends \_PhpScoperbd5d0c5f7638\Symfony\Component\Debug\Exception\FlattenException
{
    private $message;
    private $code;
    private $previous;
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = []) : self
    {
        ...
        if ($exception instanceof \_PhpScoperbd5d0c5f7638\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \_PhpScoperbd5d0c5f7638\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\_PhpScoperbd5d0c5f7638\Symfony\Component\HttpFoundation\Response::class) && isset(\_PhpScoperbd5d0c5f7638\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \_PhpScoperbd5d0c5f7638\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
        ...
        $e->setClass($exception instanceof \_PhpScoperbd5d0c5f7638\Symfony\Component\Debug\Exception\FatalThrowableError ? $exception->getOriginalClassName() : \get_debug_type($exception));
     ...
     * @return $this
     */
    public final function setPrevious(\_PhpScoperbd5d0c5f7638\Symfony\Component\Debug\Exception\FlattenException $previous) : self
    {
