...
use _PhpScoperfce0de0de1ce\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoperfce0de0de1ce\Doctrine\Persistence\Proxy;
use _PhpScoperfce0de0de1ce\Mockery\MockInterface;
use _PhpScoperfce0de0de1ce\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperfce0de0de1ce\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperfce0de0de1ce\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoperfce0de0de1ce\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperfce0de0de1ce\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoperfce0de0de1ce\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperfce0de0de1ce\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperfce0de0de1ce\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperfce0de0de1ce\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperfce0de0de1ce\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperfce0de0de1ce\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperfce0de0de1ce\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperfce0de0de1ce\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
