...
use _PhpScoperbf340cb0be9d\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoperbf340cb0be9d\Doctrine\Persistence\Proxy;
use _PhpScoperbf340cb0be9d\Mockery\MockInterface;
use _PhpScoperbf340cb0be9d\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperbf340cb0be9d\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperbf340cb0be9d\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoperbf340cb0be9d\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperbf340cb0be9d\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoperbf340cb0be9d\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperbf340cb0be9d\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbf340cb0be9d\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbf340cb0be9d\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbf340cb0be9d\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbf340cb0be9d\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbf340cb0be9d\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperbf340cb0be9d\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
