...
use RectorPrefix20210117\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use RectorPrefix20210117\Doctrine\Persistence\Proxy;
use RectorPrefix20210117\Mockery\MockInterface;
use RectorPrefix20210117\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use RectorPrefix20210117\PHPUnit\Framework\MockObject\MockObject;
use RectorPrefix20210117\Prophecy\Prophecy\ProphecySubjectInterface;
use RectorPrefix20210117\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('RectorPrefix20210117\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('RectorPrefix20210117\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \RectorPrefix20210117\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
