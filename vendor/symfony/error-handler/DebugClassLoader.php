...
use _PhpScoperbd5d0c5f7638\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoperbd5d0c5f7638\Doctrine\Persistence\Proxy;
use _PhpScoperbd5d0c5f7638\Mockery\MockInterface;
use _PhpScoperbd5d0c5f7638\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperbd5d0c5f7638\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperbd5d0c5f7638\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperbd5d0c5f7638\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoperbd5d0c5f7638\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperbd5d0c5f7638\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
