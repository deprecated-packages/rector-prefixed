...
use RectorPrefix20210114\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use RectorPrefix20210114\Doctrine\Persistence\Proxy;
use RectorPrefix20210114\Mockery\MockInterface;
use RectorPrefix20210114\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use RectorPrefix20210114\PHPUnit\Framework\MockObject\MockObject;
use RectorPrefix20210114\Prophecy\Prophecy\ProphecySubjectInterface;
use RectorPrefix20210114\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('RectorPrefix20210114\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('RectorPrefix20210114\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \RectorPrefix20210114\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
