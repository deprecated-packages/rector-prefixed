...
use RectorPrefix20210308\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use RectorPrefix20210308\Doctrine\Persistence\Proxy;
use RectorPrefix20210308\Mockery\MockInterface;
use RectorPrefix20210308\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use RectorPrefix20210308\PHPUnit\Framework\MockObject\MockObject;
use RectorPrefix20210308\Prophecy\Prophecy\ProphecySubjectInterface;
use RectorPrefix20210308\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\RectorPrefix20210308\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\RectorPrefix20210308\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \RectorPrefix20210308\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
