...
use RectorPrefix20210203\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use RectorPrefix20210203\Doctrine\Persistence\Proxy;
use RectorPrefix20210203\Mockery\MockInterface;
use RectorPrefix20210203\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use RectorPrefix20210203\PHPUnit\Framework\MockObject\MockObject;
use RectorPrefix20210203\Prophecy\Prophecy\ProphecySubjectInterface;
use RectorPrefix20210203\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\RectorPrefix20210203\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\RectorPrefix20210203\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \RectorPrefix20210203\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
