 ...
 */
namespace _PhpScoper17db12703726\Symfony\Component\String\Slugger;

use _PhpScoper17db12703726\Symfony\Component\String\AbstractUnicodeString;
use _PhpScoper17db12703726\Symfony\Component\String\UnicodeString;
use _PhpScoper17db12703726\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\_PhpScoper17db12703726\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \_PhpScoper17db12703726\Symfony\Component\String\Slugger\SluggerInterface, \_PhpScoper17db12703726\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \_PhpScoper17db12703726\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \_PhpScoper17db12703726\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
