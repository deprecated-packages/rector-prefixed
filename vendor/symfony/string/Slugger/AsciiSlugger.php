...
use _PhpScoperb75b35f52b74\Symfony\Component\String\UnicodeString;
use _PhpScoperb75b35f52b74\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\_PhpScoperb75b35f52b74\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \_PhpScoperb75b35f52b74\Symfony\Component\String\Slugger\SluggerInterface, \_PhpScoperb75b35f52b74\Symfony\Contracts\Translation\LocaleAwareInterface
{
    ...
    public function slug(string $string, string $separator = '-', string $locale = null) : \_PhpScoperb75b35f52b74\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \_PhpScoperb75b35f52b74\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
