 ...
 */
class ByteString extends \RectorPrefix20210316\Symfony\Component\String\AbstractString
{
    ...
    public static function fromRandom(int $length = 16, string $alphabet = null)
    {
        ...
        if ($bits <= 0 || $bits > 56) {
            throw new \RectorPrefix20210316\Symfony\Component\String\Exception\InvalidArgumentException('The length of the alphabet must in the [2^1, 2^56] range.');
        }
        $ret = '';
        while ($length > 0) {
            ...
            if (\false === $match($regexp, $this->string, $matches, $flags | \PREG_UNMATCHED_AS_NULL, $offset)) {
                ...
                foreach (\get_defined_constants(\true)['pcre'] as $k => $v) {
                    if ($lastError === $v && '_ERROR' === \substr($k, -6)) {
                        throw new \RectorPrefix20210316\Symfony\Component\String\Exception\RuntimeException('Matching failed with ' . $k . '.');
                    }
                }
                throw new \RectorPrefix20210316\Symfony\Component\String\Exception\RuntimeException('Matching failed with unknown error code.');
            }
        } finally {
    ...
    public function toUnicodeString(string $fromEncoding = null) : \RectorPrefix20210316\Symfony\Component\String\UnicodeString
    {
        return new \RectorPrefix20210316\Symfony\Component\String\UnicodeString($this->toCodePointString($fromEncoding)->string);
    }
    public function toCodePointString(string $fromEncoding = null) : \RectorPrefix20210316\Symfony\Component\String\CodePointString
    {
        $u = new \RectorPrefix20210316\Symfony\Component\String\CodePointString();
        ...
        if (!$validEncoding) {
            throw new \RectorPrefix20210316\Symfony\Component\String\Exception\InvalidArgumentException(\sprintf('Invalid "%s" string.', $fromEncoding ?? 'Windows-1252'));
        }
    ...
    public function width(bool $ignoreAnsiDecoration = \true) : int
    {
        ...
        return (new \RectorPrefix20210316\Symfony\Component\String\CodePointString($string))->width($ignoreAnsiDecoration);
    }
}
