 ...
 */
namespace RectorPrefix20210308\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \RectorPrefix20210308\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210308\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210308\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix20210308\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix20210308\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix20210308\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix20210308\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
