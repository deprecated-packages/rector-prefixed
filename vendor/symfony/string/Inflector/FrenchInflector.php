 ...
 */
namespace RectorPrefix20210423\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \RectorPrefix20210423\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210423\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210423\\Mes\\2s'],
    ];
    /**
    ...
    const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix20210423\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix20210423\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix20210423\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix20210423\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
