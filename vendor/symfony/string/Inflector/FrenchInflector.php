 ...
 */
namespace _PhpScoper2a4e7ab1ecbc\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper2a4e7ab1ecbc\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper2a4e7ab1ecbc\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper2a4e7ab1ecbc\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper2a4e7ab1ecbc\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper2a4e7ab1ecbc\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper2a4e7ab1ecbc\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper2a4e7ab1ecbc\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
