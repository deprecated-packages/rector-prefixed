 ...
 */
namespace _PhpScoperbf340cb0be9d\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoperbf340cb0be9d\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperbf340cb0be9d\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperbf340cb0be9d\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoperbf340cb0be9d\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoperbf340cb0be9d\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoperbf340cb0be9d\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoperbf340cb0be9d\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
