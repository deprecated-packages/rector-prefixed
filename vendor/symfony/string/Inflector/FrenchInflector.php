 ...
 */
namespace _PhpScopere8e811afab72\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScopere8e811afab72\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScopere8e811afab72\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScopere8e811afab72\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScopere8e811afab72\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScopere8e811afab72\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScopere8e811afab72\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScopere8e811afab72\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
