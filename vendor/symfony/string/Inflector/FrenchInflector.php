 ...
 */
namespace _PhpScoper0a2ac50786fa\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper0a2ac50786fa\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper0a2ac50786fa\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper0a2ac50786fa\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper0a2ac50786fa\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper0a2ac50786fa\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper0a2ac50786fa\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper0a2ac50786fa\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
