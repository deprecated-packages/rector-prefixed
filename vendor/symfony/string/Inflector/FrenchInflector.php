 ...
 */
namespace _PhpScoperf18a0c41e2d2\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoperf18a0c41e2d2\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperf18a0c41e2d2\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperf18a0c41e2d2\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoperf18a0c41e2d2\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoperf18a0c41e2d2\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoperf18a0c41e2d2\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoperf18a0c41e2d2\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
