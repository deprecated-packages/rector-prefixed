 ...
 */
namespace _PhpScoper17db12703726\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper17db12703726\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper17db12703726\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper17db12703726\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper17db12703726\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper17db12703726\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper17db12703726\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper17db12703726\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
