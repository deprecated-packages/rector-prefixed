 ...
 */
namespace _PhpScoperb75b35f52b74\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoperb75b35f52b74\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperb75b35f52b74\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperb75b35f52b74\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoperb75b35f52b74\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoperb75b35f52b74\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoperb75b35f52b74\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoperb75b35f52b74\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
