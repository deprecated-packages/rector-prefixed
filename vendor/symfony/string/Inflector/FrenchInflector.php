 ...
 */
namespace RectorPrefix20210420\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \RectorPrefix20210420\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210420\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210420\\Mes\\2s'],
    ];
    /**
    ...
    const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix20210420\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix20210420\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix20210420\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix20210420\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
