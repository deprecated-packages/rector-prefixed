 ...
 */
namespace _PhpScoper5edc98a7cce2\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper5edc98a7cce2\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper5edc98a7cce2\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper5edc98a7cce2\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper5edc98a7cce2\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper5edc98a7cce2\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper5edc98a7cce2\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper5edc98a7cce2\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
