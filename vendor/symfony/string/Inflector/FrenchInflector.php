 ...
 */
namespace RectorPrefix2020DecSat\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \RectorPrefix2020DecSat\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix2020DecSat\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix2020DecSat\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix2020DecSat\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix2020DecSat\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix2020DecSat\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix2020DecSat\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
