 ...
 */
namespace RectorPrefix20210110\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \RectorPrefix20210110\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210110\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210110\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix20210110\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix20210110\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix20210110\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix20210110\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
