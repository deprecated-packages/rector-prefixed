 ...
 */
namespace _PhpScoperfce0de0de1ce\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoperfce0de0de1ce\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperfce0de0de1ce\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoperfce0de0de1ce\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoperfce0de0de1ce\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoperfce0de0de1ce\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoperfce0de0de1ce\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoperfce0de0de1ce\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
