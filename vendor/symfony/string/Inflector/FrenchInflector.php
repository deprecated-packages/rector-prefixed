 ...
 */
namespace _PhpScoper0a6b37af0871\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper0a6b37af0871\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper0a6b37af0871\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper0a6b37af0871\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper0a6b37af0871\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper0a6b37af0871\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper0a6b37af0871\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper0a6b37af0871\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
