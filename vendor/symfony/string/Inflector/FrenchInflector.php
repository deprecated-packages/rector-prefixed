 ...
 */
namespace _PhpScoper8b9c402c5f32\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper8b9c402c5f32\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper8b9c402c5f32\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper8b9c402c5f32\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper8b9c402c5f32\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper8b9c402c5f32\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper8b9c402c5f32\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper8b9c402c5f32\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
