 ...
 */
namespace RectorPrefix20201226\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \RectorPrefix20201226\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20201226\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20201226\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix20201226\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix20201226\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix20201226\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix20201226\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
