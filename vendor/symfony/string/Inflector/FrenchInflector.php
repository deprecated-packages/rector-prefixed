 ...
 */
namespace _PhpScoper5b8c9e9ebd21\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper5b8c9e9ebd21\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper5b8c9e9ebd21\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper5b8c9e9ebd21\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper5b8c9e9ebd21\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper5b8c9e9ebd21\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper5b8c9e9ebd21\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper5b8c9e9ebd21\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
