 ...
 */
namespace RectorPrefix20210121\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \RectorPrefix20210121\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210121\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210121\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix20210121\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix20210121\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix20210121\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix20210121\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
