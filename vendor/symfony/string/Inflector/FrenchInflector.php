 ...
 */
namespace _PhpScoper50d83356d739\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper50d83356d739\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper50d83356d739\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper50d83356d739\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper50d83356d739\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper50d83356d739\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper50d83356d739\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper50d83356d739\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
