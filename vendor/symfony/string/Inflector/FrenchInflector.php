 ...
 */
namespace _PhpScoper567b66d83109\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper567b66d83109\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper567b66d83109\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper567b66d83109\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper567b66d83109\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper567b66d83109\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper567b66d83109\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper567b66d83109\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
