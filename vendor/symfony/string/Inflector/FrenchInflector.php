 ...
 */
namespace RectorPrefix20210117\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \RectorPrefix20210117\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210117\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RectorPrefix20210117\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RectorPrefix20210117\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RectorPrefix20210117\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RectorPrefix20210117\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RectorPrefix20210117\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
