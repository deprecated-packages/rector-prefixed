 ...
 */
class UnicodeString extends \_PhpScoperb75b35f52b74\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function join(array $strings, string $lastGlue = null) : \_PhpScoperb75b35f52b74\Symfony\Component\String\AbstractString
    {
     ...
     * @return static
     */
    public function normalize(int $form = self::NFC) : \_PhpScoperb75b35f52b74\parent
    {
        $str = clone $this;
    ...
    public function replaceMatches(string $fromRegexp, $to) : \_PhpScoperb75b35f52b74\Symfony\Component\String\AbstractString
    {
