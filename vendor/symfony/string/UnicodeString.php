 ...
 */
class UnicodeString extends \_PhpScoper0a6b37af0871\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function join(array $strings, string $lastGlue = null) : \_PhpScoper0a6b37af0871\Symfony\Component\String\AbstractString
    {
     ...
     * @return static
     */
    public function normalize(int $form = self::NFC) : \_PhpScoper0a6b37af0871\parent
    {
        $str = clone $this;
    ...
    public function replaceMatches(string $fromRegexp, $to) : \_PhpScoper0a6b37af0871\Symfony\Component\String\AbstractString
    {
