...
class UnicodeString extends \RectorPrefix20210317\Symfony\Component\String\AbstractUnicodeString
{
     ...
     * @param string ...$suffix
     */
    public function append(...$suffix) : \RectorPrefix20210317\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     */
    public function join($strings, $lastGlue = null) : \RectorPrefix20210317\Symfony\Component\String\AbstractString
    {
     ...
     * @param string ...$prefix
     */
    public function prepend(...$prefix) : \RectorPrefix20210317\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     * @param string $to
     */
    public function replace($from, $to) : \RectorPrefix20210317\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     */
    public function replaceMatches($fromRegexp, $to) : \RectorPrefix20210317\Symfony\Component\String\AbstractString
    {
     ...
     * @param int $length
     */
    public function slice($start = 0, $length = null) : \RectorPrefix20210317\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     * @param int $length
     */
    public function splice($replacement, $start = 0, $length = null) : \RectorPrefix20210317\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        if (\PHP_VERSION_ID < 80000 && 0 > $start && \grapheme_strlen($this->string) < -$start) {
            $start = 0;
