 ...
 */
class UnicodeString extends \RectorPrefix20210423\Symfony\Component\String\AbstractUnicodeString
{
    ...
    {
        if ($suffix instanceof \RectorPrefix20210423\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \RectorPrefix20210423\Symfony\Component\String\AbstractString) {
    ...
    public function join(array $strings, string $lastGlue = null) : \RectorPrefix20210423\Symfony\Component\String\AbstractString
    {
    ...
    public function replaceMatches(string $fromRegexp, $to) : \RectorPrefix20210423\Symfony\Component\String\AbstractString
    {
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        ...
        if (\false === $delimiter) {
            throw new \RectorPrefix20210423\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
        $tail = $this->string;
        $chunks = [];
    ...
    {
        if ($prefix instanceof \RectorPrefix20210423\Symfony\Component\String\AbstractString) {
