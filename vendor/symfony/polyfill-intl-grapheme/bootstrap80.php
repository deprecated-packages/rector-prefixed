...
if (!\function_exists('grapheme_extract')) {
    ...
    {
        return \RectorPrefix20210107\Symfony\Polyfill\Intl\Grapheme\Grapheme::grapheme_extract($haystack, $size, $type, $offset, $next);
    }
}
...
if (!\function_exists('grapheme_strlen')) {
    ...
    {
        return \RectorPrefix20210107\Symfony\Polyfill\Intl\Grapheme\Grapheme::grapheme_strlen($string);
    }
}
