 ...
 */
namespace RectorPrefix20210317\Symfony\Component\EventDispatcher\DependencyInjection;
...
use RectorPrefix20210317\Symfony\Component\EventDispatcher\EventDispatcher;
 ...
 */
class RegisterListenersPass implements \RectorPrefix20210317\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\RectorPrefix20210317\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->listenerTag, \true) as $id => $events) {
            ...
            foreach ($events as $event) {
                ...
                $dispatcherDefinition->addMethodCall('addListener', [$event['event'], [new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Reference($id)), $event['method']], $priority]);
        ...
        $extractingDispatcher = new \RectorPrefix20210317\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher();
        foreach ($container->findTaggedServiceIds($this->subscriberTag, \true) as $id => $tags) {
            ...
            if (!$r->isSubclassOf(\RectorPrefix20210317\Symfony\Component\EventDispatcher\EventSubscriberInterface::class)) {
                throw new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Service "%s" must implement interface "%s".', $id, \RectorPrefix20210317\Symfony\Component\EventDispatcher\EventSubscriberInterface::class));
            }
            $class = $r->name;
            ...
            $noPreload = 0;
            \RectorPrefix20210317\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = $aliases;
            \RectorPrefix20210317\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$subscriber = $class;
            $extractingDispatcher->addSubscriber($extractingDispatcher);
            foreach ($extractingDispatcher->listeners as $args) {
                $args[1] = [new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \RectorPrefix20210317\Symfony\Component\DependencyInjection\Reference($id)), $args[1]];
 ...
 * @internal
 */
class ExtractingEventDispatcher extends \RectorPrefix20210317\Symfony\Component\EventDispatcher\EventDispatcher implements \RectorPrefix20210317\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    public $listeners = [];
