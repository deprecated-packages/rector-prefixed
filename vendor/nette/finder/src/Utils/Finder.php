...
class Finder implements \IteratorAggregate, \Countable
{
    ...
    {
        if ($this->paths) {
            throw new \RectorPrefix20210423\Nette\InvalidStateException('Directory to search has already been specified.');
        }
    ...
    {
        if (!$this->paths) {
            throw new \RectorPrefix20210423\Nette\InvalidStateException('Call in() or from() to specify directory to search.');
    ...
    public static function compare($l, string $operator, $r) : bool
    {
        switch ($operator) {
            ...
            case '<>':
                return $l != $r;
            default:
                throw new \RectorPrefix20210423\Nette\InvalidArgumentException("Unknown operator {$operator}.");
        }
    }
