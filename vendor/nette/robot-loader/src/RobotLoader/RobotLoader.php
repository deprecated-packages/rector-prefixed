...
namespace _PhpScoper2a4e7ab1ecbc\Nette\Loaders;
...
class RobotLoader
{
    ...
    public function __construct()
    {
        if (!\extension_loaded('tokenizer')) {
            throw new \_PhpScoper2a4e7ab1ecbc\Nette\NotSupportedException('PHP extension Tokenizer is not loaded.');
        }
    }
    /**
     * Register autoloader.
        ...
        foreach ($this->scanPaths as $path) {
            ...
            foreach ($iterator as $file) {
                ...
                foreach ($classes as $class) {
                    ...
                    if (isset($info['file'])) {
                        throw new \_PhpScoper2a4e7ab1ecbc\Nette\InvalidStateException("Ambiguous class {$class} resolution; defined in {$info['file']} and in {$file}.");
                    }
     ...
     */
    private function createFileIterator(string $dir) : \_PhpScoper2a4e7ab1ecbc\Nette\Utils\Finder
    {
        if (!\is_dir($dir)) {
            throw new \_PhpScoper2a4e7ab1ecbc\Nette\IOException("File or directory '{$dir}' not found.");
        }
        ...
        $iterator = \_PhpScoper2a4e7ab1ecbc\Nette\Utils\Finder::findFiles($acceptFiles)->filter(function (\SplFileInfo $file) use(&$disallow) {
    ...
    {
        \_PhpScoper2a4e7ab1ecbc\Nette\Utils\FileSystem::createDir($dir);
