...
final class FileSystem
{
	 ...
	 * @return void
	 */
	public static function copy(string $origin, string $target, bool $overwrite = true)
	{
	 ...
	 * @return void
	 */
	public static function rename(string $origin, string $target, bool $overwrite = true)
	{
