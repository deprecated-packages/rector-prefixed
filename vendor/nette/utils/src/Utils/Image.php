...
class Image
{
    ...
    public static function fromFile(string $file, int &$type = null)
    {
        ...
        return new static(\RectorPrefix20210503\Nette\Utils\Callback::invokeSafe($method, [$file], function (string $message) : void {
    ...
    public static function fromString(string $s, int &$type = null)
    {
        ...
        return new static(\RectorPrefix20210503\Nette\Utils\Callback::invokeSafe('imagecreatefromstring', [$s], function (string $message) : void {
            throw new \RectorPrefix20210503\Nette\Utils\ImageException($message);
        }));
    }
    /**
