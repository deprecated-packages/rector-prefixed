...
class Image
{
    ...
    public static function fromFile(string $file, int &$type = null)
    {
        ...
        return new static(\RectorPrefix20210420\Nette\Utils\Callback::invokeSafe($method, [$file], function (string $message) {
    ...
    public static function fromString(string $s, int &$type = null)
    {
        ...
        return new static(\RectorPrefix20210420\Nette\Utils\Callback::invokeSafe('imagecreatefromstring', [$s], function (string $message) {
            throw new \RectorPrefix20210420\Nette\Utils\ImageException($message);
        }));
    }
    /**
