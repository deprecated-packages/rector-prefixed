...
use _PhpScoper88fe6e0ad041\Nette\Schema\DynamicParameter;
use _PhpScoper88fe6e0ad041\Nette\Schema\Helpers;
use _PhpScoper88fe6e0ad041\Nette\Schema\Schema;
final class Type implements \_PhpScoper88fe6e0ad041\Nette\Schema\Schema
{
    use Base;
    ...
    {
        $this->type .= '|' . \_PhpScoper88fe6e0ad041\Nette\Schema\DynamicParameter::class;
        return $this;
    }
    ...
    {
        $this->items = $type instanceof \_PhpScoper88fe6e0ad041\Nette\Schema\Schema ? $type : new self($type);
        return $this;
    }
    ...
    public function complete($value, \_PhpScoper88fe6e0ad041\Nette\Schema\Context $context)
    {
        ...
        if ($value instanceof \_PhpScoper88fe6e0ad041\Nette\Schema\DynamicParameter) {
            $context->dynamics[] = [$value, \str_replace('|' . \_PhpScoper88fe6e0ad041\Nette\Schema\DynamicParameter::class, '', $expected)];
        }
        if ($this->items) {
        ...
        $value = \_PhpScoper88fe6e0ad041\Nette\Schema\Helpers::merge($value, $this->default);
