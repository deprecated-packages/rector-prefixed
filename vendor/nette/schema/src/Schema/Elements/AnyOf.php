...
final class AnyOf implements \_PhpScoper006a73f0e455\Nette\Schema\Schema
{
    use Base;
    ...
    {
        $this->set[] = new \_PhpScoper006a73f0e455\Nette\Schema\Elements\Type(\_PhpScoper006a73f0e455\Nette\Schema\DynamicParameter::class);
        return $this;
    }
    /********************* processing ****************d*g**/
    ...
    public function complete($value, \_PhpScoper006a73f0e455\Nette\Schema\Context $context)
    {
        ...
        foreach ($this->set as $item) {
            if ($item instanceof \_PhpScoper006a73f0e455\Nette\Schema\Schema) {
                $dolly = new \_PhpScoper006a73f0e455\Nette\Schema\Context();
    ...
    public function completeDefault(\_PhpScoper006a73f0e455\Nette\Schema\Context $context)
    {
        ...
        if ($this->default instanceof \_PhpScoper006a73f0e455\Nette\Schema\Schema) {
