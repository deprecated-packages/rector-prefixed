...
final class Processor
{
     ...
     */
    public function process(\_PhpScoper88fe6e0ad041\Nette\Schema\Schema $schema, $data)
    {
     ...
     * @throws ValidationException
     */
    public function processMultiple(\_PhpScoper88fe6e0ad041\Nette\Schema\Schema $schema, array $dataset)
    {
        $context = $this->createContext();
        $flatten = null;
        $first = \true;
    ...
    private function throwsErrors(\_PhpScoper88fe6e0ad041\Nette\Schema\Context $context) : void
    {
        $messages = [];
        ...
        if ($messages) {
            throw new \_PhpScoper88fe6e0ad041\Nette\Schema\ValidationException($messages[0], $messages);
        }
    }
    private function createContext() : \_PhpScoper88fe6e0ad041\Nette\Schema\Context
    {
        $context = new \_PhpScoper88fe6e0ad041\Nette\Schema\Context();
