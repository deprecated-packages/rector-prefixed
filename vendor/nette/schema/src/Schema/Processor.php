...
final class Processor
{
     ...
     */
    public function process(\_PhpScopera143bcca66cb\Nette\Schema\Schema $schema, $data)
    {
     ...
     * @throws ValidationException
     */
    public function processMultiple(\_PhpScopera143bcca66cb\Nette\Schema\Schema $schema, array $dataset)
    {
        $context = $this->createContext();
        $flatten = null;
        $first = \true;
    ...
    private function throwsErrors(\_PhpScopera143bcca66cb\Nette\Schema\Context $context) : void
    {
        $messages = [];
        ...
        if ($messages) {
            throw new \_PhpScopera143bcca66cb\Nette\Schema\ValidationException($messages[0], $messages);
        }
    }
    private function createContext() : \_PhpScopera143bcca66cb\Nette\Schema\Context
    {
        $context = new \_PhpScopera143bcca66cb\Nette\Schema\Context();
