...
abstract class Definition
{
    ...
    {
        if ($this->name) {
            throw new \_PhpScoper88fe6e0ad041\Nette\InvalidStateException('Name already has been set.');
        }
        $this->name = $name;
        return $this;
    }
    ...
    protected function setType(?string $type)
    {
        ...
        if ($type === null) {
            ...
            throw new \_PhpScoper88fe6e0ad041\Nette\InvalidArgumentException("Service '{$this->name}': Class or interface '{$type}' not found.");
        } else {
            $this->type = \_PhpScoper88fe6e0ad041\Nette\DI\Helpers::normalizeClass($type);
        }
        return $this;
    }
    ...
    /********************* life cycle ****************d*g**/
    public abstract function resolveType(\_PhpScoper88fe6e0ad041\Nette\DI\Resolver $resolver) : void;
    public abstract function complete(\_PhpScoper88fe6e0ad041\Nette\DI\Resolver $resolver) : void;
    public abstract function generateMethod(\_PhpScoper88fe6e0ad041\Nette\PhpGenerator\Method $method, \_PhpScoper88fe6e0ad041\Nette\DI\PhpGenerator $generator) : void;
