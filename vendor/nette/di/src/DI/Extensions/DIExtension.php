 ...
 * DI extension.
 */
final class DIExtension extends \_PhpScoper26e51eeacccf\Nette\DI\CompilerExtension
{
    /** @var array */
    public $exportedTags = [];
    /** @var array */
    ...
    public function afterCompile(\_PhpScoper26e51eeacccf\Nette\PhpGenerator\ClassType $class)
    {
        ...
        if ($this->debugMode && ($this->config->debugger ?? $this->getContainerBuilder()->getByType(\_PhpScoper26e51eeacccf\Tracy\Bar::class))) {
            $this->enableTracyIntegration();
        }
        $this->initializeTaggedServices();
    }
    private function restrictTags(\_PhpScoper26e51eeacccf\Nette\PhpGenerator\ClassType $class) : void
    {
    ...
    private function restrictTypes(\_PhpScoper26e51eeacccf\Nette\PhpGenerator\ClassType $class) : void
    {
    ...
    {
        \_PhpScoper26e51eeacccf\Nette\Bridges\DITracy\ContainerPanel::$compilationTime = $this->time;
        $this->initialization->addBody($this->getContainerBuilder()->formatPhp('?;', [new \_PhpScoper26e51eeacccf\Nette\DI\Definitions\Statement('@Tracy\\Bar::addPanel', [new \_PhpScoper26e51eeacccf\Nette\DI\Definitions\Statement(\_PhpScoper26e51eeacccf\Nette\Bridges\DITracy\ContainerPanel::class)])]));
    }
}
