 ...
 * DI extension.
 */
final class DIExtension extends \_PhpScoperabd03f0baf05\Nette\DI\CompilerExtension
{
    /** @var array */
    public $exportedTags = [];
    /** @var array */
    ...
    public function afterCompile(\_PhpScoperabd03f0baf05\Nette\PhpGenerator\ClassType $class)
    {
        ...
        if ($this->debugMode && ($this->config->debugger ?? $this->getContainerBuilder()->getByType(\_PhpScoperabd03f0baf05\Tracy\Bar::class))) {
            $this->enableTracyIntegration();
        }
        $this->initializeTaggedServices();
    }
    private function restrictTags(\_PhpScoperabd03f0baf05\Nette\PhpGenerator\ClassType $class) : void
    {
    ...
    private function restrictTypes(\_PhpScoperabd03f0baf05\Nette\PhpGenerator\ClassType $class) : void
    {
    ...
    {
        \_PhpScoperabd03f0baf05\Nette\Bridges\DITracy\ContainerPanel::$compilationTime = $this->time;
        $this->initialization->addBody($this->getContainerBuilder()->formatPhp('?;', [new \_PhpScoperabd03f0baf05\Nette\DI\Definitions\Statement('@Tracy\\Bar::addPanel', [new \_PhpScoperabd03f0baf05\Nette\DI\Definitions\Statement(\_PhpScoperabd03f0baf05\Nette\Bridges\DITracy\ContainerPanel::class)])]));
    }
}
