 ...
 * SQLite storage.
 */
class SQLiteStorage implements \RectorPrefix20210409\Nette\Caching\Storage, \RectorPrefix20210409\Nette\Caching\BulkReader
{
    ...
    {
        $expire = isset($dependencies[\RectorPrefix20210409\Nette\Caching\Cache::EXPIRATION]) ? $dependencies[\RectorPrefix20210409\Nette\Caching\Cache::EXPIRATION] + \time() : null;
        $slide = isset($dependencies[\RectorPrefix20210409\Nette\Caching\Cache::SLIDING]) ? $dependencies[\RectorPrefix20210409\Nette\Caching\Cache::EXPIRATION] : null;
    ...
    public function clean(array $conditions) : void
    {
        if (!empty($conditions[\RectorPrefix20210409\Nette\Caching\Cache::ALL])) {
            ...
            if (!empty($conditions[\RectorPrefix20210409\Nette\Caching\Cache::TAGS])) {
                $tags = $conditions[\RectorPrefix20210409\Nette\Caching\Cache::TAGS];
