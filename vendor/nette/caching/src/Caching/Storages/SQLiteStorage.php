 ...
 * SQLite storage.
 */
class SQLiteStorage implements \RectorPrefix20210420\Nette\Caching\Storage, \RectorPrefix20210420\Nette\Caching\BulkReader
{
    ...
    public function clean(array $conditions) : void
    {
        if (!empty($conditions[\RectorPrefix20210420\Nette\Caching\Cache::ALL])) {
            ...
            if (!empty($conditions[\RectorPrefix20210420\Nette\Caching\Cache::TAGS])) {
                $tags = $conditions[\RectorPrefix20210420\Nette\Caching\Cache::TAGS];
