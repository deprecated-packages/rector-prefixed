...
use _PhpScoper88fe6e0ad041\Nette\PhpGenerator\Dumper;
use _PhpScoper88fe6e0ad041\Nette\PhpGenerator\Parameter;
/**
 * @internal
 */
trait FunctionLike
{
    ...
    {
        $this->body = $args === null ? $code : (new \_PhpScoper88fe6e0ad041\Nette\PhpGenerator\Dumper())->format($code, ...$args);
        return $this;
    }
    ...
    public function setParameters(array $val) : self
    {
        $this->parameters = [];
        foreach ($val as $v) {
            if (!$v instanceof \_PhpScoper88fe6e0ad041\Nette\PhpGenerator\Parameter) {
                throw new \_PhpScoper88fe6e0ad041\Nette\InvalidArgumentException('Argument must be Nette\\PhpGenerator\\Parameter[].');
            }
     ...
     */
    public function addParameter(string $name, $defaultValue = null) : \_PhpScoper88fe6e0ad041\Nette\PhpGenerator\Parameter
    {
        $param = new \_PhpScoper88fe6e0ad041\Nette\PhpGenerator\Parameter($name);
        if (\func_num_args() > 1) {
    ...
    /** @deprecated */
    public function setNamespace(\_PhpScoper88fe6e0ad041\Nette\PhpGenerator\PhpNamespace $val = null) : self
    {
