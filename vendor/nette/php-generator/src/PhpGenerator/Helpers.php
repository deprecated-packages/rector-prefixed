...
final class Helpers
{
    ...
    {
        return (new \_PhpScopera143bcca66cb\Nette\PhpGenerator\Dumper())->dump($var);
    }
    /** @deprecated  use Nette\PhpGenerator\Dumper::format() */
    public static function format(string $statement, ...$args) : string
    {
        return (new \_PhpScopera143bcca66cb\Nette\PhpGenerator\Dumper())->format($statement, ...$args);
    }
    /** @deprecated  use Nette\PhpGenerator\Dumper::format() */
    ...
    {
        return \_PhpScopera143bcca66cb\Nette\PhpGenerator\Dumper::createObject($class, $props);
    }
}
