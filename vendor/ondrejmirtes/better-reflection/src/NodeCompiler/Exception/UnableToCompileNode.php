...
namespace _PhpScopera143bcca66cb\Roave\BetterReflection\NodeCompiler\Exception;
...
class UnableToCompileNode extends \LogicException
{
    ...
    public static function forUnRecognizedExpressionInContext(\PhpParser\Node\Expr $expression, \_PhpScopera143bcca66cb\Roave\BetterReflection\NodeCompiler\CompilerContext $context) : self
    {
    ...
    public static function becauseOfNotFoundClassConstantReference(\_PhpScopera143bcca66cb\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext, \_PhpScopera143bcca66cb\Roave\BetterReflection\Reflection\ReflectionClass $targetClass, \PhpParser\Node\Expr\ClassConstFetch $constantFetch) : self
    {
    ...
    public static function becauseOfNotFoundConstantReference(\_PhpScopera143bcca66cb\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext, \PhpParser\Node\Expr\ConstFetch $constantFetch) : self
    {
    ...
    private static function compilerContextToContextDescription(\_PhpScopera143bcca66cb\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext) : string
    {
