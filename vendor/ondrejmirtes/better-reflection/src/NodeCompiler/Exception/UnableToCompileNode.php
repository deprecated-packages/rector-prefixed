...
namespace _PhpScoperbd5d0c5f7638\Roave\BetterReflection\NodeCompiler\Exception;
...
class UnableToCompileNode extends \LogicException
{
    ...
    public static function forUnRecognizedExpressionInContext(\PhpParser\Node\Expr $expression, \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\NodeCompiler\CompilerContext $context) : self
    {
    ...
    public static function becauseOfNotFoundClassConstantReference(\_PhpScoperbd5d0c5f7638\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext, \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\ReflectionClass $targetClass, \PhpParser\Node\Expr\ClassConstFetch $constantFetch) : self
    {
    ...
    public static function becauseOfNotFoundConstantReference(\_PhpScoperbd5d0c5f7638\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext, \PhpParser\Node\Expr\ConstFetch $constantFetch) : self
    {
    ...
    private static function compilerContextToContextDescription(\_PhpScoperbd5d0c5f7638\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext) : string
    {
