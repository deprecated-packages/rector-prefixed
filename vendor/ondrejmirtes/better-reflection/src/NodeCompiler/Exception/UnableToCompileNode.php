...
namespace _PhpScoper006a73f0e455\Roave\BetterReflection\NodeCompiler\Exception;
...
class UnableToCompileNode extends \LogicException
{
    ...
    public static function forUnRecognizedExpressionInContext(\PhpParser\Node\Expr $expression, \_PhpScoper006a73f0e455\Roave\BetterReflection\NodeCompiler\CompilerContext $context) : self
    {
    ...
    public static function becauseOfNotFoundClassConstantReference(\_PhpScoper006a73f0e455\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext, \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionClass $targetClass, \PhpParser\Node\Expr\ClassConstFetch $constantFetch) : self
    {
    ...
    public static function becauseOfNotFoundConstantReference(\_PhpScoper006a73f0e455\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext, \PhpParser\Node\Expr\ConstFetch $constantFetch) : self
    {
    ...
    private static function compilerContextToContextDescription(\_PhpScoper006a73f0e455\Roave\BetterReflection\NodeCompiler\CompilerContext $fetchContext) : string
    {
