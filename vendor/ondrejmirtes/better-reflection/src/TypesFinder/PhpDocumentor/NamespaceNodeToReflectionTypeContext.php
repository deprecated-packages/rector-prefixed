...
namespace _PhpScoperabd03f0baf05\Roave\BetterReflection\TypesFinder\PhpDocumentor;
...
{
    public function __invoke(?\PhpParser\Node\Stmt\Namespace_ $namespace) : \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context
    {
        if (!$namespace) {
            return new \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context('');
        }
        return new \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context($namespace->name ? $namespace->name->toString() : '', $this->aliasesToFullyQualifiedNames($namespace));
    }
    /**
