...
namespace _PhpScoper006a73f0e455\Roave\BetterReflection\TypesFinder\PhpDocumentor;
...
{
    public function __invoke(?\PhpParser\Node\Stmt\Namespace_ $namespace) : \_PhpScoper006a73f0e455\phpDocumentor\Reflection\Types\Context
    {
        if (!$namespace) {
            return new \_PhpScoper006a73f0e455\phpDocumentor\Reflection\Types\Context('');
        }
        return new \_PhpScoper006a73f0e455\phpDocumentor\Reflection\Types\Context($namespace->name ? $namespace->name->toString() : '', $this->aliasesToFullyQualifiedNames($namespace));
    }
    /**
