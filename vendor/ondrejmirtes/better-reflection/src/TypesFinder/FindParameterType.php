...
use LogicException;
use _PhpScoper006a73f0e455\phpDocumentor\Reflection\DocBlock\Tags\Param;
...
class FindParameterType
{
     ...
     * @return Type[]
     */
    public function __invoke(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionFunctionAbstract $function, ?\PhpParser\Node\Stmt\Namespace_ $namespace, \PhpParser\Node\Param $node) : array
    {
