...
use _PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\DocBlock\Tags\Var_;
...
class FindPropertyType
{
     ...
     * @return Type[]
     */
    public function __invoke(\_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\ReflectionProperty $reflectionProperty, ?\PhpParser\Node\Stmt\Namespace_ $namespace) : array
    {
        ...
        return \array_merge([], ...\array_map(function (\_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\DocBlock\Tags\Var_ $varTag) use($context) {
