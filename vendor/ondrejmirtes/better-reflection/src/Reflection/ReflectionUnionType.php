...
class ReflectionUnionType extends \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionType
{
    /** @var ReflectionType[] */
    private $types;
    ...
    {
        return \implode('|', \array_map(static function (\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionType $type) : string {
            return (string) $type;
        }, $this->types));
    }
}
