...
use _PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\StringCast\ReflectionParameterStringCast;
...
use _PhpScoper26e51eeacccf\Roave\BetterReflection\TypesFinder\FindParameterType;
...
class ReflectionParameter
{
    ...
    {
        return \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionClass::createFromName($className)->getMethod($methodName)->getParameter($parameterName);
    }
    /**
    ...
    {
        return \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionClass::createFromInstance($instance)->getMethod($methodName)->getParameter($parameterName);
    }
    /**
     * Create a reflection of a parameter using a closure
     */
    public static function createFromClosure(\Closure $closure, string $parameterName) : \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionParameter
    {
        return \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunction::createFromClosure($closure)->getParameter($parameterName);
    }
    /**
    ...
    public static function createFromSpec($spec, string $parameterName) : self
    {
        ...
        if (\is_string($spec)) {
            return \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunction::createFromName($spec)->getParameter($parameterName);
        }
    ...
    {
        return \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\StringCast\ReflectionParameterStringCast::toString($this);
    }
    /**
     * @internal
     *
     ...
     */
    public static function createFromNode(\_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflector\Reflector $reflector, \PhpParser\Node\Param $node, ?\PhpParser\Node\Stmt\Namespace_ $declaringNamespace, \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunctionAbstract $function, int $parameterIndex) : self
    {
        $param = new self();
    ...
    private function parseDefaultValueNode() : void
    {
        ...
        if ($defaultValueNode instanceof \PhpParser\Node\Expr\ConstFetch && !\in_array(\strtolower($defaultValueNode->name->toString()), ['true', 'false', 'null'], \true)) {
            ...
            if ($namespace !== null && !$defaultValueNode->name->isFullyQualified()) {
                ...
                if (\defined($namespacedName)) {
                    ...
                    try {
                        \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionConstant::createFromName($namespacedName);
                        $this->defaultValueConstantName = $namespacedName;
        ...
        $this->defaultValue = (new \_PhpScoper26e51eeacccf\Roave\BetterReflection\NodeCompiler\CompileNodeToValue())->__invoke($defaultValueNode, new \_PhpScoper26e51eeacccf\Roave\BetterReflection\NodeCompiler\CompilerContext($this->reflector, $this->function->getFileName(), $this->getDeclaringClass(), $namespace, $this->function->getName()));
    }
    /**
    ...
    private function findParentClassDeclaringConstant(string $constantName) : string
    {
        ...
        \assert($method instanceof \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionMethod);
     ...
     */
    public function getDeclaringFunction() : \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunctionAbstract
    {
    ...
    {
        if ($this->function instanceof \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionMethod) {
    ...
    {
        return (new \_PhpScoper26e51eeacccf\Roave\BetterReflection\TypesFinder\FindParameterType())->__invoke($this->function, $this->declaringNamespace, $this->node);
    }
    /**
     ...
     */
    public function getType() : ?\_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionType
    {
        $type = $this->node->type;
        if ($type === null) {
            return null;
     ...
     */
    public function getClass() : ?\_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionClass
    {
        $className = $this->getClassName();
        if ($className === null) {
            return null;
        }
        if (!$this->reflector instanceof \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflector\ClassReflector) {
            throw new \RuntimeException(\sprintf('Unable to reflect class type because we were not given a "%s", but a "%s" instead', \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflector\ClassReflector::class, \get_class($this->reflector)));
        }
    ...
    private function getClassName() : ?string
    {
        ...
        $type = $this->getType();
        if (!$type instanceof \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionNamedType) {
            return null;
        }
        $typeHint = $type->getName();
        if ($typeHint === 'self') {
            $declaringClass = $this->getDeclaringClass();
            \assert($declaringClass instanceof \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionClass);
    ...
    {
        throw \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\Exception\Uncloneable::fromClass(self::class);
    }
    public function getStartColumn() : int
    {
        return \_PhpScoper26e51eeacccf\Roave\BetterReflection\Util\CalculateReflectionColum::getStartColumn($this->function->getLocatedSource()->getSource(), $this->node);
    }
    public function getEndColumn() : int
    {
        return \_PhpScoper26e51eeacccf\Roave\BetterReflection\Util\CalculateReflectionColum::getEndColumn($this->function->getLocatedSource()->getSource(), $this->node);
    }
