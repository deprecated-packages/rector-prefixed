...
{
    public static function toString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionClassConstant $constantReflection) : string
    {
    ...
    private static function visibilityToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionClassConstant $constantReflection) : string
    {
