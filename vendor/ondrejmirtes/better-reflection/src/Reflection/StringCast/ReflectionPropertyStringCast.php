...
{
    public static function toString(\_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflection\ReflectionProperty $propertyReflection) : string
    {
        $stateModifier = '';
    ...
    private static function visibilityToString(\_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflection\ReflectionProperty $propertyReflection) : string
    {
