...
{
    public static function toString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionProperty $propertyReflection) : string
    {
        $stateModifier = '';
    ...
    private static function visibilityToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionProperty $propertyReflection) : string
    {
