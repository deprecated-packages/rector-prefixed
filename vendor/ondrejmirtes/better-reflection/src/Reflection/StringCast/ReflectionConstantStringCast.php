...
{
    public static function toString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
    ...
    private static function sourceToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
    ...
    private static function fileAndLinesToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
