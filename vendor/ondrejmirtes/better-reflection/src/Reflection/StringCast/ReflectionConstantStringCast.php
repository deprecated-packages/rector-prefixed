...
{
    public static function toString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
    ...
    private static function sourceToString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
    ...
    private static function fileAndLinesToString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionConstant $constantReflection) : string
    {
