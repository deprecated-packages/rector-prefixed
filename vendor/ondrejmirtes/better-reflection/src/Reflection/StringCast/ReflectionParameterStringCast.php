...
{
    public static function toString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
    ...
    private static function typeToString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
    ...
    private static function valueToString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
