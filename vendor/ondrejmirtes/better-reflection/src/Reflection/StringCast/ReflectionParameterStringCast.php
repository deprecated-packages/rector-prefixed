...
{
    public static function toString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
    ...
    private static function typeToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
    ...
    private static function valueToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
