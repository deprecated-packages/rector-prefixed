...
{
    public static function toString(\_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
    ...
    private static function typeToString(\_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
    ...
    private static function valueToString(\_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string
    {
