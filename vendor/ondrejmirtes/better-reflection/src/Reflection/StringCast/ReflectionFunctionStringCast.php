...
{
    public static function toString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function sourceToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function fileAndLinesToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function parametersToString(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
        return \array_reduce($functionReflection->getParameters(), static function (string $string, \_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string {
