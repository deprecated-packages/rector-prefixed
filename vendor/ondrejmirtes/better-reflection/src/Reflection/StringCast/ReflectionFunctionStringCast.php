...
{
    public static function toString(\_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function sourceToString(\_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function fileAndLinesToString(\_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function parametersToString(\_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
        return \array_reduce($functionReflection->getParameters(), static function (string $string, \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string {
