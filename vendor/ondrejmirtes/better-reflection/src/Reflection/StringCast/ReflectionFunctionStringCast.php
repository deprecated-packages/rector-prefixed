...
{
    public static function toString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function sourceToString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function fileAndLinesToString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
    ...
    private static function parametersToString(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionFunction $functionReflection) : string
    {
        return \array_reduce($functionReflection->getParameters(), static function (string $string, \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionParameter $parameterReflection) : string {
