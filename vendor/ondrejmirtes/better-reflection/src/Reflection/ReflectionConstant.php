...
use _PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\StringCast\ReflectionConstantStringCast;
...
use _PhpScoperabd03f0baf05\Roave\BetterReflection\Util\ConstantNodeChecker;
...
class ReflectionConstant implements \_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\Reflection
{
    /** @var Reflector */
    private $reflector;
    ...
    {
        return (new \_PhpScoperabd03f0baf05\Roave\BetterReflection\BetterReflection())->constantReflector()->reflect($constantName);
    }
    /**
     ...
     */
    public static function createFromNode(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflector\Reflector $reflector, \PhpParser\Node $node, \_PhpScoperabd03f0baf05\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, ?\PhpParser\Node\Stmt\Namespace_ $namespace = null, ?int $positionInNode = null) : self
    {
    ...
    private static function createFromConstKeyword(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflector\Reflector $reflector, \PhpParser\Node\Stmt\Const_ $node, \_PhpScoperabd03f0baf05\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, ?\PhpParser\Node\Stmt\Namespace_ $namespace, int $positionInNode) : self
    {
        $constant = new self();
     ...
     */
    private static function createFromDefineFunctionCall(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflector\Reflector $reflector, \PhpParser\Node\Expr\FuncCall $node, \_PhpScoperabd03f0baf05\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource) : self
    {
        \_PhpScoperabd03f0baf05\Roave\BetterReflection\Util\ConstantNodeChecker::assertValidDefineFunctionCall($node);
        $constant = new self();
        $constant->reflector = $reflector;
        $constant->node = $node;
        $constant->locatedSource = $locatedSource;
    ...
    public function getValue()
    {
        ...
        /** @psalm-suppress UndefinedPropertyFetch */
        $this->value = (new \_PhpScoperabd03f0baf05\Roave\BetterReflection\NodeCompiler\CompileNodeToValue())->__invoke($valueNode, new \_PhpScoperabd03f0baf05\Roave\BetterReflection\NodeCompiler\CompilerContext($this->reflector, $this->getFileName(), null, $namespace, null));
        $this->valueWasCached = \true;
        return $this->value;
    }
    ...
    {
        return \_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\StringCast\ReflectionConstantStringCast::toString($this);
    }
    /**
