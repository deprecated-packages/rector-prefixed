...
use _PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\Exception\FunctionDoesNotExist;
use _PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\StringCast\ReflectionFunctionStringCast;
...
class ReflectionFunction extends \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\ReflectionFunctionAbstract implements \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\Reflection
{
    /**
    ...
    {
        return (new \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\BetterReflection())->functionReflector()->reflect($functionName);
    }
    /**
     * @throws IdentifierNotFound
     */
    ...
    {
        $configuration = new \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\BetterReflection();
        return (new \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflector\FunctionReflector(new \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\SourceLocator\Type\ClosureSourceLocator($closure, $configuration->phpParser()), $configuration->classReflector()))->reflect(self::CLOSURE_NAME);
    }
    public function __toString() : string
    {
        return \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\StringCast\ReflectionFunctionStringCast::toString($this);
    }
    /**
     * @internal
     *
     ...
     */
    public static function createFromNode(\_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflector\Reflector $reflector, \PhpParser\Node\FunctionLike $node, \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, ?\PhpParser\Node\Stmt\Namespace_ $namespaceNode = null) : self
    {
        $function = new self();
    ...
    {
        if ($this->isClosure()) {
            throw new \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\Adapter\Exception\NotImplemented('Not implemented for closures');
        }
    }
    /**
     * @throws FunctionDoesNotExist
    ...
    private function assertFunctionExist(string $functionName) : void
    {
        if (!\function_exists($functionName)) {
            throw \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\Reflection\Exception\FunctionDoesNotExist::fromName($functionName);
        }
    }
}
