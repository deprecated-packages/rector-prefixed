...
use _PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflection\StringCast\ReflectionClassConstantStringCast;
...
class ReflectionClassConstant
{
     ...
     */
    public static function createFromNode(\_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflector\Reflector $reflector, \PhpParser\Node\Stmt\ClassConst $node, int $positionInNode, \_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflection\ReflectionClass $owner) : self
    {
        $ref = new self();
        $ref->node = $node;
    ...
    public function getValue()
    {
        ...
        $this->value = (new \_PhpScoper88fe6e0ad041\Roave\BetterReflection\NodeCompiler\CompileNodeToValue())->__invoke($this->node->consts[$this->positionInNode]->value, new \_PhpScoper88fe6e0ad041\Roave\BetterReflection\NodeCompiler\CompilerContext($this->reflector, $this->owner->getFileName(), $this->getDeclaringClass(), $this->owner->getNamespaceName(), null));
    ...
    {
        return \_PhpScoper88fe6e0ad041\Roave\BetterReflection\Util\CalculateReflectionColum::getStartColumn($this->owner->getLocatedSource()->getSource(), $this->node);
    }
    public function getEndColumn() : int
    {
        return \_PhpScoper88fe6e0ad041\Roave\BetterReflection\Util\CalculateReflectionColum::getEndColumn($this->owner->getLocatedSource()->getSource(), $this->node);
    }
    /**
    ...
    {
        return \_PhpScoper88fe6e0ad041\Roave\BetterReflection\Reflection\StringCast\ReflectionClassConstantStringCast::toString($this);
    }
