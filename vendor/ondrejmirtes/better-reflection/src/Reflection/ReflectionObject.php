...
use _PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\AnonymousClassObjectSourceLocator;
use function array_merge;
use function get_class;
use function is_object;
use function strpos;
class ReflectionObject extends \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionClass
{
    /** @var ReflectionClass */
     ...
     * @param object $object
     */
    private function __construct(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionClass $reflectionClass, $object)
    {
     ...
     */
    public static function createFromInstance($object) : \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionClass
    {
        if (!\is_object($object)) {
            throw new \InvalidArgumentException('Can only create from an instance of an object');
        }
        $className = \get_class($object);
        if (\strpos($className, \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionClass::ANONYMOUS_CLASS_NAME_PREFIX) === 0) {
            $reflector = new \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\ClassReflector(new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\AnonymousClassObjectSourceLocator($object, (new \_PhpScoper006a73f0e455\Roave\BetterReflection\BetterReflection())->phpParser()));
        } else {
            $reflector = (new \_PhpScoper006a73f0e455\Roave\BetterReflection\BetterReflection())->classReflector();
        }
    ...
    private function getRuntimeProperties(?int $filter = null) : array
    {
        ...
        foreach ($reflectionProperties as $property) {
            ...
            $runtimeProperty = \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionProperty::createFromNode($this->reflector, $this->createPropertyNodeFromReflection($property, $this->object), 0, $reflectionProperty ? $reflectionProperty->getDeclaringClass()->getDeclaringNamespaceAst() : null, $this, $this, \false);
