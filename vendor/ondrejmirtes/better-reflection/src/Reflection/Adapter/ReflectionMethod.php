...
class ReflectionMethod extends \ReflectionMethod
{
    ...
    public function __construct(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionMethod $betterReflectionMethod)
    {
        $this->betterReflectionMethod = $betterReflectionMethod;
    }
    public function getBetterReflection() : \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionMethod
    {
    ...
    public function getParameters()
    {
        ...
        foreach ($parameters as $key => $parameter) {
            $wrappedParameters[$key] = new \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Adapter\ReflectionParameter($parameter);
        }
    ...
    {
        return \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Adapter\ReflectionType::fromReturnTypeOrNull($this->betterReflectionMethod->getReturnType());
    }
    /**
     * {@inheritDoc}
     */
    ...
    public function getClosure($object = null)
    {
        ...
        } catch (\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Exception\NoObjectProvided|\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Exception\NotAnObject $e) {
            return null;
        } catch (\Throwable $e) {
    ...
    {
        return new \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\Adapter\ReflectionClass($this->betterReflectionMethod->getImplementingClass());
    }
    /**
     * {@inheritDoc}
     */
