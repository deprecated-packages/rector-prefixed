...
use _PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionParameter as BetterReflectionParameter;
use function assert;
class ReflectionParameter extends \ReflectionParameter
{
    /** @var BetterReflectionParameter */
    private $betterReflectionParameter;
    public function __construct(\_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionParameter $betterReflectionParameter)
    {
    ...
    public function getDeclaringFunction()
    {
        ...
        \assert($function instanceof \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionMethod || $function instanceof \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionFunction);
        if ($function instanceof \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\ReflectionMethod) {
            return new \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\Adapter\ReflectionMethod($function);
        }
        return new \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\Adapter\ReflectionFunction($function);
    }
    /**
     * {@inheritDoc}
     */
    public function getDeclaringClass()
    {
        ...
        return new \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\Adapter\ReflectionClass($declaringClass);
    }
    /**
     * {@inheritDoc}
     */
    public function getClass()
    {
        ...
        return new \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\Adapter\ReflectionClass($class);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return \_PhpScoper26e51eeacccf\Roave\BetterReflection\Reflection\Adapter\ReflectionType::fromReturnTypeOrNull($this->betterReflectionParameter->getType());
    }
}
