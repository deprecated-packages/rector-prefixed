...
use _PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionFunction as BetterReflectionFunction;
...
class ReflectionFunction extends \ReflectionFunction
{
    ...
    public function __construct(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\ReflectionFunction $betterReflectionFunction)
    {
    ...
    {
        return \_PhpScoperabd03f0baf05\Roave\BetterReflection\Reflection\Adapter\ReflectionType::fromReturnTypeOrNull($this->betterReflectionFunction->getReturnType());
    }
    /**
     * {@inheritDoc}
     */
