...
use _PhpScoperabd03f0baf05\Roave\BetterReflection\SourceLocator\Located\EvaledLocatedSource;
...
final class EvaledCodeSourceLocator extends \_PhpScoperabd03f0baf05\Roave\BetterReflection\SourceLocator\Type\AbstractSourceLocator
{
    /** @var SourceStubber */
    private $stubber;
    ...
    protected function createLocatedSource(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Identifier\Identifier $identifier) : ?\_PhpScoperabd03f0baf05\Roave\BetterReflection\SourceLocator\Located\LocatedSource
    {
        ...
        return new \_PhpScoperabd03f0baf05\Roave\BetterReflection\SourceLocator\Located\EvaledLocatedSource($stubData->getStub());
    }
    private function getInternalReflectionClass(\_PhpScoperabd03f0baf05\Roave\BetterReflection\Identifier\Identifier $identifier) : ?\ReflectionClass
    {
