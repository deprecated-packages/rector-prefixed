...
use _PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Exception\EvaledAnonymousClassCannotBeLocated;
use _PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Exception\TwoAnonymousClassesOnSameLine;
 ...
 * @internal
 */
final class AnonymousClassObjectSourceLocator implements \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\SourceLocator
{
    ...
    private function getReflectionClass(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper006a73f0e455\Roave\BetterReflection\Identifier\IdentifierType $identifierType) : ?\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionClass
    {
        ...
        if (\strpos($fileName, 'eval()\'d code') !== \false) {
            throw \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Exception\EvaledAnonymousClassCannotBeLocated::create();
        }
        ...
        $nodeVisitor = new class($fileName, $this->coreClassReflection->getStartLine()) extends \PhpParser\NodeVisitorAbstract
        {
            ...
            public function getAnonymousClassNode() : ?\PhpParser\Node\Stmt\Class_
            {
                ...
                if (isset($anonymousClassNodesOnSameLine[1])) {
                    throw \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Exception\TwoAnonymousClassesOnSameLine::create($this->fileName, $this->startLine);
                }
        ...
        $reflectionClass = (new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Ast\Strategy\NodeToReflection())->__invoke($reflector, $nodeVisitor->getAnonymousClassNode(), new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Located\LocatedSource($fileContents, $fileName), null);
        \assert($reflectionClass instanceof \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflection\ReflectionClass || $reflectionClass === null);
