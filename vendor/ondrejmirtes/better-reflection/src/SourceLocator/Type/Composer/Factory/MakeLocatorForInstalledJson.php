...
final class MakeLocatorForInstalledJson
{
    public function __invoke(string $installationPath, \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Ast\Locator $astLocator) : \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\SourceLocator
    {
        ...
        return new \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\AggregateSourceLocator(\array_merge([new \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\Composer\PsrAutoloaderLocator(\_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\Composer\Psr\Psr4Mapping::fromArrayMappings(\array_merge_recursive([], ...\array_map(function (array $package) use($realInstallationPath) : array {
            return $this->prefixWithPackagePath($this->packageToPsr4AutoloadNamespaces($package), $realInstallationPath, $package);
        }, $installed))), $astLocator), new \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\Composer\PsrAutoloaderLocator(\_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\Composer\Psr\Psr0Mapping::fromArrayMappings(\array_merge_recursive([], ...\array_map(function (array $package) use($realInstallationPath) : array {
