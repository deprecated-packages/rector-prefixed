...
class AggregateSourceLocator implements \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\SourceLocator
{
    /** @var SourceLocator[] */
    ...
    public function __construct(array $sourceLocators = [])
    {
        ...
        $validator = static function (\_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\SourceLocator ...$sourceLocator) : array {
    ...
    {
        return \array_merge([], ...\array_map(static function (\_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\SourceLocator $sourceLocator) use($reflector, $identifierType) {
