...
class AggregateSourceLocator implements \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\SourceLocator
{
    /** @var SourceLocator[] */
    ...
    public function __construct(array $sourceLocators = [])
    {
        ...
        $validator = static function (\_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\SourceLocator ...$sourceLocator) : array {
    ...
    {
        return \array_merge([], ...\array_map(static function (\_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\Type\SourceLocator $sourceLocator) use($reflector, $identifierType) {
