...
use _PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Exception\EmptyPhpSourceCode;
 ...
 */
class StringSourceLocator extends \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Type\AbstractSourceLocator
{
    /** @var string */
    private $source;
    /**
     ...
     */
    public function __construct(string $source, \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Ast\Locator $astLocator)
    {
        ...
        if (empty($source)) {
            ...
            throw new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Exception\EmptyPhpSourceCode('Source code string was empty');
        }
        $this->source = $source;
    }
    /**
    ...
    {
        return new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Located\LocatedSource($this->source, null);
    }
}
