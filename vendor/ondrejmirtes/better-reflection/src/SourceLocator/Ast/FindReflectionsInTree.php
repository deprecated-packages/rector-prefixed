...
use _PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Ast\Strategy\AstConversionStrategy;
...
final class FindReflectionsInTree
{
     ...
     */
    public function __construct(\_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Ast\Strategy\AstConversionStrategy $astConversionStrategy, \Closure $functionReflectorGetter)
    {
     ...
     * @return Reflection[]
     */
    public function __invoke(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\Reflector $reflector, array $ast, \_PhpScoper006a73f0e455\Roave\BetterReflection\Identifier\IdentifierType $identifierType, \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource) : array
    {
        $nodeVisitor = new class($reflector, $identifierType, $locatedSource, $this->astConversionStrategy, $this->functionReflectorGetter->__invoke()) extends \PhpParser\NodeVisitorAbstract
        {
            ...
            /** @var FunctionReflector */
            private $functionReflector;
            public function __construct(\_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\Reflector $reflector, \_PhpScoper006a73f0e455\Roave\BetterReflection\Identifier\IdentifierType $identifierType, \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Located\LocatedSource $locatedSource, \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\Ast\Strategy\AstConversionStrategy $astConversionStrategy, \_PhpScoper006a73f0e455\Roave\BetterReflection\Reflector\FunctionReflector $functionReflector)
            {
