 ...
 * @internal
 */
final class ReflectionSourceStubber implements \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    private function createStubData(string $stub, ?string $extensionName) : \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        return new \_PhpScoperbd5d0c5f7638\Roave\BetterReflection\SourceLocator\SourceStubber\StubData($stub, $extensionName);
    }
}
