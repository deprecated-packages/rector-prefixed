 ...
 * @internal
 */
final class ReflectionSourceStubber implements \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    private function createStubData(string $stub, ?string $extensionName) : \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        return new \_PhpScopera143bcca66cb\Roave\BetterReflection\SourceLocator\SourceStubber\StubData($stub, $extensionName);
    }
}
