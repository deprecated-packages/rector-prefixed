 ...
 * @internal
 */
final class ReflectionSourceStubber implements \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    private function createStubData(string $stub, ?string $extensionName) : \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        return new \_PhpScoper006a73f0e455\Roave\BetterReflection\SourceLocator\SourceStubber\StubData($stub, $extensionName);
    }
}
