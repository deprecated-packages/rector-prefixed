 ...
 * @internal
 */
final class ReflectionSourceStubber implements \_PhpScoper88fe6e0ad041\Roave\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    private function createStubData(string $stub, ?string $extensionName) : \_PhpScoper88fe6e0ad041\Roave\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        return new \_PhpScoper88fe6e0ad041\Roave\BetterReflection\SourceLocator\SourceStubber\StubData($stub, $extensionName);
    }
}
