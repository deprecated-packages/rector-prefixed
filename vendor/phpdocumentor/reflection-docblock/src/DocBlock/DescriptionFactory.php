...
class DescriptionFactory
{
     ...
     */
    public function __construct(\_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\DocBlock\TagFactory $tagFactory)
    {
     ...
     * @return Description
     */
    public function create($contents, \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context $context = null)
    {
        list($text, $tags) = $this->parse($this->lex($contents), $context);
        return new \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\DocBlock\Description($text, $tags);
    }
    /**
     ...
     * @return string[]|Tag[]
     */
    private function parse($tokens, \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context $context)
    {
        $count = \count($tokens);
        $tagCount = 0;
        $tags = [];
