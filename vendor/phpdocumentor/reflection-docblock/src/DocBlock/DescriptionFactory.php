...
class DescriptionFactory
{
     ...
     */
    public function __construct(\_PhpScoperabd03f0baf05\phpDocumentor\Reflection\DocBlock\TagFactory $tagFactory)
    {
     ...
     * @return Description
     */
    public function create($contents, \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context $context = null)
    {
        list($text, $tags) = $this->parse($this->lex($contents), $context);
        return new \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\DocBlock\Description($text, $tags);
    }
    /**
     ...
     * @return string[]|Tag[]
     */
    private function parse($tokens, \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context $context)
    {
        $count = \count($tokens);
        $tagCount = 0;
        $tags = [];
