...
use _PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Void_;
use _PhpScoperbd5d0c5f7638\Webmozart\Assert\Assert;
/**
 * Reflection class for an {@}method in a Docblock.
 */
final class Method extends \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\DocBlock\Tags\BaseTag implements \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    ...
    /** @var Type */
    private $returnType;
    public function __construct($methodName, array $arguments = [], \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Type $returnType = null, $static = \false, \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\DocBlock\Description $description = null)
    {
        \_PhpScoperbd5d0c5f7638\Webmozart\Assert\Assert::stringNotEmpty($methodName);
        \_PhpScoperbd5d0c5f7638\Webmozart\Assert\Assert::boolean($static);
        if ($returnType === null) {
            $returnType = new \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Void_();
        }
        ...
        if (\is_string($arguments) && \strlen($arguments) > 0) {
            ...
            foreach ($arguments as &$argument) {
                ...
                if ($argument[0][0] === '$') {
                    ...
                    $argumentType = new \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Void_();
                } else {
    ...
    private function filterArguments($arguments)
    {
        foreach ($arguments as &$argument) {
            ...
            if (!isset($argument['type'])) {
                $argument['type'] = new \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Void_();
            }
