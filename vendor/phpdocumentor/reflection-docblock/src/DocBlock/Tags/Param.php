 ...
 */
final class Param extends \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\DocBlock\Tags\TagWithType implements \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    /** @var string */
     ...
     */
    public function __construct($variableName, \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Type $type = null, $isVariadic = \false, \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\DocBlock\Description $description = null)
    {
        \_PhpScoper88fe6e0ad041\Webmozart\Assert\Assert::string($variableName);
        \_PhpScoper88fe6e0ad041\Webmozart\Assert\Assert::boolean($isVariadic);
        $this->name = 'param';
