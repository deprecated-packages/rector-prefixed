 ...
 */
final class Param extends \_PhpScopera143bcca66cb\phpDocumentor\Reflection\DocBlock\Tags\TagWithType implements \_PhpScopera143bcca66cb\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    /** @var string */
     ...
     */
    public function __construct($variableName, \_PhpScopera143bcca66cb\phpDocumentor\Reflection\Type $type = null, $isVariadic = \false, \_PhpScopera143bcca66cb\phpDocumentor\Reflection\DocBlock\Description $description = null)
    {
        \_PhpScopera143bcca66cb\Webmozart\Assert\Assert::string($variableName);
        \_PhpScopera143bcca66cb\Webmozart\Assert\Assert::boolean($isVariadic);
        $this->name = 'param';
