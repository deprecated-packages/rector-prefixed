 ...
 */
final class Link extends \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\DocBlock\Tags\BaseTag implements \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    protected $name = 'link';
    /** @var string */
    private $link = '';
     ...
     */
    public function __construct($link, \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\DocBlock\Description $description = null)
    {
        \_PhpScoperabd03f0baf05\Webmozart\Assert\Assert::string($link);
        $this->link = $link;
