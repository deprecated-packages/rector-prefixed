...
use _PhpScoper006a73f0e455\phpDocumentor\Reflection\DocBlock\Tags\Formatter;
use _PhpScoper006a73f0e455\phpDocumentor\Reflection\DocBlock\Tags\Formatter\PassthroughFormatter;
...
class Description
{
    ...
    {
        \_PhpScoper006a73f0e455\Webmozart\Assert\Assert::string($bodyTemplate);
     ...
     * @return string
     */
    public function render(\_PhpScoper006a73f0e455\phpDocumentor\Reflection\DocBlock\Tags\Formatter $formatter = null)
    {
        if ($formatter === null) {
            $formatter = new \_PhpScoper006a73f0e455\phpDocumentor\Reflection\DocBlock\Tags\Formatter\PassthroughFormatter();
        }
        $tags = [];
