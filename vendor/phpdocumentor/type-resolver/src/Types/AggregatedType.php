 ...
 */
abstract class AggregatedType implements \_PhpScoper006a73f0e455\phpDocumentor\Reflection\Type, \IteratorAggregate
{
    /**
     ...
     */
    public function get(int $index) : ?\_PhpScoper006a73f0e455\phpDocumentor\Reflection\Type
    {
        if (!$this->has($index)) {
            return null;
        }
     ...
     */
    public function contains(\_PhpScoper006a73f0e455\phpDocumentor\Reflection\Type $type) : bool
    {
     ...
     */
    private function add(\_PhpScoper006a73f0e455\phpDocumentor\Reflection\Type $type) : void
    {
