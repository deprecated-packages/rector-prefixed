 ...
 */
abstract class AggregatedType implements \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Type, \IteratorAggregate
{
    /**
     ...
     */
    public function get(int $index) : ?\_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Type
    {
        if (!$this->has($index)) {
            return null;
        }
     ...
     */
    public function contains(\_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Type $type) : bool
    {
     ...
     */
    private function add(\_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Type $type) : void
    {
