...
final class ContextFactory
{
     ...
     */
    public function createFromReflector(\Reflector $reflector) : \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionParameter(\ReflectionParameter $parameter) : \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionMethod(\ReflectionMethod $method) : \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionProperty(\ReflectionProperty $property) : \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionClassConstant(\ReflectionClassConstant $constant) : \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
     ...
     */
    private function createFromReflectionClass(\ReflectionClass $class) : \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context($namespace, []);
    }
    /**
     ...
     */
    public function createForNamespace(string $namespace, string $fileContents) : \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \_PhpScoper88fe6e0ad041\phpDocumentor\Reflection\Types\Context($namespace, $useStatements);
    }
    /**
