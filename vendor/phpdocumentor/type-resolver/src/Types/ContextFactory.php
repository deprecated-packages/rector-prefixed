...
final class ContextFactory
{
     ...
     */
    public function createFromReflector(\Reflector $reflector) : \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionParameter(\ReflectionParameter $parameter) : \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionMethod(\ReflectionMethod $method) : \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionProperty(\ReflectionProperty $property) : \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionClassConstant(\ReflectionClassConstant $constant) : \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
     ...
     */
    private function createFromReflectionClass(\ReflectionClass $class) : \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context($namespace, []);
    }
    /**
     ...
     */
    public function createForNamespace(string $namespace, string $fileContents) : \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \_PhpScoperbd5d0c5f7638\phpDocumentor\Reflection\Types\Context($namespace, $useStatements);
    }
    /**
