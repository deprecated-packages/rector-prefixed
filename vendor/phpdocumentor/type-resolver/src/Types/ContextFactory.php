...
final class ContextFactory
{
     ...
     */
    public function createFromReflector(\Reflector $reflector) : \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionParameter(\ReflectionParameter $parameter) : \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionMethod(\ReflectionMethod $method) : \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionProperty(\ReflectionProperty $property) : \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionClassConstant(\ReflectionClassConstant $constant) : \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
     ...
     */
    private function createFromReflectionClass(\ReflectionClass $class) : \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context($namespace, []);
    }
    /**
     ...
     */
    public function createForNamespace(string $namespace, string $fileContents) : \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \_PhpScoperabd03f0baf05\phpDocumentor\Reflection\Types\Context($namespace, $useStatements);
    }
    /**
