...
use function substr;
class Substitutions implements \RectorPrefix20210317\Doctrine\Inflector\WordInflector
{
    /** @var Substitution[] */
    ...
    public function getFlippedSubstitutions() : \RectorPrefix20210317\Doctrine\Inflector\Rules\Substitutions
    {
        $substitutions = [];
        foreach ($this->substitutions as $substitution) {
            $substitutions[] = new \RectorPrefix20210317\Doctrine\Inflector\Rules\Substitution($substitution->getTo(), $substitution->getFrom());
        }
        return new \RectorPrefix20210317\Doctrine\Inflector\Rules\Substitutions(...$substitutions);
    }
