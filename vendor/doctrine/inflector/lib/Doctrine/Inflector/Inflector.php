...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\_PhpScoper17db12703726\Doctrine\Inflector\WordInflector $singularizer, \_PhpScoper17db12703726\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => '_PhpScoper17db12703726\\1_\\2', '/([a-z\\d])([A-Z])/' => '_PhpScoper17db12703726\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
