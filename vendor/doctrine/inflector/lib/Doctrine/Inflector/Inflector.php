...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\_PhpScoper5edc98a7cce2\Doctrine\Inflector\WordInflector $singularizer, \_PhpScoper5edc98a7cce2\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => '_PhpScoper5edc98a7cce2\\1_\\2', '/([a-z\\d])([A-Z])/' => '_PhpScoper5edc98a7cce2\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
...
\class_alias('Doctrine\Inflector\Inflector', 'Doctrine\\Inflector\\Inflector', \false);
