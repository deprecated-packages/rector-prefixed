...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\_PhpScoperbf340cb0be9d\Doctrine\Inflector\WordInflector $singularizer, \_PhpScoperbf340cb0be9d\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => '_PhpScoperbf340cb0be9d\\1_\\2', '/([a-z\\d])([A-Z])/' => '_PhpScoperbf340cb0be9d\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
...
\class_alias('_PhpScoperbf340cb0be9d\\Doctrine\\Inflector\\Inflector', 'Doctrine\\Inflector\\Inflector', \false);
