...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\_PhpScopere8e811afab72\Doctrine\Inflector\WordInflector $singularizer, \_PhpScopere8e811afab72\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => '_PhpScopere8e811afab72\\1_\\2', '/([a-z\\d])([A-Z])/' => '_PhpScopere8e811afab72\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
