...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\_PhpScoper267b3276efc2\Doctrine\Inflector\WordInflector $singularizer, \_PhpScoper267b3276efc2\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => '_PhpScoper267b3276efc2\\1_\\2', '/([a-z\\d])([A-Z])/' => '_PhpScoper267b3276efc2\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
...
\class_alias('_PhpScoper267b3276efc2\\Doctrine\\Inflector\\Inflector', 'Doctrine\\Inflector\\Inflector', \false);
