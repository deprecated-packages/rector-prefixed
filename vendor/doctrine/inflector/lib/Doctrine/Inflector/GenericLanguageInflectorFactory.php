...
abstract class GenericLanguageInflectorFactory implements \RectorPrefix20210315\Doctrine\Inflector\LanguageInflectorFactory
{
    /** @var Ruleset[] */
    ...
    public final function build() : \RectorPrefix20210315\Doctrine\Inflector\Inflector
    {
    ...
    public final function withSingularRules(?\RectorPrefix20210315\Doctrine\Inflector\Rules\Ruleset $singularRules, bool $reset = \false) : self
    {
        ...
        if ($singularRules instanceof \RectorPrefix20210315\Doctrine\Inflector\Rules\Ruleset) {
    ...
    public final function withPluralRules(?\RectorPrefix20210315\Doctrine\Inflector\Rules\Ruleset $pluralRules, bool $reset = \false) : self
    {
        ...
        if ($pluralRules instanceof \RectorPrefix20210315\Doctrine\Inflector\Rules\Ruleset) {
            \array_unshift($this->pluralRulesets, $pluralRules);
        }
        return $this;
    }
    protected abstract function getSingularRuleset() : \RectorPrefix20210315\Doctrine\Inflector\Rules\Ruleset;
    protected abstract function getPluralRuleset() : \RectorPrefix20210315\Doctrine\Inflector\Rules\Ruleset;
}
