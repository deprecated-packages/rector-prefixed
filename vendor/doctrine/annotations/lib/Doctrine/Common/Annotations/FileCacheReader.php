 ...
 */
class FileCacheReader implements \_PhpScoper50d83356d739\Doctrine\Common\Annotations\Reader
{
    /** @var Reader */
    private $reader;
    /** @var string */
     ...
     */
    public function __construct(\_PhpScoper50d83356d739\Doctrine\Common\Annotations\Reader $reader, $cacheDir, $debug = \false, $umask = 02)
    {
        if (!\is_int($umask)) {
