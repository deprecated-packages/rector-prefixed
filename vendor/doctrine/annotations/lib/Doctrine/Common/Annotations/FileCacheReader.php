 ...
 */
class FileCacheReader implements \RectorPrefix20210324\Doctrine\Common\Annotations\Reader
{
    /** @var Reader */
    private $reader;
    /** @var string */
     ...
     */
    public function __construct(\RectorPrefix20210324\Doctrine\Common\Annotations\Reader $reader, $cacheDir, $debug = \false, $umask = 02)
    {
        if (!\is_int($umask)) {
