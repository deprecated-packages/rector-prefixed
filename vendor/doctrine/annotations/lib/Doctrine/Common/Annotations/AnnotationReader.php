 ...
 */
class AnnotationReader implements \RectorPrefix20210314\Doctrine\Common\Annotations\Reader
{
    /**
     ...
     */
    public function __construct(?\RectorPrefix20210314\Doctrine\Common\Annotations\DocParser $parser = null)
    {
        ...
        $this->preParser = new \RectorPrefix20210314\Doctrine\Common\Annotations\DocParser();
    ...
    public function getFunctionAnnotations(\ReflectionFunction $function) : array
    {
        ...
        $this->parser->setTarget(\RectorPrefix20210314\Doctrine\Common\Annotations\Annotation\Target::TARGET_FUNCTION);
