...
use RectorPrefix20210319\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation;
 ...
 */
class AnnotationReader implements \RectorPrefix20210319\Doctrine\Common\Annotations\Reader
{
    /**
     ...
     */
    private static $globalImports = ['ignoreannotation' => \RectorPrefix20210319\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation::class];
    /**
     ...
     */
    private static $globalIgnoredNames = \RectorPrefix20210319\Doctrine\Common\Annotations\ImplicitlyIgnoredAnnotationNames::LIST;
    /**
     * A list with annotations that are not causing exceptions when not resolved to an annotation class.
     *
     * The names are case sensitive.
     ...
     */
    public function __construct(?\RectorPrefix20210319\Doctrine\Common\Annotations\DocParser $parser = null)
    {
        if (\extension_loaded('Zend Optimizer+') && (\ini_get('zend_optimizerplus.save_comments') === '0' || \ini_get('opcache.save_comments') === '0')) {
            throw \RectorPrefix20210319\Doctrine\Common\Annotations\AnnotationException::optimizerPlusSaveComments();
        }
        if (\extension_loaded('Zend OPcache') && \ini_get('opcache.save_comments') === 0) {
            throw \RectorPrefix20210319\Doctrine\Common\Annotations\AnnotationException::optimizerPlusSaveComments();
        }
        // Make sure that the IgnoreAnnotation annotation is loaded
        \class_exists(\RectorPrefix20210319\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation::class);
        $this->parser = $parser ?: new \RectorPrefix20210319\Doctrine\Common\Annotations\DocParser();
        $this->preParser = new \RectorPrefix20210319\Doctrine\Common\Annotations\DocParser();
        $this->preParser->setImports(self::$globalImports);
        $this->preParser->setIgnoreNotImportedAnnotations(\true);
        $this->preParser->setIgnoredAnnotationNames(self::$globalIgnoredNames);
        $this->phpParser = new \RectorPrefix20210319\Doctrine\Common\Annotations\PhpParser();
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        $this->parser->setTarget(\RectorPrefix20210319\Doctrine\Common\Annotations\Annotation\Target::TARGET_CLASS);
    ...
    public function getPropertyAnnotations(\ReflectionProperty $property)
    {
        ...
        $this->parser->setTarget(\RectorPrefix20210319\Doctrine\Common\Annotations\Annotation\Target::TARGET_PROPERTY);
    ...
    public function getMethodAnnotations(\ReflectionMethod $method)
    {
        ...
        $this->parser->setTarget(\RectorPrefix20210319\Doctrine\Common\Annotations\Annotation\Target::TARGET_METHOD);
    ...
    public function getFunctionAnnotations(\ReflectionFunction $function) : array
    {
        ...
        $this->parser->setTarget(\RectorPrefix20210319\Doctrine\Common\Annotations\Annotation\Target::TARGET_FUNCTION);
    ...
    private function collectParsingMetadata($reflection) : void
    {
        ...
        foreach ($annotations as $annotation) {
            if (!$annotation instanceof \RectorPrefix20210319\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation) {
                continue;
            }
