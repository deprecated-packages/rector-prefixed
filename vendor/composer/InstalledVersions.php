...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210123\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
