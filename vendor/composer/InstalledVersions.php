...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210129\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('RectorPrefix20210129\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\RectorPrefix20210129\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
