...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210117\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
