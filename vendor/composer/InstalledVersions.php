...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper5edc98a7cce2\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
