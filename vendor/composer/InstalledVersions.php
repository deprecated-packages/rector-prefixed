...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210121\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
