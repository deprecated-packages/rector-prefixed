...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20201228\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
