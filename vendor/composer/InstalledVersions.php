...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210126\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
