...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210101\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
