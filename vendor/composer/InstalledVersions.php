...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix2020DecSat\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
