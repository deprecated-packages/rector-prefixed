...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20201226\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
