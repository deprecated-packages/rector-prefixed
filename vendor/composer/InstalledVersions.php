...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210122\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
