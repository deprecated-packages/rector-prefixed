...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper0a2ac50786fa\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
