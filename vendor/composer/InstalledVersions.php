...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210103\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
