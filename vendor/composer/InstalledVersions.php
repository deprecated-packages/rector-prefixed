...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210125\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
