...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperfce0de0de1ce\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
