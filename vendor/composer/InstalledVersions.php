...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScopere8e811afab72\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
