...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperbf340cb0be9d\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
