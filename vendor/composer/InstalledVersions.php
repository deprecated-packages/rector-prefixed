...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper17db12703726\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
