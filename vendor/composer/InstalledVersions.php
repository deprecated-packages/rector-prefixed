...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20201229\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
