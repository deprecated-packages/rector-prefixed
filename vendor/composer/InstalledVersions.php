...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210111\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
