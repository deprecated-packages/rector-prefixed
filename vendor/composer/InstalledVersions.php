...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper2a4e7ab1ecbc\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
