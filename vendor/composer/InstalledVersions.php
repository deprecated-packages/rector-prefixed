...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper0a6b37af0871\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
