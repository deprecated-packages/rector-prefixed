...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210107\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
