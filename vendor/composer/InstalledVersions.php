...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20201230\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
