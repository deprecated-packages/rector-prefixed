...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210106\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
