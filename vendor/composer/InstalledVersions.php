...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210127\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
