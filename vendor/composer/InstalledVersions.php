...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210115\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
