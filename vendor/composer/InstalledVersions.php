...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210108\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
