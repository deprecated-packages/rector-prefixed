...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper267b3276efc2\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
