...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20201231\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
