...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210105\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
