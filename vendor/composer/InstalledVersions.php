...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210116\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
