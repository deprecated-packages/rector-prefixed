...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210120\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
