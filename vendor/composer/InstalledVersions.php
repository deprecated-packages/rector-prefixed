...
class InstalledVersions
{
    ...
    public static function satisfies(\RectorPrefix20210112\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
