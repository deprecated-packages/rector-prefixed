...
class PhpConfig
{
    ...
    {
        if ($data = \RectorPrefix20210509\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \RectorPrefix20210509\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
