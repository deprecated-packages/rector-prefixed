...
class PhpConfig
{
    ...
    {
        if ($data = \RectorPrefix20210508\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \RectorPrefix20210508\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
