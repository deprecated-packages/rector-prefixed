...
class PhpConfig
{
    ...
    {
        if ($data = $this->getDataAndReset()) {
            \_PhpScoper267b3276efc2\Composer\XdebugHandler\Process::setEnv('PHPRC', $data['tmpIni']);
            \_PhpScoper267b3276efc2\Composer\XdebugHandler\Process::setEnv('PHP_INI_SCAN_DIR', '');
        }
        return array();
    }
    /**
    ...
    {
        if ($data = \_PhpScoper267b3276efc2\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
            \_PhpScoper267b3276efc2\Composer\XdebugHandler\Process::setEnv('PHPRC', $data['phprc']);
            \_PhpScoper267b3276efc2\Composer\XdebugHandler\Process::setEnv('PHP_INI_SCAN_DIR', $data['scanDir']);
        }
        return $data;
    }
}
