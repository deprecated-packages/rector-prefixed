...
class PhpConfig
{
    ...
    {
        if ($data = \RectorPrefix20210506\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \RectorPrefix20210506\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
