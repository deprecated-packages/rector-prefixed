...
class PhpConfig
{
    ...
    {
        if ($data = \RectorPrefix20210505\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \RectorPrefix20210505\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
