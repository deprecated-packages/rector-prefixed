...
class PhpConfig
{
    ...
    {
        if ($data = $this->getDataAndReset()) {
            \_PhpScoper5edc98a7cce2\Composer\XdebugHandler\Process::setEnv('PHPRC', $data['tmpIni']);
            \_PhpScoper5edc98a7cce2\Composer\XdebugHandler\Process::setEnv('PHP_INI_SCAN_DIR', '');
        }
        return array();
    }
    /**
    ...
    {
        if ($data = \_PhpScoper5edc98a7cce2\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
            \_PhpScoper5edc98a7cce2\Composer\XdebugHandler\Process::setEnv('PHPRC', $data['phprc']);
            \_PhpScoper5edc98a7cce2\Composer\XdebugHandler\Process::setEnv('PHP_INI_SCAN_DIR', $data['scanDir']);
        }
        return $data;
    }
}
