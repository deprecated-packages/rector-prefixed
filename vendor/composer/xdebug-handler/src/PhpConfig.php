...
class PhpConfig
{
    ...
    {
        if ($data = \RectorPrefix20210507\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \RectorPrefix20210507\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
