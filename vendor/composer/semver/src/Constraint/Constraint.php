 ...
 */
namespace RectorPrefix20210103\Composer\Semver\Constraint;

/**
 * Defines a constraint.
 */
class Constraint implements \RectorPrefix20210103\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matches(\RectorPrefix20210103\Composer\Semver\Constraint\ConstraintInterface $provider)
    {
     ...
     * @return bool
     */
    public function matchSpecific(\RectorPrefix20210103\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
    ...
    private function extractBounds()
    {
        ...
        // Branches
        if (\strpos($this->version, 'dev-') === 0) {
            $this->lowerBound = \RectorPrefix20210103\Composer\Semver\Constraint\Bound::zero();
            $this->upperBound = \RectorPrefix20210103\Composer\Semver\Constraint\Bound::positiveInfinity();
            return;
        }
        switch ($this->operator) {
            case self::OP_EQ:
                $this->lowerBound = new \RectorPrefix20210103\Composer\Semver\Constraint\Bound($this->version, \true);
                $this->upperBound = new \RectorPrefix20210103\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_LT:
                $this->lowerBound = \RectorPrefix20210103\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \RectorPrefix20210103\Composer\Semver\Constraint\Bound($this->version, \false);
                break;
            case self::OP_LE:
                $this->lowerBound = \RectorPrefix20210103\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \RectorPrefix20210103\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_GT:
                $this->lowerBound = new \RectorPrefix20210103\Composer\Semver\Constraint\Bound($this->version, \false);
                $this->upperBound = \RectorPrefix20210103\Composer\Semver\Constraint\Bound::positiveInfinity();
                break;
            case self::OP_GE:
                $this->lowerBound = new \RectorPrefix20210103\Composer\Semver\Constraint\Bound($this->version, \true);
