...
use RectorPrefix20210506\Composer\Composer;
use RectorPrefix20210506\Composer\Config;
use RectorPrefix20210506\Composer\EventDispatcher\EventSubscriberInterface;
use RectorPrefix20210506\Composer\IO\IOInterface;
use RectorPrefix20210506\Composer\Package\AliasPackage;
use RectorPrefix20210506\Composer\Package\Locker;
use RectorPrefix20210506\Composer\Package\PackageInterface;
use RectorPrefix20210506\Composer\Package\RootPackageInterface;
use RectorPrefix20210506\Composer\Plugin\PluginInterface;
use RectorPrefix20210506\Composer\Script\Event;
use RectorPrefix20210506\Composer\Script\ScriptEvents;
use Generator;
...
final class Installer implements \RectorPrefix20210506\Composer\Plugin\PluginInterface, \RectorPrefix20210506\Composer\EventDispatcher\EventSubscriberInterface
{
...
PHP;
    public function activate(\RectorPrefix20210506\Composer\Composer $composer, \RectorPrefix20210506\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    public function deactivate(\RectorPrefix20210506\Composer\Composer $composer, \RectorPrefix20210506\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    public function uninstall(\RectorPrefix20210506\Composer\Composer $composer, \RectorPrefix20210506\Composer\IO\IOInterface $io)
    {
        // Nothing to do here, as all features are provided through event listeners
    }
    /**
    ...
    {
        return [\RectorPrefix20210506\Composer\Script\ScriptEvents::POST_AUTOLOAD_DUMP => 'dumpVersionsClass'];
    }
    /**
     * @throws RuntimeException
     */
    public static function dumpVersionsClass(\RectorPrefix20210506\Composer\Script\Event $composerEvent)
    {
     ...
     * @throws RuntimeException
     */
    private static function writeVersionClassToFile(string $versionClassSource, \RectorPrefix20210506\Composer\Composer $composer, \RectorPrefix20210506\Composer\IO\IOInterface $io)
    {
     ...
     * @throws RuntimeException
     */
    private static function locateRootPackageInstallPath(\RectorPrefix20210506\Composer\Config $composerConfig, \RectorPrefix20210506\Composer\Package\RootPackageInterface $rootPackage) : string
    {
    ...
    private static function getRootPackageAlias(\RectorPrefix20210506\Composer\Package\RootPackageInterface $rootPackage) : \RectorPrefix20210506\Composer\Package\PackageInterface
    {
        $package = $rootPackage;
        while ($package instanceof \RectorPrefix20210506\Composer\Package\AliasPackage) {
     ...
     */
    private static function getVersions(\RectorPrefix20210506\Composer\Package\Locker $locker, \RectorPrefix20210506\Composer\Package\RootPackageInterface $rootPackage) : \Generator
    {
