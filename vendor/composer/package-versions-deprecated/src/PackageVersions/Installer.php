...
use RectorPrefix20210503\Composer\Script\Event;
...
final class Installer implements \RectorPrefix20210503\Composer\Plugin\PluginInterface, \RectorPrefix20210503\Composer\EventDispatcher\EventSubscriberInterface
{
...
PHP;
    ...
    {
        return [\RectorPrefix20210503\Composer\Script\ScriptEvents::POST_AUTOLOAD_DUMP => 'dumpVersionsClass'];
    }
    /**
     * @throws RuntimeException
     */
    public static function dumpVersionsClass(\RectorPrefix20210503\Composer\Script\Event $composerEvent)
    {
     ...
     * @throws RuntimeException
     */
    private static function writeVersionClassToFile(string $versionClassSource, \RectorPrefix20210503\Composer\Composer $composer, \RectorPrefix20210503\Composer\IO\IOInterface $io)
    {
     ...
     * @throws RuntimeException
     */
    private static function locateRootPackageInstallPath(\RectorPrefix20210503\Composer\Config $composerConfig, \RectorPrefix20210503\Composer\Package\RootPackageInterface $rootPackage) : string
    {
    ...
    private static function getRootPackageAlias(\RectorPrefix20210503\Composer\Package\RootPackageInterface $rootPackage) : \RectorPrefix20210503\Composer\Package\PackageInterface
    {
        $package = $rootPackage;
     ...
     */
    private static function getVersions(\RectorPrefix20210503\Composer\Package\Locker $locker, \RectorPrefix20210503\Composer\Package\RootPackageInterface $rootPackage) : \Generator
    {
