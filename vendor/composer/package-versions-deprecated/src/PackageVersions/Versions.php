...
use _PhpScoper50d83356d739\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper50d83356d739\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper50d83356d739\Composer\InstalledVersions::class, \false) || !\_PhpScoper50d83356d739\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper50d83356d739\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper50d83356d739\Composer\InstalledVersions::class, \false) && \_PhpScoper50d83356d739\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper50d83356d739\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper50d83356d739\Composer\InstalledVersions::getReference($packageName);
        }
