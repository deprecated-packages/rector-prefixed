...
use _PhpScoperbf340cb0be9d\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoperbf340cb0be9d\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoperbf340cb0be9d\Composer\InstalledVersions::class, \false) || !\_PhpScoperbf340cb0be9d\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoperbf340cb0be9d\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoperbf340cb0be9d\Composer\InstalledVersions::class, \false) && \_PhpScoperbf340cb0be9d\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoperbf340cb0be9d\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoperbf340cb0be9d\Composer\InstalledVersions::getReference($packageName);
        }
