...
use RectorPrefix20210219\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\RectorPrefix20210219\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\RectorPrefix20210219\Composer\InstalledVersions::class, \false) || !\RectorPrefix20210219\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \RectorPrefix20210219\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\RectorPrefix20210219\Composer\InstalledVersions::class, \false) && \RectorPrefix20210219\Composer\InstalledVersions::getRawData()) {
            return \RectorPrefix20210219\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \RectorPrefix20210219\Composer\InstalledVersions::getReference($packageName);
        }
