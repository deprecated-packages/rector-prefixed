...
use _PhpScoperbd5d0c5f7638\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoperbd5d0c5f7638\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoperbd5d0c5f7638\Composer\InstalledVersions::class, \false) || !\_PhpScoperbd5d0c5f7638\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoperbd5d0c5f7638\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoperbd5d0c5f7638\Composer\InstalledVersions::class, \false) && \_PhpScoperbd5d0c5f7638\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoperbd5d0c5f7638\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoperbd5d0c5f7638\Composer\InstalledVersions::getReference($packageName);
        }
