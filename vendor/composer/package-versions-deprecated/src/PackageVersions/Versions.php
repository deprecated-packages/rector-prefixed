...
use RectorPrefix20201231\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\RectorPrefix20201231\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\RectorPrefix20201231\Composer\InstalledVersions::class, \false) || !\RectorPrefix20201231\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \RectorPrefix20201231\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\RectorPrefix20201231\Composer\InstalledVersions::class, \false) && \RectorPrefix20201231\Composer\InstalledVersions::getRawData()) {
            return \RectorPrefix20201231\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \RectorPrefix20201231\Composer\InstalledVersions::getReference($packageName);
        }
