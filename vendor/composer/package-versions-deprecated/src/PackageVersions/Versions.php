...
use _PhpScoper0a2ac50786fa\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper0a2ac50786fa\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper0a2ac50786fa\Composer\InstalledVersions::class, \false) || !\_PhpScoper0a2ac50786fa\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper0a2ac50786fa\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper0a2ac50786fa\Composer\InstalledVersions::class, \false) && \_PhpScoper0a2ac50786fa\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper0a2ac50786fa\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper0a2ac50786fa\Composer\InstalledVersions::getReference($packageName);
        }
