...
use RectorPrefix2020DecSat\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\RectorPrefix2020DecSat\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\RectorPrefix2020DecSat\Composer\InstalledVersions::class, \false) || !\RectorPrefix2020DecSat\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \RectorPrefix2020DecSat\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\RectorPrefix2020DecSat\Composer\InstalledVersions::class, \false) && \RectorPrefix2020DecSat\Composer\InstalledVersions::getRawData()) {
            return \RectorPrefix2020DecSat\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \RectorPrefix2020DecSat\Composer\InstalledVersions::getReference($packageName);
        }
