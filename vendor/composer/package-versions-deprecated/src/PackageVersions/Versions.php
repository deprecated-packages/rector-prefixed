...
use _PhpScoperabd03f0baf05\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoperabd03f0baf05\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoperabd03f0baf05\Composer\InstalledVersions::class, \false) || !\_PhpScoperabd03f0baf05\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoperabd03f0baf05\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoperabd03f0baf05\Composer\InstalledVersions::class, \false) && \_PhpScoperabd03f0baf05\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoperabd03f0baf05\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoperabd03f0baf05\Composer\InstalledVersions::getReference($packageName);
        }
