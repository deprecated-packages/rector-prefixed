 ...
 */
class Encoder extends \_PhpScoperabd03f0baf05\Evenement\EventEmitter implements \_PhpScoperabd03f0baf05\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\_PhpScoperabd03f0baf05\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
