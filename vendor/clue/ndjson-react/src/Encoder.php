 ...
 */
class Encoder extends \_PhpScoper26e51eeacccf\Evenement\EventEmitter implements \_PhpScoper26e51eeacccf\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\_PhpScoper26e51eeacccf\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
