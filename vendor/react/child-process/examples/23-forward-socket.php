...
$server = new \_PhpScoperabd03f0baf05\React\Socket\Server('127.0.0.1:0', $loop);
$server->on('connection', function (\_PhpScoperabd03f0baf05\React\Socket\ConnectionInterface $connection) {
...
$process = new \_PhpScoperabd03f0baf05\React\ChildProcess\Process($command . ' | php -r ' . \escapeshellarg($code) . ' ' . $server->getAddress(), null, null, array());
$process->start($loop);
