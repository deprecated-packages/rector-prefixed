...
class UnwrapWritableTest extends \_PhpScopera143bcca66cb\React\Tests\Promise\Stream\TestCase
{
    private $loop;
    ...
    public function testReturnsWritableStreamForPromise()
    {
        ...
        $stream = \_PhpScopera143bcca66cb\React\Promise\Stream\unwrapWritable($promise);
    ...
    {
        $input = $this->getMockBuilder('_PhpScopera143bcca66cb\\React\\Stream\\WritableStreamInterface')->getMock();
    ...
    public function testEmitsDrainWhenPromiseResolvesWithStreamWhenForwardingData()
    {
        ...
        $stream = \_PhpScopera143bcca66cb\React\Promise\Stream\unwrapWritable($deferred->promise());
        $stream->write('hello');
    ...
    public function testClosingStreamWillCloseStreamIfItIgnoredCancellationAndResolvesLater()
    {
        ...
        $deferred = new \_PhpScopera143bcca66cb\React\Promise\Deferred();
        $stream = \_PhpScopera143bcca66cb\React\Promise\Stream\unwrapReadable($deferred->promise());
        $stream->on('close', $this->expectCallableOnce());
        $stream->close();
    ...
    {
        $promise = \_PhpScopera143bcca66cb\React\Promise\resolve(new \_PhpScopera143bcca66cb\React\Stream\ThroughStream());
        $stream = \_PhpScopera143bcca66cb\React\Promise\Stream\unwrapWritable($promise);
        $stream->close();
