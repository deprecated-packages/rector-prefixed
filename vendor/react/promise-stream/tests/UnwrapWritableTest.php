...
class UnwrapWritableTest extends \_PhpScoper88fe6e0ad041\React\Tests\Promise\Stream\TestCase
{
    private $loop;
    ...
    public function testReturnsWritableStreamForPromise()
    {
        ...
        $stream = \_PhpScoper88fe6e0ad041\React\Promise\Stream\unwrapWritable($promise);
    ...
    {
        $input = $this->getMockBuilder('_PhpScoper88fe6e0ad041\\React\\Stream\\WritableStreamInterface')->getMock();
    ...
    public function testEmitsDrainWhenPromiseResolvesWithStreamWhenForwardingData()
    {
        ...
        $stream = \_PhpScoper88fe6e0ad041\React\Promise\Stream\unwrapWritable($deferred->promise());
        $stream->write('hello');
    ...
    public function testClosingStreamWillCloseStreamIfItIgnoredCancellationAndResolvesLater()
    {
        ...
        $deferred = new \_PhpScoper88fe6e0ad041\React\Promise\Deferred();
        $stream = \_PhpScoper88fe6e0ad041\React\Promise\Stream\unwrapReadable($deferred->promise());
        $stream->on('close', $this->expectCallableOnce());
        $stream->close();
    ...
    {
        $promise = \_PhpScoper88fe6e0ad041\React\Promise\resolve(new \_PhpScoper88fe6e0ad041\React\Stream\ThroughStream());
        $stream = \_PhpScoper88fe6e0ad041\React\Promise\Stream\unwrapWritable($promise);
        $stream->close();
