...
class TestCase extends \_PhpScopera143bcca66cb\PHPUnit\Framework\TestCase
{
    ...
    {
        return $this->getMockBuilder('_PhpScopera143bcca66cb\\React\\Tests\\Promise\\Stream\\CallableStub')->getMock();
    }
    protected function expectPromiseResolve($promise)
    {
        $this->assertInstanceOf('_PhpScopera143bcca66cb\\React\\Promise\\PromiseInterface', $promise);
