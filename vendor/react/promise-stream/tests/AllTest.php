...
class AllTest extends \_PhpScoperbd5d0c5f7638\React\Tests\Promise\Stream\TestCase
{
    public function testClosedStreamResolvesWithEmptyBuffer()
    {
        $stream = new \_PhpScoperbd5d0c5f7638\React\Stream\ThroughStream();
        $stream->close();
        $promise = \_PhpScoperbd5d0c5f7638\React\Promise\Stream\all($stream);
    ...
    {
        $stream = new \_PhpScoperbd5d0c5f7638\React\Stream\ThroughStream();
        $promise = \_PhpScoperbd5d0c5f7638\React\Promise\Stream\all($stream, 'a');
