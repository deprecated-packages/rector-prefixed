...
class BufferTest extends \_PhpScoper26e51eeacccf\React\Tests\Promise\Stream\TestCase
{
    public function testClosedStreamResolvesWithEmptyBuffer()
    {
        $stream = new \_PhpScoper26e51eeacccf\React\Stream\ThroughStream();
        $stream->close();
        $promise = \_PhpScoper26e51eeacccf\React\Promise\Stream\buffer($stream);
    ...
    public function testMaximumSize()
    {
        ...
        $promise = \_PhpScoper26e51eeacccf\React\Promise\Stream\buffer($stream, 16);
        ...
        \_PhpScoper26e51eeacccf\Clue\React\Block\await($promise, $loop, 10);
    }
    public function testUnderMaximumSize()
    {
        ...
        $promise = \_PhpScoper26e51eeacccf\React\Promise\Stream\buffer($stream, 16);
        $result = \_PhpScoper26e51eeacccf\Clue\React\Block\await($promise, $loop, 10);
