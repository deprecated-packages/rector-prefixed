...
class BufferTest extends \_PhpScoper006a73f0e455\React\Tests\Promise\Stream\TestCase
{
    public function testClosedStreamResolvesWithEmptyBuffer()
    {
        $stream = new \_PhpScoper006a73f0e455\React\Stream\ThroughStream();
        $stream->close();
        $promise = \_PhpScoper006a73f0e455\React\Promise\Stream\buffer($stream);
    ...
    public function testMaximumSize()
    {
        ...
        $promise = \_PhpScoper006a73f0e455\React\Promise\Stream\buffer($stream, 16);
        ...
        \_PhpScoper006a73f0e455\Clue\React\Block\await($promise, $loop, 10);
    }
    public function testUnderMaximumSize()
    {
        ...
        $promise = \_PhpScoper006a73f0e455\React\Promise\Stream\buffer($stream, 16);
        $result = \_PhpScoper006a73f0e455\Clue\React\Block\await($promise, $loop, 10);
