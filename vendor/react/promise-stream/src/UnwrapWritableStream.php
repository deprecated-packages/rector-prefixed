 ...
 */
class UnwrapWritableStream extends \_PhpScoper88fe6e0ad041\Evenement\EventEmitter implements \_PhpScoper88fe6e0ad041\React\Stream\WritableStreamInterface
{
    private $promise;
    private $stream;
    ...
    public function __construct(\_PhpScoper88fe6e0ad041\React\Promise\PromiseInterface $promise)
    {
        ...
        $this->promise = $promise->then(function ($stream) {
            if (!$stream instanceof \_PhpScoper88fe6e0ad041\React\Stream\WritableStreamInterface) {
                throw new \InvalidArgumentException('Not a writable stream');
            }
            return $stream;
        })->then(function (\_PhpScoper88fe6e0ad041\React\Stream\WritableStreamInterface $stream) use($out, &$store, &$buffer, &$ending, &$closed) {
