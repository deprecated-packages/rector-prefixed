 ...
 */
class UnwrapReadableStream extends \_PhpScoper006a73f0e455\Evenement\EventEmitter implements \_PhpScoper006a73f0e455\React\Stream\ReadableStreamInterface
{
    private $promise;
     ...
     */
    public function __construct(\_PhpScoper006a73f0e455\React\Promise\PromiseInterface $promise)
    {
        $out = $this;
        $closed =& $this->closed;
        $this->promise = $promise->then(function ($stream) {
            ...
            return $stream;
        })->then(function (\_PhpScoper006a73f0e455\React\Stream\ReadableStreamInterface $stream) use($out, &$closed) {
    ...
    public function pause()
    {
        if ($this->promise !== null) {
            $this->promise->then(function (\_PhpScoper006a73f0e455\React\Stream\ReadableStreamInterface $stream) {
                $stream->pause();
            });
        }
    }
    ...
    public function close()
    {
        ...
        if ($this->promise instanceof \_PhpScoper006a73f0e455\React\Promise\CancellablePromiseInterface) {
            $this->promise->cancel();
        }
        $this->promise = null;
        $this->emit('close');
