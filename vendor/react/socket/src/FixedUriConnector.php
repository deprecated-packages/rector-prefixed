 ...
 * ```
 */
class FixedUriConnector implements \_PhpScoper88fe6e0ad041\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \_PhpScoper88fe6e0ad041\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
