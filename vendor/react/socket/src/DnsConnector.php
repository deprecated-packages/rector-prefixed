...
final class DnsConnector implements \_PhpScopera143bcca66cb\React\Socket\ConnectorInterface
{
    private $connector;
    private $resolver;
    public function __construct(\_PhpScopera143bcca66cb\React\Socket\ConnectorInterface $connector, \_PhpScopera143bcca66cb\React\Dns\Resolver\ResolverInterface $resolver)
    {
    ...
    public function connect($uri)
    {
        ...
        $resolved = null;
        return new \_PhpScopera143bcca66cb\React\Promise\Promise(function ($resolve, $reject) use(&$promise, &$resolved, $uri, $connector, $host, $parts) {
