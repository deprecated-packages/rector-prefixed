...
final class DnsConnector implements \_PhpScoper88fe6e0ad041\React\Socket\ConnectorInterface
{
    private $connector;
    private $resolver;
    public function __construct(\_PhpScoper88fe6e0ad041\React\Socket\ConnectorInterface $connector, \_PhpScoper88fe6e0ad041\React\Dns\Resolver\ResolverInterface $resolver)
    {
    ...
    public function connect($uri)
    {
        ...
        $resolved = null;
        return new \_PhpScoper88fe6e0ad041\React\Promise\Promise(function ($resolve, $reject) use(&$promise, &$resolved, $uri, $connector, $host, $parts) {
