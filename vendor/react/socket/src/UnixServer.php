 ...
 */
final class UnixServer extends \_PhpScoper006a73f0e455\Evenement\EventEmitter implements \_PhpScoper006a73f0e455\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \_PhpScoper006a73f0e455\React\EventLoop\LoopInterface $loop, array $context = array())
    {
        $this->loop = $loop;
    ...
    {
        $connection = new \_PhpScoper006a73f0e455\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
