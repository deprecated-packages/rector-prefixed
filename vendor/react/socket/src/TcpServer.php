 ...
 */
final class TcpServer extends \_PhpScoper006a73f0e455\Evenement\EventEmitter implements \_PhpScoper006a73f0e455\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    ...
    {
        $this->emit('connection', array(new \_PhpScoper006a73f0e455\React\Socket\Connection($socket, $this->loop)));
    }
}
