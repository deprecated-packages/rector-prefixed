 ...
 */
final class SecureServer extends \_PhpScoper26e51eeacccf\Evenement\EventEmitter implements \_PhpScoper26e51eeacccf\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\_PhpScoper26e51eeacccf\React\Socket\ServerInterface $tcp, \_PhpScoper26e51eeacccf\React\EventLoop\LoopInterface $loop, array $context)
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \_PhpScoper26e51eeacccf\React\Socket\StreamEncryption($loop);
