 ...
 */
final class SecureServer extends \_PhpScoper006a73f0e455\Evenement\EventEmitter implements \_PhpScoper006a73f0e455\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\_PhpScoper006a73f0e455\React\Socket\ServerInterface $tcp, \_PhpScoper006a73f0e455\React\EventLoop\LoopInterface $loop, array $context)
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \_PhpScoper006a73f0e455\React\Socket\StreamEncryption($loop);
    ...
    /** @internal */
    public function handleConnection(\_PhpScoper006a73f0e455\React\Socket\ConnectionInterface $connection)
    {
