 ...
 */
final class SecureServer extends \_PhpScoperabd03f0baf05\Evenement\EventEmitter implements \_PhpScoperabd03f0baf05\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\_PhpScoperabd03f0baf05\React\Socket\ServerInterface $tcp, \_PhpScoperabd03f0baf05\React\EventLoop\LoopInterface $loop, array $context)
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \_PhpScoperabd03f0baf05\React\Socket\StreamEncryption($loop);
