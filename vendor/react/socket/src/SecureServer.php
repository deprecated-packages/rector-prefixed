 ...
 */
final class SecureServer extends \_PhpScopera143bcca66cb\Evenement\EventEmitter implements \_PhpScopera143bcca66cb\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\_PhpScopera143bcca66cb\React\Socket\ServerInterface $tcp, \_PhpScopera143bcca66cb\React\EventLoop\LoopInterface $loop, array $context)
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \_PhpScopera143bcca66cb\React\Socket\StreamEncryption($loop);
    ...
    /** @internal */
    public function handleConnection(\_PhpScopera143bcca66cb\React\Socket\ConnectionInterface $connection)
    {
