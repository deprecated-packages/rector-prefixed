...
use _PhpScoper006a73f0e455\React\Stream\DuplexResourceStream;
 ...
 * @internal
 */
class Connection extends \_PhpScoper006a73f0e455\Evenement\EventEmitter implements \_PhpScoper006a73f0e455\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \_PhpScoper006a73f0e455\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \_PhpScoper006a73f0e455\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \_PhpScoper006a73f0e455\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \_PhpScoper006a73f0e455\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
