 ...
 * ```
 */
final class CoopExecutor implements \_PhpScopera143bcca66cb\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\_PhpScopera143bcca66cb\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\_PhpScopera143bcca66cb\React\Dns\Query\Query $query)
    {
