 ...
 * ```
 */
final class CoopExecutor implements \_PhpScoper88fe6e0ad041\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\_PhpScoper88fe6e0ad041\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\_PhpScoper88fe6e0ad041\React\Dns\Query\Query $query)
    {
