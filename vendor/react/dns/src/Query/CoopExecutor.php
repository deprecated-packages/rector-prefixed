 ...
 * ```
 */
final class CoopExecutor implements \_PhpScoper006a73f0e455\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\_PhpScoper006a73f0e455\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\_PhpScoper006a73f0e455\React\Dns\Query\Query $query)
    {
