 ...
 * ```
 */
final class CoopExecutor implements \_PhpScoperbd5d0c5f7638\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\_PhpScoperbd5d0c5f7638\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\_PhpScoperbd5d0c5f7638\React\Dns\Query\Query $query)
    {
