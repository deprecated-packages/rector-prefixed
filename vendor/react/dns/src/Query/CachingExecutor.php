...
final class CachingExecutor implements \_PhpScoper88fe6e0ad041\React\Dns\Query\ExecutorInterface
{
    /**
    ...
    private $executor;
    private $cache;
    public function __construct(\_PhpScoper88fe6e0ad041\React\Dns\Query\ExecutorInterface $executor, \_PhpScoper88fe6e0ad041\React\Cache\CacheInterface $cache)
    {
    ...
    public function query(\_PhpScoper88fe6e0ad041\React\Dns\Query\Query $query)
    {
        ...
        return new \_PhpScoper88fe6e0ad041\React\Promise\Promise(function ($resolve, $reject) use($query, $id, $cache, $executor, &$pending, $that) {
            $pending->then(function ($message) use($query, $id, $cache, $executor, &$pending, $that) {
                ...
                return $pending = $executor->query($query)->then(function (\_PhpScoper88fe6e0ad041\React\Dns\Model\Message $message) use($cache, $id, $that) {
     ...
     * @internal
     */
    public function ttl(\_PhpScoper88fe6e0ad041\React\Dns\Model\Message $message)
    {
