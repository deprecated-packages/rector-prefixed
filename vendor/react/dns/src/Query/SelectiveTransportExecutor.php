 ...
 * ```
 */
class SelectiveTransportExecutor implements \_PhpScoperabd03f0baf05\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\_PhpScoperabd03f0baf05\React\Dns\Query\ExecutorInterface $datagramExecutor, \_PhpScoperabd03f0baf05\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\_PhpScoperabd03f0baf05\React\Dns\Query\Query $query)
    {
        ...
        return new \_PhpScoperabd03f0baf05\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
