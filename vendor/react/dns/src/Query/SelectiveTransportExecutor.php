 ...
 * ```
 */
class SelectiveTransportExecutor implements \_PhpScoper88fe6e0ad041\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\_PhpScoper88fe6e0ad041\React\Dns\Query\ExecutorInterface $datagramExecutor, \_PhpScoper88fe6e0ad041\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\_PhpScoper88fe6e0ad041\React\Dns\Query\Query $query)
    {
        ...
        return new \_PhpScoper88fe6e0ad041\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
