...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\_PhpScoper26e51eeacccf\React\Dns\Query\Query $query)
    {
        $request = new \_PhpScoper26e51eeacccf\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\_PhpScoper26e51eeacccf\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \_PhpScoper26e51eeacccf\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \_PhpScoper26e51eeacccf\React\Dns\Model\Message::RCODE_OK;
    /**
