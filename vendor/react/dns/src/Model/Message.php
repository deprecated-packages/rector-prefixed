...
namespace _PhpScoper006a73f0e455\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\_PhpScoper006a73f0e455\React\Dns\Query\Query $query)
    {
        $request = new \_PhpScoper006a73f0e455\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\_PhpScoper006a73f0e455\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \_PhpScoper006a73f0e455\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \_PhpScoper006a73f0e455\React\Dns\Model\Message::RCODE_OK;
    /**
