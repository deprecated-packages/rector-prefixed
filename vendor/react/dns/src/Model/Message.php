...
namespace _PhpScopera143bcca66cb\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\_PhpScopera143bcca66cb\React\Dns\Query\Query $query)
    {
        $request = new \_PhpScopera143bcca66cb\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\_PhpScopera143bcca66cb\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \_PhpScopera143bcca66cb\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \_PhpScopera143bcca66cb\React\Dns\Model\Message::RCODE_OK;
    /**
