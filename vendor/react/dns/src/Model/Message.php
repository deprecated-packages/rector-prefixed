...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\_PhpScoperabd03f0baf05\React\Dns\Query\Query $query)
    {
        $request = new \_PhpScoperabd03f0baf05\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\_PhpScoperabd03f0baf05\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \_PhpScoperabd03f0baf05\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \_PhpScoperabd03f0baf05\React\Dns\Model\Message::RCODE_OK;
    /**
