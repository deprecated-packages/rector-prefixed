...
use _PhpScoper88fe6e0ad041\RingCentral\Psr7 as gPsr;
/**
 * @event response
 * @event drain
 * @event error
 ...
 * @internal
 */
class Request extends \_PhpScoper88fe6e0ad041\Evenement\EventEmitter implements \_PhpScoper88fe6e0ad041\React\Stream\WritableStreamInterface
{
    const STATE_INIT = 0;
    ...
    public function __construct(\_PhpScoper88fe6e0ad041\React\Socket\ConnectorInterface $connector, \_PhpScoper88fe6e0ad041\React\Http\Client\RequestData $requestData)
    {
    ...
    private function writeHead()
    {
        ...
        $promise->then(function (\_PhpScoper88fe6e0ad041\React\Socket\ConnectionInterface $stream) use($requestData, &$streamRef, &$stateRef, &$pendingWrites, $that) {
            $streamRef = $stream;
            ...
            $stateRef = \_PhpScoper88fe6e0ad041\React\Http\Client\Request::STATE_HEAD_WRITTEN;
    ...
    public function handleData($data)
    {
        ...
        if (\false !== \strpos($this->buffer, "\r\n\r\n") || \false !== \strpos($this->buffer, "\n\n")) {
            try {
                $response = \_PhpScoper88fe6e0ad041\RingCentral\Psr7\parse_response($this->buffer);
    ...
    protected function connect()
    {
        ...
        if ($scheme !== 'https' && $scheme !== 'http') {
            return \_PhpScoper88fe6e0ad041\React\Promise\reject(new \InvalidArgumentException('Invalid request URL given'));
        }
