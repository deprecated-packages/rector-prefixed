...
use _PhpScoper006a73f0e455\Psr\Http\Message\UploadedFileInterface;
 ...
 * @internal
 */
final class UploadedFile implements \_PhpScoper006a73f0e455\Psr\Http\Message\UploadedFileInterface
{
    /**
     * @var StreamInterface
     */
     ...
     */
    public function __construct(\_PhpScoper006a73f0e455\Psr\Http\Message\StreamInterface $stream, $size, $error, $filename, $mediaType)
    {
        $this->stream = $stream;
        $this->size = $size;
