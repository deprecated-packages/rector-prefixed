...
final class MiddlewareRunner
{
     ...
     * @throws \Exception
     */
    public function __invoke(\_PhpScopera143bcca66cb\Psr\Http\Message\ServerRequestInterface $request)
    {
    ...
    /** @internal */
    public function call(\_PhpScopera143bcca66cb\Psr\Http\Message\ServerRequestInterface $request, $position)
    {
        ...
        $that = $this;
        $next = function (\_PhpScopera143bcca66cb\Psr\Http\Message\ServerRequestInterface $request) use($that, $position) {
