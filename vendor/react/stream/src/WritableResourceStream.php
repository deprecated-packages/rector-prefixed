...
final class WritableResourceStream extends \_PhpScoperabd03f0baf05\Evenement\EventEmitter implements \_PhpScoperabd03f0baf05\React\Stream\WritableStreamInterface
{
    private $stream;
    private $loop;
    /**
    ...
    private $data = '';
    public function __construct($stream, \_PhpScoperabd03f0baf05\React\EventLoop\LoopInterface $loop, $writeBufferSoftLimit = null, $writeChunkSize = null)
    {
