...
final class Util
{
     ...
     */
    public static function pipe(\_PhpScoper88fe6e0ad041\React\Stream\ReadableStreamInterface $source, \_PhpScoper88fe6e0ad041\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
