...
final class Util
{
     ...
     */
    public static function pipe(\_PhpScopera143bcca66cb\React\Stream\ReadableStreamInterface $source, \_PhpScopera143bcca66cb\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
