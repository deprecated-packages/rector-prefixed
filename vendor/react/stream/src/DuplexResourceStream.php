...
final class DuplexResourceStream extends \_PhpScoper006a73f0e455\Evenement\EventEmitter implements \_PhpScoper006a73f0e455\React\Stream\DuplexStreamInterface
{
    private $stream;
    private $loop;
    /**
    ...
    public function __construct($stream, \_PhpScoper006a73f0e455\React\EventLoop\LoopInterface $loop, $readChunkSize = null, \_PhpScoper006a73f0e455\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \_PhpScoper006a73f0e455\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
        $this->loop = $loop;
