...
final class DuplexResourceStream extends \_PhpScoperabd03f0baf05\Evenement\EventEmitter implements \_PhpScoperabd03f0baf05\React\Stream\DuplexStreamInterface
{
    private $stream;
    private $loop;
    /**
    ...
    public function __construct($stream, \_PhpScoperabd03f0baf05\React\EventLoop\LoopInterface $loop, $readChunkSize = null, \_PhpScoperabd03f0baf05\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \_PhpScoperabd03f0baf05\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
        $this->loop = $loop;
