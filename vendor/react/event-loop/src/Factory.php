...
final class Factory
{
    ...
    public static function create()
    {
        ...
        if (\function_exists('uv_loop_new')) {
            ...
            return new \_PhpScoper006a73f0e455\React\EventLoop\ExtUvLoop();
        } elseif (\class_exists('_PhpScoper006a73f0e455\\libev\\EventLoop', \false)) {
            return new \_PhpScoper006a73f0e455\React\EventLoop\ExtLibevLoop();
        } elseif (\class_exists('EvLoop', \false)) {
            return new \_PhpScoper006a73f0e455\React\EventLoop\ExtEvLoop();
            ...
            return new \_PhpScoper006a73f0e455\React\EventLoop\ExtLibeventLoop();
        }
