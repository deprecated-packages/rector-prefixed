...
final class Factory
{
    ...
    public static function create()
    {
        ...
        if (\function_exists('uv_loop_new')) {
            ...
            return new \_PhpScoperbd5d0c5f7638\React\EventLoop\ExtUvLoop();
        } elseif (\class_exists('_PhpScoperbd5d0c5f7638\\libev\\EventLoop', \false)) {
            return new \_PhpScoperbd5d0c5f7638\React\EventLoop\ExtLibevLoop();
        } elseif (\class_exists('EvLoop', \false)) {
            return new \_PhpScoperbd5d0c5f7638\React\EventLoop\ExtEvLoop();
            ...
            return new \_PhpScoperbd5d0c5f7638\React\EventLoop\ExtLibeventLoop();
        }
