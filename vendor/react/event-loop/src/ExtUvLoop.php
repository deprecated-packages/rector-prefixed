 ...
 */
final class ExtUvLoop implements \_PhpScoperbd5d0c5f7638\React\EventLoop\LoopInterface
{
    private $uv;
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = \_PhpScoperbd5d0c5f7638\uv_signal_init($this->uv);
            \_PhpScoperbd5d0c5f7638\uv_signal_start($this->signalEvents[$signal], function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
        }
    }
    ...
    {
        if (!isset($this->streamEvents[(int) $stream])) {
            $this->streamEvents[(int) $stream] = \_PhpScoperbd5d0c5f7638\uv_poll_init_socket($this->uv, $stream);
        }
