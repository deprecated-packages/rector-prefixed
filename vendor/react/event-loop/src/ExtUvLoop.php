 ...
 */
final class ExtUvLoop implements \_PhpScoper006a73f0e455\React\EventLoop\LoopInterface
{
    private $uv;
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = \_PhpScoper006a73f0e455\uv_signal_init($this->uv);
            \_PhpScoper006a73f0e455\uv_signal_start($this->signalEvents[$signal], function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
        }
    }
    ...
    {
        if (!isset($this->streamEvents[(int) $stream])) {
            $this->streamEvents[(int) $stream] = \_PhpScoper006a73f0e455\uv_poll_init_socket($this->uv, $stream);
        }
