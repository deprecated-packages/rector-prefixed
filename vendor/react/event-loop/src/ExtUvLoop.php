 ...
 */
final class ExtUvLoop implements \_PhpScopera143bcca66cb\React\EventLoop\LoopInterface
{
    private $uv;
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = \_PhpScopera143bcca66cb\uv_signal_init($this->uv);
            \_PhpScopera143bcca66cb\uv_signal_start($this->signalEvents[$signal], function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
        }
    }
    ...
    {
        if (!isset($this->streamEvents[(int) $stream])) {
            $this->streamEvents[(int) $stream] = \_PhpScopera143bcca66cb\uv_poll_init_socket($this->uv, $stream);
        }
