...
namespace _PhpScoperabd03f0baf05\React\EventLoop\Timer;
...
final class Timers
{
    ...
    public function add(\_PhpScoperabd03f0baf05\React\EventLoop\TimerInterface $timer)
    {
    ...
    public function contains(\_PhpScoperabd03f0baf05\React\EventLoop\TimerInterface $timer)
    {
        return isset($this->timers[\spl_object_hash($timer)]);
    }
    public function cancel(\_PhpScoperabd03f0baf05\React\EventLoop\TimerInterface $timer)
    {
        $id = \spl_object_hash($timer);
