...
final class Timers
{
    ...
    public function add(\_PhpScoper006a73f0e455\React\EventLoop\TimerInterface $timer)
    {
    ...
    public function contains(\_PhpScoper006a73f0e455\React\EventLoop\TimerInterface $timer)
    {
        return isset($this->timers[\spl_object_hash($timer)]);
    }
    public function cancel(\_PhpScoper006a73f0e455\React\EventLoop\TimerInterface $timer)
    {
        $id = \spl_object_hash($timer);
