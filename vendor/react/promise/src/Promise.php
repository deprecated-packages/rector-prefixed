...
class Promise implements \_PhpScoperbd5d0c5f7638\React\Promise\ExtendedPromiseInterface, \_PhpScoperbd5d0c5f7638\React\Promise\CancellablePromiseInterface
{
    private $canceller;
    private $result;
    private $handlers = [];
    ...
    public function done(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        ...
        $this->handlers[] = static function (\_PhpScoperbd5d0c5f7638\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected) {
    ...
    public function otherwise(callable $onRejected)
    {
        return $this->then(null, static function ($reason) use($onRejected) {
            if (!_checkTypehint($onRejected, $reason)) {
                return new \_PhpScoperbd5d0c5f7638\React\Promise\RejectedPromise($reason);
            }
    ...
    private function resolver(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        return function ($resolve, $reject, $notify) use($onFulfilled, $onRejected, $onProgress) {
            ...
            $this->handlers[] = static function (\_PhpScoperbd5d0c5f7638\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected, $resolve, $reject, $progressHandler) {
    ...
    private function settle(\_PhpScoperbd5d0c5f7638\React\Promise\ExtendedPromiseInterface $promise)
    {
        $promise = $this->unwrap($promise);
        if ($promise === $this) {
            $promise = new \_PhpScoperbd5d0c5f7638\React\Promise\RejectedPromise(new \LogicException('Cannot resolve a promise with itself.'));
        }
    ...
    {
        if ($promise instanceof \_PhpScoperbd5d0c5f7638\React\Promise\LazyPromise) {
