 ...
 */
class LazyPromise implements \_PhpScoper006a73f0e455\React\Promise\ExtendedPromiseInterface, \_PhpScoper006a73f0e455\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \_PhpScoper006a73f0e455\React\Promise\RejectedPromise($exception);
