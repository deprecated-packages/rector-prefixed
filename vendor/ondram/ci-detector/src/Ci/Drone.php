...
class Drone extends \_PhpScoperabd03f0baf05\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \_PhpScoperabd03f0baf05\OndraM\CiDetector\CiDetector::CI_DRONE;
    }
    public function isPullRequest() : \_PhpScoperabd03f0baf05\OndraM\CiDetector\TrinaryLogic
    {
        return \_PhpScoperabd03f0baf05\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('DRONE_PULL_REQUEST') !== '');
    }
