...
class Travis extends \_PhpScopera143bcca66cb\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \_PhpScopera143bcca66cb\OndraM\CiDetector\CiDetector::CI_TRAVIS;
    }
    public function isPullRequest() : \_PhpScopera143bcca66cb\OndraM\CiDetector\TrinaryLogic
    {
        return \_PhpScopera143bcca66cb\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('TRAVIS_PULL_REQUEST') !== 'false');
    }
