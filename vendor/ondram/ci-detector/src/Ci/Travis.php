...
class Travis extends \_PhpScoper006a73f0e455\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \_PhpScoper006a73f0e455\OndraM\CiDetector\CiDetector::CI_TRAVIS;
    }
    public function isPullRequest() : \_PhpScoper006a73f0e455\OndraM\CiDetector\TrinaryLogic
    {
        return \_PhpScoper006a73f0e455\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('TRAVIS_PULL_REQUEST') !== 'false');
    }
