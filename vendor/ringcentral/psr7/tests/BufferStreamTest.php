...
class BufferStreamTest extends \_PhpScoper006a73f0e455\PHPUnit_Framework_TestCase
{
    public function testHasMetadata()
    {
        $b = new \_PhpScoper006a73f0e455\RingCentral\Psr7\BufferStream(10);
    ...
    {
        $b = new \_PhpScoper006a73f0e455\RingCentral\Psr7\BufferStream();
    ...
    {
        $b = new \_PhpScoper006a73f0e455\RingCentral\Psr7\BufferStream(5);
