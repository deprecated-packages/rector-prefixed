...
class BufferStreamTest extends \_PhpScoperabd03f0baf05\PHPUnit_Framework_TestCase
{
    public function testHasMetadata()
    {
        $b = new \_PhpScoperabd03f0baf05\RingCentral\Psr7\BufferStream(10);
    ...
    {
        $b = new \_PhpScoperabd03f0baf05\RingCentral\Psr7\BufferStream();
    ...
    {
        $b = new \_PhpScoperabd03f0baf05\RingCentral\Psr7\BufferStream(5);
