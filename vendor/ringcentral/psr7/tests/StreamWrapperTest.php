...
use _PhpScoper006a73f0e455\RingCentral\Psr7\StreamWrapper;
use _PhpScoper006a73f0e455\RingCentral\Psr7;
/**
 * @covers RingCentral\Psr7\StreamWrapper
 */
class StreamWrapperTest extends \_PhpScoper006a73f0e455\PHPUnit_Framework_TestCase
{
    public function testResource()
    {
        $stream = \_PhpScoper006a73f0e455\RingCentral\Psr7\stream_for('foo');
        $handle = \_PhpScoper006a73f0e455\RingCentral\Psr7\StreamWrapper::getResource($stream);
    ...
    {
        $stream = $this->getMockBuilder('_PhpScoper006a73f0e455\\Psr\\Http\\Message\\StreamInterface')->setMethods(array('isReadable', 'isWritable'))->getMockForAbstractClass();
        ...
        \_PhpScoper006a73f0e455\RingCentral\Psr7\StreamWrapper::getResource($stream);
    }
    /**
    ...
    public function testCanOpenReadonlyStream()
    {
        ...
        $r = \_PhpScoper006a73f0e455\RingCentral\Psr7\StreamWrapper::getResource($stream);
