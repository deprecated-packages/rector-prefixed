 ...
 */
class FnStreamTest extends \_PhpScoper006a73f0e455\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $stream = new \_PhpScoper006a73f0e455\RingCentral\Psr7\FnStream(array());
        $stream->seek(1);
    }
    public function testProxiesToFunction()
    {
        $self = $this;
        $s = new \_PhpScoper006a73f0e455\RingCentral\Psr7\FnStream(array('read' => function ($len) use($self) {
    ...
    {
        $called = \false;
        $s = new \_PhpScoper006a73f0e455\RingCentral\Psr7\FnStream(array('close' => function () use(&$called) {
            $called = \true;
        }));
        unset($s);
    ...
    {
        $s = new \_PhpScoper006a73f0e455\RingCentral\Psr7\FnStream(array());
        unset($s);
    }
    public function testDecoratesStream()
    {
        $a = \_PhpScoper006a73f0e455\RingCentral\Psr7\stream_for('foo');
        $b = \_PhpScoper006a73f0e455\RingCentral\Psr7\FnStream::decorate($a, array());
    ...
    public function testDecoratesWithCustomizations()
    {
        $called = \false;
        $a = \_PhpScoper006a73f0e455\RingCentral\Psr7\stream_for('foo');
        $b = \_PhpScoper006a73f0e455\RingCentral\Psr7\FnStream::decorate($a, array('read' => function ($len) use(&$called, $a) {
            $called = \true;
            return $a->read($len);
        }));
