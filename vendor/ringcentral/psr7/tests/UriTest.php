 ...
 */
class UriTest extends \_PhpScoperbd5d0c5f7638\PHPUnit_Framework_TestCase
{
    const RFC3986_BASE = "http://a/b/c/d;p?q";
    public function testParsesProvidedUrl()
    {
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('https://michael:test@test.com:443/path/123?q=abc#test');
    ...
    {
        $url = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('http://a:1/0?0#0');
        ...
        $url = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('');
        $this->assertSame('', (string) $url);
        $url = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('0');
    ...
    {
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri($base);
        $actual = \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri::resolve($uri, $rel);
    ...
    {
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('http://foo.com/bar');
        $uri = \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri::withQueryValue($uri, 'a', 'b');
        $uri = \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri::withQueryValue($uri, 'c', 'd');
        $uri = \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri::withQueryValue($uri, 'e', null);
        $this->assertEquals('a=b&c=d&e', $uri->getQuery());
        $uri = \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri::withoutQueryValue($uri, 'c');
        $uri = \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri::withoutQueryValue($uri, 'e');
        $this->assertEquals('a=b', $uri->getQuery());
        $uri = \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri::withoutQueryValue($uri, 'a');
        $uri = \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri::withoutQueryValue($uri, 'a');
    ...
    public function testGetAuthorityReturnsCorrectPort()
    {
        ...
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('https://foo.co:99');
        $this->assertEquals('foo.co:99', $uri->getAuthority());
        // HTTP non-standard port
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('http://foo.co:99');
        $this->assertEquals('foo.co:99', $uri->getAuthority());
        // No scheme
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('foo.co:99');
        $this->assertEquals('foo.co:99', $uri->getAuthority());
        // No host or port
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('http:');
        $this->assertEquals('', $uri->getAuthority());
        // No host or port
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri('http://foo.co');
    ...
    {
        $uri = new \_PhpScoperbd5d0c5f7638\RingCentral\Psr7\Uri($input);
