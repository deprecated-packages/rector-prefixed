...
use _PhpScopera143bcca66cb\RingCentral\Psr7\Response;
use _PhpScopera143bcca66cb\RingCentral\Psr7;
/**
 * @covers RingCentral\Psr7\MessageTrait
 * @covers RingCentral\Psr7\Response
 */
class ResponseTest extends \_PhpScopera143bcca66cb\PHPUnit_Framework_TestCase
{
    public function testAddsDefaultReason()
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response('200');
        $this->assertSame(200, $r->getStatusCode());
        $this->assertEquals('OK', $r->getReasonPhrase());
    }
    public function testCanGiveCustomReason()
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response(200, array(), null, '1.1', 'bar');
        $this->assertEquals('bar', $r->getReasonPhrase());
    }
    public function testCanGiveCustomProtocolVersion()
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response(200, array(), null, '1000');
    ...
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response();
    ...
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response();
        $this->assertInstanceOf('_PhpScopera143bcca66cb\\Psr\\Http\\Message\\StreamInterface', $r->getBody());
    }
    public function testCanSetHeaderAsArray()
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response(200, array('foo' => array('baz ', ' bar ')));
        $this->assertEquals('baz, bar', $r->getHeaderLine('foo'));
        $this->assertEquals(array('baz', 'bar'), $r->getHeader('foo'));
    }
    public function testSameInstanceWhenSameBody()
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response(200, array(), 'foo');
        $b = $r->getBody();
    ...
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response(200, array(), 'foo');
        $b2 = \_PhpScopera143bcca66cb\RingCentral\Psr7\stream_for('abc');
    ...
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response(200, array('Foo' => 'Bar'));
    ...
    {
        $r = new \_PhpScopera143bcca66cb\RingCentral\Psr7\Response(200, array(), '0');
