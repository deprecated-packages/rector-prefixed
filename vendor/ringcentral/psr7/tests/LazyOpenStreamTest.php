...
use _PhpScoper006a73f0e455\RingCentral\Psr7\LazyOpenStream;
class LazyOpenStreamTest extends \_PhpScoper006a73f0e455\PHPUnit_Framework_TestCase
{
    private $fname;
    ...
    {
        $l = new \_PhpScoper006a73f0e455\RingCentral\Psr7\LazyOpenStream($this->fname, 'w+');
        $l->write('foo');
    ...
    public function testProxiesToFile()
    {
        ...
        $l = new \_PhpScoper006a73f0e455\RingCentral\Psr7\LazyOpenStream($this->fname, 'r');
