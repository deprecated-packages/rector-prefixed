 ...
 */
class AppendStream implements \_PhpScoperabd03f0baf05\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoperabd03f0baf05\Psr\Http\Message\StreamInterface $stream)
    {
