 ...
 */
class MultipartStream extends \_PhpScopera143bcca66cb\RingCentral\Psr7\StreamDecoratorTrait implements \_PhpScopera143bcca66cb\Psr\Http\Message\StreamInterface
{
    private $boundary;
    /**
    ...
    {
        $stream = new \_PhpScopera143bcca66cb\RingCentral\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScopera143bcca66cb\RingCentral\Psr7\AppendStream $stream, array $element)
    {
