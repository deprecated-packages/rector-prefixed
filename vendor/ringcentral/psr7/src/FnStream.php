 ...
 */
class FnStream implements \_PhpScopera143bcca66cb\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScopera143bcca66cb\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
