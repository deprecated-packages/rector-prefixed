 ...
 */
class Uri implements \_PhpScopera143bcca66cb\Psr\Http\Message\UriInterface
{
     ...
     * @return UriInterface
     */
    public static function resolve(\_PhpScopera143bcca66cb\Psr\Http\Message\UriInterface $base, $rel)
    {
        if ($rel === null || $rel === '') {
            return $base;
        }
        if (!$rel instanceof \_PhpScopera143bcca66cb\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\_PhpScopera143bcca66cb\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\_PhpScopera143bcca66cb\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $current = $uri->getQuery();
