 ...
 */
class Uri implements \_PhpScoper88fe6e0ad041\Psr\Http\Message\UriInterface
{
     ...
     * @return UriInterface
     */
    public static function resolve(\_PhpScoper88fe6e0ad041\Psr\Http\Message\UriInterface $base, $rel)
    {
        if ($rel === null || $rel === '') {
            return $base;
        }
        if (!$rel instanceof \_PhpScoper88fe6e0ad041\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\_PhpScoper88fe6e0ad041\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\_PhpScoper88fe6e0ad041\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $current = $uri->getQuery();
