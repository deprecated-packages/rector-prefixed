...
class ClassMethod extends \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt implements \_PhpScoperb75b35f52b74\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \_PhpScoperb75b35f52b74\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoperb75b35f52b74\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
