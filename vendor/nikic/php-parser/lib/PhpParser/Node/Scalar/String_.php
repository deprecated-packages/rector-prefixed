...
class String_ extends \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper2a4e7ab1ecbc\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
