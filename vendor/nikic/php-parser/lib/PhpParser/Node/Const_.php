 ...
 */
class Const_ extends \_PhpScoper2a4e7ab1ecbc\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Expr $value, array $attributes = [])
    {
