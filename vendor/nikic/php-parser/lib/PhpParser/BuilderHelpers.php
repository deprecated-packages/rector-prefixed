...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : \PhpParser\Node\Identifier
    {
        ...
        throw new \LogicException('RectorPrefix20201231\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('RectorPrefix20201231\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    private static function normalizeNameCommon($name, bool $allowExpr)
    {
        ...
        if ($allowExpr) {
            ...
            throw new \LogicException('RectorPrefix20201231\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        } else {
            throw new \LogicException('RectorPrefix20201231\\Name must be a string or an instance of Node\\Name');
        }
    }
    /**
    ...
    public static function normalizeDocComment($docComment) : \PhpParser\Comment\Doc
    {
        if ($docComment instanceof \PhpParser\Comment\Doc) {
            ...
            throw new \LogicException('RectorPrefix20201231\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
        }
    }
    /**
