...
use _PhpScoper0a6b37af0871\PhpParser\NodeVisitor\FindingVisitor;
use _PhpScoper0a6b37af0871\PhpParser\NodeVisitor\FirstFindingVisitor;
class NodeFinder
{
    /**
    ...
    public function find($nodes, callable $filter) : array
    {
        ...
        $visitor = new \_PhpScoper0a6b37af0871\PhpParser\NodeVisitor\FindingVisitor($filter);
    ...
    public function findFirst($nodes, callable $filter)
    {
        ...
        $visitor = new \_PhpScoper0a6b37af0871\PhpParser\NodeVisitor\FirstFindingVisitor($filter);
        $traverser = new \_PhpScoper0a6b37af0871\PhpParser\NodeTraverser();
        $traverser->addVisitor($visitor);
        $traverser->traverse($nodes);
