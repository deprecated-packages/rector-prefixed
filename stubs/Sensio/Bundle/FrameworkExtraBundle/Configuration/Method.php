...
if (\class_exists('_PhpScoper88fe6e0ad041\\Sensio\\Bundle\\FrameworkExtraBundle\\Configuration\\Method')) {
    return;
}
/**
 * @Annotation
 */
class Method extends \_PhpScoper88fe6e0ad041\Sensio\Bundle\FrameworkExtraBundle\Configuration\ConfigurationAnnotation
{
    /**
