...
if (\class_exists('_PhpScoperabd03f0baf05\\Sensio\\Bundle\\FrameworkExtraBundle\\Configuration\\ParamConverter')) {
    return;
}
/**
 * @Annotation
*/
class ParamConverter extends \_PhpScoperabd03f0baf05\Sensio\Bundle\FrameworkExtraBundle\Configuration\ConfigurationAnnotation
{
    /**
     * The parameter name.
     *
