...
if (\class_exists('_PhpScoperabd03f0baf05\\JMS\\DiExtraBundle\\Annotation\\Service')) {
    return;
}
/**
 * @Annotation
 * @Target({"CLASS", "METHOD"})
 */
class Service extends \_PhpScoperabd03f0baf05\JMS\DiExtraBundle\Annotation\Reference
{
    /** @var string */
    public $id;
    /** @var string */
