...
if (\class_exists('_PhpScoper26e51eeacccf\\JMS\\DiExtraBundle\\Annotation\\Service')) {
    return;
}
/**
 * @Annotation
 * @Target({"CLASS", "METHOD"})
 */
class Service extends \_PhpScoper26e51eeacccf\JMS\DiExtraBundle\Annotation\Reference
{
    /** @var string */
    public $id;
    /** @var string */
