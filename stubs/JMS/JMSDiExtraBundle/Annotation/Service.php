...
if (\class_exists('_PhpScoper006a73f0e455\\JMS\\DiExtraBundle\\Annotation\\Service')) {
    return;
}
/**
 * @Annotation
 * @Target({"CLASS", "METHOD"})
 */
class Service extends \_PhpScoper006a73f0e455\JMS\DiExtraBundle\Annotation\Reference
{
    /** @var string */
    public $id;
    /** @var string */
