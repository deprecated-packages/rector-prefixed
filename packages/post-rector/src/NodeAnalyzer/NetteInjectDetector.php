...
namespace _PhpScoper0a6b37af0871\Rector\PostRector\NodeAnalyzer;
...
final class NetteInjectDetector
{
    ...
    public function isNetteInjectPreferred(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ $class) : bool
    {
    ...
    private function isInjectPropertyAlreadyInTheClass(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ $class) : bool
    {
    ...
    private function hasParentClassConstructor(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ $class) : bool
    {
        $className = $this->nodeNameResolver->getName($class);
        if ($className === null) {
            return \false;
        }
        if (!\is_a($className, '_PhpScoper0a6b37af0871\\Nette\\Application\\IPresenter', \true)) {
            return \false;
        }
        // has parent class
        ...
        if ($classReflection->hasMethod(\_PhpScoper0a6b37af0871\Rector\Core\ValueObject\MethodName::CONSTRUCT)) {
