...
final class UseNodesToAddCollector implements \Rector\PostRector\Contract\Collector\NodeCollectorInterface
{
    ...
    public function addUseImport(\PhpParser\Node $positionNode, \PHPStan\Type\ObjectType $objectType) : void
    {
        ...
        if (!$fileInfo instanceof \RectorPrefix20210201\Symplify\SmartFileSystem\SmartFileInfo) {
    ...
    public function clear(\RectorPrefix20210201\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
     ...
     * @return AliasedObjectType[]|FullyQualifiedObjectType[]
     */
    public function getObjectImportsByFileInfo(\RectorPrefix20210201\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
     ...
     */
    public function getFunctionImportsByFileInfo(\RectorPrefix20210201\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
     ...
     * @return string[]
     */
    public function getShortUsesByFileInfo(\RectorPrefix20210201\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
    ...
    private function getRealPathFromNode(\PhpParser\Node $node) : ?string
    {
        ...
        if (!$smartFileInfo instanceof \RectorPrefix20210201\Symplify\SmartFileSystem\SmartFileInfo) {
            return null;
        }
