...
final class UseNodesToAddCollector implements \Rector\PostRector\Contract\Collector\NodeCollectorInterface
{
    ...
    public function clear(\RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
     ...
     * @return AliasedObjectType[]|FullyQualifiedObjectType[]
     */
    public function getObjectImportsByFileInfo(\RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
     ...
     */
    public function getFunctionImportsByFileInfo(\RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
     ...
     * @return string[]
     */
    public function getShortUsesByFileInfo(\RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
