...
final class UseNodesToAddCollector implements \Rector\PostRector\Contract\Collector\NodeCollectorInterface
{
    ...
    public function clear(\RectorPrefix20210303\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
     ...
     * @return AliasedObjectType[]|FullyQualifiedObjectType[]
     */
    public function getObjectImportsByFileInfo(\RectorPrefix20210303\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
     ...
     */
    public function getFunctionImportsByFileInfo(\RectorPrefix20210303\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
     ...
     * @return string[]
     */
    public function getShortUsesByFileInfo(\RectorPrefix20210303\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
    ...
    private function getRealPathFromNode(\PhpParser\Node $node) : ?string
    {
        ...
        if (!$smartFileInfo instanceof \RectorPrefix20210303\Symplify\SmartFileSystem\SmartFileInfo) {
            return null;
        }
