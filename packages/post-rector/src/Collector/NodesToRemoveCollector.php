...
final class NodesToRemoveCollector implements \_PhpScopere8e811afab72\Rector\PostRector\Contract\Collector\NodeCollectorInterface
{
    /**
    ...
    public function __construct(\_PhpScopere8e811afab72\Rector\ChangesReporting\Collector\AffectedFilesCollector $affectedFilesCollector, \_PhpScopere8e811afab72\Rector\NodeRemoval\BreakingRemovalGuard $breakingRemovalGuard)
    {
    ...
    public function addNodeToRemove(\_PhpScopere8e811afab72\PhpParser\Node $node) : void
    {
        ...
        if (!$node instanceof \_PhpScopere8e811afab72\PhpParser\Node\Stmt\Expression && $parentNode instanceof \_PhpScopere8e811afab72\PhpParser\Node\Stmt\Expression) {
    ...
    public function isNodeRemoved(\_PhpScopere8e811afab72\PhpParser\Node $node) : bool
    {
    ...
    private function ensureIsNotPartOfChainMethodCall(\_PhpScopere8e811afab72\PhpParser\Node $node) : void
    {
        ...
        throw new \_PhpScopere8e811afab72\Rector\Core\Exception\ShouldNotHappenException('Chain method calls cannot be removed this way. It would remove the whole tree of calls. Remove them manually by creating new parent node with no following method.');
    }
}
