...
final class UseAddingPostRector extends \Rector\PostRector\Rector\AbstractPostRector
{
     ...
     * @param Node[] $nodes
     */
    private function getSmartFileInfo(array $nodes) : ?\RectorPrefix20210207\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    private function filterOutNonNamespacedNames(array $useImportTypes) : array
    {
        ...
        foreach ($useImportTypes as $useImportType) {
            if (!\RectorPrefix20210207\Nette\Utils\Strings::contains($useImportType->getClassName(), '\\')) {
                continue;
            }
