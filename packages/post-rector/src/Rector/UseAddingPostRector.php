...
CODE_SAMPLE
     ...
     * @param Node[] $nodes
     */
    private function getSmartFileInfo(array $nodes) : ?\RectorPrefix20201231\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    private function filterOutNonNamespacedNames(array $useImportTypes) : array
    {
        ...
        foreach ($useImportTypes as $useImportType) {
            if (!\RectorPrefix20201231\Nette\Utils\Strings::contains($useImportType->getClassName(), '\\')) {
                continue;
            }
