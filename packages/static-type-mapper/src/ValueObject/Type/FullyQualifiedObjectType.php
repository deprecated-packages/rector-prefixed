...
final class FullyQualifiedObjectType extends \PHPStan\Type\ObjectType
{
    ...
    {
        if (!\_PhpScoper8b9c402c5f32\Nette\Utils\Strings::contains($this->getClassName(), '\\')) {
            return $this->getClassName();
        }
        return (string) \_PhpScoper8b9c402c5f32\Nette\Utils\Strings::after($this->getClassName(), '\\', -1);
    }
