...
final class FullyQualifiedObjectType extends \PHPStan\Type\ObjectType
{
    ...
    {
        if (!\RectorPrefix20210104\Nette\Utils\Strings::contains($this->getClassName(), '\\')) {
            return $this->getClassName();
        }
        return (string) \RectorPrefix20210104\Nette\Utils\Strings::after($this->getClassName(), '\\', -1);
    }
