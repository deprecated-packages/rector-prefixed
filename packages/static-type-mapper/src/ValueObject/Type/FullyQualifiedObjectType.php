...
final class FullyQualifiedObjectType extends \PHPStan\Type\ObjectType
{
    ...
    {
        if (!\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::contains($this->getClassName(), '\\')) {
            return $this->getClassName();
        }
        return (string) \_PhpScoper5edc98a7cce2\Nette\Utils\Strings::after($this->getClassName(), '\\', -1);
    }
