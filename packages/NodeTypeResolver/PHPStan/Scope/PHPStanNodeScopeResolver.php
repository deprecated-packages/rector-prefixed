...
final class PHPStanNodeScopeResolver
{
    ...
    public function processNodes(array $nodes, SmartFileInfo $smartFileInfo): array
    {
        ...
        $nodeCallback = function (Node $node, Scope $scope) {
     ...
     * @return void
     */
    private function resolveDependentFiles(Node $node, MutatingScope $mutatingScope)
    {
     ...
     * @return void
     */
    private function reportCacheDebugAndSaveDependentFiles(SmartFileInfo $smartFileInfo, array $dependentFiles)
    {
        if (! $this->configuration->isCacheEnabled()) {
            return;
        }
     ...
     * @return void
     */
    private function reportCacheDebug(SmartFileInfo $smartFileInfo, array $dependentFiles)
    {
