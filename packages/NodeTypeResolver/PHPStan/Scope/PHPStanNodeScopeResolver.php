...
final class PHPStanNodeScopeResolver
{
     ...
     * @return void
     */
    private function reportCacheDebugAndSaveDependentFiles(\RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles)
    {
        if (!$this->configuration->isCacheEnabled()) {
            return;
        }
     ...
     * @return void
     */
    private function reportCacheDebug(\RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles)
    {
