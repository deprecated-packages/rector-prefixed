...
final class PHPStanNodeScopeResolver
{
     ...
     * @return Node[]
     */
    public function processNodes(array $nodes, \RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
    ...
    private function resolveClassOrInterfaceScope(\PhpParser\Node\Stmt\ClassLike $classLike, \PHPStan\Analyser\Scope $scope) : \PHPStan\Analyser\Scope
    {
        ...
        if ($classLike instanceof \PhpParser\Node\Stmt\Class_ && \RectorPrefix20210422\Nette\Utils\Strings::match($className, self::ANONYMOUS_CLASS_START_REGEX)) {
     ...
     * @return void
     */
    private function reportCacheDebugAndSaveDependentFiles(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles)
    {
        if (!$this->configuration->isCacheEnabled()) {
            return;
        }
     ...
     * @return void
     */
    private function reportCacheDebug(\RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles)
    {
