...
final class PHPStanNodeScopeResolver
{
     ...
     * @return Node[]
     */
    public function processNodes(array $nodes, \RectorPrefix20210315\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
     ...
     */
    private function reportCacheDebugAndSaveDependentFiles(\RectorPrefix20210315\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles) : void
    {
        if (!$this->configuration->isCacheEnabled()) {
            return;
        }
     ...
     * @param string[] $dependentFiles
     */
    private function reportCacheDebug(\RectorPrefix20210315\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles) : void
    {
