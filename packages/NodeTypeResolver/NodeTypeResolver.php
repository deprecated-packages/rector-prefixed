...
final class NodeTypeResolver
{
     ...
     * @return void
     */
    public function autowireNodeTypeResolver(ArrayTypeAnalyzer $arrayTypeAnalyzer)
    {
     ...
     */
    public function resolveObjectTypeFromScope(Scope $scope)
    {
     ...
     * @return void
     */
    private function addNodeTypeResolver(NodeTypeResolverInterface $nodeTypeResolver)
    {
     ...
     */
    private function resolveByNodeTypeResolvers(Node $node)
    {
