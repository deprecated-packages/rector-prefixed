...
CODE_SAMPLE
     ...
     * @param Node[] $nodes
     */
    private function getSmartFileInfo(array $nodes) : ?\RectorPrefix20210404\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    private function filterOutNonNamespacedNames(array $useImportTypes) : array
    {
        ...
        foreach ($useImportTypes as $useImportType) {
            if (!\RectorPrefix20210404\Nette\Utils\Strings::contains($useImportType->getClassName(), '\\')) {
                continue;
            }
