...
final class RectorChangeCollector
{
     ...
     */
    public function getRectorChangesByFileInfo(\RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
    ...
    private function addRectorClassWithLine(\Rector\Core\Contract\Rector\RectorInterface $rector, \RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, int $line) : void
    {
