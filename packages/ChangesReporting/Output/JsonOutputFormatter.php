...
final class JsonOutputFormatter implements \Rector\ChangesReporting\Contract\Output\OutputFormatterInterface
{
    ...
    public function __construct(\Rector\Core\Configuration\Configuration $configuration, \RectorPrefix20210505\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\ChangesReporting\Annotation\RectorsChangelogResolver $rectorsChangelogResolver)
    {
    ...
    public function report(\Rector\Core\ValueObject\ProcessResult $processResult) : void
    {
        ...
        $json = \RectorPrefix20210505\Nette\Utils\Json::encode($errorsArray, \RectorPrefix20210505\Nette\Utils\Json::PRETTY);
