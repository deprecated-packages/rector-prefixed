...
abstract class AbstractPhpDocInfoTest extends \RectorPrefix20210225\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var FileInfoParser
     */
     ...
     */
    protected function doTestPrintedPhpDocInfo(\RectorPrefix20210225\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, string $tagValueNodeType) : void
    {
     ...
     * @return T
     */
    private function parseFileAndGetFirstNodeOfType(\RectorPrefix20210225\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, string $nodeType) : \PhpParser\Node
    {
    ...
    private function createErrorMessage(\RectorPrefix20210225\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
     ...
     * @param class-string<\PHPStan\PhpDocParser\Ast\Node> $tagValueNodeType
     */
    private function doTestContainsTagValueNodeType(\PhpParser\Node $node, string $tagValueNodeType, \RectorPrefix20210225\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
        $phpDocInfo = $this->phpDocInfoFactory->createFromNodeOrEmpty($node);
