...
abstract class AbstractPhpDocInfoTest extends \RectorPrefix20210207\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var FileInfoParser
     */
     ...
     * @return T
     */
    private function parseFileAndGetFirstNodeOfType(\RectorPrefix20210207\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, string $nodeType) : \PhpParser\Node
    {
    ...
    private function createErrorMessage(\RectorPrefix20210207\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
