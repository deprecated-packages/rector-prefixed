...
abstract class AbstractPhpDocInfoTest extends \RectorPrefix20210101\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var FileInfoParser
     */
     ...
     */
    protected function doTestPrintedPhpDocInfo(\RectorPrefix20210101\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, string $tagValueNodeType) : void
    {
     ...
     */
    private function parseFileAndGetFirstNodeOfType(\RectorPrefix20210101\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, string $nodeType) : \PhpParser\Node
    {
    ...
    private function createErrorMessage(\RectorPrefix20210101\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
        return 'Caused by: ' . $fileInfo->getRelativeFilePathFromCwd() . \PHP_EOL;
    }
    private function doTestContainsTagValueNodeType(\PhpParser\Node $node, string $tagValueNodeType, \RectorPrefix20210101\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
