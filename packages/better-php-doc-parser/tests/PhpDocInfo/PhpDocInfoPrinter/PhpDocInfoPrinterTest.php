...
final class PhpDocInfoPrinterTest extends \Rector\BetterPhpDocParser\Tests\PhpDocInfo\PhpDocInfoPrinter\AbstractPhpDocInfoPrinterTest
{
     ...
     */
    public function test(\RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo $docFileInfo) : void
    {
        $this->doComparePrintedFileEquals($docFileInfo, $docFileInfo);
    }
    public function testRemoveSpace() : void
    {
        $this->doComparePrintedFileEquals(new \RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/FixtureChanged/with_space.txt'), new \RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/FixtureChangedExpected/with_space_expected.txt'));
    }
     ...
     */
    public function testEmpty(\RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    private function doComparePrintedFileEquals(\RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo $inputFileInfo, \RectorPrefix20210202\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo) : void
    {
