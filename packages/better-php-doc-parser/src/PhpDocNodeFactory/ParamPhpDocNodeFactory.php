...
use RectorPrefix20201227\PHPStan\PhpDocParser\Parser\ParserException;
...
final class ParamPhpDocNodeFactory
{
    ...
    public function createFromTokens(\RectorPrefix20201227\PHPStan\PhpDocParser\Parser\TokenIterator $tokenIterator) : ?\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
    {
        try {
        ...
        } catch (\RectorPrefix20201227\PHPStan\PhpDocParser\Parser\ParserException $parserException) {
    ...
    public function setPhpDocParser(\RectorPrefix20201227\PHPStan\PhpDocParser\Parser\PhpDocParser $phpDocParser) : void
    {
     ...
     */
    private function parseParamTagValue(\RectorPrefix20201227\PHPStan\PhpDocParser\Parser\TokenIterator $tokenIterator) : \Rector\AttributeAwarePhpDoc\Ast\PhpDoc\AttributeAwareParamTagValueNode
    {
        ...
        $isVariadic = $tokenIterator->tryConsumeTokenType(\RectorPrefix20201227\PHPStan\PhpDocParser\Lexer\Lexer::TOKEN_VARIADIC);
        // extra value over parent
        $isReference = $tokenIterator->tryConsumeTokenType(\RectorPrefix20201227\PHPStan\PhpDocParser\Lexer\Lexer::TOKEN_REFERENCE);
