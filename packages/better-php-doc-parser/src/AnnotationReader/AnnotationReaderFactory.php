...
final class AnnotationReaderFactory
{
    ...
    private const IGNORED_NAMES = [
        '_PhpScoper006a73f0e455\\ORM\\GeneratedValue',
        'GeneratedValue',
        '_PhpScoper006a73f0e455\\ORM\\InheritanceType',
        'InheritanceType',
        '_PhpScoper006a73f0e455\\ORM\\OrderBy',
        'OrderBy',
        '_PhpScoper006a73f0e455\\ORM\\DiscriminatorMap',
        'DiscriminatorMap',
        '_PhpScoper006a73f0e455\\ORM\\UniqueEntity',
        'UniqueEntity',
        '_PhpScoper006a73f0e455\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        '_PhpScoper006a73f0e455\\Gedmo\\Slug',
        'Slug',
        '_PhpScoper006a73f0e455\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        '_PhpScoper006a73f0e455\\Gedmo\\Blameable',
        'Blameable',
        '_PhpScoper006a73f0e455\\Gedmo\\Versioned',
        'Versioned',
        // nette @inject dummy annotation
        'inject',
    ];
    public function create() : \_PhpScoper006a73f0e455\Doctrine\Common\Annotations\Reader
    {
        \_PhpScoper006a73f0e455\Doctrine\Common\Annotations\AnnotationRegistry::registerLoader('class_exists');
        // generated
     ...
     */
    private function createAnnotationReader() : \_PhpScoper006a73f0e455\Doctrine\Common\Annotations\Reader
    {
        ...
        return new \_PhpScoper006a73f0e455\Doctrine\Common\Annotations\AnnotationReader(new \_PhpScoper006a73f0e455\Doctrine\Common\Annotations\DocParser());
    }
}
