...
use RectorPrefix20201228\Doctrine\Common\Annotations\AnnotationReader;
use RectorPrefix20201228\Doctrine\Common\Annotations\AnnotationRegistry;
use RectorPrefix20201228\Doctrine\Common\Annotations\DocParser;
...
final class AnnotationReaderFactory
{
    ...
    private const IGNORED_NAMES = [
        'RectorPrefix20201228\\ORM\\GeneratedValue',
        'GeneratedValue',
        'RectorPrefix20201228\\ORM\\InheritanceType',
        'InheritanceType',
        'RectorPrefix20201228\\ORM\\OrderBy',
        'OrderBy',
        'RectorPrefix20201228\\ORM\\DiscriminatorMap',
        'DiscriminatorMap',
        'RectorPrefix20201228\\ORM\\UniqueEntity',
        'UniqueEntity',
        'RectorPrefix20201228\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        'RectorPrefix20201228\\Gedmo\\Slug',
        'Slug',
        'RectorPrefix20201228\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        'RectorPrefix20201228\\Gedmo\\Blameable',
        'Blameable',
        'RectorPrefix20201228\\Gedmo\\Versioned',
        'Versioned',
        // nette @inject dummy annotation
        'inject',
    ];
    public function create() : \RectorPrefix20201228\Doctrine\Common\Annotations\Reader
    {
        \RectorPrefix20201228\Doctrine\Common\Annotations\AnnotationRegistry::registerLoader('class_exists');
        // generated
     ...
     */
    private function createAnnotationReader() : \RectorPrefix20201228\Doctrine\Common\Annotations\Reader
    {
        ...
        return new \RectorPrefix20201228\Doctrine\Common\Annotations\AnnotationReader(new \RectorPrefix20201228\Doctrine\Common\Annotations\DocParser());
    }
}
