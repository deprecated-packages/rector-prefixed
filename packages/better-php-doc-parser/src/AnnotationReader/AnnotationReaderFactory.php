...
use RectorPrefix20201226\Doctrine\Common\Annotations\AnnotationReader;
use RectorPrefix20201226\Doctrine\Common\Annotations\AnnotationRegistry;
use RectorPrefix20201226\Doctrine\Common\Annotations\DocParser;
...
final class AnnotationReaderFactory
{
    ...
    private const IGNORED_NAMES = [
        'RectorPrefix20201226\\ORM\\GeneratedValue',
        'GeneratedValue',
        'RectorPrefix20201226\\ORM\\InheritanceType',
        'InheritanceType',
        'RectorPrefix20201226\\ORM\\OrderBy',
        'OrderBy',
        'RectorPrefix20201226\\ORM\\DiscriminatorMap',
        'DiscriminatorMap',
        'RectorPrefix20201226\\ORM\\UniqueEntity',
        'UniqueEntity',
        'RectorPrefix20201226\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        'RectorPrefix20201226\\Gedmo\\Slug',
        'Slug',
        'RectorPrefix20201226\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        'RectorPrefix20201226\\Gedmo\\Blameable',
        'Blameable',
        'RectorPrefix20201226\\Gedmo\\Versioned',
        'Versioned',
        // nette @inject dummy annotation
        'inject',
    ];
    public function create() : \RectorPrefix20201226\Doctrine\Common\Annotations\Reader
    {
        \RectorPrefix20201226\Doctrine\Common\Annotations\AnnotationRegistry::registerLoader('class_exists');
        // generated
     ...
     */
    private function createAnnotationReader() : \RectorPrefix20201226\Doctrine\Common\Annotations\Reader
    {
        ...
        return new \RectorPrefix20201226\Doctrine\Common\Annotations\AnnotationReader(new \RectorPrefix20201226\Doctrine\Common\Annotations\DocParser());
    }
}
