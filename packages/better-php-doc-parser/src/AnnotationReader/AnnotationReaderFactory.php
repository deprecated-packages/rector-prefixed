...
use RectorPrefix20201227\Doctrine\Common\Annotations\AnnotationReader;
use RectorPrefix20201227\Doctrine\Common\Annotations\AnnotationRegistry;
use RectorPrefix20201227\Doctrine\Common\Annotations\DocParser;
...
final class AnnotationReaderFactory
{
    ...
    private const IGNORED_NAMES = [
        'RectorPrefix20201227\\ORM\\GeneratedValue',
        'GeneratedValue',
        'RectorPrefix20201227\\ORM\\InheritanceType',
        'InheritanceType',
        'RectorPrefix20201227\\ORM\\OrderBy',
        'OrderBy',
        'RectorPrefix20201227\\ORM\\DiscriminatorMap',
        'DiscriminatorMap',
        'RectorPrefix20201227\\ORM\\UniqueEntity',
        'UniqueEntity',
        'RectorPrefix20201227\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        'RectorPrefix20201227\\Gedmo\\Slug',
        'Slug',
        'RectorPrefix20201227\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        'RectorPrefix20201227\\Gedmo\\Blameable',
        'Blameable',
        'RectorPrefix20201227\\Gedmo\\Versioned',
        'Versioned',
        // nette @inject dummy annotation
        'inject',
    ];
    public function create() : \RectorPrefix20201227\Doctrine\Common\Annotations\Reader
    {
        \RectorPrefix20201227\Doctrine\Common\Annotations\AnnotationRegistry::registerLoader('class_exists');
        // generated
     ...
     */
    private function createAnnotationReader() : \RectorPrefix20201227\Doctrine\Common\Annotations\Reader
    {
        ...
        return new \RectorPrefix20201227\Doctrine\Common\Annotations\AnnotationReader(new \RectorPrefix20201227\Doctrine\Common\Annotations\DocParser());
    }
}
