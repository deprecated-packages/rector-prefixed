...
use _PhpScoper267b3276efc2\Doctrine\Common\Annotations\AnnotationReader;
use _PhpScoper267b3276efc2\Doctrine\Common\Annotations\AnnotationRegistry;
use _PhpScoper267b3276efc2\Doctrine\Common\Annotations\DocParser;
...
final class AnnotationReaderFactory
{
    ...
    private const IGNORED_NAMES = [
        '_PhpScoper267b3276efc2\\ORM\\GeneratedValue',
        'GeneratedValue',
        '_PhpScoper267b3276efc2\\ORM\\InheritanceType',
        'InheritanceType',
        '_PhpScoper267b3276efc2\\ORM\\OrderBy',
        'OrderBy',
        '_PhpScoper267b3276efc2\\ORM\\DiscriminatorMap',
        'DiscriminatorMap',
        '_PhpScoper267b3276efc2\\ORM\\UniqueEntity',
        'UniqueEntity',
        '_PhpScoper267b3276efc2\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        '_PhpScoper267b3276efc2\\Gedmo\\Slug',
        'Slug',
        '_PhpScoper267b3276efc2\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        '_PhpScoper267b3276efc2\\Gedmo\\Blameable',
        'Blameable',
        '_PhpScoper267b3276efc2\\Gedmo\\Versioned',
        'Versioned',
        // nette @inject dummy annotation
        'inject',
    ];
    public function create() : \_PhpScoper267b3276efc2\Doctrine\Common\Annotations\Reader
    {
        \_PhpScoper267b3276efc2\Doctrine\Common\Annotations\AnnotationRegistry::registerLoader('class_exists');
        // generated
     ...
     */
    private function createAnnotationReader() : \_PhpScoper267b3276efc2\Doctrine\Common\Annotations\Reader
    {
        ...
        return new \_PhpScoper267b3276efc2\Doctrine\Common\Annotations\AnnotationReader(new \_PhpScoper267b3276efc2\Doctrine\Common\Annotations\DocParser());
    }
}
