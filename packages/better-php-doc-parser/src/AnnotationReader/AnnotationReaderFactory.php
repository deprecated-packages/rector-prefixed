...
use _PhpScoper17db12703726\Doctrine\Common\Annotations\AnnotationReader;
use _PhpScoper17db12703726\Doctrine\Common\Annotations\AnnotationRegistry;
use _PhpScoper17db12703726\Doctrine\Common\Annotations\DocParser;
...
final class AnnotationReaderFactory
{
    ...
    private const IGNORED_NAMES = [
        '_PhpScoper17db12703726\\ORM\\GeneratedValue',
        'GeneratedValue',
        '_PhpScoper17db12703726\\ORM\\InheritanceType',
        'InheritanceType',
        '_PhpScoper17db12703726\\ORM\\OrderBy',
        'OrderBy',
        '_PhpScoper17db12703726\\ORM\\DiscriminatorMap',
        'DiscriminatorMap',
        '_PhpScoper17db12703726\\ORM\\UniqueEntity',
        'UniqueEntity',
        '_PhpScoper17db12703726\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        '_PhpScoper17db12703726\\Gedmo\\Slug',
        'Slug',
        '_PhpScoper17db12703726\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        '_PhpScoper17db12703726\\Gedmo\\Blameable',
        'Blameable',
        '_PhpScoper17db12703726\\Gedmo\\Versioned',
        'Versioned',
        // nette @inject dummy annotation
        'inject',
    ];
    public function create() : \_PhpScoper17db12703726\Doctrine\Common\Annotations\Reader
    {
        \_PhpScoper17db12703726\Doctrine\Common\Annotations\AnnotationRegistry::registerLoader('class_exists');
        // generated
     ...
     */
    private function createAnnotationReader() : \_PhpScoper17db12703726\Doctrine\Common\Annotations\Reader
    {
        ...
        return new \_PhpScoper17db12703726\Doctrine\Common\Annotations\AnnotationReader(new \_PhpScoper17db12703726\Doctrine\Common\Annotations\DocParser());
    }
}
