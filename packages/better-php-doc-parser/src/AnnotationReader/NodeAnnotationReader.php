...
use _PhpScoper0a2ac50786fa\Doctrine\Common\Annotations\AnnotationException;
use _PhpScoper0a2ac50786fa\Doctrine\Common\Annotations\Reader;
use _PhpScoper0a2ac50786fa\PhpParser\Node;
use _PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Class_;
use _PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassMethod;
use _PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Property;
use _PhpScoper0a2ac50786fa\Rector\DoctrineAnnotationGenerated\PhpDocNode\ConstantReferenceIdentifierRestorer;
...
final class NodeAnnotationReader
{
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\DoctrineAnnotationGenerated\PhpDocNode\ConstantReferenceIdentifierRestorer $constantReferenceIdentifierRestorer, \_PhpScoper0a2ac50786fa\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScoper0a2ac50786fa\Doctrine\Common\Annotations\Reader $reader)
    {
        $this->reader = $reader;
        $this->nodeNameResolver = $nodeNameResolver;
        $this->constantReferenceIdentifierRestorer = $constantReferenceIdentifierRestorer;
    }
    public function readAnnotation(\_PhpScoper0a2ac50786fa\PhpParser\Node $node, string $annotationClass) : ?object
    {
    ...
    public function readClassAnnotation(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Class_ $class, string $annotationClassName) : ?object
    {
        ...
        } catch (\_PhpScoper0a2ac50786fa\Doctrine\Common\Annotations\AnnotationException $annotationException) {
            // unable to load
            return null;
        }
    }
    public function readPropertyAnnotation(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Property $property, string $annotationClassName) : ?object
    {
    ...
    private function readMethodAnnotation(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassMethod $classMethod, string $annotationClassName) : ?object
    {
    ...
    private function createClassReflectionFromNode(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Class_ $class) : \ReflectionClass
    {
        /** @var string $className */
     ...
     */
    private function matchNextAnnotation(array $annotations, string $annotationClassName, \_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?object
    {
    ...
    private function createPropertyReflectionFromPropertyNode(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Property $property) : ?\ReflectionProperty
    {
        ...
        if ($className === null || !\_PhpScoper0a2ac50786fa\Rector\NodeTypeResolver\ClassExistenceStaticHelper::doesClassLikeExist($className)) {
            // probably fresh node
            return null;
        }
        try {
