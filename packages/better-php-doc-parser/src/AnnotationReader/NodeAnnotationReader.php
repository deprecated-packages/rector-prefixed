...
use RectorPrefix20210210\Doctrine\Common\Annotations\AnnotationException;
use RectorPrefix20210210\Doctrine\Common\Annotations\Reader;
use PhpParser\Node;
...
final class NodeAnnotationReader
{
    ...
    public function __construct(\Rector\DoctrineAnnotationGenerated\PhpDocNode\ConstantReferenceIdentifierRestorer $constantReferenceIdentifierRestorer, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210210\Doctrine\Common\Annotations\Reader $reader)
    {
        $this->reader = $reader;
    ...
    public function readClassAnnotation(\PhpParser\Node\Stmt\Class_ $class, string $annotationClassName) : ?object
    {
        ...
        } catch (\RectorPrefix20210210\Doctrine\Common\Annotations\AnnotationException $annotationException) {
            // unable to load
            return null;
        }
    }
