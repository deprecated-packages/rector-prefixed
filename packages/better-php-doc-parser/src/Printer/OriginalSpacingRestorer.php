...
final class OriginalSpacingRestorer
{
    ...
    public function restoreInOutputWithTokensStartAndEndPosition(\PHPStan\PhpDocParser\Ast\Node $node, string $nodeOutput, array $tokens, \Rector\BetterPhpDocParser\ValueObject\StartAndEnd $startAndEnd) : string
    {
        ...
        $nodeOutputParts = \RectorPrefix20210121\Nette\Utils\Strings::split($nodeOutput, self::WHITESPACE_SPLIT_REGEX);
        ...
        $asteriskSpaceFirst = \RectorPrefix20210121\Nette\Utils\Strings::contains($oldWhitespaces[0], '*');
        ...
        return \RectorPrefix20210121\Nette\Utils\Strings::substring($newNodeOutput, 1);
    }
}
