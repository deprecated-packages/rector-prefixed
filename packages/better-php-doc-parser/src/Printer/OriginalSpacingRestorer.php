...
final class OriginalSpacingRestorer
{
    ...
    public function __construct(\_PhpScoper2a4e7ab1ecbc\Rector\BetterPhpDocParser\Printer\WhitespaceDetector $whitespaceDetector)
    {
     ...
     * @param mixed[] $tokens
     */
    public function restoreInOutputWithTokensStartAndEndPosition(\_PhpScoper2a4e7ab1ecbc\PHPStan\PhpDocParser\Ast\Node $node, string $nodeOutput, array $tokens, \_PhpScoper2a4e7ab1ecbc\Rector\BetterPhpDocParser\ValueObject\StartAndEnd $startAndEnd) : string
    {
        ...
        $nodeOutputParts = \_PhpScoper2a4e7ab1ecbc\Nette\Utils\Strings::split($nodeOutput, self::WHITESPACE_SPLIT_REGEX);
        ...
        $asteriskSpaceFirst = \_PhpScoper2a4e7ab1ecbc\Nette\Utils\Strings::contains($oldWhitespaces[0], '*');
        ...
        return \_PhpScoper2a4e7ab1ecbc\Nette\Utils\Strings::substring($newNodeOutput, 1);
    }
}
