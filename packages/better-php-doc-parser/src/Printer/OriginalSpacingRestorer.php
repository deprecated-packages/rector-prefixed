...
final class OriginalSpacingRestorer
{
    ...
    public function restoreInOutputWithTokensStartAndEndPosition(\PHPStan\PhpDocParser\Ast\Node $node, string $nodeOutput, array $tokens, \Rector\BetterPhpDocParser\ValueObject\StartAndEnd $startAndEnd) : string
    {
        ...
        $nodeOutputParts = \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::split($nodeOutput, self::WHITESPACE_SPLIT_REGEX);
        ...
        $asteriskSpaceFirst = \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::contains($oldWhitespaces[0], '*');
        ...
        return \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::substring($newNodeOutput, 1);
    }
}
