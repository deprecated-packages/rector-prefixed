...
use _PhpScoper0a6b37af0871\Doctrine\Common\Annotations\Annotation;
...
final class AnnotationItemsResolver
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\Rector\BetterPhpDocParser\Annotation\AnnotationVisibilityDetector $annotationVisibilityDetector)
    {
    ...
    private function resolvePrivatePropertyValues(object $object) : array
    {
        ...
        foreach ((array) $object as $messedPropertyName => $value) {
            $propertyName = \_PhpScoper0a6b37af0871\Nette\Utils\Strings::after($messedPropertyName, "\0", -1);
