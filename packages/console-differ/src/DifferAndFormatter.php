...
final class DifferAndFormatter
{
    ...
    public function __construct(\RectorPrefix20210115\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter $colorConsoleDiffFormatter, \RectorPrefix20210115\SebastianBergmann\Diff\Differ $differ)
    {
        $this->differ = $differ;
