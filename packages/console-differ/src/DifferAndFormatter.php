...
final class DifferAndFormatter
{
    ...
    public function __construct(\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter $colorConsoleDiffFormatter, \_PhpScoper567b66d83109\SebastianBergmann\Diff\Differ $differ)
    {
        $this->differ = $differ;
