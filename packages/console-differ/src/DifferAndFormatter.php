...
final class DifferAndFormatter
{
    ...
    public function __construct(\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter $colorConsoleDiffFormatter, \_PhpScoper8b9c402c5f32\SebastianBergmann\Diff\Differ $differ)
    {
        $this->differ = $differ;
