...
final class DifferAndFormatter
{
    ...
    public function __construct(\RectorPrefix20201227\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter $colorConsoleDiffFormatter, \RectorPrefix20201227\SebastianBergmann\Diff\Differ $differ)
    {
        $this->differ = $differ;
