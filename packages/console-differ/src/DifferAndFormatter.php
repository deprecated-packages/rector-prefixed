...
final class DifferAndFormatter
{
    ...
    public function __construct(\RectorPrefix20210105\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter $colorConsoleDiffFormatter, \RectorPrefix20210105\SebastianBergmann\Diff\Differ $differ)
    {
        $this->differ = $differ;
