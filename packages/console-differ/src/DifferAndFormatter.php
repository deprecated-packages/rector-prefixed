...
final class DifferAndFormatter
{
    ...
    public function __construct(\RectorPrefix20210104\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter $colorConsoleDiffFormatter, \RectorPrefix20210104\SebastianBergmann\Diff\Differ $differ)
    {
        $this->differ = $differ;
