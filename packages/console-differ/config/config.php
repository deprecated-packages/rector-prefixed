...
use RectorPrefix20210123\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilder;
...
use RectorPrefix20210123\Symplify\ConsoleColorDiff\Console\Output\ConsoleDiffer;
return static function (\RectorPrefix20210123\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Rector\ConsoleDiffer\DifferAndFormatter::class)->arg('$differ', \RectorPrefix20210123\Symfony\Component\DependencyInjection\Loader\Configurator\service('differ'));
    $services->set(\Rector\ConsoleDiffer\MarkdownDifferAndFormatter::class)->arg('$markdownDiffer', \RectorPrefix20210123\Symfony\Component\DependencyInjection\Loader\Configurator\service('markdownDiffer'));
    $services->set('diffOutputBuilder', \RectorPrefix20210123\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilder::class)->arg('$options', ['fromFile' => 'Original', 'toFile' => 'New']);
    $services->set('differ', \RectorPrefix20210123\SebastianBergmann\Diff\Differ::class)->arg('$outputBuilder', \RectorPrefix20210123\Symfony\Component\DependencyInjection\Loader\Configurator\service('diffOutputBuilder'));
    ...
    $services->set(\RectorPrefix20210123\Symplify\ConsoleColorDiff\Console\Formatter\ColorConsoleDiffFormatter::class);
    $services->set(\RectorPrefix20210123\Symplify\ConsoleColorDiff\Console\Output\ConsoleDiffer::class);
};
