...
final class AttributeAwareUnionTypeNode extends \_PhpScoper0a6b37af0871\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode implements \_PhpScoper0a6b37af0871\Rector\BetterPhpDocParser\Contract\PhpDocNode\AttributeAwareNodeInterface
{
    use AttributeTrait;
    /**
     * @var string
    ...
    public function __construct(array $types, string $originalContent = '')
    {
        ...
        $this->isWrappedWithBrackets = (bool) \_PhpScoper0a6b37af0871\Nette\Utils\Strings::match($originalContent, self::BRACKET_WRAPPING_REGEX);
    }
    /**
