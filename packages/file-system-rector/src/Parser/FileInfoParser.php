...
final class FileInfoParser
{
     ...
     * @return Node[]
     */
    public function parseFileInfoToNodesAndDecorate(\RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : array
    {
     ...
     * @return Node[]
     */
    public function parseFileInfoToNodesAndDecorateWithScope(\RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : array
    {
        $oldStmts = $this->parser->parseFileInfo($fileInfo);
