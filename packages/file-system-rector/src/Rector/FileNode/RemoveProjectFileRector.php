...
, [self::FILE_PATHS_TO_REMOVE => ['someFile/ToBeRemoved.txt']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20210123\Webmozart\Assert\Assert::allString($filePathsToRemove);
    ...
    {
        if (\Rector\Testing\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun() && \RectorPrefix20210123\Nette\Utils\Strings::endsWith($relativePathInProject, $filePathToRemove)) {
            // only for tests
            return \true;
        }
