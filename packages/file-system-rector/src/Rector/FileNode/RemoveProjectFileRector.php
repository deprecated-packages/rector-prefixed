...
, [self::FILE_PATHS_TO_REMOVE => ['someFile/ToBeRemoved.txt']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \_PhpScoper8b9c402c5f32\Webmozart\Assert\Assert::allString($filePathsToRemove);
    ...
    {
        if (\Rector\Testing\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun() && \_PhpScoper8b9c402c5f32\Nette\Utils\Strings::endsWith($relativePathInProject, $filePathToRemove)) {
            // only for tests
            return \true;
        }
