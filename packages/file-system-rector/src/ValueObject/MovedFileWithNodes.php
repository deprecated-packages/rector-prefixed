...
final class MovedFileWithNodes implements \Rector\FileSystemRector\Contract\MovedFileInterface
{
     ...
     * @param Node[] $nodes
     */
    public function __construct(array $nodes, string $fileDestination, \RectorPrefix20210207\Symplify\SmartFileSystem\SmartFileInfo $originalSmartFileInfo, ?string $oldClassName = null, ?string $newClassName = null)
    {
        $this->nodes = $nodes;
    ...
    public function getOriginalFileInfo() : \RectorPrefix20210207\Symplify\SmartFileSystem\SmartFileInfo
    {
