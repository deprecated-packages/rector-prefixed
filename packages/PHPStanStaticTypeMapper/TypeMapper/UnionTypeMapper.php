...
final class UnionTypeMapper implements TypeMapperInterface
{
     ...
     * @return void
     */
    public function autowireUnionTypeMapper(PHPStanStaticTypeMapper $phpStanStaticTypeMapper)
    {
     ...
     */
    private function matchTypeForNullableUnionType(UnionType $unionType)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function matchTypeForUnionedObjectTypes(UnionType $unionType)
    {
     ...
     */
    private function matchPhpParserUnionType(UnionType $unionType)
    {
        if (! $this->phpVersionProvider->isAtLeastPhpVersion(PhpVersionFeature::UNION_TYPES)) {
            return null;
        }
     ...
     * @return \PHPStan\Type\TypeWithClassName|null
     */
    private function matchTwoObjectTypes(UnionType $unionType)
    {
