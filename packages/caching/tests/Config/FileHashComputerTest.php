...
final class FileHashComputerTest extends \RectorPrefix20210114\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $configAHash = $this->fileHashComputer->compute(new \RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo($firstConfig));
        $configBHash = $this->fileHashComputer->compute(new \RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo($secondConfig));
    ...
    public function testInvalidType() : void
    {
        ...
        $this->fileHashComputer->compute(new \RectorPrefix20210114\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/file.xml'));
    }
}
