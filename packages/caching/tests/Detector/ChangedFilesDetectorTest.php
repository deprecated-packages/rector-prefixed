...
final class ChangedFilesDetectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    {
        $smartFileInfo = new \RectorPrefix20210303\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/file.php');
    ...
    {
        $smartFileInfo = new \RectorPrefix20210303\Symplify\SmartFileSystem\SmartFileInfo($filePathName);
