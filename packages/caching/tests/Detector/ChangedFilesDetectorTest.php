...
final class ChangedFilesDetectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    {
        $smartFileInfo = new \RectorPrefix20201229\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/file.php');
    ...
    {
        $smartFileInfo = new \RectorPrefix20201229\Symplify\SmartFileSystem\SmartFileInfo($filePathName);
    ...
    {
        return new \RectorPrefix20201229\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/config.php');
    }
}
