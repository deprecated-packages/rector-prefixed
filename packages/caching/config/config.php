...
use RectorPrefix20201227\Symfony\Component\Cache\Adapter\FilesystemAdapter;
use RectorPrefix20201227\Symfony\Component\Cache\Adapter\TagAwareAdapter;
use RectorPrefix20201227\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface;
use RectorPrefix20201227\Symfony\Component\Cache\Psr16Cache;
...
return static function (\RectorPrefix20201227\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\RectorPrefix20201227\Symfony\Component\Cache\Adapter\TagAwareAdapter::class)->arg('$itemsPool', \RectorPrefix20201227\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\RectorPrefix20201227\Symfony\Component\Cache\Adapter\FilesystemAdapter::class));
    $services->alias(\RectorPrefix20201227\Psr\Cache\CacheItemPoolInterface::class, \RectorPrefix20201227\Symfony\Component\Cache\Adapter\FilesystemAdapter::class);
    $services->alias(\RectorPrefix20201227\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface::class, \RectorPrefix20201227\Symfony\Component\Cache\Adapter\TagAwareAdapter::class);
};
