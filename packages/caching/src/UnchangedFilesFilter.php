...
namespace _PhpScoper2a4e7ab1ecbc\Rector\Caching;
...
final class UnchangedFilesFilter
{
    ...
    public function __construct(\_PhpScoper2a4e7ab1ecbc\Rector\Caching\Detector\ChangedFilesDetector $changedFilesDetector)
    {
