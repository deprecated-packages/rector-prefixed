...
final class FilesystemAdapterFactory
{
    ...
    public function create() : \RectorPrefix20210227\Symfony\Component\Cache\Adapter\FilesystemAdapter
    {
        return new \RectorPrefix20210227\Symfony\Component\Cache\Adapter\FilesystemAdapter(
            // unique per project
            \RectorPrefix20210227\Nette\Utils\Strings::webalize(\getcwd()),
            0,
