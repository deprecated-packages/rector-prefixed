...
final class FilesystemAdapterFactory
{
    ...
    public function create() : \RectorPrefix20210207\Symfony\Component\Cache\Adapter\FilesystemAdapter
    {
        return new \RectorPrefix20210207\Symfony\Component\Cache\Adapter\FilesystemAdapter(
            // unique per project
            \RectorPrefix20210207\Nette\Utils\Strings::webalize(\getcwd()),
            0,
