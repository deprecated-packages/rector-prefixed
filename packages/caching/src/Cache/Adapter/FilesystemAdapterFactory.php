...
final class FilesystemAdapterFactory
{
    ...
    public function create() : \RectorPrefix20201227\Symfony\Component\Cache\Adapter\FilesystemAdapter
    {
        return new \RectorPrefix20201227\Symfony\Component\Cache\Adapter\FilesystemAdapter(
            // unique per project
            \RectorPrefix20201227\Nette\Utils\Strings::webalize(\getcwd()),
            0,
