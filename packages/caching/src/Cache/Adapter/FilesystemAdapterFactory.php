...
final class FilesystemAdapterFactory
{
    ...
    public function create() : \RectorPrefix20210123\Symfony\Component\Cache\Adapter\FilesystemAdapter
    {
        return new \RectorPrefix20210123\Symfony\Component\Cache\Adapter\FilesystemAdapter(
            // unique per project
            \RectorPrefix20210123\Nette\Utils\Strings::webalize(\getcwd()),
            0,
