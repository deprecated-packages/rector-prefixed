...
final class FilesystemAdapterFactory
{
    ...
    public function create() : \RectorPrefix20210218\Symfony\Component\Cache\Adapter\FilesystemAdapter
    {
        return new \RectorPrefix20210218\Symfony\Component\Cache\Adapter\FilesystemAdapter(
            // unique per project
            \RectorPrefix20210218\Nette\Utils\Strings::webalize(\getcwd()),
            0,
