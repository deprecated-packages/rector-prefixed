...
final class FileHashComputer
{
    public function compute(\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
        ...
        $containerBuilder = new \_PhpScoper006a73f0e455\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    private function createFileLoader(\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, \_PhpScoper006a73f0e455\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \_PhpScoper006a73f0e455\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \_PhpScoper006a73f0e455\Symfony\Component\Config\FileLocator([$fileInfo->getPath()]);
        $loaderResolver = new \_PhpScoper006a73f0e455\Symfony\Component\Config\Loader\LoaderResolver([new \_PhpScoper006a73f0e455\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \_PhpScoper006a73f0e455\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, $fileLocator), new \_PhpScoper006a73f0e455\Symfony\Component\DependencyInjection\Loader\YamlFileLoader($containerBuilder, $fileLocator)]);
