...
final class FileHashComputer
{
    public function compute(\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
        ...
        $containerBuilder = new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    private function createFileLoader(\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \_PhpScoperabd03f0baf05\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \_PhpScoperabd03f0baf05\Symfony\Component\Config\FileLocator([$fileInfo->getPath()]);
        $loaderResolver = new \_PhpScoperabd03f0baf05\Symfony\Component\Config\Loader\LoaderResolver([new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, $fileLocator), new \_PhpScoperabd03f0baf05\Symfony\Component\DependencyInjection\Loader\YamlFileLoader($containerBuilder, $fileLocator)]);
