...
final class ChangedFilesDetector
{
    ...
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \RectorPrefix2020DecSat\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface $tagAwareAdapter)
    {
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \RectorPrefix2020DecSat\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
