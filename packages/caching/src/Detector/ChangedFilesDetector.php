...
final class ChangedFilesDetector
{
    ...
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \_PhpScoper8b9c402c5f32\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface $tagAwareAdapter)
    {
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \_PhpScoper8b9c402c5f32\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
