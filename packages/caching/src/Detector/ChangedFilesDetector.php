...
final class ChangedFilesDetector
{
    ...
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \_PhpScoperfce0de0de1ce\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface $tagAwareAdapter)
    {
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \_PhpScoperfce0de0de1ce\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
