...
final class ChangedFilesDetector
{
    ...
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \RectorPrefix20210121\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface $tagAwareAdapter)
    {
     ...
     */
    public function addFileWithDependencies(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles) : void
    {
    ...
    public function hasFileChanged(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : bool
    {
    ...
    public function invalidateFile(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $fileInfoCacheKey = $this->getFileInfoCacheKey($smartFileInfo);
     ...
     */
    public function getDependentFileInfos(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : array
    {
        ...
        foreach ($dependentFiles as $dependentFile) {
            ...
            $dependentFileInfos[] = new \RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo($dependentFile);
        }
     ...
     * @api
     */
    public function setFirstResolvedConfigFileInfo(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
        // the first config is core to all → if it was changed, just invalidate it
        $configHash = $this->fileHashComputer->compute($fileInfo);
        $this->storeConfigurationDataHash($fileInfo, $configHash);
    }
    private function getFileInfoCacheKey(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        return \sha1($smartFileInfo->getRealPath());
    }
    private function hashFile(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    private function storeConfigurationDataHash(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, string $configurationHash) : void
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \RectorPrefix20210121\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
