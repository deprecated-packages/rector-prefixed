...
final class ChangedFilesDetector
{
    ...
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \_PhpScoper5b8c9e9ebd21\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface $tagAwareAdapter)
    {
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \_PhpScoper5b8c9e9ebd21\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
