...
final class ChangedFilesDetector
{
    ...
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \_PhpScoperbf340cb0be9d\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface $tagAwareAdapter)
    {
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \_PhpScoperbf340cb0be9d\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
