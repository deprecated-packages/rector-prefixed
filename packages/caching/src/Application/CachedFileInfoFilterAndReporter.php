...
final class CachedFileInfoFilterAndReporter
{
    ...
    public function __construct(\Rector\Core\Configuration\Configuration $configuration, \Rector\Caching\Detector\ChangedFilesDetector $changedFilesDetector, \RectorPrefix20210104\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Rector\Caching\UnchangedFilesFilter $unchangedFilesFilter)
    {
