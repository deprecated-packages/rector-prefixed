...
function nativePropertyFetchOnTypedVar(\Rector\NodeTypeResolver\Tests\PerNodeTypeResolver\PropertyFetchTypeResolver\Source\ClassWithNativeProps $props) : void
{
    $props->text->xxx();
    $props->number->xxx();
