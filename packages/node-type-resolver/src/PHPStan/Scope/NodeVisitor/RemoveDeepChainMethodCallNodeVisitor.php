...
final class RemoveDeepChainMethodCallNodeVisitor extends \PhpParser\NodeVisitorAbstract
{
    ...
    public function __construct(\Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder, \RectorPrefix20210120\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
