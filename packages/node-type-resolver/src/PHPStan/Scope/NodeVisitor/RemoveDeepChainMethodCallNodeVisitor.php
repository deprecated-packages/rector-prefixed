...
namespace _PhpScoper0a2ac50786fa\Rector\NodeTypeResolver\PHPStan\Scope\NodeVisitor;
 ...
 */
final class RemoveDeepChainMethodCallNodeVisitor extends \_PhpScoper0a2ac50786fa\PhpParser\NodeVisitorAbstract
{
    /**
     * @var int
     */
    ...
    public function __construct(\_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder, \_PhpScoper0a2ac50786fa\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
        $this->betterNodeFinder = $betterNodeFinder;
        $this->nestedChainMethodCallLimit = (int) $parameterProvider->provideParameter(\_PhpScoper0a2ac50786fa\Rector\Core\Configuration\Option::NESTED_CHAIN_METHOD_CALL_LIMIT);
    }
    public function enterNode(\_PhpScoper0a2ac50786fa\PhpParser\Node $node) : ?int
    {
        ...
        if ($node->expr instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\MethodCall && $node->expr->var instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\MethodCall) {
            $nestedChainMethodCalls = $this->betterNodeFinder->findInstanceOf([$node->expr], \_PhpScoper0a2ac50786fa\PhpParser\Node\Expr\MethodCall::class);
