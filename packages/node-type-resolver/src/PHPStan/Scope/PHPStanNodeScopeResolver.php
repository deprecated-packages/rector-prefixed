...
final class PHPStanNodeScopeResolver
{
     ...
     * @return Node[]
     */
    public function processNodes(array $nodes, \RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
    ...
    private function resolveClassOrInterfaceScope(\PhpParser\Node\Stmt\ClassLike $classLike, \PHPStan\Analyser\Scope $scope) : \PHPStan\Analyser\MutatingScope
    {
        ...
        if ($classLike instanceof \PhpParser\Node\Stmt\Class_ && \RectorPrefix20210129\Nette\Utils\Strings::match($className, self::ANONYMOUS_CLASS_START_REGEX)) {
     ...
     */
    private function reportCacheDebugAndSaveDependentFiles(\RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles) : void
    {
        if (!$this->configuration->isCacheEnabled()) {
            return;
        }
     ...
     * @param string[] $dependentFiles
     */
    private function reportCacheDebug(\RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles) : void
    {
