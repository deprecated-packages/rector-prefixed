...
use _PhpScoper0a6b37af0871\Rector\NodeCollector\NodeVisitor\NodeCollectorNodeVisitor;
use _PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\FileInfoNodeVisitor;
use _PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\FirstLevelNodeVisitor;
use _PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\FunctionLikeParamArgPositionNodeVisitor;
use _PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\FunctionMethodAndClassNodeVisitor;
use _PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\NamespaceNodeVisitor;
use _PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\PhpDocInfoNodeVisitor;
use _PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\StatementNodeVisitor;
use _PhpScoper0a6b37af0871\Rector\NodeTypeResolver\PHPStan\Scope\PHPStanNodeScopeResolver;
...
final class NodeScopeAndMetadataDecorator
{
    ...
    public function __construct(\_PhpScoper0a6b37af0871\PhpParser\NodeVisitor\CloningVisitor $cloningVisitor, \_PhpScoper0a6b37af0871\Rector\Core\Configuration\Configuration $configuration, \_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\FileInfoNodeVisitor $fileInfoNodeVisitor, \_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\FunctionMethodAndClassNodeVisitor $functionMethodAndClassNodeVisitor, \_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\NamespaceNodeVisitor $namespaceNodeVisitor, \_PhpScoper0a6b37af0871\Rector\NodeCollector\NodeVisitor\NodeCollectorNodeVisitor $nodeCollectorNodeVisitor, \_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\PHPStan\Scope\PHPStanNodeScopeResolver $phpStanNodeScopeResolver, \_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\PhpDocInfoNodeVisitor $phpDocInfoNodeVisitor, \_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\StatementNodeVisitor $statementNodeVisitor, \_PhpScoper0a6b37af0871\PhpParser\NodeVisitor\NodeConnectingVisitor $nodeConnectingVisitor, \_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\FunctionLikeParamArgPositionNodeVisitor $functionLikeParamArgPositionNodeVisitor, \_PhpScoper0a6b37af0871\Rector\NodeTypeResolver\NodeVisitor\FirstLevelNodeVisitor $firstLevelNodeVisitor)
    {
     ...
     * @return Node[]
     */
    public function decorateNodesFromFile(array $nodes, \_PhpScoper0a6b37af0871\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, bool $needsScope = \false) : array
    {
        $nodeTraverser = new \_PhpScoper0a6b37af0871\PhpParser\NodeTraverser();
        $nodeTraverser->addVisitor(new \_PhpScoper0a6b37af0871\PhpParser\NodeVisitor\NameResolver(null, [
        ...
        $nodeTraverser = new \_PhpScoper0a6b37af0871\PhpParser\NodeTraverser();
        $preservingNameResolver = new \_PhpScoper0a6b37af0871\PhpParser\NodeVisitor\NameResolver(null, [
            'preserveOriginalNames' => \true,
