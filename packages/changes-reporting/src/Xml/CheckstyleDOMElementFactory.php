...
namespace _PhpScoperb75b35f52b74\Rector\ChangesReporting\Xml;
...
final class CheckstyleDOMElementFactory
{
    ...
    public function create(\DOMDocument $domDocument, \_PhpScoperb75b35f52b74\Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : \DOMElement
    {
    ...
    private function createFileDOMElement(\DOMDocument $domDocument, \_PhpScoperb75b35f52b74\Rector\Core\ValueObject\Reporting\FileDiff $fileDiff) : \DOMElement
    {
    ...
    private function createNonFileErrorDOMElements(\DOMDocument $domDocument, \_PhpScoperb75b35f52b74\Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : ?\DOMElement
    {
    ...
    private function createErrorDOMElement(\_PhpScoperb75b35f52b74\Rector\ChangesReporting\ValueObject\RectorWithFileAndLineChange $rectorWithFileAndLineChange, \DOMDocument $domDocument) : \DOMElement
    {
