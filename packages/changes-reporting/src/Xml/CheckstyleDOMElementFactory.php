...
namespace _PhpScoper0a6b37af0871\Rector\ChangesReporting\Xml;
...
final class CheckstyleDOMElementFactory
{
    ...
    public function create(\DOMDocument $domDocument, \_PhpScoper0a6b37af0871\Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : \DOMElement
    {
    ...
    private function createFileDOMElement(\DOMDocument $domDocument, \_PhpScoper0a6b37af0871\Rector\Core\ValueObject\Reporting\FileDiff $fileDiff) : \DOMElement
    {
    ...
    private function createNonFileErrorDOMElements(\DOMDocument $domDocument, \_PhpScoper0a6b37af0871\Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : ?\DOMElement
    {
    ...
    private function createErrorDOMElement(\_PhpScoper0a6b37af0871\Rector\ChangesReporting\ValueObject\RectorWithFileAndLineChange $rectorWithFileAndLineChange, \DOMDocument $domDocument) : \DOMElement
    {
