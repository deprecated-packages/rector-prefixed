...
final class CheckstyleDOMElementFactory
{
    ...
    public function create(\DOMDocument $domDocument, \Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : \DOMElement
    {
    ...
    private function createFileDOMElement(\DOMDocument $domDocument, \Rector\Core\ValueObject\Reporting\FileDiff $fileDiff) : \DOMElement
    {
    ...
    private function createNonFileErrorDOMElements(\DOMDocument $domDocument, \Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : ?\DOMElement
    {
    ...
    private function createErrorDOMElement(\Rector\ChangesReporting\ValueObject\RectorWithFileAndLineChange $rectorWithFileAndLineChange, \DOMDocument $domDocument) : \DOMElement
    {
