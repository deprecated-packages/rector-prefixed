...
namespace _PhpScoper2a4e7ab1ecbc\Rector\ChangesReporting\Xml;
...
final class CheckstyleDOMElementFactory
{
    ...
    public function create(\DOMDocument $domDocument, \_PhpScoper2a4e7ab1ecbc\Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : \DOMElement
    {
    ...
    private function createFileDOMElement(\DOMDocument $domDocument, \_PhpScoper2a4e7ab1ecbc\Rector\Core\ValueObject\Reporting\FileDiff $fileDiff) : \DOMElement
    {
    ...
    private function createNonFileErrorDOMElements(\DOMDocument $domDocument, \_PhpScoper2a4e7ab1ecbc\Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : ?\DOMElement
    {
    ...
    private function createErrorDOMElement(\_PhpScoper2a4e7ab1ecbc\Rector\ChangesReporting\ValueObject\RectorWithFileAndLineChange $rectorWithFileAndLineChange, \DOMDocument $domDocument) : \DOMElement
    {
