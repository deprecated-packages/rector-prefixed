...
namespace _PhpScoper0a6b37af0871\Rector\ChangesReporting\NodeManipulator;
...
final class NotifyingNodeRemover
{
     ...
     */
    public function removeStmt(\_PhpScoper0a6b37af0871\PhpParser\Node $node, int $key) : void
    {
        if ($node->stmts === null) {
    ...
    public function removeParam(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\ClassMethod $classMethod, int $key) : void
    {
     ...
     */
    public function removeArg(\_PhpScoper0a6b37af0871\PhpParser\Node $node, int $key) : void
    {
        if ($node->args === null) {
            throw new \_PhpScoper0a6b37af0871\Rector\Core\Exception\ShouldNotHappenException();
        }
    ...
    public function removeImplements(\_PhpScoper0a6b37af0871\PhpParser\Node\Stmt\Class_ $class, int $key) : void
    {
