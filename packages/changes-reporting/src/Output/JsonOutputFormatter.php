...
final class JsonOutputFormatter implements \Rector\ChangesReporting\Contract\Output\OutputFormatterInterface
{
    ...
    public function __construct(\Rector\Core\Configuration\Configuration $configuration, \RectorPrefix20210131\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function report(\Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector) : void
    {
        ...
        $json = \RectorPrefix20210131\Nette\Utils\Json::encode($errorsArray, \RectorPrefix20210131\Nette\Utils\Json::PRETTY);
