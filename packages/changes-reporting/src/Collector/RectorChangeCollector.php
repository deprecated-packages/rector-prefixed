...
final class RectorChangeCollector
{
    ...
    public function __construct(\_PhpScoper2a4e7ab1ecbc\Rector\Core\Logging\CurrentRectorProvider $currentRectorProvider)
    {
     ...
     */
    public function getRectorChangesByFileInfo(\_PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        return \array_filter($this->rectorWithFileAndLineChanges, function (\_PhpScoper2a4e7ab1ecbc\Rector\ChangesReporting\ValueObject\RectorWithFileAndLineChange $rectorWithFileAndLineChange) use($smartFileInfo) : bool {
            return $rectorWithFileAndLineChange->getRealPath() === $smartFileInfo->getRealPath();
        });
    }
    public function notifyNodeFileInfo(\_PhpScoper2a4e7ab1ecbc\PhpParser\Node $node) : void
    {
    ...
    private function addRectorClassWithLine(\_PhpScoper2a4e7ab1ecbc\Rector\Core\Contract\Rector\RectorInterface $rector, \_PhpScoper2a4e7ab1ecbc\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, int $line) : void
    {
        $this->rectorWithFileAndLineChanges[] = new \_PhpScoper2a4e7ab1ecbc\Rector\ChangesReporting\ValueObject\RectorWithFileAndLineChange($rector, $smartFileInfo->getRealPath(), $line);
    }
}
