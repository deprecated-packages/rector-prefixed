...
final class RectorChangeCollector
{
     ...
     */
    public function getRectorChangesByFileInfo(\RectorPrefix20210105\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
    ...
    private function addRectorClassWithLine(\Rector\Core\Contract\Rector\RectorInterface $rector, \RectorPrefix20210105\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, int $line) : void
    {
