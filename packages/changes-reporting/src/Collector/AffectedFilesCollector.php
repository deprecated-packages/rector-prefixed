...
final class AffectedFilesCollector
{
    ...
    public function addFile(\RectorPrefix20210306\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
        $this->affectedFiles[$fileInfo->getRealPath()] = $fileInfo;
    }
    public function getNext() : ?\RectorPrefix20210306\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    public function removeFromList(\RectorPrefix20210306\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
