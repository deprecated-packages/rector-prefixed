...
return static function (\RectorPrefix20201227\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('RectorPrefix20201227\Rector\\Testing\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/PHPUnit/Runnable/NodeVisitor', __DIR__ . '/../src/ValueObject', __DIR__ . '/../src/PHPUnit']);
};
