...
{
    public function create() : \RectorPrefix20210301\Symplify\PhpConfigPrinter\Printer\SmartPhpConfigPrinter
    {
        $phpConfigPrinterKernel = new \RectorPrefix20210301\Symplify\PhpConfigPrinter\HttpKernel\PhpConfigPrinterKernel('prod', \true);
        ...
        return $container->get(\RectorPrefix20210301\Symplify\PhpConfigPrinter\Printer\SmartPhpConfigPrinter::class);
    }
}
