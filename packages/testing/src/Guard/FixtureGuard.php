...
final class FixtureGuard
{
    ...
    public function ensureFileInfoHasDifferentBeforeAndAfterContent(\RectorPrefix20210109\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $match = \RectorPrefix20210109\Nette\Utils\Strings::match($smartFileInfo->getContents(), self::BEFORE_AFTER_CONTENT_REGEX);
        if ($match === null) {
            return;
        }
