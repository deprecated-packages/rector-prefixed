...
final class FixtureGuard
{
    ...
    public function ensureFileInfoHasDifferentBeforeAndAfterContent(\RectorPrefix20201229\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $match = \RectorPrefix20201229\Nette\Utils\Strings::match($smartFileInfo->getContents(), self::BEFORE_AFTER_CONTENT_REGEX);
        if ($match === null) {
            return;
        }
