...
{
    protected function matchMovedFile(\RectorPrefix20210212\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : \Rector\FileSystemRector\Contract\MovedFileInterface
    {
        return $this->removedAndAddedFilesCollector->getMovedFileByFileInfo($smartFileInfo);
    }
    protected function assertFileWasNotChanged(\RectorPrefix20210212\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    protected function assertFileWasRemoved(\RectorPrefix20210212\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    {
        \RectorPrefix20210212\Webmozart\Assert\Assert::allIsAOf($addedFileWithContents, \Rector\FileSystemRector\ValueObject\AddedFileWithContent::class);
