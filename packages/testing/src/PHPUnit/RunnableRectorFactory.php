...
final class RunnableRectorFactory
{
    ...
    private function createTemporaryPathWithPrefix(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        $hash = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::substring(\md5($smartFileInfo->getRealPath()), -15);
    ...
    {
        return \_PhpScoperabd03f0baf05\Nette\Utils\Random::generate(30);
    }
}
