...
final class RunnableRectorFactory
{
    ...
    private function createTemporaryPathWithPrefix(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        $hash = \_PhpScoper006a73f0e455\Nette\Utils\Strings::substring(\md5($smartFileInfo->getRealPath()), -15);
    ...
    {
        return \_PhpScoper006a73f0e455\Nette\Utils\Random::generate(30);
    }
}
