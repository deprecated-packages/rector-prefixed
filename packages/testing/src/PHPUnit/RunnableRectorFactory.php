...
use RectorPrefix2020DecSat\Nette\Utils\Random;
...
final class RunnableRectorFactory
{
    ...
    private function createTemporaryPathWithPrefix(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        $hash = \RectorPrefix2020DecSat\Nette\Utils\Strings::substring(\md5($smartFileInfo->getRealPath()), -15);
    ...
    {
        return \RectorPrefix2020DecSat\Nette\Utils\Random::generate(30);
    }
}
