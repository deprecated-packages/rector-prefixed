...
final class RunnableRectorFactory
{
    ...
    private function createTemporaryPathWithPrefix(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        $hash = \_PhpScoper26e51eeacccf\Nette\Utils\Strings::substring(\md5($smartFileInfo->getRealPath()), -15);
    ...
    {
        return \_PhpScoper26e51eeacccf\Nette\Utils\Random::generate(30);
    }
}
