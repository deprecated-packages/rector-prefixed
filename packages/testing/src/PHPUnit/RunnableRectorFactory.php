...
use _PhpScoper567b66d83109\Nette\Utils\Random;
...
final class RunnableRectorFactory
{
    ...
    private function createTemporaryPathWithPrefix(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        $hash = \_PhpScoper567b66d83109\Nette\Utils\Strings::substring(\md5($smartFileInfo->getRealPath()), -15);
    ...
    {
        return \_PhpScoper567b66d83109\Nette\Utils\Random::generate(30);
    }
}
