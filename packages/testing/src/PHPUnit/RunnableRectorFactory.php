...
use RectorPrefix20210129\Nette\Utils\Random;
...
final class RunnableRectorFactory
{
    ...
    public function createRunnableClass(\RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $classContentFileInfo) : \Rector\Testing\Contract\RunnableInterface
    {
    ...
    private function createTemporaryPathWithPrefix(\RectorPrefix20210129\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        // warning: if this hash is too short, the file can becom "identical"; took me 1 hour to find out
        $hash = \RectorPrefix20210129\Nette\Utils\Strings::substring(\md5($smartFileInfo->getRealPath()), -15);
    ...
    {
        return \RectorPrefix20210129\Nette\Utils\Random::generate(30);
    }
}
