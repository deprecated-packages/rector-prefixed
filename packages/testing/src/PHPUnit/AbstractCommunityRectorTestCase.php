...
abstract class AbstractCommunityRectorTestCase extends \RectorPrefix20210301\Symplify\PackageBuilder\Testing\AbstractKernelTestCase implements \Rector\Testing\Contract\CommunityRectorTestCaseInterface
{
    /**
     * @var FileProcessor
     */
    ...
    protected function setUp() : void
    {
        ...
        $smartFileInfo = new \RectorPrefix20210301\Symplify\SmartFileSystem\SmartFileInfo($this->provideConfigFilePath());
    ...
    protected function doTestFileInfo(\RectorPrefix20210301\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo, bool $shouldAutoload = \true) : void
    {
        self::$fixtureGuard->ensureFileInfoHasDifferentBeforeAndAfterContent($fixtureFileInfo);
        $inputFileInfoAndExpectedFileInfo = \RectorPrefix20210301\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpectedFileInfos($fixtureFileInfo, $shouldAutoload);
    ...
    private function doTestFileMatchesExpectedContent(\RectorPrefix20210301\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \RectorPrefix20210301\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, \RectorPrefix20210301\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
