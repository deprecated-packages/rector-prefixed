...
use RectorPrefix20210217\PHPUnit\Framework\ExpectationFailedException;
use RectorPrefix20210217\Psr\Container\ContainerInterface;
...
use RectorPrefix20210217\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater;
use RectorPrefix20210217\Symplify\EasyTesting\StaticFixtureSplitter;
use RectorPrefix20210217\Symplify\PackageBuilder\Parameter\ParameterProvider;
...
abstract class AbstractRectorTestCase extends \RectorPrefix20210217\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        if ($this->provideConfigFilePath() !== '') {
            $configFileInfo = new \RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo($this->provideConfigFilePath());
        ...
        $this->parameterProvider = $this->getService(\RectorPrefix20210217\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
    ...
    {
        return \RectorPrefix20210217\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory($directory, $suffix);
    }
    protected function doTestFileInfoWithoutAutoload(\RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
     ...
     */
    protected function doTestFileInfo(\RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo, array $extraFiles = []) : void
    {
        self::$fixtureGuard->ensureFileInfoHasDifferentBeforeAndAfterContent($fixtureFileInfo);
        $inputFileInfoAndExpectedFileInfo = \RectorPrefix20210217\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpectedFileInfos($fixtureFileInfo, $this->autoloadTestFixture);
        ...
        if (!\RectorPrefix20210217\Nette\Utils\Strings::contains($inputFileInfo->getContents(), \Rector\Testing\Contract\RunnableInterface::class)) {
            return;
        }
    ...
    protected function doTestExtraFile(string $expectedExtraFileName, string $expectedExtraContentFilePath) : void
    {
        ...
        foreach ($addedFilesWithContents as $addedFilesWithContent) {
            if (!\RectorPrefix20210217\Nette\Utils\Strings::endsWith($addedFilesWithContent->getFilePath(), $expectedExtraFileName)) {
                continue;
            }
        ...
        foreach ($addedFilesWithNodes as $addedFileWithNodes) {
            if (!\RectorPrefix20210217\Nette\Utils\Strings::endsWith($addedFileWithNodes->getFilePath(), $expectedExtraFileName)) {
                continue;
            }
        ...
        foreach ($movedFilesWithContent as $movedFileWithContent) {
            if (!\RectorPrefix20210217\Nette\Utils\Strings::endsWith($movedFileWithContent->getNewPathname(), $expectedExtraFileName)) {
                continue;
            }
    ...
    protected function assertOriginalAndFixedFileResultEquals(\RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo) : void
    {
     ...
     * @param InputFilePathWithExpectedFile[] $extraFiles
     */
    private function doTestFileMatchesExpectedContent(\RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, \RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo, array $extraFiles = []) : void
    {
        $this->parameterProvider->changeParameter(\Rector\Core\Configuration\Option::SOURCE, [$originalFileInfo->getRealPath()]);
        if (!\RectorPrefix20210217\Nette\Utils\Strings::endsWith($originalFileInfo->getFilename(), '.blade.php') && \in_array($originalFileInfo->getSuffix(), ['php', 'phpt'], \true)) {
            if ($extraFiles === []) {
        ...
        } elseif (\RectorPrefix20210217\Nette\Utils\Strings::match($originalFileInfo->getFilename(), \Rector\Core\ValueObject\StaticNonPhpFileSuffixes::getSuffixRegexPattern())) {
        ...
        } catch (\RectorPrefix20210217\PHPUnit\Framework\ExpectationFailedException $expectationFailedException) {
            \RectorPrefix20210217\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater::updateFixtureContent($originalFileInfo, $changedContent, $fixtureFileInfo);
    ...
    {
        return \RectorPrefix20210217\Nette\Utils\Strings::replace($string, '#\\r\\n|\\r|\\n#', "\n");
    }
    /**
    ...
    private function initializeDependencies() : void
    {
        ...
        self::$smartFileSystem = new \RectorPrefix20210217\Symplify\SmartFileSystem\SmartFileSystem();
