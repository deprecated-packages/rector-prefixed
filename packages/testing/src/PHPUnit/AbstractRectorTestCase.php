...
use RectorPrefix20210111\Symfony\Component\HttpKernel\KernelInterface;
use RectorPrefix20210111\Symplify\EasyTesting\DataProvider\StaticFixtureFinder;
use RectorPrefix20210111\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater;
use RectorPrefix20210111\Symplify\EasyTesting\StaticFixtureSplitter;
use RectorPrefix20210111\Symplify\PackageBuilder\Parameter\ParameterProvider;
use RectorPrefix20210111\Symplify\PackageBuilder\Testing\AbstractKernelTestCase;
...
abstract class AbstractRectorTestCase extends \RectorPrefix20210111\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->smartFileSystem = new \RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileSystem();
    ...
    {
        return \RectorPrefix20210111\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory($directory, $suffix);
    }
    /**
     * @param mixed $value
     */
    ...
    {
        $parameterProvider = $this->getService(\RectorPrefix20210111\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
     ...
     */
    protected function bootKernelWithConfigInfos(string $class, array $configFileInfos) : \RectorPrefix20210111\Symfony\Component\HttpKernel\KernelInterface
    {
        $configFiles = [];
    ...
    protected function doTestFileInfoWithoutAutoload(\RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
     ...
     */
    protected function doTestFileInfo(\RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo, array $extraFiles = []) : void
    {
        $this->fixtureGuard->ensureFileInfoHasDifferentBeforeAndAfterContent($fixtureFileInfo);
        $inputFileInfoAndExpectedFileInfo = \RectorPrefix20210111\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpectedFileInfos($fixtureFileInfo, $this->autoloadTestFixture);
        ...
        if (!\RectorPrefix20210111\Nette\Utils\Strings::contains($inputFileInfo->getContents(), \Rector\Testing\Contract\RunnableInterface::class)) {
            return;
        }
    ...
    {
        return \RectorPrefix20210111\Symplify\EasyTesting\StaticFixtureSplitter::getTemporaryPath();
    }
     ...
     */
    private function resolveConfigs(\RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
     ...
     * @param InputFilePathWithExpectedFile[] $extraFiles
     */
    private function doTestFileMatchesExpectedContent(\RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, \RectorPrefix20210111\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo, array $extraFiles = []) : void
    {
        $this->setParameter(\Rector\Core\Configuration\Option::SOURCE, [$originalFileInfo->getRealPath()]);
        if (!\RectorPrefix20210111\Nette\Utils\Strings::endsWith($originalFileInfo->getFilename(), '.blade.php') && \in_array($originalFileInfo->getSuffix(), ['php', 'phpt'], \true)) {
            if ($extraFiles === []) {
        ...
        } catch (\RectorPrefix20210111\PHPUnit\Framework\ExpectationFailedException $expectationFailedException) {
            \RectorPrefix20210111\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater::updateFixtureContent($originalFileInfo, $changedContent, $fixtureFileInfo);
    ...
    {
        return \RectorPrefix20210111\Nette\Utils\Strings::replace($string, '#\\r\\n|\\r|\\n#', "\n");
    }
}
