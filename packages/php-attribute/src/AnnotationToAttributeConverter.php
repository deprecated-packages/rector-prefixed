...
final class AnnotationToAttributeConverter
{
    ...
    public function convertNode(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($phpDocInfo->hasByName('required')) {
            ...
            $node->attrGroups[] = new \PhpParser\Node\AttributeGroup([new \PhpParser\Node\Attribute(new \PhpParser\Node\Name\FullyQualified('_PhpScoper26e51eeacccf\\Symfony\\Contracts\\Service\\Attribute\\Required'))]);
