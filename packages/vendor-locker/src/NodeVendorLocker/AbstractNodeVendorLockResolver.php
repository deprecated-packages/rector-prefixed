...
abstract class AbstractNodeVendorLockResolver
{
     ...
     * @required
     */
    public function autowireAbstractNodeVendorLockResolver(\_PhpScoper0a2ac50786fa\Rector\NodeCollector\NodeCollector\ParsedNodeCollector $parsedNodeCollector, \_PhpScoper0a2ac50786fa\Rector\Core\PhpParser\Node\Manipulator\ClassManipulator $classManipulator, \_PhpScoper0a2ac50786fa\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \_PhpScoper0a2ac50786fa\Rector\FamilyTree\Reflection\FamilyRelationsAnalyzer $familyRelationsAnalyzer) : void
    {
    ...
    protected function hasParentClassChildrenClassesOrImplementsInterface(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassLike $classLike) : bool
    {
        if (($classLike instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Class_ || $classLike instanceof \_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Interface_) && $classLike->extends) {
            return \true;
        }
     ...
     */
    protected function isMethodVendorLockedByInterface(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\ClassLike $classLike, string $methodName) : bool
    {
     ...
     * @return class-string[]
     */
    protected function getChildrenClassesByClass(\_PhpScoper0a2ac50786fa\PhpParser\Node\Stmt\Class_ $class) : array
    {
        $desiredClassName = $class->getAttribute(\_PhpScoper0a2ac50786fa\Rector\NodeTypeResolver\Node\AttributeKey::CLASS_NAME);
