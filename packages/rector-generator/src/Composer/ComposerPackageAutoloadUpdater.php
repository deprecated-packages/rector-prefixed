...
use RectorPrefix20210212\Symplify\SmartFileSystem\Json\JsonFileSystem;
final class ComposerPackageAutoloadUpdater
{
    ...
    public function __construct(\RectorPrefix20210212\Symplify\SmartFileSystem\Json\JsonFileSystem $jsonFileSystem, \RectorPrefix20210212\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    public function processComposerAutoload(\Rector\RectorGenerator\ValueObject\RectorRecipe $rectorRecipe) : void
    {
        ...
        $srcAutoload = $rectorRecipe->isRectorRepository() ? \RectorPrefix20210212\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD : \RectorPrefix20210212\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV;
        $composerJson[$srcAutoload][self::PSR_4][$package->getSrcNamespace()] = $package->getSrcDirectory();
        $composerJson[\RectorPrefix20210212\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV][self::PSR_4][$package->getTestsNamespace()] = $package->getTestsDirectory();
    ...
    {
        foreach ([\RectorPrefix20210212\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD, \RectorPrefix20210212\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV] as $autoloadSection) {
