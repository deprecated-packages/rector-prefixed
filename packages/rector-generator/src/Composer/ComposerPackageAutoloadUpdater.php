...
final class ComposerPackageAutoloadUpdater
{
    ...
    public function __construct(\Rector\RectorGenerator\FileSystem\JsonFileSystem $jsonFileSystem, \RectorPrefix20210113\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
