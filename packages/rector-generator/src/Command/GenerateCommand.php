...
final class GenerateCommand extends \_PhpScoperbf340cb0be9d\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    private function resolveTestCaseDirectoryPath(array $generatedFilePaths) : string
    {
        foreach ($generatedFilePaths as $generatedFilePath) {
            if (!\_PhpScoperbf340cb0be9d\Nette\Utils\Strings::endsWith($generatedFilePath, 'Test.php')) {
                continue;
            }
