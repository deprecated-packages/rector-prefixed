...
final class GenerateCommand extends \_PhpScoper006a73f0e455\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    private function resolveTestCaseDirectoryPath(array $generatedFilePaths) : string
    {
        foreach ($generatedFilePaths as $generatedFilePath) {
            if (!\_PhpScoper006a73f0e455\Nette\Utils\Strings::endsWith($generatedFilePath, 'Test.php')) {
                continue;
            }
