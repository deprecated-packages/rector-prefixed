...
final class GenerateCommand extends \_PhpScoper8b9c402c5f32\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    private function resolveTestCaseDirectoryPath(array $generatedFilePaths) : string
    {
        foreach ($generatedFilePaths as $generatedFilePath) {
            if (!\_PhpScoper8b9c402c5f32\Nette\Utils\Strings::endsWith($generatedFilePath, 'Test.php')) {
                continue;
            }
