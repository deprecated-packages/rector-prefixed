...
final class GenerateCommand extends \_PhpScoper267b3276efc2\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    private function resolveTestCaseDirectoryPath(array $generatedFilePaths) : string
    {
        foreach ($generatedFilePaths as $generatedFilePath) {
            if (!\_PhpScoper267b3276efc2\Nette\Utils\Strings::endsWith($generatedFilePath, 'Test.php')) {
                continue;
            }
