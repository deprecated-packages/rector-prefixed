...
final class GenerateCommand extends \_PhpScoper5edc98a7cce2\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    private function resolveTestCaseDirectoryPath(array $generatedFilePaths) : string
    {
        foreach ($generatedFilePaths as $generatedFilePath) {
            if (!\_PhpScoper5edc98a7cce2\Nette\Utils\Strings::endsWith($generatedFilePath, 'Test.php')) {
                continue;
            }
