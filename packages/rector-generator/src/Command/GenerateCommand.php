 ...
 */
final class GenerateCommand extends \RectorPrefix20201230\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::INTERACTIVE_MODE_NAME, 'i', \RectorPrefix20201230\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Turns on Interactive Mode - Rector will be generated based on responses to questions instead of using rector-recipe.php');
    }
    ...
    private function resolveTestCaseDirectoryPath(array $generatedFilePaths) : string
    {
        foreach ($generatedFilePaths as $generatedFilePath) {
            ...
            $generatedFileInfo = new \RectorPrefix20201230\Symplify\SmartFileSystem\SmartFileInfo($generatedFilePath);
    ...
    {
        if (\RectorPrefix20201230\Nette\Utils\Strings::endsWith($generatedFilePath, 'Test.php')) {
            return \true;
        }
        if (!\RectorPrefix20201230\Nette\Utils\Strings::endsWith($generatedFilePath, 'Test.php.inc')) {
            return \false;
        }
    ...
    private function printSuccess(string $name, array $generatedFilePaths, string $testCaseFilePath) : void
    {
        ...
        foreach ($generatedFilePaths as $generatedFilePath) {
            $fileInfo = new \RectorPrefix20201230\Symplify\SmartFileSystem\SmartFileInfo($generatedFilePath);
    ...
    private function getRectorRecipe(\RectorPrefix20201230\Symfony\Component\Console\Input\InputInterface $input) : \Rector\RectorGenerator\ValueObject\RectorRecipe
    {
