...
final class GenerateCommand extends \_PhpScoper17db12703726\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    private function resolveTestCaseDirectoryPath(array $generatedFilePaths) : string
    {
        foreach ($generatedFilePaths as $generatedFilePath) {
            if (!\_PhpScoper17db12703726\Nette\Utils\Strings::endsWith($generatedFilePath, 'Test.php')) {
                continue;
            }
