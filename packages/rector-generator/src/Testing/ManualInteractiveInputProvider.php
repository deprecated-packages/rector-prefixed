...
use RectorPrefix20210124\Symfony\Component\Console\Tester\CommandTester;
...
final class ManualInteractiveInputProvider
{
    ...
    public function __construct(\RectorPrefix20210124\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \RectorPrefix20210124\Symplify\PackageBuilder\Reflection\PrivatesCaller $privatesCaller, \RectorPrefix20210124\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor)
    {
    ...
    {
        $arrayInput = new \RectorPrefix20210124\Symfony\Component\Console\Input\ArrayInput([]);
    ...
    private function createInputStream(array $manualInteractiveInput)
    {
        ...
        return $this->privatesCaller->callPrivateMethod(\RectorPrefix20210124\Symfony\Component\Console\Tester\CommandTester::class, 'createStream', [$manualInteractiveInput]);
    }
}
