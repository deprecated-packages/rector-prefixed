...
use RectorPrefix20210228\Symfony\Component\Console\Tester\CommandTester;
...
final class ManualInteractiveInputProvider
{
    ...
    public function __construct(\RectorPrefix20210228\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \RectorPrefix20210228\Symplify\PackageBuilder\Reflection\PrivatesCaller $privatesCaller, \RectorPrefix20210228\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor)
    {
    ...
    {
        $arrayInput = new \RectorPrefix20210228\Symfony\Component\Console\Input\ArrayInput([]);
    ...
    private function createInputStream(array $manualInteractiveInput)
    {
        ...
        return $this->privatesCaller->callPrivateMethod(\RectorPrefix20210228\Symfony\Component\Console\Tester\CommandTester::class, 'createStream', [$manualInteractiveInput]);
    }
}
