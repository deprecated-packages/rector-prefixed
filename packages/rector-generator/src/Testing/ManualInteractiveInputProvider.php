...
use RectorPrefix20210130\Symfony\Component\Console\Tester\CommandTester;
...
final class ManualInteractiveInputProvider
{
    ...
    public function __construct(\RectorPrefix20210130\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \RectorPrefix20210130\Symplify\PackageBuilder\Reflection\PrivatesCaller $privatesCaller, \RectorPrefix20210130\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor)
    {
    ...
    {
        $arrayInput = new \RectorPrefix20210130\Symfony\Component\Console\Input\ArrayInput([]);
    ...
    private function createInputStream(array $manualInteractiveInput)
    {
        ...
        return $this->privatesCaller->callPrivateMethod(\RectorPrefix20210130\Symfony\Component\Console\Tester\CommandTester::class, 'createStream', [$manualInteractiveInput]);
    }
}
