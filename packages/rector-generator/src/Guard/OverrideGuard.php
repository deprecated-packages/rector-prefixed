...
final class OverrideGuard
{
    ...
    public function __construct(\RectorPrefix20201226\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Rector\RectorGenerator\FileSystem\TemplateFileSystem $templateFileSystem)
    {
