...
final class ConfigFilesystem
{
    ...
    public function appendRectorServiceToSet(\Rector\RectorGenerator\ValueObject\RectorRecipe $rectorRecipe, array $templateVariables) : void
    {
        ...
        $setFileInfo = new \RectorPrefix20210103\Symplify\SmartFileSystem\SmartFileInfo($setFilePath);
        ...
        if (\RectorPrefix20210103\Nette\Utils\Strings::contains($setFileContents, $rectorFqnName)) {
            return;
        }
        // 1. parse the file
