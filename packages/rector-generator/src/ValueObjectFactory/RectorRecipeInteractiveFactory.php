...
CODE_SAMPLE;
    ...
    public function __construct(\Rector\RectorGenerator\Provider\PackageNamesProvider $packageNamesProvider, \Rector\RectorGenerator\Provider\NodeTypesProvider $nodeTypesProvider, \Rector\RectorGenerator\Provider\SetsListProvider $setsListProvider, \RectorPrefix20210119\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    {
        $question = new \RectorPrefix20210119\Symfony\Component\Console\Question\Question(\sprintf('Package name for which Rector should be created (e.g. <fg=yellow>%s</>)', 'Naming'));
    ...
    {
        $choiceQuestion = new \RectorPrefix20210119\Symfony\Component\Console\Question\ChoiceQuestion(\sprintf('For what Nodes should the Rector be run (e.g. <fg=yellow>%s</>)', 'Expr/MethodCall'), $this->nodeTypesProvider->provide());
    ...
    {
        $question = new \RectorPrefix20210119\Symfony\Component\Console\Question\Question(\sprintf('Set to which Rector should be added (e.g. <fg=yellow>%s</>)', 'SYMFONY_52'));
