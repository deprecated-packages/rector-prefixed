...
final class JsonFileSystem
{
    ...
    public function __construct(\Rector\RectorGenerator\FileSystem\JsonStringFormatter $jsonStringFormatter, \RectorPrefix20201228\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $content = \RectorPrefix20201228\Nette\Utils\Json::encode($json, \RectorPrefix20201228\Nette\Utils\Json::PRETTY);
