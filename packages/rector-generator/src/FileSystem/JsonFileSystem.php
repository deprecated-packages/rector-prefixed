...
final class JsonFileSystem
{
    ...
    public function __construct(\Rector\RectorGenerator\FileSystem\JsonStringFormatter $jsonStringFormatter, \RectorPrefix20210113\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $content = \RectorPrefix20210113\Nette\Utils\Json::encode($json, \RectorPrefix20210113\Nette\Utils\Json::PRETTY);
