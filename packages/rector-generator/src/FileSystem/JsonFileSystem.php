...
final class JsonFileSystem
{
    ...
    public function __construct(\Rector\RectorGenerator\FileSystem\JsonStringFormatter $jsonStringFormatter, \RectorPrefix20210108\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $content = \RectorPrefix20210108\Nette\Utils\Json::encode($json, \RectorPrefix20210108\Nette\Utils\Json::PRETTY);
