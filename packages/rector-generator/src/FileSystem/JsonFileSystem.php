...
final class JsonFileSystem
{
    ...
    public function __construct(\Rector\RectorGenerator\FileSystem\JsonStringFormatter $jsonStringFormatter, \RectorPrefix20201229\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $content = \RectorPrefix20201229\Nette\Utils\Json::encode($json, \RectorPrefix20201229\Nette\Utils\Json::PRETTY);
