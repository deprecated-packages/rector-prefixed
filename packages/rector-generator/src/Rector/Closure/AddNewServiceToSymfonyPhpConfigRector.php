...
final class AddNewServiceToSymfonyPhpConfigRector extends \Rector\Core\Rector\AbstractRector implements \Rector\RectorGenerator\Contract\InternalRectorInterface
{
    ...
    {
        return new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Adds a new $services->set(...) call to PHP Config', [new \RectorPrefix20201228\Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
