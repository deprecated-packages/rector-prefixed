...
final class IntegerTypeMapper implements \_PhpScoper0a2ac50786fa\Rector\PHPStanStaticTypeMapper\Contract\TypeMapperInterface
{
    /**
    ...
    {
        return \_PhpScoper0a2ac50786fa\PHPStan\Type\IntegerType::class;
    }
    /**
    ...
    {
        return new \_PhpScoper0a2ac50786fa\Rector\AttributeAwarePhpDoc\Ast\Type\AttributeAwareIdentifierTypeNode('int');
    }
    /**
     * @param IntegerType $type
     */
    public function mapToPhpParserNode(\_PhpScoper0a2ac50786fa\PHPStan\Type\Type $type, ?string $kind = null) : ?\_PhpScoper0a2ac50786fa\PhpParser\Node
    {
        ...
        return new \_PhpScoper0a2ac50786fa\PhpParser\Node\Name('int');
    }
