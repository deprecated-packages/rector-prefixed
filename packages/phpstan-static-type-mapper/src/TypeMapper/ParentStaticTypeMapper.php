...
final class ParentStaticTypeMapper implements \_PhpScoperb75b35f52b74\Rector\PHPStanStaticTypeMapper\Contract\TypeMapperInterface
{
    public function getNodeClass() : string
    {
        return \_PhpScoperb75b35f52b74\Rector\PHPStan\Type\ParentStaticType::class;
    }
    /**
    ...
    {
        return new \_PhpScoperb75b35f52b74\Rector\AttributeAwarePhpDoc\Ast\Type\AttributeAwareIdentifierTypeNode('parent');
    }
    /**
     * @param ParentStaticType $type
     */
    ...
    {
        return new \_PhpScoperb75b35f52b74\PhpParser\Node\Name('parent');
    }
