...
final class FloatTypeMapper implements \_PhpScoper2a4e7ab1ecbc\Rector\PHPStanStaticTypeMapper\Contract\TypeMapperInterface
{
    /**
    ...
    {
        return \_PhpScoper2a4e7ab1ecbc\PHPStan\Type\FloatType::class;
    }
    /**
    ...
    {
        return new \_PhpScoper2a4e7ab1ecbc\Rector\AttributeAwarePhpDoc\Ast\Type\AttributeAwareIdentifierTypeNode('float');
    }
    /**
     * @param FloatType $type
     */
    public function mapToPhpParserNode(\_PhpScoper2a4e7ab1ecbc\PHPStan\Type\Type $type, ?string $kind = null) : ?\_PhpScoper2a4e7ab1ecbc\PhpParser\Node
    {
        ...
        return new \_PhpScoper2a4e7ab1ecbc\PhpParser\Node\Name('float');
    }
