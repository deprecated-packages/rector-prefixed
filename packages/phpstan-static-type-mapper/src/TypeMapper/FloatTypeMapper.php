...
final class FloatTypeMapper implements \_PhpScopere8e811afab72\Rector\PHPStanStaticTypeMapper\Contract\TypeMapperInterface
{
    /**
    ...
    {
        return \_PhpScopere8e811afab72\PHPStan\Type\FloatType::class;
    }
    /**
    ...
    {
        return new \_PhpScopere8e811afab72\Rector\AttributeAwarePhpDoc\Ast\Type\AttributeAwareIdentifierTypeNode('float');
    }
    /**
     * @param FloatType $type
     */
    public function mapToPhpParserNode(\_PhpScopere8e811afab72\PHPStan\Type\Type $type, ?string $kind = null) : ?\_PhpScopere8e811afab72\PhpParser\Node
    {
        ...
        return new \_PhpScopere8e811afab72\PhpParser\Node\Name('float');
    }
