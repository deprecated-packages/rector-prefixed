...
final class NodeTypes
{
     ...
     */
    public const TYPE_AWARE_NODES = [\PHPStan\PhpDocParser\Ast\PhpDoc\VarTagValueNode::class, \PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode::class, \PHPStan\PhpDocParser\Ast\PhpDoc\ReturnTagValueNode::class, \PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode::class, \PHPStan\PhpDocParser\Ast\PhpDoc\PropertyTagValueNode::class, \Rector\Symfony\PhpDoc\Node\JMS\SerializerTypeTagValueNode::class, \Rector\BetterPhpDocParser\ValueObject\PhpDocNode\Doctrine\Property_\OneToManyTagValueNode::class, \Rector\Symfony\PhpDoc\Node\AssertChoiceTagValueNode::class, \Rector\Symfony\PhpDoc\Node\AssertEmailTagValueNode::class, \Rector\Symfony\PhpDoc\Node\AssertRangeTagValueNode::class];
}
