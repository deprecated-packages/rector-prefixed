...
final class PhpDocTypeChanger
{
     ...
     * @return void
     */
    public function changeVarType(PhpDocInfo $phpDocInfo, Type $newType)
    {
     ...
     * @return void
     */
    public function changeReturnType(PhpDocInfo $phpDocInfo, Type $newType)
    {
     ...
     * @return void
     */
    public function changeParamType(PhpDocInfo $phpDocInfo, Type $newType, Param $param, string $paramName)
    {
        // better skip, could crash hard
