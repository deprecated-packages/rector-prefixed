...
use RectorPrefix20210315\Doctrine\Common\Annotations\AnnotationException;
...
final class NodeAnnotationReader
{
    ...
    public function __construct(\Rector\DoctrineAnnotationGenerated\PhpDocNode\ConstantReferenceIdentifierRestorer $constantReferenceIdentifierRestorer, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210315\Doctrine\Common\Annotations\Reader $reader, \PHPStan\Reflection\ReflectionProvider $reflectionProvider)
    {
        $this->reader = $reader;
    ...
    public function readClassAnnotation(\PhpParser\Node\Stmt\Class_ $class, string $annotationClassName)
    {
        ...
        } catch (\RectorPrefix20210315\Doctrine\Common\Annotations\AnnotationException $annotationException) {
            // unable to load
            return null;
        }
    }
