...
namespace _PhpScopere8e811afab72\Rector\DoctrineAnnotationGenerated\PhpDocNode;

use _PhpScopere8e811afab72\Rector\BetterPhpDocParser\Annotation\AnnotationItemsResolver;
use _PhpScopere8e811afab72\Rector\BetterPhpDocParser\Annotation\AnnotationVisibilityDetector;
use _PhpScopere8e811afab72\Rector\DoctrineAnnotationGenerated\DataCollector\ResolvedConstantStaticCollector;
...
final class ConstantReferenceIdentifierRestorer
{
    ...
    public function __construct(\_PhpScopere8e811afab72\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor, \_PhpScopere8e811afab72\Rector\BetterPhpDocParser\Annotation\AnnotationItemsResolver $annotationItemsResolver, \_PhpScopere8e811afab72\Rector\BetterPhpDocParser\Annotation\AnnotationVisibilityDetector $annotationVisibilityDetector)
    {
    ...
    public function restoreObject(object $annotation) : void
    {
        ...
        $identifierToResolvedValues = \_PhpScopere8e811afab72\Rector\DoctrineAnnotationGenerated\DataCollector\ResolvedConstantStaticCollector::provide();
        ...
        \_PhpScopere8e811afab72\Rector\DoctrineAnnotationGenerated\DataCollector\ResolvedConstantStaticCollector::clear();
    }
    /**
