...
final class RectorSetProvider extends \RectorPrefix20210317\Symplify\SetConfigResolver\Provider\AbstractSetProvider
{
    /**
     * @var string
    ...
    public function provideByName(string $desiredSetName) : ?\RectorPrefix20210317\Symplify\SetConfigResolver\ValueObject\Set
    {
        ...
        if ($foundSet instanceof \RectorPrefix20210317\Symplify\SetConfigResolver\ValueObject\Set) {
            return $foundSet;
        }
        ...
        foreach ($this->sets as $set) {
            ...
            $desiredSetFileInfo = new \RectorPrefix20210317\Symplify\SmartFileSystem\SmartFileInfo($desiredSetName);
