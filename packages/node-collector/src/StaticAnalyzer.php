...
namespace _PhpScoper0a6b37af0871\Rector\NodeCollector;
...
final class StaticAnalyzer
{
    ...
    {
        return (bool) \_PhpScoper0a6b37af0871\Nette\Utils\Strings::match((string) $reflectionClass->getDocComment(), '#@method\\s*static\\s*(.*?)\\b' . $methodName . '\\b#');
    }
}
