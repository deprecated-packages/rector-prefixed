...
final class JetbrainsStubsRenamer
{
    ...
    private function renameFilesSuffixesInPhpStormStubsMapFile(string $phpStormStubsDirectory) : void
    {
        ...
        $stubsMapContents = \_PhpScoperabd03f0baf05\Nette\Utils\Strings::replace($stubsMapContents, self::PHP_SUFFIX_COMMA_REGEX, ".stub',");
    ...
    private function getStubFileInfos(string $phpStormStubsDirectory) : array
    {
        ...
        $stubFinder = \_PhpScoperabd03f0baf05\Symfony\Component\Finder\Finder::create()->files()->name('*.php')->in($phpStormStubsDirectory)->notName('#PhpStormStubsMap\\.php$#');
