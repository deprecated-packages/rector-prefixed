...
final class FixtureGuard
{
    ...
    public function ensureFileInfoHasDifferentBeforeAndAfterContent(\RectorPrefix20210316\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $match = \RectorPrefix20210316\Nette\Utils\Strings::match($smartFileInfo->getContents(), self::BEFORE_AFTER_CONTENT_REGEX);
        if ($match === null) {
            return;
        }
