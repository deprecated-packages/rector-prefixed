...
trait MovingFilesTrait
{
    ...
    {
        \RectorPrefix20210507\Webmozart\Assert\Assert::allIsAOf($expectedAddedFileWithContents, \Rector\FileSystemRector\ValueObject\AddedFileWithContent::class);
        ...
        \RectorPrefix20210507\Webmozart\Assert\Assert::notEmpty($addedFilePathsWithContents);
