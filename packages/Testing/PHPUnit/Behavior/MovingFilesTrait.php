...
trait MovingFilesTrait
{
    ...
    {
        \RectorPrefix20210508\Webmozart\Assert\Assert::allIsAOf($expectedAddedFileWithContents, \Rector\FileSystemRector\ValueObject\AddedFileWithContent::class);
        ...
        \RectorPrefix20210508\Webmozart\Assert\Assert::notEmpty($addedFilePathsWithContents);
