...
{
    protected function assertFileWasNotChanged(\RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    protected function assertFileWasRemoved(\RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    {
        \RectorPrefix20210429\Webmozart\Assert\Assert::allIsAOf($expectedAddedFileWithContents, \Rector\FileSystemRector\ValueObject\AddedFileWithContent::class);
        ...
        \RectorPrefix20210429\Webmozart\Assert\Assert::notEmpty($addedFilePathsWithContents);
