...
use RectorPrefix20210429\PHPUnit\Framework\ExpectationFailedException;
...
use RectorPrefix20210429\Symplify\EasyTesting\DataProvider\StaticFixtureFinder;
use RectorPrefix20210429\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater;
use RectorPrefix20210429\Symplify\EasyTesting\StaticFixtureSplitter;
...
abstract class AbstractRectorTestCase extends \Rector\Testing\PHPUnit\AbstractTestCase implements \Rector\Testing\Contract\RectorTestInterface
{
    ...
    protected function setUp() : void
    {
        ...
        $configFileInfo = new \RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo($this->provideConfigFilePath());
        ...
        $this->parameterProvider = $this->getService(\RectorPrefix20210429\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
    ...
    {
        return \RectorPrefix20210429\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectoryExclusively($directory, $suffix);
    }
    protected function doTestFileInfo(\RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $inputFileInfoAndExpectedFileInfo = \RectorPrefix20210429\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpectedFileInfos($fixtureFileInfo);
    ...
    private function doTestFileMatchesExpectedContent(\RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, \RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        ...
        } catch (\RectorPrefix20210429\PHPUnit\Framework\ExpectationFailedException $expectationFailedException) {
            \RectorPrefix20210429\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater::updateFixtureContent($originalFileInfo, $changedContent, $fixtureFileInfo);
    ...
    {
        return \RectorPrefix20210429\Nette\Utils\Strings::replace($string, '#\\r\\n|\\r|\\n#', "\n");
    }
    private function processFileInfo(\RectorPrefix20210429\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
