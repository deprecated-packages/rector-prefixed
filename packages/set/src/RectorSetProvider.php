...
use RectorPrefix20210302\Symplify\SetConfigResolver\Provider\AbstractSetProvider;
...
final class RectorSetProvider extends \RectorPrefix20210302\Symplify\SetConfigResolver\Provider\AbstractSetProvider
{
    /**
     * @var string
    ...
    public function provideByName(string $desiredSetName) : ?\RectorPrefix20210302\Symplify\SetConfigResolver\ValueObject\Set
    {
        ...
        if ($foundSet instanceof \RectorPrefix20210302\Symplify\SetConfigResolver\ValueObject\Set) {
            return $foundSet;
        }
        ...
        foreach ($this->sets as $set) {
            ...
            $desiredSetFileInfo = new \RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo($desiredSetName);
    ...
    private function hydrateSetsFromConstants(\ReflectionClass $setListReflectionClass) : void
    {
        foreach ($setListReflectionClass->getConstants() as $name => $setPath) {
            ...
            $setName = \RectorPrefix20210302\Nette\Utils\Strings::replace($setName, self::DASH_NUMBER_REGEX, '$1');
            $this->sets[] = new \RectorPrefix20210302\Symplify\SetConfigResolver\ValueObject\Set($setName, new \RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo($setPath));
        }
    }
}
