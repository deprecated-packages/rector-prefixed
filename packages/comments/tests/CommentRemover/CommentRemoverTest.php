...
final class CommentRemoverTest extends \RectorPrefix20210210\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var CommentRemover
     */
     ...
     */
    public function test(\RectorPrefix20210210\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $fileInfoToLocalInputAndExpected = \RectorPrefix20210210\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($smartFileInfo);
    ...
    {
        return \RectorPrefix20210210\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory(__DIR__ . '/Fixture', '*.php.inc');
    }
}
