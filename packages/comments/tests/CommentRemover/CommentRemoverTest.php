...
final class CommentRemoverTest extends \RectorPrefix20210121\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var CommentRemover
     */
     ...
     */
    public function test(\RectorPrefix20210121\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $fileInfoToLocalInputAndExpected = \RectorPrefix20210121\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($smartFileInfo);
    ...
    {
        return \RectorPrefix20210121\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory(__DIR__ . '/Fixture', '*.php.inc');
    }
}
