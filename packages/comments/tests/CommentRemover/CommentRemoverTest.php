...
final class CommentRemoverTest extends \RectorPrefix20210224\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var CommentRemover
     */
    ...
    {
        $fileInfoToLocalInputAndExpected = \RectorPrefix20210224\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($smartFileInfo);
    ...
    {
        return \RectorPrefix20210224\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory(__DIR__ . '/Fixture', '*.php.inc');
    }
}
