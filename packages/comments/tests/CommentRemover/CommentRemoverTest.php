...
final class CommentRemoverTest extends \RectorPrefix20210223\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var CommentRemover
     */
    ...
    {
        $fileInfoToLocalInputAndExpected = \RectorPrefix20210223\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($smartFileInfo);
    ...
    {
        return \RectorPrefix20210223\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory(__DIR__ . '/Fixture', '*.php.inc');
    }
}
