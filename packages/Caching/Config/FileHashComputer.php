...
{
    public function compute(\RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
    ...
    private function ensureIsPhp(\RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    private function createFileLoader(\RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, \RectorPrefix20210414\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \RectorPrefix20210414\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \RectorPrefix20210414\Symfony\Component\Config\FileLocator([$fileInfo->getPath()]);
        $fileLoaders = [new \RectorPrefix20210414\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \RectorPrefix20210414\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \RectorPrefix20210414\Symfony\Component\Config\Loader\LoaderResolver($fileLoaders);
