...
{
    public function compute(\RectorPrefix20210420\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
        $this->ensureIsPhp($fileInfo);
        $containerBuilder = new \RectorPrefix20210420\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    private function createFileLoader(\RectorPrefix20210420\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, \RectorPrefix20210420\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \RectorPrefix20210420\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \RectorPrefix20210420\Symfony\Component\Config\FileLocator([$fileInfo->getPath()]);
        $fileLoaders = [new \RectorPrefix20210420\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \RectorPrefix20210420\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \RectorPrefix20210420\Symfony\Component\Config\Loader\LoaderResolver($fileLoaders);
