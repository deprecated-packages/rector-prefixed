...
final class ChangedFilesDetector
{
     ...
     */
    private $cache;
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \RectorPrefix20210505\Nette\Caching\Cache $cache)
    {
    ...
    {
        $this->cache->clean([\RectorPrefix20210505\Nette\Caching\Cache::ALL => \true]);
    }
    /**
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \RectorPrefix20210505\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
