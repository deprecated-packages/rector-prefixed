...
final class ChangedFilesDetector
{
    ...
    {
        $this->cache->clean([\RectorPrefix20210506\Nette\Caching\Cache::ALL => \true]);
    }
    /**
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \RectorPrefix20210506\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
