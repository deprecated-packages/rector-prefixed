...
use RectorPrefix20210506\Nette\Caching\Storages\FileStorage;
...
final class NetteCacheFactory
{
    ...
    public function create() : \RectorPrefix20210506\Nette\Caching\Cache
    {
        ...
        $fileStorage = new \RectorPrefix20210506\Nette\Caching\Storages\FileStorage($cacheDirectory);
        // namespace is unique per project
        $namespace = \RectorPrefix20210506\Nette\Utils\Strings::webalize(\getcwd());
        return new \RectorPrefix20210506\Nette\Caching\Cache($fileStorage, $namespace);
    }
}
