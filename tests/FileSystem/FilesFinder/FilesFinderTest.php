...
final class FilesFinderTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var FilesFinder
     */
    ...
    public function testMatchGitDiff() : void
    {
        ...
        $foundFiles = $this->filesFinder->findInDirectoriesAndFiles([$dir], ['php'], \true);
