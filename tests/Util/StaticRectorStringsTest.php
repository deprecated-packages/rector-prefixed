...
final class StaticRectorStringsTest extends \_PhpScoperbd5d0c5f7638\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->assertSame($expected, \Rector\Core\Util\StaticRectorStrings::camelCaseToUnderscore($content));
    }
    ...
    {
        $this->assertSame($expected, \Rector\Core\Util\StaticRectorStrings::underscoreToCamelCase($content));
    }
    ...
    {
        $this->assertSame($expected, \Rector\Core\Util\StaticRectorStrings::underscoreToPascalCase($content));
    }
