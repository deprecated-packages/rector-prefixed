...
final class ClassSyncerNodeTraverser extends \PhpParser\NodeTraverser
{
    /**
     ...
     */
    public function __construct(array $classSyncerRectors, \Rector\PostRector\Application\PostFileProcessor $postFileProcessor)
    {
