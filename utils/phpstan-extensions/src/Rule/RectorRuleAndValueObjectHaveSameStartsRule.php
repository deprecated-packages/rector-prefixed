...
final class RectorRuleAndValueObjectHaveSameStartsRule implements \PHPStan\Rules\Rule
{
    ...
    public function processNode(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope) : array
    {
        ...
        $expectedValueObjectShortClass = \_PhpScoper006a73f0e455\Nette\Utils\Strings::replace($rectorShortClass, self::RECTOR_SUFFIX_REGEX, '');
    ...
    {
        return !$this->typeAndNameAnalyzer->isMethodCallTypeAndName($methodCall, $scope, '_PhpScoper006a73f0e455\\Symfony\\Component\\DependencyInjection\\Loader\\Configurator\\ServicesConfigurator', 'set');
    }
