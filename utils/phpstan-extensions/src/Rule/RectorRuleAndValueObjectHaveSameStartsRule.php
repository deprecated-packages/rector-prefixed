...
final class RectorRuleAndValueObjectHaveSameStartsRule implements \PHPStan\Rules\Rule
{
    ...
    public function processNode(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope) : array
    {
        ...
        $expectedValueObjectShortClass = \_PhpScopera143bcca66cb\Nette\Utils\Strings::replace($rectorShortClass, self::RECTOR_SUFFIX_REGEX, '');
    ...
    {
        return !$this->typeAndNameAnalyzer->isMethodCallTypeAndName($methodCall, $scope, '_PhpScopera143bcca66cb\\Symfony\\Component\\DependencyInjection\\Loader\\Configurator\\ServicesConfigurator', 'set');
    }
