...
final class NodeInfosFactory
{
    ...
    public function __construct(\Rector\Utils\NodeDocumentationGenerator\NodeCodeSampleProvider $nodeCodeSampleProvider, \Rector\Utils\NodeDocumentationGenerator\Sorter\NodeInfoSorter $nodeInfoSorter)
    {
    ...
    public function create() : array
    {
        ...
        foreach ($this->nodeCodeSampleProvider->provide() as $nodeClass => $nodeCodeSamples) {
            $nodeInfos[] = new \Rector\Utils\NodeDocumentationGenerator\ValueObject\NodeInfo($nodeClass, $nodeCodeSamples);
        }
