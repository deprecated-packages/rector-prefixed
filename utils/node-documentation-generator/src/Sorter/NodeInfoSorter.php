...
final class NodeInfoSorter
{
    ...
    {
        \usort($nodeInfos, function (\Rector\Utils\NodeDocumentationGenerator\ValueObject\NodeInfo $firstNodeInfo, \Rector\Utils\NodeDocumentationGenerator\ValueObject\NodeInfo $secondNodeInfo) : int {
