...
final class NodeClassFinder
{
    ...
    {
        return $this->findClassesByNamePatternInDirectories('*Node.php', [__DIR__ . '/../../../../vendor/phpstan/phpdoc-parser/src/Ast/Type', __DIR__ . '/../../../../vendor/phpstan/phpdoc-parser/src/Ast/PhpDoc']);
    }
    /**
