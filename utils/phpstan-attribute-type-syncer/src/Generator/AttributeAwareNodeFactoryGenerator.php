...
final class AttributeAwareNodeFactoryGenerator extends \Rector\Utils\PHPStanAttributeTypeSyncer\Generator\AbstractAttributeAwareNodeGenerator
{
    /**
    ...
    public function __construct(\Rector\Utils\PHPStanAttributeTypeSyncer\NodeFactory\AttributeAwareClassFactoryFactory $attributeAwareClassFactoryFactory, \Rector\Utils\PHPStanAttributeTypeSyncer\ClassNaming\AttributeClassNaming $attributeClassNaming, \Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    private function resolveTargetFilePath(string $phpDocParserNodeClass) : string
    {
        ...
        if (\_PhpScoperabd03f0baf05\Nette\Utils\Strings::contains($phpDocParserNodeClass, '\\Type\\')) {
