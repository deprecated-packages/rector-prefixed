...
return static function (\RectorPrefix20201227\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Rector\Generic\Rector\FuncCall\RemoveFuncCallArgRector::class)->call('configure', [[\Rector\Generic\Rector\FuncCall\RemoveFuncCallArgRector::REMOVED_FUNCTION_ARGUMENTS => \RectorPrefix20201227\Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Generic\ValueObject\RemoveFuncCallArg('mysql_pconnect', 3), new \Rector\Generic\ValueObject\RemoveFuncCallArg('mysql_connect', 3), new \Rector\Generic\ValueObject\RemoveFuncCallArg('mysql_connect', 4)])]]);
    ...
    $services->set(\Rector\Generic\Rector\FuncCall\SwapFuncCallArgumentsRector::class)->call('configure', [[\Rector\Generic\Rector\FuncCall\SwapFuncCallArgumentsRector::FUNCTION_ARGUMENT_SWAPS => \RectorPrefix20201227\Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Generic\ValueObject\SwapFuncCallArguments('mysql_query', [1, 0]), new \Rector\Generic\ValueObject\SwapFuncCallArguments('mysql_real_escape_string', [1, 0]), new \Rector\Generic\ValueObject\SwapFuncCallArguments('mysql_select_db', [1, 0]), new \Rector\Generic\ValueObject\SwapFuncCallArguments('mysql_set_charset', [1, 0])])]]);
