...
return static function (\_PhpScoper567b66d83109\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Rector\Transform\Rector\StaticCall\StaticCallToMethodCallRector::class)->call('configure', [[\Rector\Transform\Rector\StaticCall\StaticCallToMethodCallRector::STATIC_CALLS_TO_METHOD_CALLS => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Transform\ValueObject\StaticCallToMethodCall('_PhpScoper567b66d83109\\Nette\\Security\\Passwords', 'hash', '_PhpScoper567b66d83109\\Nette\\Security\\Passwords', 'hash'), new \Rector\Transform\ValueObject\StaticCallToMethodCall('_PhpScoper567b66d83109\\Nette\\Security\\Passwords', 'verify', '_PhpScoper567b66d83109\\Nette\\Security\\Passwords', 'verify'), new \Rector\Transform\ValueObject\StaticCallToMethodCall('_PhpScoper567b66d83109\\Nette\\Security\\Passwords', 'needsRehash', '_PhpScoper567b66d83109\\Nette\\Security\\Passwords', 'needsRehash')])]]);
    ...
    $services->set(\Rector\Renaming\Rector\Name\RenameClassRector::class)->call('configure', [[\Rector\Renaming\Rector\Name\RenameClassRector::OLD_TO_NEW_CLASSES => [
        ...
        '_PhpScoper567b66d83109\\Nextras\\FormComponents\\Controls\\DatePicker' => '_PhpScoper567b66d83109\\Nextras\\FormComponents\\Controls\\DateControl',
        # @see https://github.com/nette/di/commit/a0d361192f8ac35f1d9f82aab7eb351e4be395ea
        '_PhpScoper567b66d83109\\Nette\\DI\\ServiceDefinition' => '_PhpScoper567b66d83109\\Nette\\DI\\Definitions\\ServiceDefinition',
        '_PhpScoper567b66d83109\\Nette\\DI\\Statement' => '_PhpScoper567b66d83109\\Nette\\DI\\Definitions\\Statement',
        '_PhpScoper567b66d83109\\WebChemistry\\Forms\\Controls\\Multiplier' => '_PhpScoper567b66d83109\\Contributte\\FormMultiplier\\Multiplier',
    ]]]);
    $services->set(\Rector\Generic\Rector\ClassMethod\ArgumentDefaultValueReplacerRector::class)->call('configure', [[\Rector\Generic\Rector\ClassMethod\ArgumentDefaultValueReplacerRector::REPLACED_ARGUMENTS => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([
        ...
        new \Rector\Generic\ValueObject\ArgumentDefaultValueReplacer('_PhpScoper567b66d83109\\Nette\\Utils\\Json', 'decode', 1, \true, 'Nette\\Utils\\Json::FORCE_ARRAY'),
        // @see https://github.com/nette/forms/commit/574b97f9d5e7a902a224e57d7d584e7afc9fefec
        new \Rector\Generic\ValueObject\ArgumentDefaultValueReplacer('_PhpScoper567b66d83109\\Nette\\Forms\\Form', 'decode', 0, \true, 'array'),
    ])]]);
    $services->set(\Rector\Renaming\Rector\MethodCall\RenameMethodRector::class)->call('configure', [[\Rector\Renaming\Rector\MethodCall\RenameMethodRector::METHOD_CALL_RENAMES => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([
        ...
        new \Rector\Renaming\ValueObject\MethodCallRename('_PhpScoper567b66d83109\\Nette\\Forms\\Controls\\BaseControl', 'setType', 'setHtmlType'),
        new \Rector\Renaming\ValueObject\MethodCallRename('_PhpScoper567b66d83109\\Nette\\Forms\\Controls\\BaseControl', 'setAttribute', 'setHtmlAttribute'),
        new \Rector\Renaming\ValueObject\MethodCallRename(
            '_PhpScoper567b66d83109\\Nette\\DI\\Definitions\\ServiceDefinition',
            # see https://github.com/nette/di/commit/1705a5db431423fc610a6f339f88dead1b5dc4fb
            'setClass',
            'setType'
        ),
        new \Rector\Renaming\ValueObject\MethodCallRename('_PhpScoper567b66d83109\\Nette\\DI\\Definitions\\ServiceDefinition', 'getClass', 'getType'),
        new \Rector\Renaming\ValueObject\MethodCallRename('_PhpScoper567b66d83109\\Nette\\DI\\Definitions\\Definition', 'isAutowired', 'getAutowired'),
    ])]]);
