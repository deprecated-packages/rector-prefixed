...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Rector\Generic\Rector\Expression\MethodCallToReturnRector::class)->call('configure', [[\Rector\Generic\Rector\Expression\MethodCallToReturnRector::METHOD_CALL_WRAPS => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Generic\ValueObject\MethodCallToReturn('_PhpScoper006a73f0e455\\Illuminate\\Auth\\Access\\HandlesAuthorization', 'deny')])]]);
    ...
    $services->set(\Rector\Renaming\Rector\MethodCall\RenameMethodRector::class)->call('configure', [[\Rector\Renaming\Rector\MethodCall\RenameMethodRector::METHOD_CALL_RENAMES => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Renaming\ValueObject\MethodCallRename(
        '_PhpScoper006a73f0e455\\Illuminate\\Auth\\Access\\Gate',
        ...
        '_PhpScoper006a73f0e455\\Illuminate\\Support\\Facades\\Lang',
        # https://github.com/laravel/framework/commit/efbe23c4116f86846ad6edc0d95cd56f4175a446
        'trans',
        'get'
    ), new \Rector\Renaming\ValueObject\MethodCallRename('_PhpScoper006a73f0e455\\Illuminate\\Support\\Facades\\Lang', 'transChoice', 'choice'), new \Rector\Renaming\ValueObject\MethodCallRename(
        '_PhpScoper006a73f0e455\\Illuminate\\Translation\\Translator',
    ...
    $configuration = [
        ...
        new \Rector\Renaming\ValueObject\RenameStaticMethod('_PhpScoper006a73f0e455\\Illuminate\\Support\\Facades\\Input', 'get', '_PhpScoper006a73f0e455\\Illuminate\\Support\\Facades\\Request', 'input'),
    ];
    ...
    $services->set(\Rector\Renaming\Rector\Name\RenameClassRector::class)->call('configure', [[\Rector\Renaming\Rector\Name\RenameClassRector::OLD_TO_NEW_CLASSES => ['_PhpScoper006a73f0e455\\Illuminate\\Support\\Facades\\Input' => '_PhpScoper006a73f0e455\\Illuminate\\Support\\Facades\\Request']]]);
    ...
    $services->set(\Rector\Generic\Rector\ClassMethod\ArgumentAdderRector::class)->call('configure', [[\Rector\Generic\Rector\ClassMethod\ArgumentAdderRector::ADDED_ARGUMENTS => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([
        ...
        new \Rector\Generic\ValueObject\ArgumentAdder('_PhpScoper006a73f0e455\\Illuminate\\Database\\Capsule\\Manager', 'table', 1, 'as', 'null'),
        new \Rector\Generic\ValueObject\ArgumentAdder('_PhpScoper006a73f0e455\\Illuminate\\Database\\Connection', 'table', 1, 'as', 'null'),
        new \Rector\Generic\ValueObject\ArgumentAdder('_PhpScoper006a73f0e455\\Illuminate\\Database\\ConnectionInterface', 'table', 1, 'as', 'null'),
        new \Rector\Generic\ValueObject\ArgumentAdder('_PhpScoper006a73f0e455\\Illuminate\\Database\\Query\\Builder', 'from', 1, 'as', 'null'),
    ])]]);
};
