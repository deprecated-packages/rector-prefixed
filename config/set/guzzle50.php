...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $configuration = [new \Rector\Transform\ValueObject\FuncNameToMethodCallName('_PhpScoper88fe6e0ad041\\GuzzleHttp\\json_decode', '_PhpScoper88fe6e0ad041\\GuzzleHttp\\Utils', 'jsonDecode'), new \Rector\Transform\ValueObject\FuncNameToMethodCallName('_PhpScoper88fe6e0ad041\\GuzzleHttp\\get_path', '_PhpScoper88fe6e0ad041\\GuzzleHttp\\Utils', 'getPath')];
    ...
    $services->set(\Rector\Renaming\Rector\MethodCall\RenameMethodRector::class)->call('configure', [[\Rector\Renaming\Rector\MethodCall\RenameMethodRector::METHOD_CALL_RENAMES => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Renaming\ValueObject\MethodCallRename('_PhpScoper88fe6e0ad041\\GuzzleHttp\\Message\\MessageInterface', 'getHeaderLines', 'getHeaderAsArray')])]]);
};
